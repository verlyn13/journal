...
class ContentFixer:
    ...
    def consolidate_duplicates(self):
        ...
        um_files = list(Path('docs/features/user-management').glob('USER_MANAGEMENT_ORCHESTRATEV*.md'))
        ...
        if len(um_files) > 1:
            ...
            consolidated_path = Path('docs/features/user-management/USER_MANAGEMENT_ORCHESTRATION.md')
            content = f"""---
