...
console.assert(
	changes.length === 1,
	"insertBold (no selection): Should have 1 change",
);
console.assert(
	changes[0]?.insert === "****bold text**",
	`insertBold (no selection): Incorrect insert: ${changes[0]?.insert}`,
);
console.assert(
	selection?.main?.anchor === 2,
	`insertBold (no selection): Incorrect cursor pos: ${selection?.main?.anchor}`,
);
...
console.assert(
	changes.length === 2,
	"insertBold (with selection): Should have 2 changes",
);
console.assert(
	changes[0]?.insert === "**",
	`insertBold (with selection): Incorrect prefix: ${changes[0]?.insert}`,
);
console.assert(
	changes[1]?.insert === "**",
	`insertBold (with selection): Incorrect suffix: ${changes[1]?.insert}`,
);
console.assert(
	selection?.main?.anchor === 2 && selection?.main?.head === 7,
	`insertBold (with selection): Incorrect selection: ${selection?.main?.anchor}-${selection?.main?.head}`,
);
...
console.assert(
	changes.length === 1,
	"insertItalic (no selection): Should have 1 change",
);
console.assert(
	changes[0]?.insert === "**italic text*",
	`insertItalic (no selection): Incorrect insert: ${changes[0]?.insert}`,
);
console.assert(
	selection?.main?.anchor === 1,
	`insertItalic (no selection): Incorrect cursor pos: ${selection?.main?.anchor}`,
);
...
console.assert(
	changes.length === 1,
	"insertLink (no selection): Should have 1 change",
);
console.assert(
	changes[0]?.insert === "[link text](url)",
	`insertLink (no selection): Incorrect insert: ${changes[0]?.insert}`,
);
console.assert(
	selection?.main?.anchor === 11,
	`insertLink (no selection): Incorrect cursor pos: ${selection?.main?.anchor}`,
); // Cursor inside (url)
...
console.assert(
	changes.length === 1,
	"insertLink (with selection): Should have 1 change",
);
console.assert(
	changes[0]?.insert === "[my site](url)",
	`insertLink (with selection): Incorrect insert: ${changes[0]?.insert}`,
);
console.assert(
	selection?.main?.anchor === 10,
	`insertLink (with selection): Incorrect cursor pos: ${selection?.main?.anchor}`,
); // Cursor inside (url)
...
console.assert(
	changes.length === 1,
	"insertList (ul, single): Should have 1 change",
);
console.assert(
	changes[0]?.from === 0,
	`insertList (ul, single): Incorrect from: ${changes[0]?.from}`,
);
console.assert(
	changes[0]?.insert === "- ",
	`insertList (ul, single): Incorrect insert: ${changes[0]?.insert}`,
);
...
console.assert(
	changes.length === 2,
	"insertList (ol, multi): Should have 2 changes",
);
console.assert(
	changes[0]?.from === 0 && changes[0]?.insert === "1. ",
	`insertList (ol, multi): Incorrect change 1: ${changes[0]?.insert}`,
);
console.assert(
	changes[1]?.from === 6 && changes[1]?.insert === "2. ",
	`insertList (ol, multi): Incorrect change 2: ${changes[1]?.insert}`,
...
console.assert(
	changes.length === 2,
	"insertBlockquote (multi): Should have 2 changes",
);
console.assert(
	changes[0]?.from === 0 && changes[0]?.insert === "> ",
	`insertBlockquote (multi): Incorrect change 1: ${changes[0]?.insert}`,
);
console.assert(
	changes[1]?.from === 9 && changes[1]?.insert === "> ",
	`insertBlockquote (multi): Incorrect change 2: ${changes[1]?.insert}`,
); // Line 2 starts at index 9
