...
```
1{2  "options": {3    "patterns": [4      {5        "group": ["import-entry/*", "!import-entry/user"],6        "message": "import-entry is deprecated, except for modules in import-entry/baz."7      }8    ]9  }10}
```
...
1type Bar = { \[BAR]: true };2const BAR = "tag";

```
```

1interface Bar {2  child: { grandChild: { \[BAR]: typeof BAR; enumFoo: EnumFoo } };3}4const BAR = "tag";5enum EnumFoo {6  BAR = "tag",7}
