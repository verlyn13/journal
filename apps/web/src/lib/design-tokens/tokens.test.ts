...
describe('Design Tokens', () => {
  ...
  it('should generate CSS variables for dawn theme', () => {
    ...
    expect(variables).toContain('--sanctuary-text-primary: #2c2f35;');
    expect(variables).toContain('--sanctuary-accent-primary: #5a7390;');
  ...
  it('should generate CSS variables for dusk theme', () => {
    ...
    expect(variables).toContain('--sanctuary-text-primary: #e4e6e9;');
