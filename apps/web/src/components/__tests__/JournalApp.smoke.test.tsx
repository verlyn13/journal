...
vi.mock('../../hooks/useEntryQueries', () => {
  return {
    useEntriesList: () => ({
      data: [
        { id: 'e1', title: 'First', preview: 'Preview content', date: 'Today', time: '10:00', wordCount: 10, tags: ['t1'] },
      ],
      isLoading: false,
    }),
    useCreateEntry: () => ({ mutateAsync: vi.fn(async () => ({ id: 'e2', title: 'New', content: '', version: 1, content_version: 2 })) }),
