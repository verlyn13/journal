...
def upgrade() -> None:
    ...
    op.alter_column("entries", "version", server_default="1", existing_type=sa.Integer())
    op.alter_column("entries", "version", nullable=False, existing_type=sa.Integer())

    op.alter_column("entries", "word_count", server_default="0", existing_type=sa.Integer())
    op.alter_column("entries", "word_count", nullable=False, existing_type=sa.Integer())

    op.alter_column("entries", "char_count", server_default="0", existing_type=sa.Integer())
    op.alter_column("entries", "char_count", nullable=False, existing_type=sa.Integer())
