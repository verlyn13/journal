...
@pytest.mark.asyncio
async def test_real_user_registration_and_login(client: AsyncClient, session: AsyncSession):
...
@pytest.mark.asyncio
async def test_entry_ownership(client: AsyncClient, session: AsyncSession):
...
@pytest.mark.asyncio
async def test_user_entries_isolation(client: AsyncClient, session: AsyncSession):
