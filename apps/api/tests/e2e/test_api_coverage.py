...
async def test_entry_api_edge_cases(client: AsyncClient, auth_headers):
    ...
    r4 = await client.put(
        ...
        json={"markdown_content": "# Updated\n\nNew content", "content_version": 2, "expected_version": r2.json()["version"]},
        headers=auth_headers,
    )
...
async def test_invalid_entry_ids(client: AsyncClient, auth_headers):
    ...
    r2 = await client.put("/api/v1/entries/not-a-uuid", json={"title": "Test", "expected_version": 1}, headers=auth_headers)
    ...
    r5 = await client.put(f"/api/v1/entries/{fake_id}", json={"title": "Test", "expected_version": 1}, headers=auth_headers)
