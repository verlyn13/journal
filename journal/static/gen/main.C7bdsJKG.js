						...
						(function (e) {
							...
							i.some((t) => {
								if (document.querySelector(t))
									return xe(`found "${t}", but missing ${e} plugin`), !0;
							});
					});
				});
		},
...
function Dt(e, t, i) {
	...
	r || n.set(i, (r = new Set())),
		r.has(bt) ||
			...
			bt.deps.push(r),
			bt.options.onTrack &&
				bt.options.onTrack({ effect: bt, target: e, type: t, key: i }));
}
...
var wi = new WeakMap(),
	...
	Qi = new WeakMap();
function Pi(e) {
	return e && e.__v_isReadonly ? e : Zi(e, !1, Ft, xi, wi);
}
function $i(e) {
...
V(
	...
	te("teleport", (e, { modifiers: t, expression: i }, { cleanup: n }) => {
		"template" !== e.tagName.toLowerCase() &&
			xe("x-teleport can only be used on a <template> tag", e);
		let r = Ri(i),
...
(Bi.inline = (e, { value: t, modifiers: i, expression: n }) => {
					...
					n((n) => {
						...
						if (s(n))
							n = Object.entries(n).map(([e, s]) => {
								...
								r(
									(e) => {
										u.includes(e) && xe("Duplicate key on x-for", t), u.push(e);
									},
									{ scope: { index: e, ...o } },
								),
									c.push(o);
						...
						for (let e = 0; e < d.length; e++) {
							...
							P(() => {
								r || xe('x-for ":key" is undefined or invalid', o, i, l),
									r.after(s),
									n.after(r),
	...
	te("if", (e, { expression: t }, { effect: i, cleanup: n }) => {
		"template" !== e.tagName.toLowerCase() &&
			xe("x-if can only be used on a <template> tag", e);
		let r = N(e, t);
		i(() =>
			r((t) => {
				t
			...
			const i = (function (e, t) {
				const i = function () {
					...
					if (!Mt.includes(i)) {
						jt(i);
						try {
							return Lt.push(qt), (qt = !0), Mt.push(i), (bt = i), e();
						} finally {
							Mt.pop(), Vt(), (bt = Mt[Mt.length - 1]);
						}
					}
				};
				return (
...
function wr(e) {
	return (t) => {
		...
		if (
			...
			return xr.Word;
		for (let i = 0; i < e.length; i++) if (t.indexOf(e[i]) > -1) return xr.Word;
		return xr.Other;
	};
}
class Sr {
	...
	applyTransaction(e) {
		...
		for (let t of e.effects)
			t.is(Hn.reconfigure)
				...
				: t.is(ur.reconfigure)
					? ((i = null), (n = t.value))
					: t.is(ur.appendConfig) && ((i = null), (n = br(n).concat(t.value)));
	...
	changeByRange(e) {
		...
		for (let i = 1; i < t.ranges.length; i++) {
			...
			r.push(o.range.map(h)),
				(n = n.compose(l)),
				(s = ur.mapEffects(s, l).concat(ur.mapEffects(br(o.effects), h)));
		}
	...
	wordAt(e) {
		...
		for (; s > 0; ) {
			let e = gn(t, s, !1);
			if (r(t.slice(e, s)) != xr.Word) break;
			s = e;
		}
		for (; o < n; ) {
			let e = gn(t, o);
			if (r(t.slice(o, e)) != xr.Word) break;
			o = e;
		}
...
function wa(e, t, i) {
	...
	for (let f = e.firstChild; f; f = f.nextSibling) {
		...
		for (let d = 0; d < e.length; d++) {
			let p = e[d];
			r && xa(r, p) && (p = va(ya(p, r.bottom), r.top));
			let O = ga(t, p),
				m = ba(i, p);
...
function ka(e, t, i, n = -1) {
	...
	if (
		...
		if (p.caretPositionFromPoint) {
			...
			e && ({ offsetNode: g, offset: b } = e);
		} else if (p.caretRangeFromPoint) {
			let t = p.caretRangeFromPoint(c, u);
			t &&
				(({ startContainer: g, startOffset: b } = t),
	...
	if (!g || !e.docView.dom.contains(g)) {
		...
		({ node: g, offset: b } = wa(t.dom, c, u));
	}
	let x = e.docView.nearest(g);
	if (!x) return null;
	if (
		x.isWidget &&
		1 == (null === (s = x.dom) || void 0 === s ? void 0 : s.nodeType)
	) {
		let e = x.dom.getBoundingClientRect();
...
class xl {
	...
	setHeight(e) {
		this.height != e &&
			(Math.abs(this.height - e) > bl && (fl = !0), (this.height = e));
	}
	replace(e, t, i) {
		return xl.of(i);
	}
	...
	static of(e) {
		...
		return (
			...
			new kl(xl.of(e.slice(0, t)), s, xl.of(e.slice(i)))
		);
	}
}
function vl(e, t) {
...
class Sl extends xl {
	...
	updateHeight(e, t = 0, i = !1, n) {
		...
		if (n && n.from <= t + this.length && n.more) {
			...
			return (
				(o < 0 ||
					Math.abs(a.height - this.height) >= bl ||
					Math.abs(o - this.heightMetrics(e, t).perLine) >= bl) &&
					(fl = !0),
				vl(this, a)
			);
		}
			...
			let e = () => {
				...
				if (e) {
					this.clearDelayedAndroidKey(),
						...
						!this.flush() && e.force && bs(this.dom, e.key, e.keyCode);
				}
			};
...
class Jl {
		...
		(a || h) &&
			Promise.resolve().then(() => {
				a && this.state == a.startState && this.dispatch(a),
					h && !Ra(this, h) && l.force && bs(this.contentDOM, l.key, l.keyCode);
			});
	}
	setState(e) {
		if (0 != this.updateState)
	...
	bidiSpans(e) {
		...
		let n = (function (e, t, i) {
			if (!e) return [new Po(0, 0, t == bo ? 1 : 0)];
	...
	static forRange(e, t, i) {
		...
		return (function (e, t, i) {
			...
			if (O && m && O.from == m.from && O.to == m.to)
				return b(x(i.from, i.to, O));
			{
				let t = O ? x(i.from, null, O) : v(d, !1),
					n = m ? x(null, i.to, m) : v(p, !0),
					r = [];
				return (
					...
					b(t).concat(r).concat(b(n))
				);
			}
			function g(e, i, n, r) {
				return new ph(t, e - l.left, i - l.top, n - e, r - i);
			}
			function b({ top: e, bottom: t, horizontal: i }) {
				let n = [];
...
class gh {
	...
	update(e) {
		e.startState.facet(bh) != e.state.facet(bh) && this.setOrder(e.state),
...
const bh = Rn.define();
function xh(e) {
	return [ea.define((t) => new gh(t, e)), bh.of(e)];
}
const vh = Rn.define({
	combine: (e) =>
		kr(
			...
			writeMeasure(e) {
				...
				for (let a = 0; a < this.manager.tooltips.length; a++) {
					...
					let d = l.arrow ? h.dom.querySelector(".cm-tooltip-arrow") : null,
						...
						g = h.offset || sc,
						b = this.view.textDirection == mo.LTR,
						x =
					...
					if (
						("absolute" == this.position
							? ((c.style.top = (w - e.parent.top) / s + "px"),
								nc(c, (x - e.parent.left) / r))
							: ((c.style.top = w / s + "px"), nc(c, x / r)),
						d)
					) {
						let e = u.left + (b ? g.x : -g.x) - (x + 14 - 7);
						d.style.left = e / r + "px";
					}
					!0 !== h.overlap &&
						o.push({ left: x, top: w, right: S, bottom: w + m }),
...
const gc = ea.fromClass(
	class {
		constructor(e) {
			...
			(this.top = new bc(e, !0, t.topContainer)),
				(this.bottom = new bc(e, !1, t.bottomContainer)),
		...
		update(e) {
			...
			this.top.container != t.topContainer &&
				(this.top.sync([]), (this.top = new bc(e.view, !0, t.topContainer))),
				this.bottom.container != t.bottomContainer &&
					(this.bottom.sync([]),
					(this.bottom = new bc(e.view, !1, t.bottomContainer))),
		...
		return (function (e) {
			...
			function u(e, t, i, b, x, v) {
				...
				for (; k < 0; ) {
					if ((a.next(), -1 == k)) {
						let t = s[y];
						return i.push(t), void b.push(w - e);
					}
			...
			let b = [],
				x = [];
			for (; a.pos > 0; ) u(e.start || 0, e.bufferStart || 0, b, x, -1, 0);
			let v =
				null !== (t = e.length) && void 0 !== t
					...
					: b.length
						? x[0] + b[0].length
						: 0;
			return new iu(l[e.topID], b.reverse(), x.reverse(), v);
		})(e);
	}
}
...
function xu(e, t, i, n, r, s, o, a, l) {
	let h = 0;
	for (let i = n; i < r; i++) h += bu(e, t[i]);
		...
		(function t(i, n, r, o, a) {
			for (let h = r; h < o; ) {
				...
				if (h == r + 1) {
					...
					u.push(xu(e, i, n, r, h, d, t, null, l));
				}
				f.push(d + a - s);
			}
		})(t, i, n, r, 0),
...
const bd = Rn.define(),
	xd = Rn.define({ combine: (e) => (e.length ? [e[0]] : null) });
function vd(e) {
	let t = e.facet(bd);
...
const Xp = [
	{ key: "Mod-z", run: xp, preventDefault: !0 },
...
class RO {
	...
	peek() {
		...
		return bn(this.buffer, this.bufferPos);
	}
	next() {
...
function FO(e, t, i, n) {
	return !(
		(0 != i && e(t.sliceDoc(i - 1, i)) == xr.Word) ||
		(n != t.doc.length && e(t.sliceDoc(n, n + 1)) == xr.Word)
	);
}
					...
					if (t.wholeWords) {
						if (
							...
							!FO(o, i, s.from, s.to) ||
								!(function (e, t, i, n) {
									return (
										e(t.sliceDoc(i, i + 1)) == xr.Word &&
										e(t.sliceDoc(n - 1, n)) == xr.Word
									);
								})(o, i, s.from, s.to))
						)
							return no.none;
		...
		e.wholeWord
			? (function (e, t) {
					return (i, n, r, s) => (
						...
						!(
							(t(om(r, i - s)) == xr.Word && t(am(r, i - s)) == xr.Word) ||
							(t(am(r, n - s)) == xr.Word && t(om(r, n - s)) == xr.Word)
						)
					);
		...
		e.search,
		{
			...
			test: e.wholeWord
				? ((r = t.charCategorizer(t.selection.main.head)),
					(e, t, i) =>
						!i[0].length ||
						((r(om(i.input, i.index)) != xr.Word ||
							r(am(i.input, i.index)) != xr.Word) &&
							(r(am(i.input, i.index + i[0].length)) != xr.Word ||
								r(om(i.input, i.index + i[0].length)) != xr.Word)))
				: void 0,
		},
		i,
		n,
		...
		(this.commit = this.commit.bind(this)),
			...
			(this.dom = _O(
				...
				[
					...
					i("prev", () => bm(e), [Tm(e, "previous")]),
					i("select", () => xm(e), [Tm(e, "all")]),
	...
	keydown(e) {
		!(function (e, t, i) {
			...
			? 13 == e.keyCode && e.target == this.searchField
				? (e.preventDefault(), (e.shiftKey ? bm : gm)(this.view))
				: 13 == e.keyCode &&
...
function Lm(e, t) {
	return (i) => {
		for (let t = bf(i.state).resolveInner(i.pos, -1); t; t = t.parent) {
...
class Um {
	constructor(e) {
		...
		for (let t = 0; t < e.length; ) {
			...
			let r = e.slice(t, t + n),
				s = r.toUpperCase();
			this.folded.push(bn(s == r ? r.toLowerCase() : s, 0)), (t += n);
		}
	...
	result(e, t, i) {
		let n = [],
			r = 0;
		for (let e of t) {
			let t = e + (this.astral ? vn(bn(i, e)) : 1);
	...
	Gg = Jl.inputHandler.of((e, t, i, n) => {
		...
		let s = (function (e, t) {
			...
			for (let r of n) {
				...
				if (t == r)
					return s == r
						? tb(e, r, n.indexOf(r + r + r) > -1, i)
						: Jg(e, r, s, i.before || Dg.before);
				if (t == s && Fg(e, e.selection.main.from)) return eb(e, r, s);
			}
			return null;
		})(e.state, n);
					...
					r = e.changeByRange((t) => {
						if (t.empty) {
							let n = (function (e, t) {
								...
								return vn(bn(i, 0)) == i.length ? i : i.slice(1);
							})(e.doc, t.head);
							for (let r of i)
								if (r == n && Kg(e.doc, t.head) == Ig(bn(r, 0)))
									return {
	...
	let r = n.stringPrefixes || Dg.stringPrefixes,
		...
		o = e.changeByRange((n) => {
			...
			if (l == t) {
				...
				if (
					e.charCategorizer(a)(l) != xr.Word &&
					nb(e, a, r) > -1 &&
					!(function (e, t, i, n) {
						let r = bf(e).resolveInner(t, -1),
...
function ib(e, t) {
	let i = bf(e).resolveInner(t + 1);
	return i.parent && i.from == t;
}
function nb(e, t, i) {
	let n = e.charCategorizer(t);
	if (n(e.sliceDoc(t - 1, t)) != xr.Word) return t;
	for (let r of i) {
		let i = t - r.length;
		if (e.sliceDoc(i, t) == r && n(e.sliceDoc(i - 1, i)) != xr.Word) return i;
	}
	return -1;
}
function rb(e = {}) {
	return [wg, pg, Hm.of(e), vg, ob, Sg];
}
const sb = [
		{ key: "Ctrl-Space", run: bg },
		{ mac: "Alt-`", run: bg },
		{
			key: "Escape",
			run: (e) => {
	...
	ob = Un.highest(
		ah.computeN([Hm], (e) => (e.facet(Hm).defaultKeymap ? [sb] : [])),
	);
class ab {
	constructor(e, t, i) {
	...
	static init(e, t, i) {
		...
		for (let e = 0; ; ) {
			...
			if (
				...
				s.add(t, t, no.widget({ widget: new wb(h), diagnostics: o.slice() }));
			else {
				let e = o.reduce(
		...
		let l = s.finish();
		return new lb(l, t, hb(l));
	}
}
function hb(e, t = null, i = 0) {
	let n = null;
	return (
		e.between(i, 1e9, (e, i, { spec: r }) => {
			if (!(t && r.diagnostics.indexOf(t) < 0))
				if (n) {
					...
					n = new ab(n.from, i, n.diagnostic);
				} else n = new ab(e, i, t || r.diagnostics[0]);
		}),
		n
	);
}
const cb = ur.define(),
	...
	fb = ur.define(),
	db = Wn.define({
		create: () => new lb(no.none, null, null),
		update(e, t) {
			if (t.docChanged && e.diagnostics.size) {
				...
				if (e.selected) {
					...
					n = hb(i, e.selected.diagnostic, r) || hb(i, null, r);
				}
				!i.size && r && t.state.facet(xb).autoPanel && (r = null),
					(e = new lb(i, r, n));
			}
			for (let i of t.effects)
				if (i.is(cb)) {
					let n = t.state.facet(xb).autoPanel
						? i.value.length
							? kb.open
							: null
						: e.panel;
					e = lb.init(i.value, n, t.state);
				} else
					i.is(ub)
						? (e = new lb(e.diagnostics, i.value ? kb.open : null, e.selected))
						: i.is(fb) && (e = new lb(e.diagnostics, e.panel, i.value));
			return e;
		},
		provide: (e) => [
			vc.from(e, (e) => e.panel),
	...
	pb = no.mark({ class: "cm-lintRange cm-lintRange-active" });
function Ob(e, t, i) {
	let n,
		{ diagnostics: r } = e.state.field(db),
		s = -1,
		o = -1;
	...
	let a = e.state.facet(xb).tooltipFilter;
	return (
		n && a && (n = a(n, e.state)),
		n
			? {
...
const gb = (e) => {
		let t = e.state.field(db, !1);
		return !(!t || !t.panel) && (e.dispatch({ effects: ub.of(!1) }), !0);
	},
	bb = [
		{
			key: "Mod-Shift-m",
				...
				(t && t.panel) ||
					e.dispatch({
						effects:
							((i = e.state),
							(n = [ub.of(!0)]),
							i.field(db, !1) ? n : n.concat(ur.appendConfig.of(Cb))),
					});
				let r = mc(e, kb.open);
			...
			: n.map((i, n) => {
					let s = !1,
						o = (n) => {
							...
							s = !0;
							let r = hb(e.state.field(db).diagnostics, t);
...
class kb {
	constructor(e) {
		...
		(this.list = _O("ul", {
			...
			onkeydown: (t) => {
				if (27 == t.keyCode) gb(this.view), this.view.focus();
						...
						return;
					{
						...
						for (let r = 0; r < n.length; r++)
							if (n[r].toUpperCase().charCodeAt(0) == t.keyCode) {
								let t = hb(this.view.state.field(db).diagnostics, i);
	...
	get selectedIndex() {
		let e = this.view.state.field(db).selected;
		if (!e) return -1;
		for (let t = 0; t < this.items.length; t++)
	...
	update() {
		let { diagnostics: e, selected: t } = this.view.state.field(db),
			i = 0,
			n = !1,
			r = null,
			s = new Set();
		for (
			e.between(0, this.view.state.doc.length, (e, o, { spec: a }) => {
				for (let e of a.diagnostics) {
					...
					a < 0
						? ((o = new Sb(this.view, e)), this.items.splice(i, 0, o), (n = !0))
						: ((o = this.items[a]),
	...
	moveSelection(e) {
		...
		let t = hb(this.view.state.field(db).diagnostics, this.items[e].diagnostic);
		t &&
			this.view.dispatch({
...
const Pb = Jl.baseTheme({
	...
	".cm-lintRange-error": { backgroundImage: Qb("#d11") },
	".cm-lintRange-warning": { backgroundImage: Qb("orange") },
	".cm-lintRange-info": { backgroundImage: Qb("#999") },
	".cm-lintRange-hint": { backgroundImage: Qb("#66d") },
...
const Cb = [
		db,
		Jl.decorations.compute([db], (e) => {
			let { selected: t, panel: i } = e.field(db);
			return t && i && t.from != t.to
				? no.set([pb.range(t.from, t.to)])
				: no.none;
		}),
		fc(Ob, {
			hideOn: function (e, t) {
				let i = t.pos,
					n = t.end || i,
					r = e.state.facet(xb).hideOn(e, i, n);
				if (null != r) return r;
				let s = e.startState.doc.lineAt(t.pos);
				return !(
					!e.effects.some((e) => e.is(cb)) &&
	...
	Tb = (() => [
		...
		Wh,
		[JO, KO],
		ah.of([...Hg, ...AO, ...Zm, ...Xp, ...od, ...sb, ...bb]),
	])();
class Ab {
	static create(e, t, i, n, r) {
		return new Ab(e, t, i, (n + (n << 8) + e + (t << 4)) | 0, r, [], []);
	}
	constructor(e, t, i, n, r, s, o) {
		(this.type = e),
			(this.value = t),
...
function Rb(e, t, i) {
	...
	let n = (e.type == _b.OrderedList ? Yb : Bb)(i, t, !1);
	return (
		n > 0 &&
		(e.type != _b.BulletList || Wb(i, t, !1) < 0) &&
...
const Eb = {
	[_b.Blockquote]: (e, t, i) =>
		62 == i.next &&
		(i.markers.push(
			xx(_b.QuoteMark, t.lineStart + i.pos, t.lineStart + i.pos + 1),
		),
		i.moveBase(i.pos + (jb(i.text.charCodeAt(i.pos + 1)) ? 2 : 1)),
...
function qb(e, t = 0) {
	for (; t < e.length && jb(e.charCodeAt(t)); ) t++;
	return t;
}
function Lb(e, t, i) {
	for (; t > i && jb(e.charCodeAt(t - 1)); ) t--;
	return t;
}
function Vb(e) {
...
function Wb(e, t, i) {
	...
	for (let t = e.pos + 1; t < e.text.length; t++) {
		...
		if (i == e.next) n++;
		else if (!jb(i)) return -1;
	}
	return (i &&
		45 == e.next &&
		Nb(e) > -1 &&
		e.depth == t.stack.length &&
		t.parser.leafBlockParsers.indexOf(sx.SetextHeading) > -1) ||
		n < 3
		? -1
		: 1;
}
...
function Bb(e, t, i) {
	return (45 != e.next && 43 != e.next && 42 != e.next) ||
		(e.pos != e.text.length - 1 && !jb(e.text.charCodeAt(e.pos + 1))) ||
		!(!i || zb(t, _b.BulletList) || e.skipSpace(e.pos + 2) < e.text.length)
		? -1
		: 1;
}
function Yb(e, t, i) {
	...
	return n == e.pos ||
		n > e.pos + 9 ||
		(46 != r && 41 != r) ||
		(n < e.text.length - 1 && !jb(e.text.charCodeAt(n + 1))) ||
		(i &&
			!zb(t, _b.OrderedList) &&
...
function Nb(e) {
	...
	for (; t < e.text.length && e.text.charCodeAt(t) == e.next; ) t++;
	let i = t;
	for (; t < e.text.length && jb(e.text.charCodeAt(t)); ) t++;
...
function Kb(e, t, i) {
	...
	for (let e = 0, t = Fb.length - (i ? 1 : 0); e < t; e++)
		if (Fb[e][0].test(n)) return e;
	return -1;
}
function Jb(e, t) {
...
function ex(e, t, i) {
	let n = e.length - 1;
	n >= 0 && e[n].to == t && e[n].type == _b.CodeText
		? (e[n].to = i)
		: e.push(xx(_b.CodeText, t, i));
}
const tx = {
	...
	IndentedCode(e, t) {
		...
		let n = t.findColumn(i),
			...
			o = [],
			a = [];
		for (ex(o, r, s); e.nextLine() && t.depth >= e.stack.length; )
			if (t.pos == t.text.length) {
				ex(a, e.lineStart - 1, e.lineStart);
				...
				if (t.indent < i) break;
				{
					if (a.length) {
						for (let e of a)
							e.type == _b.CodeText ? ex(o, e.from, e.to) : o.push(e);
						a = [];
					}
					ex(o, e.lineStart - 1, e.lineStart);
		...
		return (
			a.length &&
				((a = a.filter((e) => e.type != _b.CodeText)),
				a.length && (t.markers = a.concat(t.markers))),
			e.addNode(e.buffer.writeElements(o, -r).finish(_b.CodeBlock, s - r), r),
			!0
		);
	},
	FencedCode(e, t) {
		...
		let n = e.lineStart + t.pos,
			...
			s = i - t.pos,
			o = t.skipSpace(i),
			a = Lb(t.text, t.text.length, o),
			l = [xx(_b.CodeMark, n, n + s)];
		o < a && l.push(xx(_b.CodeInfo, e.lineStart + o, e.lineStart + a));
		for (let i = !0; e.nextLine() && t.depth >= e.stack.length; i = !1) {
			...
			if (n - t.pos >= s && t.skipSpace(n) == t.text.length) {
				...
				l.push(xx(_b.CodeMark, e.lineStart + t.pos, e.lineStart + n)),
					e.nextLine();
				break;
			}
			{
				i || ex(l, e.lineStart - 1, e.lineStart);
				for (let e of t.markers) l.push(e);
		...
		return (
			e.addNode(
				e.buffer
					.writeElements(l, -n)
					.finish(_b.FencedCode, e.prevLineEnd() - n),
				n,
			),
			!0
		);
	...
	Blockquote(e, t) {
		...
		return (
			!(i < 0) &&
			(e.startContext(_b.Blockquote, t.pos),
			e.addNode(_b.QuoteMark, e.lineStart + t.pos, e.lineStart + t.pos + 1),
			t.moveBase(t.pos + i),
			null)
		);
	},
	HorizontalRule(e, t) {
		if (Wb(t, e, !1) < 0) return !1;
		let i = e.lineStart + t.pos;
		return e.nextLine(), e.addNode(_b.HorizontalRule, i), !0;
	},
	BulletList(e, t) {
		let i = Bb(t, e, !1);
		if (i < 0) return !1;
		e.block.type != _b.BulletList &&
			e.startContext(_b.BulletList, t.basePos, t.next);
		let n = Jb(t, t.pos + 1);
		return (
			e.startContext(_b.ListItem, t.basePos, n - t.baseIndent),
			e.addNode(_b.ListMark, e.lineStart + t.pos, e.lineStart + t.pos + i),
			t.moveBaseColumn(n),
			null
		);
	},
	...
	ATXHeading(e, t) {
		...
		let n = t.pos,
			r = e.lineStart + n,
			s = Lb(t.text, t.text.length, n),
			o = s;
		for (; o > n && t.text.charCodeAt(o - 1) == t.next; ) o--;
		(o != s && o != n && jb(t.text.charCodeAt(o - 1))) || (o = t.text.length);
		let a = e.buffer
			.write(_b.HeaderMark, 0, i)
			.writeElements(
				e.parser.parseInline(t.text.slice(n + i + 1, o), r + i + 1),
				-r,
			);
		o < t.text.length && a.write(_b.HeaderMark, o - n, s - n);
		let l = a.finish(_b.ATXHeading1 - 1 + i, t.text.length - n);
...
class ix {
	...
	finish(e, t) {
		return (
			...
			qb(t.content, this.pos) == t.content.length &&
	...
	complete(e, t, i) {
		return (
			e.addLeafElement(
				t,
				xx(_b.LinkReference, this.start, this.start + i, this.elts),
			),
			!0
		);
	}
	...
	advance(e) {
		for (;;) {
			if (-1 == this.stage) return -1;
			if (0 == this.stage) {
				if (!this.nextStage(Ax(e, this.pos, this.start, !0))) return -1;
				if (58 != e.charCodeAt(this.pos)) return (this.stage = -1);
				this.elts.push(
					xx(_b.LinkMark, this.pos + this.start, this.pos + this.start + 1),
				),
					this.pos++;
			} else {
				if (1 != this.stage) {
					if (2 == this.stage) {
						let t = qb(e, this.pos),
							i = 0;
						if (t > this.pos) {
							let n = Tx(e, t, this.start);
							if (n) {
								let t = nx(e, n.to - this.start);
								t > 0 && (this.nextStage(n), (i = t));
							}
						}
						return i || (i = nx(e, this.pos)), i > 0 && i < e.length ? i : -1;
					}
					return nx(e, this.pos);
				}
				if (!this.nextStage(Cx(e, qb(e, this.pos), this.start))) return -1;
			}
		}
	}
}
...
class rx {
	nextLine(e, t, i) {
		let n = t.depth < e.stack.length ? -1 : Nb(t),
			r = t.next;
		if (n < 0) return !1;
		let s = xx(_b.HeaderMark, e.lineStart + t.pos, e.lineStart + n);
		return (
			e.nextLine(),
			e.addLeafElement(
				i,
				xx(
					61 == r ? _b.SetextHeading1 : _b.SetextHeading2,
					i.start,
					e.prevLineEnd(),
...
const sx = {
		LinkReference: (e, t) => (91 == t.content.charCodeAt(0) ? new ix(t) : null),
		SetextHeading: () => new rx(),
	},
	ox = [
		(e, t) => Ib(t) >= 0,
		(e, t) => Vb(t) >= 0,
...
class lx {
		...
		(this.parser = e),
			...
			(this.lineStart =
				...
				this.absoluteLineEnd =
					n[0].from),
			(this.block = Ab.create(_b.Document, 0, this.lineStart, 0, 0)),
			(this.stack = [this.block]),
			(this.fragments = i.length ? new Rx(i, t) : null),
			this.readLine();
	}
	get parsedPos() {
	...
	advance() {
		...
		let t = new Mb(this.lineStart + e.pos, e.text.slice(e.pos));
	...
	reuseFragment(e) {
		...
		return (
			...
			(this.lineStart = Ex(this.absoluteLineStart, this.ranges)),
			this.moveRangeI(),
	...
	readLine() {
		...
		for (
			...
			if (!i) throw new Error("Unhandled block context " + _b[t.type]);
			if (!i(t, this, e)) break;
			e.forward();
		}
	}
	...
	addLeafElement(e, t) {
		this.addNode(
			this.buffer
				.writeElements(Mx(t.children, e.marks), -t.from)
	...
	finishLeaf(e) {
		...
		let t = Mx(this.parser.parseInline(e.content, e.start), e.marks);
		this.addNode(
			this.buffer
				.writeElements(t, -e.start)
				.finish(_b.Paragraph, e.content.length),
			e.start,
		);
	}
	elt(e, t, i, n) {
		return "string" == typeof e
			? xx(this.parser.getNodeType(e), t, i, n)
			: new bx(e, t);
	}
	get buffer() {
		return new mx(this.parser.nodeSet);
	}
}
function hx(e, t, i, n, r) {
	let s = e[t].to,
		o = [],
		a = [],
		l = i.from + n;
...
class cx extends wu {
	...
	configure(e) {
			...
			for (let i of t.defineNodes) {
				...
				let l = r.length,
					h = o
						? ["Block", "BlockContext"]
						: s
							? l >= _b.ATXHeading1 && l <= _b.SetextHeading2
		...
		if ((ux(t.props) && (i = i.extend(...t.props)), ux(t.remove)))
		...
		return t.wrap && (c = c.concat(t.wrap)), new cx(i, r, s, o, h, n, a, l, c);
	}
	getNodeType(e) {
		...
		props:
			t >= _b.Escape
				...
				: [
						[
							Uc.group,
							t in Eb ? ["Block", "BlockContext"] : ["Block", "LeafBlock"],
						],
					],
		top: "Document" == e,
	});
...
function xx(e, t, i, n) {
	return new gx(e, t, i, n);
}
const vx = { resolve: "Emphasis", mark: "EmphasisMark" },
	yx = { resolve: "Emphasis", mark: "EmphasisMark" },
	wx = {},
	Sx = {};
class kx {
	constructor(e, t, i, n) {
...
const $x = {
	Escape(e, t, i) {
		...
		let n = e.char(i + 1);
		for (let t = 0; t < 32; t++)
			if (Qx.charCodeAt(t) == n) return e.append(xx(_b.Escape, i, i + 2));
		return -1;
	},
	Entity(e, t, i) {
		if (38 != t) return -1;
		let n = /^(?:#\d+|#x[a-f\d]+|\w+);/i.exec(e.slice(i + 1, i + 31));
		return n ? e.append(xx(_b.Entity, i, i + 1 + n[0].length)) : -1;
	},
	InlineCode(e, t, i) {
		...
		for (; n < e.end; n++)
			if (96 == e.char(n)) {
				if ((s++, s == r && 96 != e.char(n + 1)))
					return e.append(
						xx(_b.InlineCode, i, n + 1, [
							xx(_b.CodeMark, i, i + r),
							xx(_b.CodeMark, n + 1 - r, n + 1),
						]),
					);
			} else s = 0;
		return -1;
	...
	HTMLTag(e, t, i) {
		...
		if (r)
			return e.append(
				xx(_b.Autolink, i, i + 1 + r[0].length, [
					xx(_b.LinkMark, i, i + 1),
					xx(_b.URL, i + 1, i + r[0].length),
					xx(_b.LinkMark, i + r[0].length, i + 1 + r[0].length),
				]),
			);
		let s = /^!--[^>](?:-[^-]|[^-])*?-->/i.exec(n);
		if (s) return e.append(xx(_b.Comment, i, i + 1 + s[0].length));
		let o = /^\?[^]*?\?>/.exec(n);
		if (o)
			return e.append(xx(_b.ProcessingInstruction, i, i + 1 + o[0].length));
		let a =
			/^(?:![A-Z][^]*?>|!\[CDATA\[[^]*?\]\]>|\/\s*[a-zA-Z][\w-]*\s*>|\s*[a-zA-Z][\w-]*(\s+[a-zA-Z:_][\w-.:]*(?:\s*=\s*(?:[^\s"'=<>`]+|'[^']*'|"[^"]*"))?)*\s*(\/\s*)?>)/.exec(
				n,
			);
		return a ? e.append(xx(_b.HTMLTag, i, i + 1 + a[0].length)) : -1;
	},
	Emphasis(e, t, i) {
		...
		let r = e.slice(i - 1, i),
			...
			f = c && (42 == t || !u || o),
			d = u && (42 == t || !c || a);
		return e.append(new kx(95 == t ? vx : yx, i, n, (f ? 1 : 0) | (d ? 2 : 0)));
	},
	HardBreak(e, t, i) {
		if (92 == t && 10 == e.char(i + 1))
			return e.append(xx(_b.HardBreak, i, i + 2));
		if (32 == t) {
			let t = i + 1;
			for (; 32 == e.char(t); ) t++;
			if (10 == e.char(t) && t >= i + 2)
				return e.append(xx(_b.HardBreak, i, t + 1));
		}
		return -1;
	},
	Link: (e, t, i) => (91 == t ? e.append(new kx(wx, i, i + 1, 1)) : -1),
	Image: (e, t, i) =>
		33 == t && 91 == e.char(i + 1) ? e.append(new kx(Sx, i, i + 2, 1)) : -1,
	LinkEnd(e, t, i) {
		if (93 != t) return -1;
		for (let t = e.parts.length - 1; t >= 0; t--) {
			let n = e.parts[t];
			if (n instanceof kx && (n.type == wx || n.type == Sx)) {
				if (
					!n.side ||
				...
				if (n.type == wx)
					for (let i = 0; i < t; i++) {
						let t = e.parts[i];
						t instanceof kx && t.type == wx && (t.side = 0);
					}
				return s.to;
			}
		}
...
function Zx(e, t, i, n, r) {
	let { text: s } = e,
		o = e.char(r),
		a = r;
	if (
		(t.unshift(xx(_b.LinkMark, n, n + (i == _b.Image ? 2 : 1))),
		t.push(xx(_b.LinkMark, r - 1, r)),
		40 == o)
	) {
		let i,
			n = e.skipSpace(r + 1),
			o = Cx(s, n - e.offset, e.offset);
		o &&
			((n = e.skipSpace(o.to)),
			n != o.to &&
				((i = Tx(s, n - e.offset, e.offset)), i && (n = e.skipSpace(i.to)))),
			41 == e.char(n) &&
				(t.push(xx(_b.LinkMark, r, r + 1)),
				(a = n + 1),
				o && t.push(o),
				i && t.push(i),
				t.push(xx(_b.LinkMark, n, a)));
	} else if (91 == o) {
		let i = Ax(s, r - e.offset, e.offset, !1);
		i && (t.push(i), (a = i.to));
	}
	return xx(i, n, a, t);
}
function Cx(e, t, i) {
	if (60 == e.charCodeAt(t)) {
		for (let n = t + 1; n < e.length; n++) {
			...
			if (62 == r) return xx(_b.URL, t + i, n + 1 + i);
	...
	}
	{
		...
		return r > t ? xx(_b.URL, t + i, r + i) : r == e.length && null;
	}
}
function Tx(e, t, i) {
	...
	for (let n = t + 1, s = !1; n < e.length; n++) {
		...
		if (s) s = !1;
			...
			if (o == r) return xx(_b.LinkTitle, t + i, n + 1 + i);
			92 == o && (s = !0);
		}
	}
	return null;
...
function Ax(e, t, i, n) {
	for (let r = !1, s = t + 1, o = Math.min(e.length, s + 999); s < o; s++) {
		...
		if (r) r = !1;
			...
			if (93 == o) return !n && xx(_b.LinkLabel, t + i, s + 1 + i);
			if ((n && !jb(o) && (n = !1), 91 == o)) return !1;
			92 == o && (r = !0);
		}
	}
	return null;
...
class _x {
	...
	addDelimiter(e, t, i, n, r) {
		return this.append(new kx(e, t, i, (n ? 1 : 0) | (r ? 2 : 0)));
	}
	get hasOpenLink() {
		for (let e = this.parts.length - 1; e >= 0; e--) {
			let t = this.parts[e];
			if (t instanceof kx && (t.type == wx || t.type == Sx)) return !0;
		}
		return !1;
	}
	addElement(e) {
	...
	resolveMarkers(e) {
		for (let t = e; t < this.parts.length; t++) {
			let i = this.parts[t];
			if (!(i instanceof kx && i.type.resolve && 2 & i.side)) continue;
			let n,
				r = i.type == vx || i.type == yx,
				s = i.to - i.from,
				o = t - 1;
			for (; o >= e; o--) {
				let e = this.parts[o];
			...
			for (let e = o + 1; e < t; e++)
				this.parts[e] instanceof gx && l.push(this.parts[e]),
					(this.parts[e] = null);
			i.type.mark && l.push(this.elt(i.type.mark, i.from, c));
			let u = this.elt(a, h, c, l);
			(this.parts[o] =
				r && n.from != h ? new kx(n.type, n.from, h, n.side) : null),
				(this.parts[t] =
					r && i.to != c ? new kx(i.type, c, i.to, i.side) : null)
	...
	findOpeningDelimiter(e) {
		for (let t = this.parts.length - 1; t >= 0; t--) {
			let i = this.parts[t];
			if (i instanceof kx && i.type == e) return t;
		}
		return null;
	}
	takeContent(e) {
	...
	skipSpace(e) {
		return qb(this.text, e - this.offset) + this.offset;
	}
	elt(e, t, i, n) {
		return "string" == typeof e
			? xx(this.parser.getNodeType(e), t, i, n)
...
function Mx(e, t) {
	...
	for (let e of t) {
		...
		if (n < i.length && i[n].from < e.from) {
			let t = i[n];
			t instanceof gx &&
				(i[n] = new gx(t.type, t.from, t.to, Mx(t.children, [e])));
		} else i.splice(n++, 0, e);
	}
	return i;
}
const Xx = [_b.CodeBlock, _b.ListItem, _b.OrderedList, _b.BulletList];
let Rx = class {
	constructor(e, t) {
		(this.fragments = e),
			(this.input = t),
	...
	takeNodes(e) {
		...
		for (;;) {
			...
			let r = Ex(t.from - i, e.ranges);
			if (t.to - i <= e.ranges[e.rangeI].to) e.addNode(t.tree, r);
			else {
				let i = new iu(
					e.parser.nodeSet.types[_b.Paragraph],
					[],
					[],
					0,
					e.block.hashProp,
...
const jx = Wu({
	...
	qx = new cx(
		new Kc(px).extend(jx),
		Object.keys(tx).map((e) => tx[e]),
		Object.keys(tx).map((e) => sx[e]),
		Object.keys(tx),
		ox,
		Eb,
		Object.keys($x).map((e) => $x[e]),
		Object.keys($x),
		[],
	);
function Lx(e, t, i) {
...
const Vx = { resolve: "Strikethrough", mark: "StrikethroughMark" },
	Dx = {
		defineNodes: [
			{
				name: "Strikethrough",
		...
		if (null == this.rows) {
			...
			if (
				...
				(45 == t.next || 58 == t.next || 124 == t.next) &&
					Bx.test((n = t.text.slice(t.pos))))
			) {
				let r = [];
				Wx(e, i.content, 0, r, i.start) == Wx(e, n, t.pos) &&
					(this.rows = [
			...
			let i = [];
			Wx(e, t.text, t.pos, i, e.lineStart),
				this.rows.push(
					e.elt(
						"TableRow",
						e.lineStart + t.pos,
...
const Ix = {
	...
	parseBlock: [
		{
			name: "Table",
			leaf: (e, t) => (zx(t.content, 0) ? new Yx() : null),
			endLeaf(e, t, i) {
				if (i.parsers.some((e) => e instanceof Yx) || !zx(t.text, t.basePos))
					return !1;
				let n = e.peekLine();
				return Bx.test(n) && Wx(e, t.text, t.basePos) == Wx(e, n, t.basePos);
			},
...
const Ux = {
	...
	Gx = /(www\.)|(https?:\/\/)|([\w.+-]{1,100}@)|(mailto:|xmpp:)/gy,
	Hx = /[\w-]+(\.[\w-]+)+(\/[^\s<]*)?/gy,
	Fx = /[\w-]+\.[\w-]+($|\/)/,
	Kx = /[\w.+-]+@[\w-]+(\.[\w.-]+)+/gy,
	Jx = /\/[a-zA-Z\d@.]+/gy;
					...
					if (r[1] || r[2]) {
						if (
							((s = (function (e, t) {
								Hx.lastIndex = t;
								let i = Hx.exec(e);
								if (!i || Fx.exec(i[0])[0].indexOf("_") > -1) return -1;
								let n = t + i[0].length;
								for (;;) {
									let i,
										r = e[n - 1];
...
function nv(e, t, i) {
	return (n, r, s) => {
		...
		for (let r = s + 1; r < n.end; r++) {
			...
			if ((92 == a && o.push(n.elt("Escape", r, 2 + r++)), jb(a))) break;
		}
		return -1;
	};
}
...
class Ov {
	...
	token(e, t) {
		let { parser: i } = t.p;
		bv(this.data, e, t, this.id, i.data, i.tokenPrecTable);
	}
}
...
class mv {
	...
	token(e, t) {
		...
		for (;;) {
			...
			if (
				(bv(this.data, e, t, 0, this.data, this.precTable), e.token.value > -1)
			)
				break;
...
function nw(e) {
	let t = bf(e.state).resolveInner(e.pos, -1);
...
function sw(e) {
	let t = (t) => e.state.doc.sliceString(t.from, t.to),
		i = bf(e.state).resolveInner(e.pos, -1);
...
function xw(e, t, i) {
	let n = bw(e.line, e.column, t, i),
		r = {
			from: n,
			to:
				null != e.endLine && 1 != e.endColumn
					? bw(e.endLine, e.endColumn, t, i)
					: n,
			message: e.message,
		...
		return (
			...
			(i) => {
				...
				for (let { from: i, to: s } of ow.findRegions(n)) {
					...
					for (let o of e.verify(n.sliceDoc(i, s), t)) r.push(xw(o, n.doc, a));
				}
				return r;
			}
		);
...
const tS = If.of((e, t, i) => {
	for (let n = bf(e).resolveInner(i, -1); n && !(n.from < t); n = n.parent) {
	...
	l.push(
		(function (e) {
			let { codeParser: t, htmlParser: i } = e,
				n = ku((e, n) => {
					let r = e.type.id;
					if (!t || (r != _b.CodeBlock && r != _b.FencedCode)) {
						if (i && (r == _b.HTMLBlock || r == _b.HTMLTag))
							return { parser: i, overlay: Lx(e.node, e.from, e.to) };
					} else {
						let i = "";
						if (r == _b.FencedCode) {
							let t = e.node.getChild(_b.CodeInfo);
							t && (i = n.read(t.from, t.to));
						}
						let s = t(i);
						if (s)
							return { parser: s, overlay: (e) => e.type.id == _b.CodeText };
					}
					return null;
				});
			return { wrap: n };
...
function wS(e) {
	return import("./chunks/index.BSKeQiaL.js").then((t) =>
		t.sql({ dialect: t[e] }),
	);
}
const SS = [
		Cf.of({
			name: "C",
			extensions: ["c", "h", "ino"],
			load: () => import("./chunks/index.BtH4JJcj.js").then((e) => e.cpp()),
		}),
		Cf.of({
			name: "C++",
			alias: ["cpp"],
		...
		Cf.of({
			name: "Go",
			extensions: ["go"],
			load: () => import("./chunks/index.1q-J1ARa.js").then((e) => e.go()),
		}),
		Cf.of({
			name: "HTML",
			alias: ["xhtml"],
		...
		Cf.of({
			name: "Java",
			extensions: ["java"],
			load: () => import("./chunks/index.NTg2y4TW.js").then((e) => e.java()),
		}),
		Cf.of({
			name: "JavaScript",
		...
		Cf.of({
			...
			alias: ["json5"],
			extensions: ["json", "map"],
			load: () => import("./chunks/index.ChK_kOGN.js").then((e) => e.json()),
		}),
		Cf.of({
			name: "JSX",
			extensions: ["jsx"],
		...
		Cf.of({
			name: "LESS",
			extensions: ["less"],
			load: () => import("./chunks/index.Iz6ysoWJ.js").then((e) => e.less()),
		}),
		Cf.of({
			name: "Liquid",
			extensions: ["liquid"],
			load: () => import("./chunks/index.B-68qOo9.js").then((e) => e.liquid()),
		}),
		...
		Cf.of({
			...
			load: () => import("./chunks/index.BowEETBG.js").then((e) => e.php()),
		}),
		...
		Cf.of({
			...
			filename: /^(BUCK|BUILD)$/,
			load: () => import("./chunks/index.CnRuzwKj.js").then((e) => e.python()),
		}),
		Cf.of({
			name: "Rust",
			extensions: ["rs"],
			load: () => import("./chunks/index.BN068G42.js").then((e) => e.rust()),
		}),
		Cf.of({
			name: "Sass",
			extensions: ["sass"],
			load: () =>
				import("./chunks/index.BTtyJfkt.js").then((e) =>
					e.sass({ indented: !0 }),
				),
		}),
		Cf.of({
			name: "SCSS",
			extensions: ["scss"],
			load: () => import("./chunks/index.BTtyJfkt.js").then((e) => e.sass()),
		}),
		...
		Cf.of({
			name: "WebAssembly",
			extensions: ["wat", "wast"],
			load: () => import("./chunks/index.DUu2H61H.js").then((e) => e.wast()),
		}),
		Cf.of({
			name: "XML",
			alias: ["rss", "wsdl", "xsd"],
			extensions: ["xml", "xsl", "xsd", "svg"],
			load: () => import("./chunks/index.CuJoR5B4.js").then((e) => e.xml()),
		}),
		Cf.of({
			name: "YAML",
			alias: ["yml"],
			extensions: ["yaml", "yml"],
			load: () => import("./chunks/index.CQQjoZnj.js").then((e) => e.yaml()),
		}),
		Cf.of({
			name: "APL",
			extensions: ["dyalog", "apl"],
			load: () => import("./chunks/apl.CoYkLPXx.js").then((e) => yS(e.apl)),
		}),
		Cf.of({
			name: "PGP",
			alias: ["asciiarmor"],
			...
			load: () =>
				import("./chunks/asciiarmor.DIAkHhl9.js").then((e) => yS(e.asciiArmor)),
		}),
		Cf.of({
			name: "ASN.1",
			extensions: ["asn", "asn1"],
			load: () =>
				import("./chunks/asn1.Cu3_oVX0.js").then((e) => yS(e.asn1({}))),
		}),
		Cf.of({
			name: "Asterisk",
			filename: /^extensions\.conf$/i,
			load: () =>
				import("./chunks/asterisk.7Hg-6yDM.js").then((e) => yS(e.asterisk)),
		}),
		Cf.of({
			name: "Brainfuck",
			extensions: ["b", "bf"],
			load: () =>
				import("./chunks/brainfuck.B4XeytA5.js").then((e) => yS(e.brainfuck)),
		}),
		Cf.of({
			name: "Cobol",
			extensions: ["cob", "cpy"],
			load: () => import("./chunks/cobol.wFpzvcC1.js").then((e) => yS(e.cobol)),
		}),
		Cf.of({
			name: "C#",
			alias: ["csharp", "cs"],
			extensions: ["cs"],
			load: () =>
				import("./chunks/clike.DtMo_rcW.js").then((e) => yS(e.csharp)),
		}),
		Cf.of({
			name: "Clojure",
			extensions: ["clj", "cljc", "cljx"],
			load: () =>
				import("./chunks/clojure.DMZvuCLl.js").then((e) => yS(e.clojure)),
		}),
		Cf.of({
			name: "ClojureScript",
			extensions: ["cljs"],
		...
		Cf.of({
			...
			extensions: ["gss"],
			load: () => import("./chunks/css.2QFlDmTq.js").then((e) => yS(e.gss)),
		}),
		Cf.of({
			name: "CMake",
			extensions: ["cmake", "cmake.in"],
			filename: /^CMakeLists\.txt$/,
			load: () => import("./chunks/cmake.D2clZDVj.js").then((e) => yS(e.cmake)),
		}),
		Cf.of({
			name: "CoffeeScript",
			...
			extensions: ["coffee"],
			load: () =>
				import("./chunks/coffeescript.CjOFjIyE.js").then((e) =>
					yS(e.coffeeScript),
				),
		}),
		Cf.of({
			...
			load: () =>
				import("./chunks/commonlisp.DWo4xKNo.js").then((e) => yS(e.commonLisp)),
		}),
		Cf.of({
			name: "Cypher",
			extensions: ["cyp", "cypher"],
			load: () =>
				import("./chunks/cypher.CU4T17lF.js").then((e) => yS(e.cypher)),
		}),
		Cf.of({
			name: "Cython",
			extensions: ["pyx", "pxd", "pxi"],
			load: () =>
				import("./chunks/python.CS84Zfvc.js").then((e) => yS(e.cython)),
		}),
		Cf.of({
			name: "Crystal",
			extensions: ["cr"],
			load: () =>
				import("./chunks/crystal.Dmxk9nS7.js").then((e) => yS(e.crystal)),
		}),
		Cf.of({
			name: "D",
			extensions: ["d"],
			load: () => import("./chunks/d.BFWmQ61I.js").then((e) => yS(e.d)),
		}),
		Cf.of({
			name: "Dart",
			extensions: ["dart"],
			load: () => import("./chunks/clike.DtMo_rcW.js").then((e) => yS(e.dart)),
		}),
		Cf.of({
			name: "diff",
			extensions: ["diff", "patch"],
			load: () => import("./chunks/diff.BsKiEusU.js").then((e) => yS(e.diff)),
		}),
		Cf.of({
			name: "Dockerfile",
			filename: /^Dockerfile$/,
			load: () =>
				import("./chunks/dockerfile.BZoq1TSI.js").then((e) => yS(e.dockerFile)),
		}),
		Cf.of({
			name: "DTD",
			extensions: ["dtd"],
			load: () => import("./chunks/dtd.DWPrqkNR.js").then((e) => yS(e.dtd)),
		}),
		Cf.of({
			name: "Dylan",
			extensions: ["dylan", "dyl", "intr"],
			load: () => import("./chunks/dylan.DwzpE3S3.js").then((e) => yS(e.dylan)),
		}),
		Cf.of({
			name: "EBNF",
			load: () => import("./chunks/ebnf.DLffYbvO.js").then((e) => yS(e.ebnf)),
		}),
		Cf.of({
			name: "ECL",
			extensions: ["ecl"],
			load: () => import("./chunks/ecl.oP4gfeMO.js").then((e) => yS(e.ecl)),
		}),
		Cf.of({
			name: "edn",
			extensions: ["edn"],
		...
		Cf.of({
			...
			extensions: ["e"],
			load: () =>
				import("./chunks/eiffel.BnviB2bR.js").then((e) => yS(e.eiffel)),
		}),
		Cf.of({
			name: "Elm",
			extensions: ["elm"],
			load: () => import("./chunks/elm.oFb72QPz.js").then((e) => yS(e.elm)),
		}),
		Cf.of({
			name: "Erlang",
			extensions: ["erl"],
			load: () =>
				import("./chunks/erlang.BtXX2BD5.js").then((e) => yS(e.erlang)),
		}),
		Cf.of({
			name: "Esper",
			load: () => import("./chunks/sql.D0tCVmkR.js").then((e) => yS(e.esper)),
		}),
		Cf.of({
			name: "Factor",
			extensions: ["factor"],
			load: () =>
				import("./chunks/factor.D9ayrqzU.js").then((e) => yS(e.factor)),
		}),
		Cf.of({
			name: "FCL",
			load: () => import("./chunks/fcl.igGoMLNw.js").then((e) => yS(e.fcl)),
		}),
		Cf.of({
			name: "Forth",
			extensions: ["forth", "fth", "4th"],
			load: () => import("./chunks/forth.cxVjVubu.js").then((e) => yS(e.forth)),
		}),
		Cf.of({
			name: "Fortran",
			extensions: ["f", "for", "f77", "f90", "f95"],
			load: () =>
				import("./chunks/fortran.DhvqekKU.js").then((e) => yS(e.fortran)),
		}),
		Cf.of({
			name: "F#",
			alias: ["fsharp"],
			extensions: ["fs"],
			load: () =>
				import("./chunks/mllike.CjeCnh_w.js").then((e) => yS(e.fSharp)),
		}),
		Cf.of({
			name: "Gas",
			extensions: ["s"],
			load: () => import("./chunks/gas.DbMmUTwC.js").then((e) => yS(e.gas)),
		}),
		Cf.of({
			name: "Gherkin",
			extensions: ["feature"],
			load: () =>
				import("./chunks/gherkin.BYtqUz2D.js").then((e) => yS(e.gherkin)),
		}),
		Cf.of({
			name: "Groovy",
			...
			load: () =>
				import("./chunks/groovy.B5QNFcUr.js").then((e) => yS(e.groovy)),
		}),
		Cf.of({
			name: "Haskell",
			extensions: ["hs"],
			load: () =>
				import("./chunks/haskell.ColH7b0X.js").then((e) => yS(e.haskell)),
		}),
		Cf.of({
			name: "Haxe",
			extensions: ["hx"],
			load: () => import("./chunks/haxe.DS-YFbic.js").then((e) => yS(e.haxe)),
		}),
		Cf.of({
			name: "HXML",
			extensions: ["hxml"],
			load: () => import("./chunks/haxe.DS-YFbic.js").then((e) => yS(e.hxml)),
		}),
		Cf.of({
			name: "HTTP",
			load: () => import("./chunks/http.BO6w3GKc.js").then((e) => yS(e.http)),
		}),
		Cf.of({
			name: "IDL",
			extensions: ["pro"],
			load: () => import("./chunks/idl.DJSzRZnd.js").then((e) => yS(e.idl)),
		}),
		Cf.of({
			name: "JSON-LD",
			alias: ["jsonld"],
			extensions: ["jsonld"],
			load: () =>
				import("./chunks/javascript.BkcyunWm.js").then((e) => yS(e.jsonld)),
		}),
		Cf.of({
			name: "Jinja2",
			extensions: ["j2", "jinja", "jinja2"],
			load: () =>
				import("./chunks/jinja2.DNfBzfaY.js").then((e) => yS(e.jinja2)),
		}),
		Cf.of({
			name: "Julia",
			extensions: ["jl"],
			load: () => import("./chunks/julia.DH7GyxIm.js").then((e) => yS(e.julia)),
		}),
		Cf.of({
			name: "Kotlin",
			extensions: ["kt", "kts"],
			load: () =>
				import("./chunks/clike.DtMo_rcW.js").then((e) => yS(e.kotlin)),
		}),
		Cf.of({
			name: "LiveScript",
			alias: ["ls"],
			extensions: ["ls"],
			load: () =>
				import("./chunks/livescript.CMzoSIaa.js").then((e) => yS(e.liveScript)),
		}),
		Cf.of({
			name: "Lua",
			extensions: ["lua"],
			load: () => import("./chunks/lua.DIkee9ES.js").then((e) => yS(e.lua)),
		}),
		Cf.of({
			name: "mIRC",
			extensions: ["mrc"],
			load: () => import("./chunks/mirc.BnlZQcfY.js").then((e) => yS(e.mirc)),
		}),
		Cf.of({
			name: "Mathematica",
			extensions: ["m", "nb", "wl", "wls"],
			load: () =>
				import("./chunks/mathematica.CJGpvUvv.js").then((e) =>
					yS(e.mathematica),
				),
		}),
		Cf.of({
			...
			extensions: ["mo"],
			load: () =>
				import("./chunks/modelica.DjOhfe42.js").then((e) => yS(e.modelica)),
		}),
		Cf.of({
			name: "MUMPS",
			extensions: ["mps"],
			load: () => import("./chunks/mumps.DKlpSWqD.js").then((e) => yS(e.mumps)),
		}),
		Cf.of({
			name: "Mbox",
			extensions: ["mbox"],
			load: () => import("./chunks/mbox.CiO3cwEL.js").then((e) => yS(e.mbox)),
		}),
		Cf.of({
			name: "Nginx",
			filename: /nginx.*\.conf$/i,
			load: () => import("./chunks/nginx.CLFCqIac.js").then((e) => yS(e.nginx)),
		}),
		Cf.of({
			name: "NSIS",
			extensions: ["nsh", "nsi"],
			load: () => import("./chunks/nsis.CU3xU27D.js").then((e) => yS(e.nsis)),
		}),
		Cf.of({
			name: "NTriples",
			extensions: ["nt", "nq"],
			load: () =>
				import("./chunks/ntriples.7lTnIsdJ.js").then((e) => yS(e.ntriples)),
		}),
		Cf.of({
			name: "Objective-C",
			...
			extensions: ["m"],
			load: () =>
				import("./chunks/clike.DtMo_rcW.js").then((e) => yS(e.objectiveC)),
		}),
		Cf.of({
			name: "Objective-C++",
			alias: ["objective-c++", "objc++"],
			extensions: ["mm"],
			load: () =>
				import("./chunks/clike.DtMo_rcW.js").then((e) => yS(e.objectiveCpp)),
		}),
		Cf.of({
			name: "OCaml",
			extensions: ["ml", "mli", "mll", "mly"],
			load: () =>
				import("./chunks/mllike.CjeCnh_w.js").then((e) => yS(e.oCaml)),
		}),
		Cf.of({
			name: "Octave",
			extensions: ["m"],
			load: () =>
				import("./chunks/octave.DE6q16sJ.js").then((e) => yS(e.octave)),
		}),
		Cf.of({
			name: "Oz",
			extensions: ["oz"],
			load: () => import("./chunks/oz.BpLcoBqU.js").then((e) => yS(e.oz)),
		}),
		Cf.of({
			name: "Pascal",
			extensions: ["p", "pas"],
			load: () =>
				import("./chunks/pascal.Ci-RgUK1.js").then((e) => yS(e.pascal)),
		}),
		Cf.of({
			name: "Perl",
			extensions: ["pl", "pm"],
			load: () => import("./chunks/perl.DBUTCC9E.js").then((e) => yS(e.perl)),
		}),
		Cf.of({
			name: "Pig",
			extensions: ["pig"],
			load: () => import("./chunks/pig.MqEbsLTj.js").then((e) => yS(e.pig)),
		}),
		Cf.of({
			name: "PowerShell",
			extensions: ["ps1", "psd1", "psm1"],
			load: () =>
				import("./chunks/powershell.8Wcba7xo.js").then((e) => yS(e.powerShell)),
		}),
		Cf.of({
			...
			load: () =>
				import("./chunks/properties.DR3VzWXW.js").then((e) => yS(e.properties)),
		}),
		Cf.of({
			name: "ProtoBuf",
			extensions: ["proto"],
			load: () =>
				import("./chunks/protobuf.BJQWJR-f.js").then((e) => yS(e.protobuf)),
		}),
		Cf.of({
			name: "Pug",
			alias: ["jade"],
			extensions: ["pug", "jade"],
			load: () => import("./chunks/pug.BhcLDiLE.js").then((e) => yS(e.pug)),
		}),
		Cf.of({
			name: "Puppet",
			extensions: ["pp"],
			load: () =>
				import("./chunks/puppet.Crn4EZ-A.js").then((e) => yS(e.puppet)),
		}),
		Cf.of({
			name: "Q",
			extensions: ["q"],
			load: () => import("./chunks/q.Calqmaak.js").then((e) => yS(e.q)),
		}),
		Cf.of({
			name: "R",
			alias: ["rscript"],
			extensions: ["r", "R"],
			load: () => import("./chunks/r.Dt_CItxq.js").then((e) => yS(e.r)),
		}),
		Cf.of({
			name: "RPM Changes",
			load: () =>
				import("./chunks/rpm.NTib4cXe.js").then((e) => yS(e.rpmChanges)),
		}),
		Cf.of({
			name: "RPM Spec",
			extensions: ["spec"],
			load: () => import("./chunks/rpm.NTib4cXe.js").then((e) => yS(e.rpmSpec)),
		}),
		Cf.of({
			name: "Ruby",
			...
			load: () => import("./chunks/ruby.DMksp8rH.js").then((e) => yS(e.ruby)),
		}),
		Cf.of({
			name: "SAS",
			extensions: ["sas"],
			load: () => import("./chunks/sas.CiTe19K6.js").then((e) => yS(e.sas)),
		}),
		Cf.of({
			name: "Scala",
			extensions: ["scala"],
			load: () => import("./chunks/clike.DtMo_rcW.js").then((e) => yS(e.scala)),
		}),
		Cf.of({
			name: "Scheme",
			extensions: ["scm", "ss"],
			load: () =>
				import("./chunks/scheme.CwmlBT-y.js").then((e) => yS(e.scheme)),
		}),
		Cf.of({
			name: "Shell",
			alias: ["bash", "sh", "zsh"],
			...
			filename: /^PKGBUILD$/,
			load: () => import("./chunks/shell.CQWpSIpl.js").then((e) => yS(e.shell)),
		}),
		Cf.of({
			name: "Sieve",
			extensions: ["siv", "sieve"],
			load: () => import("./chunks/sieve.iEDP3t-W.js").then((e) => yS(e.sieve)),
		}),
		Cf.of({
			name: "Smalltalk",
			extensions: ["st"],
			load: () =>
				import("./chunks/smalltalk.CWheKCXR.js").then((e) => yS(e.smalltalk)),
		}),
		Cf.of({
			name: "Solr",
			load: () => import("./chunks/solr.B9MH1J-f.js").then((e) => yS(e.solr)),
		}),
		Cf.of({
			name: "SML",
			extensions: ["sml", "sig", "fun", "smackspec"],
			load: () => import("./chunks/mllike.CjeCnh_w.js").then((e) => yS(e.sml)),
		}),
		Cf.of({
			name: "SPARQL",
			alias: ["sparul"],
			...
			load: () =>
				import("./chunks/sparql.Cn44ORHD.js").then((e) => yS(e.sparql)),
		}),
		Cf.of({
			name: "Spreadsheet",
			alias: ["excel", "formula"],
			load: () =>
				import("./chunks/spreadsheet.BLAiOWuQ.js").then((e) =>
					yS(e.spreadsheet),
				),
		}),
		Cf.of({
			...
			extensions: ["nut"],
			load: () =>
				import("./chunks/clike.DtMo_rcW.js").then((e) => yS(e.squirrel)),
		}),
		Cf.of({
			name: "Stylus",
			extensions: ["styl"],
			load: () =>
				import("./chunks/stylus.viHZo6_g.js").then((e) => yS(e.stylus)),
		}),
		Cf.of({
			name: "Swift",
			extensions: ["swift"],
			load: () => import("./chunks/swift.BNA1-Ppi.js").then((e) => yS(e.swift)),
		}),
		Cf.of({
			name: "sTeX",
			load: () => import("./chunks/stex.W3DFwsNd.js").then((e) => yS(e.stex)),
		}),
		Cf.of({
			name: "LaTeX",
			alias: ["tex"],
		...
		Cf.of({
			...
			extensions: ["v", "sv", "svh"],
			load: () =>
				import("./chunks/verilog.CbeNw8Px.js").then((e) => yS(e.verilog)),
		}),
		Cf.of({
			name: "Tcl",
			extensions: ["tcl"],
			load: () => import("./chunks/tcl.adw4OWzn.js").then((e) => yS(e.tcl)),
		}),
		Cf.of({
			name: "Textile",
			extensions: ["textile"],
			load: () =>
				import("./chunks/textile.BxGAfx2a.js").then((e) => yS(e.textile)),
		}),
		Cf.of({
			name: "TiddlyWiki",
			load: () =>
				import("./chunks/tiddlywiki.Bcbec9nS.js").then((e) => yS(e.tiddlyWiki)),
		}),
		Cf.of({
			name: "Tiki wiki",
			load: () => import("./chunks/tiki.BuIrK4D4.js").then((e) => yS(e.tiki)),
		}),
		Cf.of({
			name: "TOML",
			extensions: ["toml"],
			load: () => import("./chunks/toml.B1MlXWtT.js").then((e) => yS(e.toml)),
		}),
		Cf.of({
			name: "Troff",
			extensions: ["1", "2", "3", "4", "5", "6", "7", "8", "9"],
			load: () => import("./chunks/troff.4C0eGkZh.js").then((e) => yS(e.troff)),
		}),
		Cf.of({
			name: "TTCN",
			extensions: ["ttcn", "ttcn3", "ttcnpp"],
			load: () => import("./chunks/ttcn.DkoayBsV.js").then((e) => yS(e.ttcn)),
		}),
		Cf.of({
			name: "TTCN_CFG",
			extensions: ["cfg"],
			load: () =>
				import("./chunks/ttcn-cfg.fNVRypFs.js").then((e) => yS(e.ttcnCfg)),
		}),
		Cf.of({
			name: "Turtle",
			extensions: ["ttl"],
			load: () =>
				import("./chunks/turtle.E7kXyr91.js").then((e) => yS(e.turtle)),
		}),
		Cf.of({
			name: "Web IDL",
			extensions: ["webidl"],
			load: () =>
				import("./chunks/webidl.wIXeq1Od.js").then((e) => yS(e.webIDL)),
		}),
		Cf.of({
			name: "VB.NET",
			extensions: ["vb"],
			load: () => import("./chunks/vb.uX7EQwtg.js").then((e) => yS(e.vb)),
		}),
		Cf.of({
			name: "VBScript",
			extensions: ["vbs"],
			load: () =>
				import("./chunks/vbscript.C_sVkEMu.js").then((e) => yS(e.vbScript)),
		}),
		Cf.of({
			name: "Velocity",
			extensions: ["vtl"],
			load: () =>
				import("./chunks/velocity.CMH8uTYR.js").then((e) => yS(e.velocity)),
		}),
		Cf.of({
			name: "Verilog",
			extensions: ["v"],
		...
		Cf.of({
			name: "VHDL",
			extensions: ["vhd", "vhdl"],
			load: () => import("./chunks/vhdl.ByRt45QS.js").then((e) => yS(e.vhdl)),
		}),
		Cf.of({
			name: "XQuery",
			extensions: ["xy", "xquery"],
			load: () =>
				import("./chunks/xquery.WRCRDNjF.js").then((e) => yS(e.xQuery)),
		}),
		Cf.of({
			name: "Yacas",
			extensions: ["ys"],
			load: () => import("./chunks/yacas.Ck3zdBrB.js").then((e) => yS(e.yacas)),
		}),
		Cf.of({
			name: "Z80",
			extensions: ["z80"],
			load: () => import("./chunks/z80.Cel8Sx0S.js").then((e) => yS(e.z80)),
		}),
		Cf.of({
			name: "MscGen",
			extensions: ["mscgen", "mscin", "msc"],
			load: () =>
				import("./chunks/mscgen.Bbr4xJX0.js").then((e) => yS(e.mscgen)),
		}),
		Cf.of({
			name: "Xù",
			extensions: ["xu"],
			load: () => import("./chunks/mscgen.Bbr4xJX0.js").then((e) => yS(e.xu)),
		}),
		Cf.of({
			name: "MsGenny",
			extensions: ["msgenny"],
			load: () =>
				import("./chunks/mscgen.Bbr4xJX0.js").then((e) => yS(e.msgenny)),
		}),
		Cf.of({
			name: "Vue",
			extensions: ["vue"],
			load: () => import("./chunks/index.CbGrZSiK.js").then((e) => e.vue()),
		}),
		Cf.of({
			name: "Angular Template",
			load: () => import("./chunks/index.CcIK47it.js").then((e) => e.angular()),
		}),
	],
...
function DS(e, t, i, n, r = t.length) {
...
function YS(e = null) {
	return {
		...
		init() {
			...
			this.persistence = new VS(this.entryId);
			...
			const r = new MutationObserver((e, t) => {
				const i = this.$el.querySelector('[x-ref="editorElement"]');
				if (i) {
					console.log(
						...
						t.disconnect();
					try {
						(this.editorView = LS(i, this.content, {
							onChange: (e) => {
			...
			this.$nextTick(() => {
				...
				if (e) {
					...
					try {
						(this.editorView = LS(e, this.content, {
							onChange: (e) => {
								(this.content = e), this.handleContentChange();
							},
						})),
				...
				} else r.observe(this.$el, { childList: !0, subtree: !0 });
			}),
				setInterval(() => {
		...
		handleContentChange: BS(function () {
			console.log(
		...
		insertMarkdown(e) {
			if (this.editorView)
				switch (e) {
					...
					case "italic":
						!(function (e) {
							const t = DS(e.state, "*", "*", "italic text");
							e.dispatch(
					...
					case "blockquote":
						...
						break;
					case "image":
						zS(this.editorView, "![", "](url)", "alt text");
						break;
					case "table":
						const t =
							"| Header 1 | Header 2 |\n|---|---|\n| Cell 1 | Cell 2 |\n| Cell 3 | Cell 4 |";
						zS(this.editorView, "", "", t, !0);
						break;
					case "codeblock":
						zS(this.editorView, "```\n", "\n```", "code here", !0);
						break;
