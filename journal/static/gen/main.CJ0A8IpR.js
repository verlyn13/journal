...
import { basicSetup as t } from "@codemirror/basic-setup";
var e,
	i,
	n,
	r,
...
function h(t) {
	!(function (t) {
		...
		o || s || ((s = !0), queueMicrotask(u));
	})(t);
}
function c(t) {
	let e = a.indexOf(t);
	-1 !== e && e > l && a.splice(e, 1);
}
function u() {
	(s = !1), (o = !0);
	for (let t = 0; t < a.length; t++) a[t](), (l = t);
	(a.length = 0), (l = -1), (o = !1);
}
var O = !0;
function d(t) {
...
function v() {
	!(function () {
		...
		let e = $.length;
		queueMicrotask(() => {
			if ($.length === e) for (; $.length > 0; ) $.shift()();
		});
	})(),
		y.disconnect(),
		(w = !1);
...
function T(t) {
	...
	for (let t of i) e.some((e) => e.contains(t)) || g.forEach((e) => e(t));
	for (let t of e) t.isConnected && m.forEach((e) => e(t));
...
function V(t, e, i) {
	if (("string" == typeof e && (e = e.split(".")), 1 !== e.length)) {
		...
		return t[e[0]] || (t[e[0]] = {}), V(t[e[0]], e.slice(1), i);
	}
	t[e[0]] = i;
}
var L = {};
				...
				: (function (t, e, i) {
						let n = (function (t, e) {
							...
							const r = () => {
								try {
									...
									return D(i, e, t), Promise.resolve();
								}
							};
							let s = r();
							return (F[t] = s), s;
						...
						return (r = () => {}, { scope: s = {}, params: o = [] } = {}) => {
							...
							if ("function" == typeof n) {
								let t = n(n, a).catch((t) => D(t, i, e));
								n.finished
									? (K(r, n.result, a, o, i), (n.result = void 0))
									: t
											.then((t) => {
												K(r, t, a, o, i);
											})
...
function K(t, e, i, n, r) {
	if (B && "function" == typeof e) {
		...
		s instanceof Promise
			? s.then((e) => K(t, e, i, n)).catch((t) => D(t, r, e))
			: t(s);
	} else
	...
	return (
		(et[t] = e),
		{
			before(e) {
				...
				const i = gt.indexOf(e);
				gt.splice(i >= 0 ? i : gt.indexOf("DEFAULT"), 0, t);
			},
		}
	);
}
...
function ct(t = () => {}) {
	return ({ name: e, value: i }) => {
		let { name: n, value: r } = ut.reduce((t, e) => e(t), {
			name: e,
			value: i,
		});
...
function mt(t, e) {
	let i = -1 === gt.indexOf(t.type) ? pt : t.type,
		n = -1 === gt.indexOf(e.type) ? pt : e.type;
	return gt.indexOf(i) - gt.indexOf(n);
}
function xt(t, e, i = {}) {
	t.dispatchEvent(
		new CustomEvent(e, {
...
function bt(t, e) {
	if ("function" == typeof ShadowRoot && t instanceof ShadowRoot)
		return void Array.from(t.children).forEach((t) => bt(t, e));
	let i = !1;
	if ((e(t, () => (i = !0)), i)) return;
	let n = t.firstElementChild;
	for (; n; ) bt(n, e), (n = n.nextElementSibling);
}
function St(t, ...e) {
...
function Zt(t, e = !1) {
	return _t(t, (t) => {
		if ((e ? vt() : kt()).some((e) => t.matches(e))) return !0;
	});
}
function _t(t, e) {
	if (t) {
		...
		if ((t._x_teleportBack && (t = t._x_teleportBack), t.parentElement))
			return _t(t.parentElement, e);
	}
}
var Tt = [];
var Xt = 1;
function Ct(t, e = bt, i = () => {}) {
	_t(t, (t) => t._x_ignore) ||
		(function (t) {
			st = !0;
			let e = Symbol();
...
function At(t, e = bt) {
	e(t, (t) => {
		!(function (t) {
			for (t._x_effects?.forEach(c); t._x_cleanups?.length; )
				t._x_cleanups.pop()();
		})(t),
			Q(t),
			delete t._x_marker;
...
it("transition", (t, { value: e, modifiers: i, expression: n }, {
	evaluate: r,
}) => {
			...
			(n && "boolean" != typeof n
				...
				: (function (t, e, i) {
						...
						let o = !e.includes("opacity") && !e.includes("scale"),
							...
							h = a ? 0 : 1,
							c = l ? Bt(e, "scale", 95) / 100 : 1,
							u = Bt(e, "delay", 0) / 1e3,
							O = Bt(e, "origin", "center"),
							d = "opacity, transform",
							f = Bt(e, "duration", 150) / 1e3,
							p = Bt(e, "duration", 75) / 1e3,
...
function Kt(t, i, n, r = []) {
	switch (
		...
		(t._x_bindings[i] = n),
		(i = r.includes("camel")
			? i.toLowerCase().replace(/-(\w)/g, (t, e) => e.toUpperCase())
			: i))
	) {
		case "value":
			!(function (t, e) {
				if (oe(t))
					void 0 === t.attributes.value && (t.value = e),
						window.fromModel &&
							(t.checked =
								"boolean" == typeof e ? ee(t.value) === e : te(t.value, e));
				else if (se(t))
					Number.isInteger(e)
						? (t.value = e)
						: Array.isArray(e) ||
...
function he({ get: t, set: e }, { get: r, set: s }) {
	let o,
		a = !0,
		l = i(() => {
			let i = t(),
			...
			if (a) s(ce(i)), (a = !1);
				...
				let t = JSON.stringify(i),
					r = JSON.stringify(n);
				t !== o ? s(ce(i)) : t !== r && e(ce(n));
			}
			(o = JSON.stringify(t())), JSON.stringify(r());
		});
	return () => {
		n(l);
	};
...
var ge = {
		...
		extractProp: function (t, e, i, n = !0) {
			...
			if (t._x_inlineBindings && void 0 !== t._x_inlineBindings[e]) {
				...
				return (i.extract = n), I(() => U(t, i.expression));
			}
			return re(t, e, i);
		},
		findClosest: _t,
		...
		plugin: function (t) {
			(Array.isArray(t) ? t : [t]).forEach((t) => t(me));
		},
		magic: W,
		store: function (t, i) {
			if ((Oe || ((ue = e(ue)), (Oe = !0)), void 0 === i)) return ue[t];
			(ue[t] = i),
				E(ue[t]),
				"object" == typeof i &&
					null !== i &&
		...
		start: function () {
			...
			Qt &&
				...
				Array.from(document.querySelectorAll(vt().join(",")))
					.filter((t) => !Zt(t.parentElement, !0))
					.forEach((t) => {
						Ct(t);
					}),
				...
				setTimeout(() => {
					[
						...
						(function (t) {
							return Object.keys(et).includes(t);
						})(e) ||
							i.some((e) => {
								if (document.querySelector(e))
									return St(`found "${e}", but missing ${t} plugin`), !0;
							});
					});
				});
		},
		...
		bind: function (t, e) {
			...
			return t instanceof Element ? fe(t, i()) : ((de[t] = i), () => {});
		},
	},
	me = ge;
function xe(t, e) {
...
var be,
	...
	ye = (t, e) => Qe.call(t, e),
	we = Array.isArray,
	ke = (t) => "[object Map]" === Ze(t),
	ve = (t) => "symbol" == typeof t,
...
function Ye(t, e, i) {
	if (!Ve || void 0 === be) return;
	let n = Ae.get(t);
	n || Ae.set(t, (n = new Map()));
	let r = n.get(i);
	r || n.set(i, (r = new Set())),
		r.has(be) ||
			(r.add(be),
			be.deps.push(r),
			be.options.onTrack &&
				be.options.onTrack({ effect: be, target: t, type: e, key: i }));
}
	...
	if ("clear" === e) o.forEach(l);
		...
		switch ((void 0 !== i && l(o.get(i)), e)) {
			case "add":
				we(t)
					? Te(i) && l(o.get("length"))
					: (l(o.get(Me)), ke(t) && l(o.get(je)));
				break;
			case "delete":
				we(t) || (l(o.get(Me)), ke(t) && l(o.get(je)));
				break;
			case "set":
				ke(t) && l(o.get(Me));
		}
...
var De = xe("__proto__,__v_isRef,__isVue"),
	Be = new Set(
...
function Ne() {
	...
	return (
		["includes", "indexOf", "lastIndexOf"].forEach((e) => {
			t[e] = function (...t) {
				const i = Ti(this);
				for (let t = 0, e = this.length; t < e; t++) Ye(i, "get", t + "");
				const n = i[e](...t);
				return -1 === n || !1 === n ? i[e](...t.map(Ti)) : n;
			};
		}),
		["push", "pop", "shift", "unshift", "splice"].forEach((e) => {
			t[e] = function (...t) {
				Le.push(Ve), (Ve = !1);
				const i = Ti(this)[e].apply(this, t);
				return We(), i;
			};
		}),
		t
...
function He(t = !1, e = !1) {
	return function (i, n, r) {
		...
		if ("__v_raw" === n && r === (t ? (e ? $i : vi) : e ? ki : wi).get(i))
			return i;
		const s = we(i);
		if (!t && s && ye(Ge, n)) return Reflect.get(Ge, n, r);
		const o = Reflect.get(i, n, r);
		if (ve(n) ? Be.has(n) : De(n)) return o;
		if ((t || Ye(i, "get", n), e)) return o;
		if (Xi(o)) {
			return !s || !Te(n) ? o.value : o;
		}
		return $e(o) ? (t ? Zi(o) : Pi(o)) : o;
	};
}
function Fe(t = !1) {
	return function (e, i, n, r) {
		let s = e[i];
		if (!t && ((n = Ti(n)), (s = Ti(s)), !we(e) && Xi(s) && !Xi(n)))
			return (s.value = n), !0;
		const o = we(e) && Te(i) ? Number(i) < e.length : ye(e, i),
			a = Reflect.set(e, i, n, r);
		return (
			e === Ti(r) &&
				(o ? Ce(n, s) && ze(e, "set", i, n, s) : ze(e, "add", i, n)),
			a
		);
	};
}
var Ke = {
		...
		deleteProperty: function (t, e) {
			...
			return r && i && ze(t, "delete", e, void 0, n), r;
		},
		has: function (t, e) {
			const i = Reflect.has(t, e);
			return (ve(e) && Be.has(e)) || Ye(t, "has", e), i;
		},
		ownKeys: function (t) {
			return Ye(t, "iterate", we(t) ? "length" : Me), Reflect.ownKeys(t);
		},
	},
	Je = {
		get: Ue,
...
function ri(t, e, i = !1, n = !1) {
	const r = Ti((t = t.__v_raw)),
		s = Ti(e);
	e !== s && !i && Ye(r, "get", e), !i && Ye(r, "get", s);
	const { has: o } = ni(r),
		a = n ? ii : i ? ei : ti;
	return o.call(r, e)
		? a(t.get(e))
...
function oi(t, e = !1) {
	return (
		(t = t.__v_raw), !e && Ye(Ti(t), "iterate", Me), Reflect.get(t, "size", t)
	);
}
function ai(t) {
	t = Ti(t);
	const e = Ti(this);
	return ni(e).has.call(e, t) || (e.add(t), ze(e, "add", t, t)), this;
}
function li(t, e) {
	e = Ti(e);
	const i = Ti(this),
		{ has: n, get: r } = ni(i);
	let s = n.call(i, t);
	s ? yi(i, n, t) : ((t = Ti(t)), (s = n.call(i, t)));
	const o = r.call(i, t);
	return (
		i.set(t, e),
		s ? Ce(e, o) && ze(i, "set", t, e, o) : ze(i, "add", t, e),
		this
	);
}
function hi(t) {
	const e = Ti(this),
		{ has: i, get: n } = ni(e);
	let r = i.call(e, t);
	r ? yi(e, i, t) : ((t = Ti(t)), (r = i.call(e, t)));
	const s = n ? n.call(e, t) : void 0,
		o = e.delete(t);
	return r && ze(e, "delete", t, void 0, s), o;
}
function ci() {
	const t = Ti(this),
		e = 0 !== t.size,
		i = ke(t) ? new Map(t) : new Set(t),
		n = t.clear();
	return e && ze(t, "clear", void 0, void 0, i), n;
}
function ui(t, e) {
	return function (i, n) {
		const r = this,
			...
			a = e ? ii : t ? ei : ti;
		return (
			!t && Ye(o, "iterate", Me), s.forEach((t, e) => i.call(n, a(t), a(e), r))
		);
	};
}
function Oi(t, e, i) {
	...
	return function (...e) {
		{
			...
			console.warn(
				`${Xe(t)} operation ${i}failed: target is readonly.`,
				Ti(this),
			);
		}
	...
	return (e, n, r) =>
		"__v_isReactive" === n
			...
			: "__v_isReadonly" === n
				...
				: "__v_raw" === n
					? e
					: Reflect.get(ye(i, n) && n in e ? i : e, n, r);
}
var Si = { get: bi(!1) },
	Qi = { get: bi(!0) };
function yi(t, e, i) {
...
var wi = new WeakMap(),
	...
	$i = new WeakMap();
function Pi(t) {
	return t && t.__v_isReadonly ? t : _i(t, !1, Ke, Si, wi);
}
function Zi(t) {
	return _i(t, !0, Je, Qi, vi);
}
...
function Ti(t) {
	return (t && Ti(t.__v_raw)) || t;
}
function Xi(t) {
	return Boolean(t && !0 === t.__v_isRef);
}
W("nextTick", () => jt),
	W("dispatch", (t) => xt.bind(xt, t)),
	W("watch", (t, { evaluateLater: e, cleanup: i }) => (t, n) => {
		let r = e(t),
			s = f(() => {
				let t;
				return r((e) => (t = e)), t;
...
W(
	...
	it("teleport", (t, { modifiers: e, expression: i }, { cleanup: n }) => {
		"template" !== t.tagName.toLowerCase() &&
			St("x-teleport can only be used on a <template> tag", t);
		let r = ji(i),
...
function qi(t, e, i, n) {
	...
	if (
		...
		let t = i[i.indexOf("debounce") + 1] || "invalid-wait",
			e = Vi(t.split("ms")[0]) ? Number(t.split("ms")[0]) : 250;
		s = ae(s, e);
	}
			...
			(s = a(s, (t, e) => {
				(function (t, e) {
					...
					if (i.includes("debounce")) {
						...
						i.splice(
							t,
							Vi((i[t + 1] || "invalid-wait").split("ms")[0]) ? 2 : 1,
						);
					}
					if (i.includes("throttle")) {
					...
					if (1 === i.length && Wi(t.key).includes(i[0])) return !1;
					...
					if (((i = i.filter((t) => !n.includes(t))), n.length > 0)) {
						if (
							...
							if (Li(t.type)) return !1;
							if (Wi(t.key).includes(i[0])) return !1;
						}
					}
					return !0;
				})(e, i) || t(e);
	...
	return P(() => {
		...
		if ("select" === t.tagName.toLowerCase() && t.multiple)
			return e.includes("number")
				? Array.from(i.target.selectedOptions).map((t) => zi(t.value || t.text))
				: e.includes("boolean")
					...
					: Array.from(i.target.selectedOptions).map((t) => t.value || t.text);
		{
			let r;
			return (
				(r = oe(t) ? (i.target.checked ? i.target.value : n) : i.target.value),
				e.includes("number")
					? zi(r)
					: e.includes("boolean")
						? ee(r)
...
(Ei.inline = (t, { modifiers: e }, { cleanup: i }) => {
	...
	it(
		"effect",
		Ut((t, { expression: e }, { effect: i }) => {
			i(G(t, e));
		}),
	),
	it("model", (t, { modifiers: e, expression: i }, {
		effect: n,
		cleanup: r,
	}) => {
		let s = t;
		...
		let l = () => {
				let t;
				return a((e) => (t = e)), Di(t) ? t.get() : t;
			},
			h = (t) => {
				let e;
				a((t) => (e = t)),
					Di(e) ? e.set(t) : o(() => {}, { scope: { __placeholder: t } });
			};
		"string" == typeof i &&
			"radio" === t.type &&
			P(() => {
		...
		if (
			...
			let i = qi(t.form, "reset", [], (i) => {
				jt(() => t._x_model && t._x_model.set(Yi(t, e, { target: t }, l())));
			});
			r(() => i());
		}
		(t._x_model = {
	...
	it("cloak", (t) =>
		queueMicrotask(() => P(() => t.removeAttribute(tt("cloak"))))),
	Pt(() => `[${tt("init")}]`),
	it(
		"init",
		Ut((t, { expression: e }, { evaluate: i }) =>
			"string" == typeof e ? !!e.trim() && i(e, {}, !1) : i(e, {}, !1),
		),
	),
	it("text", (t, { expression: e }, { effect: i, evaluateLater: n }) => {
		let r = n(e);
		i(() => {
			r((e) => {
				P(() => {
	...
	it("html", (t, { expression: e }, { effect: i, evaluateLater: n }) => {
		let r = n(e);
		i(() => {
			r((e) => {
				P(() => {
...
(Bi.inline = (t, { value: e, modifiers: i, expression: n }) => {
	e &&
	...
	it("bind", Bi),
	$t(() => `[${tt("data")}]`),
	it("data", (t, { expression: i }, { cleanup: n }) => {
		if (
			(function (t) {
				return !!It && (!!Ht || t.hasAttribute("data-has-alpine-state"));
			})(t)
		)
			return;
		i = "" === i ? "{}" : i;
		...
		let l = U(t, i, { scope: s });
		(void 0 !== l && !0 !== l) || (l = {}), Y(l, t);
		let h = e(l);
		E(h);
		let c = C(t, h);
		h.init && U(t, h.init),
			n(() => {
				h.destroy && U(t, h.destroy), c();
			});
	}),
	Nt((t, e) => {
		t._x_dataStack &&
	...
	it("show", (t, { modifiers: e, expression: i }, { effect: n }) => {
		let r = G(t, i);
		t._x_doHide ||
			(t._x_doHide = () => {
				P(() => {
	...
	it("for", (t, { expression: i }, { effect: n, cleanup: r }) => {
		let s = (function (t) {
				let e = /,([^,\}\]]*)(?:,([^,\}\]]*))?$/,
					i = /^\s*\(|\)\s*$/g,
					n = /([\s\S]*?)\s+(?:in|of)\s+([\s\S]*)/,
					...
					n((n) => {
						...
						if (s(n))
							n = Object.entries(n).map(([e, s]) => {
								...
								r(
									(e) => {
										u.includes(e) && St("Duplicate key on x-for", t), u.push(e);
									},
									{ scope: { index: e, ...o } },
								),
									c.push(o);
						...
						for (let t = 0; t < d.length; t++) {
							...
							P(() => {
								r || St('x-for ":key" is undefined or invalid', o, i, l),
									r.after(s),
									n.after(r),
	...
	(Ui.inline = (t, { expression: e }, { cleanup: i }) => {
		let n = Zt(t);
		n._x_refs || (n._x_refs = {}),
			(n._x_refs[e] = t),
	...
	it("ref", Ui),
	it("if", (t, { expression: e }, { effect: i, cleanup: n }) => {
		"template" !== t.tagName.toLowerCase() &&
			St("x-if can only be used on a <template> tag", t);
		let r = G(t, e);
		i(() =>
			r((e) => {
				e
	...
	it("id", (t, { expression: e }, { evaluate: i }) => {
		i(e).forEach((e) =>
			(function (t, e) {
	...
	it(
		"on",
		Ut((t, { value: e, modifiers: i, expression: n }, { cleanup: r }) => {
			let s = n ? G(t, n) : () => {};
			"template" === t.tagName.toLowerCase() &&
	...
	Gi("Collapse", "collapse", "collapse"),
	Gi("Intersect", "intersect", "intersect"),
	Gi("Focus", "trap", "focus"),
	Gi("Mask", "mask", "mask"),
	me.setEvaluator(H),
	me.setReactivityEngine({
		reactive: Pi,
		effect: function (t, e = Se) {
			(function (t) {
			...
			const i = (function (t, e) {
				const i = function () {
					...
					if (!Re.includes(i)) {
						qe(i);
						try {
							return Le.push(Ve), (Ve = !0), Re.push(i), (be = i), t();
						} finally {
							Re.pop(), We(), (be = Re[Re.length - 1]);
						}
					}
				};
				return (
		...
		release: function (t) {
			t.active &&
				(qe(t), t.options.onStop && t.options.onStop(), (t.active = !1));
		},
		raw: Ti,
	});
var Ni = me;
...
(() => {
	...
	for (let e = 0, i = 0; e < t.length; e++) (e % 2 ? Fi : Hi).push((i += t[e]));
})();
function tn(t, e, i = !0, n = !0) {
	return (i ? en : nn)(t, e, n);
}
function en(t, e, i) {
	if (e == t.length) return e;
	e && sn(t.charCodeAt(e)) && on(t.charCodeAt(e - 1)) && e--;
	let n = rn(t, e);
	for (e += an(n); e < t.length; ) {
		let r = rn(t, e);
		if (8205 == n || 8205 == r || (i && Ki(r))) (e += an(r)), (n = r);
		else {
			if (!Ji(r)) break;
			{
				let i = 0,
					n = e - 2;
				for (; n >= 0 && Ji(rn(t, n)); ) i++, (n -= 2);
				if (i % 2 == 0) break;
				e += 2;
			}
		}
...
function rn(t, e) {
	...
	if (!on(i) || e + 1 == t.length) return i;
	let n = t.charCodeAt(e + 1);
	return sn(n) ? n - 56320 + ((i - 55296) << 10) + 65536 : i;
}
function sn(t) {
...
class ln {
	...
	replace(t, e, i) {
		...
		return (
			...
			cn.from(n, this.length - (e - t) + i.length)
		);
	}
	append(t) {
	...
	slice(t, e = this.length) {
		[t, e] = mn(this, t, e);
		let i = [];
		return this.decompose(t, e, i, 0), cn.from(i, e - t);
	}
	eq(t) {
		if (t == this) return !0;
...
class hn extends ln {
	...
	lineInner(t, e, i, n) {
		for (let r = 0; ; r++) {
			let s = this.text[r],
				o = n + s.length;
			if ((e ? i : o) >= t) return new gn(n, o, i, s);
			(n = o + 1), i++;
		}
	}
	decompose(t, e, i, n) {
		...
		if (1 & n) {
			let t = i.pop(),
				e = un(r.text, t.text.slice(), 0, r.length);
			if (e.length <= 32) i.push(new hn(e, t.length + r.length));
			else {
				let t = e.length >> 1;
				i.push(new hn(e.slice(0, t)), new hn(e.slice(t)));
			}
		} else i.push(r);
	}
	replace(t, e, i) {
		if (!(i instanceof hn)) return super.replace(t, e, i);
		[t, e] = mn(this, t, e);
		let n = un(this.text, un(i.text, On(this.text, 0, t)), e),
			r = this.length + i.length - (e - t);
		return n.length <= 32 ? new hn(n, r) : cn.from(hn.split(n, []), r);
	}
	...
	static split(t, e) {
		...
		for (let r of t)
			i.push(r),
				(n += r.length + 1),
				32 == i.length && (e.push(new hn(i, n)), (i = []), (n = -1));
		return n > -1 && e.push(new hn(i, n)), e;
	}
}
class cn extends ln {
	constructor(t, e) {
			...
			for (let n = 0, r = 0; n < this.children.length; n++) {
				...
				if (t >= r && e <= o) {
					...
					if (a.lines < l >> 4 && a.lines > l >> 6) {
						...
						return (r[n] = a), new cn(r, this.length - (e - t) + i.length);
					}
	...
	static from(t, e = t.reduce((t, e) => t + e.length + 1, -1)) {
		...
		function c(t) {
			let e;
			if (t.lines > r && t instanceof cn) for (let e of t.children) c(e);
			else
				t.lines > s && (a > s || !a)
					? (u(), o.push(t))
					: t instanceof hn &&
							a &&
							(e = h[h.length - 1]) instanceof hn &&
							t.lines + e.lines <= 32
						? ((a += t.lines),
							(l += t.length + 1),
							(h[h.length - 1] = new hn(
		...
		function u() {
			0 != a &&
				(o.push(1 == h.length ? h[0] : cn.from(h, l)),
				(l = -1),
				(a = h.length = 0));
		}
		for (let e of t) c(e);
		return u(), 1 == o.length ? o[0] : new cn(o, e);
	}
}
function un(t, e, i = 0, n = 1e9) {
...
class dn {
	constructor(t, e = 1) {
		(this.dir = e),
			...
			(this.nodes = [t]),
			(this.offsets = [
				e > 0 ? 1 : (t instanceof hn ? t.text.length : t.children.length) << 1,
			]);
	}
	nextInner(t, e) {
		for (this.done = this.lineBreak = !1; ; ) {
			let i = this.nodes.length - 1,
				...
				r = this.offsets[i],
				s = r >> 1,
				o = n instanceof hn ? n.text.length : n.children.length;
			if (s == (e > 0 ? o : 0)) {
				...
				t > r.length
					...
					: (e < 0 && this.offsets[i]--,
						...
						this.offsets.push(
							e > 0
								? 1
								: (r instanceof hn ? r.text.length : r.children.length) << 1,
						));
			}
		}
	}
...
class Qn {
	...
	composeDesc(t) {
		return this.empty ? t : t.empty ? this : Pn(this, t);
	}
	mapDesc(t, e = !1) {
		return t.empty ? this : $n(this, t, e);
	}
	mapPos(t, e = -1, i = Sn.Simple) {
		let n = 0,
			r = 0;
		for (let s = 0; s < this.sections.length; ) {
			...
			if (a < 0) {
				...
				if (
					i != Sn.Simple &&
					l >= t &&
					((i == Sn.TrackDel && n < t && l > t) ||
						(i == Sn.TrackBefore && n < t) ||
						(i == Sn.TrackAfter && l > t))
				)
					return null;
				if (l > t || (l == t && e < 0 && !o))
...
class yn extends Qn {
	...
	apply(t) {
		...
		return (
			vn(this, (e, i, n, r, s) => (t = t.replace(n, n + (i - e), s)), !1), t
		);
	}
	mapDesc(t, e = !1) {
		return $n(this, t, e, !0);
	...
	invert(t) {
		...
		for (let n = 0, r = 0; n < e.length; n += 2) {
			...
			if (o >= 0) {
				(e[n] = o), (e[n + 1] = s);
				let a = n >> 1;
				for (; i.length < a; ) i.push(ln.empty);
				i.push(s ? t.slice(r, r + s) : ln.empty);
			}
			r += s;
		}
		return new yn(e, i);
	...
	compose(t) {
		return this.empty ? t : t.empty ? this : Pn(this, t, !0);
	}
	map(t, e = !1) {
	...
	filter(t) {
		...
		t: for (let s = 0, o = 0; ; ) {
			...
			for (; o < a || (o == a && 0 == r.len); ) {
				...
				wn(e, t, s), s > 0 && kn(i, e, r.text), r.forward(t), (o += t);
			}
			let l = t[s++];
			for (; o < l; ) {
				if (r.done) break t;
				...
				wn(e, t, -1),
					wn(n, t, -1 == r.ins ? -1 : 0 == r.off ? r.ins : 0),
					r.forward(t),
					(o += t);
			}
		}
		return { changes: new yn(e, i), filtered: Qn.create(n) };
	}
	toJSON() {
		let t = [];
		for (let e = 0; e < this.sections.length; e += 2) {
		...
		for (let n = 0; n < t.length; n++) {
			...
			if ("number" == typeof r) e.push(r, -1);
				...
				if (1 == r.length) e.push(r[0], 0);
					...
					for (; i.length < n; ) i.push(ln.empty);
					(i[n] = ln.of(r.slice(1))), e.push(r[0], i[n].length);
				}
			}
		}
		return new yn(e, i);
...
function kn(t, e, i) {
	...
	if (n < t.length) t[t.length - 1] = t[t.length - 1].append(i);
		...
		for (; t.length < n; ) t.push(ln.empty);
		t.push(i);
	}
}
function vn(t, e, i) {
...
function $n(t, e, i, n = !1) {
	...
	for (let t = -1; ; ) {
		...
		if (-1 == o.ins && -1 == a.ins) {
			...
			wn(r, t, -1), o.forward(t), a.forward(t);
		} else if (
			a.ins >= 0 &&
			(o.ins < 0 ||
				t == o.i ||
			...
			for (wn(r, a.ins, -1); e; ) {
				...
				o.ins >= 0 &&
					t < o.i &&
					o.len <= i &&
					(wn(r, 0, o.ins), s && kn(s, r, o.text), (t = o.i)),
					o.forward(i),
					(e -= i);
			}
			a.next();
			...
			if (!(o.ins >= 0)) {
				if (o.done && a.done) return s ? yn.createSet(r, s) : Qn.create(r);
				throw new Error("Mismatched change set lengths");
			}
			{
				let e = 0,
				...
				wn(r, e, t < o.i ? o.ins : 0),
					s && t < o.i && kn(s, r, o.text),
					(t = o.i),
					o.forward(o.len - i);
			}
		}
...
function Pn(t, e, i = !1) {
	let n = [],
		...
		o = new Zn(e);
	for (let t = !1; ; ) {
		if (s.done && o.done) return r ? yn.createSet(n, r) : Qn.create(n);
		if (0 == s.ins) wn(n, s.len, 0, t), s.next();
			...
			if (s.done || o.done) throw new Error("Mismatched change set lengths");
			{
				...
				if (-1 == s.ins) {
					...
					wn(n, e, i, t), r && i && kn(r, n, o.text);
				} else
					-1 == o.ins
						? (wn(n, s.off ? 0 : s.len, e, t), r && kn(r, n, s.textBit(e)))
						: (wn(n, s.off ? 0 : s.len, o.off ? 0 : o.ins, t),
							r && !o.off && kn(r, n, o.text));
				(t = (s.ins > e || (o.ins >= 0 && o.len > e)) && (t || n.length > i)),
					s.forward2(e),
					o.forward(e);
			}
		} else wn(n, 0, o.ins, t), r && kn(r, n, o.text), o.next();
	}
}
class Zn {
	constructor(t) {
	...
	get text() {
		let { inserted: t } = this.set,
			e = (this.i - 2) >> 1;
		return e >= t.length ? ln.empty : t[e];
	}
	textBit(t) {
...
class _n {
	...
	extend(t, e = t) {
		if (t <= this.anchor && e >= this.anchor) return Tn.range(t, e);
	...
	static fromJSON(t) {
		...
		return Tn.range(t.anchor, t.head);
	}
	static create(t, e, i) {
		return new _n(t, e, i);
	}
...
class Tn {
	...
	addRange(t, e = !0) {
		return Tn.create([t].concat(this.ranges), e ? 0 : this.mainIndex + 1);
	}
	replaceRange(t, e = this.mainIndex) {
		let i = this.ranges.slice();
		return (i[e] = t), Tn.create(i, this.mainIndex);
	}
	toJSON() {
	...
	static fromJSON(t) {
		...
		return new Tn(
			t.ranges.map((t) => _n.fromJSON(t)),
			t.main,
		);
	}
	static single(t, e = t) {
		return new Tn([Tn.range(t, e)], 0);
	}
	static create(t, e = 0) {
		if (0 == t.length)
		...
		for (let i = 0, n = 0; n < t.length; n++) {
			...
			if (r.empty ? r.from <= i : r.from < i)
				return Tn.normalized(t.slice(), e);
			i = r.to;
		}
		return new Tn(t, e);
	}
	...
	static normalized(t, e = 0) {
		...
		for (let i = 1; i < t.length; i++) {
			...
			if (n.empty ? n.from <= r.to : n.from < r.to) {
				...
				i <= e && e--,
					t.splice(--i, 2, n.anchor > n.head ? Tn.range(o, s) : Tn.range(s, o));
			}
		}
		return new Tn(t, e);
	}
...
class An {
	...
	static define(t = {}) {
		return new An(
			...
			t.compare || (t.combine ? (t, e) => t === e : Rn),
			!!t.static,
			t.enables,
		);
	}
		...
		return {
			...
			update(t, e) {
				if (
					...
					let e = i(t);
					if (o ? !jn(e, t.values[s], n) : !n(e, t.values[s]))
				...
				if (null != l) {
					...
					if (
						this.dependencies.every((i) =>
							i instanceof An
								? e.facet(i) === t.facet(i)
								: !(i instanceof Ln) || e.field(i, !1) == t.field(i, !1),
						) ||
						(o ? jn((a = i(t)), r, n) : n((a = i(t)), r))
					)
	...
	return {
		...
		reconfigure(t, r) {
			let s = En(t, n),
				...
				h = r.facet(e);
			if (l && !s && Rn(i, l)) return (t.values[o] = h), 0;
			let c = a(t);
			return e.compare(c, h) ? ((t.values[o] = h), 0) : ((t.values[o] = c), 1);
		},
	};
}
const Vn = An.define({ static: !0 });
class Ln {
	constructor(t, e, i, n, r) {
		(this.id = t),
			(this.createF = e),
	...
	create(t) {
		let e = t.facet(Vn).find((t) => t.field == this);
	...
	init(t) {
		return [this, Vn.of({ field: this, create: t })];
	}
	get extension() {
		return this;
	}
...
class Gn {
	...
	reconfigure(t) {
		return Gn.reconfigure.of({ compartment: this, extension: t });
	}
	get(t) {
	...
	static resolve(t, e, i) {
		...
		for (let i of (function (t, e, i) {
			...
			function s(t, o) {
				...
				if (null != a) {
					...
					let e = n[a].indexOf(t);
					e > -1 && n[a].splice(e, 1),
						t instanceof Nn && i.delete(t.compartment);
				}
				...
				} else if (t instanceof Un) s(t.inner, t.prec);
				else if (t instanceof Ln) n[o].push(t), t.provides && s(t.provides, o);
				else if (t instanceof Mn)
					n[o].push(t), t.facet.extensions && s(t.facet.extensions, zn);
				else {
					let e = t.extension;
					if (!e)
						throw new Error(
			...
			return s(t, zn), n.reduce((t, e) => t.concat(e));
		})(t, e, s))
			i instanceof Ln
				? n.push(i)
		...
		for (let t in r) {
			...
			if (e.every((t) => 0 == t.type))
				if (((o[n.id] = (a.length << 1) | 1), Rn(s, e))) a.push(i.facet(n));
				else {
				...
				(o[n.id] = l.length << 1), l.push((t) => qn(t, n, e));
			}
		}
		let c = l.map((t) => t(o));
		return new Hn(t, s, c, o, a, r);
	}
}
function Fn(t, e) {
	if (1 & e) return 2;
...
const Jn = An.define(),
	tr = An.define({ combine: (t) => t.some((t) => t), static: !0 }),
	er = An.define({ combine: (t) => (t.length ? t[0] : void 0), static: !0 }),
	ir = An.define(),
	nr = An.define(),
	rr = An.define(),
	sr = An.define({ combine: (t) => !!t.length && t[0] });
class or {
	constructor(t, e) {
...
(hr.reconfigure = hr.define()), (hr.appendConfig = hr.define());
class cr {
	constructor(t, e, i, n, r, s) {
		(this.startState = t),
			(this.changes = e),
			...
			(this._state = null),
			i && Xn(i, e.newLength),
			r.some((t) => t.type == cr.time) ||
				(this.annotations = r.concat(cr.time.of(Date.now())));
	}
	static create(t, e, i, n, r, s) {
		return new cr(t, e, i, n, r, s);
	}
	get newDoc() {
	...
	isUserEvent(t) {
		let e = this.annotation(cr.userEvent);
		return !(
			!e ||
			!(
				e == t ||
				...
				(o = t.changes.compose(r))),
		{
			...
			selection: e.selection
				...
				: null === (n = t.selection) || void 0 === n
					? void 0
					: n.map(r),
			effects: hr.mapEffects(t.effects, r).concat(hr.mapEffects(e.effects, s)),
...
function dr(t, e, i) {
	let n = e.selection,
		r = gr(e.annotations);
	return (
		e.userEvent && (r = r.concat(cr.userEvent.of(e.userEvent))),
		{
			changes:
				e.changes instanceof yn
					? e.changes
					: yn.of(e.changes || [], i, t.facet(er)),
			selection: n && (n instanceof Tn ? n : Tn.single(n.anchor, n.head)),
			effects: gr(e.effects),
			annotations: r,
...
function fr(t, e, i) {
	let n = dr(t, e.length ? e[0] : {}, t.doc.length);
	e.length && !1 === e[0].filter && (i = !1);
	for (let r = 1; r < e.length; r++) {
		!1 === e[r].filter && (i = !1);
		let s = !!e[r].sequential;
		n = Or(n, dr(t, e[r], s ? n.changes.newLength : t.doc.length), s);
	}
	let r = cr.create(
		t,
		n.changes,
	...
	return (function (t) {
		...
		for (let r = i.length - 1; r >= 0; r--) {
			...
			s &&
				...
				(n = Or(n, dr(e, s, t.changes.newLength), !0));
		}
		return n == t
			? t
			: cr.create(
		...
		i
			? (function (t) {
					let e = t.startState,
						i = !0;
					for (let n of e.facet(ir)) {
						let e = n(t);
						if (!1 === e) {
							i = !1;
							break;
						}
						Array.isArray(e) && (i = !0 === i ? e : ur(i, e));
					}
					if (!0 !== i) {
						let n, r;
						if (!1 === i)
							(r = t.changes.invertedDesc), (n = yn.empty(e.doc.length));
						else {
					...
					for (let i = n.length - 1; i >= 0; i--) {
						...
						t =
							r instanceof cr
								? r
								: Array.isArray(r) && 1 == r.length && r[0] instanceof cr
									? r[0]
									: fr(e, gr(r), !1);
					}
					return t;
...
(cr.time = or.define()),
	(cr.userEvent = or.define()),
	(cr.addToHistory = or.define()),
	(cr.remote = or.define());
const pr = [];
function gr(t) {
	return null == t ? pr : Array.isArray(t) ? t : [t];
}
var mr = (function (t) {
	return (
		(t[(t.Word = 0)] = "Word"),
...
function Sr(t) {
	return (e) => {
		if (!/\S/.test(e)) return mr.Space;
		if (
			(function (t) {
				if (br) return br.test(t);
				for (let e = 0; e < t.length; e++) {
					let i = t[e];
					if (
						/\w/.test(i) ||
						(i > "" && (i.toUpperCase() != i.toLowerCase() || xr.test(i)))
					)
						return !0;
				}
				return !1;
			...
			return mr.Word;
		for (let i = 0; i < t.length; i++) if (e.indexOf(t[i]) > -1) return mr.Word;
		return mr.Other;
	};
}
class Qr {
	constructor(t, e, i, n, r, s) {
		(this.config = t),
			...
			(this.computeSlot = r),
			s && (s._state = this);
		for (let t = 0; t < this.config.dynamicSlots.length; t++) Fn(this, t << 1);
		this.computeSlot = null;
	}
	field(t, e = !0) {
		let i = this.config.address[t.id];
		if (null != i) return Fn(this, i), Kn(this, i);
	...
	applyTransaction(t) {
		...
		for (let e of t.effects)
			e.is(Gn.reconfigure)
				...
				: e.is(hr.reconfigure)
					? ((i = null), (n = e.value))
					: e.is(hr.appendConfig) && ((i = null), (n = gr(n).concat(e.value)));
		if (i) e = t.startState.values.slice();
		else {
			(i = Hn.resolve(n, r, this)),
				(e = new Qr(
					i,
					this.doc,
					this.selection,
		...
		let s = t.startState.facet(tr) ? t.newSelection : t.newSelection.asSingle();
		new Qr(i, t.newDoc, s, e, (e, i) => i.update(e, t), t);
	}
	replaceSelection(t) {
		return (
	...
	changeByRange(t) {
		...
		for (let i = 1; i < e.ranges.length; i++) {
			...
			r.push(o.range.map(h)),
				(n = n.compose(l)),
				(s = hr.mapEffects(s, l).concat(hr.mapEffects(gr(o.effects), h)));
		}
		return { changes: n, selection: Tn.create(r, e.mainIndex), effects: s };
	}
	changes(t = []) {
		return t instanceof yn
			? t
			: yn.of(t, this.doc.length, this.facet(Qr.lineSeparator));
	}
	toText(t) {
		return ln.of(t.split(this.facet(Qr.lineSeparator) || bn));
	}
	...
	facet(t) {
		...
		return null == e ? t.default : (Fn(this, e), Kn(this, e));
	}
	toJSON(t) {
	...
	static fromJSON(t, e = {}, i) {
		...
		return Qr.create({
			doc: t.doc,
			selection: Tn.fromJSON(t.selection),
			extensions: e.extensions ? n.concat([e.extensions]) : n,
		});
	}
	static create(t = {}) {
		let e = Hn.resolve(t.extensions || [], new Map()),
			i =
				t.doc instanceof ln
					? t.doc
					: ln.of((t.doc || "").split(e.staticFacet(Qr.lineSeparator) || bn)),
			n = t.selection
				? t.selection instanceof Tn
					? t.selection
					: Tn.single(t.selection.anchor, t.selection.head)
				: Tn.single(0);
		return (
			Xn(n, i.length),
			e.staticFacet(tr) || (n = n.asSingle()),
			new Qr(
				e,
				i,
				n,
	...
	get tabSize() {
		return this.facet(Qr.tabSize);
	}
	get lineBreak() {
		return this.facet(Qr.lineSeparator) || "\n";
	}
	get readOnly() {
		return this.facet(sr);
	}
	phrase(t, ...e) {
		for (let e of this.facet(Qr.phrases))
...
(Qr.allowMultipleSelections = tr),
	(Qr.tabSize = An.define({ combine: (t) => (t.length ? t[0] : 4) })),
	(Qr.lineSeparator = er),
	(Qr.readOnly = sr),
	(Qr.phrases = An.define({
		compare(t, e) {
			let i = Object.keys(t),
				n = Object.keys(e);
	...
	(Qr.languageData = Jn),
	(Qr.changeFilter = ir),
	(Qr.transactionFilter = nr),
	(Qr.transactionExtender = rr),
	(Gn.reconfigure = hr.define());
class yr {
	eq(t) {
		return this == t;
	}
	range(t, e = t) {
		return wr.create(t, e, this);
	}
}
(yr.prototype.startSide = yr.prototype.endSide = 0),
	(yr.prototype.point = !1),
	(yr.prototype.mapMode = Sn.TrackDel);
let wr = class t {
	constructor(t, e, i) {
...
class vr {
	...
	map(t, e) {
		...
		return { mapped: i.length ? new vr(n, r, i, o) : null, pos: s };
	}
}
class $r {
	constructor(t, e, i, n) {
	...
	update(t) {
		...
		if ((i && (e = e.slice().sort(kr)), this.isEmpty))
			return e.length ? $r.of(e) : this;
				...
				h.addChunk(this.chunkPos[o.chunkIndex], this.chunk[o.chunkIndex])
					...
					: ((!s || n > o.to || r < o.from || s(o.from, o.to, o.value)) &&
							(h.addInner(o.from, o.to, o.value) ||
								l.push(wr.create(o.from, o.to, o.value))),
						o.next());
	...
	map(t) {
		...
		return 0 == e.length ? r : new $r(i, e, r || $r.empty, n);
	}
	between(t, e, i) {
		if (!this.isEmpty) {
	...
	iter(t = 0) {
		return Tr.from([this]).goto(t);
	}
	get isEmpty() {
		return this.nextLayer == this;
	}
	static iter(t, e = 0) {
		return Tr.from(t).goto(e);
	}
	static compare(t, e, i, n, r = -1) {
		let s = t.filter((t) => t.maxPoint > 0 || (!t.isEmpty && t.maxPoint >= r)),
			...
			l = new Cr(s, a, r),
			h = new Cr(o, a, r);
		i.iterGaps((t, e, i) => Ar(l, t, h, e, i, n)),
	...
	static eq(t, e, i = 0, n) {
		...
		let o = Zr(r, s),
			a = new Cr(r, o, 0).goto(i),
			l = new Cr(s, o, 0).goto(i);
		for (;;) {
			if (
				a.to != l.to ||
				!Rr(a.active, l.active) ||
				...
				? (function (t) {
						if (t.length > 1)
							for (let e = t[0], i = 1; i < t.length; i++) {
								let n = t[i];
								if (kr(e, n) > 0) return t.slice().sort(kr);
								e = n;
							}
						return t;
					})(t)
	...
	static join(t) {
		...
		for (let i = t.length - 2; i >= 0; i--)
			for (let n = t[i]; n != $r.empty; n = n.nextLayer)
				e = new $r(n.chunkPos, n.chunk, e, Math.max(n.maxPoint, e.maxPoint));
		return e;
	}
}
($r.empty = new $r([], [], null, -1)), ($r.empty.nextLayer = $r.empty);
class Pr {
	finishChunk(t) {
		this.chunks.push(new vr(this.from, this.to, this.value, this.maxPoint)),
	...
	add(t, e, i) {
		this.addInner(t, e, i) ||
			(this.nextLayer || (this.nextLayer = new Pr())).add(t, e, i);
	}
	addInner(t, e, i) {
...
class Tr {
	...
	static from(t, e = null, i = -1) {
		...
		for (let r = 0; r < t.length; r++)
			for (let s = t[r]; !s.isEmpty; s = s.nextLayer)
				s.maxPoint >= i && n.push(new _r(s, e, i, r));
	...
	goto(t, e = -1e9) {
		...
		for (let t = this.heap.length >> 1; t >= 0; t--) Xr(this.heap, t);
...
class Cr {
	...
	removeActive(t) {
		Mr(this.active, t),
			Mr(this.activeTo, t),
			Mr(this.activeRank, t),
			(this.minActive = Er(this.active, this.activeTo));
	}
	addActive(t) {
		let e = 0,
		...
		for (
			...
			e++;
		jr(this.active, e, i),
			jr(this.activeTo, e, n),
			jr(this.activeRank, e, r),
			t && jr(t, e, this.cursor.from),
			(this.minActive = Er(this.active, this.activeTo));
	}
	next() {
		let t = this.to,
		...
		if (
			(t.point || i.point
				? (t.point &&
						...
						Rr(t.activeForPoint(t.to), i.activeForPoint(i.to))) ||
					s.comparePoint(a, h, t.point, i.point)
				: h > a &&
					!Rr(t.active, i.active) &&
...
function qr(t, e, i = t.length) {
	let n = 0;
	for (let r = 0; r < i && r < t.length; )
		9 == t.charCodeAt(r) ? ((n += e - (n % e)), r++) : (n++, (r = xn(t, r)));
	return n;
}
const Vr = "undefined" == typeof Symbol ? "__ͼ" : Symbol.for("ͼ"),
	Lr =
		"undefined" == typeof Symbol
...
class Yr {
	...
	static newName() {
		let t = Wr[Vr] || 1;
		return (Wr[Vr] = t + 1), "ͼ" + t.toString(36);
	}
	static mount(t, e, i) {
		let n = t[Lr],
			r = i && i.nonce;
		n ? r && n.setNonce(r) : (n = new Dr(t, r)),
...
for (
	var Br = {
		...
		Ur = "undefined" != typeof navigator && /Mac/.test(navigator.platform),
		Gr =
	...
	Br[48 + Nr] = Br[96 + Nr] = String(Nr);
for (Nr = 1; Nr <= 24; Nr++) Br[Nr + 111] = "F" + Nr;
for (Nr = 65; Nr <= 90; Nr++)
	(Br[Nr] = String.fromCharCode(Nr + 32)), (Ir[Nr] = String.fromCharCode(Nr));
for (var Hr in Br) Ir.hasOwnProperty(Hr) || (Ir[Hr] = Br[Hr]);
function Fr(t) {
	let e;
	return (
...
function ts(t) {
	return 3 == t.nodeType
		? ds(t, 0, t.nodeValue.length).getClientRects()
		: 1 == t.nodeType
			? t.getClientRects()
			: [];
}
function es(t, e, i, n) {
	return !!i && (rs(t, e, i, n, -1) || rs(t, e, i, n, 1));
}
function is(t) {
...
function ms(t, e) {
	for (let i = t, n = e; ; ) {
		...
		if (1 == i.nodeType && n > 0) {
			...
			if (!i.parentNode || ns(i)) return null;
			(n = is(i)), (i = i.parentNode);
		}
	}
}
function xs(t, e) {
...
class bs {
	...
	static before(t, e) {
		return new bs(t.parentNode, is(t), e);
	}
	static after(t, e) {
		return new bs(t.parentNode, is(t) + 1, e);
	}
}
const Ss = [];
class Qs {
...
const Zs = /Edge\/(\d+)/.exec($s.userAgent),
	_s = /MSIE \d/.test($s.userAgent),
	Ts = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec($s.userAgent),
	Xs = !!(_s || Ts || Zs),
	Cs = !Xs && /gecko\/(\d+)/i.test($s.userAgent),
	As = !Xs && /Chrome\/(\d+)/.exec($s.userAgent),
	Rs = "webkitFontSmoothing" in Ps.documentElement.style,
	Ms = !Xs && /Apple Computer/.test($s.vendor),
	js = Ms && (/Mobile\/\w+/.test($s.userAgent) || $s.maxTouchPoints > 2);
var Es = {
	mac: js || /Mac/.test($s.platform),
	windows: /Win/.test($s.platform),
	linux: /Linux|X11/.test($s.platform),
	ie: Xs,
	ie_version: _s ? Ps.documentMode || 6 : Ts ? +Ts[1] : Zs ? +Zs[1] : 0,
	gecko: Cs,
	gecko_version: Cs ? +(/Firefox\/(\d+)/.exec($s.userAgent) || [0, 0])[1] : 0,
	chrome: !!As,
	chrome_version: As ? +As[1] : 0,
	ios: js,
	android: /Android\b/.test($s.userAgent),
	safari: Ms,
	webkit_version: Rs
		? +(/\bAppleWebKit\/(\d+)/.exec($s.userAgent) || [0, 0])[1]
		: 0,
	tabSize:
		null != Ps.documentElement.style.tabSize ? "tab-size" : "-moz-tab-size",
};
class qs extends Qs {
	constructor(t) {
		super(), (this.text = t);
...
class Vs extends Qs {
	...
	merge(t, e, i, n, r, s) {
		return (
			(!i ||
				!(
					!(i instanceof Vs && i.mark.eq(this.mark)) ||
					(t && r <= 0) ||
					(e < this.length && s <= 0)
				)) &&
			(vs(this, t, e, i ? i.children.slice() : [], r - 1, s - 1),
			this.markDirty(),
			!0)
		);
	}
...
class Ls extends Qs {
	...
	split(t) {
		let e = Ls.create(this.widget, this.length - t, this.side);
	...
	merge(t, e, i, n, r, s) {
		return (
			!(
				i &&
				(!(i instanceof Ls && this.widget.compare(i.widget)) ||
					(t > 0 && r <= 0) ||
					(e < this.length && s <= 0))
	...
	get overrideDOMText() {
		if (0 == this.length) return ln.empty;
		let t = this;
		for (; t.parent; ) t = t.parent;
		let { view: e } = t,
			i = e && e.state.doc,
			n = this.posAtStart;
		return i ? i.slice(n, n + this.length) : ln.empty;
	}
	domAtPos(t) {
		return (this.length ? 0 == t : this.side > 0)
			? bs.before(this.dom)
			: bs.after(this.dom, t == this.length);
	}
	domBoundsAround() {
		return null;
	}
...
class Ws extends Qs {
	...
	become(t) {
		return t instanceof Ws && t.side == this.side;
	}
	split() {
	...
	domAtPos(t) {
		return this.side > 0 ? bs.before(this.dom) : bs.after(this.dom);
	}
	localPosFromDOM() {
		return 0;
	}
...
function zs(t, e, i) {
	...
	e instanceof Vs &&
	r.length &&
	(n = r[r.length - 1]) instanceof Vs &&
	n.mark.eq(e.mark)
		? zs(n, e.children[0], i - 1)
...
qs.prototype.children = Ls.prototype.children = Ws.prototype.children = Ss;
...
class Js extends yr {
	...
	static widget(t) {
		...
		return (
			...
			new io(t, e, e, i, t.widget || null, !1)
		);
	}
	static replace(t) {
		let e,
		...
		if (t.isBlockGap) (e = -5e8), (i = 4e8);
			...
			let { start: r, end: s } = no(t, n);
			(e = (r ? (n ? -3e8 : -1) : 5e8) - 1),
				(i = 1 + (s ? (n ? 2e8 : 1) : -6e8));
		}
		return new io(t, e, i, n, t.widget || null, !0);
	}
	static line(t) {
		return new eo(t);
	}
...
class eo extends Js {
	...
	eq(t) {
		return (
			...
			Gs(this.spec.attributes, t.spec.attributes)
		);
	}
	range(t, e = t) {
		if (e != t)
...
(eo.prototype.mapMode = Sn.TrackBefore), (eo.prototype.point = !0);
class io extends Js {
	constructor(t, e, i, n, r, s) {
		super(e, i, r, t),
			(this.block = n),
...
function ro(t, e, i, n = 0) {
	let r = i.length - 1;
	r >= 0 && i[r] + n >= t ? (i[r] = Math.max(i[r], e)) : i.push(t, e);
}
io.prototype.point = !0;
class so extends Qs {
	constructor() {
		super(...arguments),
			(this.children = []),
	...
	merge(t, e, i, n, r, s) {
		...
		return (
			...
			vs(this, t, e, i ? i.children.slice() : [], r, s),
			!0
		);
	}
	split(t) {
	...
	addLineDeco(t) {
		let e = t.spec.attributes,
			i = t.spec.class;
		e && (this.attrs = Is(e, this.attrs || {})),
			i && (this.attrs = Is({ class: i }, this.attrs || {}));
	}
	domAtPos(t) {
		return Ys(this, t);
	}
	...
	sync(t, e) {
		...
		for (; n && Qs.get(n) instanceof Vs; ) n = n.lastChild;
		if (
			!(
				n &&
				this.length &&
				("BR" == n.nodeName ||
					0 !=
						(null === (i = Qs.get(n)) || void 0 === i
							? void 0
							: i.isEditable) ||
					(Es.ios && this.children.some((t) => t instanceof qs)))
			)
		) {
	...
	measureTextSize() {
		...
		let t,
			e = 0;
		for (let i of this.children) {
			if (!(i instanceof qs) || /[^ -~]/.test(i.text)) return null;
			let n = ts(i.dom);
...
class oo extends Qs {
	...
	merge(t, e, i, n, r, s) {
		return (
			!(
				i &&
				(!(i instanceof oo && this.widget.compare(i.widget)) ||
					(t > 0 && r <= 0) ||
					(e < this.length && s <= 0))
			) && ((this.length = t + (i ? i.length : 0) + (this.length - e)), !0)
		);
	...
	domAtPos(t) {
		return 0 == t ? bs.before(this.dom) : bs.after(this.dom, t == this.length);
	}
	split(t) {
		let e = this.length - t;
		this.length = t;
		let i = new oo(this.widget, e, this.deco);
	...
	coordsAt(t, e) {
		...
		return (
			i ||
			(this.widget instanceof ao
				? null
				: os(this.dom.getBoundingClientRect(), this.length ? 0 == t : e <= 0))
		);
	}
	destroy() {
		super.destroy(), this.dom && this.widget.destroy(this.dom);
...
class lo {
	...
	posCovered() {
		...
		return !(t.breakAfter || (t instanceof oo && t.deco.endSide < 0));
	}
	getLine() {
		return (
			this.curLine ||
				(this.content.push((this.curLine = new so())), (this.atCursorPos = !0)),
			this.curLine
		);
	}
	flushBuffer(t = this.bufferMarks) {
		this.pendingBuffer &&
			(this.curLine.append(ho(new Ws(-1), t), t.length),
			(this.pendingBuffer = 0));
	}
	addBlockWidget(t) {
	...
	finish(t) {
		this.pendingBuffer && t <= this.bufferMarks.length
			...
			this.posCovered() ||
				(t &&
					this.content.length &&
					this.content[this.content.length - 1] instanceof oo) ||
				this.getLine();
	}
	buildText(t, e, i) {
		for (; t > 0; ) {
			...
			this.flushBuffer(e.slice(e.length - i)),
				this.getLine().append(
					ho(new qs(this.text.slice(this.textOff, this.textOff + n)), e),
					i,
				),
				(this.atCursorPos = !0),
				(this.textOff += n),
	...
	point(t, e, i, n, r, s) {
		if (this.disallowBlockEffectsFor[s] && i instanceof io) {
			if (i.block)
				throw new RangeError(
		...
		if (i instanceof io)
			if (i.block)
				i.startSide > 0 && !this.posCovered() && this.getLine(),
					this.addBlockWidget(new oo(i.widget || co.block, o, i));
			else {
				let s = Ls.create(i.widget || co.inline, o, o ? 0 : i.startSide),
					a =
						this.atCursorPos &&
						!s.isEditable &&
						r <= n.length &&
	...
	static build(t, e, i, n, r) {
		let s = new lo(t, e, i, r);
		return (
			(s.openEnd = $r.spans(n, e, i, s)),
...
function ho(t, e) {
	for (let i of e) t = new Vs(i, [t], t.length);
	return t;
}
class co extends Fs {
	constructor(t) {
...
(co.inline = new co("span")), (co.block = new co("div"));
var uo = (function (t) {
			...
			t: for (;;)
				if (h < s.length && d == s[h].from) {
					...
					if ((h++, u)) u.push(f);
						...
						f.from > l && o.push(new yo(l, f.from, O)),
							$o(
								t,
								(f.direction == Oo) != !(O % 2) ? n + 1 : n,
								r,
								f.inner,
								f.from,
								f.to,
					...
					if (d == i || (e ? ko[d] != a : ko[d] == a)) break;
					d++;
				}
			u ? vo(t, l, d, n + 1, r, u, o) : l < d && o.push(new yo(l, d, O)),
				(l = d);
		}
	else
		for (let l = i, h = s.length; l > e; ) {
			...
			t: for (;;)
				if (h && d == s[h - 1].to) {
					...
					if (d == e || (i ? ko[d - 1] != a : ko[d - 1] == a)) break;
					d--;
				}
			u ? vo(t, d, l, n + 1, r, u, o) : d < l && o.push(new yo(d, l, O)),
				(l = d);
		}
}
		...
		for (let s = 0; s <= n.length; s++) {
			...
			for (let t = o, e = l, n = l; t < a; t++) {
				...
				if (128 == r)
					...
					for (; r < a && 64 == ko[r]; ) r++;
					let s =
						(t && 8 == e) || (r < i && 8 == ko[r]) ? (1 == n ? 1 : 8) : 256;
					for (let e = t; e < r; e++) ko[e] = s;
					t = r - 1;
				} else 8 == r && 1 == n && (ko[t] = 1);
				(e = r), 7 & r && (n = r);
			}
		...
		(function (t, e, i, n, r) {
			...
			for (let o = 0, a = 0, l = 0; o <= n.length; o++) {
				...
				for (let e, i, n, o = h; o < c; o++)
					if ((i = xo[(e = t.charCodeAt(o))]))
						if (i < 0) {
							for (let t = a - 3; t >= 0; t -= 3)
								if (bo[t + 1] == -i) {
									let e = bo[t + 2],
										i = 2 & e ? r : 4 & e ? (1 & e ? s : r) : 0;
									i && (ko[o] = ko[bo[t]] = i), (a = t);
									break;
								}
						} else {
							if (189 == bo.length) break;
							(bo[a++] = o), (bo[a++] = e), (bo[a++] = l);
						}
					else if (2 == (n = ko[o]) || 1 == n) {
						let t = n == r;
						l = t ? 0 : 1;
...
function _o(t, e, i, n, r) {
	...
	let c = xn(t.text, o, l.forward(r, i));
	(c < l.from || c > l.to) && (c = h),
		(Zo = t.text.slice(Math.min(o, c), Math.max(o, c)));
	let u = a == (r ? e.length - 1 : 0) ? null : e[a + (r ? 1 : -1)];
	return u && c == h && u.level + (r ? 0 : 1) < l.level
		? Tn.cursor(u.side(!r, i) + t.from, u.forward(r, i) ? 1 : -1, u.level)
		: Tn.cursor(c + t.from, l.forward(r, i) ? -1 : 1, l.level);
}
function To(t, e, i) {
	for (let n = e; n < i; n++) {
		let e = So(t.charCodeAt(n));
		if (1 == e) return Oo;
		if (2 == e || 4 == e) return fo;
	}
	return Oo;
}
const Xo = An.define(),
	...
	qo = An.define(),
	Vo = An.define(),
	Lo = An.define({ combine: (t) => t.some((t) => t) }),
	Wo = An.define({ combine: (t) => t.some((t) => t) }),
	Yo = An.define();
class zo {
...
const Do = hr.define({ map: (t, e) => t.map(e) }),
	Bo = hr.define();
function Io(t, e, i) {
	let n = t.facet(Ro);
	n.length
...
const Uo = An.define({ combine: (t) => !t.length || t[0] });
let Go = 0;
const No = An.define();
class Ho {
	constructor(t, e, i, n, r) {
	...
	update(t) {
		if (this.value) {
			if (this.mustUpdate) {
				...
				if (((this.mustUpdate = null), this.value.update))
					try {
						...
						if (
							(Io(t.state, e, "CodeMirror plugin crashed"), this.value.destroy)
						)
							try {
								this.value.destroy();
							} catch (t) {}
			...
			try {
				...
				Io(t.state, e, "CodeMirror plugin crashed"), this.deactivate();
			}
		return this;
	}
	destroy(t) {
		...
		if (null === (e = this.value) || void 0 === e ? void 0 : e.destroy)
			try {
				...
				Io(t.state, e, "CodeMirror plugin crashed");
			}
	}
	deactivate() {
		...
		for (let n = 0, r = 0, s = 0, o = 0; ; n++) {
			...
			for (; r < e.length && e[r] < h; ) {
				let t = e[r],
					...
					s = Math.max(o, t),
					a = Math.min(h, n);
				if ((s <= a && new la(s + l, a + l, s, a).addToSet(i), n > h)) break;
				r += 2;
			}
			if (!a) return i;
			new la(a.fromA, a.toA, a.fromB, a.toB).addToSet(i),
				(s = a.toA),
				(o = a.toB);
		}
	}
...
class ha {
	constructor(t, e, i) {
		...
		let n = [];
		this.changes.iterChangedRanges((t, e, i, r) => n.push(new la(t, e, i, r))),
...
class ca extends Qs {
	...
	constructor(t) {
		super(),
			...
			(this.editContextFormatting = Js.none),
			...
			this.updateDeco(),
			this.updateInner([new la(0, 0, 0, t.state.doc.length)], 0, null);
	}
	update(t) {
		var e;
			...
			n > -1
				? (function (t, e, i) {
						...
						let l = e.invertedDesc,
							h = new la(l.mapPos(s), l.mapPos(o), s, o),
							c = [];
						for (let e = r.parentNode; ; e = e.parentNode) {
							let i = Qs.get(e);
							if (i instanceof Vs) c.push({ node: e, deco: i.mark });
							else {
								if (
									i instanceof so ||
		...
		let s = (function (t, e, i) {
			let n = new Oa();
			return $r.compare(t, e, i, n), n.changes;
		})(this.decorations, this.updateDeco(), t.changes);
		return (
			(i = la.extendWithRanges(i, s)),
	...
	updateInner(t, e, i) {
		...
		if (
			...
			for (let t of this.children)
				t instanceof oo && t.widget instanceof ao && r.push(t.dom);
		n.updateGaps(r);
	}
	...
	updateEditContextFormatting(t) {
		...
		for (let e of t.transactions)
			for (let t of e.effects)
				t.is(Bo) && (this.editContextFormatting = t.value);
	}
	compositionView(t) {
		let e = new qs(t.text.nodeValue);
		e.flags |= 8;
		for (let { deco: i } of t.marks) e = new Vs(i, [e], e.length);
		let i = new so();
	...
	updateSelection(t = !1, e = !1) {
		...
		let i = this.view.root.activeElement,
			...
			r =
				!n &&
				!(this.view.state.facet(Uo) || this.dom.tabIndex > -1) &&
		...
		(!s &&
								...
								1 != e.nodeType
									...
									: (n && "false" == e.childNodes[n - 1].contentEditable
										...
										"false" == e.childNodes[n].contentEditable
											...
											: 0));
							if (t && 3 != t) {
								let e = (1 == t ? ms : xs)(a.node, a.offset);
								e && (a = new bs(e.node, e.offset));
							}
						}
			...
			(this.impreciseAnchor = a.precise
				? null
				: new bs(c.anchorNode, c.anchorOffset)),
			(this.impreciseHead = l.precise
				? null
				: new bs(c.focusNode, c.focusOffset));
	}
	suppressWidgetCursorChange(t, e) {
		return (
			this.hasComposition &&
			e.empty &&
			es(t.focusNode, t.focusOffset, t.anchorNode, t.anchorOffset) &&
	...
	moveToLine(t) {
		...
		return e ? new bs(e.node, e.offset, !0) : t;
	}
	nearest(t) {
		for (let e = t; e; ) {
			let t = Qs.get(e);
	...
	coordsAt(t, e) {
		...
		for (let r = this.length, s = this.children.length - 1; s >= 0; s--) {
			...
			if (
				...
				(i = o), (n = l);
			else if (i && l == t && a == t && o instanceof oo && Math.abs(e) < 2) {
	...
	coordsForChar(t) {
		...
		if (!(n instanceof qs)) return null;
		let r = xn(n.text, i);
		if (r == i) return null;
		let s = ds(n.dom, i, r).getClientRects();
	...
	measureVisibleLineHeights(t) {
		let e = [],
			...
			o = -1,
			a = this.view.textDirection == uo.LTR;
	...
	updateDeco() {
		let t = 1,
			...
			i = !1,
			n = this.view.state.facet(ea).map((t, e) => {
				let n = "function" == typeof t;
				return n && (i = !0), n ? t(this.view) : t;
			});
		for (
			n.length && ((this.dynamicDecorationMap[t++] = i), e.push($r.join(n))),
				this.decorations = [
	...
	scrollIntoView(t) {
		...
		for (let e of this.view.state.facet(Yo))
			try {
				if (e(this.view, t.range, t)) return !0;
			} catch (t) {
				Io(this.view.state, t, "scroll handler");
			}
		let e,
			{ range: i } = t,
		...
		!(function (t, e, i, n, r, s, o, a) {
			...
			this.view.textDirection == uo.LTR,
		);
	}
}
function ua(t, e) {
	...
	let n = ms(i.focusNode, i.focusOffset),
		r = xs(i.focusNode, i.focusOffset),
		s = n || r;
	if (r && n && r.node != n.node) {
		let e = Qs.get(r.node);
		if (!e || (e instanceof qs && e.text != r.node.nodeValue)) s = r;
		else if (t.docView.lastCompositionAfterCursor) {
			let t = Qs.get(n.node);
			!t || (t instanceof qs && t.text != n.node.nodeValue) || (s = r);
		}
	}
...
function xa(t, e, i) {
	...
	for (let O = t.firstChild; O; O = O.nextSibling) {
		...
		for (let d = 0; d < t.length; d++) {
			let f = t[d];
			r && pa(r, f) && (f = ga(ma(f, r.bottom), r.top));
			let p = da(e, f),
				g = fa(i, f);
			if (0 == p && 0 == g) return 3 == O.nodeType ? ba(O, e, i) : xa(O, e, i);
			if (!n || o > g || (o == g && s > p)) {
				(n = O), (r = f), (s = p), (o = g);
...
function ba(t, e, i) {
	let n = t.nodeValue.length,
		...
		o = 0;
	for (let a = 0; a < n; a++) {
		let n = ds(t, a, a + 1).getClientRects();
		for (let l = 0; l < n.length; l++) {
			...
			if (h.left - 1 <= e && h.right + 1 >= e && c < s) {
				let i = e >= (h.left + h.right) / 2,
					n = i;
				if (Es.chrome || Es.gecko) {
					ds(t, a).getBoundingClientRect().left == h.right && (n = !i);
				}
...
function Sa(t, e, i, n = -1) {
	...
	for (
		...
		(o = t.elementAtHeight(O)), o.type != Ks.Text;
	)
				...
				(!t.contentDOM.contains(m) ||
					(Es.safari &&
						(function (t, e, i) {
							...
							return ds(t, n - 1, n).getBoundingClientRect().left > i;
						})(m, x, c)) ||
					(Es.chrome &&
						(function (t, e, i) {
							if (0 != e) return !1;
	...
	if (!m || !t.docView.dom.contains(m)) {
		let e = so.find(t.docView, d);
		if (!e) return O > o.top + o.height / 2 ? o.to : o.from;
		({ node: m, offset: x } = xa(e.dom, c, u));
	}
	...
	return (
		...
		(function (t, e, i) {
			for (let n = 0, r = 0; ; ) {
				if (r >= e) return n;
				if (n == t.length) break;
				(r += 9 == t.charCodeAt(n) ? i - (r % i) : 1), (n = xn(t, n));
			}
			return t.length;
		})(o, s, t.state.tabSize)
	);
...
function ya(t, e, i, n) {
	let r = (function (t, e) {
			...
			if (Array.isArray(i.type))
				for (let t of i.type)
					if (t.to > e || (t.to == e && (t.to == i.to || t.type == Ks.Text)))
						return t;
			return i;
		})(t, e.head),
		s =
			n && r.type == Ks.Text && (t.lineWrapping || r.widgetLineBreaks)
	...
	if (s) {
		let e = t.dom.getBoundingClientRect(),
			...
			o = t.posAtCoords({
				x: i == (n == uo.LTR) ? e.right - 1 : e.left + 1,
				y: (s.top + s.bottom) / 2,
			});
...
class Pa {
	constructor(t, e) {
		(this.points = t),
			(this.text = ""),
			(this.lineSeparator = e.facet(Qr.lineSeparator));
	}
	append(t) {
		this.text += t;
	}
	...
	findPointInside(t, e) {
		for (let i of this.points)
			(3 == t.nodeType ? i.node == t : t.contains(i.node)) &&
				(i.pos = this.text.length + (Za(t, i.node, i.offset) ? e : 0));
	}
}
function Za(t, e, i) {
	for (;;) {
...
function Xa(t, e) {
	...
	if (e.bounds) {
		let { from: n, to: o } = e.bounds,
			a = r.from,
			l = null;
		(8 === s || (Es.android && e.text.length < o - n)) &&
			((a = r.to), (l = "end"));
		...
		})(t.state.doc.sliceString(n, o, $a), e.text, a - n, l);
		h &&
			(Es.chrome &&
				13 == s &&
				h.toB == h.from + 2 &&
				e.text.slice(h.from, h.toB) == $a + $a &&
				h.toB--,
			(i = {
				from: n + h.from,
				to: n + h.toA,
				insert: ln.of(e.text.slice(h.from, h.toB).split($a)),
			}));
	} else
		n && ((!t.hasFocus && t.state.facet(Uo)) || n.main.eq(r)) && (n = null);
	if (!i && !n) return !1;
	if (
			...
			: (Es.mac || Es.android) &&
				...
				? (n &&
					...
					(i = {
						from: i.from,
						to: i.to,
						insert: ln.of([i.insert.toString().replace(".", " ")]),
					}))
				: i &&
						i.from >= r.from &&
						i.to <= r.to &&
					...
					: Es.chrome &&
						...
						(i = { from: r.from, to: r.to, insert: ln.of([" "]) })),
		i)
	)
		return Ca(t, i, n, s);
	if (n && !n.main.eq(r)) {
...
function Ca(t, e, i, n = -1) {
	if (Es.ios && t.inputState.flushIOSKey(e)) return !0;
				...
				if (
					...
					n = r.changeByRange((i) => {
						...
						return {
							changes: d,
							range: a
								? Tn.range(Math.max(0, a.anchor + f), Math.max(0, a.head + f))
								: i.map(d),
						};
					});
	...
	return (
		t.state.facet(jo).some((i) => i(t, e.from, e.to, o, a)) || t.dispatch(a()),
		!0
	);
}
class Aa {
	...
	constructor(t) {
		(this.view = t),
			...
			Es.safari && t.contentDOM.addEventListener("input", () => null),
			Es.gecko &&
				(function (t) {
					ol.has(t) ||
						(ol.add(t),
	...
	handleEvent(t) {
		(function (t, e) {
			...
			for (let i, n = e.target; n != t.contentDOM; n = n.parentNode)
				if (!n || 11 == n.nodeType || ((i = Qs.get(n)) && i.ignoreEvent(e)))
					return !1;
			return !0;
		})(this.view, t) &&
	...
	keydown(t) {
		...
		return !Es.ios ||
			...
			t.metaKey ||
			!(
				((e = ja.find((e) => e.keyCode == t.keyCode)) && !t.ctrlKey) ||
				(Ea.indexOf(t.key) > -1 && t.ctrlKey && !t.shiftKey)
			)
	...
	for (let e of t) {
		...
		if (t && t.domEventHandlers)
			for (let n in t.domEventHandlers) {
				...
				r && i(n).handlers.push(Ra(e.value, r));
			}
		if (t && t.domEventObservers)
			for (let n in t.domEventObservers) {
				let r = t.domEventObservers[n];
				r && i(n).observers.push(Ra(e.value, r));
			}
	}
	for (let t in Wa) i(t).handlers.push(Wa[t]);
	for (let t in Ya) i(t).observers.push(Ya[t]);
	return e;
}
const ja = [
...
class La {
	constructor(t, e, i, n) {
		(this.view = t),
			...
			(this.atoms = t.state.facet(ia).map((e) => e(t)));
		...
		r.addEventListener("mousemove", (this.move = this.move.bind(this))),
			...
			(this.multiple =
				t.state.facet(Qr.allowMultipleSelections) &&
				(function (t, e) {
					let i = t.state.facet(Xo);
					return i.length ? i[0](e) : Es.mac ? e.metaKey : e.ctrlKey;
				})(t, e)),
			(this.dragging =
				!(
					!(function (t, e) {
	...
	move(t) {
		...
		t.clientX - h.left <= s + 6
			? (n = -Va(s - t.clientX))
			: t.clientX + h.right >= a - 6 && (n = Va(t.clientX - a)),
			t.clientY - h.top <= o + 6
				? (r = -Va(o - t.clientY))
				: t.clientY + h.bottom >= l - 6 && (r = Va(t.clientY - l)),
	...
	skipAtoms(t) {
		...
		for (let i = 0; i < t.ranges.length; i++) {
			let n = t.ranges[i],
				r = null;
			if (n.empty) {
				let t = ka(this.atoms, n.from, 0);
				t != n.from && (r = Tn.cursor(t, -1));
			} else {
				let t = ka(this.atoms, n.from, -1),
					e = ka(this.atoms, n.to, 1);
				(t == n.from && e == n.to) ||
					(r = Tn.range(n.from == n.anchor ? t : e, n.from == n.head ? t : e));
			}
			r && (e || (e = t.ranges.slice()), (e[i] = r));
		}
		return e ? Tn.create(e, t.mainIndex) : t;
	}
	select(t) {
		let { view: e } = this,
...
const Wa = Object.create(null),
	...
	za = (Es.ie && Es.ie_version < 15) || (Es.ios && Es.webkit_version < 604);
function Da(t, e, i) {
...
function Ia(t, e, i, n) {
	if (1 == n) return Tn.cursor(e, i);
	if (2 == n)
		return (function (t, e, i = 1) {
			let n = t.charCategorizer(e),
				r = t.doc.lineAt(e),
				s = e - r.from;
			if (0 == r.length) return Tn.cursor(e);
			0 == s ? (i = 1) : s == r.length && (i = -1);
			let o = s,
				a = s;
			i < 0 ? (o = xn(r.text, s, !1)) : (a = xn(r.text, s));
		...
		})(t.state, e, i);
	{
		let i = so.find(t.docView, e),
			...
			s = i ? i.posAtEnd : n.to;
		return s < t.state.doc.length && s == n.to && s++, Tn.range(r, s);
	}
}
(Ya.scroll = (t) => {
	...
	(Wa.mousedown = (t, e) => {
		if ((t.observer.flush(), t.inputState.lastTouchTime > Date.now() - 2e3))
			return !1;
		let i = null;
		for (let n of t.state.facet(Ao)) if (((i = n(t, e)), i)) break;
		if (
			(i ||
				0 != e.button ||
				(i = (function (t, e) {
					...
					return {
						...
						get(e, s, o) {
							let a,
								l = Na(t, e),
								h = Ia(t, l.pos, l.bias, n);
							if (i.pos != l.pos && !s) {
								let e = Ia(t, i.pos, i.bias, n),
			...
			let n = !t.hasFocus;
			t.inputState.startMouseSelection(new La(t, e, i, n)),
				n &&
					t.observer.ignore(() => {
						Os(t.contentDOM);
...
function Ga(t, e, i, n) {
	...
	if (o && Ua(i, n, o)) return -1;
	let a = r.coordsAt(s, 1);
	return a && Ua(i, n, a) ? 1 : o && o.bottom >= n ? -1 : 1;
}
function Na(t, e) {
	let i = t.posAtCoords({ x: e.clientX, y: e.clientY }, !1);
	return { pos: i, bias: Ga(t, i, e.clientX, e.clientY) };
}
const Ha = Es.ie && Es.ie_version <= 11;
let Fa = null,
	Ka = 0,
	Ja = 0;
function tl(t) {
	if (!Ha) return t.detail;
	let e = Fa,
		i = Ja;
	return (
		(Fa = t),
	...
	let r = t.posAtCoords({ x: e.clientX, y: e.clientY }, !1),
		...
		o =
			...
			(function (t, e) {
				...
				return i.length ? i[0](e) : Es.mac ? !e.altKey : !e.ctrlKey;
			})(t, e)
				? { from: s.from, to: s.to }
				: null,
		a = { from: r, insert: i },
...
(Wa.dragstart = (t, e) => {
	...
	if (e.target.draggable) {
		...
		if (n && n.isWidget) {
			let t = n.posAtStart,
				e = t + n.length;
			(t >= i.to || e <= i.from) && (i = Tn.range(t, e));
		}
	}
	let { inputState: n } = t;
	return (
		...
		e.dataTransfer &&
			(e.dataTransfer.setData(
				"Text",
				Da(t.state, Vo, t.state.sliceDoc(i.from, i.to)),
			),
			(e.dataTransfer.effectAllowed = "copyMove")),
		!1
	);
}),
	(Wa.dragend = (t) => ((t.inputState.draggedContent = null), !1)),
	(Wa.drop = (t, e) => {
		...
		if (i && i.length) {
			let n = Array(i.length),
				...
				s = () => {
					++r == i.length &&
						el(t, e, n.filter((t) => null != t).join(t.state.lineBreak), !1);
				};
	...
	(Wa.paste = (t, e) => {
		if (t.state.readOnly) return !0;
		t.observer.flush();
		let i = za ? null : e.clipboardData;
		return i
			? (Ba(t, i.getData("text/plain") || i.getData("text/uri-list")), !0)
			: ((function (t) {
...
Wa.copy = Wa.cut = (t, e) => {
	let {
		...
		return { text: Da(t, Vo, e.join(t.lineBreak)), ranges: i, linewise: n };
	})(t.state);
	if (!i && !r) return !1;
	(il = r ? i : null),
		"cut" != e.type ||
...
function rl(t, e) {
	let i = [];
	for (let n of t.facet(Eo)) {
		let r = n(t, e);
		r && i.push(r);
	}
	return i ? t.update({ effects: i, annotations: nl.of(!0) }) : null;
}
function sl(t) {
	setTimeout(() => {
		let e = t.hasFocus;
...
(Ya.focus = (t) => {
	...
	(Ya.blur = (t) => {
		t.observer.clearSelectionRange(), sl(t);
	}),
	...
	(Wa.beforeinput = (t, e) => {
		...
		if ("insertReplacementText" == e.inputType && t.observer.editContext) {
			...
			if (n && r.length) {
				...
				return Ca(t, { from: i, to: s, insert: t.state.toText(n) }, null), !0;
			}
		}
		let r;
		if (
			Es.chrome &&
			Es.android &&
			(r = ja.find((t) => t.inputType == e.inputType)) &&
		...
		return (
			Es.ios && "deleteContentForward" == e.inputType && t.observer.flushSoon(),
			Es.safari &&
				"insertText" == e.inputType &&
				t.inputState.composing >= 0 &&
				setTimeout(() => Ya.compositionend(t, e), 20),
			!1
		);
	});
const ol = new Set();
...
class cl {
	...
	mustRefreshForWrapping(t) {
		return al.indexOf(t) > -1 != this.lineWrapping;
	}
...
class Ol {
	...
	get widget() {
		return this._content instanceof io ? this._content.widget : null;
	}
...
class pl {
	...
	setHeight(t) {
		this.height != t &&
			(Math.abs(this.height - t) > fl && (ll = !0), (this.height = t));
	}
	replace(t, e, i) {
		return pl.of(i);
	}
	...
	applyChanges(t, e, i, n) {
		...
		for (let o = n.length - 1; o >= 0; o--) {
			let { fromA: a, toA: l, fromB: h, toB: c } = n[o],
				u = r.lineAt(a, dl.ByPosNoHeight, i.setDoc(e), 0, 0),
				O = u.to >= l ? u : r.lineAt(l, dl.ByPosNoHeight, i, 0, 0);
			for (c += O.to - l, l = O.to; o > 0 && u.from <= n[o - 1].toA; )
				(a = n[o - 1].fromA),
					(h = n[o - 1].fromB),
					o--,
					a < u.from && (u = r.lineAt(a, dl.ByPosNoHeight, i, 0, 0));
			(h += u.from - a), (a = u.from);
			let d = yl.build(i.setDoc(s), t, h, c);
			r = gl(r, r.replace(a, l, d));
		}
	...
	static of(t) {
		...
		return (
			...
			new Sl(pl.of(t.slice(0, e)), s, pl.of(t.slice(i)))
		);
	}
}
function gl(t, e) {
	return t == e ? t : (t.constructor != e.constructor && (ll = !0), e);
}
pl.prototype.size = 1;
class ml extends pl {
	constructor(t, e, i) {
...
class xl extends ml {
	...
	replace(t, e, i) {
		let n = i[0];
		return 1 == i.length &&
			(n instanceof xl || (n instanceof bl && 4 & n.flags)) &&
			Math.abs(this.length - n.length) < 10
			? (n instanceof bl
					? (n = new xl(n.length, this.height))
...
class bl extends pl {
	...
	lineAt(t, e, i, n, r) {
		if (e == dl.ByHeight) return this.blockAt(t, i, n, r);
		if (e == dl.ByPosNoHeight) {
			let { from: e, to: n } = i.doc.lineAt(t);
			return new Ol(e, n - e, 0, 0, 0);
		}
	...
	forEachLine(t, e, i, n, r, s) {
		...
		for (let h = t, c = n; h <= e; ) {
			...
			let n = a + l * e.length;
			s(new Ol(e.from, e.length, c, n, 0)), (c += n), (h = e.to + 1);
		}
	}
	replace(t, e, i) {
		let n = this.length - e;
		if (n > 0) {
			let t = i[i.length - 1];
			t instanceof bl
				? (i[i.length - 1] = new bl(t.length + n))
				: i.push(null, new bl(n - 1));
		}
		if (t > 0) {
			let e = i[0];
			e instanceof bl
				? (i[0] = new bl(t + e.length))
				: i.unshift(new bl(t - 1), null);
		}
		return pl.of(i);
	}
	decomposeLeft(t, e) {
	...
	updateHeight(t, e = 0, i = !1, n) {
		...
		if (n && n.from <= e + this.length && n.more) {
			...
			for (
				...
				-1 == o ? (o = r) : Math.abs(r - o) >= fl && (o = -2);
				let a = new xl(e, r);
				(a.outdated = !1), i.push(a), (s += e + 1);
			}
			s <= r && i.push(null, new bl(r - s).updateHeight(t, s));
			let a = pl.of(i);
			return (
				(o < 0 ||
					Math.abs(a.height - this.height) >= fl ||
					Math.abs(o - this.heightMetrics(t, e).perLine) >= fl) &&
					(ll = !0),
				gl(this, a)
			);
		}
...
class Sl extends pl {
	...
	forEachLine(t, e, i, n, r, s) {
		...
		if (this.break)
			...
			let l = this.lineAt(a, dl.ByPos, i, n, r);
	...
	balanced(t, e) {
		return t.size > 2 * e.size || e.size > 2 * t.size
			? pl.of(this.break ? [t, null, e] : [t, e])
			: ((this.left = gl(this.left, t)),
				(this.right = gl(this.right, e)),
...
function Ql(t, e) {
	let i, n;
	null == t[e] &&
		(i = t[e - 1]) instanceof bl &&
		(n = t[e + 1]) instanceof bl &&
		t.splice(e - 1, 3, new bl(i.length + 1 + n.length));
}
class yl {
	constructor(t, e) {
		(this.pos = t),
		...
		if (this.lineStart > -1) {
			...
			i instanceof xl
				...
				: (t > this.pos || !this.isCovered) &&
					this.nodes.push(new xl(t - this.pos, -1)),
				(this.writtenTo = t),
				e > t &&
	...
	enterLine() {
		...
		(this.lineStart = t),
			...
			this.pos > t && this.nodes.push(new xl(this.pos - t, -1)),
	...
	finish(t) {
		...
		!(this.lineStart > -1) || e instanceof xl || this.isCovered
			? (this.writtenTo < this.pos || null == e) &&
				this.nodes.push(this.blankContent(this.writtenTo, this.pos))
			: this.nodes.push(new xl(0, -1));
		let i = t;
		for (let t of this.nodes)
			t instanceof xl && t.updateHeight(this.oracle, i),
				(i += t ? t.length : 1);
		return this.nodes;
	}
	static build(t, e, i, n) {
		let r = new yl(i, t);
		return $r.spans(e, i, n, r, 0), r.finish(i);
	}
}
class wl {
	constructor() {
...
class $l {
	...
	draw(t, e) {
		return Js.replace({
			widget: new Pl(this.displaySize * (e ? t.scaleY : t.scaleX), e),
...
class Zl {
	constructor(t) {
		(this.state = t),
			...
			(this.defaultTextDirection = uo.LTR),
			(this.visibleRanges = []),
			(this.mustEnforceCursorAssoc = !1);
		let e = t
			.facet(Jo)
			.some((t) => "function" != typeof t && "cm-lineWrapping" == t.class);
		(this.heightOracle = new cl(e)),
			(this.stateDeco = t.facet(ta).filter((t) => "function" != typeof t)),
			(this.heightMap = pl
				.empty()
				.applyChanges(
					this.stateDeco,
		...
		this.updateViewportLines(),
			...
			(this.lineGapDeco = Js.set(this.lineGaps.map((t) => t.draw(this, !1)))),
	...
	updateViewportLines() {
		(this.viewportLines = []),
			this.heightMap.forEachLine(
				...
				0,
				(t) => {
					this.viewportLines.push(Rl(t, this.scaler));
				},
			);
	}
	update(t, e = null) {
		...
		this.stateDeco = this.state.facet(ta).filter((t) => "function" != typeof t);
		let n = t.changedRanges,
			r = la.extendWithRanges(
				n,
				(function (t, e, i) {
					let n = new wl();
					return $r.compare(t, e, i, n, 0), n.changes;
				})(i, this.stateDeco, t ? t.changes : yn.empty(this.state.doc.length)),
			),
		...
		hl(),
			...
			(this.heightMap.height != s || ll) && (t.flags |= 2),
			o
	...
	measure(t) {
		let e = t.contentDOM,
			...
			n = this.heightOracle,
			r = i.whiteSpace;
		this.defaultTextDirection = "rtl" == i.direction ? uo.RTL : uo.LTR;
		...
		this.scrollTop != O &&
			...
			(this.scrolledToBottom = gs(t.scrollDOM));
		let d = (this.printing ? vl : kl)(e, this.paddingTop),
					...
					s
						? pl
								...
								.applyChanges(this.stateDeco, ln.empty, this.heightOracle, [
									new la(0, 0, 0, t.state.doc.length),
								])
						: this.heightMap
				).updateHeight(n, 0, s, new ul(i.from, r));
			}
			ll && (l |= 2);
		}
		let x =
	...
	getViewport(t, e) {
		let i = 0.5 - Math.max(-0.5, Math.min(0.5, t / 1e3 / 2)),
			...
			a = new _l(
				n.lineAt(s - 1e3 * i, dl.ByHeight, r, 0, 0).from,
				n.lineAt(o + 1e3 * (1 - i), dl.ByHeight, r, 0, 0).to,
			);
		if (e) {
			let { head: t } = e.range;
			if (t < a.from || t > a.to) {
				...
				(i =
					"center" == e.y
						...
						: "start" == e.y || ("nearest" == e.y && t < a.from)
							...
							: o.bottom - s),
					(a = new _l(
						n.lineAt(i - 500, dl.ByHeight, r, 0, 0).from,
						n.lineAt(i + s + 500, dl.ByHeight, r, 0, 0).to,
					));
			}
		}
		return a;
	...
	mapViewport(t, e) {
		let i = e.mapPos(t.from, -1),
			n = e.mapPos(t.to, 1);
		return new _l(
			this.heightMap.lineAt(i, dl.ByPos, this.heightOracle, 0, 0).from,
			this.heightMap.lineAt(n, dl.ByPos, this.heightOracle, 0, 0).to,
		);
	}
	...
	mapLineGaps(t, e) {
		...
		for (let n of t)
			e.touchesRange(n.from, n.to) ||
				i.push(new $l(e.mapPos(n.from), e.mapPos(n.to), n.size, n.displaySize));
		return i;
	}
	ensureLineGaps(t, e) {
		let i = this.heightOracle.lineWrapping,
			...
			r = n >> 1,
			s = n << 1;
		if (this.defaultTextDirection != uo.LTR && !i) return [];
		let o = [],
			a = (n, s, l, h) => {
				if (s - n < r) return;
				...
				if (!O) {
					if (
						...
						let t = e.moveToLineBoundary(Tn.cursor(s), !1, !0).head;
						t > n && (s = t);
					}
					let t = this.gapSize(l, n, s, h);
					O = new $l(n, s, t, i || t < 2e6 ? t : 2e6);
				}
				o.push(O);
			},
			l = (e) => {
				if (e.length < s || e.type != Ks.Text) return;
	...
	updateLineGaps(t) {
		$l.same(t, this.lineGaps) ||
			((this.lineGaps = t),
			(this.lineGapDeco = Js.set(
	...
	lineBlockAt(t) {
		return (
			...
			Rl(
				this.heightMap.lineAt(t, dl.ByPos, this.heightOracle, 0, 0),
				this.scaler,
			)
		);
	}
...
function Tl({ total: t, ranges: e }, i) {
...
class Al {
	constructor(t, e, i) {
		...
		(this.viewports = i.map(({ from: i, to: r }) => {
			let s = e.lineAt(i, dl.ByPos, t, 0, 0).top,
				o = e.lineAt(r, dl.ByPos, t, 0, 0).bottom;
			return (
				(n += o - s),
...
function Rl(t, e) {
	...
	return new Ol(
		...
		i,
		n - i,
		Array.isArray(t._content) ? t._content.map((t) => Rl(t, e)) : t._content,
	);
}
const Ml = An.define({ combine: (t) => t.join(" ") }),
	jl = An.define({ combine: (t) => t.indexOf(!0) > -1 }),
	El = Yr.newName(),
	ql = Yr.newName(),
	Vl = Yr.newName(),
	Ll = { "&light": "." + ql, "&dark": "." + Vl };
...
const Yl = Wl(
	...
	Dl = Es.ie && Es.ie_version <= 11;
class Bl {
	constructor(t) {
		(this.view = t),
			(this.active = !1),
			(this.editContext = null),
			(this.selectionRange = new hs()),
			...
			(this.observer = new MutationObserver((e) => {
				...
				((Es.ie && Es.ie_version <= 11) || (Es.ios && t.composing)) &&
				e.some(
					(t) =>
			...
			!window.EditContext ||
				...
				(Es.chrome && Es.chrome_version < 126) ||
				((this.editContext = new Gl(t)),
				t.state.facet(Uo) &&
	...
	onSelectionChange(t) {
		...
		if (i.state.facet(Uo) ? i.root.activeElement != this.dom : !Jr(this.dom, n))
			return;
		let r = n.anchorNode && i.docView.nearest(n.anchorNode);
		r && r.ignoreEvent(t)
			? e || (this.selectionChanged = !1)
			: ((Es.ie && Es.ie_version <= 11) || (Es.android && Es.chrome)) &&
			...
			(function (t, e) {
				...
				for (n = Math.min(n, ss(i)); ; )
					if (n) {
						...
						"false" == t.contentEditable ? n-- : ((i = t), (n = ss(i)));
					} else {
						if (i == t) return !0;
						(n = is(i)), (i = i.parentNode);
					}
			...
			let t = () => {
				...
				if (t) {
					this.clearDelayedAndroidKey(),
						...
						!this.flush() && t.force && fs(this.dom, t.key, t.keyCode);
				}
			};
	...
	readChange() {
		let { from: t, to: e, typeOver: i } = this.processRecords(),
			n = this.selectionChanged && Jr(this.dom, this.selectionRange);
		if (t < 0 && !n) return null;
		t > -1 && (this.lastChange = Date.now()),
			(this.view.inputState.lastFocusTime = 0),
			(this.selectionChanged = !1);
		let r = new Ta(this.view, t, e, i);
		return (
	...
	readMutation(t) {
		...
		if (
			...
			let i = Il(e, t.previousSibling || t.target.previousSibling, -1),
				n = Il(e, t.nextSibling || t.target.nextSibling, 1);
			return {
	...
	update(t) {
		this.editContext &&
			...
			t.startState.facet(Uo) != t.state.facet(Uo) &&
				(t.view.contentDOM.editContext = t.state.facet(Uo)
...
class Gl {
	constructor(t) {
		...
		(this.handlers.textupdate = (e) => {
			...
			let a = { from: s, to: o, insert: ln.of(e.text.split("\n")) };
			if (
				...
				if (
					((Es.mac || Es.android) &&
						...
						/^\. ?$/.test(e.text) &&
						"off" == t.contentDOM.getAttribute("autocorrect") &&
						(a = { from: s, to: o, insert: ln.of([e.text.replace(".", " ")]) }),
				...
				for (let t of e.getTextFormats()) {
					...
					if ("None" != e && "None" != n) {
						...
						if (r < s) {
							...
							i.push(Js.mark({ attributes: { style: t } }).range(r, s));
						}
					}
				}
				t.dispatch({ effects: Bo.of(Js.set(i)) });
			}),
...
class Nl {
	...
	constructor(t = {}) {
		...
		(this.dispatchTransactions =
			...
			(this._root =
				...
				document),
			(this.viewState = new Zl(t.state || Qr.create(t))),
			t.scrollTo &&
				t.scrollTo.is(Do) &&
				(this.viewState.scrollTarget = t.scrollTo.value.clip(
					this.viewState.state,
				)),
			(this.plugins = this.state.facet(No).map((t) => new Fo(t)));
		for (let t of this.plugins) t.update(this);
		(this.observer = new Bl(this)),
			(this.inputState = new Aa(this)),
			this.inputState.ensureHandlers(this.plugins),
			(this.docView = new ca(this)),
			this.mountStyles(),
			this.updateAttrs(),
			(this.updateState = 0),
			this.requestMeasure(),
	...
	update(t) {
		...
		let s = this.hasFocus,
			o = 0,
			a = null;
		t.some((t) => t.annotation(nl))
			? ((this.inputState.notifiedFocused = s), (o = 1))
			: s != this.inputState.notifiedFocused &&
				((this.inputState.notifiedFocused = s), (a = rl(r, s)), a || (o = 1));
			...
			(l
				? (this.observer.clearDelayedAndroidKey(),
					...
					((h && !this.state.doc.eq(r.doc)) ||
						...
						(h = null))
				: this.observer.clear(),
			r.facet(Qr.phrases) != this.state.facet(Qr.phrases))
		)
			return this.setState(r);
		(e = ha.create(this, r, t)), (e.flags |= o);
		...
		try {
			...
			for (let e of t) {
				if ((c && (c = c.map(e.changes)), e.scrollIntoView)) {
					...
					c = new zo(
						t.empty ? t : Tn.cursor(t.head, t.head > t.anchor ? -1 : 1),
					);
				}
				for (let t of e.effects) t.is(Do) && (c = t.value.clip(this.state));
			}
			this.viewState.update(e, c),
				(this.bidiCache = Kl.update(this.bidiCache, e.changes)),
				e.empty || (this.updatePlugins(e), this.inputState.update(e)),
				(i = this.docView.update(e)),
				this.state.facet(aa) != this.styleModules && this.mountStyles(),
				(n = this.updateAttrs()),
		...
		if (
			(e.startState.facet(Ml) != e.state.facet(Ml) &&
			...
			for (let t of this.state.facet(Mo))
				try {
					t(e);
				} catch (t) {
					Io(this.state, t, "update listener");
				}
		(a || h) &&
			Promise.resolve().then(() => {
				a && this.state == a.startState && this.dispatch(a),
					h && !Xa(this, h) && l.force && fs(this.contentDOM, l.key, l.keyCode);
			});
	}
	setState(t) {
		if (0 != this.updateState)
		...
		try {
			...
			(this.viewState = new Zl(t)),
				(this.plugins = t.facet(No).map((t) => new Fo(t))),
	...
	updatePlugins(t) {
		let e = t.startState.facet(No),
			i = t.state.facet(No);
		if (e != i) {
			let n = [];
			for (let r of i) {
				let i = e.indexOf(r);
				if (i < 0) n.push(new Fo(r));
				else {
		...
		for (let t of this.plugins) {
			...
			if (e && e.docViewUpdate)
				try {
					...
					Io(this.state, t, "doc view update listener");
				}
		}
	}
	measure(t = !0) {
		...
		try {
			for (let t = 0; ; t++) {
				if (s < 0)
					if (gs(i)) (r = -1), (s = this.viewState.heightMap.height);
					else {
				...
				let l = a.map((t) => {
						try {
							...
							return Io(this.state, t), Fl;
						}
					}),
					h = ha.create(this, this.state, []),
					c = !1;
				(h.flags |= o),
					e ? (e.flags |= o) : (e = h),
					(this.updateState = 2),
		...
		if (e && !e.empty) for (let t of this.state.facet(Mo)) t(e);
	}
	get themeClasses() {
		return (
			El + " " + (this.state.facet(jl) ? Vl : ql) + " " + this.state.facet(Ml)
		);
	}
	updateAttrs() {
		let t = Jl(this, Ko, {
			...
			e = {
				...
				translate: "no",
				contenteditable: this.state.facet(Uo) ? "true" : "false",
				class: "cm-content",
				style: `${Es.tabSize}: ${this.state.tabSize}`,
				role: "textbox",
				"aria-multiline": "true",
			};
		this.state.readOnly && (e["aria-readonly"] = "true"), Jl(this, Jo, e);
		let i = this.observer.ignore(() => {
			let i = Ns(this.contentDOM, this.contentAttrs, e),
				n = Ns(this.dom, this.editorAttrs, t);
			return i || n;
		});
	...
	mountStyles() {
		this.styleModules = this.state.facet(aa);
		let t = this.state.facet(Nl.cspNonce);
		Yr.mount(
			this.root,
	...
	moveByChar(t, e, i) {
		return va(this, t, wa(this, t, e, i));
	}
	moveByGroup(t, e) {
		return va(
			this,
	...
	visualLineSide(t, e) {
		let i = this.bidiSpans(t),
			...
			r = i[e ? i.length - 1 : 0];
		return Tn.cursor(r.side(e, n) + t.from, r.forward(!e, n) ? 1 : -1);
	}
	moveToLineBoundary(t, e, i = !0) {
		return ya(this, t, e, i);
	}
	moveVertically(t, e, i) {
		return va(
			...
			(function (t, e, i, n) {
				let r = e.head,
					s = i ? 1 : -1;
				if (r == (i ? t.state.doc.length : 0)) return Tn.cursor(r, e.assoc);
				let o,
					a = e.goalColumn,
	...
	posAtCoords(t, e = !0) {
		return this.readMeasured(), Sa(this, t, e);
	}
	coordsAtPos(t, e = 1) {
		this.readMeasured();
		...
		let n = this.state.doc.lineAt(t),
			r = this.bidiSpans(n);
		return os(i, (r[yo.find(r, t - n.from, -1, e)].dir == uo.LTR) == e > 0);
	}
	coordsForChar(t) {
	...
	bidiSpans(t) {
		if (t.length > Hl) return Po(t.length);
		let e,
		...
		for (let n of this.bidiCache)
			if (
				n.from == t.from &&
				n.dir == i &&
				(n.fresh || wo(n.isolates, (e = ra(this, t))))
			)
				return n.order;
		e || (e = ra(this, t));
		let n = (function (t, e, i) {
			if (!t) return [new yo(0, 0, e == fo ? 1 : 0)];
			if (e == Oo && !i.length && !Qo.test(t)) return Po(t.length);
			if (i.length) for (; t.length > ko.length; ) ko[ko.length] = 256;
			let n = [],
				r = e == Oo ? 0 : 1;
			return $o(t, r, r, i, 0, t.length, n), n;
		})(t.text, i, e);
		return this.bidiCache.push(new Kl(t.from, t.to, i, e, !0, n)), n;
	}
	get hasFocus() {
		var t;
		return (
	...
	scrollSnapshot() {
		...
		return Do.of(new zo(Tn.cursor(i.from), "start", "start", i.top - t, e, !0));
	}
	setTabFocusMode(t) {
		null == t
	...
	static domEventHandlers(t) {
		return Ho.define(() => ({}), { eventHandlers: t });
	}
	static domEventObservers(t) {
		return Ho.define(() => ({}), { eventObservers: t });
	}
	static theme(t, e) {
		let i = Yr.newName(),
			n = [Ml.of(i), aa.of(Wl(`.${i}`, t))];
		return e && e.dark && n.push(jl.of(!0)), n;
	}
	static baseTheme(t) {
		return In.lowest(aa.of(Wl("." + El, t, Ll)));
	}
	static findFromDOM(t) {
		var e;
		let i = t.querySelector(".cm-content"),
			n = (i && Qs.get(i)) || Qs.get(t);
		return (
...
(Nl.styleModule = aa),
	(Nl.inputHandler = jo),
	(Nl.clipboardInputFilter = qo),
	(Nl.clipboardOutputFilter = Vo),
	(Nl.scrollHandler = Yo),
	(Nl.focusChangeEffect = Eo),
	(Nl.perLineTextDirection = Lo),
	(Nl.exceptionSink = Ro),
	(Nl.updateListener = Mo),
	(Nl.editable = Uo),
	(Nl.mouseSelectionStyle = Ao),
	(Nl.dragMovesSelection = Co),
	(Nl.clickAddsSelectionRange = Xo),
	(Nl.decorations = ta),
	(Nl.outerDecorations = ea),
	(Nl.atomicRanges = ia),
	(Nl.bidiIsolatedRanges = na),
	(Nl.scrollMargins = sa),
	(Nl.darkTheme = jl),
	(Nl.cspNonce = An.define({ combine: (t) => (t.length ? t[0] : "") })),
	(Nl.contentAttributes = Jo),
	(Nl.editorAttributes = Ko),
	(Nl.lineWrapping = Nl.contentAttributes.of({ class: "cm-lineWrapping" })),
	(Nl.announce = hr.define());
const Hl = 4096,
	Fl = {};
class Kl {
	constructor(t, e, i, n, r, s) {
	...
	static update(t, e) {
		...
		let i = [],
			n = t.length ? t[t.length - 1].dir : uo.LTR;
...
const th = Es.mac ? "mac" : Es.windows ? "win" : Es.linux ? "linux" : "key";
function eh(t, e, i) {
	return (
		e.altKey && (t = "Alt-" + t),
		e.ctrlKey && (t = "Ctrl-" + t),
			...
			keydown: (t, e) =>
				(function (t, e, i, n) {
					...
					let r = (function (t) {
							var e =
								(!(
									(Ur && t.metaKey && t.shiftKey && !t.ctrlKey && !t.altKey) ||
									(Gr && t.shiftKey && t.key && 1 == t.key.length) ||
									"Unidentified" == t.key
								) &&
									t.key) ||
								(t.shiftKey ? Ir : Br)[t.keyCode] ||
								t.key ||
								"Unidentified";
							return (
								"Esc" == e && (e = "Escape"),
					...
					sh &&
						...
						sh.scope == n &&
						((a = sh.prefix + " "),
						qa.indexOf(e.keyCode) < 0 && ((h = !0), (sh = null)));
					let u,
						O,
						d = new Set(),
						f = (t) => {
							...
							: o &&
								...
								? (f(p[a + eh(u, e, !0)]) ||
										(e.shiftKey &&
											...
											f(p[a + eh(O, e, !1)]))) &&
									(l = !0)
								: o && e.shiftKey && f(p[a + eh(r, e, !0)]) && (l = !0),
						!l && f(p._any) && (l = !0));
					h && (l = !0);
									...
									for (let n of t) {
										...
										if (n.any)
											for (let e of t) {
												...
												let { any: r } = n;
												for (let e in t) t[e].run.push((t) => r(t, ah));
											}
										let r = n[e] || n.key;
										if (r)
											for (let e of t)
...
class lh extends Fs {
	...
	coordsAt(t) {
		let e = t.firstChild ? ts(t.firstChild) : [];
		if (!e.length) return null;
		let i = window.getComputedStyle(t.parentNode),
			n = os(e[0], "rtl" != i.direction),
			...
			constructor(e) {
				(this.view = e),
					(this.placeholder = Js.set([
						Js.widget({ widget: new lh(t), side: 1 }).range(0),
					]));
			}
			get decorations() {
				return this.view.state.doc.length ? Js.none : this.placeholder;
			}
		},
...
(ch.prototype.elementClass = ""),
	...
	(ch.prototype.mapMode = Sn.TrackBefore),
...
class fh {
	...
	add(t) {
		...
		return (
			"function" != typeof t && (t = mh.match(t)),
			(e) => {
				let i = t(e);
...
(fh.closedBy = new fh({ deserialize: (t) => t.split(" ") })),
	(fh.openedBy = new fh({ deserialize: (t) => t.split(" ") })),
	(fh.group = new fh({ deserialize: (t) => t.split(" ") })),
	(fh.isolate = new fh({
		deserialize: (t) => {
	...
	(fh.contextHash = new fh({ perNode: !0 })),
	(fh.lookAhead = new fh({ perNode: !0 })),
	(fh.mounted = new fh({ perNode: !0 }));
class ph {
	constructor(t, e, i) {
		(this.tree = t), (this.overlay = e), (this.parser = i);
	}
	static get(t) {
		return t && t.props && t.props[fh.mounted.id];
	}
}
const gh = Object.create(null);
class mh {
	constructor(t, e, i, n = 0) {
		(this.name = t), (this.props = e), (this.id = i), (this.flags = n);
	}
	static define(t) {
		let e = t.props && t.props.length ? Object.create(null) : gh,
			i =
				(t.top ? 1 : 0) |
				(t.skipped ? 2 : 0) |
				(t.error ? 4 : 0) |
				(null == t.name ? 8 : 0),
			n = new mh(t.name || "", e, t.id, i);
		if (t.props)
	...
	static match(t) {
		...
		return (t) => {
			for (let i = t.prop(fh.group), n = -1; n < (i ? i.length : 0); n++) {
...
mh.none = new mh("", Object.create(null), 0, 8);
class xh {
	constructor(t) {
		this.types = t;
		for (let e = 0; e < t.length; e++)
	...
	extend(...t) {
		...
		for (let i of this.types) {
			...
			e.push(n ? new mh(i.name, n, i.id, i.flags) : i);
		}
		return new xh(e);
	}
}
...
class yh {
	...
	cursor(t = 0) {
		return new Mh(this.topNode, t);
	}
	cursorAt(t, e = 0, i = 0) {
		let n = bh.get(this) || this.topNode,
			r = new Mh(n);
		return r.moveTo(t, e), bh.set(this, r._tree), r;
	}
	get topNode() {
		return new Zh(this, 0, 0, null);
	}
	resolve(t, e = 0) {
		let i = $h(bh.get(this) || this.topNode, t, e, !1);
		return bh.set(this, i), i;
	}
	resolveInner(t, e = 0) {
		let i = $h(Sh.get(this) || this.topNode, t, e, !0);
	...
	resolveStack(t, e = 0) {
		return (function (t, e, i) {
			let n = t.resolveInner(e, i),
				r = null;
			for (let t = n instanceof Zh ? n : n.context.parent; t; t = t.parent)
				if (t.index < 0) {
					let s = t.parent;
					...
					if (
						...
						let o = new Zh(s.tree, s.overlay[0].from + t.from, -1, t);
						(r || (r = [n])).push($h(o, e, i, !1));
					}
				}
			return r ? Ah(r) : n;
		})(this, t, e);
	...
	iterate(t) {
		let { enter: e, leave: i, from: n = 0, to: r = this.length } = t,
			s = t.mode || 0,
			o = (s & Qh.IncludeAnonymous) > 0;
		for (let t = this.cursor(s | Qh.IncludeAnonymous); ; ) {
			let s = !1;
			if (
				t.from <= r &&
				t.to >= n &&
	...
	balance(t = {}) {
		return this.children.length <= 8
			...
			: Vh(
					...
					0,
					this.length,
					(t, e, i) => new yh(this.type, t, e, i, this.propValues),
					t.makeTree || ((t, e, i) => new yh(mh.none, t, e, i)),
				);
	}
	static build(t) {
		return (function (t) {
			...
			let {
					buffer: i,
					nodeSet: n,
					maxBufferLength: r = uh,
					reused: s = [],
					minRepeatType: o = n.types.length,
				} = t,
				a = Array.isArray(i) ? new wh(i, i.length) : i,
				l = n.types,
				h = 0,
				c = 0;
			function u(t, e, i, x, b, S) {
				...
				if (w - y <= r && (Z = g(a.pos - e, b))) {
					...
					(P = new kh(e, w - Z.start, n)), (T = Z.start - t);
				} else {
					let t = a.pos - k;
					a.next();
					let e = [],
					...
					if (
						...
						let t = d(_, $);
						P = Vh(_, e, i, 0, e.length, 0, w - y, t, t);
				...
				if (l) {
					...
					for (let t = o.length - 3, i = 0; t >= 0; t -= 3)
						(e[i++] = o[t]),
							...
							(e[i++] = o[t + 2] - r),
							(e[i++] = i);
					i.push(new kh(e, o[2] - r, n)), s.push(r - t);
				}
			}
			function d(t, e) {
				return (i, n, r) => {
					let s,
						...
						a = 0,
						l = i.length - 1;
					if (l >= 0 && (s = i[l]) instanceof yh) {
						if (!l && s.type == t && s.length == r) return s;
						(o = s.prop(fh.lookAhead)) && (a = n[l] + s.length + o);
					}
			...
			function p(t, e, i, n, r, s, o) {
				if (s) {
					let t = [fh.contextHash, s];
					o = o ? [t].concat(o) : [t];
				}
				if (r > 25) {
					let t = [fh.lookAhead, r];
					o = o ? [t].concat(o) : [t];
				}
				return new yh(t, e, i, n, o);
			}
			function g(t, e) {
				let i = a.fork(),
					n = 0,
			...
			let S =
				null !== (e = t.length) && void 0 !== e
					...
					: x.length
						? b[0] + x[0].length
						: 0;
			return new yh(l[t.topID], x.reverse(), b.reverse(), S);
		})(t);
	}
}
yh.empty = new yh(mh.none, [], [], 0);
class wh {
	constructor(t, e) {
...
class kh {
	...
	findChild(t, e, i, n, r) {
		...
		for (
			let a = t;
			a != e && !(vh(r, n, s[a + 1], s[a + 2]) && ((o = a), i > 0));
			a = s[a + 3]
		);
		return o;
	}
...
function $h(t, e, i, n) {
	for (
		...
		let e = !n && t instanceof Zh && t.index < 0 ? null : t.parent;
		if (!e) return t;
		t = e;
	}
	let s = n ? 0 : Qh.IgnoreOverlays;
	if (n)
...
class Zh extends Ph {
	...
	nextChild(t, e, i, n, r = 0) {
		for (let s = this; ; ) {
			for (
				...
				let l = o[t],
					h = a[t] + s.from;
				if (vh(n, i, h, h + l.length))
					if (l instanceof kh) {
						if (r & Qh.ExcludeBuffers) continue;
						let o = l.findChild(0, l.buffer.length, e, i - h, n);
						if (o > -1) return new Ch(new Xh(s, l, t, h), null, o);
					} else if (r & Qh.IncludeAnonymous || !l.type.isAnonymous || jh(l)) {
						let o;
						if (!(r & Qh.IgnoreMounts) && (o = ph.get(l)) && !o.overlay)
							return new Zh(o.tree, h, t, s);
						let a = new Zh(l, h, t, s);
						return r & Qh.IncludeAnonymous || !a.type.isAnonymous
							? a
							: a.nextChild(e < 0 ? l.children.length - 1 : 0, e, i, n);
					}
			}
			if (r & Qh.IncludeAnonymous || !s.type.isAnonymous) return null;
			if (
				((t =
					s.index >= 0
						? s.index + e
	...
	enter(t, e, i = 0) {
		let n;
		if (!(i & Qh.IgnoreOverlays) && (n = ph.get(this._tree)) && n.overlay) {
			let i = t - this.from;
			for (let { from: t, to: r } of n.overlay)
				if ((e > 0 ? t <= i : t < i) && (e < 0 ? r >= i : r > i))
					return new Zh(n.tree, n.overlay[0].from + this.from, -1, this);
		}
...
class Ch extends Ph {
	...
	child(t, e, i) {
		...
		return r < 0 ? null : new Ch(this.context, this, r);
	}
	get firstChild() {
	...
	enter(t, e, i = 0) {
		if (i & Qh.ExcludeBuffers) return null;
		let { buffer: n } = this.context,
			r = n.findChild(
				this.index + 4,
				n.buffer[this.index + 3],
	...
	get nextSibling() {
		...
		return e <
			...
			? new Ch(this.context, this._parent, e)
	...
	toTree() {
		...
		return new yh(this.type, t, e, this.to - this.from);
	}
	toString() {
...
function Ah(t) {
	...
	let n = i instanceof Zh && i.index < 0 ? null : i.parent,
		r = t.slice();
	return n ? (r[e] = n) : r.splice(e, 1), new Rh(r, i);
}
class Rh {
	constructor(t, e) {
...
class Mh {
	...
	enter(t, e, i = this.mode) {
		return this.buffer
			? !(i & Qh.ExcludeBuffers) && this.enterChild(1, t, e)
			: this.yield(this._tree.enter(t, e, i));
	}
	parent() {
		if (!this.buffer)
			return this.yieldNode(
				this.mode & Qh.IncludeAnonymous
					? this._tree._parent
					: this._tree.parent,
			);
	...
	get node() {
		...
		for (let t = i; t < this.stack.length; t++)
			e = new Ch(this.buffer, e, this.stack[t]);
		return (this.bufferNode = new Ch(this.buffer, e, this.index));
	}
	get tree() {
	...
	matchContext(t) {
		if (!this.buffer) return Th(this.node.parent, t);
		let { buffer: e } = this.buffer,
			{ types: i } = e.set;
		for (let n = t.length - 1, r = this.stack.length - 1; n >= 0; r--) {
			if (r < 0) return Th(this._tree, t, n);
...
function jh(t) {
	return t.children.some(
		(t) => t instanceof kh || !t.type.isAnonymous || jh(t),
	);
}
const Eh = new WeakMap();
function qh(t, e) {
	if (!t.isAnonymous || e instanceof kh || e.type != t) return 1;
	let i = Eh.get(e);
	if (null == i) {
		i = 1;
		for (let n of e.children) {
			if (n.type != t || !(n instanceof yh)) {
				i = 1;
				break;
			}
			i += qh(t, n);
...
function Vh(t, e, i, n, r, s, o, a, l) {
	let h = 0;
	for (let i = n; i < r; i++) h += qh(t, e[i]);
		...
		(function e(i, n, r, o, a) {
			for (let h = r; h < o; ) {
				...
				if (h == r + 1) {
					...
					u.push(Vh(t, i, n, r, h, d, e, null, l));
				}
				O.push(d + a - s);
			}
		})(e, i, n, r, 0),
...
class Lh {
	...
	set(t, e) {
		t instanceof Ch
			...
			: t instanceof Zh && this.map.set(t.tree, e);
	}
	get(t) {
...
class Wh {
	...
	static addTree(t, e = [], i = !1) {
		let n = [new Wh(0, t.length, t, 0, !1, i)];
				...
				for (; s && s.from < c; ) {
					...
					if (a >= e.from || c <= e.to || l) {
						let t = Math.max(e.from, a) - l,
							i = Math.min(e.to, c) - l;
						e = t >= i ? null : new Wh(t, i, e.tree, e.offset + l, o > 0, !!h);
					}
...
class Yh {
	startParse(t, e, i) {
		return (
			"string" == typeof t && (t = new zh(t)),
			(i = i
				? i.length
					? i.map((t) => new dh(t.from, t.to))
					: [new dh(0, 0)]
				: [new dh(0, t.length)]),
...
function Dh(t) {
	return (e, i, n, r) => new Nh(e, t, i, n, r);
}
class Bh {
	constructor(t, e, i, n, r) {
		(this.parser = t),
...
class Nh {
	...
	advance() {
			...
			return (
				null != this.stoppedAt &&
					(t = new yh(
						...
						t.positions,
						t.length,
						t.propValues.concat([[Gh, this.stoppedAt]]),
					)),
				t
			);
		}
		...
		if (e) {
			...
			(i[fh.mounted.id] = new ph(e, t.overlay, t.parser)), (t.target.props = i);
		}
		return null;
	}
	get parsedPos() {
	...
	startInner() {
		let t = new tc(this.fragments),
			e = null,
			i = null,
			n = new Mh(
				new Zh(this.baseTree, this.ranges[0].from, 0, null),
				Qh.IncludeAnonymous | Qh.IgnoreMounts,
			);
		t: for (let r, s; ; ) {
			let o,
				a = !0;
			if (null != this.stoppedAt && n.from >= this.stoppedAt) a = !1;
				...
				a = !1;
			} else if (i && (s = Hh(i.ranges, n.from, n.to))) a = 2 != s;
			else if (
				!n.type.isAnonymous &&
				...
				if ("function" == typeof r.overlay)
					...
					let t = ec(
						this.ranges,
						r.overlay || (n.from < n.to ? [new dh(n.from, n.to)] : []),
					);
					t.length && Ih(t),
						(!t.length && r.overlay) ||
							this.inner.push(
								new Bh(
									r.parser,
									t.length
										? r.parser.startParse(this.input, nc(s, t), t)
										: r.parser.startParse(""),
									r.overlay
										? r.overlay.map(
												(t) => new dh(t.from - n.from, t.to - n.from),
											)
										: null,
									n.tree,
				...
				e &&
				(o = e.predicate(n)) &&
				(!0 === o && (o = new dh(n.from, n.to)), o.from < o.to)
			) {
					...
					if (e && !--e.depth) {
						...
						t.length &&
							...
							this.inner.splice(
								...
								new Bh(
									e.parser,
									e.parser.startParse(this.input, nc(e.mounts, t), t),
									e.ranges.map((t) => new dh(t.from - e.start, t.to - e.start)),
									e.target,
									t[0].from,
								),
							)),
...
function Kh(t) {
	...
	r.children[s] = (function t(n, r, s, h, c, u) {
		...
		let m = u
			...
			: e.toTree();
		return (
			d.push(m), f.push(p - h), Fh(o, a[O + 3], r, d, f, h), new yh(s, d, f, c)
		);
	})(0, a.length, mh.none, 0, o.length, i.length - 1);
	for (let e of l) {
		let i = t.tree.children[e],
			n = t.tree.positions[e];
		t.yield(new Zh(i, n + t.from, e, t._tree));
	}
}
class Jh {
	constructor(t, e) {
		(this.offset = e),
			(this.done = !1),
			(this.cursor = t.cursor(Qh.IncludeAnonymous | Qh.IgnoreMounts));
	}
	moveTo(t) {
		let { cursor: e } = this,
			i = t - this.offset;
		for (; !this.done && e.from < i; )
			(e.to >= t && e.enter(i, 1, Qh.IgnoreOverlays | Qh.ExcludeBuffers)) ||
				e.next(!1) ||
				(this.done = !0);
	}
	hasNode(t) {
...
let tc = class {
	constructor(t) {
		...
		if (((this.fragments = t), (this.curTo = 0), (this.fragI = 0), t.length)) {
			...
			(this.curTo = null !== (e = i.tree.prop(Gh)) && void 0 !== e ? e : i.to),
				(this.inner = new Jh(i.tree, -i.offset));
	...
	nextFrag() {
		...
		if ((this.fragI++, this.fragI == this.fragments.length))
			...
			(this.curTo = null !== (t = e.tree.prop(Gh)) && void 0 !== t ? t : e.to),
				(this.inner = new Jh(e.tree, -e.offset));
		}
	}
	findMounts(t, e) {
		var i;
		...
		if (this.inner) {
			...
			for (let t = this.inner.cursor.node; t; t = t.parent) {
				let r =
					null === (i = t.tree) || void 0 === i ? void 0 : i.prop(fh.mounted);
				if (r && r.parser == e)
	...
	for (let r = 1, s = 0; r < t.length; r++) {
		...
		for (; s < n.length; s++) {
			...
			t.to <= o ||
				...
				t.from < o
					? ((i[s] = new dh(t.from, o)),
						t.to > a && i.splice(s + 1, 0, new dh(a, t.to)))
					: t.to > a
						? (i[s--] = new dh(a, t.to))
						: i.splice(s--, 1));
		}
...
function nc(t, e) {
	...
	for (let { pos: n, mount: r, frag: s } of t) {
		...
		if (r.overlay) {
			let o = ic(
				e,
				r.overlay.map((t) => new dh(t.from + n, t.to + n)),
				a,
				l,
			);
			for (let e = 0, n = a; ; e++) {
...
class sc {
	...
	static define(t, e) {
		...
		if ((t instanceof sc && (e = t), null == e ? void 0 : e.base))
...
class ac {
	constructor(t) {
		(this.name = t), (this.instances = []), (this.id = oc++);
	}
	static get(t, e) {
		if (!e.length) return t;
		...
		for (let e of t.set)
			if (!e.modified.length) for (let t of s) n.push(ac.get(e, t));
		return r;
	}
}
function lc(t) {
	...
	for (let i in t) {
		...
		for (let t of i.split(" "))
			if (t) {
				...
				let l = new cc(n, r, o > 0 ? i.slice(0, o) : null);
				e[a] = l.sort(e[a]);
			}
	}
	return hc.add(e);
...
const uc = sc.define,
	...
	$c = {
		...
		unit: uc(Qc),
		modifier: uc(Qc),
		operatorKeyword: uc(Qc),
		controlKeyword: uc(Qc),
		definitionKeyword: uc(Qc),
		moduleKeyword: uc(Qc),
		operator: yc,
		derefOperator: uc(yc),
		arithmeticOperator: uc(yc),
		logicOperator: uc(yc),
		bitwiseOperator: uc(yc),
		compareOperator: uc(yc),
		updateOperator: uc(yc),
		definitionOperator: uc(yc),
		typeOperator: uc(yc),
		controlOperator: uc(yc),
		punctuation: wc,
		separator: uc(wc),
		bracket: kc,
		angleBracket: uc(kc),
		...
		documentMeta: uc(vc),
		annotation: uc(vc),
		processingInstruction: uc(vc),
		definition: sc.defineModifier("definition"),
		constant: sc.defineModifier("constant"),
		function: sc.defineModifier("function"),
		standard: sc.defineModifier("standard"),
		local: sc.defineModifier("local"),
		special: sc.defineModifier("special"),
	};
for (let t in $c) {
	let e = $c[t];
	e instanceof sc && (e.name = t);
}
var Pc;
!(function (t) {
	let e = Object.create(null);
...
const Zc = new fh();
function _c(t) {
	return An.define({ combine: t ? (e) => e.concat(t) : void 0 });
}
const Tc = new fh();
class Xc {
	constructor(t, e, i = [], n = "") {
		(this.data = t),
			(this.name = n),
			Qr.prototype.hasOwnProperty("tree") ||
				Object.defineProperty(Qr.prototype, "tree", {
					get() {
						return Rc(this);
					},
				}),
	...
	isActiveAt(t, e, i = -1) {
		return Cc(t, e, i).type.prop(Zc) == this.data;
	}
	findRegions(t) {
		let e = t.facet(zc);
		...
		let i = [],
			n = (t, e) => {
				if (t.prop(Zc) == this.data)
					return void i.push({ from: e, to: e + t.length });
				let r = t.prop(fh.mounted);
				if (r) {
					if (r.tree.prop(Zc) == this.data) {
						if (r.overlay)
				...
				for (let i = 0; i < t.children.length; i++) {
					let r = t.children[i];
					r instanceof yh && n(r, t.positions[i] + e);
				}
			};
		return n(Rc(t), 0), i;
	}
...
function Cc(t, e, i) {
	...
	if (!n || n.allowsNesting)
		for (let t = r; t; t = t.enter(e, i, Qh.ExcludeBuffers))
			t.type.isTop && (r = t);
	return r;
}
Xc.setState = hr.define();
class Ac extends Xc {
	constructor(t, e, i) {
		super(t, e, [], i), (this.parser = e);
	}
	static define(t) {
		let e = _c(t.languageData);
		return new Ac(
			e,
			t.parser.configure({ props: [Zc.add((t) => (t.isTop ? e : void 0))] }),
			t.name,
		);
	}
	configure(t, e) {
		return new Ac(this.data, this.parser.configure(t), e || this.name);
	}
	get allowsNesting() {
...
function Rc(t) {
	let e = t.field(Xc.state, !1);
	return e ? e.tree : yh.empty;
}
class Mc {
	constructor(t) {
		(this.doc = t),
...
class Ec {
	...
	static create(t, e, i) {
		return new Ec(t, e, [], yh.empty, 0, i, [], null);
	}
	startParse() {
							...
							if (n) {
								if (
									((this.fragments = this.withoutTempSkipped(
										Wh.addTree(n, this.fragments, null != this.parse.stoppedAt),
									)),
									(this.treeLen =
	...
	takeTree() {
		...
		this.parse &&
			...
			(this.tree = e),
			(this.fragments = this.withoutTempSkipped(
				Wh.addTree(this.tree, this.fragments, !0),
			)),
			(this.parse = null));
	}
	withContext(t) {
	...
	withoutTempSkipped(t) {
		for (let e; (e = this.tempSkipped.pop()); ) t = qc(t, e.from, e.to);
		return t;
	}
	changes(t, e) {
		...
		return new Ec(this.parser, e, i, n, r, s, o, this.scheduleOn);
	}
	updateViewport(t) {
		...
		for (let e = 0; e < this.skipped.length; e++) {
			...
			i < t.to &&
				n > t.from &&
				((this.fragments = qc(this.fragments, i, n)),
			...
			createParse(e, i, n) {
				...
				return {
					...
					advance() {
						...
						return (this.parsedPos = s), new yh(mh.none, [], [], s - r);
					},
					stoppedAt: null,
					stopAt() {},
				};
...
function qc(t, e, i) {
	return Wh.applyChanges(t, [{ fromA: e, toA: i, fromB: e, toB: i }]);
}
class Vc {
	constructor(t) {
	...
	apply(t) {
		...
		return e.work(20, i) || e.takeTree(), new Vc(e);
	}
	static init(t) {
		let e = Math.min(3e3, t.doc.length),
			i = Ec.create(t.facet(zc).parser, t, { from: 0, to: e });
		return i.work(20, e) || i.takeTree(), new Vc(i);
	}
}
Xc.state = Ln.define({
	create: Vc.init,
	update(t, e) {
		for (let t of e.effects) if (t.is(Xc.setState)) return t.value;
		return e.startState.facet(zc) != e.state.facet(zc)
			? Vc.init(e.state)
			: t.apply(e);
	},
});
...
const Wc =
		"undefined" != typeof navigator &&
		(null === (Pc = navigator.scheduling) || void 0 === Pc
			? void 0
			: Pc.isInputPending)
	...
	Yc = Ho.fromClass(
		class {
			...
			update(t) {
				let e = this.view.state.field(Xc.state).context;
			...
			work(t) {
				...
				let s =
						...
						Math.min(
							this.chunkBudget,
							100,
							t && !Wc ? Math.max(25, t.timeRemaining() - 5) : 1e9,
						),
				...
				(this.chunkBudget -= Date.now() - e),
					(a || this.chunkBudget <= 0) &&
						(r.context.takeTree(),
						this.view.dispatch({ effects: Xc.setState.of(new Vc(r.context)) })),
	...
	zc = An.define({
		...
		enables: (t) => [
			Xc.state,
			Yc,
			Nl.contentAttributes.compute([t], (e) => {
				let i = e.facet(t);
...
const Gc = new fh();
function Nc({ closing: t, align: e = !0, units: i = 1 }) {
	return (n) =>
		(function (t, e, i, n, r) {
			let s = t.textAfter,
...
const Hc = (t) => t.baseIndent;
function Fc({ except: t, units: e = 1 } = {}) {
	return (i) => {
...
class nu {
	...
	indentation() {
		...
		return null !== (t = this.overrideIndent) && void 0 !== t
			? t
			: iu(this.string, null, this.tabSize);
	}
	match(t, e, i) {
		if ("string" == typeof t) {
...
class ou extends Xc {
	constructor(t) {
		let e,
			...
			n = {
				...
				copyState: r.copyState || ru,
				indent: r.indent || (() => null),
				languageData: r.languageData || {},
				tokenTable: r.tokenTable || uu,
				mergeTokens: !1 !== r.mergeTokens,
			};
		var r;
		super(
			i,
			new (class extends Yh {
				createParse(t, i, n) {
					return new hu(e, t, i, n);
				}
			})(),
			[],
			t.name,
			...
			(this.topNode = (function (t, e) {
				let i = mh.define({
					id: Ou.length,
					name: "Document",
					props: [Zc.add(() => t), Gc.add(() => (t) => e.getIndent(t))],
					top: !0,
				});
				return Ou.push(i), i;
			})(i, this)),
			(e = this),
			(this.streamParser = n),
			(this.stateAfter = new fh({ perNode: !0 })),
			(this.tokenTable = t.tokenTable ? new mu(n.tokenTable) : xu);
	}
	static define(t) {
		return new ou(t);
	}
	getIndent(t) {
		...
		i && ((e = su.get(t.state)), null != e && e < t.pos - 1e4 && (e = void 0));
		let n,
			r,
			s = au(
				this,
		...
		for (; n < t.pos; ) {
			...
			if (e.length) {
				let n = i ? i(e.from) : -1,
					o = new nu(e.text, t.state.tabSize, t.unit, n < 0 ? void 0 : n);
				for (; o.pos < s - e.from; ) cu(this.streamParser.token, o, r);
		...
		return (
			i && null == e && su.set(t.state, o.from),
...
function au(t, e, i, n, r) {
	...
	for (let s = e.children.length - 1; s >= 0; s--) {
		let o = e.children[s],
			a = i + e.positions[s],
			l = o instanceof yh && a < r && au(t, o, a, n, r);
		if (l) return l;
	}
	return null;
}
function lu(t, e, i, n, r) {
	...
	for (let s = e.children.length - 1; s >= 0; s--) {
		let o,
			a = e.positions[s],
			l = e.children[s];
		if (a < n && l instanceof yh) {
			if (!(o = lu(t, l, i - a, n - a, r))) break;
			return r
				? new yh(
						e.type,
...
let hu = class {
	constructor(t, e, i, n) {
			...
			{ state: o, tree: a } = (function (t, e, i, n, r) {
				for (let r of e) {
					let e,
						...
						a = s <= i && o > i && au(t, r.tree, 0 - r.offset, i, o);
					if (
						a &&
						a.pos <= n &&
						(e = lu(t, r.tree, i + r.offset, a.pos + r.offset, !1))
					)
						return { state: a.state, tree: e };
				}
				return {
					state: t.streamParser.startState(r ? Uc(r) : 4),
					tree: yh.empty,
				};
		...
		r &&
			...
			((this.state = this.lang.streamParser.startState(Uc(r.state))),
	...
	parseLine(t) {
		let { line: e, end: i } = this.nextLine(),
			...
			s = new nu(e, t ? t.state.tabSize : 4, t ? Uc(t.state) : 2);
		if (s.eol()) r.blankLine(this.state, s.indentUnit);
		else
			for (; !s.eol(); ) {
				let t = cu(r.token, s, this.state);
				if (
					(t &&
						(n = this.emitToken(
	...
	finishChunk() {
		...
		(t = new yh(t.type, t.children, t.positions, t.length, [
...
class mu {
	constructor(t) {
		(this.extra = t), (this.table = Object.assign(Object.create(null), gu));
	}
	resolve(t) {
		return t ? this.table[t] || (this.table[t] = Su(this.extra, t)) : 0;
	}
}
const xu = new mu(uu);
function bu(t, e) {
	fu.indexOf(t) > -1 || (fu.push(t), console.warn(e));
}
function Su(t, e) {
	let i = [];
		...
		for (let i of n.split(".")) {
			...
			n
				? "function" == typeof n
					? e.length
						? (e = e.map(n))
						: bu(i, `Modifier ${i} used at start of tag`)
					: e.length
						? bu(i, `Tag ${i} used as modifier`)
						: (e = Array.isArray(n) ? n : [n])
				: bu(i, `Unknown highlighting tag ${i}`);
		}
...
class Qu {
	...
	tokenBefore(t) {
		let e = Rc(this.state).resolveInner(this.pos, -1);
...
function ku(t, e) {
	return (i) => {
		for (let e = Rc(i.state).resolveInner(i.pos, -1); e; e = e.parent) {
...
class Zu {
	...
	map(t) {
		let e = t.mapPos(this.from, -1, Sn.TrackDel),
			i = t.mapPos(this.to, 1, Sn.TrackDel);
		return null == e || null == i ? null : new Zu(this.field, e, i);
	}
}
class _u {
	constructor(t, e) {
	...
	static parse(t) {
		...
		for (let s of t.split(/\r\n?|\n/)) {
			for (
				...
				r.push(new Pu(a, n.length, e.index, e.index + l.length)),
...
let Tu = Js.widget({
	...
	Xu = Js.mark({ class: "cm-snippetField" });
class Cu {
	constructor(t, e) {
		(this.ranges = t),
			(this.active = e),
			(this.deco = Js.set(
				t.map((t) => (t.from == t.to ? Tu : Xu).range(t.from, t.to)),
			));
	}
	map(t) {
		let e = [];
...
const Au = hr.define({ map: (t, e) => t && t.map(e) }),
	Ru = hr.define(),
	Mu = Ln.define({
		create: () => null,
		update(t, e) {
			for (let i of e.effects) {
				if (i.is(Au)) return i.value;
				if (i.is(Ru) && t) return new Cu(t.ranges, i.value);
			}
			return (
		...
		provide: (t) => Nl.decorations.from(t, (t) => (t ? t.deco : Js.none)),
	});
function ju(t, e) {
	return Tn.create(
		t.filter((t) => t.field == e).map((t) => Tn.range(t.from, t.to)),
	);
}
function Eu(t) {
	let e = _u.parse(t);
	return (t, i, n, r) => {
		let { text: s, ranges: o } = e.instantiate(t.state, n),
			...
			l = {
				changes: { from: n, to: r == a.from ? a.to : r, insert: ln.of(s) },
				scrollIntoView: !0,
				annotations: i ? [vu.of(i), cr.userEvent.of("input.complete")] : void 0,
			};
		if ((o.length && (l.selection = ju(o, 0)), o.some((t) => t.field > 0))) {
			let e = new Cu(o, 0),
				i = (l.effects = [Au.of(e)]);
			void 0 === t.state.field(Mu, !1) &&
				i.push(hr.appendConfig.of([Mu, Wu, zu, $u]));
		}
...
function qu(t) {
	return ({ state: e, dispatch: i }) => {
		...
		return (
			i(
				e.update({
					selection: ju(n.ranges, r),
					effects: Au.of(s ? null : new Cu(n.ranges, r)),
					scrollIntoView: !0,
				}),
			),
			!0
...
const Vu = [
		{ key: "Tab", run: qu(1), shift: qu(-1) },
		{
			key: "Escape",
			run: ({ state: t, dispatch: e }) =>
				!!t.field(Mu, !1) && (e(t.update({ effects: Au.of(null) })), !0),
		},
	],
	Lu = An.define({ combine: (t) => (t.length ? t[0] : Vu) }),
	Wu = In.highest(nh.compute([Lu], (t) => t.facet(Lu)));
function Yu(t, e) {
	return Object.assign(Object.assign({}, e), { apply: Eu(t) });
}
const zu = Nl.domEventHandlers({
		mousedown(t, e) {
			let i,
				n = e.state.field(Mu, !1);
			...
			return (
				!(!r || r.field == n.active) &&
				(e.dispatch({
					selection: ju(n.ranges, r.field),
					effects: Au.of(
						n.ranges.some((t) => t.field > r.field)
							? new Cu(n.ranges, r.field)
							: null,
					),
					scrollIntoView: !0,
				}),
	...
	Du = new (class extends yr {})();
(Du.startSide = 1), (Du.endSide = -1);
class Bu {
	static create(t, e, i, n, r) {
		return new Bu(t, e, i, (n + (n << 8) + t + (e << 4)) | 0, r, [], []);
	}
	constructor(t, e, i, n, r, s, o) {
		(this.type = t),
			(this.value = e),
			...
			(this.children = s),
			(this.positions = o),
			(this.hashProp = [[fh.contextHash, n]]);
	}
	addChild(t, e) {
		t.prop(fh.contextHash) != this.hash &&
			(t = new yh(t.type, t.children, t.positions, t.length, this.hashProp)),
	...
	toTree(t, e = this.end) {
		...
		return (
			...
			new yh(
				...
				makeTree: (t, e, i) => new yh(mh.none, t, e, i, this.hashProp),
			})
		);
	}
}
...
function Nu(t, e, i) {
	...
	let n = (t.type == Iu.OrderedList ? sO : rO)(i, e, !1);
	return (
		n > 0 &&
		(t.type != Iu.BulletList || iO(i, e, !1) < 0) &&
...
const Hu = {
	[Iu.Blockquote]: (t, e, i) =>
		62 == i.next &&
		(i.markers.push(
			AO(Iu.QuoteMark, e.lineStart + i.pos, e.lineStart + i.pos + 1),
		),
		i.moveBase(i.pos + (Fu(i.text.charCodeAt(i.pos + 1)) ? 2 : 1)),
...
function Ku(t, e = 0) {
	for (; e < t.length && Fu(t.charCodeAt(e)); ) e++;
	return e;
}
function Ju(t, e, i) {
	for (; e > i && Fu(t.charCodeAt(e - 1)); ) e--;
	return e;
}
function tO(t) {
...
function iO(t, e, i) {
	...
	for (let e = t.pos + 1; e < t.text.length; e++) {
		...
		if (i == t.next) n++;
		else if (!Fu(i)) return -1;
	}
	return (i &&
		45 == t.next &&
		aO(t) > -1 &&
		t.depth == e.stack.length &&
		e.parser.leafBlockParsers.indexOf(bO.SetextHeading) > -1) ||
		n < 3
		? -1
		: 1;
}
...
function rO(t, e, i) {
	return (45 != t.next && 43 != t.next && 42 != t.next) ||
		(t.pos != t.text.length - 1 && !Fu(t.text.charCodeAt(t.pos + 1))) ||
		!(!i || nO(e, Iu.BulletList) || t.skipSpace(t.pos + 2) < t.text.length)
		? -1
		: 1;
}
function sO(t, e, i) {
	...
	return n == t.pos ||
		n > t.pos + 9 ||
		(46 != r && 41 != r) ||
		(n < t.text.length - 1 && !Fu(t.text.charCodeAt(n + 1))) ||
		(i &&
			!nO(e, Iu.OrderedList) &&
...
function aO(t) {
	...
	for (; e < t.text.length && t.text.charCodeAt(e) == t.next; ) e++;
	let i = e;
	for (; e < t.text.length && Fu(t.text.charCodeAt(e)); ) e++;
...
function OO(t, e, i) {
	...
	for (let t = 0, e = uO.length - (i ? 1 : 0); t < e; t++)
		if (uO[t][0].test(n)) return t;
	return -1;
}
function dO(t, e) {
...
function fO(t, e, i) {
	let n = t.length - 1;
	n >= 0 && t[n].to == e && t[n].type == Iu.CodeText
		? (t[n].to = i)
		: t.push(AO(Iu.CodeText, e, i));
}
const pO = {
	...
	IndentedCode(t, e) {
		...
		let n = e.findColumn(i),
			...
			o = [],
			a = [];
		for (fO(o, r, s); t.nextLine() && e.depth >= t.stack.length; )
			if (e.pos == e.text.length) {
				fO(a, t.lineStart - 1, t.lineStart);
				...
				if (e.indent < i) break;
				{
					if (a.length) {
						for (let t of a)
							t.type == Iu.CodeText ? fO(o, t.from, t.to) : o.push(t);
						a = [];
					}
					fO(o, t.lineStart - 1, t.lineStart);
		...
		return (
			a.length &&
				((a = a.filter((t) => t.type != Iu.CodeText)),
				a.length && (e.markers = a.concat(e.markers))),
			t.addNode(t.buffer.writeElements(o, -r).finish(Iu.CodeBlock, s - r), r),
			!0
		);
	},
	FencedCode(t, e) {
		...
		let n = t.lineStart + e.pos,
			...
			s = i - e.pos,
			o = e.skipSpace(i),
			a = Ju(e.text, e.text.length, o),
			l = [AO(Iu.CodeMark, n, n + s)];
		o < a && l.push(AO(Iu.CodeInfo, t.lineStart + o, t.lineStart + a));
		for (let i = !0; t.nextLine() && e.depth >= t.stack.length; i = !1) {
			...
			if (n - e.pos >= s && e.skipSpace(n) == e.text.length) {
				...
				l.push(AO(Iu.CodeMark, t.lineStart + e.pos, t.lineStart + n)),
					t.nextLine();
				break;
			}
			{
				i || fO(l, t.lineStart - 1, t.lineStart);
				for (let t of e.markers) l.push(t);
		...
		return (
			t.addNode(
				t.buffer
					.writeElements(l, -n)
					.finish(Iu.FencedCode, t.prevLineEnd() - n),
				n,
			),
			!0
		);
	...
	Blockquote(t, e) {
		...
		return (
			!(i < 0) &&
			(t.startContext(Iu.Blockquote, e.pos),
			t.addNode(Iu.QuoteMark, t.lineStart + e.pos, t.lineStart + e.pos + 1),
			e.moveBase(e.pos + i),
			null)
		);
	},
	HorizontalRule(t, e) {
		if (iO(e, t, !1) < 0) return !1;
		let i = t.lineStart + e.pos;
		return t.nextLine(), t.addNode(Iu.HorizontalRule, i), !0;
	},
	BulletList(t, e) {
		let i = rO(e, t, !1);
		if (i < 0) return !1;
		t.block.type != Iu.BulletList &&
			t.startContext(Iu.BulletList, e.basePos, e.next);
		let n = dO(e, e.pos + 1);
		return (
			t.startContext(Iu.ListItem, e.basePos, n - e.baseIndent),
			t.addNode(Iu.ListMark, t.lineStart + e.pos, t.lineStart + e.pos + i),
			e.moveBaseColumn(n),
			null
		);
	},
	...
	ATXHeading(t, e) {
		...
		let n = e.pos,
			r = t.lineStart + n,
			s = Ju(e.text, e.text.length, n),
			o = s;
		for (; o > n && e.text.charCodeAt(o - 1) == e.next; ) o--;
		(o != s && o != n && Fu(e.text.charCodeAt(o - 1))) || (o = e.text.length);
		let a = t.buffer
			.write(Iu.HeaderMark, 0, i)
			.writeElements(
				t.parser.parseInline(e.text.slice(n + i + 1, o), r + i + 1),
				-r,
			);
		o < e.text.length && a.write(Iu.HeaderMark, o - n, s - n);
		let l = a.finish(Iu.ATXHeading1 - 1 + i, e.text.length - n);
...
class gO {
	...
	finish(t, e) {
		return (
			...
			Ku(e.content, this.pos) == e.content.length &&
	...
	complete(t, e, i) {
		return (
			t.addLeafElement(
				e,
				AO(Iu.LinkReference, this.start, this.start + i, this.elts),
			),
			!0
		);
	}
	...
	advance(t) {
		for (;;) {
			if (-1 == this.stage) return -1;
			if (0 == this.stage) {
				if (!this.nextStage(BO(t, this.pos, this.start, !0))) return -1;
				if (58 != t.charCodeAt(this.pos)) return (this.stage = -1);
				this.elts.push(
					AO(Iu.LinkMark, this.pos + this.start, this.pos + this.start + 1),
				),
					this.pos++;
			} else {
				if (1 != this.stage) {
					if (2 == this.stage) {
						let e = Ku(t, this.pos),
							i = 0;
						if (e > this.pos) {
							let n = DO(t, e, this.start);
							if (n) {
								let e = mO(t, n.to - this.start);
								e > 0 && (this.nextStage(n), (i = e));
							}
						}
						return i || (i = mO(t, this.pos)), i > 0 && i < t.length ? i : -1;
					}
					return mO(t, this.pos);
				}
				if (!this.nextStage(zO(t, Ku(t, this.pos), this.start))) return -1;
			}
		}
	}
}
...
class xO {
	nextLine(t, e, i) {
		let n = e.depth < t.stack.length ? -1 : aO(e),
			r = e.next;
		if (n < 0) return !1;
		let s = AO(Iu.HeaderMark, t.lineStart + e.pos, t.lineStart + n);
		return (
			t.nextLine(),
			t.addLeafElement(
				i,
				AO(
					61 == r ? Iu.SetextHeading1 : Iu.SetextHeading2,
					i.start,
					t.prevLineEnd(),
...
const bO = {
		LinkReference: (t, e) => (91 == e.content.charCodeAt(0) ? new gO(e) : null),
		SetextHeading: () => new xO(),
	},
	SO = [
		(t, e) => oO(e) >= 0,
		(t, e) => tO(e) >= 0,
...
class yO {
		...
		(this.parser = t),
			...
			(this.lineStart =
				...
				this.absoluteLineEnd =
					n[0].from),
			(this.block = Bu.create(Iu.Document, 0, this.lineStart, 0, 0)),
			(this.stack = [this.block]),
			(this.fragments = i.length ? new NO(i, e) : null),
			this.readLine();
	}
	get parsedPos() {
	...
	advance() {
		...
		let e = new Uu(this.lineStart + t.pos, t.text.slice(t.pos));
	...
	reuseFragment(t) {
		...
		return (
			...
			(this.lineStart = HO(this.absoluteLineStart, this.ranges)),
			this.moveRangeI(),
	...
	readLine() {
		...
		for (
			...
			if (!i) throw new Error("Unhandled block context " + Iu[e.type]);
			if (!i(e, this, t)) break;
			t.forward();
		}
	}
	...
	addLeafElement(t, e) {
		this.addNode(
			this.buffer
				.writeElements(UO(e.children, t.marks), -e.from)
	...
	finishLeaf(t) {
		...
		let e = UO(this.parser.parseInline(t.content, t.start), t.marks);
		this.addNode(
			this.buffer
				.writeElements(e, -t.start)
				.finish(Iu.Paragraph, t.content.length),
			t.start,
		);
	}
	elt(t, e, i, n) {
		return "string" == typeof t
			? AO(this.parser.getNodeType(t), e, i, n)
			: new CO(t, e);
	}
	get buffer() {
		return new TO(this.parser.nodeSet);
	}
}
function wO(t, e, i, n, r) {
	...
	return (
		h(i.to + n, !1),
		new yh(i.type, o, a, i.to + n - l, i.tree ? i.tree.propValues : void 0)
	);
}
class kO extends Yh {
	...
	configure(t) {
			...
			for (let i of e.defineNodes) {
				...
				let l = r.length,
					h = o
						? ["Block", "BlockContext"]
						: s
							? l >= Iu.ATXHeading1 && l <= Iu.SetextHeading2
								? ["Block", "LeafBlock", "Heading"]
								: ["Block", "LeafBlock"]
							: void 0;
				r.push(mh.define({ id: l, name: e, props: h && [[fh.group, h]] })),
					a &&
						(t || (t = {}),
						Array.isArray(a) || a instanceof sc
							? (t[e] = a)
							: Object.assign(t, a));
			}
			(i = new xh(r)), t && (i = i.extend(lc(t)));
		}
		if ((vO(e.props) && (i = i.extend(...e.props)), vO(e.remove)))
		...
		return e.wrap && (c = c.concat(e.wrap)), new kO(i, r, s, o, h, n, a, l, c);
	}
	getNodeType(t) {
		...
		props:
			e >= Iu.Escape
				...
				: [
						[
							fh.group,
							e in Hu ? ["Block", "BlockContext"] : ["Block", "LeafBlock"],
						],
					],
		top: "Document" == t,
	});
...
function AO(t, e, i, n) {
	return new XO(t, e, i, n);
}
const RO = { resolve: "Emphasis", mark: "EmphasisMark" },
	MO = { resolve: "Emphasis", mark: "EmphasisMark" },
	jO = {},
	EO = {};
class qO {
	constructor(t, e, i, n) {
...
const WO = {
	Escape(t, e, i) {
		...
		let n = t.char(i + 1);
		for (let e = 0; e < 32; e++)
			if (VO.charCodeAt(e) == n) return t.append(AO(Iu.Escape, i, i + 2));
		return -1;
	},
	Entity(t, e, i) {
		if (38 != e) return -1;
		let n = /^(?:#\d+|#x[a-f\d]+|\w+);/i.exec(t.slice(i + 1, i + 31));
		return n ? t.append(AO(Iu.Entity, i, i + 1 + n[0].length)) : -1;
	},
	InlineCode(t, e, i) {
		...
		for (; n < t.end; n++)
			if (96 == t.char(n)) {
				if ((s++, s == r && 96 != t.char(n + 1)))
					return t.append(
						AO(Iu.InlineCode, i, n + 1, [
							AO(Iu.CodeMark, i, i + r),
							AO(Iu.CodeMark, n + 1 - r, n + 1),
						]),
					);
			} else s = 0;
		return -1;
	...
	HTMLTag(t, e, i) {
		...
		if (r)
			return t.append(
				AO(Iu.Autolink, i, i + 1 + r[0].length, [
					AO(Iu.LinkMark, i, i + 1),
					AO(Iu.URL, i + 1, i + r[0].length),
					AO(Iu.LinkMark, i + r[0].length, i + 1 + r[0].length),
				]),
			);
		let s = /^!--[^>](?:-[^-]|[^-])*?-->/i.exec(n);
		if (s) return t.append(AO(Iu.Comment, i, i + 1 + s[0].length));
		let o = /^\?[^]*?\?>/.exec(n);
		if (o)
			return t.append(AO(Iu.ProcessingInstruction, i, i + 1 + o[0].length));
		let a =
			/^(?:![A-Z][^]*?>|!\[CDATA\[[^]*?\]\]>|\/\s*[a-zA-Z][\w-]*\s*>|\s*[a-zA-Z][\w-]*(\s+[a-zA-Z:_][\w-.:]*(?:\s*=\s*(?:[^\s"'=<>`]+|'[^']*'|"[^"]*"))?)*\s*(\/\s*)?>)/.exec(
				n,
			);
		return a ? t.append(AO(Iu.HTMLTag, i, i + 1 + a[0].length)) : -1;
	},
	Emphasis(t, e, i) {
		...
		let r = t.slice(i - 1, i),
			...
			O = c && (42 == e || !u || o),
			d = u && (42 == e || !c || a);
		return t.append(new qO(95 == e ? RO : MO, i, n, (O ? 1 : 0) | (d ? 2 : 0)));
	},
	HardBreak(t, e, i) {
		if (92 == e && 10 == t.char(i + 1))
			return t.append(AO(Iu.HardBreak, i, i + 2));
		if (32 == e) {
			let e = i + 1;
			for (; 32 == t.char(e); ) e++;
			if (10 == t.char(e) && e >= i + 2)
				return t.append(AO(Iu.HardBreak, i, e + 1));
		}
		return -1;
	},
	Link: (t, e, i) => (91 == e ? t.append(new qO(jO, i, i + 1, 1)) : -1),
	Image: (t, e, i) =>
		33 == e && 91 == t.char(i + 1) ? t.append(new qO(EO, i, i + 2, 1)) : -1,
	LinkEnd(t, e, i) {
		if (93 != e) return -1;
		for (let e = t.parts.length - 1; e >= 0; e--) {
			let n = t.parts[e];
			if (n instanceof qO && (n.type == jO || n.type == EO)) {
				if (
					!n.side ||
				...
				if (n.type == jO)
					for (let i = 0; i < e; i++) {
						let e = t.parts[i];
						e instanceof qO && e.type == jO && (e.side = 0);
					}
				return s.to;
			}
		}
...
function YO(t, e, i, n, r) {
	let { text: s } = t,
		...
		a = r;
	if (
		(e.unshift(AO(Iu.LinkMark, n, n + (i == Iu.Image ? 2 : 1))),
		e.push(AO(Iu.LinkMark, r - 1, r)),
		40 == o)
	) {
		let i,
			n = t.skipSpace(r + 1),
			o = zO(s, n - t.offset, t.offset);
		o &&
			((n = t.skipSpace(o.to)),
			n != o.to &&
				((i = DO(s, n - t.offset, t.offset)), i && (n = t.skipSpace(i.to)))),
			41 == t.char(n) &&
				(e.push(AO(Iu.LinkMark, r, r + 1)),
				(a = n + 1),
				o && e.push(o),
				i && e.push(i),
				e.push(AO(Iu.LinkMark, n, a)));
	} else if (91 == o) {
		let i = BO(s, r - t.offset, t.offset, !1);
		i && (e.push(i), (a = i.to));
	}
	return AO(i, n, a, e);
}
function zO(t, e, i) {
	if (60 == t.charCodeAt(e)) {
		for (let n = e + 1; n < t.length; n++) {
			...
			if (62 == r) return AO(Iu.URL, e + i, n + 1 + i);
	...
	}
	{
		...
		return r > e ? AO(Iu.URL, e + i, r + i) : r == t.length && null;
	}
}
function DO(t, e, i) {
	...
	for (let n = e + 1, s = !1; n < t.length; n++) {
		...
		if (s) s = !1;
			...
			if (o == r) return AO(Iu.LinkTitle, e + i, n + 1 + i);
			92 == o && (s = !0);
		}
	}
	return null;
...
function BO(t, e, i, n) {
	for (let r = !1, s = e + 1, o = Math.min(t.length, s + 999); s < o; s++) {
		...
		if (r) r = !1;
			...
			if (93 == o) return !n && AO(Iu.LinkLabel, e + i, s + 1 + i);
			if ((n && !Fu(o) && (n = !1), 91 == o)) return !1;
			92 == o && (r = !0);
		}
	}
	return null;
...
class IO {
	...
	addDelimiter(t, e, i, n, r) {
		return this.append(new qO(t, e, i, (n ? 1 : 0) | (r ? 2 : 0)));
	}
	get hasOpenLink() {
		for (let t = this.parts.length - 1; t >= 0; t--) {
			let e = this.parts[t];
			if (e instanceof qO && (e.type == jO || e.type == EO)) return !0;
		}
		return !1;
	}
	addElement(t) {
	...
	resolveMarkers(t) {
		for (let e = t; e < this.parts.length; e++) {
			let i = this.parts[e];
			if (!(i instanceof qO && i.type.resolve && 2 & i.side)) continue;
			let n,
				r = i.type == RO || i.type == MO,
				s = i.to - i.from,
				o = e - 1;
			for (; o >= t; o--) {
				let t = this.parts[o];
			...
			for (let t = o + 1; t < e; t++)
				this.parts[t] instanceof XO && l.push(this.parts[t]),
					(this.parts[t] = null);
			i.type.mark && l.push(this.elt(i.type.mark, i.from, c));
			let u = this.elt(a, h, c, l);
			(this.parts[o] =
				r && n.from != h ? new qO(n.type, n.from, h, n.side) : null),
				(this.parts[e] =
					r && i.to != c ? new qO(i.type, c, i.to, i.side) : null)
	...
	findOpeningDelimiter(t) {
		for (let e = this.parts.length - 1; e >= 0; e--) {
			let i = this.parts[e];
			if (i instanceof qO && i.type == t) return e;
		}
		return null;
	}
	takeContent(t) {
	...
	skipSpace(t) {
		return Ku(this.text, t - this.offset) + this.offset;
	}
	elt(t, e, i, n) {
		return "string" == typeof t
			? AO(this.parser.getNodeType(t), e, i, n)
...
function UO(t, e) {
	...
	for (let t of e) {
		...
		if (n < i.length && i[n].from < t.from) {
			let e = i[n];
			e instanceof XO &&
				(i[n] = new XO(e.type, e.from, e.to, UO(e.children, [t])));
		} else i.splice(n++, 0, t);
	}
	return i;
}
const GO = [Iu.CodeBlock, Iu.ListItem, Iu.OrderedList, Iu.BulletList];
let NO = class {
	constructor(t, e) {
		(this.fragments = t),
			(this.input = e),
	...
	matches(t) {
		...
		return e && e.prop(fh.contextHash) == t;
	}
	takeNodes(t) {
		let e = this.cursor,
		...
		for (;;) {
			...
			let r = HO(e.from - i, t.ranges);
			if (e.to - i <= t.ranges[t.rangeI].to) t.addNode(e.tree, r);
			else {
				let i = new yh(
					t.parser.nodeSet.types[Iu.Paragraph],
					[],
					[],
					0,
					t.block.hashProp,
...
const FO = lc({
	...
	KO = new kO(
		new xh(ZO).extend(FO),
		Object.keys(pO).map((t) => pO[t]),
		Object.keys(pO).map((t) => bO[t]),
		Object.keys(pO),
		SO,
		Hu,
		Object.keys(WO).map((t) => WO[t]),
		Object.keys(WO),
		[],
	);
function JO(t, e, i) {
...
const td = { resolve: "Strikethrough", mark: "StrikethroughMark" },
	ed = {
		defineNodes: [
			{
				name: "Strikethrough",
		...
		if (null == this.rows) {
			...
			if (
				...
				(45 == e.next || 58 == e.next || 124 == e.next) &&
					rd.test((n = e.text.slice(e.pos))))
			) {
				let r = [];
				id(t, i.content, 0, r, i.start) == id(t, n, e.pos) &&
					(this.rows = [
			...
			let i = [];
			id(t, e.text, e.pos, i, t.lineStart),
				this.rows.push(
					t.elt(
						"TableRow",
						t.lineStart + e.pos,
...
const od = {
	...
	parseBlock: [
		{
			name: "Table",
			leaf: (t, e) => (nd(e.content, 0) ? new sd() : null),
			endLeaf(t, e, i) {
				if (i.parsers.some((t) => t instanceof sd) || !nd(e.text, e.basePos))
					return !1;
				let n = t.peekLine();
				return rd.test(n) && id(t, e.text, e.basePos) == id(t, n, e.basePos);
			},
...
const ld = {
	...
	hd = /(www\.)|(https?:\/\/)|([\w.+-]{1,100}@)|(mailto:|xmpp:)/gy,
	cd = /[\w-]+(\.[\w-]+)+(\/[^\s<]*)?/gy,
	ud = /[\w-]+\.[\w-]+($|\/)/,
	Od = /[\w.+-]+@[\w-]+(\.[\w.-]+)+/gy,
	dd = /\/[a-zA-Z\d@.]+/gy;
					...
					if (r[1] || r[2]) {
						if (
							((s = (function (t, e) {
								cd.lastIndex = e;
								let i = cd.exec(t);
								if (!i || ud.exec(i[0])[0].indexOf("_") > -1) return -1;
								let n = e + i[0].length;
								for (;;) {
									let i,
										r = t[n - 1];
...
function md(t, e, i) {
	return (n, r, s) => {
		...
		for (let r = s + 1; r < n.end; r++) {
			...
			if ((92 == a && o.push(n.elt("Escape", r, 2 + r++)), Fu(a))) break;
		}
		return -1;
	};
}
const xd = {
		...
		parseInline: [
			{ name: "Superscript", parse: md(94, "Superscript", "SuperscriptMark") },
		],
	},
	bd = {
		defineNodes: [
		...
		parseInline: [
			{ name: "Subscript", parse: md(126, "Subscript", "SubscriptMark") },
		],
	},
	Sd = {
...
class Qd {
	...
	updateContext(t) {
		if (t != this.curContext.context) {
			let e = new yd(this.curContext.tracker, t);
...
class kd {
	...
	static create(t, e = t.bufferBase + t.buffer.length) {
		return new kd(t, e, e - t.bufferBase);
	}
	maybeNext() {
...
class _d {
	...
	token(t, e) {
		let { parser: i } = e.p;
		Cd(this.data, t, e, this.id, i.data, i.tokenPrecTable);
	}
}
_d.prototype.contextual = _d.prototype.fallback = _d.prototype.extend = !1;
class Td {
	constructor(t, e, i) {
		(this.precTable = e),
			(this.elseToken = i),
			(this.data = "string" == typeof t ? vd(t) : t);
	}
	token(t, e) {
		let i = t.pos,
			n = 0;
		for (;;) {
			...
			if (
				(Cd(this.data, t, e, 0, this.data, this.precTable), t.token.value > -1)
			)
				break;
...
Td.prototype.contextual = _d.prototype.fallback = _d.prototype.extend = !1;
class Xd {
	constructor(t, e = {}) {
		(this.token = t),
...
let jd = null;
function Ed(t, e, i) {
	let n = t.cursor(Qh.IncludeAnonymous);
	for (n.moveTo(e); ; )
		...
		if (t) {
			for (
				this.safeFrom = t.openStart
					? Ed(t.tree, t.from + t.offset, 1) - t.offset
					: t.from,
					this.safeTo = t.openEnd
						? Ed(t.tree, t.to + t.offset, -1) - t.offset
						: t.to;
				this.trees.length;
			)
...
class Vd {
	constructor(t, e) {
		(this.stream = e),
			...
			(this.mainToken = null),
			(this.actions = []),
			(this.tokens = t.tokenizers.map((t) => new $d()));
	}
	getActions(t) {
		let e = 0,
			i = null,
			...
			for (let a = s.stateSlot(r, t ? 2 : 1); ; a += 3) {
				if (65535 == o[a]) {
					if (1 != o[a + 1]) {
						0 == n &&
							2 == o[a + 1] &&
							(n = this.putAction(Id(o, a + 2), e, i, n));
						break;
					}
					a = Id(o, a + 2);
				}
				o[a] == e && (n = this.putAction(Id(o, a + 1), e, i, n));
			}
		return n;
	}
}
class Ld {
	constructor(t, e, i, n) {
		(this.parser = t),
			...
			(this.stream = new Zd(e, n)),
			(this.tokens = new Vd(t, this.stream)),
			(this.topTerm = t.top[1]);
		let { from: r } = n[0];
		(this.stacks = [Qd.start(this, t.top[0], r)]),
			(this.fragments =
	...
	advance() {
		...
		if (!r.length) {
			...
			if (e)
				return (
					Md && console.log("Finish with " + this.stackID(e)),
					this.stackToTree(e)
				);
		...
		if (this.recovering && t) {
			...
			if (i)
				return (
					Md && console.log("Force-finish " + this.stackID(i)),
			...
			for (let o = this.fragments.nodeAt(n); o; ) {
				let n =
					this.parser.nodeSet.types[o.type.id] == o.type
						...
						: -1;
				if (n > -1 && o.length && (!e || (o.prop(fh.contextHash) || 0) == i))
					return (
						t.useNode(o, n),
						Md &&
							console.log(
				...
				if (!(o instanceof yh) || 0 == o.children.length || o.positions[0] > 0)
					break;
				let a = o.children[0];
				if (!(a instanceof yh && 0 == o.positions[0])) break;
				o = a;
			}
		}
		...
		for (let s = 0; s < t.length; s++) {
			...
			if (o.deadEnd) {
				...
				if (
					((r = !0),
					o.restart(),
					Md && console.log(h + this.stackID(o) + " (restarted)"),
			...
			for (let t = 0; c.forceReduce() && t < 10; t++) {
				if (
					(Md && console.log(u + this.stackID(c) + " (via force-reduce)"),
			...
			for (let t of o.recoverByInsert(a))
				Md && console.log(h + this.stackID(t) + " (via recover-insert)"),
	...
	stackID(t) {
		let e = (jd || (jd = new WeakMap())).get(t);
		return (
			e || jd.set(t, (e = String.fromCodePoint(this.nextStackID++))), e + t
		);
	}
}
function Wd(t, e) {
...
class Dd {
	constructor(t) {
		(this.start = t.start),
			(this.shift = t.shift || zd),
			(this.reduce = t.reduce || zd),
			(this.reuse = t.reuse || zd),
			(this.hash = t.hash || (() => 0)),
...
class Bd extends Yh {
	constructor(t) {
		...
		(this.nodeSet = new xh(
			...
			(this.strict = !1),
			(this.bufferLength = uh);
		let s = vd(t.tokenData);
		...
		(this.specializers = this.specializerSpecs.map(Ud)),
			(this.states = vd(t.states, Uint32Array)),
			(this.data = vd(t.stateData)),
			(this.goto = vd(t.goto)),
			(this.maxTerm = t.maxTerm),
			(this.tokenizers = t.tokenizers.map((t) =>
				"number" == typeof t ? new _d(s, t) : t,
			)),
	...
	hasAction(t, e) {
		...
		for (let n = 0; n < 2; n++)
			for (let r, s = this.stateSlot(t, n ? 2 : 1); ; s += 3) {
				if (65535 == (r = i[s])) {
					if (1 != i[s + 1]) {
						if (2 == i[s + 1]) return Id(i, s + 2);
						break;
					}
					r = i[(s = Id(i, s + 2))];
				}
				if (r == e || 0 == r) return Id(i, s + 1);
			}
		return 0;
	}
	stateSlot(t, e) {
	...
	configure(t) {
		let e = Object.assign(Object.create(Bd.prototype), this);
		...
		return (
			...
			t.specializers &&
				...
				(e.specializerSpecs = this.specializerSpecs.map((i, n) => {
					...
					return (e.specializers[n] = Ud(s)), s;
				}))),
...
function ef(t, e) {
	...
	return (
		(Jd = t),
		(tf = i),
		(Kd = r ? r.toLowerCase() : n == nf || n == rf ? void 0 : null)
	);
}
const nf = 63,
	rf = 33;
...
const of = [6, 10, 7, 8, 9],
	af = new Dd({
		start: null,
		shift: (t, e, i, n) => (of.indexOf(e) > -1 ? new sf(ef(n, 1) || "", t) : t),
		reduce: (t, e) => (20 == e && t ? t.parent : t),
		reuse(t, e, i, n) {
			let r = e.type.id;
			return 6 == r || 36 == r ? new sf(ef(n, 1) || "", t) : t;
		},
		strict: !1,
	}),
	lf = new Xd(
		(t, e) => {
			...
			if (i) {
				...
				if (r && Nd[r]) return t.acceptToken(57, -2);
				...
				if (Gd.hasOwnProperty(n)) return t.acceptToken(10);
				r && Hd[r] && Hd[r][n] ? t.acceptToken(57, -1) : t.acceptToken(6);
			}
		},
		{ contextual: !0 },
	),
...
const Of = uf("script", 54, 1),
	...
	gf = Bd.deserialize({
		...
		tokenizers: [Of, df, ff, cf, lf, hf, 0, 1, 2, 3, 4, 5],
...
function bf(t, e, i) {
	let n;
	for (let r of i)
		if (!r.attrs || r.attrs(n || (n = mf(t.node.parent.firstChild, e))))
...
function Sf(t = [], e = []) {
	...
	return Dh((t, e) => {
		let a = t.type.id;
		if (28 == a) return bf(t, e, i);
		if (31 == a) return bf(t, e, n);
		if (34 == a) return bf(t, e, r);
		if (20 == a && s.length) {
			let i,
				n = t.node,
				r = n.firstChild,
			...
			if (o)
				for (let t of s)
					if (t.tag == o && (!t.attrs || t.attrs(i || (i = mf(r, e))))) {
						let e = n.lastChild,
		...
		if (o && 23 == a) {
			...
			if ((i = n.firstChild)) {
				...
				if (t)
					for (let i of t) {
						if (i.tagName && i.tagName != xf(n.parent, e)) continue;
						let t = n.lastChild;
						if (26 == t.type.id) {
							let e = t.from + 1,
								n = t.lastChild,
...
const kf = new Xd((t, e) => {
	...
	$f = new Xd((t) => {
		if (!Qf.includes(t.peek(-1))) {
			let { next: e } = t;
			if ((37 == e && (t.advance(), t.acceptToken(1)), yf(e))) {
				do {
					t.advance();
				} while (yf(t.next) || wf(t.next));
				t.acceptToken(1);
			}
		}
	}),
	...
	Tf = { __proto__: null, not: 134, only: 134 },
	Xf = Bd.deserialize({
		version: 14,
		states:
		...
		tokenizers: [
			...
			3,
			4,
			new Td("m~RRYZ[z{a~~g~aO#`~~dP!P!Qg~lO#a~~", 28, 107),
		],
		topRules: { StyleSheet: [0, 4], Styles: [1, 87] },
		specialized: [
			{ term: 102, get: (t) => Zf[t] || -1 },
			{ term: 59, get: (t) => _f[t] || -1 },
			{ term: 103, get: (t) => Tf[t] || -1 },
		],
		tokenPrec: 1246,
	});
let Cf = null;
function Af() {
	if (!Cf && "object" == typeof document && document.body) {
		...
		Cf = e.sort().map((t) => ({ type: "property", label: t, apply: t + ": " }));
	}
	return Cf || [];
}
const Rf = [
...
function zf(t, e, i) {
	if (e.to - e.from > 4096) {
		...
		let r = [],
			s = new Set(),
			o = e.cursor(Qh.IncludeAnonymous);
		if (o.firstChild())
			do {
				for (let e of zf(t, o.node, i))
...
const Df = (t) => (e) => {
		...
		if (
			...
			return { from: r.from, options: Af(), validFor: qf };
		if ("ValueName" == r.name)
			return { from: r.from, options: Mf, validFor: qf };
		if ("PseudoClassName" == r.name)
			return { from: r.from, options: Rf, validFor: qf };
		if (
			t(r) ||
			((e.explicit || s) &&
				(function (t, e) {
		...
		if ("TagName" == r.name) {
			for (let { parent: t } = r; t; t = t.parent)
				if ("Block" == t.name)
					return { from: r.from, options: Af(), validFor: qf };
			return { from: r.from, options: jf, validFor: qf };
		}
		if ("AtKeyword" == r.name)
			return { from: r.from, options: Ef, validFor: qf };
		if (!e.explicit) return null;
		let o = r.resolve(n),
			a = o.childBefore(n);
		return a && ":" == a.name && "PseudoClassSelector" == o.name
			? { from: n, options: Rf, validFor: qf }
			: (a && ":" == a.name && "Declaration" == o.name) || "ArgList" == o.name
				? { from: n, options: Mf, validFor: qf }
				: "Block" == o.name || "Styles" == o.name
					? { from: n, options: Af(), validFor: qf }
					: null;
	},
	Bf = Df((t) => "VariableName" == t.name),
	If = Ac.define({
		name: "css",
		parser: Xf.configure({
			props: [
				Gc.add({ Declaration: Fc() }),
				Jc.add({ "Block KeyframeList": tu }),
			],
		}),
		languageData: {
...
function Uf() {
	return new Dc(If, If.data.of({ autocomplete: Bf }));
}
var Gf = Object.freeze({
	__proto__: null,
	css: Uf,
	cssCompletionSource: Bf,
	cssLanguage: If,
	defineCSSCompletionSource: Df,
});
const Nf = [
		9, 10, 11, 12, 13, 32, 133, 160, 5760, 8192, 8193, 8194, 8195, 8196, 8197,
		8198, 8199, 8200, 8201, 8202, 8232, 8233, 8239, 8287, 12288,
...
const ip = new Xd((t, e) => {
		...
		let i = 0;
		for (; Nf.indexOf(t.next) > -1; ) t.advance(), i++;
		if (ep(t.next, !0)) {
			for (t.advance(), i++; ep(t.next, !1); ) t.advance(), i++;
			for (; Nf.indexOf(t.next) > -1; ) t.advance(), i++;
			if (44 == t.next) return;
			for (let e = 0; ; e++) {
				if (7 == e) {
					if (!ep(t.next, !0)) return;
					break;
				}
	...
	np = lc({
		...
		"CallExpression/MemberExpression/PropertyName": $c.function(
			$c.propertyName,
		),
		"FunctionDeclaration/VariableDefinition": $c.function(
	...
	ap = Bd.deserialize({
		...
		tokenizers: [
			...
			new Td("j~RQYZXz{^~^O(O~~aP!P!Qd~iO(P~~", 25, 321),
		],
		topRules: {
			Script: [0, 7],
		...
		specialized: [
			{ term: 325, get: (t) => rp[t] || -1 },
			{ term: 341, get: (t) => sp[t] || -1 },
			{ term: 93, get: (t) => op[t] || -1 },
		],
		tokenPrec: 15116,
	}),
	lp = [
		Yu("function ${name}(${params}) {\n\t${}\n}", {
			label: "function",
			detail: "definition",
			type: "keyword",
		}),
		Yu("for (let ${index} = 0; ${index} < ${bound}; ${index}++) {\n\t${}\n}", {
			label: "for",
			detail: "loop",
			type: "keyword",
		}),
		Yu("for (let ${name} of ${collection}) {\n\t${}\n}", {
			label: "for",
			detail: "of loop",
			type: "keyword",
		}),
		...
		Yu('import {${names}} from "${module}"\n${}', {
			label: "import",
			detail: "named",
			type: "keyword",
		}),
		Yu('import ${name} from "${module}"\n${}', {
			label: "import",
			detail: "default",
			type: "keyword",
		}),
...
const dp = ["FunctionDeclaration"],
	fp = {
		FunctionDeclaration: Op("function"),
		ClassDeclaration: Op("class"),
		ClassExpression: () => !0,
		EnumDeclaration: Op("constant"),
		TypeAliasDeclaration: Op("type"),
		NamespaceDeclaration: Op("namespace"),
		VariableDefinition(t, e) {
			t.matchContext(dp) || e(t, "variable");
		},
		TypeDefinition(t, e) {
			e(t, "type");
		},
...
function pp(t, e) {
	...
	return (
		e.cursor(Qh.IncludeAnonymous).iterate((e) => {
			if (r) r = !1;
			else if (e.name) {
				let t = fp[e.name];
				if ((t && t(e, s)) || up.has(e.name)) return !1;
			} else if (e.to - e.from > 8192) {
				for (let i of pp(t, e.node)) n.push(i);
				return !1;
			}
		}),
		cp.set(e, n),
...
function xp(t) {
	let e = Rc(t.state).resolveInner(t.pos, -1);
	if (mp.indexOf(e.name) > -1) return null;
	let i =
		"VariableName" == e.name ||
		(e.to - e.from < 20 && gp.test(t.state.sliceDoc(e.from, e.to)));
	if (!i && !t.explicit) return null;
	let n = [];
	for (let i = e; i; i = i.parent)
		up.has(i.name) && (n = n.concat(pp(t.state.doc, i)));
	return { options: n, from: i ? e.from : t.pos, validFor: gp };
}
function bp(t, e, i) {
	var n;
	let r = [];
...
function Sp(t) {
	let e = (e) => t.state.doc.sliceString(e.from, e.to),
		i = Rc(t.state).resolveInner(t.pos, -1);
	return "PropertyName" == i.name
		? bp(e, i.parent, e(i))
		: ("." != i.name && "?." != i.name) || "MemberExpression" != i.parent.name
			? mp.indexOf(i.name) > -1
				? null
				: "VariableName" == i.name || (i.to - i.from < 20 && gp.test(e(i)))
					? { path: [], name: e(i) }
...
const Qp = Ac.define({
		...
		parser: ap.configure({
			props: [
				Gc.add({
					IfStatement: Fc({ except: /^\s*({|else\b)/ }),
					TryStatement: Fc({ except: /^\s*({|catch\b|finally\b)/ }),
					LabeledStatement: Hc,
					SwitchBody: (t) => {
						let e = t.textAfter,
							i = /^\s*\}/.test(e),
	...
	yp = {
		...
		facet: _c({ commentTokens: { block: { open: "{/*", close: "*/}" } } }),
	},
	wp = Qp.configure({ dialect: "ts" }, "typescript"),
	kp = Qp.configure({
		dialect: "jsx",
		props: [Tc.add((t) => (t.isTop ? [yp] : void 0))],
	}),
	vp = Qp.configure(
		{ dialect: "jsx ts", props: [Tc.add((t) => (t.isTop ? [yp] : void 0))] },
		"typescript",
	);
let $p = (t) => ({ label: t, type: "keyword" });
const Pp =
		"break case const continue default delete export extends false finally in instanceof let new return static super switch this throw true typeof var yield"
			...
			.map($p),
	Zp = Pp.concat(
		["declare", "implements", "private", "protected", "public"].map($p),
	);
function _p(t = {}) {
	let e = t.jsx ? (t.typescript ? vp : kp) : t.typescript ? wp : Qp,
		i = t.typescript ? hp.concat(Zp) : lp.concat(Pp);
	return new Dc(e, [
		Qp.data.of({ autocomplete: ku(mp, wu(i)) }),
		Qp.data.of({ autocomplete: xp }),
		t.jsx ? Cp : [],
	]);
}
function Tp(t, e, i = t.length) {
...
const Xp =
	...
	Cp = Nl.inputHandler.of((t, e, i, n, r) => {
		if (
			(Xp ? t.composing : t.compositionStarted) ||
			t.state.readOnly ||
			e != i ||
			(">" != n && "/" != n) ||
			!Qp.isActiveAt(t.state, e, -1)
		)
			return !1;
		let s = r(),
			{ state: o } = s,
...
function Rp(t, e, i) {
	let n = Ap(t.line, t.column, e, i),
		r = {
			from: n,
			to:
				null != t.endLine && 1 != t.endColumn
					? Ap(t.endLine, t.endColumn, e, i)
					: n,
			message: t.message,
...
var Mp = Object.freeze({
	...
	esLint: function (t, e) {
		return (
			...
			(i) => {
				let { state: n } = i,
					r = [];
				for (let { from: i, to: s } of Qp.findRegions(n)) {
					let o = n.doc.lineAt(i),
						a = { line: o.number - 1, col: i - o.from, pos: i };
					for (let o of t.verify(n.sliceDoc(i, s), e)) r.push(Rp(o, n.doc, a));
				}
				return r;
			}
		);
	...
	javascript: _p,
	javascriptLanguage: Qp,
	jsxLanguage: kp,
	localCompletionSource: xp,
	scopeCompletionSource: function (t) {
		...
		return (i) => {
			...
			return (
				...
				{ from: i.pos - n.name.length, options: s, validFor: gp }
			);
		};
	},
	snippets: lp,
	tsxLanguage: vp,
	typescriptLanguage: wp,
	typescriptSnippets: hp,
});
const jp = ["_blank", "_self", "_top", "_parent"],
	Ep = ["ascii", "utf-8", "utf-16", "latin1", "latin1"],
	qp = ["get", "post", "put", "delete"],
	Vp = [
	...
	Yp = {
		...
		b: Wp,
		base: { attrs: { href: null, target: jp } },
		bdi: Wp,
		bdo: Wp,
	...
	Dp =
		"beforeunload copy cut dragstart dragover dragleave dragenter dragend drag paste focus blur change click load mousedown mouseenter mouseleave mouseup keydown keyup resize scroll unload"
			.split(" ")
			.map((t) => "on" + t);
for (let t of Dp) zp[t] = null;
class Bp {
	constructor(t, e) {
		(this.tags = Object.assign(Object.assign({}, Yp), t)),
			(this.globalAttrs = Object.assign(Object.assign({}, zp), e)),
...
function Gp(t, e, i) {
	let n = i.tags[Ip(t, Up(e))];
	return (null == n ? void 0 : n.children) || i.allTags;
}
function Np(t, e) {
	let i = [];
	for (let n = Up(e); n && !n.type.isTop; n = Up(n.parent)) {
		let r = Ip(t, n);
...
function tg(t) {
	return Jp(Bp.default, t);
}
function eg(t) {
	let { extraTags: e, extraGlobalAttributes: i } = t,
		n = i || e ? new Bp(e, i) : Bp.default;
	return (t) => Jp(n, t);
}
const ig = Qp.parser.configure({ top: "SingleExpression" }),
	ng = [
		{
			tag: "script",
	...
	rg = [
		{ name: "style", parser: If.parser.configure({ top: "Styles" }) },
	].concat(Dp.map((t) => ({ name: t, parser: Qp.parser }))),
	sg = Ac.define({
		name: "html",
		parser: gf.configure({
			props: [
				...
				eu.add({ "OpenTag CloseTag": (t) => t.getChild("TagName") }),
			],
		}),
		languageData: {
...
function ag(t = {}) {
	...
	!1 === t.matchClosingTags && (i = "noMatch"),
		...
		((t.nestedLanguages && t.nestedLanguages.length) ||
			...
			(e = Sf(
				(t.nestedLanguages || []).concat(ng),
				(t.nestedAttributes || []).concat(rg),
			));
	let n = e
		? sg.configure({ wrap: e, dialect: i })
		: i
			? og.configure({ dialect: i })
			: og;
	return new Dc(n, [
		og.data.of({ autocomplete: eg(t) }),
		!1 !== t.autoCloseTags ? hg : [],
		_p().support,
		Uf().support,
	]);
}
const lg = new Set(
	...
	hg = Nl.inputHandler.of((t, e, i, n, r) => {
		if (
			t.composing ||
			t.state.readOnly ||
			e != i ||
			(">" != n && "/" != n) ||
			!og.isActiveAt(t.state, e, -1)
		)
			return !1;
		let s = r(),
			{ state: o } = s,
...
var cg = Object.freeze({
	...
	autoCloseTags: hg,
	html: ag,
	htmlCompletionSource: tg,
	htmlCompletionSourceWith: eg,
	htmlLanguage: og,
	htmlPlain: sg,
});
const ug = _c({
...
function pg(t, e) {
	...
	for (;;) {
		let t,
			n = i.nextSibling;
		if (!n || (null != (t = fg(n.type)) && t <= e)) break;
		i = n;
	}
	return i.to;
}
const gg = Kc.of((t, e, i) => {
	for (let n = Rc(t).resolveInner(i, -1); n && !(n.from < e); n = n.parent) {
...
function mg(t) {
	return new Xc(ug, t, [gg], "markdown");
}
const xg = mg(dg),
	bg = mg(
		dg.configure([
...
class Sg {
	...
	marker(t, e) {
		let i =
			"OrderedList" == this.node.name ? String(+yg(this.item, t)[2] + e) : "";
...
function Qg(t, e) {
	...
	for (let t = i.length - 1; t >= 0; t--) {
		...
		if ("Blockquote" == s.name && (r = /^ *>( ?)/.exec(o.text.slice(a))))
			n.push(new Sg(s, a, a + r[0].length, "", r[1], ">", null));
		else if (
			"ListItem" == s.name &&
			...
			t.length >= 4 && ((t = t.slice(0, t.length - 4)), (e -= 4)),
				n.push(new Sg(s.parent, a, a + e, r[1], t, r[2], s));
		} else if (
			"ListItem" == s.name &&
			...
			r[3] && (i += r[3].replace(/[xX]/, " ")),
				n.push(new Sg(s.parent, a, a + e, r[1], t, i, s));
		}
	}
	return n;
}
...
function kg(t, e) {
	...
	if (!i || "\t" != e.facet(Ic)) return t;
	let n = "";
	for (let e = qr(t, 4, i); e > 0; )
		e >= 4 ? ((n += "\t"), (e -= 4)) : ((n += " "), e--);
	return n + t.slice(i);
}
const vg = ({ state: t, dispatch: e }) => {
	let i = Rc(t),
		{ doc: n } = t,
		r = null,
		s = t.changeByRange((e) => {
			if (!e.empty || !bg.isActiveAt(t, e.from, 0)) return (r = { range: e });
			let s = e.from,
				o = n.lineAt(s),
				a = Qg(i.resolveInner(s, -1), n);
			...
			if (l.item && h) {
				...
				if (
					...
					return (
						"OrderedList" == l.node.name && wg(l.item, n, r, -2),
						e && "OrderedList" == e.node.name && wg(e.item, n, r),
						{ range: Tn.cursor(t + i.length), changes: r }
					);
				}
				{
					let e = Pg(a, t, o);
					return {
						range: Tn.cursor(s + e.length + 1),
			...
			let c = [];
			"OrderedList" == l.node.name && wg(l.item, n, c);
			...
			if (!u || /^[\s\d.)\-+*>]*/.exec(o.text)[0].length >= l.to)
				for (let t = 0, e = a.length - 1; t <= e; t++)
					O +=
						t != e || u
							? a[t].blank(
									t < e ? qr(o.text, 4, a[t + 1].from) - O.length : null,
								)
							: a[t].marker(n, 1);
			let d = s;
			...
			return (
				...
				})(l.node, t.doc) && (O = Pg(a, t, o) + t.lineBreak + O),
				c.push({ from: d, to: s, insert: t.lineBreak + O }),
				{ range: Tn.cursor(d + O.length + 1), changes: c }
			);
		});
...
function Pg(t, e, i) {
	...
	for (let e = 0, r = t.length - 2; e <= r; e++)
		n += t[e].blank(
			e < r
				? qr(i.text, 4, Math.min(i.text.length, t[e + 1].from)) - n.length
				: null,
			e < r,
		);
	return kg(n, e);
}
const Zg = ({ state: t, dispatch: e }) => {
		let i = Rc(t),
			n = null,
			r = t.changeByRange((e) => {
				let r = e.from,
					{ doc: s } = t;
				if (e.empty && bg.isActiveAt(t, e.from)) {
					let e = s.lineAt(r),
						n = Qg(
							(function (t, e) {
								let i = t.resolveInner(e, -1),
									n = e;
								$g(i) && ((n = i.from), (i = i.parent));
					...
					if (n.length) {
						...
						if (
							...
							if (
								...
								let r = i.blank(qr(e.text, 4, i.to) - qr(e.text, 4, i.from));
								return (
									n == e.from && (r = kg(r, t)),
									{
	...
	_g = [
		{ key: "Enter", run: vg },
		{ key: "Backspace", run: Zg },
	],
	Tg = ag({ matchClosingTags: !1 });
function Xg(t = {}) {
	let {
		codeLanguages: e,
	...
	let a,
		...
		h = [o.support];
	i instanceof Dc ? (h.push(i.support), (a = i.language)) : i && (a = i);
	let c =
		e || a
			? (function (t, e) {
					return (i) => {
						if (i && t) {
							...
							if (
								...
								(e =
									"function" == typeof t
										? t(i)
										: Bc.matchLanguageName(t, i, !0)),
								e instanceof Bc)
							)
								return e.support
									? e.support.language.parser
									: Ec.getSkippingParser(e.load());
	...
	l.push(
		(function (t) {
			let { codeParser: e, htmlParser: i } = t,
				n = Dh((t, n) => {
					let r = t.type.id;
					if (!e || (r != Iu.CodeBlock && r != Iu.FencedCode)) {
						if (i && (r == Iu.HTMLBlock || r == Iu.HTMLTag))
							return { parser: i, overlay: JO(t.node, t.from, t.to) };
					} else {
						let i = "";
						if (r == Iu.FencedCode) {
							let e = t.node.getChild(Iu.CodeInfo);
							e && (i = n.read(e.from, e.to));
						}
						let s = e(i);
						if (s)
							return { parser: s, overlay: (t) => t.type.id == Iu.CodeText };
					}
					return null;
				});
			return { wrap: n };
		...
		n && h.push(In.high(nh.of(_g)));
	let u = mg(r.configure(l));
	return s && h.push(u.data.of({ autocomplete: Cg })), new Dc(u, h);
}
function Cg(t) {
	let { state: e, pos: i } = t,
		n = /<[:\-\.\w\u00b7-\uffff]*$/.exec(e.sliceDoc(i - 25, i));
	if (!n) return null;
	let r = Rc(e).resolveInner(i, -1);
	for (; r && !r.type.isTop; ) {
		if (
			"CodeBlock" == r.name ||
			"FencedCode" == r.name ||
...
function Rg() {
	if (Ag) return Ag;
	let t = tg(new Qu(Qr.create({ extensions: Tg }), 0, !0));
	return (Ag = t ? t.options : []);
}
var Mg = Object.freeze({
	__proto__: null,
	commonmarkLanguage: xg,
	deleteMarkupBackward: Zg,
	insertNewlineContinueMarkup: vg,
	markdown: Xg,
	markdownKeymap: _g,
	markdownLanguage: bg,
});
function jg(t) {
	return new Dc(ou.define(t));
}
function Eg(t) {
	return import("./chunks/index.XSmUqgPf.js").then((e) =>
		e.sql({ dialect: e[t] }),
	);
}
const qg = [
		Bc.of({
			name: "C",
			extensions: ["c", "h", "ino"],
			load: () => import("./chunks/index.CIi-gzWP.js").then((t) => t.cpp()),
		}),
		Bc.of({
			name: "C++",
			alias: ["cpp"],
		...
		Bc.of({
			name: "Go",
			extensions: ["go"],
			load: () => import("./chunks/index.MfsJPQT_.js").then((t) => t.go()),
		}),
		Bc.of({
			name: "HTML",
			alias: ["xhtml"],
		...
		Bc.of({
			name: "Java",
			extensions: ["java"],
			load: () => import("./chunks/index.rvA5wCnx.js").then((t) => t.java()),
		}),
		Bc.of({
			name: "JavaScript",
		...
		Bc.of({
			...
			alias: ["json5"],
			extensions: ["json", "map"],
			load: () => import("./chunks/index.DRCxLVPT.js").then((t) => t.json()),
		}),
		Bc.of({
			name: "JSX",
			extensions: ["jsx"],
		...
		Bc.of({
			name: "LESS",
			extensions: ["less"],
			load: () => import("./chunks/index.BWAIi92b.js").then((t) => t.less()),
		}),
		Bc.of({
			name: "Liquid",
			extensions: ["liquid"],
			load: () => import("./chunks/index.BY4Al_ux.js").then((t) => t.liquid()),
		}),
		Bc.of({ name: "MariaDB SQL", load: () => Eg("MariaSQL") }),
		Bc.of({
			name: "Markdown",
		...
		Bc.of({ name: "MS SQL", load: () => Eg("MSSQL") }),
		Bc.of({ name: "MySQL", load: () => Eg("MySQL") }),
		Bc.of({
			name: "PHP",
			extensions: ["php", "php3", "php4", "php5", "php7", "phtml"],
			load: () => import("./chunks/index.BX1GRAbN.js").then((t) => t.php()),
		}),
		Bc.of({ name: "PLSQL", extensions: ["pls"], load: () => Eg("PLSQL") }),
		Bc.of({ name: "PostgreSQL", load: () => Eg("PostgreSQL") }),
		Bc.of({
			name: "Python",
			extensions: ["BUILD", "bzl", "py", "pyw"],
			filename: /^(BUCK|BUILD)$/,
			load: () => import("./chunks/index.CYrtBRI0.js").then((t) => t.python()),
		}),
		Bc.of({
			name: "Rust",
			extensions: ["rs"],
			load: () => import("./chunks/index.D_C1UtKD.js").then((t) => t.rust()),
		}),
		Bc.of({
			name: "Sass",
			extensions: ["sass"],
			load: () =>
				import("./chunks/index.C8mTMFDs.js").then((t) =>
					t.sass({ indented: !0 }),
				),
		}),
		Bc.of({
			name: "SCSS",
			extensions: ["scss"],
			load: () => import("./chunks/index.C8mTMFDs.js").then((t) => t.sass()),
		}),
		Bc.of({ name: "SQL", extensions: ["sql"], load: () => Eg("StandardSQL") }),
		Bc.of({ name: "SQLite", load: () => Eg("SQLite") }),
		Bc.of({
			name: "TSX",
			extensions: ["tsx"],
			load: () =>
		...
		Bc.of({
			name: "WebAssembly",
			extensions: ["wat", "wast"],
			load: () => import("./chunks/index.DEv7i-ve.js").then((t) => t.wast()),
		}),
		Bc.of({
			name: "XML",
			alias: ["rss", "wsdl", "xsd"],
			extensions: ["xml", "xsl", "xsd", "svg"],
			load: () => import("./chunks/index.B9htZ9tf.js").then((t) => t.xml()),
		}),
		Bc.of({
			name: "YAML",
			alias: ["yml"],
			extensions: ["yaml", "yml"],
			load: () => import("./chunks/index.BsjL4Bbx.js").then((t) => t.yaml()),
		}),
		Bc.of({
			name: "APL",
			extensions: ["dyalog", "apl"],
			load: () => import("./chunks/apl.D1xadxTF.js").then((t) => jg(t.apl)),
		}),
		Bc.of({
			name: "PGP",
			alias: ["asciiarmor"],
			...
			load: () =>
				import("./chunks/asciiarmor.BILnJ9tB.js").then((t) => jg(t.asciiArmor)),
		}),
		Bc.of({
			name: "ASN.1",
			extensions: ["asn", "asn1"],
			load: () =>
				import("./chunks/asn1.CWcnZwdf.js").then((t) => jg(t.asn1({}))),
		}),
		Bc.of({
			name: "Asterisk",
			filename: /^extensions\.conf$/i,
			load: () =>
				import("./chunks/asterisk.CG_-liZT.js").then((t) => jg(t.asterisk)),
		}),
		Bc.of({
			name: "Brainfuck",
			extensions: ["b", "bf"],
			load: () =>
				import("./chunks/brainfuck.HLmZ2Yni.js").then((t) => jg(t.brainfuck)),
		}),
		Bc.of({
			name: "Cobol",
			extensions: ["cob", "cpy"],
			load: () => import("./chunks/cobol.Dsp8JvOj.js").then((t) => jg(t.cobol)),
		}),
		Bc.of({
			name: "C#",
			alias: ["csharp", "cs"],
			extensions: ["cs"],
			load: () =>
				import("./chunks/clike.B_HlCD4f.js").then((t) => jg(t.csharp)),
		}),
		Bc.of({
			name: "Clojure",
			extensions: ["clj", "cljc", "cljx"],
			load: () =>
				import("./chunks/clojure.CwBuzIq8.js").then((t) => jg(t.clojure)),
		}),
		Bc.of({
			name: "ClojureScript",
			extensions: ["cljs"],
		...
		Bc.of({
			...
			extensions: ["gss"],
			load: () => import("./chunks/css.BfUqciy4.js").then((t) => jg(t.gss)),
		}),
		Bc.of({
			name: "CMake",
			extensions: ["cmake", "cmake.in"],
			filename: /^CMakeLists\.txt$/,
			load: () => import("./chunks/cmake.Dc2XidXf.js").then((t) => jg(t.cmake)),
		}),
		Bc.of({
			name: "CoffeeScript",
			...
			extensions: ["coffee"],
			load: () =>
				import("./chunks/coffeescript.5EXtBDQH.js").then((t) =>
					jg(t.coffeeScript),
				),
		}),
		Bc.of({
			...
			load: () =>
				import("./chunks/commonlisp.CdiRWv96.js").then((t) => jg(t.commonLisp)),
		}),
		Bc.of({
			name: "Cypher",
			extensions: ["cyp", "cypher"],
			load: () =>
				import("./chunks/cypher.90__O2IO.js").then((t) => jg(t.cypher)),
		}),
		Bc.of({
			name: "Cython",
			extensions: ["pyx", "pxd", "pxi"],
			load: () =>
				import("./chunks/python.2WY94If7.js").then((t) => jg(t.cython)),
		}),
		Bc.of({
			name: "Crystal",
			extensions: ["cr"],
			load: () =>
				import("./chunks/crystal.B-p3TS9A.js").then((t) => jg(t.crystal)),
		}),
		Bc.of({
			name: "D",
			extensions: ["d"],
			load: () => import("./chunks/d.CIU5yipp.js").then((t) => jg(t.d)),
		}),
		Bc.of({
			name: "Dart",
			extensions: ["dart"],
			load: () => import("./chunks/clike.B_HlCD4f.js").then((t) => jg(t.dart)),
		}),
		Bc.of({
			name: "diff",
			extensions: ["diff", "patch"],
			load: () => import("./chunks/diff.Cq64MLKB.js").then((t) => jg(t.diff)),
		}),
		Bc.of({
			name: "Dockerfile",
			filename: /^Dockerfile$/,
			load: () =>
				import("./chunks/dockerfile.CoTGClxN.js").then((t) => jg(t.dockerFile)),
		}),
		Bc.of({
			name: "DTD",
			extensions: ["dtd"],
			load: () => import("./chunks/dtd._DgYC_mm.js").then((t) => jg(t.dtd)),
		}),
		Bc.of({
			name: "Dylan",
			extensions: ["dylan", "dyl", "intr"],
			load: () => import("./chunks/dylan.DKtGwIsa.js").then((t) => jg(t.dylan)),
		}),
		Bc.of({
			name: "EBNF",
			load: () => import("./chunks/ebnf.Dd57W7fd.js").then((t) => jg(t.ebnf)),
		}),
		Bc.of({
			name: "ECL",
			extensions: ["ecl"],
			load: () => import("./chunks/ecl.DuuFTW0t.js").then((t) => jg(t.ecl)),
		}),
		Bc.of({
			name: "edn",
			extensions: ["edn"],
		...
		Bc.of({
			...
			extensions: ["e"],
			load: () =>
				import("./chunks/eiffel.CPGYQ081.js").then((t) => jg(t.eiffel)),
		}),
		Bc.of({
			name: "Elm",
			extensions: ["elm"],
			load: () => import("./chunks/elm.DgboOdRW.js").then((t) => jg(t.elm)),
		}),
		Bc.of({
			name: "Erlang",
			extensions: ["erl"],
			load: () =>
				import("./chunks/erlang.05Q_BKEP.js").then((t) => jg(t.erlang)),
		}),
		Bc.of({
			name: "Esper",
			load: () => import("./chunks/sql.CxoInVZG.js").then((t) => jg(t.esper)),
		}),
		Bc.of({
			name: "Factor",
			extensions: ["factor"],
			load: () =>
				import("./chunks/factor.YpGaQHuD.js").then((t) => jg(t.factor)),
		}),
		Bc.of({
			name: "FCL",
			load: () => import("./chunks/fcl.BnZAavVj.js").then((t) => jg(t.fcl)),
		}),
		Bc.of({
			name: "Forth",
			extensions: ["forth", "fth", "4th"],
			load: () => import("./chunks/forth.-9W2rYN0.js").then((t) => jg(t.forth)),
		}),
		Bc.of({
			name: "Fortran",
			extensions: ["f", "for", "f77", "f90", "f95"],
			load: () =>
				import("./chunks/fortran.C6XEHu72.js").then((t) => jg(t.fortran)),
		}),
		Bc.of({
			name: "F#",
			alias: ["fsharp"],
			extensions: ["fs"],
			load: () =>
				import("./chunks/mllike.BI1A9XVN.js").then((t) => jg(t.fSharp)),
		}),
		Bc.of({
			name: "Gas",
			extensions: ["s"],
			load: () => import("./chunks/gas.C6K-W2qh.js").then((t) => jg(t.gas)),
		}),
		Bc.of({
			name: "Gherkin",
			extensions: ["feature"],
			load: () =>
				import("./chunks/gherkin.8LJrrLgb.js").then((t) => jg(t.gherkin)),
		}),
		Bc.of({
			name: "Groovy",
			...
			load: () =>
				import("./chunks/groovy.Btby9hIE.js").then((t) => jg(t.groovy)),
		}),
		Bc.of({
			name: "Haskell",
			extensions: ["hs"],
			load: () =>
				import("./chunks/haskell.ChglmAwV.js").then((t) => jg(t.haskell)),
		}),
		Bc.of({
			name: "Haxe",
			extensions: ["hx"],
			load: () => import("./chunks/haxe.3zAv-sI_.js").then((t) => jg(t.haxe)),
		}),
		Bc.of({
			name: "HXML",
			extensions: ["hxml"],
			load: () => import("./chunks/haxe.3zAv-sI_.js").then((t) => jg(t.hxml)),
		}),
		Bc.of({
			name: "HTTP",
			load: () => import("./chunks/http.DBfjp9Fr.js").then((t) => jg(t.http)),
		}),
		Bc.of({
			name: "IDL",
			extensions: ["pro"],
			load: () => import("./chunks/idl.BWJ-nAbX.js").then((t) => jg(t.idl)),
		}),
		Bc.of({
			name: "JSON-LD",
			alias: ["jsonld"],
			extensions: ["jsonld"],
			load: () =>
				import("./chunks/javascript.CJdc-uJY.js").then((t) => jg(t.jsonld)),
		}),
		Bc.of({
			name: "Jinja2",
			extensions: ["j2", "jinja", "jinja2"],
			load: () =>
				import("./chunks/jinja2.DAifJEzV.js").then((t) => jg(t.jinja2)),
		}),
		Bc.of({
			name: "Julia",
			extensions: ["jl"],
			load: () => import("./chunks/julia.BYfQnCNo.js").then((t) => jg(t.julia)),
		}),
		Bc.of({
			name: "Kotlin",
			extensions: ["kt", "kts"],
			load: () =>
				import("./chunks/clike.B_HlCD4f.js").then((t) => jg(t.kotlin)),
		}),
		Bc.of({
			name: "LiveScript",
			alias: ["ls"],
			extensions: ["ls"],
			load: () =>
				import("./chunks/livescript.B_Rwz3ZU.js").then((t) => jg(t.liveScript)),
		}),
		Bc.of({
			name: "Lua",
			extensions: ["lua"],
			load: () => import("./chunks/lua.CGIL-lHk.js").then((t) => jg(t.lua)),
		}),
		Bc.of({
			name: "mIRC",
			extensions: ["mrc"],
			load: () => import("./chunks/mirc.C5b-RBXs.js").then((t) => jg(t.mirc)),
		}),
		Bc.of({
			name: "Mathematica",
			extensions: ["m", "nb", "wl", "wls"],
			load: () =>
				import("./chunks/mathematica.Dakul7Rk.js").then((t) =>
					jg(t.mathematica),
				),
		}),
		Bc.of({
			...
			extensions: ["mo"],
			load: () =>
				import("./chunks/modelica.mZthsjGB.js").then((t) => jg(t.modelica)),
		}),
		Bc.of({
			name: "MUMPS",
			extensions: ["mps"],
			load: () => import("./chunks/mumps.DvZVl6a_.js").then((t) => jg(t.mumps)),
		}),
		Bc.of({
			name: "Mbox",
			extensions: ["mbox"],
			load: () => import("./chunks/mbox.Vqd5vFJ4.js").then((t) => jg(t.mbox)),
		}),
		Bc.of({
			name: "Nginx",
			filename: /nginx.*\.conf$/i,
			load: () => import("./chunks/nginx.D9S7ogWl.js").then((t) => jg(t.nginx)),
		}),
		Bc.of({
			name: "NSIS",
			extensions: ["nsh", "nsi"],
			load: () => import("./chunks/nsis.CaUSwXSo.js").then((t) => jg(t.nsis)),
		}),
		Bc.of({
			name: "NTriples",
			extensions: ["nt", "nq"],
			load: () =>
				import("./chunks/ntriples.B8it0qiB.js").then((t) => jg(t.ntriples)),
		}),
		Bc.of({
			name: "Objective-C",
			...
			extensions: ["m"],
			load: () =>
				import("./chunks/clike.B_HlCD4f.js").then((t) => jg(t.objectiveC)),
		}),
		Bc.of({
			name: "Objective-C++",
			alias: ["objective-c++", "objc++"],
			extensions: ["mm"],
			load: () =>
				import("./chunks/clike.B_HlCD4f.js").then((t) => jg(t.objectiveCpp)),
		}),
		Bc.of({
			name: "OCaml",
			extensions: ["ml", "mli", "mll", "mly"],
			load: () =>
				import("./chunks/mllike.BI1A9XVN.js").then((t) => jg(t.oCaml)),
		}),
		Bc.of({
			name: "Octave",
			extensions: ["m"],
			load: () =>
				import("./chunks/octave.OIcYkY5x.js").then((t) => jg(t.octave)),
		}),
		Bc.of({
			name: "Oz",
			extensions: ["oz"],
			load: () => import("./chunks/oz.DKp2N5gA.js").then((t) => jg(t.oz)),
		}),
		Bc.of({
			name: "Pascal",
			extensions: ["p", "pas"],
			load: () =>
				import("./chunks/pascal.CxERGeJK.js").then((t) => jg(t.pascal)),
		}),
		Bc.of({
			name: "Perl",
			extensions: ["pl", "pm"],
			load: () => import("./chunks/perl.BEF2RHrq.js").then((t) => jg(t.perl)),
		}),
		Bc.of({
			name: "Pig",
			extensions: ["pig"],
			load: () => import("./chunks/pig.DhBXeDa3.js").then((t) => jg(t.pig)),
		}),
		Bc.of({
			name: "PowerShell",
			extensions: ["ps1", "psd1", "psm1"],
			load: () =>
				import("./chunks/powershell.mA74TTR-.js").then((t) => jg(t.powerShell)),
		}),
		Bc.of({
			...
			load: () =>
				import("./chunks/properties.dU89aNz3.js").then((t) => jg(t.properties)),
		}),
		Bc.of({
			name: "ProtoBuf",
			extensions: ["proto"],
			load: () =>
				import("./chunks/protobuf.B3zELWWQ.js").then((t) => jg(t.protobuf)),
		}),
		Bc.of({
			name: "Pug",
			alias: ["jade"],
			extensions: ["pug", "jade"],
			load: () => import("./chunks/pug.Q-P1oAzq.js").then((t) => jg(t.pug)),
		}),
		Bc.of({
			name: "Puppet",
			extensions: ["pp"],
			load: () =>
				import("./chunks/puppet.nUkAEXft.js").then((t) => jg(t.puppet)),
		}),
		Bc.of({
			name: "Q",
			extensions: ["q"],
			load: () => import("./chunks/q.BYcfTnav.js").then((t) => jg(t.q)),
		}),
		Bc.of({
			name: "R",
			alias: ["rscript"],
			extensions: ["r", "R"],
			load: () => import("./chunks/r.ryerXi8L.js").then((t) => jg(t.r)),
		}),
		Bc.of({
			name: "RPM Changes",
			load: () =>
				import("./chunks/rpm.BbHvl5S7.js").then((t) => jg(t.rpmChanges)),
		}),
		Bc.of({
			name: "RPM Spec",
			extensions: ["spec"],
			load: () => import("./chunks/rpm.BbHvl5S7.js").then((t) => jg(t.rpmSpec)),
		}),
		Bc.of({
			name: "Ruby",
			...
			load: () => import("./chunks/ruby.jQxFq7rv.js").then((t) => jg(t.ruby)),
		}),
		Bc.of({
			name: "SAS",
			extensions: ["sas"],
			load: () => import("./chunks/sas.B7KsZ091.js").then((t) => jg(t.sas)),
		}),
		Bc.of({
			name: "Scala",
			extensions: ["scala"],
			load: () => import("./chunks/clike.B_HlCD4f.js").then((t) => jg(t.scala)),
		}),
		Bc.of({
			name: "Scheme",
			extensions: ["scm", "ss"],
			load: () =>
				import("./chunks/scheme.B5rVGHqS.js").then((t) => jg(t.scheme)),
		}),
		Bc.of({
			name: "Shell",
			alias: ["bash", "sh", "zsh"],
			...
			filename: /^PKGBUILD$/,
			load: () => import("./chunks/shell.CO7aidUB.js").then((t) => jg(t.shell)),
		}),
		Bc.of({
			name: "Sieve",
			extensions: ["siv", "sieve"],
			load: () => import("./chunks/sieve.EDcZ7vZn.js").then((t) => jg(t.sieve)),
		}),
		Bc.of({
			name: "Smalltalk",
			extensions: ["st"],
			load: () =>
				import("./chunks/smalltalk.BQAwgX6q.js").then((t) => jg(t.smalltalk)),
		}),
		Bc.of({
			name: "Solr",
			load: () => import("./chunks/solr.CgpCptpM.js").then((t) => jg(t.solr)),
		}),
		Bc.of({
			name: "SML",
			extensions: ["sml", "sig", "fun", "smackspec"],
			load: () => import("./chunks/mllike.BI1A9XVN.js").then((t) => jg(t.sml)),
		}),
		Bc.of({
			name: "SPARQL",
			alias: ["sparul"],
			...
			load: () =>
				import("./chunks/sparql.BlzW9ZQl.js").then((t) => jg(t.sparql)),
		}),
		Bc.of({
			name: "Spreadsheet",
			alias: ["excel", "formula"],
			load: () =>
				import("./chunks/spreadsheet.CDMtX4oR.js").then((t) =>
					jg(t.spreadsheet),
				),
		}),
		Bc.of({
			...
			extensions: ["nut"],
			load: () =>
				import("./chunks/clike.B_HlCD4f.js").then((t) => jg(t.squirrel)),
		}),
		Bc.of({
			name: "Stylus",
			extensions: ["styl"],
			load: () =>
				import("./chunks/stylus.DWwXPI-y.js").then((t) => jg(t.stylus)),
		}),
		Bc.of({
			name: "Swift",
			extensions: ["swift"],
			load: () => import("./chunks/swift.DfGJUd1C.js").then((t) => jg(t.swift)),
		}),
		Bc.of({
			name: "sTeX",
			load: () => import("./chunks/stex.swDcP6MU.js").then((t) => jg(t.stex)),
		}),
		Bc.of({
			name: "LaTeX",
			alias: ["tex"],
		...
		Bc.of({
			...
			extensions: ["v", "sv", "svh"],
			load: () =>
				import("./chunks/verilog.BDKx7hNb.js").then((t) => jg(t.verilog)),
		}),
		Bc.of({
			name: "Tcl",
			extensions: ["tcl"],
			load: () => import("./chunks/tcl.CXmAXCLI.js").then((t) => jg(t.tcl)),
		}),
		Bc.of({
			name: "Textile",
			extensions: ["textile"],
			load: () =>
				import("./chunks/textile.CEgoWrSe.js").then((t) => jg(t.textile)),
		}),
		Bc.of({
			name: "TiddlyWiki",
			load: () =>
				import("./chunks/tiddlywiki.CSfuaA_A.js").then((t) => jg(t.tiddlyWiki)),
		}),
		Bc.of({
			name: "Tiki wiki",
			load: () => import("./chunks/tiki.CDdb9smR.js").then((t) => jg(t.tiki)),
		}),
		Bc.of({
			name: "TOML",
			extensions: ["toml"],
			load: () => import("./chunks/toml.Idc_rqT0.js").then((t) => jg(t.toml)),
		}),
		Bc.of({
			name: "Troff",
			extensions: ["1", "2", "3", "4", "5", "6", "7", "8", "9"],
			load: () => import("./chunks/troff.BUbQoz0Y.js").then((t) => jg(t.troff)),
		}),
		Bc.of({
			name: "TTCN",
			extensions: ["ttcn", "ttcn3", "ttcnpp"],
			load: () => import("./chunks/ttcn.BrdfdUW3.js").then((t) => jg(t.ttcn)),
		}),
		Bc.of({
			name: "TTCN_CFG",
			extensions: ["cfg"],
			load: () =>
				import("./chunks/ttcn-cfg.bbfQeJRF.js").then((t) => jg(t.ttcnCfg)),
		}),
		Bc.of({
			name: "Turtle",
			extensions: ["ttl"],
			load: () =>
				import("./chunks/turtle.606I-o_3.js").then((t) => jg(t.turtle)),
		}),
		Bc.of({
			name: "Web IDL",
			extensions: ["webidl"],
			load: () =>
				import("./chunks/webidl.CyHjCsKo.js").then((t) => jg(t.webIDL)),
		}),
		Bc.of({
			name: "VB.NET",
			extensions: ["vb"],
			load: () => import("./chunks/vb.Cjobq8-m.js").then((t) => jg(t.vb)),
		}),
		Bc.of({
			name: "VBScript",
			extensions: ["vbs"],
			load: () =>
				import("./chunks/vbscript.NuhLE5U5.js").then((t) => jg(t.vbScript)),
		}),
		Bc.of({
			name: "Velocity",
			extensions: ["vtl"],
			load: () =>
				import("./chunks/velocity.CCcv9xCT.js").then((t) => jg(t.velocity)),
		}),
		Bc.of({
			name: "Verilog",
			extensions: ["v"],
		...
		Bc.of({
			name: "VHDL",
			extensions: ["vhd", "vhdl"],
			load: () => import("./chunks/vhdl.DZrVDpYt.js").then((t) => jg(t.vhdl)),
		}),
		Bc.of({
			name: "XQuery",
			extensions: ["xy", "xquery"],
			load: () =>
				import("./chunks/xquery.Ypr2CTyD.js").then((t) => jg(t.xQuery)),
		}),
		Bc.of({
			name: "Yacas",
			extensions: ["ys"],
			load: () => import("./chunks/yacas.DEs-oECU.js").then((t) => jg(t.yacas)),
		}),
		Bc.of({
			name: "Z80",
			extensions: ["z80"],
			load: () => import("./chunks/z80.C5C7TGbY.js").then((t) => jg(t.z80)),
		}),
		Bc.of({
			name: "MscGen",
			extensions: ["mscgen", "mscin", "msc"],
			load: () =>
				import("./chunks/mscgen.h0dQ33Om.js").then((t) => jg(t.mscgen)),
		}),
		Bc.of({
			name: "Xù",
			extensions: ["xu"],
			load: () => import("./chunks/mscgen.h0dQ33Om.js").then((t) => jg(t.xu)),
		}),
		Bc.of({
			name: "MsGenny",
			extensions: ["msgenny"],
			load: () =>
				import("./chunks/mscgen.h0dQ33Om.js").then((t) => jg(t.msgenny)),
		}),
		Bc.of({
			name: "Vue",
			extensions: ["vue"],
			load: () => import("./chunks/index.CjhtiLSK.js").then((t) => t.vue()),
		}),
		Bc.of({
			name: "Angular Template",
			load: () => import("./chunks/index.BEmSd851.js").then((t) => t.angular()),
		}),
	],
	Vg = "var(--editor-bg, #1e1e1e)",
	Lg = "var(--editor-text, #d4d4d4)",
	Wg = "var(--editor-selection-bg, #3a3d41)",
	Yg = "var(--editor-cursor, #aeafad)",
	zg = "var(--editor-line-highlight-bg, #2a2a2a)",
	Dg = "var(--editor-comment, #6a9955)",
	Bg = "var(--editor-keyword, #569cd6)",
	Ig = "var(--editor-string, #ce9178)",
	Ug = "var(--editor-number, #b5cea8)",
	Gg = "var(--editor-heading, #4ec9b0)",
	Ng = "var(--editor-link, #9cdcfe)",
	Hg = "var(--editor-operator, #d4d4d4)",
	Fg = "var(--editor-punctuation, #808080)",
	Kg = Nl.theme(
		{
			"&": {
				color: Lg,
			...
			"&.cm-focused .cm-cursor": { borderLeftColor: Yg },
			"&.cm-focused .cm-selectionBackground, ::selection": {
				backgroundColor: Wg + " !important",
			},
			".cm-gutters": { backgroundColor: Vg, color: Fg, border: "none" },
			".cm-activeLineGutter": { backgroundColor: zg },
			".cm-activeLine": { backgroundColor: zg },
			[$c.heading]: { color: Gg, fontWeight: "bold" },
			[$c.strong]: { fontWeight: "bold" },
			[$c.emphasis]: { fontStyle: "italic" },
			[$c.link]: { color: Ng, textDecoration: "underline" },
			[$c.url]: { color: Ng },
			[$c.quote]: { color: Dg, fontStyle: "italic" },
			[$c.keyword]: { color: Bg },
			[$c.comment]: { color: Dg, fontStyle: "italic" },
			[$c.string]: { color: Ig },
			[$c.number]: { color: Ug },
			[$c.operator]: { color: Hg },
			[$c.punctuation]: { color: Fg },
			[$c.monospace]: {
				fontFamily: "var(--editor-mono-font-family, monospace)",
			},
			[$c.contentSeparator]: { color: Gg, fontWeight: "bold" },
			[$c.list]: { color: Lg },
			[$c.meta]: { color: Dg },
		},
		{ dark: !0 },
...
function em(t, e, i, n, r = e.length) {
	...
	return {
		...
		selection: Tn.range(s.from + e.length, s.to + e.length),
	};
}
function im(t, e, i = !1) {
	const n = [];
...
function sm(e = null) {
	return {
		...
		init() {
			...
			let e = "";
			const i = "initial-entry-data",
				n = document.getElementById(i);
			if (n)
				try {
					(e = JSON.parse(n.textContent).content || ""),
						console.log(
							`[EditorComponent] Parsed initial content from #${i}. Length: ${e.length}`,
						);
				} catch (t) {
					console.error(
						`[EditorComponent] Error parsing initial content JSON from #${i}:`,
						t,
					),
						(e = "");
				}
				...
				console.warn(
					`[EditorComponent] Initial content script tag #${i} not found. Editor will start empty.`,
				);
			this.persistence = new tm(this.entryId);
			...
			const r = this.persistence.loadDraft();
			null !== r && r !== e
				...
				this.$nextTick(() => {
					if (
						...
						try {
							(this.editorView = (function (e, i = "", n = {}) {
								const { onChange: r = () => {}, additionalExtensions: s = [] } =
										n,
									o = Qr.create({
										doc: i,
										extensions: [
											t,
											Xg({ base: bg, codeLanguages: qg }),
											Kg,
											hh("Start writing your journal entry..."),
											Jg(r),
											...s,
										],
									});
								return new Nl({ state: o, parent: e });
		...
		handleContentChange: rm(function () {
			console.log(
		...
		insertMarkdown(t) {
			if (this.editorView)
				switch (t) {
					...
					case "italic":
						!(function (t) {
							const e = em(t.state, "*", "*", "italic text");
							t.dispatch(
						...
						!(function (t) {
							...
							if (i.empty) {
								...
								n = {
									...
									selection: Tn.cursor(i.from + t.length + 3),
								};
							}
					...
					case "blockquote":
						...
						break;
					case "image":
						nm(this.editorView, "![", "](url)", "alt text");
						break;
					case "table":
						const e =
							"| Header 1 | Header 2 |\n|---|---|\n| Cell 1 | Cell 2 |\n| Cell 3 | Cell 4 |";
						nm(this.editorView, "", "", e, !0);
						break;
					case "codeblock":
						nm(this.editorView, "```\n", "\n```", "code here", !0);
						break;
