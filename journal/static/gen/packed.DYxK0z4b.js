						...
						let n = (function (e, t) {
							...
							const r = () => {
								try {
									...
									return D(i, t, e), Promise.resolve();
								}
							};
							let s = r();
							return (H[e] = s), s;
...
function F(e, t, i, n, r) {
	if (Y && "function" == typeof t) {
		...
		s instanceof Promise
			? s.then((t) => F(e, t, i, n)).catch((e) => D(e, r, t))
			: e(s);
	} else
...
function ge(e, t) {
	let i = -1 === pe.indexOf(e.type) ? Oe : e.type,
		n = -1 === pe.indexOf(t.type) ? Oe : t.type;
	...
	return (
		["includes", "indexOf", "lastIndexOf"].forEach((t) => {
			e[t] = function (...e) {
				...
				const n = i[t](...e);
				return -1 === n || !1 === n ? i[t](...e.map(Ti)) : n;
			};
		}),
		["push", "pop", "shift", "unshift", "splice"].forEach((t) => {
			e[t] = function (...e) {
				Vt.push(qt), (qt = !1);
				const i = Ti(this)[t].apply(this, e);
				return Lt(), i;
			};
		}),
		e
...
function Nt(e = !1, t = !1) {
	return function (i, n, r) {
		...
		if (kt(n) ? Yt.has(n) : Dt(n)) return o;
		if ((e || Wt(i, "get", n), t)) return o;
		if (_i(o)) {
			return !s || !Tt(n) ? o.value : o;
		}
...
function Ht(e = !1) {
	return function (t, i, n, r) {
		let s = t[i];
		if (!e && ((n = Ti(n)), (s = Ti(s)), !Qt(t) && _i(s) && !_i(n)))
			return (s.value = n), !0;
		const o = Qt(t) && Tt(i) ? Number(i) < t.length : yt(t, i),
...
var Ft = {
		...
		has: function (e, t) {
			...
			return (kt(t) && Yt.has(t)) || Wt(e, "has", t), i;
		},
		ownKeys: function (e) {
...
function si(e, t = !1) {
	return (
		(e = e.__v_raw), !t && Wt(Ti(e), "iterate", Rt), Reflect.get(e, "size", e)
	);
}
function oi(e) {
	e = Ti(e);
...
function ai(e, t) {
	...
	const i = Ti(this),
		{ has: n, get: r } = ii(i);
	let s = n.call(i, e);
	s ? yi(i, n, e) : ((e = Ti(e)), (s = n.call(i, e)));
	const o = r.call(i, e);
	return (
		i.set(e, t),
...
function li(e) {
	const t = Ti(this),
		{ has: i, get: n } = ii(t);
	let r = i.call(t, e);
	r ? yi(t, i, e) : ((e = Ti(e)), (r = i.call(t, e)));
	...
	return function (...t) {
		{
			...
			console.warn(
				`${_t(e)} operation ${i}failed: target is readonly.`,
				Ti(this),
			);
		}
...
(ji.inline = (e, { modifiers: t }, { cleanup: i }) => {
	...
	te(
		...
		(e, { modifiers: t, expression: i }, { effect: n, cleanup: r }) => {
			...
			let l = () => {
					let e;
					return a((t) => (e = t)), Di(e) ? e.get() : e;
				},
				h = (e) => {
					let t;
					a((e) => (t = e)),
						Di(t) ? t.set(e) : o(() => {}, { scope: { __placeholder: e } });
				};
			"string" == typeof i &&
				"radio" === e.type &&
				$(() => {
...
(Yi.inline = (e, { value: t, modifiers: i, expression: n }) => {
	t &&
				...
				(function (t, i, n, r) {
					...
					n((n) => {
						...
						for (let e = 0; e < u.length; e++) {
							let t = u[e],
								i = h.indexOf(t);
							if (-1 === i) h.splice(e, 0, t), f.push([g, e]);
							else if (i !== e) {
...
class Tn {
	...
	addRange(e, t = !0) {
		return Tn.create([e].concat(this.ranges), t ? 0 : this.mainIndex + 1);
	}
	replaceRange(e, t = this.mainIndex) {
		let i = this.ranges.slice();
		return (i[t] = e), Tn.create(i, this.mainIndex);
	}
	toJSON() {
	...
	static normalized(e, t = 0) {
		...
		for (let i = 1; i < e.length; i++) {
			...
			if (n.empty ? n.from <= r.to : n.from < r.to) {
				...
				i <= t && t--,
					e.splice(--i, 2, n.anchor > n.head ? Tn.range(o, s) : Tn.range(s, o));
			}
		}
		return new Tn(e, t);
	}
...
function fr(e, t, i) {
	...
	return (
		t.userEvent && (r = r.concat(hr.userEvent.of(t.userEvent))),
		{
			...
			selection: n && (n instanceof Tn ? n : Tn.single(n.anchor, n.head)),
		...
		if (
			(function (e) {
				...
				for (let t = 0; t < e.length; t++) {
					...
					if (
						/\w/.test(i) ||
						(i > "" && (i.toUpperCase() != i.toLowerCase() || mr.test(i)))
					)
						return !0;
				}
				return !1;
			...
			return gr.Word;
		for (let i = 0; i < e.length; i++) if (t.indexOf(e[i]) > -1) return gr.Word;
		return gr.Other;
	};
}
class Sr {
	...
	changeByRange(e) {
		...
		return { changes: n, selection: Tn.create(r, t.mainIndex), effects: s };
	}
	changes(e = []) {
	...
	wordAt(e) {
		...
		return s == o ? null : Tn.range(s + i, o + i);
	}
}
...
class Tr {
	...
	static from(e, t = null, i = -1) {
		...
		return 1 == n.length ? n[0] : new Tr(n);
	}
	get startSide() {
		return this.value ? this.value.startSide : 0;
	}
...
function Er(e, t, i = e.length) {
	...
	for (let r = 0; r < i && r < e.length; )
		9 == e.charCodeAt(r) ? ((n += t - (n % t)), r++) : (n++, (r = mn(e, r)));
	return n;
}
		...
		for (let l = t, h = 0; l < i; ) {
			...
			e: for (;;)
				if (h < s.length && d == s[h].from) {
					...
					if (d == i || (t ? wo[d] != a : wo[d] == a)) break;
					d++;
				}
			u ? ko(e, l, d, n + 1, r, u, o) : l < d && o.push(new yo(l, d, f)),
				(l = d);
		}
	else
		for (let l = i, h = s.length; l > t; ) {
			...
			e: for (;;)
				if (h && d == s[h - 1].to) {
					...
					if (d == t || (i ? wo[d - 1] != a : wo[d - 1] == a)) break;
					d--;
				}
			u ? ko(e, d, l, n + 1, r, u, o) : d < l && o.push(new yo(d, l, f)),
				(l = d);
		}
}
...
function Zo(e, t, i, n, r) {
	...
	let c = mn(e.text, o, l.forward(r, i));
	(c < l.from || c > l.to) && (c = h),
		(Po = e.text.slice(Math.min(o, c), Math.max(o, c)));
	let u = a == (r ? t.length - 1 : 0) ? null : t[a + (r ? 1 : -1)];
	return u && c == h && u.level + (r ? 0 : 1) < l.level
		? Tn.cursor(u.side(!r, i) + e.from, u.forward(r, i) ? 1 : -1, u.level)
		: Tn.cursor(c + e.from, l.forward(r, i) ? -1 : 1, l.level);
}
function To(e, t, i) {
	for (let n = t; n < i; n++) {
				...
				if (1 == c.nodeType) {
					...
					if ("nearest" == r)
						t.top < e.top
							...
							: t.bottom > e.bottom &&
								((g = t.bottom - e.bottom + o),
								i < 0 && t.top - g < e.top && (g = t.top - (e.top + o)));
					else {
					...
					if (
						...
						if (f) h.scrollBy(p, g);
							...
							if (g) {
								let e = c.scrollTop;
								(c.scrollTop += g / O), (i = (c.scrollTop - e) * O);
							}
							if (p) {
								let t = c.scrollLeft;
...
function ca(e, t) {
	...
	let n = gs(i.focusNode, i.focusOffset),
		r = ms(i.focusNode, i.focusOffset),
		s = n || r;
...
function ma(e, t, i) {
	...
	for (let f = e.firstChild; f; f = f.nextSibling) {
		...
		for (let d = 0; d < e.length; d++) {
			...
			let p = fa(t, O),
				g = da(i, O);
			if (0 == p && 0 == g) return 3 == f.nodeType ? xa(f, t, i) : ma(f, t, i);
			if (!n || o > g || (o == g && s > p)) {
				(n = f), (r = O), (s = p), (o = g);
				let a = g ? (i < O.top ? -1 : 1) : p ? (t < O.left ? -1 : 1) : 0;
				u = !a || (a > 0 ? d < e.length - 1 : d > 0);
			}
			0 == p
				? i > O.bottom && (!h || h.bottom < O.bottom)
					? ((a = f), (h = O))
					: i < O.top && (!c || c.top > O.top) && ((l = f), (c = O))
				: h && Oa(h, O)
					? (h = ga(h, O.bottom))
	...
	return (
		...
		(function (e, t, i) {
			for (let n = 0, r = 0; ; ) {
				if (r >= t) return n;
				if (n == e.length) break;
				(r += 9 == e.charCodeAt(n) ? i - (r % i) : 1), (n = mn(e, n));
			}
			return e.length;
		})(o, s, e.state.tabSize)
	);
...
function ya(e, t, i, n) {
	...
	if (s) {
		...
		if (null != o) return Tn.cursor(o, i ? -1 : 1);
	}
	return Tn.cursor(i ? r.to : r.from, i ? -1 : 1);
}
function Qa(e, t, i, n) {
...
function ka(e, t, i) {
	...
	return n == i.from ? i : Tn.cursor(n, n < i.from ? 1 : -1);
}
const va = "￿";
class $a {
	constructor(e, t) {
		...
		if (e.state.readOnly && t > -1) this.newSel = null;
			...
			i.readRange(this.bounds.startDOM, this.bounds.endDOM),
				...
				(this.newSel = (function (e, t) {
					...
					return i > -1 && n > -1 ? Tn.single(i + t, n + t) : null;
				})(t, this.bounds.from));
		} else {
	...
	if (
		(!i && t.typeOver && !r.empty && n && n.main.empty
			...
			: (js.mac || js.android) &&
				...
				? (n &&
						2 == i.insert.length &&
						(n = Tn.single(n.main.anchor - 1, n.main.head - 1)),
					(i = {
						from: i.from,
						to: i.to,
				...
				: i &&
					...
					: js.chrome &&
						...
						"\n " == i.insert.toString() &&
						e.lineWrapping &&
						(n && (n = Tn.single(n.main.anchor - 1, n.main.head - 1)),
				...
				if (
					...
					n = r.changeByRange((i) => {
						...
						return {
							changes: d,
							range: a
								? Tn.range(Math.max(0, a.anchor + O), Math.max(0, a.head + O))
								: i.map(d),
						};
					});
	...
	skipAtoms(e) {
		...
		for (let i = 0; i < e.ranges.length; i++) {
			...
			if (n.empty) {
				...
				e != n.from && (r = Tn.cursor(e, -1));
			} else {
				let e = wa(this.atoms, n.from, -1),
					t = wa(this.atoms, n.to, 1);
				(e == n.from && t == n.to) ||
					(r = Tn.range(n.from == n.anchor ? e : t, n.from == n.head ? e : t));
			}
	...
	if (
		...
		i = n.changeByRange((i) => {
			...
			return {
				...
				range: Tn.cursor(i.from + l.length),
			};
		});
	} else
		i = o
...
function Ba(e, t, i, n) {
	if (1 == n) return Tn.cursor(t, i);
	if (2 == n)
		return (function (e, t, i = 1) {
			let n = e.charCategorizer(t),
				r = e.doc.lineAt(t),
				s = t - r.from;
			if (0 == r.length) return Tn.cursor(t);
			0 == s ? (i = 1) : s == r.length && (i = -1);
			let o = s,
				a = s;
			i < 0 ? (o = mn(r.text, s, !1)) : (a = mn(r.text, s));
			...
			return Tn.range(o + r.from, a + r.from);
		})(e.state, t, i);
	{
		let i = ro.find(e.docView, t),
			...
			s = i ? i.posAtEnd : n.to;
		return s < e.state.doc.length && s == n.to && s++, Tn.range(r, s);
	}
}
(Wa.scroll = (e) => {
					...
					return {
						...
						get(t, s, o) {
							...
							if (i.pos != l.pos && !s) {
								...
								h = r < h.from ? Tn.range(r, s) : Tn.range(s, r);
							}
							return s
...
(La.dragstart = (e, t) => {
	...
	if (t.target.draggable) {
		...
		if (n && n.isWidget) {
			let e = n.posAtStart,
				t = e + n.length;
			(e >= i.to || t <= i.from) && (i = Tn.range(e, t));
		}
	}
	let { inputState: n } = e;
	return (
		...
		t.dataTransfer &&
			(t.dataTransfer.setData(
				"Text",
				Da(e.state, qo, e.state.sliceDoc(i.from, i.to)),
			),
	...
	(La.paste = (e, t) => {
		...
		return i
			? (Ya(e, i.getData("text/plain") || i.getData("text/uri-list")), !0)
			: ((function (e) {
...
La.copy = La.cut = (e, t) => {
	let {
		...
		return { text: Da(e, qo, t.join(e.lineBreak)), ranges: i, linewise: n };
	})(e.state);
	if (!i && !r) return !1;
	(tl = r ? i : null),
		"cut" != t.type ||
...
class Ol {
	...
	applyChanges(e, t, i, n) {
		...
		for (let o = n.length - 1; o >= 0; o--) {
			...
			(h += u.from - a), (a = u.from);
			let d = yl.build(i.setDoc(s), e, h, c);
	...
	static of(e) {
		...
		return (
			...
			new bl(Ol.of(e.slice(0, t)), s, Ol.of(e.slice(i)))
		);
	}
}
function pl(e, t) {
...
class ml extends gl {
	...
	replace(e, t, i) {
		let n = i[0];
		return 1 == i.length &&
			(n instanceof ml || (n instanceof xl && 4 & n.flags)) &&
			Math.abs(this.length - n.length) < 10
			? (n instanceof xl
					? (n = new ml(n.length, this.height))
...
class yl {
	...
	finish(e) {
		...
		for (let e of this.nodes)
			e instanceof ml && e.updateHeight(this.oracle, i),
				(i += e ? e.length : 1);
		return this.nodes;
	}
...
class Pl {
	...
	measure(e) {
		...
		let d = (this.printing ? kl : wl)(t, this.paddingTop),
		...
		if (
			...
			if (
				...
				s ||
					(n.lineWrapping && Math.abs(m - this.contentDOMWidth) > n.charWidth))
			) {
				let {
					lineHeight: i,
					charWidth: o,
...
function Tl({ total: e, ranges: t }, i) {
	...
	constructor(e) {
		...
		(this.handlers.textupdate = (t) => {
			...
			(this.handlers.textformatupdate = (t) => {
				...
				e.dispatch({ effects: Yo.of(Ks.set(i)) });
			}),
...
class Gl {
	...
	visualLineSide(e, t) {
		let i = this.bidiSpans(e),
			...
			r = i[t ? i.length - 1 : 0];
		return Tn.cursor(r.side(t, n) + e.from, r.forward(!t, n) ? 1 : -1);
	}
	...
	moveVertically(e, t, i) {
		return ka(
			...
			(function (e, t, i, n) {
				let r = t.head,
					s = i ? 1 : -1;
				if (r == (i ? e.state.doc.length : 0)) return Tn.cursor(r, t.assoc);
				let o,
					a = t.goalColumn,
	...
	scrollSnapshot() {
		...
		return Do.of(new zo(Tn.cursor(i.from), "start", "start", i.top - e, t, !0));
	}
	setTabFocusMode(e) {
		null == e
...
class ph {
	...
	extend(...e) {
		...
		for (let i of this.types) {
			...
			t.push(n ? new Oh(i.name, n, i.id, i.flags) : i);
		}
		return new ph(t);
	}
}
...
class bh {
	...
	cursorAt(e, t = 0, i = 0) {
		let n = gh.get(this) || this.topNode,
			r = new Ah(n);
	...
	resolve(e, t = 0) {
		let i = wh(gh.get(this) || this.topNode, e, t, !1);
		return gh.set(this, i), i;
	}
	resolveInner(e, t = 0) {
		let i = wh(mh.get(this) || this.topNode, e, t, !0);
	...
	balance(e = {}) {
		return this.children.length <= 8
			...
			: jh(
					...
					e.makeTree || ((e, t, i) => new bh(Oh.none, e, t, i)),
				);
	}
	static build(e) {
		return (function (e) {
			...
			function u(e, t, i, x, b, S) {
				...
				let P,
					...
					T = l[y],
					_ = Q - e;
				if (w - Q <= r && (Z = g(a.pos - t, b))) {
					let t = new Uint16Array(Z.size - Z.skip),
						i = a.pos - Z.size,
						r = t.length;
					for (; a.pos > i; ) r = m(Z.start, t, r);
					(P = new yh(t, w - Z.start, n)), (_ = Z.start - e);
				} else {
					let e = a.pos - k;
					a.next();
					let t = [],
					...
					for (; a.pos > e; )
						n >= 0 && a.id == n && a.size >= 0
							...
							: S > 2500
								...
								: u(Q, e, t, i, n, S + 1);
					if (
						(n >= 0 && s > 0 && s < t.length && O(t, i, Q, s, Q, l, n, v, $),
						t.reverse(),
						i.reverse(),
						n > -1 && s > 0)
					) {
						let e = d(T, $);
						P = jh(T, t, i, 0, t.length, 0, w - Q, e, e);
					} else P = p(T, t, i, w - Q, v - w, $);
				}
				i.push(P), x.push(_);
			}
			function f(e, t, i, s) {
		...
		(function t(i, n, r, o, a) {
			for (let h = r; h < o; ) {
				...
				if (h == r + 1) {
					...
					u.push(jh(e, i, n, r, h, d, t, null, l));
				}
				f.push(d + a - s);
			}
		})(t, i, n, r, 0),
...
function Nh(e) {
	...
	})(0, a.length, Oh.none, 0, o.length, i.length - 1);
	for (let t of l) {
...
class Zc {
	...
	isActiveAt(e, t, i = -1) {
		return Tc(e, t, i).type.prop(vc) == this.data;
	}
	findRegions(e) {
		let t = e.facet(Lc);
...
class mu extends Zc {
	constructor(e) {
		...
		super(
			...
			(this.tokenTable = e.tokenTable ? new Zu(n.tokenTable) : Tu);
	}
	static define(e) {
		return new mu(e);
	}
	getIndent(e) {
		...
		i && ((t = gu.get(e.state)), null != t && t < e.pos - 1e4 && (t = void 0));
		let n,
			r,
			s = xu(
				this,
		...
		for (; n < e.pos; ) {
			...
			if (t.length) {
				let n = i ? i(t.from) : -1,
					o = new Ou(t.text, e.state.tabSize, e.unit, n < 0 ? void 0 : n);
		...
		return (
			i && null == t && gu.set(e.state, o.from),
		...
		for (let i of n.split(".")) {
			...
			n
				? "function" == typeof n
					? t.length
						? (t = t.map(n))
						: _u(i, `Modifier ${i} used at start of tag`)
					: t.length
						? _u(i, `Tag ${i} used as modifier`)
						: (t = Array.isArray(n) ? n : [n])
				: _u(i, `Unknown highlighting tag ${i}`);
		}
	...
	let r = i.map((e, i) =>
		(function (e, { open: t, close: i }, n, r) {
			...
			let f = /^\s*/.exec(s)[0].length,
				d = /\s*$/.exec(o)[0].length,
				O = o.length - d - i.length;
			return s.slice(f, f + t.length) == t && o.slice(O, O + i.length) == i
				? {
						open: {
							pos: n + f + t.length,
...
const Lu = sr.define(),
	...
	Yu = Vn.define({
		create: () => lf.empty,
		update(e, t) {
			let i = t.state.facet(Du),
				n = t.annotation(Lu);
			if (n) {
				let r = Fu.fromTransaction(t, n.selection),
					s = n.side,
					o = 0 == s ? e.undone : e.done;
				return (
					(o = r
						? Ku(o, o.length, i.minDepth, r)
						: nf(o, t.startState.selection)),
					new lf(0 == s ? n.rest : o, 0 == s ? o : n.rest)
				);
			}
...
function nf(e, t) {
	if (e.length) {
		let i = e[e.length - 1],
			n = i.selectionsAfter.slice(Math.max(0, i.selectionsAfter.length - tf));
		return n.length && n[n.length - 1].eq(t)
			? e
			: (n.push(t), Ku(e, e.length - 1, 1e9, i.setSelAfter(n)));
	}
...
function sf(e, t) {
	...
	return n.length ? [Fu.selection(n)] : ef;
}
function of(e, t, i) {
	let n = Ju(
	...
	if (!e.changes) return Fu.selection(n);
	let r = e.changes.map(t),
		s = t.mapDesc(e.changes, !0),
		o = e.mapped ? e.mapped.composeDesc(s) : s;
	return new Fu(r, lr.mapEffects(e.effects, t), o, e.startSelection.map(s), n);
}
...
class lf {
	...
	addSelection(e, t, i, n) {
		...
		return r.length > 0 &&
			...
			? this
			: new lf(nf(this.done, e), this.undone, t, i);
		var s, o;
	}
	addMapping(e) {
		return new lf(
	...
	pop(e, t, i) {
		...
		if (i && r.selectionsAfter.length)
			return t.update({
				...
				annotations: Lu.of({ side: e, rest: rf(n), selection: s }),
				userEvent: 0 == e ? "select.undo" : "select.redo",
				scrollIntoView: !0,
			});
		if (r.changes) {
			let i = 1 == n.length ? ef : n.slice(0, n.length - 1);
			return (
				r.mapped && (i = sf(i, r.mapped)),
				t.update({
					changes: r.changes,
...
function ff({ state: e, dispatch: t }, i) {
	let n = cf(e.selection, i);
	return !n.eq(e.selection, !0) && (t(uf(e, n)), !0);
}
function df(e, t) {
	return Tn.cursor(t ? e.to : e.from);
}
function Of(e, t) {
	return ff(e, (i) => (i.empty ? e.moveByChar(i, t) : df(i, t)));
}
function pf(e) {
...
const gf = (e) => Of(e, !pf(e)),
	mf = (e) => Of(e, pf(e));
function xf(e, t) {
	return ff(e, (i) => (i.empty ? e.moveByGroup(i, t) : df(i, t)));
}
function bf(e, t, i) {
...
function vf(e, t) {
	let i,
		...
		{ state: r } = e,
		s = cf(r.selection, (i) =>
			i.empty ? e.moveVertically(i, t, n.height) : df(i, t),
		);
	...
	return e.dispatch(uf(r, s), { effects: i }), !0;
}
const $f = (e) => vf(e, !1),
	Pf = (e) => vf(e, !0);
function Zf(e, t, i) {
	...
	if (
		...
		i && t.head != n.from + i && (r = Tn.cursor(n.from + i));
	}
	return r;
}
function Tf(e, t) {
	let i = cf(e.state.selection, (e) => {
		let i = t(e);
		return Tn.range(e.anchor, i.head, i.goalColumn, i.bidiLevel || void 0);
	});
	return !i.eq(e.state.selection) && (e.dispatch(uf(e.state, i)), !0);
}
function _f(e, t) {
	return Tf(e, (i) => e.moveByChar(i, t));
}
const Xf = (e) => _f(e, !pf(e)),
	Af = (e) => _f(e, pf(e));
function Cf(e, t) {
	return Tf(e, (i) => e.moveByGroup(i, t));
}
function Rf(e, t) {
	return Tf(e, (i) => e.moveVertically(i, t));
}
const Mf = (e) => Rf(e, !1),
	jf = (e) => Rf(e, !0);
function Ef(e, t) {
	return Tf(e, (i) => e.moveVertically(i, t, kf(e).height));
}
const qf = (e) => Ef(e, !1),
	Vf = (e) => Ef(e, !0),
	...
	let i = "delete.selection",
		...
		r = n.changeByRange((n) => {
			...
			if (r == s) {
				let o = t(n);
				o < r
					? ((i = "delete.backward"), (o = Bf(e, o, !1)))
					: o > r && ((i = "delete.forward"), (o = Bf(e, o, !0))),
					(r = Math.min(r, o)),
					(s = Math.max(s, o));
			...
			return r == s
				...
				: {
						changes: { from: r, to: s },
						range: Tn.cursor(r, r < n.head ? -1 : 1),
					};
		});
	return (
		!r.changes.empty &&
	...
	Nf = (e, t) =>
		Yf(e, (i) => {
			...
			for (let e = null; ; ) {
				...
				let a = mn(s.text, n - s.from, t) + s.from,
...
function Kf(e, t, i) {
	...
	for (let t of Ff(e)) {
		...
		if (i) {
			...
			for (let e of t.ranges) r.push(Tn.range(e.anchor - o, e.head - o));
		}
	}
	return (
		!!n.length &&
		(t(
			e.update({
				changes: n,
				scrollIntoView: !0,
				selection: Tn.create(r, e.selection.mainIndex),
				userEvent: "move.line",
			}),
		),
		!0)
		...
		let n = t.changeByRange((i) => {
			...
			return (
				o && h.push(Ic(t, a.lineIndent(s.from, -1))),
				{
					...
					range: Tn.cursor(n + 1 + h[1].length),
				}
			);
		});
...
function nd(e, t) {
	...
	return e.changeByRange((n) => {
		...
		return {
			changes: r,
			range: Tn.range(s.mapPos(n.anchor, 1), s.mapPos(n.head, 1)),
		};
	});
}
const rd = [
		...
		{ key: "Ctrl-n", run: wf, shift: jf },
		{
			key: "Ctrl-a",
			run: (e) => ff(e, (t) => Tn.cursor(e.lineBlockAt(t.head).from, 1)),
			shift: (e) => Tf(e, (t) => Tn.cursor(e.lineBlockAt(t.head).from)),
		},
		{
			key: "Ctrl-e",
			run: (e) => ff(e, (t) => Tn.cursor(e.lineBlockAt(t.head).to, -1)),
			shift: (e) => Tf(e, (t) => Tn.cursor(e.lineBlockAt(t.head).to)),
		},
		{ key: "Ctrl-d", run: Gf },
		{ key: "Ctrl-h", run: Uf },
		{
		...
		},
		{
			...
			run: ({ state: e, dispatch: t }) => {
				...
				let i = e.changeByRange((t) => {
					...
					let i = t.from,
						n = e.doc.lineAt(i),
						r = i == n.from ? i - 1 : mn(n.text, i - n.from, !1) + n.from,
						s = i == n.to ? i + 1 : mn(n.text, i - n.from, !0) + n.from;
					return {
						changes: {
							from: r,
							to: s,
	...
	sd = [
		...
		{ key: "ArrowDown", run: wf, shift: jf, preventDefault: !0 },
	...
	od = [
		...
		},
		{
			...
			run: ({ state: e, dispatch: t }) => {
				...
				return (
					i.ranges.length > 1
						? (n = Tn.create([i.main]))
						: i.main.empty || (n = Tn.create([Tn.cursor(i.main.head)])),
					!!n && (t(uf(e, n)), !0)
				);
			},
		},
		{ key: "Mod-Enter", run: td },
		{
			...
			mac: "Ctrl-l",
			run: ({ state: e, dispatch: t }) => {
				let i = Ff(e).map(({ from: t, to: i }) =>
					Tn.range(t, Math.min(i + 1, e.doc.length)),
				);
				return (
					t(e.update({ selection: Tn.create(i), userEvent: "select" })), !0
				);
			},
		},
		{
				...
				let i = cf(e.selection, (t) => {
					...
					for (let e = n; e; e = e.next) {
						...
						if (
							...
							return Tn.range(i.to, i.from);
					}
					return t;
				});
				return !i.eq(e.selection) && (t(uf(e, i)), !0);
			},
			preventDefault: !0,
		},
		{
		...
		},
		{
			...
			run: ({ state: e, dispatch: t }) =>
				...
				(t(
					e.update(
						nd(e, (t, i) => {
							i.push({ from: t.from, insert: e.facet(Yc) });
						}),
...
class Od {
	...
	map(e) {
		...
		return null == t || null == i ? null : new Od(this.field, t, i);
	}
}
class pd {
	constructor(e, t) {
	...
	static parse(e) {
		...
		for (let s of e.split(/\r\n?|\n/)) {
			for (
				...
				r.push(new dd(a, n.length, t.index, t.index + l.length)),
	...
	yd = Vn.define({
		...
		update(e, t) {
			for (let i of t.effects) {
				if (i.is(bd)) return i.value;
				if (i.is(Sd) && e) return new xd(e.ranges, i.value);
			}
			return (
	...
	return (e, i, n, r) => {
		let { text: s, ranges: o } = t.instantiate(e.state, n),
			...
			l = {
				...
				scrollIntoView: !0,
				annotations: i ? [ud.of(i), hr.userEvent.of("input.complete")] : void 0,
			};
		if ((o.length && (l.selection = Qd(o, 0)), o.some((e) => e.field > 0))) {
			let t = new xd(o, 0),
				i = (l.effects = [bd.of(t)]);
			void 0 === e.state.field(yd, !1) &&
				i.push(lr.appendConfig.of([yd, Pd, Td, fd]));
		}
...
function kd(e) {
	return ({ state: t, dispatch: i }) => {
		...
		return (
			i(
				t.update({
					selection: Qd(n.ranges, r),
					effects: bd.of(s ? null : new xd(n.ranges, r)),
					scrollIntoView: !0,
				}),
			),
			!0
...
const vd = [
	...
	$d = An.define({ combine: (e) => (e.length ? e[0] : vd) }),
	Pd = Bn.highest(ih.compute([$d], (e) => e.facet($d)));
function Zd(e, t) {
	return Object.assign(Object.assign({}, t), { apply: wd(e) });
}
const Td = Gl.domEventHandlers({
		mousedown(e, t) {
			let i,
				n = t.state.field(yd, !1);
			...
			return (
				!(!r || r.field == n.active) &&
				(t.dispatch({
					selection: Qd(n.ranges, r.field),
					effects: bd.of(
						n.ranges.some((e) => e.field > r.field)
							? new xd(n.ranges, r.field)
							: null,
					),
					scrollIntoView: !0,
				}),
...
class Xd {
	static create(e, t, i, n, r) {
		return new Xd(e, t, i, (n + (n << 8) + e + (t << 4)) | 0, r, [], []);
	}
	constructor(e, t, i, n, r, s, o) {
		(this.type = e),
			(this.value = t),
	...
	toTree(e, t = this.end) {
		...
		return (
			...
			new bh(
				...
				makeTree: (e, t, i) => new bh(Oh.none, e, t, i, this.hashProp),
			})
		);
	}
}
...
function Md(e, t, i) {
	...
	let n = (e.type == Ad.OrderedList ? Bd : Yd)(i, t, !1);
	return (
		n > 0 &&
		(e.type != Ad.BulletList || zd(i, t, !1) < 0) &&
...
const jd = {
	[Ad.Blockquote]: (e, t, i) =>
		62 == i.next &&
		(i.markers.push(
			bO(Ad.QuoteMark, t.lineStart + i.pos, t.lineStart + i.pos + 1),
		),
		i.moveBase(i.pos + (Ed(i.text.charCodeAt(i.pos + 1)) ? 2 : 1)),
...
function Yd(e, t, i) {
	return (45 != e.next && 43 != e.next && 42 != e.next) ||
		...
		!(!i || Dd(t, Ad.BulletList) || e.skipSpace(e.pos + 2) < e.text.length)
		? -1
		: 1;
}
function Bd(e, t, i) {
	...
	return n == e.pos ||
		n > e.pos + 9 ||
		(46 != r && 41 != r) ||
		(n < e.text.length - 1 && !Ed(e.text.charCodeAt(n + 1))) ||
		(i &&
			!Dd(t, Ad.OrderedList) &&
...
function Kd(e, t, i) {
	...
	for (let e = 0, t = Fd.length - (i ? 1 : 0); e < t; e++)
		if (Fd[e][0].test(n)) return e;
	return -1;
}
function Jd(e, t) {
...
function eO(e, t, i) {
	let n = e.length - 1;
	n >= 0 && e[n].to == t && e[n].type == Ad.CodeText
		? (e[n].to = i)
		: e.push(bO(Ad.CodeText, t, i));
}
const tO = {
	...
	FencedCode(e, t) {
		...
		for (let i = !0; e.nextLine() && t.depth >= e.stack.length; i = !1) {
			...
			if (n - t.pos >= s && t.skipSpace(n) == t.text.length) {
				...
				l.push(bO(Ad.CodeMark, e.lineStart + t.pos, e.lineStart + n)),
					e.nextLine();
				break;
			}
			{
				i || eO(l, e.lineStart - 1, e.lineStart);
				for (let e of t.markers) l.push(e);
		...
		return (
			e.addNode(
				e.buffer
					.writeElements(l, -n)
					.finish(Ad.FencedCode, e.prevLineEnd() - n),
				n,
			),
			!0
		);
	...
	HorizontalRule(e, t) {
		...
		return e.nextLine(), e.addNode(Ad.HorizontalRule, i), !0;
	},
	BulletList(e, t) {
		let i = Yd(t, e, !1);
		if (i < 0) return !1;
		...
		let n = Jd(t, t.pos + 1);
		return (
			e.startContext(Ad.ListItem, t.basePos, n - t.baseIndent),
			e.addNode(Ad.ListMark, e.lineStart + t.pos, e.lineStart + t.pos + i),
			t.moveBaseColumn(n),
			null
		);
	},
	...
	ATXHeading(e, t) {
		...
		let n = t.pos,
			r = e.lineStart + n,
			s = Vd(t.text, t.text.length, n),
			o = s;
		for (; o > n && t.text.charCodeAt(o - 1) == t.next; ) o--;
		(o != s && o != n && Ed(t.text.charCodeAt(o - 1))) || (o = t.text.length);
		let a = e.buffer
			.write(Ad.HeaderMark, 0, i)
			.writeElements(
				e.parser.parseInline(t.text.slice(n + i + 1, o), r + i + 1),
				-r,
			);
		o < t.text.length && a.write(Ad.HeaderMark, o - n, s - n);
		let l = a.finish(Ad.ATXHeading1 - 1 + i, t.text.length - n);
...
class iO {
	...
	complete(e, t, i) {
		return (
			e.addLeafElement(
				t,
				bO(Ad.LinkReference, this.start, this.start + i, this.elts),
			),
			!0
		);
	}
				...
				if (1 != this.stage) {
					if (2 == this.stage) {
						let t = qd(e, this.pos),
							i = 0;
						if (t > this.pos) {
							let n = _O(e, t, this.start);
							if (n) {
								let t = nO(e, n.to - this.start);
								t > 0 && (this.nextStage(n), (i = t));
							}
						}
						return i || (i = nO(e, this.pos)), i > 0 && i < e.length ? i : -1;
					}
					return nO(e, this.pos);
				}
...
class rO {
	nextLine(e, t, i) {
		let n = t.depth < e.stack.length ? -1 : Ud(t),
			r = t.next;
		if (n < 0) return !1;
		let s = bO(Ad.HeaderMark, e.lineStart + t.pos, e.lineStart + n);
		return (
			e.nextLine(),
			e.addLeafElement(
				i,
...
const sO = {
		LinkReference: (e, t) => (91 == t.content.charCodeAt(0) ? new iO(t) : null),
...
class lO {
	constructor(e, t, i, n) {
		(this.parser = e),
			...
			(this.fragments = i.length ? new MO(i, t) : null),
			this.readLine();
	}
	get parsedPos() {
	...
	readLine() {
		...
		for (
			...
			if (!i) throw new Error("Unhandled block context " + Ad[t.type]);
			if (!i(t, this, e)) break;
			e.forward();
		}
	}
	...
	elt(e, t, i, n) {
		return "string" == typeof e
			? bO(this.parser.getNodeType(e), t, i, n)
			: new xO(e, t);
	}
	get buffer() {
...
class cO extends Vh {
	...
	configure(e) {
		...
		if ((uO(t.props) && (i = i.extend(...t.props)), uO(t.remove)))
		...
		return t.wrap && (c = c.concat(t.wrap)), new cO(i, r, s, o, h, n, a, l, c);
	}
	getNodeType(e) {
...
const PO = {
	Escape(e, t, i) {
		...
		let n = e.char(i + 1);
		for (let t = 0; t < 32; t++)
			if (vO.charCodeAt(t) == n) return e.append(bO(Ad.Escape, i, i + 2));
		return -1;
	},
	Entity(e, t, i) {
		if (38 != t) return -1;
		let n = /^(?:#\d+|#x[a-f\d]+|\w+);/i.exec(e.slice(i + 1, i + 31));
		return n ? e.append(bO(Ad.Entity, i, i + 1 + n[0].length)) : -1;
	},
	InlineCode(e, t, i) {
		...
		for (; n < e.end; n++)
			if (96 == e.char(n)) {
				if ((s++, s == r && 96 != e.char(n + 1)))
					return e.append(
						bO(Ad.InlineCode, i, n + 1, [
							bO(Ad.CodeMark, i, i + r),
							bO(Ad.CodeMark, n + 1 - r, n + 1),
						]),
					);
			} else s = 0;
		return -1;
	...
	HTMLTag(e, t, i) {
		...
		if (r)
			return e.append(
				bO(Ad.Autolink, i, i + 1 + r[0].length, [
					bO(Ad.LinkMark, i, i + 1),
					bO(Ad.URL, i + 1, i + r[0].length),
					bO(Ad.LinkMark, i + r[0].length, i + 1 + r[0].length),
				]),
			);
		let s = /^!--[^>](?:-[^-]|[^-])*?-->/i.exec(n);
		if (s) return e.append(bO(Ad.Comment, i, i + 1 + s[0].length));
		let o = /^\?[^]*?\?>/.exec(n);
		if (o)
			return e.append(bO(Ad.ProcessingInstruction, i, i + 1 + o[0].length));
		let a =
			/^(?:![A-Z][^]*?>|!\[CDATA\[[^]*?\]\]>|\/\s*[a-zA-Z][\w-]*\s*>|\s*[a-zA-Z][\w-]*(\s+[a-zA-Z:_][\w-.:]*(?:\s*=\s*(?:[^\s"'=<>`]+|'[^']*'|"[^"]*"))?)*\s*(\/\s*)?>)/.exec(
				n,
			);
		return a ? e.append(bO(Ad.HTMLTag, i, i + 1 + a[0].length)) : -1;
	},
	Emphasis(e, t, i) {
		...
		let r = e.slice(i - 1, i),
			...
			f = c && (42 == t || !u || o),
			d = u && (42 == t || !c || a);
		return e.append(new kO(95 == t ? SO : yO, i, n, (f ? 1 : 0) | (d ? 2 : 0)));
	},
	HardBreak(e, t, i) {
		if (92 == t && 10 == e.char(i + 1))
			return e.append(bO(Ad.HardBreak, i, i + 2));
		if (32 == t) {
			let t = i + 1;
			for (; 32 == e.char(t); ) t++;
			if (10 == e.char(t) && t >= i + 2)
				return e.append(bO(Ad.HardBreak, i, t + 1));
		}
		return -1;
	},
	Link: (e, t, i) => (91 == t ? e.append(new kO(QO, i, i + 1, 1)) : -1),
	Image: (e, t, i) =>
		33 == t && 91 == e.char(i + 1) ? e.append(new kO(wO, i, i + 2, 1)) : -1,
	LinkEnd(e, t, i) {
		if (93 != t) return -1;
		for (let t = e.parts.length - 1; t >= 0; t--) {
			let n = e.parts[t];
			if (n instanceof kO && (n.type == QO || n.type == wO)) {
				if (
					!n.side ||
				...
				if (n.type == QO)
					for (let i = 0; i < t; i++) {
						let t = e.parts[i];
						t instanceof kO && t.type == QO && (t.side = 0);
					}
				return s.to;
			}
		}
...
function ZO(e, t, i, n, r) {
	let { text: s } = e,
		...
		a = r;
	if (
		(t.unshift(bO(Ad.LinkMark, n, n + (i == Ad.Image ? 2 : 1))),
		t.push(bO(Ad.LinkMark, r - 1, r)),
		40 == o)
	) {
		let i,
			n = e.skipSpace(r + 1),
			o = TO(s, n - e.offset, e.offset);
		o &&
			((n = e.skipSpace(o.to)),
			n != o.to &&
				((i = _O(s, n - e.offset, e.offset)), i && (n = e.skipSpace(i.to)))),
			41 == e.char(n) &&
				(t.push(bO(Ad.LinkMark, r, r + 1)),
				(a = n + 1),
				o && t.push(o),
				i && t.push(i),
				t.push(bO(Ad.LinkMark, n, a)));
	} else if (91 == o) {
		let i = XO(s, r - e.offset, e.offset, !1);
		i && (t.push(i), (a = i.to));
	}
	return bO(i, n, a, t);
}
function TO(e, t, i) {
	if (60 == e.charCodeAt(t)) {
		for (let n = t + 1; n < e.length; n++) {
			...
			if (62 == r) return bO(Ad.URL, t + i, n + 1 + i);
	...
	}
	{
		...
		return r > t ? bO(Ad.URL, t + i, r + i) : r == e.length && null;
	}
}
function _O(e, t, i) {
	...
	for (let n = t + 1, s = !1; n < e.length; n++) {
		...
		if (s) s = !1;
			...
			if (o == r) return bO(Ad.LinkTitle, t + i, n + 1 + i);
			92 == o && (s = !0);
		}
	}
	return null;
...
function XO(e, t, i, n) {
	for (let r = !1, s = t + 1, o = Math.min(e.length, s + 999); s < o; s++) {
		...
		if (r) r = !1;
			...
			if (93 == o) return !n && bO(Ad.LinkLabel, t + i, s + 1 + i);
			if ((n && !Ed(o) && (n = !1), 91 == o)) return !1;
			92 == o && (r = !0);
		}
	}
	return null;
...
class AO {
	...
	addDelimiter(e, t, i, n, r) {
		return this.append(new kO(e, t, i, (n ? 1 : 0) | (r ? 2 : 0)));
	}
	get hasOpenLink() {
		for (let e = this.parts.length - 1; e >= 0; e--) {
			let t = this.parts[e];
			if (t instanceof kO && (t.type == QO || t.type == wO)) return !0;
		}
		return !1;
	}
	addElement(e) {
	...
	resolveMarkers(e) {
		for (let t = e; t < this.parts.length; t++) {
			let i = this.parts[t];
			if (!(i instanceof kO && i.type.resolve && 2 & i.side)) continue;
			let n,
				r = i.type == SO || i.type == yO,
				s = i.to - i.from,
				o = t - 1;
			for (; o >= e; o--) {
				let e = this.parts[o];
			...
			(this.parts[o] =
				r && n.from != h ? new kO(n.type, n.from, h, n.side) : null),
				(this.parts[t] =
					r && i.to != c ? new kO(i.type, c, i.to, i.side) : null)
	...
	findOpeningDelimiter(e) {
		for (let t = this.parts.length - 1; t >= 0; t--) {
			let i = this.parts[t];
			if (i instanceof kO && i.type == e) return t;
		}
		return null;
	}
	takeContent(e) {
...
function CO(e, t) {
	...
	for (let e of t) {
		...
		if (n < i.length && i[n].from < e.from) {
			let t = i[n];
			t instanceof mO &&
				(i[n] = new mO(t.type, t.from, t.to, CO(t.children, [e])));
		} else i.splice(n++, 0, e);
	}
	return i;
}
		...
		if (null == this.rows) {
			...
			if (
				...
				(45 == t.next || 58 == t.next || 124 == t.next) &&
					YO.test((n = t.text.slice(t.pos))))
			) {
				let r = [];
				zO(e, i.content, 0, r, i.start) == zO(e, n, t.pos) &&
					(this.rows = [
			...
			let i = [];
			zO(e, t.text, t.pos, i, e.lineStart),
				this.rows.push(
					e.elt(
						"TableRow",
						e.lineStart + t.pos,
	...
	parseBlock: [
		{
			...
			endLeaf(e, t, i) {
				if (i.parsers.some((e) => e instanceof BO) || !DO(t.text, t.basePos))
					return !1;
				let n = e.peekLine();
				return YO.test(n) && zO(e, t.text, t.basePos) == zO(e, n, t.basePos);
			},
					...
					if (r[1] || r[2]) {
						if (
							((s = (function (e, t) {
								HO.lastIndex = t;
								let i = HO.exec(e);
								if (!i || FO.exec(i[0])[0].indexOf("_") > -1) return -1;
								let n = t + i[0].length;
								for (;;) {
									let i,
										r = e[n - 1];
...
function np(e, t, i) {
	return (n, r, s) => {
		...
		for (let r = s + 1; r < n.end; r++) {
			...
			if ((92 == a && o.push(n.elt("Escape", r, 2 + r++)), Ed(a))) break;
		}
		return -1;
	};
}
const rp = {
		...
		parseInline: [
			{ name: "Superscript", parse: np(94, "Superscript", "SuperscriptMark") },
		],
	},
	sp = {
		defineNodes: [
		...
		parseInline: [
			{ name: "Subscript", parse: np(126, "Subscript", "SubscriptMark") },
		],
	},
	op = {
		...
		if (e) {
			for (
				this.safeFrom = e.openStart
					? wp(e.tree, e.from + e.offset, 1) - e.offset
					: e.from,
					this.safeTo = e.openEnd
						? wp(e.tree, e.to + e.offset, -1) - e.offset
						: e.to;
				this.trees.length;
			)
			...
			for (let a = s.stateSlot(r, e ? 2 : 1); ; a += 3) {
				if (65535 == o[a]) {
					if (1 != o[a + 1]) {
						0 == n &&
							2 == o[a + 1] &&
							(n = this.putAction(Ap(o, a + 2), t, i, n));
						break;
					}
					a = Ap(o, a + 2);
				}
				o[a] == t && (n = this.putAction(Ap(o, a + 1), t, i, n));
			}
		return n;
	}
}
class $p {
	...
	advance() {
		...
		if (this.recovering && e) {
			...
			if (i)
				return (
					yp && console.log("Force-finish " + this.stackID(i)),
	...
	hasAction(e, t) {
		...
		for (let n = 0; n < 2; n++)
			for (let r, s = this.stateSlot(e, n ? 2 : 1); ; s += 3) {
				if (65535 == (r = i[s])) {
					if (1 != i[s + 1]) {
						if (2 == i[s + 1]) return Ap(i, s + 2);
						break;
					}
					r = i[(s = Ap(i, s + 2))];
				}
				if (r == t || 0 == r) return Ap(i, s + 1);
			}
		return 0;
	}
	stateSlot(e, t) {
		...
		return (
			...
			e.specializers &&
				...
				(t.specializerSpecs = this.specializerSpecs.map((i, n) => {
					...
					return (t.specializers[n] = Cp(s)), s;
				}))),
...
function Wp(e, t) {
	...
	return (
		(Vp = e),
		(Lp = i),
		(qp = r ? r.toLowerCase() : n == zp || n == Dp ? void 0 : null)
	);
}
const zp = 63,
	Dp = 33;
...
const Bp = [6, 10, 7, 8, 9],
	Ip = new _p({
		start: null,
		shift: (e, t, i, n) => (Bp.indexOf(t) > -1 ? new Yp(Wp(n, 1) || "", e) : e),
		reduce: (e, t) => (20 == t && e ? e.parent : e),
		reuse(e, t, i, n) {
			let r = t.type.id;
			return 6 == r || 36 == r ? new Yp(Wp(n, 1) || "", e) : e;
		},
		strict: !1,
	}),
	Up = new mp(
		(e, t) => {
			...
			if (i) {
				...
				if (Rp.hasOwnProperty(n)) return e.acceptToken(10);
				r && jp[r] && jp[r][n] ? e.acceptToken(57, -1) : e.acceptToken(6);
			}
		},
		{ contextual: !0 },
	),
...
function rg(e, t, i) {
	let n;
	for (let r of i)
		if (!r.attrs || r.attrs(n || (n = ig(e.node.parent.firstChild, t))))
...
function sg(e = [], t = []) {
	...
	return Wh((e, t) => {
		let a = e.type.id;
		if (28 == a) return rg(e, t, i);
		if (31 == a) return rg(e, t, n);
		...
		if (20 == a && s.length) {
			...
			if (o)
				for (let e of s)
					if (e.tag == o && (!e.attrs || e.attrs(i || (i = ig(r, t))))) {
						let t = n.lastChild,
		...
		if (o && 23 == a) {
			...
			if ((i = n.firstChild)) {
				...
				if (e)
					for (let i of e) {
						if (i.tagName && i.tagName != ng(n.parent, t)) continue;
						let e = n.lastChild;
						if (26 == e.type.id) {
							let t = e.from + 1,
								n = e.lastChild,
...
const Tg = (e) => (t) => {
		...
		if (
			...
			return { from: r.from, options: xg(), validFor: wg };
		if ("ValueName" == r.name)
			return { from: r.from, options: Sg, validFor: wg };
		if ("PseudoClassName" == r.name)
			return { from: r.from, options: bg, validFor: wg };
		if (
			e(r) ||
			((t.explicit || s) &&
				(function (e, t) {
		...
		if ("TagName" == r.name) {
			for (let { parent: e } = r; e; e = e.parent)
				if ("Block" == e.name)
					return { from: r.from, options: xg(), validFor: wg };
			return { from: r.from, options: yg, validFor: wg };
		}
		if ("AtKeyword" == r.name)
			return { from: r.from, options: Qg, validFor: wg };
		if (!t.explicit) return null;
		let o = r.resolve(n),
			a = o.childBefore(n);
		return a && ":" == a.name && "PseudoClassSelector" == o.name
			? { from: n, options: bg, validFor: wg }
			: (a && ":" == a.name && "Declaration" == o.name) || "ArgList" == o.name
				? { from: n, options: Sg, validFor: wg }
				: "Block" == o.name || "Styles" == o.name
					? { from: n, options: xg(), validFor: wg }
					: null;
	},
...
const Wg = new mp((e, t) => {
		...
		let i = 0;
		for (; Rg.indexOf(e.next) > -1; ) e.advance(), i++;
		if (Lg(e.next, !0)) {
			for (e.advance(), i++; Lg(e.next, !1); ) e.advance(), i++;
			for (; Rg.indexOf(e.next) > -1; ) e.advance(), i++;
			if (44 == e.next) return;
			for (let t = 0; ; t++) {
				if (7 == t) {
	...
	return (
		t.cursor(xh.IncludeAnonymous).iterate((t) => {
			if (r) r = !1;
				...
				for (let i of em(e, t.node)) n.push(i);
				return !1;
			}
		}),
		Ng.set(t, n),
...
function nm(e) {
	...
	if (im.indexOf(t.name) > -1) return null;
	let i =
		"VariableName" == t.name ||
	...
	for (let i = t; i; i = i.parent)
		Hg.has(i.name) && (n = n.concat(em(e.state.doc, i)));
	return { options: n, from: i ? t.from : e.pos, validFor: tm };
}
function rm(e, t, i) {
	var n;
	let r = [];
...
function sm(e) {
	...
	return "PropertyName" == i.name
		...
		: ("." != i.name && "?." != i.name) || "MemberExpression" != i.parent.name
			? im.indexOf(i.name) > -1
				? null
				: "VariableName" == i.name || (i.to - i.from < 20 && tm.test(t(i)))
					? { path: [], name: t(i) }
...
function Om(e = {}) {
	let t = e.jsx ? (e.typescript ? cm : hm) : e.typescript ? lm : om,
		i = e.typescript ? Gg.concat(dm) : Ug.concat(fm);
	return new Wc(t, [
		om.data.of({ autocomplete: cd(im, hd(i)) }),
		om.data.of({ autocomplete: nm }),
		e.jsx ? mm : [],
	]);
}
function pm(e, t, i = e.length) {
...
const gm =
	...
	mm = Gl.inputHandler.of((e, t, i, n, r) => {
		if (
...
function bm(e, t, i) {
	let n = xm(e.line, e.column, t, i),
		r = {
			from: n,
			to:
				null != e.endLine && 1 != e.endColumn
					? xm(e.endLine, e.endColumn, t, i)
					: n,
			message: e.message,
	...
	esLint: function (e, t) {
		return (
			...
			(i) => {
				let { state: n } = i,
					r = [];
				for (let { from: i, to: s } of om.findRegions(n)) {
					let o = n.doc.lineAt(i),
						a = { line: o.number - 1, col: i - o.from, pos: i };
					for (let o of e.verify(n.sliceDoc(i, s), t)) r.push(bm(o, n.doc, a));
				}
				return r;
			}
		);
	...
	scopeCompletionSource: function (e) {
		...
		return (i) => {
			...
			return (
				...
				{ from: i.pos - n.name.length, options: s, validFor: tm }
			);
		};
	},
	snippets: Ug,
...
function Cm(e, t, i) {
	let n = i.tags[Xm(e, Am(t))];
	return (null == n ? void 0 : n.children) || i.allTags;
}
function Rm(e, t) {
	let i = [];
	for (let n = Am(t); n && !n.type.isTop; n = Am(n.parent)) {
		let r = Xm(e, n);
					...
					: "Is" == r.name ||
						...
						: !t.explicit ||
							...
							: (function (e, t, i, n) {
									let r = [],
										s = 0;
									for (let n of Cm(e.doc, i, t))
										r.push({ label: "<" + n, type: "type" });
									for (let t of Rm(e.doc, i))
										r.push({
											label: "</" + t + ">",
											type: "type",
											boost: 99 - s++,
...
function Im(e = {}) {
	...
	let n = t
		? Ym.configure({ wrap: t, dialect: i })
		: i
			? Bm.configure({ dialect: i })
			: Bm;
	return new Wc(n, [
...
const Um = new Set(
	...
	Gm = Gl.inputHandler.of((e, t, i, n, r) => {
		if (
			e.composing ||
			e.state.readOnly ||
			t != i ||
...
function ex(e, t) {
	...
	for (;;) {
		let e,
			n = i.nextSibling;
		if (!n || (null != (e = Jm(n.type)) && e <= t)) break;
		i = n;
	}
	return i.to;
}
const tx = su.of((e, t, i) => {
...
function ox(e, t) {
	...
	for (let e = i.length - 1; e >= 0; e--) {
		...
		if ("Blockquote" == s.name && (r = /^ *>( ?)/.exec(o.text.slice(a))))
			n.push(new sx(s, a, a + r[0].length, "", r[1], ">", null));
		else if (
			"ListItem" == s.name &&
			...
			e.length >= 4 && ((e = e.slice(0, e.length - 4)), (t -= 4)),
				n.push(new sx(s.parent, a, a + t, r[1], e, r[2], s));
		} else if (
			"ListItem" == s.name &&
			...
			r[3] && (i += r[3].replace(/[xX]/, " ")),
				n.push(new sx(s.parent, a, a + t, r[1], e, i, s));
		}
	}
	return n;
}
		...
		s = e.changeByRange((t) => {
			...
			if (l.item && h) {
				...
				if (
					...
					return (
						"OrderedList" == l.node.name && lx(l.item, n, r, -2),
						t && "OrderedList" == t.node.name && lx(t.item, n, r),
						{ range: Tn.cursor(e + i.length), changes: r }
					);
				}
				{
					let t = fx(a, e, o);
					return {
						range: Tn.cursor(s + t.length + 1),
			...
			let c = [];
			"OrderedList" == l.node.name && lx(l.item, n, c);
			...
			return (
				...
				{ range: Tn.cursor(d + f.length + 1), changes: c }
			);
		});
						...
						if (
							...
							if (
								...
								return (
									n == t.from && (r = hx(r, e)),
									{
										range: Tn.cursor(n + r.length),
										changes: { from: n, to: t.from + i.to, insert: r },
									}
								);
							}
							if (n < r)
								return { range: Tn.cursor(n), changes: { from: n, to: r } };
						}
					}
				}
				return (n = { range: t });
			...
			let { codeParser: t, htmlParser: i } = e,
				n = Wh((e, n) => {
					...
					if (!t || (r != Ad.CodeBlock && r != Ad.FencedCode)) {
						if (i && (r == Ad.HTMLBlock || r == Ad.HTMLTag))
							return { parser: i, overlay: VO(e.node, e.from, e.to) };
					} else {
						let i = "";
						if (r == Ad.FencedCode) {
...
function Qx(e) {
	return import("./index-j45NRnMQ.js").then((t) => t.sql({ dialect: t[e] }));
}
const wx = [
		zc.of({
			name: "C",
			extensions: ["c", "h", "ino"],
			load: () => import("./index-DqSNg-SV.js").then((e) => e.cpp()),
		}),
		zc.of({
			name: "C++",
			alias: ["cpp"],
		...
		zc.of({
			name: "Go",
			extensions: ["go"],
			load: () => import("./index-BNdhTJsO.js").then((e) => e.go()),
		}),
		zc.of({
			name: "HTML",
			alias: ["xhtml"],
		...
		zc.of({
			name: "Java",
			extensions: ["java"],
			load: () => import("./index-C-N4jc85.js").then((e) => e.java()),
		}),
		zc.of({
			name: "JavaScript",
		...
		zc.of({
			...
			alias: ["json5"],
			extensions: ["json", "map"],
			load: () => import("./index-Bizl68N5.js").then((e) => e.json()),
		}),
		zc.of({
			name: "JSX",
			extensions: ["jsx"],
		...
		zc.of({
			name: "LESS",
			extensions: ["less"],
			load: () => import("./index-CF6t3dvw.js").then((e) => e.less()),
		}),
		zc.of({
			name: "Liquid",
			extensions: ["liquid"],
			load: () => import("./index-NStk51FJ.js").then((e) => e.liquid()),
		}),
		...
		zc.of({
			...
			load: () => import("./index-CeFpseKX.js").then((e) => e.php()),
		}),
		...
		zc.of({
			...
			filename: /^(BUCK|BUILD)$/,
			load: () => import("./index-h8YlorrD.js").then((e) => e.python()),
		}),
		zc.of({
			name: "Rust",
			extensions: ["rs"],
			load: () => import("./index-D2H-U1EM.js").then((e) => e.rust()),
		}),
		zc.of({
			name: "Sass",
			extensions: ["sass"],
			load: () =>
				import("./index-Dr8ZKucK.js").then((e) => e.sass({ indented: !0 })),
		}),
		zc.of({
			name: "SCSS",
			extensions: ["scss"],
			load: () => import("./index-Dr8ZKucK.js").then((e) => e.sass()),
		}),
		...
		zc.of({
			name: "WebAssembly",
			extensions: ["wat", "wast"],
			load: () => import("./index-7B7OCHLO.js").then((e) => e.wast()),
		}),
		zc.of({
			name: "XML",
			alias: ["rss", "wsdl", "xsd"],
			extensions: ["xml", "xsl", "xsd", "svg"],
			load: () => import("./index-D_Gk6kFj.js").then((e) => e.xml()),
		}),
		zc.of({
			name: "YAML",
			alias: ["yml"],
			extensions: ["yaml", "yml"],
			load: () => import("./index-BT3Ui71v.js").then((e) => e.yaml()),
		}),
		zc.of({
			name: "APL",
			extensions: ["dyalog", "apl"],
			load: () => import("./apl-DPxMobLc.js").then((e) => yx(e.apl)),
		}),
		zc.of({
			name: "PGP",
			alias: ["asciiarmor"],
			...
			load: () =>
				import("./asciiarmor-B51oD8Ym.js").then((e) => yx(e.asciiArmor)),
		}),
		zc.of({
			name: "ASN.1",
			extensions: ["asn", "asn1"],
			load: () => import("./asn1-Cil3lh9G.js").then((e) => yx(e.asn1({}))),
		}),
		zc.of({
			name: "Asterisk",
			filename: /^extensions\.conf$/i,
			load: () => import("./asterisk-BLXj2Kgd.js").then((e) => yx(e.asterisk)),
		}),
		zc.of({
			name: "Brainfuck",
			extensions: ["b", "bf"],
			load: () =>
				import("./brainfuck-BHwJslvD.js").then((e) => yx(e.brainfuck)),
		}),
		zc.of({
			name: "Cobol",
			extensions: ["cob", "cpy"],
			load: () => import("./cobol-C5dsN7c4.js").then((e) => yx(e.cobol)),
		}),
		zc.of({
			name: "C#",
			alias: ["csharp", "cs"],
			extensions: ["cs"],
			load: () => import("./clike-BsU_3Ptx.js").then((e) => yx(e.csharp)),
		}),
		zc.of({
			name: "Clojure",
			extensions: ["clj", "cljc", "cljx"],
			load: () => import("./clojure-oPQ69egj.js").then((e) => yx(e.clojure)),
		}),
		zc.of({
			name: "ClojureScript",
			extensions: ["cljs"],
		...
		zc.of({
			...
			extensions: ["gss"],
			load: () => import("./css-DFVBrA6K.js").then((e) => yx(e.gss)),
		}),
		zc.of({
			name: "CMake",
			extensions: ["cmake", "cmake.in"],
			filename: /^CMakeLists\.txt$/,
			load: () => import("./cmake-DE1Tmldz.js").then((e) => yx(e.cmake)),
		}),
		zc.of({
			name: "CoffeeScript",
			...
			extensions: ["coffee"],
			load: () =>
				import("./coffeescript-CIpLmZy1.js").then((e) => yx(e.coffeeScript)),
		}),
		zc.of({
			name: "Common Lisp",
			alias: ["lisp"],
			...
			load: () =>
				import("./commonlisp-Bh7_dm6J.js").then((e) => yx(e.commonLisp)),
		}),
		zc.of({
			name: "Cypher",
			extensions: ["cyp", "cypher"],
			load: () => import("./cypher-niYxv7YP.js").then((e) => yx(e.cypher)),
		}),
		zc.of({
			name: "Cython",
			extensions: ["pyx", "pxd", "pxi"],
			load: () => import("./python-Dk6A-v1d.js").then((e) => yx(e.cython)),
		}),
		zc.of({
			name: "Crystal",
			extensions: ["cr"],
			load: () => import("./crystal-B3M-4rOT.js").then((e) => yx(e.crystal)),
		}),
		zc.of({
			name: "D",
			extensions: ["d"],
			load: () => import("./d-fz-mrRy1.js").then((e) => yx(e.d)),
		}),
		zc.of({
			name: "Dart",
			extensions: ["dart"],
			load: () => import("./clike-BsU_3Ptx.js").then((e) => yx(e.dart)),
		}),
		zc.of({
			name: "diff",
			extensions: ["diff", "patch"],
			load: () => import("./diff-CAH5xNMa.js").then((e) => yx(e.diff)),
		}),
		zc.of({
			name: "Dockerfile",
			filename: /^Dockerfile$/,
			load: () =>
				import("./dockerfile-CI87wDm9.js").then((e) => yx(e.dockerFile)),
		}),
		zc.of({
			name: "DTD",
			extensions: ["dtd"],
			load: () => import("./dtd-CrXbFSGo.js").then((e) => yx(e.dtd)),
		}),
		zc.of({
			name: "Dylan",
			extensions: ["dylan", "dyl", "intr"],
			load: () => import("./dylan-BD3E5D-t.js").then((e) => yx(e.dylan)),
		}),
		zc.of({
			name: "EBNF",
			load: () => import("./ebnf-DdCNqlPO.js").then((e) => yx(e.ebnf)),
		}),
		zc.of({
			name: "ECL",
			extensions: ["ecl"],
			load: () => import("./ecl-8vfqhaZw.js").then((e) => yx(e.ecl)),
		}),
		zc.of({
			name: "edn",
			extensions: ["edn"],
		...
		zc.of({
			name: "Eiffel",
			extensions: ["e"],
			load: () => import("./eiffel-DHYrYbwi.js").then((e) => yx(e.eiffel)),
		}),
		zc.of({
			name: "Elm",
			extensions: ["elm"],
			load: () => import("./elm-zdQ55cZ5.js").then((e) => yx(e.elm)),
		}),
		zc.of({
			name: "Erlang",
			extensions: ["erl"],
			load: () => import("./erlang-BUx2Pbg5.js").then((e) => yx(e.erlang)),
		}),
		zc.of({
			name: "Esper",
			load: () => import("./sql-BGrMlkuy.js").then((e) => yx(e.esper)),
		}),
		zc.of({
			name: "Factor",
			extensions: ["factor"],
			load: () => import("./factor-jLc--FSb.js").then((e) => yx(e.factor)),
		}),
		zc.of({
			name: "FCL",
			load: () => import("./fcl-DtEU-sOG.js").then((e) => yx(e.fcl)),
		}),
		zc.of({
			name: "Forth",
			extensions: ["forth", "fth", "4th"],
			load: () => import("./forth-sOw8g7Fh.js").then((e) => yx(e.forth)),
		}),
		zc.of({
			name: "Fortran",
			extensions: ["f", "for", "f77", "f90", "f95"],
			load: () => import("./fortran-CUw0gOHq.js").then((e) => yx(e.fortran)),
		}),
		zc.of({
			name: "F#",
			alias: ["fsharp"],
			extensions: ["fs"],
			load: () => import("./mllike-XYhq5y8_.js").then((e) => yx(e.fSharp)),
		}),
		zc.of({
			name: "Gas",
			extensions: ["s"],
			load: () => import("./gas-D6kEQ7Rc.js").then((e) => yx(e.gas)),
		}),
		zc.of({
			name: "Gherkin",
			extensions: ["feature"],
			load: () => import("./gherkin-QaWPbPIp.js").then((e) => yx(e.gherkin)),
		}),
		zc.of({
			name: "Groovy",
			extensions: ["groovy", "gradle"],
			filename: /^Jenkinsfile$/,
			load: () => import("./groovy-DCsad2Oo.js").then((e) => yx(e.groovy)),
		}),
		zc.of({
			name: "Haskell",
			extensions: ["hs"],
			load: () => import("./haskell-B0DI3rnZ.js").then((e) => yx(e.haskell)),
		}),
		zc.of({
			name: "Haxe",
			extensions: ["hx"],
			load: () => import("./haxe-D83Ia0Bb.js").then((e) => yx(e.haxe)),
		}),
		zc.of({
			name: "HXML",
			extensions: ["hxml"],
			load: () => import("./haxe-D83Ia0Bb.js").then((e) => yx(e.hxml)),
		}),
		zc.of({
			name: "HTTP",
			load: () => import("./http-CEWkRLH-.js").then((e) => yx(e.http)),
		}),
		zc.of({
			name: "IDL",
			extensions: ["pro"],
			load: () => import("./idl-B3zlXbgM.js").then((e) => yx(e.idl)),
		}),
		zc.of({
			name: "JSON-LD",
			alias: ["jsonld"],
			extensions: ["jsonld"],
			load: () => import("./javascript-BPk6jw1r.js").then((e) => yx(e.jsonld)),
		}),
		zc.of({
			name: "Jinja2",
			extensions: ["j2", "jinja", "jinja2"],
			load: () => import("./jinja2-BeTZ1LTs.js").then((e) => yx(e.jinja2)),
		}),
		zc.of({
			name: "Julia",
			extensions: ["jl"],
			load: () => import("./julia-DlEOxaAi.js").then((e) => yx(e.julia)),
		}),
		zc.of({
			name: "Kotlin",
			extensions: ["kt", "kts"],
			load: () => import("./clike-BsU_3Ptx.js").then((e) => yx(e.kotlin)),
		}),
		zc.of({
			name: "LiveScript",
			alias: ["ls"],
			extensions: ["ls"],
			load: () =>
				import("./livescript-uLyHAz2f.js").then((e) => yx(e.liveScript)),
		}),
		zc.of({
			name: "Lua",
			extensions: ["lua"],
			load: () => import("./lua-BnH60Yfs.js").then((e) => yx(e.lua)),
		}),
		zc.of({
			name: "mIRC",
			extensions: ["mrc"],
			load: () => import("./mirc-BO8-zUSx.js").then((e) => yx(e.mirc)),
		}),
		zc.of({
			name: "Mathematica",
			extensions: ["m", "nb", "wl", "wls"],
			load: () =>
				import("./mathematica-as6zDwYy.js").then((e) => yx(e.mathematica)),
		}),
		zc.of({
			name: "Modelica",
			extensions: ["mo"],
			load: () => import("./modelica-C36xtOoU.js").then((e) => yx(e.modelica)),
		}),
		zc.of({
			name: "MUMPS",
			extensions: ["mps"],
			load: () => import("./mumps-BTol1Blm.js").then((e) => yx(e.mumps)),
		}),
		zc.of({
			name: "Mbox",
			extensions: ["mbox"],
			load: () => import("./mbox-BW5B8sHr.js").then((e) => yx(e.mbox)),
		}),
		zc.of({
			name: "Nginx",
			filename: /nginx.*\.conf$/i,
			load: () => import("./nginx-BtJCkB_N.js").then((e) => yx(e.nginx)),
		}),
		zc.of({
			name: "NSIS",
			extensions: ["nsh", "nsi"],
			load: () => import("./nsis-DCUiYBIv.js").then((e) => yx(e.nsis)),
		}),
		zc.of({
			name: "NTriples",
			extensions: ["nt", "nq"],
			load: () => import("./ntriples-C3TCn7t8.js").then((e) => yx(e.ntriples)),
		}),
		zc.of({
			name: "Objective-C",
			alias: ["objective-c", "objc"],
			extensions: ["m"],
			load: () => import("./clike-BsU_3Ptx.js").then((e) => yx(e.objectiveC)),
		}),
		zc.of({
			name: "Objective-C++",
			alias: ["objective-c++", "objc++"],
			extensions: ["mm"],
			load: () => import("./clike-BsU_3Ptx.js").then((e) => yx(e.objectiveCpp)),
		}),
		zc.of({
			name: "OCaml",
			extensions: ["ml", "mli", "mll", "mly"],
			load: () => import("./mllike-XYhq5y8_.js").then((e) => yx(e.oCaml)),
		}),
		zc.of({
			name: "Octave",
			extensions: ["m"],
			load: () => import("./octave-l5YK3rmg.js").then((e) => yx(e.octave)),
		}),
		zc.of({
			name: "Oz",
			extensions: ["oz"],
			load: () => import("./oz-YcMr9qRC.js").then((e) => yx(e.oz)),
		}),
		zc.of({
			name: "Pascal",
			extensions: ["p", "pas"],
			load: () => import("./pascal-C7yJoDUq.js").then((e) => yx(e.pascal)),
		}),
		zc.of({
			name: "Perl",
			extensions: ["pl", "pm"],
			load: () => import("./perl-DSYjljZJ.js").then((e) => yx(e.perl)),
		}),
		zc.of({
			name: "Pig",
			extensions: ["pig"],
			load: () => import("./pig-BthYB5Hz.js").then((e) => yx(e.pig)),
		}),
		zc.of({
			name: "PowerShell",
			extensions: ["ps1", "psd1", "psm1"],
			load: () =>
				import("./powershell-vZEBNqmt.js").then((e) => yx(e.powerShell)),
		}),
		zc.of({
			...
			load: () =>
				import("./properties-BWiOuWqJ.js").then((e) => yx(e.properties)),
		}),
		zc.of({
			name: "ProtoBuf",
			extensions: ["proto"],
			load: () => import("./protobuf-DoE0cNFa.js").then((e) => yx(e.protobuf)),
		}),
		zc.of({
			name: "Pug",
			alias: ["jade"],
			extensions: ["pug", "jade"],
			load: () => import("./pug-Dq5U0CG_.js").then((e) => yx(e.pug)),
		}),
		zc.of({
			name: "Puppet",
			extensions: ["pp"],
			load: () => import("./puppet-DD1cESfM.js").then((e) => yx(e.puppet)),
		}),
		zc.of({
			name: "Q",
			extensions: ["q"],
			load: () => import("./q-DIFQivbw.js").then((e) => yx(e.q)),
		}),
		zc.of({
			name: "R",
			alias: ["rscript"],
			extensions: ["r", "R"],
			load: () => import("./r-BMfgZ5yV.js").then((e) => yx(e.r)),
		}),
		zc.of({
			name: "RPM Changes",
			load: () => import("./rpm-BSEG7loO.js").then((e) => yx(e.rpmChanges)),
		}),
		zc.of({
			name: "RPM Spec",
			extensions: ["spec"],
			load: () => import("./rpm-BSEG7loO.js").then((e) => yx(e.rpmSpec)),
		}),
		zc.of({
			name: "Ruby",
			...
			load: () => import("./ruby-CssCQRhO.js").then((e) => yx(e.ruby)),
		}),
		zc.of({
			name: "SAS",
			extensions: ["sas"],
			load: () => import("./sas-HnRH-2zZ.js").then((e) => yx(e.sas)),
		}),
		zc.of({
			name: "Scala",
			extensions: ["scala"],
			load: () => import("./clike-BsU_3Ptx.js").then((e) => yx(e.scala)),
		}),
		zc.of({
			name: "Scheme",
			extensions: ["scm", "ss"],
			load: () => import("./scheme-B7GW9J_7.js").then((e) => yx(e.scheme)),
		}),
		zc.of({
			name: "Shell",
			alias: ["bash", "sh", "zsh"],
			...
			filename: /^PKGBUILD$/,
			load: () => import("./shell-C9Em7lCa.js").then((e) => yx(e.shell)),
		}),
		zc.of({
			name: "Sieve",
			extensions: ["siv", "sieve"],
			load: () => import("./sieve-D58baEEm.js").then((e) => yx(e.sieve)),
		}),
		zc.of({
			name: "Smalltalk",
			extensions: ["st"],
			load: () =>
				import("./smalltalk-CRwoVvYQ.js").then((e) => yx(e.smalltalk)),
		}),
		zc.of({
			name: "Solr",
			load: () => import("./solr-hb7a9myP.js").then((e) => yx(e.solr)),
		}),
		zc.of({
			name: "SML",
			extensions: ["sml", "sig", "fun", "smackspec"],
			load: () => import("./mllike-XYhq5y8_.js").then((e) => yx(e.sml)),
		}),
		zc.of({
			name: "SPARQL",
			alias: ["sparul"],
			extensions: ["rq", "sparql"],
			load: () => import("./sparql-BFjb6nLJ.js").then((e) => yx(e.sparql)),
		}),
		zc.of({
			name: "Spreadsheet",
			alias: ["excel", "formula"],
			load: () =>
				import("./spreadsheet-BtPPhYI9.js").then((e) => yx(e.spreadsheet)),
		}),
		zc.of({
			name: "Squirrel",
			extensions: ["nut"],
			load: () => import("./clike-BsU_3Ptx.js").then((e) => yx(e.squirrel)),
		}),
		zc.of({
			name: "Stylus",
			extensions: ["styl"],
			load: () => import("./stylus-1Pvu7UXQ.js").then((e) => yx(e.stylus)),
		}),
		zc.of({
			name: "Swift",
			extensions: ["swift"],
			load: () => import("./swift-CAT9wtmT.js").then((e) => yx(e.swift)),
		}),
		zc.of({
			name: "sTeX",
			load: () => import("./stex-BrA22C5O.js").then((e) => yx(e.stex)),
		}),
		zc.of({
			name: "LaTeX",
			alias: ["tex"],
		...
		zc.of({
			name: "SystemVerilog",
			extensions: ["v", "sv", "svh"],
			load: () => import("./verilog-D0Lo9oPB.js").then((e) => yx(e.verilog)),
		}),
		zc.of({
			name: "Tcl",
			extensions: ["tcl"],
			load: () => import("./tcl-BsptRImA.js").then((e) => yx(e.tcl)),
		}),
		zc.of({
			name: "Textile",
			extensions: ["textile"],
			load: () => import("./textile-DwbuwdYj.js").then((e) => yx(e.textile)),
		}),
		zc.of({
			name: "TiddlyWiki",
			load: () =>
				import("./tiddlywiki-eHRRguqQ.js").then((e) => yx(e.tiddlyWiki)),
		}),
		zc.of({
			name: "Tiki wiki",
			load: () => import("./tiki-C3-6d3YE.js").then((e) => yx(e.tiki)),
		}),
		zc.of({
			name: "TOML",
			extensions: ["toml"],
			load: () => import("./toml-_XLYe2Wa.js").then((e) => yx(e.toml)),
		}),
		zc.of({
			name: "Troff",
			extensions: ["1", "2", "3", "4", "5", "6", "7", "8", "9"],
			load: () => import("./troff-DXviO7Mp.js").then((e) => yx(e.troff)),
		}),
		zc.of({
			name: "TTCN",
			extensions: ["ttcn", "ttcn3", "ttcnpp"],
			load: () => import("./ttcn-BSzdvELj.js").then((e) => yx(e.ttcn)),
		}),
		zc.of({
			name: "TTCN_CFG",
			extensions: ["cfg"],
			load: () => import("./ttcn-cfg-CtOb6jrc.js").then((e) => yx(e.ttcnCfg)),
		}),
		zc.of({
			name: "Turtle",
			extensions: ["ttl"],
			load: () => import("./turtle-5heLEolO.js").then((e) => yx(e.turtle)),
		}),
		zc.of({
			name: "Web IDL",
			extensions: ["webidl"],
			load: () => import("./webidl-CS14qeoI.js").then((e) => yx(e.webIDL)),
		}),
		zc.of({
			name: "VB.NET",
			extensions: ["vb"],
			load: () => import("./vb-GZ0Y1TrX.js").then((e) => yx(e.vb)),
		}),
		zc.of({
			name: "VBScript",
			extensions: ["vbs"],
			load: () => import("./vbscript-9okRuUr7.js").then((e) => yx(e.vbScript)),
		}),
		zc.of({
			name: "Velocity",
			extensions: ["vtl"],
			load: () => import("./velocity-D5tFZ5bk.js").then((e) => yx(e.velocity)),
		}),
		zc.of({
			name: "Verilog",
			extensions: ["v"],
		...
		zc.of({
			name: "VHDL",
			extensions: ["vhd", "vhdl"],
			load: () => import("./vhdl-B7VoT424.js").then((e) => yx(e.vhdl)),
		}),
		zc.of({
			name: "XQuery",
			extensions: ["xy", "xquery"],
			load: () => import("./xquery-D8QROkwP.js").then((e) => yx(e.xQuery)),
		}),
		zc.of({
			name: "Yacas",
			extensions: ["ys"],
			load: () => import("./yacas-mn8YnPAW.js").then((e) => yx(e.yacas)),
		}),
		zc.of({
			name: "Z80",
			extensions: ["z80"],
			load: () => import("./z80-C3LewqKw.js").then((e) => yx(e.z80)),
		}),
		zc.of({
			name: "MscGen",
			extensions: ["mscgen", "mscin", "msc"],
			load: () => import("./mscgen-C5yui7A0.js").then((e) => yx(e.mscgen)),
		}),
		zc.of({
			name: "Xù",
			extensions: ["xu"],
			load: () => import("./mscgen-C5yui7A0.js").then((e) => yx(e.xu)),
		}),
		zc.of({
			name: "MsGenny",
			extensions: ["msgenny"],
			load: () => import("./mscgen-C5yui7A0.js").then((e) => yx(e.msgenny)),
		}),
		zc.of({
			name: "Vue",
			extensions: ["vue"],
			load: () => import("./index-DGuDbUCB.js").then((e) => e.vue()),
		}),
		zc.of({
			name: "Angular Template",
			load: () => import("./index-DzB-eGMK.js").then((e) => e.angular()),
		}),
	],
	kx = "var(--editor-bg, #1e1e1e)",
	...
	Ex = Gl.theme(
		{
			...
			".cm-gutters": { backgroundColor: kx, color: jx, border: "none" },
			".cm-activeLineGutter": { backgroundColor: Zx },
			".cm-activeLine": { backgroundColor: Zx },
			[wc.heading]: { color: Cx, fontWeight: "bold" },
			[wc.strong]: { fontWeight: "bold" },
			[wc.emphasis]: { fontStyle: "italic" },
			[wc.link]: { color: Rx, textDecoration: "underline" },
			[wc.url]: { color: Rx },
			[wc.quote]: { color: Tx, fontStyle: "italic" },
			[wc.keyword]: { color: _x },
			[wc.comment]: { color: Tx, fontStyle: "italic" },
			[wc.string]: { color: Xx },
			[wc.number]: { color: Ax },
			[wc.operator]: { color: Mx },
			[wc.punctuation]: { color: jx },
			[wc.monospace]: {
				fontFamily: "var(--editor-mono-font-family, monospace)",
			},
			[wc.contentSeparator]: { color: Cx, fontWeight: "bold" },
			[wc.list]: { color: vx },
			[wc.meta]: { color: Tx },
		},
		{ dark: !0 },
...
function Vx(e, t = "", i = {}) {
	const { onChange: n = () => {}, additionalExtensions: r = [] } = i,
		s = Sr.create({
			doc: initialContent,
			extensions: [
				[
...
function Wx(e, t, i, n, r = t.length) {
	const s = e.selection.main;
	if (s.empty) {
		const e = t + n + i;
		return {
			changes: { from: s.from, insert: e },
			selection: Tn.cursor(s.from + r),
		};
	}
	return {
		changes: [
		...
		selection: Tn.range(s.from + t.length, s.to + t.length),
	};
}
function zx(e, t, i = !1) {
	const n = [];
...
function Dx(e, t, i = "", n = "", r = !1) {
	...
	e.dispatch({
		...
		selection:
			a.empty && !r
				? Tn.cursor(a.from + l.length)
				: a.empty && r
					? Tn.cursor(startLine.from + l.length + 1 + n.length + 1)
					: void 0,
			...
			if (i)
				try {
					...
					console.error(
						...
						console.error(`Error parsing initial content from #${t}:`, i),
						(e = "");
				}
			else
				console.warn(
						...
						!(function (e) {
							...
							if (i.empty) {
								...
								n = {
									...
									selection: Tn.cursor(i.from + e.length + 3),
								};
							}
