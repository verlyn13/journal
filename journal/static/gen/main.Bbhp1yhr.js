...
function F(e, t, n, i, r) {
	if (Y && "function" == typeof t) {
		...
		s instanceof Promise
			? s.then((t) => F(e, t, n, i)).catch((e) => D(e, r, t))
			: e(s);
	} else
				...
				(i && "boolean" != typeof i
					...
					: (function (e, t, n) {
							...
							let o = !t.includes("opacity") && !t.includes("scale"),
								...
								h = a ? 0 : 1,
								c = l ? Ye(t, "scale", 95) / 100 : 1,
								u = Ye(t, "delay", 0) / 1e3,
								f = Ye(t, "origin", "center"),
								d = "opacity, transform",
								O = Ye(t, "duration", 150) / 1e3,
								p = Ye(t, "duration", 75) / 1e3,
...
var pt = {
		...
		plugin: function (e) {
			(Array.isArray(e) ? e : [e]).forEach((e) => e(gt));
		},
		magic: L,
		store: function (t, n) {
...
var Dt = mt("__proto__,__v_isRef,__isVue"),
	Yt = new Set(
...
function Nt(e = !1, t = !1) {
	return function (n, i, r) {
		...
		if (wt(i) ? Yt.has(i) : Dt(i)) return o;
...
var Ft = {
		...
		has: function (e, t) {
			...
			return (wt(t) && Yt.has(t)) || Wt(e, "has", t), n;
		},
		ownKeys: function (e) {
	...
	return $(() => {
		...
		if ("select" === e.tagName.toLowerCase() && e.multiple)
			return t.includes("number")
				? Array.from(n.target.selectedOptions).map((e) => Dn(e.value || e.text))
				: t.includes("boolean")
...
(En.inline = (e, { modifiers: t }, { cleanup: n }) => {
	...
	te(
		...
		(e, { modifiers: t, expression: n }, { effect: i, cleanup: r }) => {
			...
			let l = () => {
					let e;
					return a((t) => (e = t)), Yn(e) ? e.get() : e;
				},
				h = (e) => {
					let t;
					a((e) => (t = e)),
						Yn(t) ? t.set(e) : o(() => {}, { scope: { __placeholder: e } });
				};
			"string" == typeof n &&
				"radio" === e.type &&
				$(() => {
				...
				(function (t, n, i, r) {
					...
					i((i) => {
						...
						for (let e = 0; e < u.length; e++) {
							let t = u[e],
								n = h.indexOf(t);
							if (-1 === n) h.splice(e, 0, t), f.push([g, e]);
							else if (n !== e) {
			...
			const n = (function (e, t) {
				const n = function () {
					...
					if (!Ct.includes(n)) {
						Et(n);
						try {
							return Vt.push(qt), (qt = !0), Ct.push(n), (xt = n), e();
						} finally {
...
class hi extends ai {
	...
	replace(e, t, n) {
		if ((([e, t] = gi(this, e, t)), n.lines < this.lines))
...
class Ai {
	...
	static define(e = {}) {
		return new Ai(
			...
			e.compare || (e.combine ? (e, t) => e === t : Ci),
			!!e.static,
			e.enables,
		);
	}
	...
	return {
		...
		reconfigure(e, r) {
			let s = ji(e, i),
				...
				h = r.facet(t);
			if (l && !s && Ci(n, l)) return (e.values[o] = h), 0;
			let c = a(e);
			return t.compare(c, h) ? ((e.values[o] = h), 0) : ((e.values[o] = c), 1);
		},
	};
}
const qi = Ai.define({ static: !0 });
class Vi {
	constructor(e, t, n, i, r) {
		(this.id = e),
			(this.createF = t),
	...
	static resolve(e, t, n) {
		...
		for (let e in r) {
			...
			if (t.every((e) => 0 == e.type))
				if (((o[i.id] = (a.length << 1) | 1), Ci(s, t))) a.push(n.facet(i));
				else {
...
const Ki = Ai.define(),
	Ji = Ai.define({ combine: (e) => e.some((e) => e), static: !0 }),
	er = Ai.define({ combine: (e) => (e.length ? e[0] : void 0), static: !0 }),
	tr = Ai.define(),
	nr = Ai.define(),
	ir = Ai.define(),
	rr = Ai.define({ combine: (e) => !!e.length && e[0] });
class sr {
	constructor(e, t) {
		...
		if (
			(function (e) {
				...
				for (let t = 0; t < e.length; t++) {
					...
					if (
						/\w/.test(n) ||
						(n > "" && (n.toUpperCase() != n.toLowerCase() || mr.test(n)))
					)
						return !0;
				}
				return !1;
			...
			return gr.Word;
		for (let n = 0; n < e.length; n++) if (t.indexOf(e[n]) > -1) return gr.Word;
		return gr.Other;
	};
}
class Sr {
	...
	wordAt(e) {
		...
		for (; s > 0; ) {
			let e = mi(t, s, !1);
			if (r(t.slice(e, s)) != gr.Word) break;
			s = e;
		}
		for (; o < i; ) {
			let e = mi(t, o);
			if (r(t.slice(o, e)) != gr.Word) break;
			o = e;
		}
...
(Sr.allowMultipleSelections = Ji),
	(Sr.tabSize = Ai.define({ combine: (e) => (e.length ? e[0] : 4) })),
	(Sr.lineSeparator = er),
	(Sr.readOnly = rr),
	(Sr.phrases = Ai.define({
		compare(e, t) {
			let n = Object.keys(e),
				i = Object.keys(t);
...
class vr {
	...
	static compare(e, t, n, i, r = -1) {
		let s = e.filter((e) => e.maxPoint > 0 || (!e.isEmpty && e.maxPoint >= r)),
			...
			l = new Xr(s, a, r),
			h = new Xr(o, a, r);
		n.iterGaps((e, t, n) => Ar(l, e, h, t, n, i)),
			n.empty && 0 == n.length && Ar(l, 0, h, 0, 0, i);
	}
	static eq(e, t, n = 0, i) {
		null == i && (i = 999999999);
		...
		if (
			(e.point || n.point
				? (e.point &&
						...
						Cr(e.activeForPoint(e.to), n.activeForPoint(n.to))) ||
					s.comparePoint(a, h, e.point, n.point)
				: h > a &&
					!Cr(e.active, n.active) &&
...
function Er(e, t, n = e.length) {
	...
	for (let r = 0; r < n && r < e.length; )
		9 == e.charCodeAt(r) ? ((i += t - (i % t)), r++) : (i++, (r = mi(e, r)));
	return i;
}
...
for (
	...
	Yr[48 + Gr] = Yr[96 + Gr] = String(Gr);
for (Gr = 1; Gr <= 24; Gr++) Yr[Gr + 111] = "F" + Gr;
for (Gr = 65; Gr <= 90; Gr++)
	(Yr[Gr] = String.fromCharCode(Gr + 32)), (Br[Gr] = String.fromCharCode(Gr));
for (var Nr in Yr) Br.hasOwnProperty(Nr) || (Br[Nr] = Yr[Nr]);
function Hr(e) {
	let t;
	return (
...
const Ps = /Edge\/(\d+)/.exec(vs.userAgent),
	...
	As = !_s && /Chrome\/(\d+)/.exec(vs.userAgent),
...
function Zo(e, t, n, i, r) {
	...
	let c = mi(e.text, o, l.forward(r, n));
	(c < l.from || c > l.to) && (c = h),
...
const _o = Ai.define(),
	...
	Eo = Ai.define(),
	qo = Ai.define(),
	Vo = Ai.define({ combine: (e) => e.some((e) => e) }),
	Lo = Ai.define({ combine: (e) => e.some((e) => e) }),
	Wo = Ai.define();
class zo {
...
const Do = lr.define({ map: (e, t) => e.map(t) }),
	Yo = lr.define();
function Bo(e, t, n) {
	let i = e.facet(Co);
	i.length
...
const Io = Ai.define({ combine: (e) => !e.length || e[0] });
let Uo = 0;
const Go = Ai.define();
class No {
	constructor(e, t, n, i, r) {
	...
	updateChildren(e, t, n) {
		...
		for (let e = i.length - 1; ; e--) {
			...
			let { i: d, off: O } = r.findPos(c, 1),
				{ i: p, off: g } = r.findPos(h, -1);
			ks(this, p, g, d, O, s, o, a, l);
		}
	...
	updateEditContextFormatting(e) {
		...
		for (let t of e.transactions)
			for (let e of t.effects)
				e.is(Yo) && (this.editContextFormatting = e.value);
	}
	compositionView(e) {
								...
								1 != t.nodeType
									...
									: (i && "false" == t.childNodes[i - 1].contentEditable
										...
										"false" == t.childNodes[i].contentEditable
											...
											: 0));
							if (e && 3 != e) {
								let t = (1 == e ? gs : ms)(a.node, a.offset);
				...
				if (1 == c.nodeType) {
					...
					if (
						...
						if (f) h.scrollBy(p, g);
							...
							if (g) {
								let e = c.scrollTop;
								(c.scrollTop += g / O), (n = (c.scrollTop - e) * O);
							}
							if (p) {
								let t = c.scrollLeft;
...
function ca(e, t) {
	...
	let i = gs(n.focusNode, n.focusOffset),
		r = ms(n.focusNode, n.focusOffset),
		s = i || r;
...
function ma(e, t, n) {
	...
	for (let f = e.firstChild; f; f = f.nextSibling) {
		...
		for (let d = 0; d < e.length; d++) {
			let O = e[d];
			r && Oa(r, O) && (O = pa(ga(O, r.bottom), r.top));
			let p = fa(t, O),
				g = da(n, O);
			if (0 == p && 0 == g) return 3 == f.nodeType ? xa(f, t, n) : ma(f, t, n);
			if (!i || o > g || (o == g && s > p)) {
				(i = f), (r = O), (s = p), (o = g);
				let a = g ? (n < O.top ? -1 : 1) : p ? (t < O.left ? -1 : 1) : 0;
...
function ba(e, t, n, i = -1) {
	...
	if (!m || !e.docView.dom.contains(m)) {
		let t = ro.find(e.docView, d);
		if (!t) return f > o.top + o.height / 2 ? o.to : o.from;
		({ node: m, offset: x } = ma(t.dom, c, u));
	}
	let b = e.docView.nearest(m);
	if (!b) return null;
	if (
		b.isWidget &&
	...
	return b.localPosFromDOM(m, x) + b.posAtStart;
}
	...
	return (
		...
		(function (e, t, n) {
			for (let i = 0, r = 0; ; ) {
				if (r >= t) return i;
				if (i == e.length) break;
				(r += 9 == e.charCodeAt(i) ? n - (r % n) : 1), (i = mi(e, i));
			}
			return e.length;
		})(o, s, e.state.tabSize)
	);
...
function Ba(e, t, n, i) {
	...
	if (2 == i)
		return (function (e, t, n = 1) {
			...
			let o = s,
				a = s;
			n < 0 ? (o = mi(r.text, s, !1)) : (a = mi(r.text, s));
...
(Wa.scroll = (e) => {
	...
	(La.mousedown = (e, t) => {
		if ((e.observer.flush(), e.inputState.lastTouchTime > Date.now() - 2e3))
			return !1;
		let n = null;
		for (let i of e.state.facet(Ao)) if (((n = i(e, t)), n)) break;
		if (
			(n ||
				0 != t.button ||
				(n = (function (e, t) {
...
(La.dragstart = (e, t) => {
	...
	return (
		...
		t.dataTransfer &&
			(t.dataTransfer.setData(
				"Text",
				Da(e.state, qo, e.state.sliceDoc(n.from, n.to)),
			),
	...
	(La.paste = (e, t) => {
		...
		return n
			? (Ya(e, n.getData("text/plain") || n.getData("text/uri-list")), !0)
			: ((function (e) {
...
La.copy = La.cut = (e, t) => {
	let {
		...
		return { text: Da(e, qo, t.join(e.lineBreak)), ranges: n, linewise: i };
	})(e.state);
	if (!n && !r) return !1;
	(tl = r ? n : null),
		"cut" != t.type ||
...
class ml extends gl {
	...
	replace(e, t, n) {
		let i = n[0];
		return 1 == n.length &&
			(i instanceof ml || (i instanceof xl && 4 & i.flags)) &&
			Math.abs(this.length - i.length) < 10
			? (i instanceof xl
					? (i = new ml(i.length, this.height))
...
class yl {
		...
		if (this.lineStart > -1) {
			...
			n instanceof ml
				...
				: (e > this.pos || !this.isCovered) &&
					this.nodes.push(new ml(e - this.pos, -1)),
				(this.writtenTo = e),
				t > e &&
	...
	enterLine() {
		...
		(this.lineStart = e),
			...
			this.pos > e && this.nodes.push(new ml(this.pos - e, -1)),
	...
	finish(e) {
		...
		!(this.lineStart > -1) || t instanceof ml || this.isCovered
			? (this.writtenTo < this.pos || null == t) &&
				this.nodes.push(this.blankContent(this.writtenTo, this.pos))
			: this.nodes.push(new ml(0, -1));
		let n = e;
		for (let e of this.nodes)
			e instanceof ml && e.updateHeight(this.oracle, n),
				(n += e ? e.length : 1);
		return this.nodes;
	}
	...
	measure(e) {
		...
		if (
			...
			if (
				...
				s ||
					(i.lineWrapping && Math.abs(m - this.contentDOMWidth) > i.charWidth))
			) {
				let {
					lineHeight: n,
					charWidth: o,
...
const Rl = Ai.define({ combine: (e) => e.join(" ") }),
	Ml = Ai.define({ combine: (e) => e.indexOf(!0) > -1 }),
	jl = Wr.newName(),
	El = Wr.newName(),
	ql = Wr.newName(),
	Vl = { "&light": "." + El, "&dark": "." + ql };
	...
	constructor(e) {
		...
		(this.handlers.textupdate = (t) => {
			...
			(this.handlers.textformatupdate = (t) => {
				...
				e.dispatch({ effects: Yo.of(Ks.set(n)) });
			}),
...
class Gl {
	...
	update(e) {
		...
		try {
			...
			for (let t of e) {
				...
				for (let e of t.effects) e.is(Do) && (c = e.value.clip(this.state));
			}
	...
	scrollSnapshot() {
		...
		return Do.of(new zo(Ti.cursor(n.from), "start", "start", n.top - e, t, !0));
	}
	setTabFocusMode(e) {
		null == e
...
(Gl.styleModule = oa),
	...
	(Gl.scrollMargins = ra),
	(Gl.darkTheme = Ml),
	(Gl.cspNonce = Ai.define({ combine: (e) => (e.length ? e[0] : "") })),
...
class bh {
	...
	cursorAt(e, t = 0, n = 0) {
		let i = gh.get(this) || this.topNode,
			r = new Ah(i);
		return r.moveTo(e, t), gh.set(this, r._tree), r;
	}
	get topNode() {
		return new vh(this, 0, 0, null);
	}
	resolve(e, t = 0) {
		let n = kh(gh.get(this) || this.topNode, e, t, !1);
		return gh.set(this, n), n;
	}
	resolveInner(e, t = 0) {
		let n = kh(mh.get(this) || this.topNode, e, t, !0);
		...
		return (function (e) {
			...
			function u(e, t, n, x, b, S) {
				...
				let P,
					...
					T = l[y],
					_ = Q - e;
				if (k - Q <= r && (Z = g(a.pos - t, b))) {
					let t = new Uint16Array(Z.size - Z.skip),
						n = a.pos - Z.size,
						r = t.length;
					for (; a.pos > n; ) r = m(Z.start, t, r);
...
function Nh(e) {
	...
	r.children[s] = (function e(i, r, s, h, c, u) {
		...
		l.push(d.length);
		let m = u
			? e(f + 4, a[f + 3], o.set.types[a[f]], p, g - p, u - 1)
			: t.toTree();
		return (
			d.push(m), O.push(p - h), Gh(o, a[f + 3], r, d, O, h), new bh(s, d, O, c)
		);
...
const vc = new uh();
function $c(e) {
	return Ai.define({ combine: e ? (t) => t.concat(e) : void 0 });
}
const Pc = new uh();
class Zc {
	constructor(e, t, n = [], i = "") {
...
class mu extends Zc {
	...
	getIndent(e) {
		...
		n && ((t = gu.get(e.state)), null != t && t < e.pos - 1e4 && (t = void 0));
		let i,
			r,
			s = xu(
				this,
		...
		return (
			n && null == t && gu.set(e.state, o.from),
	...
	Nf = (e, t) =>
		Yf(e, (n) => {
			...
			for (let e = null; ; ) {
				...
				let a = mi(s.text, i - s.from, t) + s.from,
...
const rd = [
		{ key: "Ctrl-b", run: gf, shift: Xf, preventDefault: !0 },
		{ key: "Ctrl-f", run: mf, shift: Af },
			...
			run: ({ state: e, dispatch: t }) => {
				...
				let n = e.changeByRange((t) => {
					...
					let n = t.from,
						...
						s = n == i.to ? n + 1 : mi(i.text, n - i.from, !0) + i.from;
					return {
						changes: {
							from: r,
							to: s,
	...
	sd = [
		{ key: "ArrowLeft", run: gf, shift: Xf, preventDefault: !0 },
		{
			key: "Mod-ArrowLeft",
			mac: "Alt-ArrowLeft",
			run: (e) => xf(e, !pf(e)),
		...
		{ key: "ArrowRight", run: mf, shift: Af, preventDefault: !0 },
		{
			key: "Mod-ArrowRight",
			mac: "Alt-ArrowRight",
			run: (e) => xf(e, pf(e)),
		...
		{ mac: "Cmd-ArrowDown", run: Wf, shift: Df },
		...
		},
		{
			...
			run: ({ state: e, dispatch: t }) =>
				...
				(t(
					e.update(
						id(e, (t, n) => {
							n.push({ from: t.from, insert: e.facet(Yc) });
						}),
		...
		},
		{
			...
			run: (e) => {
				let { state: t } = e,
					...
					i = ju(e.state, n.from);
				return i.line ? Cu(e) : !!i.block && Mu(e);
			},
		},
		{ key: "Alt-A", run: Ru },
		{
	...
	instantiate(e, t) {
		...
		for (let r of this.lines) {
			if (n.length) {
				let n = s,
					o = /^\t*/.exec(r)[0].length;
				for (let t = 0; t < o; t++) n += e.facet(Yc);
...
let gd = Ks.widget({
	...
	md = Ks.mark({ class: "cm-snippetField" });
class xd {
	constructor(e, t) {
		(this.ranges = e),
			(this.active = t),
			(this.deco = Ks.set(
				e.map((e) => (e.from == e.to ? gd : md).range(e.from, e.to)),
			));
	}
	map(e) {
		let t = [];
...
const vd = [
	...
	$d = Ai.define({ combine: (e) => (e.length ? e[0] : vd) }),
...
function Md(e, t, n) {
	...
	let i = (e.type == Ad.OrderedList ? Bd : Yd)(n, t, !1);
	return (
		i > 0 &&
		(e.type != Ad.BulletList || zd(n, t, !1) < 0) &&
...
const jd = {
	[Ad.Blockquote]: (e, t, n) =>
		62 == n.next &&
		(n.markers.push(
			bO(Ad.QuoteMark, t.lineStart + n.pos, t.lineStart + n.pos + 1),
		),
...
function Yd(e, t, n) {
	return (45 != e.next && 43 != e.next && 42 != e.next) ||
		...
		!(!n || Dd(t, Ad.BulletList) || e.skipSpace(e.pos + 2) < e.text.length)
		? -1
		: 1;
}
function Bd(e, t, n) {
...
function eO(e, t, n) {
	let i = e.length - 1;
	i >= 0 && e[i].to == t && e[i].type == Ad.CodeText
		? (e[i].to = n)
		: e.push(bO(Ad.CodeText, t, n));
}
const tO = {
	...
	IndentedCode(e, t) {
		...
		for (eO(o, r, s); e.nextLine() && t.depth >= e.stack.length; )
			if (t.pos == t.text.length) {
				...
				if (t.indent < n) break;
				{
					if (a.length) {
						for (let e of a)
							e.type == Ad.CodeText ? eO(o, e.from, e.to) : o.push(e);
						a = [];
					}
		...
		return (
			a.length &&
				((a = a.filter((e) => e.type != Ad.CodeText)),
				a.length && (t.markers = a.concat(t.markers))),
			e.addNode(e.buffer.writeElements(o, -r).finish(Ad.CodeBlock, s - r), r),
			!0
		);
	},
	FencedCode(e, t) {
		...
		let i = e.lineStart + t.pos,
			...
			l = [bO(Ad.CodeMark, i, i + s)];
		o < a && l.push(bO(Ad.CodeInfo, e.lineStart + o, e.lineStart + a));
		for (let n = !0; e.nextLine() && t.depth >= e.stack.length; n = !1) {
			...
			if (i - t.pos >= s && t.skipSpace(i) == t.text.length) {
				...
				l.push(bO(Ad.CodeMark, e.lineStart + t.pos, e.lineStart + i)),
					e.nextLine();
				break;
			}
			{
		...
		return (
			e.addNode(
				e.buffer
					.writeElements(l, -i)
					.finish(Ad.FencedCode, e.prevLineEnd() - i),
				i,
			),
			!0
		);
	...
	Blockquote(e, t) {
		...
		return (
			!(n < 0) &&
			(e.startContext(Ad.Blockquote, t.pos),
			e.addNode(Ad.QuoteMark, e.lineStart + t.pos, e.lineStart + t.pos + 1),
			t.moveBase(t.pos + n),
			null)
		);
	},
	HorizontalRule(e, t) {
		...
		return e.nextLine(), e.addNode(Ad.HorizontalRule, n), !0;
	},
	BulletList(e, t) {
		let n = Yd(t, e, !1);
		if (n < 0) return !1;
		e.block.type != Ad.BulletList &&
			e.startContext(Ad.BulletList, t.basePos, t.next);
		let i = Jd(t, t.pos + 1);
		return (
			e.startContext(Ad.ListItem, t.basePos, i - t.baseIndent),
			e.addNode(Ad.ListMark, e.lineStart + t.pos, e.lineStart + t.pos + n),
			t.moveBaseColumn(i),
			null
		);
	},
	...
	ATXHeading(e, t) {
		...
		let a = e.buffer
			.write(Ad.HeaderMark, 0, n)
			.writeElements(
				e.parser.parseInline(t.text.slice(i + n + 1, o), r + n + 1),
				-r,
			);
		o < t.text.length && a.write(Ad.HeaderMark, o - i, s - i);
		let l = a.finish(Ad.ATXHeading1 - 1 + n, t.text.length - i);
...
class nO {
	...
	complete(e, t, n) {
		return (
			e.addLeafElement(
				t,
				bO(Ad.LinkReference, this.start, this.start + n, this.elts),
			),
			!0
		);
	}
	...
	advance(e) {
		for (;;) {
			...
			if (0 == this.stage) {
				...
				this.elts.push(
					bO(Ad.LinkMark, this.pos + this.start, this.pos + this.start + 1),
				),
					this.pos++;
			} else {
				if (1 != this.stage) {
...
class rO {
	nextLine(e, t, n) {
		let i = t.depth < e.stack.length ? -1 : Ud(t),
			r = t.next;
		if (i < 0) return !1;
		let s = bO(Ad.HeaderMark, e.lineStart + t.pos, e.lineStart + i);
		return (
			e.nextLine(),
			e.addLeafElement(
				n,
				bO(
					61 == r ? Ad.SetextHeading1 : Ad.SetextHeading2,
					n.start,
					e.prevLineEnd(),
...
class lO {
		...
		(this.parser = e),
			...
			(this.lineStart =
				...
				this.absoluteLineEnd =
					i[0].from),
			(this.block = Xd.create(Ad.Document, 0, this.lineStart, 0, 0)),
	...
	advance() {
		...
		let t = new Cd(this.lineStart + e.pos, e.text.slice(e.pos));
	...
	readLine() {
		...
		for (
			...
			if (!n) throw new Error("Unhandled block context " + Ad[t.type]);
			if (!n(t, this, e)) break;
			e.forward();
		}
	}
	...
	addLeafElement(e, t) {
		this.addNode(
			this.buffer
				.writeElements(CO(t.children, e.marks), -t.from)
	...
	finishLeaf(e) {
		...
		let t = CO(this.parser.parseInline(e.content, e.start), e.marks);
		this.addNode(
			this.buffer
				.writeElements(t, -e.start)
				.finish(Ad.Paragraph, e.content.length),
			e.start,
		);
	}
	elt(e, t, n, i) {
	...
	get buffer() {
		return new gO(this.parser.nodeSet);
	}
}
			...
			for (let n of t.defineNodes) {
				...
				let l = r.length,
					h = o
						? ["Block", "BlockContext"]
						: s
							? l >= Ad.ATXHeading1 && l <= Ad.SetextHeading2
...
const PO = {
	Escape(e, t, n) {
		...
		let i = e.char(n + 1);
		for (let t = 0; t < 32; t++)
			if (vO.charCodeAt(t) == i) return e.append(bO(Ad.Escape, n, n + 2));
		return -1;
	},
	Entity(e, t, n) {
		if (38 != t) return -1;
		let i = /^(?:#\d+|#x[a-f\d]+|\w+);/i.exec(e.slice(n + 1, n + 31));
		return i ? e.append(bO(Ad.Entity, n, n + 1 + i[0].length)) : -1;
	},
	InlineCode(e, t, n) {
		...
		for (; i < e.end; i++)
			if (96 == e.char(i)) {
				if ((s++, s == r && 96 != e.char(i + 1)))
					return e.append(
						bO(Ad.InlineCode, n, i + 1, [
							bO(Ad.CodeMark, n, n + r),
							bO(Ad.CodeMark, i + 1 - r, i + 1),
						]),
					);
			} else s = 0;
		return -1;
	...
	HTMLTag(e, t, n) {
		...
		if (r)
			return e.append(
				bO(Ad.Autolink, n, n + 1 + r[0].length, [
					bO(Ad.LinkMark, n, n + 1),
					bO(Ad.URL, n + 1, n + r[0].length),
					bO(Ad.LinkMark, n + r[0].length, n + 1 + r[0].length),
				]),
			);
		let s = /^!--[^>](?:-[^-]|[^-])*?-->/i.exec(i);
		if (s) return e.append(bO(Ad.Comment, n, n + 1 + s[0].length));
		let o = /^\?[^]*?\?>/.exec(i);
		if (o)
			return e.append(bO(Ad.ProcessingInstruction, n, n + 1 + o[0].length));
		let a =
			/^(?:![A-Z][^]*?>|!\[CDATA\[[^]*?\]\]>|\/\s*[a-zA-Z][\w-]*\s*>|\s*[a-zA-Z][\w-]*(\s+[a-zA-Z:_][\w-.:]*(?:\s*=\s*(?:[^\s"'=<>`]+|'[^']*'|"[^"]*"))?)*\s*(\/\s*)?>)/.exec(
				i,
			);
		return a ? e.append(bO(Ad.HTMLTag, n, n + 1 + a[0].length)) : -1;
	},
	Emphasis(e, t, n) {
	...
	HardBreak(e, t, n) {
		if (92 == t && 10 == e.char(n + 1))
			return e.append(bO(Ad.HardBreak, n, n + 2));
		if (32 == t) {
			let t = n + 1;
			for (; 32 == e.char(t); ) t++;
			if (10 == e.char(t) && t >= n + 2)
				return e.append(bO(Ad.HardBreak, n, t + 1));
		}
		return -1;
	},
...
function ZO(e, t, n, i, r) {
	let { text: s } = e,
		...
		a = r;
	if (
		(t.unshift(bO(Ad.LinkMark, i, i + (n == Ad.Image ? 2 : 1))),
		t.push(bO(Ad.LinkMark, r - 1, r)),
		40 == o)
	) {
		let n,
			i = e.skipSpace(r + 1),
		...
		o &&
			...
			41 == e.char(i) &&
				(t.push(bO(Ad.LinkMark, r, r + 1)),
				(a = i + 1),
				o && t.push(o),
				n && t.push(n),
				t.push(bO(Ad.LinkMark, i, a)));
	} else if (91 == o) {
...
function TO(e, t, n) {
	if (60 == e.charCodeAt(t)) {
		for (let i = t + 1; i < e.length; i++) {
			...
			if (62 == r) return bO(Ad.URL, t + n, i + 1 + n);
	...
	}
	{
		...
		return r > t ? bO(Ad.URL, t + n, r + n) : r == e.length && null;
	}
}
function _O(e, t, n) {
	...
	for (let i = t + 1, s = !1; i < e.length; i++) {
		...
		if (s) s = !1;
			...
			if (o == r) return bO(Ad.LinkTitle, t + n, i + 1 + n);
			92 == o && (s = !0);
		}
	}
	return null;
...
function XO(e, t, n, i) {
	for (let r = !1, s = t + 1, o = Math.min(e.length, s + 999); s < o; s++) {
		...
		if (r) r = !1;
			...
			if (93 == o) return !i && bO(Ad.LinkLabel, t + n, s + 1 + n);
...
class AO {
	...
	resolveMarkers(e) {
		for (let t = e; t < this.parts.length; t++) {
			...
			for (let e = o + 1; e < t; e++)
				this.parts[e] instanceof mO && l.push(this.parts[e]),
					(this.parts[e] = null);
...
function CO(e, t) {
	...
	for (let e of t) {
		...
		if (i < n.length && n[i].from < e.from) {
			let t = n[i];
			t instanceof mO &&
				(n[i] = new mO(t.type, t.from, t.to, CO(t.children, [e])));
		} else n.splice(i++, 0, e);
	}
	return n;
}
const RO = [Ad.CodeBlock, Ad.ListItem, Ad.OrderedList, Ad.BulletList];
let MO = class {
	constructor(e, t) {
		(this.fragments = e),
			(this.input = t),
	...
	takeNodes(e) {
		...
		for (;;) {
			...
			if (t.to - n <= e.ranges[e.rangeI].to) e.addNode(t.tree, r);
				...
				let n = new bh(
					e.parser.nodeSet.types[Ad.Paragraph],
					[],
					[],
					0,
					e.block.hashProp,
...
const IO = {
	...
	parseBlock: [
		{
			name: "Table",
			leaf: (e, t) => (DO(t.content, 0) ? new BO() : null),
			endLeaf(e, t, n) {
				if (n.parsers.some((e) => e instanceof BO) || !DO(t.text, t.basePos))
					return !1;
				let i = e.peekLine();
				return YO.test(i) && zO(e, t.text, t.basePos) == zO(e, i, t.basePos);
			},
...
gp.prototype.contextual = pp.prototype.fallback = pp.prototype.extend = !1;
class mp {
	constructor(e, t = {}) {
		(this.token = e),
			...
			for (let a = s.stateSlot(r, e ? 2 : 1); ; a += 3) {
				if (65535 == o[a]) {
					if (1 != o[a + 1]) {
						0 == i &&
							2 == o[a + 1] &&
							(i = this.putAction(Ap(o, a + 2), t, n, i));
						break;
					}
					a = Ap(o, a + 2);
				}
				o[a] == t && (i = this.putAction(Ap(o, a + 1), t, n, i));
			}
		return i;
	}
}
...
class Xp extends Vh {
	constructor(e) {
		...
		(this.specializers = this.specializerSpecs.map(Cp)),
	...
	hasAction(e, t) {
		...
		for (let i = 0; i < 2; i++)
			for (let r, s = this.stateSlot(e, i ? 2 : 1); ; s += 3) {
				if (65535 == (r = n[s])) {
					if (1 != n[s + 1]) {
						if (2 == n[s + 1]) return Ap(n, s + 2);
						break;
					}
					r = n[(s = Ap(n, s + 2))];
				}
				if (r == t || 0 == r) return Ap(n, s + 1);
			}
		return 0;
	}
	stateSlot(e, t) {
		...
		return (
			...
			e.specializers &&
				...
				(t.specializerSpecs = this.specializerSpecs.map((n, i) => {
					...
					return (t.specializers[i] = Cp(s)), s;
				}))),
...
function Wp(e, t) {
	...
	return (
		(Vp = e),
		(Lp = n),
		(qp = r ? r.toLowerCase() : i == zp || i == Dp ? void 0 : null)
	);
}
const zp = 63,
	Dp = 33;
...
const Bp = [6, 10, 7, 8, 9],
	Ip = new _p({
		start: null,
		shift: (e, t, n, i) => (Bp.indexOf(t) > -1 ? new Yp(Wp(i, 1) || "", e) : e),
		reduce: (e, t) => (20 == t && e ? e.parent : e),
		reuse(e, t, n, i) {
			let r = t.type.id;
			return 6 == r || 36 == r ? new Yp(Wp(i, 1) || "", e) : e;
		},
		strict: !1,
	}),
	Up = new mp(
...
function rg(e, t, n) {
	let i;
	for (let r of n)
		if (!r.attrs || r.attrs(i || (i = ng(e.node.parent.firstChild, t))))
...
function sg(e = [], t = []) {
	...
	return Wh((e, t) => {
		let a = e.type.id;
		if (28 == a) return rg(e, t, n);
		if (31 == a) return rg(e, t, i);
		if (34 == a) return rg(e, t, r);
		if (20 == a && s.length) {
			let n,
				i = e.node,
				r = i.firstChild,
			...
			if (o)
				for (let e of s)
					if (e.tag == o && (!e.attrs || e.attrs(n || (n = ng(r, t))))) {
						let t = i.lastChild,
		...
		if (o && 23 == a) {
			...
			if ((n = i.firstChild)) {
				...
				if (e)
					for (let n of e) {
						if (n.tagName && n.tagName != ig(i.parent, t)) continue;
						let e = i.lastChild;
						if (26 == e.type.id) {
							let t = e.from + 1,
								i = e.lastChild,
...
const hg = new mp((e, t) => {
	...
	ug = new mp((e) => {
		if (!og.includes(e.peek(-1))) {
			let { next: t } = e;
			if ((37 == t && (e.advance(), e.acceptToken(1)), ag(t))) {
				do {
					e.advance();
				} while (ag(e.next) || lg(e.next));
				e.acceptToken(1);
			}
		}
	}),
	...
	pg = { __proto__: null, not: 134, only: 134 },
	gg = Xp.deserialize({
		version: 14,
		states:
		...
		tokenizers: [
			...
			3,
			4,
			new gp("m~RRYZ[z{a~~g~aO#`~~dP!P!Qg~lO#a~~", 28, 107),
		],
		topRules: { StyleSheet: [0, 4], Styles: [1, 87] },
		specialized: [
			{ term: 102, get: (e) => dg[e] || -1 },
			{ term: 59, get: (e) => Og[e] || -1 },
			{ term: 103, get: (e) => pg[e] || -1 },
		],
		tokenPrec: 1246,
	});
let mg = null;
function xg() {
	if (!mg && "object" == typeof document && document.body) {
		...
		mg = t.sort().map((e) => ({ type: "property", label: e, apply: e + ": " }));
	}
	return mg || [];
}
const bg = [
...
const Tg = (e) => (t) => {
		...
		if (
			...
			return { from: r.from, options: xg(), validFor: kg };
		if ("ValueName" == r.name)
			return { from: r.from, options: Sg, validFor: kg };
		if ("PseudoClassName" == r.name)
			return { from: r.from, options: bg, validFor: kg };
		if (
			e(r) ||
			((t.explicit || s) &&
				(function (e, t) {
		...
		if ("TagName" == r.name) {
			for (let { parent: e } = r; e; e = e.parent)
				if ("Block" == e.name)
					return { from: r.from, options: xg(), validFor: kg };
			return { from: r.from, options: yg, validFor: kg };
		}
		if ("AtKeyword" == r.name)
			return { from: r.from, options: Qg, validFor: kg };
		if (!t.explicit) return null;
		let o = r.resolve(i),
			a = o.childBefore(i);
		return a && ":" == a.name && "PseudoClassSelector" == o.name
			? { from: i, options: bg, validFor: kg }
			: (a && ":" == a.name && "Declaration" == o.name) || "ArgList" == o.name
				? { from: i, options: Sg, validFor: kg }
				: "Block" == o.name || "Styles" == o.name
					? { from: i, options: xg(), validFor: kg }
					: null;
	},
	_g = Tg((e) => "VariableName" == e.name),
	Xg = _c.define({
		name: "css",
		parser: gg.configure({
			props: [
...
function Ag() {
	return new Wc(Xg, Xg.data.of({ autocomplete: _g }));
}
var Cg = Object.freeze({
	__proto__: null,
	css: Ag,
	cssCompletionSource: _g,
	cssLanguage: Xg,
	defineCSSCompletionSource: Tg,
});
const Rg = [
		9, 10, 11, 12, 13, 32, 133, 160, 5760, 8192, 8193, 8194, 8195, 8196, 8197,
		8198, 8199, 8200, 8201, 8202, 8232, 8233, 8239, 8287, 12288,
...
const Wg = new mp((e, t) => {
		...
		let n = 0;
		for (; Rg.indexOf(e.next) > -1; ) e.advance(), n++;
		if (Lg(e.next, !0)) {
			for (e.advance(), n++; Lg(e.next, !1); ) e.advance(), n++;
			for (; Rg.indexOf(e.next) > -1; ) e.advance(), n++;
			if (44 == e.next) return;
			for (let t = 0; ; t++) {
				if (7 == t) {
					if (!Lg(e.next, !0)) return;
					break;
				}
	...
	Ig = Xp.deserialize({
		...
		tokenizers: [
			...
			new gp("j~RQYZXz{^~^O(O~~aP!P!Qd~iO(P~~", 25, 321),
		],
		topRules: {
			Script: [0, 7],
		...
		specialized: [
			{ term: 325, get: (e) => Dg[e] || -1 },
			{ term: 341, get: (e) => Yg[e] || -1 },
			{ term: 93, get: (e) => Bg[e] || -1 },
		],
		tokenPrec: 15116,
	}),
	Ug = [
...
const Kg = ["FunctionDeclaration"],
	Jg = {
		FunctionDeclaration: Fg("function"),
		ClassDeclaration: Fg("class"),
		ClassExpression: () => !0,
		EnumDeclaration: Fg("constant"),
		TypeAliasDeclaration: Fg("type"),
		NamespaceDeclaration: Fg("namespace"),
		VariableDefinition(e, t) {
			e.matchContext(Kg) || t(e, "variable");
		},
		TypeDefinition(e, t) {
			t(e, "type");
		},
	...
	return (
		t.cursor(xh.IncludeAnonymous).iterate((t) => {
			if (r) r = !1;
				...
				let e = Jg[t.name];
				if ((e && e(t, s)) || Hg.has(t.name)) return !1;
			} else if (t.to - t.from > 8192) {
				for (let n of em(e, t.node)) i.push(n);
				return !1;
			}
		}),
		Ng.set(t, i),
...
function im(e) {
	...
	if (nm.indexOf(t.name) > -1) return null;
	let n =
		"VariableName" == t.name ||
		(t.to - t.from < 20 && tm.test(e.state.sliceDoc(t.from, t.to)));
	if (!n && !e.explicit) return null;
	let i = [];
	for (let n = t; n; n = n.parent)
		Hg.has(n.name) && (i = i.concat(em(e.state.doc, n)));
	return { options: i, from: n ? t.from : e.pos, validFor: tm };
}
function rm(e, t, n) {
	var i;
	let r = [];
...
function sm(e) {
	...
	return "PropertyName" == n.name
		...
		: ("." != n.name && "?." != n.name) || "MemberExpression" != n.parent.name
			? nm.indexOf(n.name) > -1
				? null
				: "VariableName" == n.name || (n.to - n.from < 20 && tm.test(t(n)))
					? { path: [], name: t(n) }
...
const om = _c.define({
	...
	lm = om.configure({ dialect: "ts" }, "typescript"),
	hm = om.configure({
		dialect: "jsx",
		props: [Pc.add((e) => (e.isTop ? [am] : void 0))],
	}),
	cm = om.configure(
		{ dialect: "jsx ts", props: [Pc.add((e) => (e.isTop ? [am] : void 0))] },
		"typescript",
	);
let um = (e) => ({ label: e, type: "keyword" });
const fm =
		"break case const continue default delete export extends false finally in instanceof let new return static super switch this throw true typeof var yield"
			...
			.map(um),
	dm = fm.concat(
		["declare", "implements", "private", "protected", "public"].map(um),
	);
function Om(e = {}) {
	let t = e.jsx ? (e.typescript ? cm : hm) : e.typescript ? lm : om,
		n = e.typescript ? Gg.concat(dm) : Ug.concat(fm);
	return new Wc(t, [
		om.data.of({ autocomplete: cd(nm, hd(n)) }),
		om.data.of({ autocomplete: im }),
		e.jsx ? mm : [],
	]);
}
function pm(e, t, n = e.length) {
...
const gm =
	...
	mm = Gl.inputHandler.of((e, t, n, i, r) => {
		if (
			(gm ? e.composing : e.compositionStarted) ||
			e.state.readOnly ||
			t != n ||
			(">" != i && "/" != i) ||
			!om.isActiveAt(e.state, t, -1)
		)
			return !1;
		let s = r(),
			{ state: o } = s,
...
function bm(e, t, n) {
	let i = xm(e.line, e.column, t, n),
		r = {
			from: i,
			to:
				null != e.endLine && 1 != e.endColumn
					? xm(e.endLine, e.endColumn, t, n)
					: i,
			message: e.message,
...
var Sm = Object.freeze({
	...
	esLint: function (e, t) {
		return (
			...
			(n) => {
				let { state: i } = n,
					r = [];
				for (let { from: n, to: s } of om.findRegions(i)) {
					let o = i.doc.lineAt(n),
						a = { line: o.number - 1, col: n - o.from, pos: n };
					for (let o of e.verify(i.sliceDoc(n, s), t)) r.push(bm(o, i.doc, a));
				}
				return r;
			}
		);
	...
	javascript: Om,
	javascriptLanguage: om,
	jsxLanguage: hm,
	localCompletionSource: im,
	scopeCompletionSource: function (e) {
		...
		return (n) => {
			...
			return (
				...
				{ from: n.pos - i.name.length, options: s, validFor: tm }
			);
		};
	},
	snippets: Ug,
	tsxLanguage: cm,
	typescriptLanguage: lm,
	typescriptSnippets: Gg,
});
const ym = ["_blank", "_self", "_top", "_parent"],
	Qm = ["ascii", "utf-8", "utf-16", "latin1", "latin1"],
	km = ["get", "post", "put", "delete"],
	wm = [
	...
	Pm = {
		...
		b: $m,
		base: { attrs: { href: null, target: ym } },
		bdi: $m,
		bdo: $m,
	...
	Tm =
		"beforeunload copy cut dragstart dragover dragleave dragenter dragend drag paste focus blur change click load mousedown mouseenter mouseleave mouseup keydown keyup resize scroll unload"
			.split(" ")
			.map((e) => "on" + e);
for (let e of Tm) Zm[e] = null;
class _m {
	constructor(e, t) {
		(this.tags = Object.assign(Object.assign({}, Pm), e)),
			(this.globalAttrs = Object.assign(Object.assign({}, Zm), t)),
			(this.allTags = Object.keys(this.tags)),
			(this.globalAttrNames = Object.keys(this.globalAttrs));
	}
}
function Xm(e, t, n = e.length) {
	if (!t) return "";
	let i = t.firstChild,
...
function Cm(e, t, n) {
	let i = n.tags[Xm(e, Am(t))];
	return (null == i ? void 0 : i.children) || n.allTags;
}
function Rm(e, t) {
	let n = [];
	for (let i = Am(t); i && !i.type.isTop; i = Am(i.parent)) {
		let r = Xm(e, i);
					...
					: "Is" == r.name ||
						...
						: !t.explicit ||
							...
							: (function (e, t, n, i) {
									let r = [],
										s = 0;
									for (let i of Cm(e.doc, n, t))
										r.push({ label: "<" + i, type: "type" });
									for (let t of Rm(e.doc, n))
										r.push({
											label: "</" + t + ">",
											type: "type",
											boost: 99 - s++,
...
function Vm(e) {
	return qm(_m.default, e);
}
function Lm(e) {
	let { extraTags: t, extraGlobalAttributes: n } = e,
		i = n || t ? new _m(t, n) : _m.default;
	return (e) => qm(i, e);
}
const Wm = om.parser.configure({ top: "SingleExpression" }),
	zm = [
		{
			tag: "script",
	...
	Dm = [
		{ name: "style", parser: Xg.parser.configure({ top: "Styles" }) },
	].concat(Tm.map((e) => ({ name: e, parser: om.parser }))),
	Ym = _c.define({
		name: "html",
		parser: tg.configure({
			props: [
...
function Im(e = {}) {
	...
	!1 === e.matchClosingTags && (n = "noMatch"),
		...
		((e.nestedLanguages && e.nestedLanguages.length) ||
			...
			(t = sg(
				(e.nestedLanguages || []).concat(zm),
				(e.nestedAttributes || []).concat(Dm),
			));
	let i = t
		? Ym.configure({ wrap: t, dialect: n })
		: n
			? Bm.configure({ dialect: n })
			: Bm;
	return new Wc(i, [
		Bm.data.of({ autocomplete: Lm(e) }),
		!1 !== e.autoCloseTags ? Gm : [],
		Om().support,
		Ag().support,
	]);
}
const Um = new Set(
	...
	Gm = Gl.inputHandler.of((e, t, n, i, r) => {
		if (
			e.composing ||
			e.state.readOnly ||
			t != n ||
			(">" != i && "/" != i) ||
			!Bm.isActiveAt(e.state, t, -1)
		)
			return !1;
		let s = r(),
			{ state: o } = s,
...
var Nm = Object.freeze({
	...
	autoCloseTags: Gm,
	html: Im,
	htmlCompletionSource: Vm,
	htmlCompletionSourceWith: Lm,
	htmlLanguage: Bm,
	htmlPlain: Ym,
});
const Hm = $c({
...
function ex(e, t) {
	...
	for (;;) {
		let e,
			i = n.nextSibling;
		if (!i || (null != (e = Jm(i.type)) && e <= t)) break;
		n = i;
	}
	return n.to;
}
...
function nx(e) {
	return new Zc(Hm, e, [tx], "markdown");
}
const ix = nx(Km),
	rx = nx(
		Km.configure([
	...
	l.push(
		(function (e) {
			let { codeParser: t, htmlParser: n } = e,
				i = Wh((e, i) => {
					let r = e.type.id;
					if (!t || (r != Ad.CodeBlock && r != Ad.FencedCode)) {
						if (n && (r == Ad.HTMLBlock || r == Ad.HTMLTag))
							return { parser: n, overlay: VO(e.node, e.from, e.to) };
					} else {
						let n = "";
						if (r == Ad.FencedCode) {
							let t = e.node.getChild(Ad.CodeInfo);
							t && (n = i.read(t.from, t.to));
						}
						let s = t(n);
						if (s)
							return { parser: s, overlay: (e) => e.type.id == Ad.CodeText };
					}
					return null;
				});
			return { wrap: i };
...
function bx() {
	if (xx) return xx;
	let e = Vm(new ad(Sr.create({ extensions: px }), 0, !0));
...
function yx(e) {
	return new Wc(mu.define(e));
}
function Qx(e) {
	return import("./chunks/index.Dz6MXsJt.js").then((t) =>
		t.sql({ dialect: t[e] }),
	);
}
const kx = [
		zc.of({
			name: "C",
			extensions: ["c", "h", "ino"],
			load: () => import("./chunks/index.vnWDqxFg.js").then((e) => e.cpp()),
		}),
		zc.of({
			name: "C++",
			alias: ["cpp"],
		...
		zc.of({
			name: "Go",
			extensions: ["go"],
			load: () => import("./chunks/index.BpzzPxb1.js").then((e) => e.go()),
		}),
		zc.of({
			name: "HTML",
			alias: ["xhtml"],
		...
		zc.of({
			name: "Java",
			extensions: ["java"],
			load: () => import("./chunks/index.Db8MaeW7.js").then((e) => e.java()),
		}),
		zc.of({
			name: "JavaScript",
		...
		zc.of({
			...
			alias: ["json5"],
			extensions: ["json", "map"],
			load: () => import("./chunks/index.Cq5z_ObN.js").then((e) => e.json()),
		}),
		zc.of({
			name: "JSX",
			extensions: ["jsx"],
		...
		zc.of({
			name: "LESS",
			extensions: ["less"],
			load: () => import("./chunks/index.CbjuyU5R.js").then((e) => e.less()),
		}),
		zc.of({
			name: "Liquid",
			extensions: ["liquid"],
			load: () => import("./chunks/index.DwBf64tz.js").then((e) => e.liquid()),
		}),
		...
		zc.of({
			...
			load: () => import("./chunks/index.DoTmANBH.js").then((e) => e.php()),
		}),
		...
		zc.of({
			...
			filename: /^(BUCK|BUILD)$/,
			load: () => import("./chunks/index.D7Sc2vqO.js").then((e) => e.python()),
		}),
		zc.of({
			name: "Rust",
			extensions: ["rs"],
			load: () => import("./chunks/index.CV5oCHAc.js").then((e) => e.rust()),
		}),
		zc.of({
			name: "Sass",
			extensions: ["sass"],
			load: () =>
				import("./chunks/index.D1ZeY94q.js").then((e) =>
					e.sass({ indented: !0 }),
				),
		}),
		zc.of({
			name: "SCSS",
			extensions: ["scss"],
			load: () => import("./chunks/index.D1ZeY94q.js").then((e) => e.sass()),
		}),
		...
		zc.of({
			name: "WebAssembly",
			extensions: ["wat", "wast"],
			load: () => import("./chunks/index.DcKzCWKB.js").then((e) => e.wast()),
		}),
		zc.of({
			name: "XML",
			alias: ["rss", "wsdl", "xsd"],
			extensions: ["xml", "xsl", "xsd", "svg"],
			load: () => import("./chunks/index.BXjEoYyB.js").then((e) => e.xml()),
		}),
		zc.of({
			name: "YAML",
			alias: ["yml"],
			extensions: ["yaml", "yml"],
			load: () => import("./chunks/index.TEF_SQFV.js").then((e) => e.yaml()),
		}),
		zc.of({
			name: "APL",
			extensions: ["dyalog", "apl"],
			load: () => import("./chunks/apl.DPxMobLc.js").then((e) => yx(e.apl)),
		}),
		zc.of({
			name: "PGP",
			alias: ["asciiarmor"],
			...
			load: () =>
				import("./chunks/asciiarmor.B51oD8Ym.js").then((e) => yx(e.asciiArmor)),
		}),
		zc.of({
			name: "ASN.1",
			extensions: ["asn", "asn1"],
			load: () =>
				import("./chunks/asn1.Cil3lh9G.js").then((e) => yx(e.asn1({}))),
		}),
		zc.of({
			name: "Asterisk",
			filename: /^extensions\.conf$/i,
			load: () =>
				import("./chunks/asterisk.BLXj2Kgd.js").then((e) => yx(e.asterisk)),
		}),
		zc.of({
			name: "Brainfuck",
			extensions: ["b", "bf"],
			load: () =>
				import("./chunks/brainfuck.BHwJslvD.js").then((e) => yx(e.brainfuck)),
		}),
		zc.of({
			name: "Cobol",
			extensions: ["cob", "cpy"],
			load: () => import("./chunks/cobol.C5dsN7c4.js").then((e) => yx(e.cobol)),
		}),
		zc.of({
			name: "C#",
			alias: ["csharp", "cs"],
			extensions: ["cs"],
			load: () =>
				import("./chunks/clike.BsU_3Ptx.js").then((e) => yx(e.csharp)),
		}),
		zc.of({
			name: "Clojure",
			extensions: ["clj", "cljc", "cljx"],
			load: () =>
				import("./chunks/clojure.oPQ69egj.js").then((e) => yx(e.clojure)),
		}),
		zc.of({
			name: "ClojureScript",
			extensions: ["cljs"],
		...
		zc.of({
			...
			extensions: ["gss"],
			load: () => import("./chunks/css.DFVBrA6K.js").then((e) => yx(e.gss)),
		}),
		zc.of({
			name: "CMake",
			extensions: ["cmake", "cmake.in"],
			filename: /^CMakeLists\.txt$/,
			load: () => import("./chunks/cmake.DE1Tmldz.js").then((e) => yx(e.cmake)),
		}),
		zc.of({
			name: "CoffeeScript",
			...
			extensions: ["coffee"],
			load: () =>
				import("./chunks/coffeescript.CIpLmZy1.js").then((e) =>
					yx(e.coffeeScript),
				),
		}),
		zc.of({
			...
			load: () =>
				import("./chunks/commonlisp.Bh7_dm6J.js").then((e) => yx(e.commonLisp)),
		}),
		zc.of({
			name: "Cypher",
			extensions: ["cyp", "cypher"],
			load: () =>
				import("./chunks/cypher.niYxv7YP.js").then((e) => yx(e.cypher)),
		}),
		zc.of({
			name: "Cython",
			extensions: ["pyx", "pxd", "pxi"],
			load: () =>
				import("./chunks/python.Dk6A-v1d.js").then((e) => yx(e.cython)),
		}),
		zc.of({
			name: "Crystal",
			extensions: ["cr"],
			load: () =>
				import("./chunks/crystal.B3M-4rOT.js").then((e) => yx(e.crystal)),
		}),
		zc.of({
			name: "D",
			extensions: ["d"],
			load: () => import("./chunks/d.fz-mrRy1.js").then((e) => yx(e.d)),
		}),
		zc.of({
			name: "Dart",
			extensions: ["dart"],
			load: () => import("./chunks/clike.BsU_3Ptx.js").then((e) => yx(e.dart)),
		}),
		zc.of({
			name: "diff",
			extensions: ["diff", "patch"],
			load: () => import("./chunks/diff.CAH5xNMa.js").then((e) => yx(e.diff)),
		}),
		zc.of({
			name: "Dockerfile",
			filename: /^Dockerfile$/,
			load: () =>
				import("./chunks/dockerfile.DW6eXJJy.js").then((e) => yx(e.dockerFile)),
		}),
		zc.of({
			name: "DTD",
			extensions: ["dtd"],
			load: () => import("./chunks/dtd.CrXbFSGo.js").then((e) => yx(e.dtd)),
		}),
		zc.of({
			name: "Dylan",
			extensions: ["dylan", "dyl", "intr"],
			load: () => import("./chunks/dylan.BD3E5D-t.js").then((e) => yx(e.dylan)),
		}),
		zc.of({
			name: "EBNF",
			load: () => import("./chunks/ebnf.DdCNqlPO.js").then((e) => yx(e.ebnf)),
		}),
		zc.of({
			name: "ECL",
			extensions: ["ecl"],
			load: () => import("./chunks/ecl.8vfqhaZw.js").then((e) => yx(e.ecl)),
		}),
		zc.of({
			name: "edn",
			extensions: ["edn"],
		...
		zc.of({
			...
			extensions: ["e"],
			load: () =>
				import("./chunks/eiffel.DHYrYbwi.js").then((e) => yx(e.eiffel)),
		}),
		zc.of({
			name: "Elm",
			extensions: ["elm"],
			load: () => import("./chunks/elm.zdQ55cZ5.js").then((e) => yx(e.elm)),
		}),
		zc.of({
			name: "Erlang",
			extensions: ["erl"],
			load: () =>
				import("./chunks/erlang.BUx2Pbg5.js").then((e) => yx(e.erlang)),
		}),
		zc.of({
			name: "Esper",
			load: () => import("./chunks/sql.BGrMlkuy.js").then((e) => yx(e.esper)),
		}),
		zc.of({
			name: "Factor",
			extensions: ["factor"],
			load: () =>
				import("./chunks/factor.eWBVjnCL.js").then((e) => yx(e.factor)),
		}),
		zc.of({
			name: "FCL",
			load: () => import("./chunks/fcl.DtEU-sOG.js").then((e) => yx(e.fcl)),
		}),
		zc.of({
			name: "Forth",
			extensions: ["forth", "fth", "4th"],
			load: () => import("./chunks/forth.sOw8g7Fh.js").then((e) => yx(e.forth)),
		}),
		zc.of({
			name: "Fortran",
			extensions: ["f", "for", "f77", "f90", "f95"],
			load: () =>
				import("./chunks/fortran.CUw0gOHq.js").then((e) => yx(e.fortran)),
		}),
		zc.of({
			name: "F#",
			alias: ["fsharp"],
			extensions: ["fs"],
			load: () =>
				import("./chunks/mllike.XYhq5y8_.js").then((e) => yx(e.fSharp)),
		}),
		zc.of({
			name: "Gas",
			extensions: ["s"],
			load: () => import("./chunks/gas.D6kEQ7Rc.js").then((e) => yx(e.gas)),
		}),
		zc.of({
			name: "Gherkin",
			extensions: ["feature"],
			load: () =>
				import("./chunks/gherkin.QaWPbPIp.js").then((e) => yx(e.gherkin)),
		}),
		zc.of({
			name: "Groovy",
			...
			load: () =>
				import("./chunks/groovy.DCsad2Oo.js").then((e) => yx(e.groovy)),
		}),
		zc.of({
			name: "Haskell",
			extensions: ["hs"],
			load: () =>
				import("./chunks/haskell.B0DI3rnZ.js").then((e) => yx(e.haskell)),
		}),
		zc.of({
			name: "Haxe",
			extensions: ["hx"],
			load: () => import("./chunks/haxe.D83Ia0Bb.js").then((e) => yx(e.haxe)),
		}),
		zc.of({
			name: "HXML",
			extensions: ["hxml"],
			load: () => import("./chunks/haxe.D83Ia0Bb.js").then((e) => yx(e.hxml)),
		}),
		zc.of({
			name: "HTTP",
			load: () => import("./chunks/http.CEWkRLH-.js").then((e) => yx(e.http)),
		}),
		zc.of({
			name: "IDL",
			extensions: ["pro"],
			load: () => import("./chunks/idl.B3zlXbgM.js").then((e) => yx(e.idl)),
		}),
		zc.of({
			name: "JSON-LD",
			alias: ["jsonld"],
			extensions: ["jsonld"],
			load: () =>
				import("./chunks/javascript.BPk6jw1r.js").then((e) => yx(e.jsonld)),
		}),
		zc.of({
			name: "Jinja2",
			extensions: ["j2", "jinja", "jinja2"],
			load: () =>
				import("./chunks/jinja2.BeTZ1LTs.js").then((e) => yx(e.jinja2)),
		}),
		zc.of({
			name: "Julia",
			extensions: ["jl"],
			load: () => import("./chunks/julia.DlEOxaAi.js").then((e) => yx(e.julia)),
		}),
		zc.of({
			name: "Kotlin",
			extensions: ["kt", "kts"],
			load: () =>
				import("./chunks/clike.BsU_3Ptx.js").then((e) => yx(e.kotlin)),
		}),
		zc.of({
			name: "LiveScript",
			alias: ["ls"],
			extensions: ["ls"],
			load: () =>
				import("./chunks/livescript.uLyHAz2f.js").then((e) => yx(e.liveScript)),
		}),
		zc.of({
			name: "Lua",
			extensions: ["lua"],
			load: () => import("./chunks/lua.BnH60Yfs.js").then((e) => yx(e.lua)),
		}),
		zc.of({
			name: "mIRC",
			extensions: ["mrc"],
			load: () => import("./chunks/mirc.BO8-zUSx.js").then((e) => yx(e.mirc)),
		}),
		zc.of({
			name: "Mathematica",
			extensions: ["m", "nb", "wl", "wls"],
			load: () =>
				import("./chunks/mathematica.as6zDwYy.js").then((e) =>
					yx(e.mathematica),
				),
		}),
		zc.of({
			...
			extensions: ["mo"],
			load: () =>
				import("./chunks/modelica.C36xtOoU.js").then((e) => yx(e.modelica)),
		}),
		zc.of({
			name: "MUMPS",
			extensions: ["mps"],
			load: () => import("./chunks/mumps.BTol1Blm.js").then((e) => yx(e.mumps)),
		}),
		zc.of({
			name: "Mbox",
			extensions: ["mbox"],
			load: () => import("./chunks/mbox.BW5B8sHr.js").then((e) => yx(e.mbox)),
		}),
		zc.of({
			name: "Nginx",
			filename: /nginx.*\.conf$/i,
			load: () => import("./chunks/nginx.BtJCkB_N.js").then((e) => yx(e.nginx)),
		}),
		zc.of({
			name: "NSIS",
			extensions: ["nsh", "nsi"],
			load: () => import("./chunks/nsis.D7FyGgHU.js").then((e) => yx(e.nsis)),
		}),
		zc.of({
			name: "NTriples",
			extensions: ["nt", "nq"],
			load: () =>
				import("./chunks/ntriples.C3TCn7t8.js").then((e) => yx(e.ntriples)),
		}),
		zc.of({
			name: "Objective-C",
			...
			extensions: ["m"],
			load: () =>
				import("./chunks/clike.BsU_3Ptx.js").then((e) => yx(e.objectiveC)),
		}),
		zc.of({
			name: "Objective-C++",
			alias: ["objective-c++", "objc++"],
			extensions: ["mm"],
			load: () =>
				import("./chunks/clike.BsU_3Ptx.js").then((e) => yx(e.objectiveCpp)),
		}),
		zc.of({
			name: "OCaml",
			extensions: ["ml", "mli", "mll", "mly"],
			load: () =>
				import("./chunks/mllike.XYhq5y8_.js").then((e) => yx(e.oCaml)),
		}),
		zc.of({
			name: "Octave",
			extensions: ["m"],
			load: () =>
				import("./chunks/octave.l5YK3rmg.js").then((e) => yx(e.octave)),
		}),
		zc.of({
			name: "Oz",
			extensions: ["oz"],
			load: () => import("./chunks/oz.YcMr9qRC.js").then((e) => yx(e.oz)),
		}),
		zc.of({
			name: "Pascal",
			extensions: ["p", "pas"],
			load: () =>
				import("./chunks/pascal.C7yJoDUq.js").then((e) => yx(e.pascal)),
		}),
		zc.of({
			name: "Perl",
			extensions: ["pl", "pm"],
			load: () => import("./chunks/perl.DSYjljZJ.js").then((e) => yx(e.perl)),
		}),
		zc.of({
			name: "Pig",
			extensions: ["pig"],
			load: () => import("./chunks/pig.BthYB5Hz.js").then((e) => yx(e.pig)),
		}),
		zc.of({
			name: "PowerShell",
			extensions: ["ps1", "psd1", "psm1"],
			load: () =>
				import("./chunks/powershell.vZEBNqmt.js").then((e) => yx(e.powerShell)),
		}),
		zc.of({
			...
			load: () =>
				import("./chunks/properties.BWiOuWqJ.js").then((e) => yx(e.properties)),
		}),
		zc.of({
			name: "ProtoBuf",
			extensions: ["proto"],
			load: () =>
				import("./chunks/protobuf.DoE0cNFa.js").then((e) => yx(e.protobuf)),
		}),
		zc.of({
			name: "Pug",
			alias: ["jade"],
			extensions: ["pug", "jade"],
			load: () => import("./chunks/pug.D8CFr8uJ.js").then((e) => yx(e.pug)),
		}),
		zc.of({
			name: "Puppet",
			extensions: ["pp"],
			load: () =>
				import("./chunks/puppet.DD1cESfM.js").then((e) => yx(e.puppet)),
		}),
		zc.of({
			name: "Q",
			extensions: ["q"],
			load: () => import("./chunks/q.DIFQivbw.js").then((e) => yx(e.q)),
		}),
		zc.of({
			name: "R",
			alias: ["rscript"],
			extensions: ["r", "R"],
			load: () => import("./chunks/r.BMfgZ5yV.js").then((e) => yx(e.r)),
		}),
		zc.of({
			name: "RPM Changes",
			load: () =>
				import("./chunks/rpm.BSEG7loO.js").then((e) => yx(e.rpmChanges)),
		}),
		zc.of({
			name: "RPM Spec",
			extensions: ["spec"],
			load: () => import("./chunks/rpm.BSEG7loO.js").then((e) => yx(e.rpmSpec)),
		}),
		zc.of({
			name: "Ruby",
			...
			load: () => import("./chunks/ruby.CssCQRhO.js").then((e) => yx(e.ruby)),
		}),
		zc.of({
			name: "SAS",
			extensions: ["sas"],
			load: () => import("./chunks/sas.HnRH-2zZ.js").then((e) => yx(e.sas)),
		}),
		zc.of({
			name: "Scala",
			extensions: ["scala"],
			load: () => import("./chunks/clike.BsU_3Ptx.js").then((e) => yx(e.scala)),
		}),
		zc.of({
			name: "Scheme",
			extensions: ["scm", "ss"],
			load: () =>
				import("./chunks/scheme.B7GW9J_7.js").then((e) => yx(e.scheme)),
		}),
		zc.of({
			name: "Shell",
			alias: ["bash", "sh", "zsh"],
			...
			filename: /^PKGBUILD$/,
			load: () => import("./chunks/shell.C9Em7lCa.js").then((e) => yx(e.shell)),
		}),
		zc.of({
			name: "Sieve",
			extensions: ["siv", "sieve"],
			load: () => import("./chunks/sieve.D58baEEm.js").then((e) => yx(e.sieve)),
		}),
		zc.of({
			name: "Smalltalk",
			extensions: ["st"],
			load: () =>
				import("./chunks/smalltalk.CRwoVvYQ.js").then((e) => yx(e.smalltalk)),
		}),
		zc.of({
			name: "Solr",
			load: () => import("./chunks/solr.hb7a9myP.js").then((e) => yx(e.solr)),
		}),
		zc.of({
			name: "SML",
			extensions: ["sml", "sig", "fun", "smackspec"],
			load: () => import("./chunks/mllike.XYhq5y8_.js").then((e) => yx(e.sml)),
		}),
		zc.of({
			name: "SPARQL",
			alias: ["sparul"],
			...
			load: () =>
				import("./chunks/sparql.BFjb6nLJ.js").then((e) => yx(e.sparql)),
		}),
		zc.of({
			name: "Spreadsheet",
			alias: ["excel", "formula"],
			load: () =>
				import("./chunks/spreadsheet.BtPPhYI9.js").then((e) =>
					yx(e.spreadsheet),
				),
		}),
		zc.of({
			...
			extensions: ["nut"],
			load: () =>
				import("./chunks/clike.BsU_3Ptx.js").then((e) => yx(e.squirrel)),
		}),
		zc.of({
			name: "Stylus",
			extensions: ["styl"],
			load: () =>
				import("./chunks/stylus.1Pvu7UXQ.js").then((e) => yx(e.stylus)),
		}),
		zc.of({
			name: "Swift",
			extensions: ["swift"],
			load: () => import("./chunks/swift.CAT9wtmT.js").then((e) => yx(e.swift)),
		}),
		zc.of({
			name: "sTeX",
			load: () => import("./chunks/stex.BrA22C5O.js").then((e) => yx(e.stex)),
		}),
		zc.of({
			name: "LaTeX",
			alias: ["tex"],
		...
		zc.of({
			...
			extensions: ["v", "sv", "svh"],
			load: () =>
				import("./chunks/verilog.D0Lo9oPB.js").then((e) => yx(e.verilog)),
		}),
		zc.of({
			name: "Tcl",
			extensions: ["tcl"],
			load: () => import("./chunks/tcl.BsptRImA.js").then((e) => yx(e.tcl)),
		}),
		zc.of({
			name: "Textile",
			extensions: ["textile"],
			load: () =>
				import("./chunks/textile.DwbuwdYj.js").then((e) => yx(e.textile)),
		}),
		zc.of({
			name: "TiddlyWiki",
			load: () =>
				import("./chunks/tiddlywiki.eHRRguqQ.js").then((e) => yx(e.tiddlyWiki)),
		}),
		zc.of({
			name: "Tiki wiki",
			load: () => import("./chunks/tiki.C3-6d3YE.js").then((e) => yx(e.tiki)),
		}),
		zc.of({
			name: "TOML",
			extensions: ["toml"],
			load: () => import("./chunks/toml._XLYe2Wa.js").then((e) => yx(e.toml)),
		}),
		zc.of({
			name: "Troff",
			extensions: ["1", "2", "3", "4", "5", "6", "7", "8", "9"],
			load: () => import("./chunks/troff.DXviO7Mp.js").then((e) => yx(e.troff)),
		}),
		zc.of({
			name: "TTCN",
			extensions: ["ttcn", "ttcn3", "ttcnpp"],
			load: () => import("./chunks/ttcn.BSzdvELj.js").then((e) => yx(e.ttcn)),
		}),
		zc.of({
			name: "TTCN_CFG",
			extensions: ["cfg"],
			load: () =>
				import("./chunks/ttcn-cfg.CtOb6jrc.js").then((e) => yx(e.ttcnCfg)),
		}),
		zc.of({
			name: "Turtle",
			extensions: ["ttl"],
			load: () =>
				import("./chunks/turtle.5heLEolO.js").then((e) => yx(e.turtle)),
		}),
		zc.of({
			name: "Web IDL",
			extensions: ["webidl"],
			load: () =>
				import("./chunks/webidl.CS14qeoI.js").then((e) => yx(e.webIDL)),
		}),
		zc.of({
			name: "VB.NET",
			extensions: ["vb"],
			load: () => import("./chunks/vb.GZ0Y1TrX.js").then((e) => yx(e.vb)),
		}),
		zc.of({
			name: "VBScript",
			extensions: ["vbs"],
			load: () =>
				import("./chunks/vbscript.9okRuUr7.js").then((e) => yx(e.vbScript)),
		}),
		zc.of({
			name: "Velocity",
			extensions: ["vtl"],
			load: () =>
				import("./chunks/velocity.D5tFZ5bk.js").then((e) => yx(e.velocity)),
		}),
		zc.of({
			name: "Verilog",
			extensions: ["v"],
		...
		zc.of({
			name: "VHDL",
			extensions: ["vhd", "vhdl"],
			load: () => import("./chunks/vhdl.B7VoT424.js").then((e) => yx(e.vhdl)),
		}),
		zc.of({
			name: "XQuery",
			extensions: ["xy", "xquery"],
			load: () =>
				import("./chunks/xquery.D8QROkwP.js").then((e) => yx(e.xQuery)),
		}),
		zc.of({
			name: "Yacas",
			extensions: ["ys"],
			load: () => import("./chunks/yacas.mn8YnPAW.js").then((e) => yx(e.yacas)),
		}),
		zc.of({
			name: "Z80",
			extensions: ["z80"],
			load: () => import("./chunks/z80.C3LewqKw.js").then((e) => yx(e.z80)),
		}),
		zc.of({
			name: "MscGen",
			extensions: ["mscgen", "mscin", "msc"],
			load: () =>
				import("./chunks/mscgen.C5yui7A0.js").then((e) => yx(e.mscgen)),
		}),
		zc.of({
			name: "Xù",
			extensions: ["xu"],
			load: () => import("./chunks/mscgen.C5yui7A0.js").then((e) => yx(e.xu)),
		}),
		zc.of({
			name: "MsGenny",
			extensions: ["msgenny"],
			load: () =>
				import("./chunks/mscgen.C5yui7A0.js").then((e) => yx(e.msgenny)),
		}),
		zc.of({
			name: "Vue",
			extensions: ["vue"],
			load: () => import("./chunks/index.B1NU7O0_.js").then((e) => e.vue()),
		}),
		zc.of({
			name: "Angular Template",
			load: () => import("./chunks/index.BVzDpFfW.js").then((e) => e.angular()),
		}),
	],
	...
	Ax = "var(--editor-number, #b5cea8)",
	Cx = "var(--editor-heading, #4ec9b0)",
	...
	Ex = Gl.theme(
		{
			...
			[kc.heading]: { color: Cx, fontWeight: "bold" },
			...
			[kc.contentSeparator]: { color: Cx, fontWeight: "bold" },
			[kc.list]: { color: vx },
			[kc.meta]: { color: Tx },
		},
		{ dark: !0 },
...
function Vx(e, t = "", n = {}) {
	const { onChange: i = () => {}, additionalExtensions: r = [] } = n,
		s = Sr.create({
			doc: initialContent,
			extensions: [
				[
...
function Wx(e, t, n, i, r = t.length) {
	...
	return {
		...
		init() {
			...
			if (n)
				try {
					(e = JSON.parse(n.textContent).content || ""),
						console.log(
							`[EditorComponent] Successfully parsed initial content from #${t}. Length: ${e.length}`,
						),
						console.log(
							"Initial content length from JSON script tag:",
							e.length,
						);
				} catch (n) {
					console.error(
						...
						console.error(`Error parsing initial content from #${t}:`, n),
						(e = "");
				}
			else
				console.warn(
					...
					console.warn(`Initial content script tag #${t} not found.`);
			(this.persistence = new Lx(this.entryId)),
				console.log(
					`[EditorComponent] Initializing EditorPersistence for entryId: ${this.entryId || "new"}`,
				);
			document.querySelector(".flash-success") &&
				...
				(this.content = e),
				console.warn(
					"[EditorComponent] Draft loading is temporarily disabled for debugging.",
				),
				console.log("Draft loading temporarily disabled for debugging."),
				...
				this.$nextTick(() => {
					if (
						...
						console.log(
							"Alpine $nextTick: Attempting to find editorElement ref:",
						...
						return (
							console.error(
								"[EditorComponent/$nextTick] Editor target element (x-ref='editorElement') not found.",
							),
							void console.error(
								"Editor target element (x-ref='editorElement') still not found within $nextTick.",
							)
						);
					console.log(
						"[EditorComponent/$nextTick] Attempting to create CodeMirror editor...",
					),
						console.log("Alpine $nextTick: Creating CodeMirror editor...");
					try {
						(this.editorView = Vx(this.$refs.editorElement, this.content, {
							onChange: (e) => {
							...
							console.log(
								"Alpine $nextTick: CodeMirror editor created successfully.",
							);
					} catch (e) {
						console.error(
							...
							console.error(
								"Error creating CodeMirror editor inside $nextTick:",
								e,
							);
					}
				...
				setInterval(() => {
					this.saveDraftIfNeeded(), this.saveDraftIfNeeded();
				}, 1e4),
				...
				console.log("Alpine editor component initialized.");
		},
		handleContentChange: Yx(function () {
			console.log(
				"[EditorComponent/handleContentChange] Content changed (debounced). Triggering draft save check and potential preview update.",
			),
		...
		async updatePreview() {
			...
			try {
				...
				(this.previewHtml = n.html),
					console.log(
						"[EditorComponent/updatePreview] Preview fetched successfully, triggering MathJax typesetting via $nextTick.",
					),
					this.$nextTick(() => {
						const e = this.$refs.previewContent;
						e && window.MathJax && window.MathJax.typesetPromise
							? (console.log(
									"[EditorComponent/updatePreview/$nextTick] Triggering MathJax typesetting...",
								),
				...
				(this.isLoadingPreview = !1),
					console.log(
						"[EditorComponent/updatePreview] Preview update finished.",
					);
			}
		},
		saveDraftIfNeeded() {
		...
		insertMarkdown(e) {
			if (this.editorView)
				switch (
					(console.log(
						`[EditorComponent/insertMarkdown] Inserting markdown type: ${e}`,
					),
					e)
				) {
					case "bold":
						!(function (e) {
							const t = Wx(e.state, "**", "**", "bold text");
					...
					case "italic":
						!(function (e) {
							const t = Wx(e.state, "*", "*", "italic text");
							e.dispatch(
					...
					case "blockquote":
						...
						break;
					case "image":
						Dx(this.editorView, "![", "](url)", "alt text");
						break;
					case "table":
						const t =
							"| Header 1 | Header 2 |\n|---|---|\n| Cell 1 | Cell 2 |\n| Cell 3 | Cell 4 |";
						Dx(this.editorView, "", "", t, !0);
						break;
					case "codeblock":
						Dx(this.editorView, "```\n", "\n```", "code here", !0);
						break;
					default:
						console.warn(
							`[EditorComponent/insertMarkdown] Unknown markdown type requested: ${e}`,
						);
				}
			else
				console.warn(
					"[EditorComponent/insertMarkdown] Attempted to insert markdown, but editorView is not available.",
				);
		},
		insertImage() {
