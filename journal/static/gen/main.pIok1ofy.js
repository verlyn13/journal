...
function wS(e) {
	return import("./chunks/index.CXI5xrH4.js").then((t) =>
		t.sql({ dialect: t[e] }),
	);
}
const SS = [
		Cf.of({
			name: "C",
			extensions: ["c", "h", "ino"],
			load: () => import("./chunks/index.B8YZkeZJ.js").then((e) => e.cpp()),
		}),
		Cf.of({
			name: "C++",
			alias: ["cpp"],
		...
		Cf.of({
			name: "Go",
			extensions: ["go"],
			load: () => import("./chunks/index.CtSgih8l.js").then((e) => e.go()),
		}),
		Cf.of({
			name: "HTML",
			alias: ["xhtml"],
		...
		Cf.of({
			name: "Java",
			extensions: ["java"],
			load: () => import("./chunks/index.VZU9SeiS.js").then((e) => e.java()),
		}),
		Cf.of({
			name: "JavaScript",
		...
		Cf.of({
			...
			alias: ["json5"],
			extensions: ["json", "map"],
			load: () => import("./chunks/index.DMWMOyWe.js").then((e) => e.json()),
		}),
		Cf.of({
			name: "JSX",
			extensions: ["jsx"],
		...
		Cf.of({
			name: "LESS",
			extensions: ["less"],
			load: () => import("./chunks/index.T9HCaFSA.js").then((e) => e.less()),
		}),
		Cf.of({
			name: "Liquid",
			extensions: ["liquid"],
			load: () => import("./chunks/index.CHQ5JAeK.js").then((e) => e.liquid()),
		}),
		...
		Cf.of({
			...
			load: () => import("./chunks/index.CStXAYNm.js").then((e) => e.php()),
		}),
		...
		Cf.of({
			...
			filename: /^(BUCK|BUILD)$/,
			load: () => import("./chunks/index.CUriET5u.js").then((e) => e.python()),
		}),
		Cf.of({
			name: "Rust",
			extensions: ["rs"],
			load: () => import("./chunks/index.Br4PYRIo.js").then((e) => e.rust()),
		}),
		Cf.of({
			name: "Sass",
			extensions: ["sass"],
			load: () =>
				import("./chunks/index.jMTlkin1.js").then((e) =>
					e.sass({ indented: !0 }),
				),
		}),
		Cf.of({
			name: "SCSS",
			extensions: ["scss"],
			load: () => import("./chunks/index.jMTlkin1.js").then((e) => e.sass()),
		}),
		...
		Cf.of({
			name: "WebAssembly",
			extensions: ["wat", "wast"],
			load: () => import("./chunks/index.CJegEV1J.js").then((e) => e.wast()),
		}),
		Cf.of({
			name: "XML",
			alias: ["rss", "wsdl", "xsd"],
			extensions: ["xml", "xsl", "xsd", "svg"],
			load: () => import("./chunks/index.CnO1MRKS.js").then((e) => e.xml()),
		}),
		Cf.of({
			name: "YAML",
			alias: ["yml"],
			extensions: ["yaml", "yml"],
			load: () => import("./chunks/index.Dek2qRcP.js").then((e) => e.yaml()),
		}),
		Cf.of({
			name: "APL",
			extensions: ["dyalog", "apl"],
			load: () => import("./chunks/apl.Rusiczck.js").then((e) => yS(e.apl)),
		}),
		Cf.of({
			name: "PGP",
			alias: ["asciiarmor"],
			...
			load: () =>
				import("./chunks/asciiarmor.ClLY-WTZ.js").then((e) => yS(e.asciiArmor)),
		}),
		Cf.of({
			name: "ASN.1",
			extensions: ["asn", "asn1"],
			load: () =>
				import("./chunks/asn1.Bcu4OC03.js").then((e) => yS(e.asn1({}))),
		}),
		Cf.of({
			name: "Asterisk",
			filename: /^extensions\.conf$/i,
			load: () =>
				import("./chunks/asterisk.DG7Dc1qR.js").then((e) => yS(e.asterisk)),
		}),
		Cf.of({
			name: "Brainfuck",
			extensions: ["b", "bf"],
			load: () =>
				import("./chunks/brainfuck.B5sSJ1Ix.js").then((e) => yS(e.brainfuck)),
		}),
		Cf.of({
			name: "Cobol",
			extensions: ["cob", "cpy"],
			load: () => import("./chunks/cobol.DgDdcr27.js").then((e) => yS(e.cobol)),
		}),
		Cf.of({
			name: "C#",
			alias: ["csharp", "cs"],
			extensions: ["cs"],
			load: () =>
				import("./chunks/clike.DO2CYvQc.js").then((e) => yS(e.csharp)),
		}),
		Cf.of({
			name: "Clojure",
			extensions: ["clj", "cljc", "cljx"],
			load: () =>
				import("./chunks/clojure.DKnz3pFJ.js").then((e) => yS(e.clojure)),
		}),
		Cf.of({
			name: "ClojureScript",
			extensions: ["cljs"],
		...
		Cf.of({
			...
			extensions: ["gss"],
			load: () => import("./chunks/css.Bh_tEyAY.js").then((e) => yS(e.gss)),
		}),
		Cf.of({
			name: "CMake",
			extensions: ["cmake", "cmake.in"],
			filename: /^CMakeLists\.txt$/,
			load: () => import("./chunks/cmake.BkQoKRCJ.js").then((e) => yS(e.cmake)),
		}),
		Cf.of({
			name: "CoffeeScript",
			...
			extensions: ["coffee"],
			load: () =>
				import("./chunks/coffeescript.DNT1Z9Z_.js").then((e) =>
					yS(e.coffeeScript),
				),
		}),
		Cf.of({
			...
			load: () =>
				import("./chunks/commonlisp.Dyb_KEcw.js").then((e) => yS(e.commonLisp)),
		}),
		Cf.of({
			name: "Cypher",
			extensions: ["cyp", "cypher"],
			load: () =>
				import("./chunks/cypher.BzBRaCjL.js").then((e) => yS(e.cypher)),
		}),
		Cf.of({
			name: "Cython",
			extensions: ["pyx", "pxd", "pxi"],
			load: () =>
				import("./chunks/python.IgJaah-H.js").then((e) => yS(e.cython)),
		}),
		Cf.of({
			name: "Crystal",
			extensions: ["cr"],
			load: () =>
				import("./chunks/crystal.Dbzl_Rrp.js").then((e) => yS(e.crystal)),
		}),
		Cf.of({
			name: "D",
			extensions: ["d"],
			load: () => import("./chunks/d.BI_YKmYZ.js").then((e) => yS(e.d)),
		}),
		Cf.of({
			name: "Dart",
			extensions: ["dart"],
			load: () => import("./chunks/clike.DO2CYvQc.js").then((e) => yS(e.dart)),
		}),
		Cf.of({
			name: "diff",
			extensions: ["diff", "patch"],
			load: () => import("./chunks/diff.Cg58PLnt.js").then((e) => yS(e.diff)),
		}),
		Cf.of({
			name: "Dockerfile",
			filename: /^Dockerfile$/,
			load: () =>
				import("./chunks/dockerfile.CzMja6Cg.js").then((e) => yS(e.dockerFile)),
		}),
		Cf.of({
			name: "DTD",
			extensions: ["dtd"],
			load: () => import("./chunks/dtd.BIaZDBsj.js").then((e) => yS(e.dtd)),
		}),
		Cf.of({
			name: "Dylan",
			extensions: ["dylan", "dyl", "intr"],
			load: () => import("./chunks/dylan.BeSf3Rrd.js").then((e) => yS(e.dylan)),
		}),
		Cf.of({
			name: "EBNF",
			load: () => import("./chunks/ebnf.BmgU5Ztz.js").then((e) => yS(e.ebnf)),
		}),
		Cf.of({
			name: "ECL",
			extensions: ["ecl"],
			load: () => import("./chunks/ecl.DRQvD-9p.js").then((e) => yS(e.ecl)),
		}),
		Cf.of({
			name: "edn",
			extensions: ["edn"],
		...
		Cf.of({
			...
			extensions: ["e"],
			load: () =>
				import("./chunks/eiffel.Dni1Lk3P.js").then((e) => yS(e.eiffel)),
		}),
		Cf.of({
			name: "Elm",
			extensions: ["elm"],
			load: () => import("./chunks/elm.Bx8TGOZk.js").then((e) => yS(e.elm)),
		}),
		Cf.of({
			name: "Erlang",
			extensions: ["erl"],
			load: () =>
				import("./chunks/erlang.Du4aOnpR.js").then((e) => yS(e.erlang)),
		}),
		Cf.of({
			name: "Esper",
			load: () => import("./chunks/sql.Djd92tmc.js").then((e) => yS(e.esper)),
		}),
		Cf.of({
			name: "Factor",
			extensions: ["factor"],
			load: () =>
				import("./chunks/factor.BFRTAnUv.js").then((e) => yS(e.factor)),
		}),
		Cf.of({
			name: "FCL",
			load: () => import("./chunks/fcl.Bm6C5A9q.js").then((e) => yS(e.fcl)),
		}),
		Cf.of({
			name: "Forth",
			extensions: ["forth", "fth", "4th"],
			load: () => import("./chunks/forth.ClOm-aLU.js").then((e) => yS(e.forth)),
		}),
		Cf.of({
			name: "Fortran",
			extensions: ["f", "for", "f77", "f90", "f95"],
			load: () =>
				import("./chunks/fortran.DpB4UExZ.js").then((e) => yS(e.fortran)),
		}),
		Cf.of({
			name: "F#",
			alias: ["fsharp"],
			extensions: ["fs"],
			load: () =>
				import("./chunks/mllike.DNMiBe-B.js").then((e) => yS(e.fSharp)),
		}),
		Cf.of({
			name: "Gas",
			extensions: ["s"],
			load: () => import("./chunks/gas.GrjgVhyp.js").then((e) => yS(e.gas)),
		}),
		Cf.of({
			name: "Gherkin",
			extensions: ["feature"],
			load: () =>
				import("./chunks/gherkin.BXsoYLos.js").then((e) => yS(e.gherkin)),
		}),
		Cf.of({
			name: "Groovy",
			...
			load: () =>
				import("./chunks/groovy.DnzBZsR9.js").then((e) => yS(e.groovy)),
		}),
		Cf.of({
			name: "Haskell",
			extensions: ["hs"],
			load: () =>
				import("./chunks/haskell.CN0SaQOX.js").then((e) => yS(e.haskell)),
		}),
		Cf.of({
			name: "Haxe",
			extensions: ["hx"],
			load: () => import("./chunks/haxe.z_sBiP7a.js").then((e) => yS(e.haxe)),
		}),
		Cf.of({
			name: "HXML",
			extensions: ["hxml"],
			load: () => import("./chunks/haxe.z_sBiP7a.js").then((e) => yS(e.hxml)),
		}),
		Cf.of({
			name: "HTTP",
			load: () => import("./chunks/http.RbUhE9Qb.js").then((e) => yS(e.http)),
		}),
		Cf.of({
			name: "IDL",
			extensions: ["pro"],
			load: () => import("./chunks/idl.PCzsGK5Q.js").then((e) => yS(e.idl)),
		}),
		Cf.of({
			name: "JSON-LD",
			alias: ["jsonld"],
			extensions: ["jsonld"],
			load: () =>
				import("./chunks/javascript.8_q2pdLS.js").then((e) => yS(e.jsonld)),
		}),
		Cf.of({
			name: "Jinja2",
			extensions: ["j2", "jinja", "jinja2"],
			load: () =>
				import("./chunks/jinja2.D0tXMtyd.js").then((e) => yS(e.jinja2)),
		}),
		Cf.of({
			name: "Julia",
			extensions: ["jl"],
			load: () => import("./chunks/julia.LqyyEvjL.js").then((e) => yS(e.julia)),
		}),
		Cf.of({
			name: "Kotlin",
			extensions: ["kt", "kts"],
			load: () =>
				import("./chunks/clike.DO2CYvQc.js").then((e) => yS(e.kotlin)),
		}),
		Cf.of({
			name: "LiveScript",
			alias: ["ls"],
			extensions: ["ls"],
			load: () =>
				import("./chunks/livescript.COMB8LOn.js").then((e) => yS(e.liveScript)),
		}),
		Cf.of({
			name: "Lua",
			extensions: ["lua"],
			load: () => import("./chunks/lua.BuvV7maR.js").then((e) => yS(e.lua)),
		}),
		Cf.of({
			name: "mIRC",
			extensions: ["mrc"],
			load: () => import("./chunks/mirc.CkEHd69e.js").then((e) => yS(e.mirc)),
		}),
		Cf.of({
			name: "Mathematica",
			extensions: ["m", "nb", "wl", "wls"],
			load: () =>
				import("./chunks/mathematica.CJoBeBZW.js").then((e) =>
					yS(e.mathematica),
				),
		}),
		Cf.of({
			...
			extensions: ["mo"],
			load: () =>
				import("./chunks/modelica.z_--6j3p.js").then((e) => yS(e.modelica)),
		}),
		Cf.of({
			name: "MUMPS",
			extensions: ["mps"],
			load: () => import("./chunks/mumps.DX27y0o9.js").then((e) => yS(e.mumps)),
		}),
		Cf.of({
			name: "Mbox",
			extensions: ["mbox"],
			load: () => import("./chunks/mbox.DOF3wDeM.js").then((e) => yS(e.mbox)),
		}),
		Cf.of({
			name: "Nginx",
			filename: /nginx.*\.conf$/i,
			load: () => import("./chunks/nginx.C4N4D5JU.js").then((e) => yS(e.nginx)),
		}),
		Cf.of({
			name: "NSIS",
			extensions: ["nsh", "nsi"],
			load: () => import("./chunks/nsis.CCe9ScYl.js").then((e) => yS(e.nsis)),
		}),
		Cf.of({
			name: "NTriples",
			extensions: ["nt", "nq"],
			load: () =>
				import("./chunks/ntriples.C_dgDhqC.js").then((e) => yS(e.ntriples)),
		}),
		Cf.of({
			name: "Objective-C",
			...
			extensions: ["m"],
			load: () =>
				import("./chunks/clike.DO2CYvQc.js").then((e) => yS(e.objectiveC)),
		}),
		Cf.of({
			name: "Objective-C++",
			alias: ["objective-c++", "objc++"],
			extensions: ["mm"],
			load: () =>
				import("./chunks/clike.DO2CYvQc.js").then((e) => yS(e.objectiveCpp)),
		}),
		Cf.of({
			name: "OCaml",
			extensions: ["ml", "mli", "mll", "mly"],
			load: () =>
				import("./chunks/mllike.DNMiBe-B.js").then((e) => yS(e.oCaml)),
		}),
		Cf.of({
			name: "Octave",
			extensions: ["m"],
			load: () =>
				import("./chunks/octave.C7a7me8W.js").then((e) => yS(e.octave)),
		}),
		Cf.of({
			name: "Oz",
			extensions: ["oz"],
			load: () => import("./chunks/oz.WvvbRWRZ.js").then((e) => yS(e.oz)),
		}),
		Cf.of({
			name: "Pascal",
			extensions: ["p", "pas"],
			load: () =>
				import("./chunks/pascal.CbP-fPZg.js").then((e) => yS(e.pascal)),
		}),
		Cf.of({
			name: "Perl",
			extensions: ["pl", "pm"],
			load: () => import("./chunks/perl.pDkQ_1OQ.js").then((e) => yS(e.perl)),
		}),
		Cf.of({
			name: "Pig",
			extensions: ["pig"],
			load: () => import("./chunks/pig.DyEcqBhL.js").then((e) => yS(e.pig)),
		}),
		Cf.of({
			name: "PowerShell",
			extensions: ["ps1", "psd1", "psm1"],
			load: () =>
				import("./chunks/powershell.Cr70XH7c.js").then((e) => yS(e.powerShell)),
		}),
		Cf.of({
			...
			load: () =>
				import("./chunks/properties.BrREO46k.js").then((e) => yS(e.properties)),
		}),
		Cf.of({
			name: "ProtoBuf",
			extensions: ["proto"],
			load: () =>
				import("./chunks/protobuf.DPs34VvP.js").then((e) => yS(e.protobuf)),
		}),
		Cf.of({
			name: "Pug",
			alias: ["jade"],
			extensions: ["pug", "jade"],
			load: () => import("./chunks/pug.C3_II9OJ.js").then((e) => yS(e.pug)),
		}),
		Cf.of({
			name: "Puppet",
			extensions: ["pp"],
			load: () =>
				import("./chunks/puppet.CxXAvA6o.js").then((e) => yS(e.puppet)),
		}),
		Cf.of({
			name: "Q",
			extensions: ["q"],
			load: () => import("./chunks/q.BcQSF38z.js").then((e) => yS(e.q)),
		}),
		Cf.of({
			name: "R",
			alias: ["rscript"],
			extensions: ["r", "R"],
			load: () => import("./chunks/r.xZcmECQh.js").then((e) => yS(e.r)),
		}),
		Cf.of({
			name: "RPM Changes",
			load: () =>
				import("./chunks/rpm.CBW_L_kK.js").then((e) => yS(e.rpmChanges)),
		}),
		Cf.of({
			name: "RPM Spec",
			extensions: ["spec"],
			load: () => import("./chunks/rpm.CBW_L_kK.js").then((e) => yS(e.rpmSpec)),
		}),
		Cf.of({
			name: "Ruby",
			...
			load: () => import("./chunks/ruby.dac3SCcA.js").then((e) => yS(e.ruby)),
		}),
		Cf.of({
			name: "SAS",
			extensions: ["sas"],
			load: () => import("./chunks/sas.NtZewr9f.js").then((e) => yS(e.sas)),
		}),
		Cf.of({
			name: "Scala",
			extensions: ["scala"],
			load: () => import("./chunks/clike.DO2CYvQc.js").then((e) => yS(e.scala)),
		}),
		Cf.of({
			name: "Scheme",
			extensions: ["scm", "ss"],
			load: () =>
				import("./chunks/scheme.B709qnR2.js").then((e) => yS(e.scheme)),
		}),
		Cf.of({
			name: "Shell",
			alias: ["bash", "sh", "zsh"],
			...
			filename: /^PKGBUILD$/,
			load: () => import("./chunks/shell.Dd_YDQX5.js").then((e) => yS(e.shell)),
		}),
		Cf.of({
			name: "Sieve",
			extensions: ["siv", "sieve"],
			load: () => import("./chunks/sieve.DVaT3Clo.js").then((e) => yS(e.sieve)),
		}),
		Cf.of({
			name: "Smalltalk",
			extensions: ["st"],
			load: () =>
				import("./chunks/smalltalk.DiVc81j4.js").then((e) => yS(e.smalltalk)),
		}),
		Cf.of({
			name: "Solr",
			load: () => import("./chunks/solr.UW6nQGQv.js").then((e) => yS(e.solr)),
		}),
		Cf.of({
			name: "SML",
			extensions: ["sml", "sig", "fun", "smackspec"],
			load: () => import("./chunks/mllike.DNMiBe-B.js").then((e) => yS(e.sml)),
		}),
		Cf.of({
			name: "SPARQL",
			alias: ["sparul"],
			...
			load: () =>
				import("./chunks/sparql.CR4YzKtk.js").then((e) => yS(e.sparql)),
		}),
		Cf.of({
			name: "Spreadsheet",
			alias: ["excel", "formula"],
			load: () =>
				import("./chunks/spreadsheet.CRs2YadT.js").then((e) =>
					yS(e.spreadsheet),
				),
		}),
		Cf.of({
			...
			extensions: ["nut"],
			load: () =>
				import("./chunks/clike.DO2CYvQc.js").then((e) => yS(e.squirrel)),
		}),
		Cf.of({
			name: "Stylus",
			extensions: ["styl"],
			load: () =>
				import("./chunks/stylus.DBi6hgaL.js").then((e) => yS(e.stylus)),
		}),
		Cf.of({
			name: "Swift",
			extensions: ["swift"],
			load: () => import("./chunks/swift.e2jJwuGx.js").then((e) => yS(e.swift)),
		}),
		Cf.of({
			name: "sTeX",
			load: () => import("./chunks/stex.ByZX9_s2.js").then((e) => yS(e.stex)),
		}),
		Cf.of({
			name: "LaTeX",
			alias: ["tex"],
		...
		Cf.of({
			...
			extensions: ["v", "sv", "svh"],
			load: () =>
				import("./chunks/verilog.Di2bp-y8.js").then((e) => yS(e.verilog)),
		}),
		Cf.of({
			name: "Tcl",
			extensions: ["tcl"],
			load: () => import("./chunks/tcl.BavmUol7.js").then((e) => yS(e.tcl)),
		}),
		Cf.of({
			name: "Textile",
			extensions: ["textile"],
			load: () =>
				import("./chunks/textile.AH_tb6Av.js").then((e) => yS(e.textile)),
		}),
		Cf.of({
			name: "TiddlyWiki",
			load: () =>
				import("./chunks/tiddlywiki.Bd1w42kE.js").then((e) => yS(e.tiddlyWiki)),
		}),
		Cf.of({
			name: "Tiki wiki",
			load: () => import("./chunks/tiki.DSR997g1.js").then((e) => yS(e.tiki)),
		}),
		Cf.of({
			name: "TOML",
			extensions: ["toml"],
			load: () => import("./chunks/toml.C1MjJCZR.js").then((e) => yS(e.toml)),
		}),
		Cf.of({
			name: "Troff",
			extensions: ["1", "2", "3", "4", "5", "6", "7", "8", "9"],
			load: () => import("./chunks/troff.BO_sL1By.js").then((e) => yS(e.troff)),
		}),
		Cf.of({
			name: "TTCN",
			extensions: ["ttcn", "ttcn3", "ttcnpp"],
			load: () => import("./chunks/ttcn.DjK-o0cK.js").then((e) => yS(e.ttcn)),
		}),
		Cf.of({
			name: "TTCN_CFG",
			extensions: ["cfg"],
			load: () =>
				import("./chunks/ttcn-cfg.DZ6IFii_.js").then((e) => yS(e.ttcnCfg)),
		}),
		Cf.of({
			name: "Turtle",
			extensions: ["ttl"],
			load: () =>
				import("./chunks/turtle.yU5RJg9-.js").then((e) => yS(e.turtle)),
		}),
		Cf.of({
			name: "Web IDL",
			extensions: ["webidl"],
			load: () =>
				import("./chunks/webidl.DW3N0_iP.js").then((e) => yS(e.webIDL)),
		}),
		Cf.of({
			name: "VB.NET",
			extensions: ["vb"],
			load: () => import("./chunks/vb.C-BNQdy3.js").then((e) => yS(e.vb)),
		}),
		Cf.of({
			name: "VBScript",
			extensions: ["vbs"],
			load: () =>
				import("./chunks/vbscript.CepH-u18.js").then((e) => yS(e.vbScript)),
		}),
		Cf.of({
			name: "Velocity",
			extensions: ["vtl"],
			load: () =>
				import("./chunks/velocity.B7OHmJb2.js").then((e) => yS(e.velocity)),
		}),
		Cf.of({
			name: "Verilog",
			extensions: ["v"],
		...
		Cf.of({
			name: "VHDL",
			extensions: ["vhd", "vhdl"],
			load: () => import("./chunks/vhdl._mVW2aQx.js").then((e) => yS(e.vhdl)),
		}),
		Cf.of({
			name: "XQuery",
			extensions: ["xy", "xquery"],
			load: () =>
				import("./chunks/xquery.BTH_W-W7.js").then((e) => yS(e.xQuery)),
		}),
		Cf.of({
			name: "Yacas",
			extensions: ["ys"],
			load: () => import("./chunks/yacas.CNAsF__X.js").then((e) => yS(e.yacas)),
		}),
		Cf.of({
			name: "Z80",
			extensions: ["z80"],
			load: () => import("./chunks/z80.Dc7HhLMx.js").then((e) => yS(e.z80)),
		}),
		Cf.of({
			name: "MscGen",
			extensions: ["mscgen", "mscin", "msc"],
			load: () =>
				import("./chunks/mscgen.yPdkNouO.js").then((e) => yS(e.mscgen)),
		}),
		Cf.of({
			name: "Xù",
			extensions: ["xu"],
			load: () => import("./chunks/mscgen.yPdkNouO.js").then((e) => yS(e.xu)),
		}),
		Cf.of({
			name: "MsGenny",
			extensions: ["msgenny"],
			load: () =>
				import("./chunks/mscgen.yPdkNouO.js").then((e) => yS(e.msgenny)),
		}),
		Cf.of({
			name: "Vue",
			extensions: ["vue"],
			load: () => import("./chunks/index.DXazJYQz.js").then((e) => e.vue()),
		}),
		Cf.of({
			name: "Angular Template",
			load: () => import("./chunks/index.xxRTKUX4.js").then((e) => e.angular()),
		}),
	],
				...
				this.$nextTick(() => {
					if (
						...
						try {
							...
							})(this.$refs.editorElement, this.content, {
								onChange: (e) => {
						...
						console.error(
							"[EditorComponent/$nextTick] Editor target element (x-ref='editorElement') not found in $refs after $nextTick. Cannot initialize CodeMirror.",
						);
				}),
				setInterval(() => {
