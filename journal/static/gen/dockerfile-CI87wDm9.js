import { s as e } from "./simple-mode-BK_cjIr5.js";
var n = "from",
	t = new RegExp("^(\\s*)\\b(" + n + ")\\b", "i"),
	r = ["run", "cmd", "entrypoint", "shell"],
	o = new RegExp("^(\\s*)(" + r.join("|") + ")(\\s+\\[)", "i"),
	l = "expose",
