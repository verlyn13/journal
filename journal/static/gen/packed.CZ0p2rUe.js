...
function yx(e) {
	return import("./index-CbRZWDj3.js").then((t) => t.sql({ dialect: t[e] }));
}
const Qx = [
		zc.of({
			name: "C",
			extensions: ["c", "h", "ino"],
			load: () => import("./index-CLbR_Jnn.js").then((e) => e.cpp()),
		}),
		zc.of({
			name: "C++",
			alias: ["cpp"],
		...
		zc.of({
			name: "Go",
			extensions: ["go"],
			load: () => import("./index-BGDmzMj7.js").then((e) => e.go()),
		}),
		zc.of({
			name: "HTML",
			alias: ["xhtml"],
		...
		zc.of({
			name: "Java",
			extensions: ["java"],
			load: () => import("./index-DhNw_DRt.js").then((e) => e.java()),
		}),
		zc.of({
			name: "JavaScript",
		...
		zc.of({
			...
			alias: ["json5"],
			extensions: ["json", "map"],
			load: () => import("./index-DQ9RViCs.js").then((e) => e.json()),
		}),
		zc.of({
			name: "JSX",
			extensions: ["jsx"],
		...
		zc.of({
			name: "LESS",
			extensions: ["less"],
			load: () => import("./index-B5bnWCS3.js").then((e) => e.less()),
		}),
		zc.of({
			name: "Liquid",
			extensions: ["liquid"],
			load: () => import("./index-DnHTxkgs.js").then((e) => e.liquid()),
		}),
		...
		zc.of({
			...
			load: () => import("./index-HADs62HZ.js").then((e) => e.php()),
		}),
		...
		zc.of({
			...
			filename: /^(BUCK|BUILD)$/,
			load: () => import("./index-DuEupBqn.js").then((e) => e.python()),
		}),
		zc.of({
			name: "Rust",
			extensions: ["rs"],
			load: () => import("./index-DT80MKoJ.js").then((e) => e.rust()),
		}),
		zc.of({
			name: "Sass",
			extensions: ["sass"],
			load: () =>
				import("./index-Dw5Z4wVl.js").then((e) => e.sass({ indented: !0 })),
		}),
		zc.of({
			name: "SCSS",
			extensions: ["scss"],
			load: () => import("./index-Dw5Z4wVl.js").then((e) => e.sass()),
		}),
		...
		zc.of({
			name: "WebAssembly",
			extensions: ["wat", "wast"],
			load: () => import("./index-CZ_bFUAf.js").then((e) => e.wast()),
		}),
		zc.of({
			name: "XML",
			alias: ["rss", "wsdl", "xsd"],
			extensions: ["xml", "xsl", "xsd", "svg"],
			load: () => import("./index-Dl__6gbw.js").then((e) => e.xml()),
		}),
		zc.of({
			name: "YAML",
			alias: ["yml"],
			extensions: ["yaml", "yml"],
			load: () => import("./index-CuAQxja6.js").then((e) => e.yaml()),
		}),
		zc.of({
			name: "APL",
		...
		zc.of({
			name: "Vue",
			extensions: ["vue"],
			load: () => import("./index-Co0cAs8B.js").then((e) => e.vue()),
		}),
		zc.of({
			name: "Angular Template",
			load: () => import("./index-CR6t2ApP.js").then((e) => e.angular()),
		}),
	],
