...
function Ht(e = !1) {
	return function (t, n, i, r) {
		let s = t[n];
		if (!e && ((i = Tn(i)), (s = Tn(s)), !Qt(t) && Xn(s) && !Xn(i)))
			return (s.value = i), !0;
		const o = Qt(t) && _t(n) ? Number(n) < t.length : yt(t, n),
...
function on(e, t = !1) {
	return (
		(e = e.__v_raw), !t && Wt(Tn(e), "iterate", Rt), Reflect.get(e, "size", e)
	);
}
function an(e) {
	e = Tn(e);
...
function ln(e, t) {
	...
	const n = Tn(this),
		{ has: i, get: r } = nn(n);
	let s = i.call(n, e);
	s ? Qn(n, i, e) : ((e = Tn(e)), (s = i.call(n, e)));
	const o = r.call(n, e);
	return (
		n.set(e, t),
...
function hn(e) {
	const t = Tn(this),
		{ has: n, get: i } = nn(t);
	let r = n.call(t, e);
	r ? Qn(t, n, e) : ((e = Tn(e)), (r = n.call(t, e)));
...
var kn = new WeakMap(),
	...
	$n = new WeakMap();
function Pn(e) {
	return e && e.__v_isReadonly ? e : _n(e, !1, Ft, Sn, kn);
}
function Zn(e) {
	return _n(e, !0, Kt, yn, vn);
}
...
class Zi {
	...
	extend(e, t = e) {
		if (e <= this.anchor && t >= this.anchor) return _i.range(e, t);
		let n = Math.abs(e - this.anchor) > Math.abs(t - this.anchor) ? e : t;
		return _i.range(this.anchor, n);
	}
	eq(e, t = !1) {
		return !(
	...
	static fromJSON(e) {
		...
		return _i.range(e.anchor, e.head);
	}
	static create(e, t, n) {
		return new Zi(e, t, n);
	}
...
class _i {
	...
	asSingle() {
		return 1 == this.ranges.length ? this : new _i([this.main], 0);
	}
	addRange(e, t = !0) {
		return _i.create([e].concat(this.ranges), t ? 0 : this.mainIndex + 1);
	}
	replaceRange(e, t = this.mainIndex) {
		let n = this.ranges.slice();
		return (n[t] = e), _i.create(n, this.mainIndex);
	}
	toJSON() {
	...
	static create(e, t = 0) {
		...
		for (let n = 0, i = 0; i < e.length; i++) {
			...
			if (r.empty ? r.from <= n : r.from < n)
				return _i.normalized(e.slice(), t);
			n = r.to;
		}
		return new _i(e, t);
	}
	...
	static normalized(e, t = 0) {
		...
		for (let n = 1; n < e.length; n++) {
			...
			if (i.empty ? i.from <= r.to : i.from < r.to) {
				...
				n <= t && t--,
					e.splice(--n, 2, i.anchor > i.head ? _i.range(o, s) : _i.range(s, o));
			}
		}
		return new _i(e, t);
	}
...
function fr(e, t, n) {
	...
	return (
		t.userEvent && (r = r.concat(hr.userEvent.of(t.userEvent))),
		{
			...
			selection: i && (i instanceof _i ? i : _i.single(i.anchor, i.head)),
...
class Sr {
	...
	replaceSelection(e) {
		return (
			...
			this.changeByRange((t) => ({
				...
				range: _i.cursor(t.from + e.length),
			}))
		);
	}
	changeByRange(e) {
		...
		return { changes: i, selection: _i.create(r, t.mainIndex), effects: s };
	}
	changes(e = []) {
	...
	static fromJSON(e, t = {}, n) {
		...
		return Sr.create({
			doc: e.doc,
			selection: _i.fromJSON(e.selection),
	...
	static create(e = {}) {
		let t = Ni.resolve(e.extensions || [], new Map()),
			...
			i = e.selection
				? e.selection instanceof _i
					? e.selection
					: _i.single(e.selection.anchor, e.selection.head)
				: _i.single(0);
		return (
			Ti(i, n.length),
	...
	wordAt(e) {
		...
		return s == o ? null : _i.range(s + n, o + n);
	}
}
...
class _r {
	...
	static from(e, t = null, n = -1) {
		...
		return 1 == i.length ? i[0] : new _r(i);
	}
	get startSide() {
		return this.value ? this.value.startSide : 0;
	}
...
function Zo(e, t, n, i, r) {
	...
	return u && c == h && u.level + (r ? 0 : 1) < l.level
		? _i.cursor(u.side(!r, n) + e.from, u.forward(r, n) ? 1 : -1, u.level)
		: _i.cursor(c + e.from, l.forward(r, n) ? -1 : 1, l.level);
}
function _o(e, t, n) {
	for (let i = t; i < n; i++) {
...
function ya(e, t, n, i) {
	...
	if (s) {
		...
		if (null != o) return _i.cursor(o, n ? -1 : 1);
	}
	return _i.cursor(n ? r.to : r.from, n ? -1 : 1);
}
function Qa(e, t, n, i) {
...
function wa(e, t, n) {
	...
	return i == n.from ? n : _i.cursor(i, i < n.from ? 1 : -1);
}
const va = "￿";
class $a {
	constructor(e, t) {
		...
		if (e.state.readOnly && t > -1) this.newSel = null;
			...
			n.readRange(this.bounds.startDOM, this.bounds.endDOM),
				...
				(this.newSel = (function (e, t) {
					...
					return n > -1 && i > -1 ? _i.single(n + t, i + t) : null;
				})(t, this.bounds.from));
		} else {
	...
	if (
		(!n && t.typeOver && !r.empty && i && i.main.empty
			...
			: (js.mac || js.android) &&
				...
				? (i &&
						2 == n.insert.length &&
						(i = _i.single(i.main.anchor - 1, i.main.head - 1)),
					(n = {
						from: n.from,
						to: n.to,
				...
				: n &&
					...
					: js.chrome &&
						...
						"\n " == n.insert.toString() &&
						e.lineWrapping &&
						(i && (i = _i.single(i.main.anchor - 1, i.main.head - 1)),
				...
				if (
					...
					i = r.changeByRange((n) => {
						...
						return {
							changes: d,
							range: a
								? _i.range(Math.max(0, a.anchor + O), Math.max(0, a.head + O))
								: n.map(d),
						};
					});
	...
	skipAtoms(e) {
		...
		for (let n = 0; n < e.ranges.length; n++) {
			...
			if (i.empty) {
				...
				e != i.from && (r = _i.cursor(e, -1));
			} else {
				let e = ka(this.atoms, i.from, -1),
					t = ka(this.atoms, i.to, 1);
				(e == i.from && t == i.to) ||
					(r = _i.range(i.from == i.anchor ? e : t, i.from == i.head ? e : t));
			}
			r && (t || (t = e.ranges.slice()), (t[n] = r));
		}
		return t ? _i.create(t, e.mainIndex) : e;
	}
	select(e) {
		let { view: t } = this,
	...
	if (
		...
		n = i.changeByRange((n) => {
			...
			return {
				...
				range: _i.cursor(n.from + l.length),
			};
		});
	} else
		n = o
			? i.changeByRange((e) => {
					...
					return {
						...
						range: _i.cursor(e.from + t.length),
					};
				})
...
function Ba(e, t, n, i) {
	if (1 == i) return _i.cursor(t, n);
	if (2 == i)
		return (function (e, t, n = 1) {
			let i = e.charCategorizer(t),
				r = e.doc.lineAt(t),
				s = t - r.from;
			if (0 == r.length) return _i.cursor(t);
			...
			return _i.range(o + r.from, a + r.from);
		})(e.state, t, n);
	{
		let n = ro.find(e.docView, t),
			...
			s = n ? n.posAtEnd : i.to;
		return s < e.state.doc.length && s == i.to && s++, _i.range(r, s);
	}
}
(Wa.scroll = (e) => {
					...
					return {
						...
						get(t, s, o) {
							...
							if (n.pos != l.pos && !s) {
								...
								h = r < h.from ? _i.range(r, s) : _i.range(s, r);
							}
							return s
...
(La.dragstart = (e, t) => {
	...
	if (t.target.draggable) {
		...
		if (i && i.isWidget) {
			let e = i.posAtStart,
				t = e + i.length;
			(e >= n.to || t <= n.from) && (n = _i.range(e, t));
		}
	}
	let { inputState: i } = e;
	return (
			...
			a = (i, s, l, h) => {
				...
				if (!f) {
					if (
						...
						let e = t.moveToLineBoundary(_i.cursor(s), !1, !0).head;
						e > i && (s = e);
					}
...
function _l({ total: e, ranges: t }, n) {
...
class Gl {
		...
		try {
			...
			for (let t of e) {
				if ((c && (c = c.map(t.changes)), t.scrollIntoView)) {
					...
					c = new zo(
						e.empty ? e : _i.cursor(e.head, e.head > e.anchor ? -1 : 1),
					);
				}
		...
		(a || h) &&
			Promise.resolve().then(() => {
				a && this.state == a.startState && this.dispatch(a),
					h && !Ta(this, h) && l.force && ds(this.contentDOM, l.key, l.keyCode);
			});
	}
	setState(e) {
		if (0 != this.updateState)
	...
	visualLineSide(e, t) {
		let n = this.bidiSpans(e),
			...
			r = n[t ? n.length - 1 : 0];
		return _i.cursor(r.side(t, i) + e.from, r.forward(!t, i) ? 1 : -1);
	}
	...
	moveVertically(e, t, n) {
		return wa(
			...
			(function (e, t, n, i) {
				let r = t.head,
					s = n ? 1 : -1;
				if (r == (n ? e.state.doc.length : 0)) return _i.cursor(r, t.assoc);
				let o,
					a = t.goalColumn,
	...
	scrollSnapshot() {
		...
		return Yo.of(new zo(_i.cursor(n.from), "start", "start", n.top - e, t, !0));
	}
	setTabFocusMode(e) {
		null == e
		...
		return (function (e) {
			...
			function u(e, t, n, x, b, S) {
				...
				if (k - Q <= r && (Z = m(a.pos - t, b))) {
					...
					(P = new yh(t, k - Z.start, i)), (T = Z.start - e);
				} else {
					let e = a.pos - w;
					a.next();
					let t = [],
					...
					if (
						...
						let e = d(_, $);
						P = jh(_, t, n, 0, t.length, 0, k - Q, e, e);
					} else P = p(_, t, n, k - Q, v - k, $);
				}
				n.push(P), x.push(T);
			}
			function f(e, t, n, s) {
...
class Zc {
	...
	isActiveAt(e, t, n = -1) {
		return _c(e, t, n).type.prop(vc) == this.data;
	}
	findRegions(e) {
		let t = e.facet(Lc);
...
class gu extends Zc {
	constructor(e) {
		...
		super(
			...
			(this.tokenTable = e.tokenTable ? new Zu(i.tokenTable) : _u);
	}
	static define(e) {
		return new gu(e);
	}
		...
		for (let n of i.split(".")) {
			...
			i
				? "function" == typeof i
					? t.length
						? (t = t.map(i))
						: Tu(n, `Modifier ${n} used at start of tag`)
					: t.length
						? Tu(n, `Tag ${n} used as modifier`)
						: (t = Array.isArray(i) ? i : [i])
				: Tu(n, `Unknown highlighting tag ${n}`);
		}
...
class Fu {
	...
	static fromJSON(e) {
		return new Fu(
			...
			e.startSelection && _i.fromJSON(e.startSelection),
			e.selectionsAfter.map(_i.fromJSON),
		);
	}
...
function cf(e, t) {
	return _i.create(e.ranges.map(t), e.mainIndex);
}
function uf(e, t) {
...
function df(e, t) {
	return _i.cursor(t ? e.to : e.from);
}
function Of(e, t) {
...
function Zf(e, t, n) {
	...
	if (
		...
		n && t.head != i.from + n && (r = _i.cursor(i.from + n));
	}
	return r;
}
function _f(e, t) {
	let n = cf(e.state.selection, (e) => {
		let n = t(e);
		return _i.range(e.anchor, n.head, n.goalColumn, n.bidiLevel || void 0);
	});
	return !n.eq(e.state.selection) && (e.dispatch(uf(e.state, n)), !0);
}
function Tf(e, t) {
	return _f(e, (n) => e.moveByChar(n, t));
}
const Xf = (e) => Tf(e, !pf(e)),
	Af = (e) => Tf(e, pf(e));
function Cf(e, t) {
	return _f(e, (n) => e.moveByGroup(n, t));
}
function Rf(e, t) {
	return _f(e, (n) => e.moveVertically(n, t));
}
const Mf = (e) => Rf(e, !1),
	jf = (e) => Rf(e, !0);
function Ef(e, t) {
	return _f(e, (n) => e.moveVertically(n, t, wf(e).height));
}
const qf = (e) => Ef(e, !1),
	Vf = (e) => Ef(e, !0),
	...
	let n = "delete.selection",
		...
		r = i.changeByRange((i) => {
			...
			return r == s
				...
				: {
						changes: { from: r, to: s },
						range: _i.cursor(r, r < i.head ? -1 : 1),
					};
		});
	return (
		!r.changes.empty &&
...
function Kf(e, t, n) {
	...
	for (let t of Ff(e)) {
		...
		if (n) {
			...
			for (let e of t.ranges) r.push(_i.range(e.anchor - o, e.head - o));
		}
	}
	return (
		!!i.length &&
		(t(
			e.update({
				changes: i,
				scrollIntoView: !0,
				selection: _i.create(r, e.selection.mainIndex),
				userEvent: "move.line",
			}),
		),
		!0)
		...
		let i = t.changeByRange((n) => {
			...
			return (
				o && h.push(Ic(t, a.lineIndent(s.from, -1))),
				{
					...
					range: _i.cursor(i + 1 + h[1].length),
				}
			);
		});
...
function id(e, t) {
	...
	return e.changeByRange((i) => {
		...
		return {
			changes: r,
			range: _i.range(s.mapPos(i.anchor, 1), s.mapPos(i.head, 1)),
		};
	});
}
const rd = [
		...
		{
			key: "Ctrl-a",
			run: (e) => ff(e, (t) => _i.cursor(e.lineBlockAt(t.head).from, 1)),
			shift: (e) => _f(e, (t) => _i.cursor(e.lineBlockAt(t.head).from)),
		},
		{
			key: "Ctrl-e",
			run: (e) => ff(e, (t) => _i.cursor(e.lineBlockAt(t.head).to, -1)),
			shift: (e) => _f(e, (t) => _i.cursor(e.lineBlockAt(t.head).to)),
		},
		{ key: "Ctrl-d", run: Gf },
		{ key: "Ctrl-h", run: Uf },
		{
		...
		},
		{
			...
			run: ({ state: e, dispatch: t }) => {
				...
				return (
					n.ranges.length > 1
						? (i = _i.create([n.main]))
						: n.main.empty || (i = _i.create([_i.cursor(n.main.head)])),
					!!i && (t(uf(e, i)), !0)
				);
			},
		},
		{ key: "Mod-Enter", run: td },
		{
			...
			run: ({ state: e, dispatch: t }) => {
				let n = Ff(e).map(({ from: t, to: n }) =>
					_i.range(t, Math.min(n + 1, e.doc.length)),
				);
				return (
					t(e.update({ selection: _i.create(n), userEvent: "select" })), !0
				);
			},
		},
		{
...
function Qd(e, t) {
	return _i.create(
		e.filter((e) => e.field == t).map((e) => _i.range(e.from, e.to)),
	);
}
function kd(e) {
	let t = pd.parse(e);
	return (e, n, i, r) => {
		...
		if ((o.length && (l.selection = Qd(o, 0)), o.some((e) => e.field > 0))) {
			...
			void 0 === e.state.field(yd, !1) &&
				n.push(lr.appendConfig.of([yd, Pd, _d, fd]));
		}
...
const _d = Gl.domEventHandlers({
	...
	Td = new (class extends yr {})();
(Td.startSide = 1), (Td.endSide = -1);
class Xd {
...
function Md(e, t, n) {
	...
	let i = (e.type == Ad.OrderedList ? Bd : Dd)(n, t, !1);
	return (
		i > 0 &&
...
function Dd(e, t, n) {
	return (45 != e.next && 43 != e.next && 42 != e.next) ||
		...
		!(!n || Yd(t, Ad.BulletList) || e.skipSpace(e.pos + 2) < e.text.length)
		? -1
		: 1;
}
function Bd(e, t, n) {
	...
	advance(e) {
		for (;;) {
			...
			if (0 == this.stage) {
				...
				if (!this.nextStage(_O(e, qd(e, this.pos), this.start))) return -1;
			}
		}
	}
}
...
function ZO(e, t, n, i, r) {
	...
	if (
		...
		let n,
			i = e.skipSpace(r + 1),
			o = _O(s, i - e.offset, e.offset);
		o &&
			((i = e.skipSpace(o.to)),
			i != o.to &&
				((n = TO(s, i - e.offset, e.offset)), n && (i = e.skipSpace(n.to)))),
			41 == e.char(i) &&
...
function CO(e, t) {
	...
	for (let e of t) {
		...
		if (i < n.length && n[i].from < e.from) {
			let t = n[i];
			t instanceof gO &&
				(n[i] = new gO(t.type, t.from, t.to, CO(t.children, [e])));
		} else n.splice(i++, 0, e);
	}
	return n;
}
...
function Cg(e, t, n) {
	let i = n.tags[Xg(e, Ag(t))];
	return (null == i ? void 0 : i.children) || n.allTags;
}
function Rg(e, t) {
	let n = [];
	for (let i = Ag(t); i && !i.type.isTop; i = Ag(i.parent)) {
		let r = Xg(e, i);
	...
	let n = Xc(e),
		...
		s = e.changeByRange((t) => {
			...
			if (l.item && h) {
				...
				if (
					...
					return (
						...
						{ range: _i.cursor(e + n.length), changes: r }
					);
				}
				{
					let t = fx(a, e, o);
					return {
						range: _i.cursor(s + t.length + 1),
			...
			return (
				...
				{ range: _i.cursor(d + f.length + 1), changes: c }
			);
		});
						...
						if (
							...
							if (
								...
								return (
									i == t.from && (r = hx(r, e)),
									{
										range: _i.cursor(i + r.length),
										changes: { from: i, to: t.from + n.to, insert: r },
									}
								);
							}
							if (i < r)
								return { range: _i.cursor(i), changes: { from: i, to: r } };
						}
					}
				}
				return (i = { range: t });
...
function Qx(e) {
	return import("./chunks/index.D1e6qeoJ.js").then((t) =>
		t.sql({ dialect: t[e] }),
	);
}
const kx = [
		zc.of({
			name: "C",
			extensions: ["c", "h", "ino"],
			load: () => import("./chunks/index.3zen4qUs.js").then((e) => e.cpp()),
		}),
		zc.of({
			name: "C++",
			alias: ["cpp"],
		...
		zc.of({
			name: "Go",
			extensions: ["go"],
			load: () => import("./chunks/index.B7xcimxH.js").then((e) => e.go()),
		}),
		zc.of({
			name: "HTML",
			alias: ["xhtml"],
		...
		zc.of({
			name: "Java",
			extensions: ["java"],
			load: () => import("./chunks/index.bv2HqjBm.js").then((e) => e.java()),
		}),
		zc.of({
			name: "JavaScript",
		...
		zc.of({
			...
			alias: ["json5"],
			extensions: ["json", "map"],
			load: () => import("./chunks/index.BF3rOfOH.js").then((e) => e.json()),
		}),
		zc.of({
			name: "JSX",
			extensions: ["jsx"],
		...
		zc.of({
			name: "LESS",
			extensions: ["less"],
			load: () => import("./chunks/index.BwV3E_RA.js").then((e) => e.less()),
		}),
		zc.of({
			name: "Liquid",
			extensions: ["liquid"],
			load: () => import("./chunks/index.D2tNR7pS.js").then((e) => e.liquid()),
		}),
		...
		zc.of({
			...
			load: () => import("./chunks/index.28lHe5yL.js").then((e) => e.php()),
		}),
		...
		zc.of({
			...
			filename: /^(BUCK|BUILD)$/,
			load: () => import("./chunks/index.DaCMgIVQ.js").then((e) => e.python()),
		}),
		zc.of({
			name: "Rust",
			extensions: ["rs"],
			load: () => import("./chunks/index.BMRrOrMB.js").then((e) => e.rust()),
		}),
		zc.of({
			name: "Sass",
			extensions: ["sass"],
			load: () =>
				import("./chunks/index.BnhCNyly.js").then((e) =>
					e.sass({ indented: !0 }),
				),
		}),
		zc.of({
			name: "SCSS",
			extensions: ["scss"],
			load: () => import("./chunks/index.BnhCNyly.js").then((e) => e.sass()),
		}),
		...
		zc.of({
			name: "WebAssembly",
			extensions: ["wat", "wast"],
			load: () => import("./chunks/index.D9MZOvLy.js").then((e) => e.wast()),
		}),
		zc.of({
			name: "XML",
			alias: ["rss", "wsdl", "xsd"],
			extensions: ["xml", "xsl", "xsd", "svg"],
			load: () => import("./chunks/index.zyOERESR.js").then((e) => e.xml()),
		}),
		zc.of({
			name: "YAML",
			alias: ["yml"],
			extensions: ["yaml", "yml"],
			load: () => import("./chunks/index.BgLsgiyO.js").then((e) => e.yaml()),
		}),
		zc.of({
			name: "APL",
			extensions: ["dyalog", "apl"],
			load: () => import("./chunks/apl.CVGyXvpW.js").then((e) => yx(e.apl)),
		}),
		zc.of({
			name: "PGP",
			alias: ["asciiarmor"],
			...
			load: () =>
				import("./chunks/asciiarmor.4a6Itf0W.js").then((e) => yx(e.asciiArmor)),
		}),
		zc.of({
			name: "ASN.1",
			extensions: ["asn", "asn1"],
			load: () =>
				import("./chunks/asn1.CSGlY9U9.js").then((e) => yx(e.asn1({}))),
		}),
		zc.of({
			name: "Asterisk",
			filename: /^extensions\.conf$/i,
			load: () =>
				import("./chunks/asterisk.CVRM6Uan.js").then((e) => yx(e.asterisk)),
		}),
		zc.of({
			name: "Brainfuck",
			extensions: ["b", "bf"],
			load: () =>
				import("./chunks/brainfuck.CsT4k8ZU.js").then((e) => yx(e.brainfuck)),
		}),
		zc.of({
			name: "Cobol",
			extensions: ["cob", "cpy"],
			load: () => import("./chunks/cobol.BjFMl1J_.js").then((e) => yx(e.cobol)),
		}),
		zc.of({
			name: "C#",
			alias: ["csharp", "cs"],
			extensions: ["cs"],
			load: () =>
				import("./chunks/clike.BFAmk9k9.js").then((e) => yx(e.csharp)),
		}),
		zc.of({
			name: "Clojure",
			extensions: ["clj", "cljc", "cljx"],
			load: () =>
				import("./chunks/clojure.BaLW3zy_.js").then((e) => yx(e.clojure)),
		}),
		zc.of({
			name: "ClojureScript",
			extensions: ["cljs"],
		...
		zc.of({
			...
			extensions: ["gss"],
			load: () => import("./chunks/css.DIkwKQj-.js").then((e) => yx(e.gss)),
		}),
		zc.of({
			name: "CMake",
			extensions: ["cmake", "cmake.in"],
			filename: /^CMakeLists\.txt$/,
			load: () => import("./chunks/cmake.-NI8ioKx.js").then((e) => yx(e.cmake)),
		}),
		zc.of({
			name: "CoffeeScript",
			...
			extensions: ["coffee"],
			load: () =>
				import("./chunks/coffeescript.C_6FJjbZ.js").then((e) =>
					yx(e.coffeeScript),
				),
		}),
		zc.of({
			...
			load: () =>
				import("./chunks/commonlisp.DiyoMRNN.js").then((e) => yx(e.commonLisp)),
		}),
		zc.of({
			name: "Cypher",
			extensions: ["cyp", "cypher"],
			load: () =>
				import("./chunks/cypher.BHQTmWDd.js").then((e) => yx(e.cypher)),
		}),
		zc.of({
			name: "Cython",
			extensions: ["pyx", "pxd", "pxi"],
			load: () =>
				import("./chunks/python.CkVZVfcm.js").then((e) => yx(e.cython)),
		}),
		zc.of({
			name: "Crystal",
			extensions: ["cr"],
			load: () =>
				import("./chunks/crystal.BrWZxs1A.js").then((e) => yx(e.crystal)),
		}),
		zc.of({
			name: "D",
			extensions: ["d"],
			load: () => import("./chunks/d.CcnBisTF.js").then((e) => yx(e.d)),
		}),
		zc.of({
			name: "Dart",
			extensions: ["dart"],
			load: () => import("./chunks/clike.BFAmk9k9.js").then((e) => yx(e.dart)),
		}),
		zc.of({
			name: "diff",
			extensions: ["diff", "patch"],
			load: () => import("./chunks/diff.BdEq39lK.js").then((e) => yx(e.diff)),
		}),
		zc.of({
			name: "Dockerfile",
			filename: /^Dockerfile$/,
			load: () =>
				import("./chunks/dockerfile.CtbD2tnN.js").then((e) => yx(e.dockerFile)),
		}),
		zc.of({
			name: "DTD",
			extensions: ["dtd"],
			load: () => import("./chunks/dtd.AbSeXNco.js").then((e) => yx(e.dtd)),
		}),
		zc.of({
			name: "Dylan",
			extensions: ["dylan", "dyl", "intr"],
			load: () => import("./chunks/dylan.BSqs3dT7.js").then((e) => yx(e.dylan)),
		}),
		zc.of({
			name: "EBNF",
			load: () => import("./chunks/ebnf.ClTdX3yV.js").then((e) => yx(e.ebnf)),
		}),
		zc.of({
			name: "ECL",
			extensions: ["ecl"],
			load: () => import("./chunks/ecl.BSYFEDpJ.js").then((e) => yx(e.ecl)),
		}),
		zc.of({
			name: "edn",
			extensions: ["edn"],
		...
		zc.of({
			...
			extensions: ["e"],
			load: () =>
				import("./chunks/eiffel.DKOZiPuZ.js").then((e) => yx(e.eiffel)),
		}),
		zc.of({
			name: "Elm",
			extensions: ["elm"],
			load: () => import("./chunks/elm.CjA8dcvR.js").then((e) => yx(e.elm)),
		}),
		zc.of({
			name: "Erlang",
			extensions: ["erl"],
			load: () =>
				import("./chunks/erlang.DvBECbvb.js").then((e) => yx(e.erlang)),
		}),
		zc.of({
			name: "Esper",
			load: () => import("./chunks/sql.B-6udf5S.js").then((e) => yx(e.esper)),
		}),
		zc.of({
			name: "Factor",
			extensions: ["factor"],
			load: () =>
				import("./chunks/factor.DGVcujuH.js").then((e) => yx(e.factor)),
		}),
		zc.of({
			name: "FCL",
			load: () => import("./chunks/fcl.Da1S6GpR.js").then((e) => yx(e.fcl)),
		}),
		zc.of({
			name: "Forth",
			extensions: ["forth", "fth", "4th"],
			load: () => import("./chunks/forth.o3O6UTxK.js").then((e) => yx(e.forth)),
		}),
		zc.of({
			name: "Fortran",
			extensions: ["f", "for", "f77", "f90", "f95"],
			load: () =>
				import("./chunks/fortran.CeASbp7j.js").then((e) => yx(e.fortran)),
		}),
		zc.of({
			name: "F#",
			alias: ["fsharp"],
			extensions: ["fs"],
			load: () =>
				import("./chunks/mllike.BEp3lFFC.js").then((e) => yx(e.fSharp)),
		}),
		zc.of({
			name: "Gas",
			extensions: ["s"],
			load: () => import("./chunks/gas.D78nNu17.js").then((e) => yx(e.gas)),
		}),
		zc.of({
			name: "Gherkin",
			extensions: ["feature"],
			load: () =>
				import("./chunks/gherkin.BWx9Bu3F.js").then((e) => yx(e.gherkin)),
		}),
		zc.of({
			name: "Groovy",
			...
			load: () =>
				import("./chunks/groovy.y_fzmijC.js").then((e) => yx(e.groovy)),
		}),
		zc.of({
			name: "Haskell",
			extensions: ["hs"],
			load: () =>
				import("./chunks/haskell.3AyGDIUM.js").then((e) => yx(e.haskell)),
		}),
		zc.of({
			name: "Haxe",
			extensions: ["hx"],
			load: () => import("./chunks/haxe.BUm-qmxx.js").then((e) => yx(e.haxe)),
		}),
		zc.of({
			name: "HXML",
			extensions: ["hxml"],
			load: () => import("./chunks/haxe.BUm-qmxx.js").then((e) => yx(e.hxml)),
		}),
		zc.of({
			name: "HTTP",
			load: () => import("./chunks/http.C3RvNBRg.js").then((e) => yx(e.http)),
		}),
		zc.of({
			name: "IDL",
			extensions: ["pro"],
			load: () => import("./chunks/idl.uBKihfgJ.js").then((e) => yx(e.idl)),
		}),
		zc.of({
			name: "JSON-LD",
			alias: ["jsonld"],
			extensions: ["jsonld"],
			load: () =>
				import("./chunks/javascript.BV3Jxeon.js").then((e) => yx(e.jsonld)),
		}),
		zc.of({
			name: "Jinja2",
			extensions: ["j2", "jinja", "jinja2"],
			load: () =>
				import("./chunks/jinja2.C8evKYGX.js").then((e) => yx(e.jinja2)),
		}),
		zc.of({
			name: "Julia",
			extensions: ["jl"],
			load: () => import("./chunks/julia.B-eb3Kvw.js").then((e) => yx(e.julia)),
		}),
		zc.of({
			name: "Kotlin",
			extensions: ["kt", "kts"],
			load: () =>
				import("./chunks/clike.BFAmk9k9.js").then((e) => yx(e.kotlin)),
		}),
		zc.of({
			name: "LiveScript",
			alias: ["ls"],
			extensions: ["ls"],
			load: () =>
				import("./chunks/livescript.B68ZtWi-.js").then((e) => yx(e.liveScript)),
		}),
		zc.of({
			name: "Lua",
			extensions: ["lua"],
			load: () => import("./chunks/lua._m3LKqq3.js").then((e) => yx(e.lua)),
		}),
		zc.of({
			name: "mIRC",
			extensions: ["mrc"],
			load: () => import("./chunks/mirc.Cxu-wlOm.js").then((e) => yx(e.mirc)),
		}),
		zc.of({
			name: "Mathematica",
			extensions: ["m", "nb", "wl", "wls"],
			load: () =>
				import("./chunks/mathematica.tcZzVIuZ.js").then((e) =>
					yx(e.mathematica),
				),
		}),
		zc.of({
			...
			extensions: ["mo"],
			load: () =>
				import("./chunks/modelica.CU-WNL2_.js").then((e) => yx(e.modelica)),
		}),
		zc.of({
			name: "MUMPS",
			extensions: ["mps"],
			load: () => import("./chunks/mumps.iGhzlkAm.js").then((e) => yx(e.mumps)),
		}),
		zc.of({
			name: "Mbox",
			extensions: ["mbox"],
			load: () => import("./chunks/mbox.Dd0n2Qma.js").then((e) => yx(e.mbox)),
		}),
		zc.of({
			name: "Nginx",
			filename: /nginx.*\.conf$/i,
			load: () => import("./chunks/nginx.D-qTTk-Q.js").then((e) => yx(e.nginx)),
		}),
		zc.of({
			name: "NSIS",
			extensions: ["nsh", "nsi"],
			load: () => import("./chunks/nsis.B20Fp6MG.js").then((e) => yx(e.nsis)),
		}),
		zc.of({
			name: "NTriples",
			extensions: ["nt", "nq"],
			load: () =>
				import("./chunks/ntriples.DSgSuH6p.js").then((e) => yx(e.ntriples)),
		}),
		zc.of({
			name: "Objective-C",
			...
			extensions: ["m"],
			load: () =>
				import("./chunks/clike.BFAmk9k9.js").then((e) => yx(e.objectiveC)),
		}),
		zc.of({
			name: "Objective-C++",
			alias: ["objective-c++", "objc++"],
			extensions: ["mm"],
			load: () =>
				import("./chunks/clike.BFAmk9k9.js").then((e) => yx(e.objectiveCpp)),
		}),
		zc.of({
			name: "OCaml",
			extensions: ["ml", "mli", "mll", "mly"],
			load: () =>
				import("./chunks/mllike.BEp3lFFC.js").then((e) => yx(e.oCaml)),
		}),
		zc.of({
			name: "Octave",
			extensions: ["m"],
			load: () =>
				import("./chunks/octave.Tzgi-fZa.js").then((e) => yx(e.octave)),
		}),
		zc.of({
			name: "Oz",
			extensions: ["oz"],
			load: () => import("./chunks/oz.Cigl7mbm.js").then((e) => yx(e.oz)),
		}),
		zc.of({
			name: "Pascal",
			extensions: ["p", "pas"],
			load: () =>
				import("./chunks/pascal.Co98ByvO.js").then((e) => yx(e.pascal)),
		}),
		zc.of({
			name: "Perl",
			extensions: ["pl", "pm"],
			load: () => import("./chunks/perl.BUYnZlex.js").then((e) => yx(e.perl)),
		}),
		zc.of({
			name: "Pig",
			extensions: ["pig"],
			load: () => import("./chunks/pig.BlGBCkr5.js").then((e) => yx(e.pig)),
		}),
		zc.of({
			name: "PowerShell",
			extensions: ["ps1", "psd1", "psm1"],
			load: () =>
				import("./chunks/powershell.BeuhDvJv.js").then((e) => yx(e.powerShell)),
		}),
		zc.of({
			...
			load: () =>
				import("./chunks/properties.CFu-qS5I.js").then((e) => yx(e.properties)),
		}),
		zc.of({
			name: "ProtoBuf",
			extensions: ["proto"],
			load: () =>
				import("./chunks/protobuf.cHTHut9l.js").then((e) => yx(e.protobuf)),
		}),
		zc.of({
			name: "Pug",
			alias: ["jade"],
			extensions: ["pug", "jade"],
			load: () => import("./chunks/pug.D6TYStf-.js").then((e) => yx(e.pug)),
		}),
		zc.of({
			name: "Puppet",
			extensions: ["pp"],
			load: () =>
				import("./chunks/puppet.p8Q1SeDj.js").then((e) => yx(e.puppet)),
		}),
		zc.of({
			name: "Q",
			extensions: ["q"],
			load: () => import("./chunks/q.BLAXse1i.js").then((e) => yx(e.q)),
		}),
		zc.of({
			name: "R",
			alias: ["rscript"],
			extensions: ["r", "R"],
			load: () => import("./chunks/r.BCdZ_m1g.js").then((e) => yx(e.r)),
		}),
		zc.of({
			name: "RPM Changes",
			load: () =>
				import("./chunks/rpm.0nNNCQE4.js").then((e) => yx(e.rpmChanges)),
		}),
		zc.of({
			name: "RPM Spec",
			extensions: ["spec"],
			load: () => import("./chunks/rpm.0nNNCQE4.js").then((e) => yx(e.rpmSpec)),
		}),
		zc.of({
			name: "Ruby",
			...
			load: () => import("./chunks/ruby.DsVBEDoa.js").then((e) => yx(e.ruby)),
		}),
		zc.of({
			name: "SAS",
			extensions: ["sas"],
			load: () => import("./chunks/sas.1HDIzLnO.js").then((e) => yx(e.sas)),
		}),
		zc.of({
			name: "Scala",
			extensions: ["scala"],
			load: () => import("./chunks/clike.BFAmk9k9.js").then((e) => yx(e.scala)),
		}),
		zc.of({
			name: "Scheme",
			extensions: ["scm", "ss"],
			load: () =>
				import("./chunks/scheme.DK9SlL4G.js").then((e) => yx(e.scheme)),
		}),
		zc.of({
			name: "Shell",
			alias: ["bash", "sh", "zsh"],
			...
			filename: /^PKGBUILD$/,
			load: () => import("./chunks/shell.Dud7T5A8.js").then((e) => yx(e.shell)),
		}),
		zc.of({
			name: "Sieve",
			extensions: ["siv", "sieve"],
			load: () => import("./chunks/sieve.BROZiUuN.js").then((e) => yx(e.sieve)),
		}),
		zc.of({
			name: "Smalltalk",
			extensions: ["st"],
			load: () =>
				import("./chunks/smalltalk.CeU3h3fS.js").then((e) => yx(e.smalltalk)),
		}),
		zc.of({
			name: "Solr",
			load: () => import("./chunks/solr.BnzS9UdH.js").then((e) => yx(e.solr)),
		}),
		zc.of({
			name: "SML",
			extensions: ["sml", "sig", "fun", "smackspec"],
			load: () => import("./chunks/mllike.BEp3lFFC.js").then((e) => yx(e.sml)),
		}),
		zc.of({
			name: "SPARQL",
			alias: ["sparul"],
			...
			load: () =>
				import("./chunks/sparql.CABTWfhA.js").then((e) => yx(e.sparql)),
		}),
		zc.of({
			name: "Spreadsheet",
			alias: ["excel", "formula"],
			load: () =>
				import("./chunks/spreadsheet.kDZB-uf9.js").then((e) =>
					yx(e.spreadsheet),
				),
		}),
		zc.of({
			...
			extensions: ["nut"],
			load: () =>
				import("./chunks/clike.BFAmk9k9.js").then((e) => yx(e.squirrel)),
		}),
		zc.of({
			name: "Stylus",
			extensions: ["styl"],
			load: () =>
				import("./chunks/stylus.BFKJkOir.js").then((e) => yx(e.stylus)),
		}),
		zc.of({
			name: "Swift",
			extensions: ["swift"],
			load: () => import("./chunks/swift.BbwWtjOZ.js").then((e) => yx(e.swift)),
		}),
		zc.of({
			name: "sTeX",
			load: () => import("./chunks/stex.Pb0ny7B0.js").then((e) => yx(e.stex)),
		}),
		zc.of({
			name: "LaTeX",
			alias: ["tex"],
		...
		zc.of({
			...
			extensions: ["v", "sv", "svh"],
			load: () =>
				import("./chunks/verilog.BMl2lkNU.js").then((e) => yx(e.verilog)),
		}),
		zc.of({
			name: "Tcl",
			extensions: ["tcl"],
			load: () => import("./chunks/tcl.CpEoxIJC.js").then((e) => yx(e.tcl)),
		}),
		zc.of({
			name: "Textile",
			extensions: ["textile"],
			load: () =>
				import("./chunks/textile.DlyIUycb.js").then((e) => yx(e.textile)),
		}),
		zc.of({
			name: "TiddlyWiki",
			load: () =>
				import("./chunks/tiddlywiki.C0DmOYHT.js").then((e) => yx(e.tiddlyWiki)),
		}),
		zc.of({
			name: "Tiki wiki",
			load: () => import("./chunks/tiki.Dh5SkdNt.js").then((e) => yx(e.tiki)),
		}),
		zc.of({
			name: "TOML",
			extensions: ["toml"],
			load: () => import("./chunks/toml.CEdfpJsm.js").then((e) => yx(e.toml)),
		}),
		zc.of({
			name: "Troff",
			extensions: ["1", "2", "3", "4", "5", "6", "7", "8", "9"],
			load: () => import("./chunks/troff.B5hs3wo9.js").then((e) => yx(e.troff)),
		}),
		zc.of({
			name: "TTCN",
			extensions: ["ttcn", "ttcn3", "ttcnpp"],
			load: () => import("./chunks/ttcn.BCYPC6pN.js").then((e) => yx(e.ttcn)),
		}),
		zc.of({
			name: "TTCN_CFG",
			extensions: ["cfg"],
			load: () =>
				import("./chunks/ttcn-cfg.D8D2sfWu.js").then((e) => yx(e.ttcnCfg)),
		}),
		zc.of({
			name: "Turtle",
			extensions: ["ttl"],
			load: () =>
				import("./chunks/turtle.ObAFaJOI.js").then((e) => yx(e.turtle)),
		}),
		zc.of({
			name: "Web IDL",
			extensions: ["webidl"],
			load: () =>
				import("./chunks/webidl.eM93rtqX.js").then((e) => yx(e.webIDL)),
		}),
		zc.of({
			name: "VB.NET",
			extensions: ["vb"],
			load: () => import("./chunks/vb.BPtc2fMC.js").then((e) => yx(e.vb)),
		}),
		zc.of({
			name: "VBScript",
			extensions: ["vbs"],
			load: () =>
				import("./chunks/vbscript.BIMcNkvr.js").then((e) => yx(e.vbScript)),
		}),
		zc.of({
			name: "Velocity",
			extensions: ["vtl"],
			load: () =>
				import("./chunks/velocity.fy2NwKRk.js").then((e) => yx(e.velocity)),
		}),
		zc.of({
			name: "Verilog",
			extensions: ["v"],
		...
		zc.of({
			name: "VHDL",
			extensions: ["vhd", "vhdl"],
			load: () => import("./chunks/vhdl.HrsxZ_-P.js").then((e) => yx(e.vhdl)),
		}),
		zc.of({
			name: "XQuery",
			extensions: ["xy", "xquery"],
			load: () =>
				import("./chunks/xquery.BX8zlwTo.js").then((e) => yx(e.xQuery)),
		}),
		zc.of({
			name: "Yacas",
			extensions: ["ys"],
			load: () => import("./chunks/yacas.CpS7HSpC.js").then((e) => yx(e.yacas)),
		}),
		zc.of({
			name: "Z80",
			extensions: ["z80"],
			load: () => import("./chunks/z80.CT1yOPUm.js").then((e) => yx(e.z80)),
		}),
		zc.of({
			name: "MscGen",
			extensions: ["mscgen", "mscin", "msc"],
			load: () =>
				import("./chunks/mscgen.Cz7-nse4.js").then((e) => yx(e.mscgen)),
		}),
		zc.of({
			name: "Xù",
			extensions: ["xu"],
			load: () => import("./chunks/mscgen.Cz7-nse4.js").then((e) => yx(e.xu)),
		}),
		zc.of({
			name: "MsGenny",
			extensions: ["msgenny"],
			load: () =>
				import("./chunks/mscgen.Cz7-nse4.js").then((e) => yx(e.msgenny)),
		}),
		zc.of({
			name: "Vue",
			extensions: ["vue"],
			load: () => import("./chunks/index.DPWeiXSw.js").then((e) => e.vue()),
		}),
		zc.of({
			name: "Angular Template",
			load: () => import("./chunks/index.CK7dYH1k.js").then((e) => e.angular()),
		}),
	],
	...
	Ex = Gl.theme(
		{
			...
			[kc.url]: { color: Rx },
			[kc.quote]: { color: _x, fontStyle: "italic" },
			[kc.keyword]: { color: Tx },
			[kc.comment]: { color: _x, fontStyle: "italic" },
			[kc.string]: { color: Xx },
			[kc.number]: { color: Ax },
...
function Lx(e, t, n, i, r = t.length) {
	...
	return {
		...
		selection: _i.range(s.from + t.length, s.to + t.length),
	};
}
function Wx(e, t, n = !1) {
	const i = [];
...
function zx(e, t, n = "", i = "", r = !1) {
	...
	e.dispatch({
		...
		selection:
			a.empty && !r
				? _i.cursor(a.from + l.length)
				: a.empty && r
					? _i.cursor(startLine.from + l.length + 1 + i.length + 1)
					: void 0,
			...
			null !== i && i !== e
				...
				this.$nextTick(() => {
					if (
						...
						console.error(
							"[EditorComponent/$nextTick] CRITICAL: Editor target element (x-ref='editorElement') still not found in $refs after $nextTick. Cannot initialize CodeMirror.",
						);
				}),
				setInterval(() => {
						...
						!(function (e) {
							...
							if (n.empty) {
								...
								i = {
									...
									selection: _i.cursor(n.from + e.length + 3),
								};
							}
