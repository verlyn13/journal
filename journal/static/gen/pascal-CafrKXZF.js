...
function n(n, o) {
	var l,
		s = n.next();
	if ("#" == s && o.startOfLine) return n.skipToEnd(), "meta";
	if ('"' == s || "'" == s)
		return (
			(o.tokenize =
				((l = s),
	...
	if ("(" == s && n.eat("*")) return (o.tokenize = a), a(n, o);
	if ("{" == s) return (o.tokenize = i), i(n, o);
	if (/[\[\]\(\),;\:\.]/.test(s)) return null;
	if (/\d/.test(s)) return n.eatWhile(/[\w\.]/), "number";
	if ("/" == s && n.eat("/")) return n.skipToEnd(), "comment";
	if (r.test(s)) return n.eatWhile(r), "operator";
	n.eatWhile(/[\w\$_]/);
	var u = n.current().toLowerCase();
	return e.propertyIsEnumerable(u)
		? "keyword"
		: t.propertyIsEnumerable(u)
			? "atom"
			: "variable";
}
function a(e, t) {
