...
function yx(e) {
	return import("./index-CAHdWlMl.js").then((t) => t.sql({ dialect: t[e] }));
}
const Qx = [
		zc.of({
			name: "C",
			extensions: ["c", "h", "ino"],
			load: () => import("./index-D1HJWTa5.js").then((e) => e.cpp()),
		}),
		zc.of({
			name: "C++",
			alias: ["cpp"],
		...
		zc.of({
			name: "Go",
			extensions: ["go"],
			load: () => import("./index-DLvTzXyn.js").then((e) => e.go()),
		}),
		zc.of({
			name: "HTML",
			alias: ["xhtml"],
		...
		zc.of({
			name: "Java",
			extensions: ["java"],
			load: () => import("./index-Bvzfblfo.js").then((e) => e.java()),
		}),
		zc.of({
			name: "JavaScript",
		...
		zc.of({
			...
			alias: ["json5"],
			extensions: ["json", "map"],
			load: () => import("./index-BgHXCFwe.js").then((e) => e.json()),
		}),
		zc.of({
			name: "JSX",
			extensions: ["jsx"],
		...
		zc.of({
			name: "LESS",
			extensions: ["less"],
			load: () => import("./index-kPRXh8Lj.js").then((e) => e.less()),
		}),
		zc.of({
			name: "Liquid",
			extensions: ["liquid"],
			load: () => import("./index-PO2QC2sI.js").then((e) => e.liquid()),
		}),
		...
		zc.of({
			...
			load: () => import("./index-Dp9KOISb.js").then((e) => e.php()),
		}),
		...
		zc.of({
			...
			filename: /^(BUCK|BUILD)$/,
			load: () => import("./index-Bfy-Y24r.js").then((e) => e.python()),
		}),
		zc.of({
			name: "Rust",
			extensions: ["rs"],
			load: () => import("./index-BdsgSitE.js").then((e) => e.rust()),
		}),
		zc.of({
			name: "Sass",
			extensions: ["sass"],
			load: () =>
				import("./index-BAmuHUBB.js").then((e) => e.sass({ indented: !0 })),
		}),
		zc.of({
			name: "SCSS",
			extensions: ["scss"],
			load: () => import("./index-BAmuHUBB.js").then((e) => e.sass()),
		}),
		...
		zc.of({
			name: "WebAssembly",
			extensions: ["wat", "wast"],
			load: () => import("./index-DOIG2x9V.js").then((e) => e.wast()),
		}),
		zc.of({
			name: "XML",
			alias: ["rss", "wsdl", "xsd"],
			extensions: ["xml", "xsl", "xsd", "svg"],
			load: () => import("./index-DdQ3bpF5.js").then((e) => e.xml()),
		}),
		zc.of({
			name: "YAML",
			alias: ["yml"],
			extensions: ["yaml", "yml"],
			load: () => import("./index-2iHM1AWW.js").then((e) => e.yaml()),
		}),
		zc.of({
			name: "APL",
		...
		zc.of({
			name: "Vue",
			extensions: ["vue"],
			load: () => import("./index-DeCZwC-j.js").then((e) => e.vue()),
		}),
		zc.of({
			name: "Angular Template",
			load: () => import("./index-BRQNzXfP.js").then((e) => e.angular()),
		}),
	],
...
function Yx(e = null) {
	return {
		...
		init() {
			...
			let e = "";
			const t = `initial-content-${this.entryId || "new"}`,
				i = document.getElementById(t);
			if (i)
				try {
					(e = JSON.parse(i.textContent)),
						console.log("Initial content length from script tag:", e.length);
				} catch (i) {
			...
			null !== n && n !== e
				? (console.log("Applying saved draft."), (this.content = n))
				: (this.content = e),
				...
				this.$nextTick(() => {
					if (
						...
						try {
							...
							})(this.$refs.editorElement, this.content, (e) => {
