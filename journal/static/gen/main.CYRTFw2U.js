...
function Qx(e) {
	return import("./chunks/index.C_njkRfd.js").then((t) =>
		t.sql({ dialect: t[e] }),
	);
}
const kx = [
		zc.of({
			name: "C",
			extensions: ["c", "h", "ino"],
			load: () => import("./chunks/index.BBoW90k3.js").then((e) => e.cpp()),
		}),
		zc.of({
			name: "C++",
			alias: ["cpp"],
		...
		zc.of({
			name: "Go",
			extensions: ["go"],
			load: () => import("./chunks/index.DDCEiiLY.js").then((e) => e.go()),
		}),
		zc.of({
			name: "HTML",
			alias: ["xhtml"],
		...
		zc.of({
			name: "Java",
			extensions: ["java"],
			load: () => import("./chunks/index.D0_F02oy.js").then((e) => e.java()),
		}),
		zc.of({
			name: "JavaScript",
		...
		zc.of({
			...
			alias: ["json5"],
			extensions: ["json", "map"],
			load: () => import("./chunks/index.BAYDwUN-.js").then((e) => e.json()),
		}),
		zc.of({
			name: "JSX",
			extensions: ["jsx"],
		...
		zc.of({
			name: "LESS",
			extensions: ["less"],
			load: () => import("./chunks/index.Dmr1ilEl.js").then((e) => e.less()),
		}),
		zc.of({
			name: "Liquid",
			extensions: ["liquid"],
			load: () => import("./chunks/index.lsovNlou.js").then((e) => e.liquid()),
		}),
		...
		zc.of({
			...
			load: () => import("./chunks/index.CfZ-xlFv.js").then((e) => e.php()),
		}),
		...
		zc.of({
			...
			filename: /^(BUCK|BUILD)$/,
			load: () => import("./chunks/index.ZrQxV1n8.js").then((e) => e.python()),
		}),
		zc.of({
			name: "Rust",
			extensions: ["rs"],
			load: () => import("./chunks/index.UVk4xnAv.js").then((e) => e.rust()),
		}),
		zc.of({
			name: "Sass",
			extensions: ["sass"],
			load: () =>
				import("./chunks/index.CkLnrtjv.js").then((e) =>
					e.sass({ indented: !0 }),
				),
		}),
		zc.of({
			name: "SCSS",
			extensions: ["scss"],
			load: () => import("./chunks/index.CkLnrtjv.js").then((e) => e.sass()),
		}),
		...
		zc.of({
			name: "WebAssembly",
			extensions: ["wat", "wast"],
			load: () => import("./chunks/index.gcwHAH-W.js").then((e) => e.wast()),
		}),
		zc.of({
			name: "XML",
			alias: ["rss", "wsdl", "xsd"],
			extensions: ["xml", "xsl", "xsd", "svg"],
			load: () => import("./chunks/index.BwFYANOn.js").then((e) => e.xml()),
		}),
		zc.of({
			name: "YAML",
			alias: ["yml"],
			extensions: ["yaml", "yml"],
			load: () => import("./chunks/index.BjUsFqUt.js").then((e) => e.yaml()),
		}),
		zc.of({
			name: "APL",
			extensions: ["dyalog", "apl"],
			load: () => import("./chunks/apl.Alt_qSKs.js").then((e) => yx(e.apl)),
		}),
		zc.of({
			name: "PGP",
			alias: ["asciiarmor"],
			...
			load: () =>
				import("./chunks/asciiarmor.DvqkNPYV.js").then((e) => yx(e.asciiArmor)),
		}),
		zc.of({
			name: "ASN.1",
			extensions: ["asn", "asn1"],
			load: () =>
				import("./chunks/asn1.CyDNmWMj.js").then((e) => yx(e.asn1({}))),
		}),
		zc.of({
			name: "Asterisk",
			filename: /^extensions\.conf$/i,
			load: () =>
				import("./chunks/asterisk.BrcnAWsU.js").then((e) => yx(e.asterisk)),
		}),
		zc.of({
			name: "Brainfuck",
			extensions: ["b", "bf"],
			load: () =>
				import("./chunks/brainfuck.Bu7bVJph.js").then((e) => yx(e.brainfuck)),
		}),
		zc.of({
			name: "Cobol",
			extensions: ["cob", "cpy"],
			load: () => import("./chunks/cobol.DZwxZI4l.js").then((e) => yx(e.cobol)),
		}),
		zc.of({
			name: "C#",
			alias: ["csharp", "cs"],
			extensions: ["cs"],
			load: () =>
				import("./chunks/clike.Z6adwjbt.js").then((e) => yx(e.csharp)),
		}),
		zc.of({
			name: "Clojure",
			extensions: ["clj", "cljc", "cljx"],
			load: () =>
				import("./chunks/clojure.Duw5IjLs.js").then((e) => yx(e.clojure)),
		}),
		zc.of({
			name: "ClojureScript",
			extensions: ["cljs"],
		...
		zc.of({
			...
			extensions: ["gss"],
			load: () => import("./chunks/css.C6zgyGds.js").then((e) => yx(e.gss)),
		}),
		zc.of({
			name: "CMake",
			extensions: ["cmake", "cmake.in"],
			filename: /^CMakeLists\.txt$/,
			load: () => import("./chunks/cmake.8955puMm.js").then((e) => yx(e.cmake)),
		}),
		zc.of({
			name: "CoffeeScript",
			...
			extensions: ["coffee"],
			load: () =>
				import("./chunks/coffeescript.CyNE6uW0.js").then((e) =>
					yx(e.coffeeScript),
				),
		}),
		zc.of({
			...
			load: () =>
				import("./chunks/commonlisp.DfIpvJMf.js").then((e) => yx(e.commonLisp)),
		}),
		zc.of({
			name: "Cypher",
			extensions: ["cyp", "cypher"],
			load: () =>
				import("./chunks/cypher.Cn3MkU_u.js").then((e) => yx(e.cypher)),
		}),
		zc.of({
			name: "Cython",
			extensions: ["pyx", "pxd", "pxi"],
			load: () =>
				import("./chunks/python.CUdqr0lR.js").then((e) => yx(e.cython)),
		}),
		zc.of({
			name: "Crystal",
			extensions: ["cr"],
			load: () =>
				import("./chunks/crystal.jZAxhkJg.js").then((e) => yx(e.crystal)),
		}),
		zc.of({
			name: "D",
			extensions: ["d"],
			load: () => import("./chunks/d.C9QCkKmz.js").then((e) => yx(e.d)),
		}),
		zc.of({
			name: "Dart",
			extensions: ["dart"],
			load: () => import("./chunks/clike.Z6adwjbt.js").then((e) => yx(e.dart)),
		}),
		zc.of({
			name: "diff",
			extensions: ["diff", "patch"],
			load: () => import("./chunks/diff.Cwmny6Hs.js").then((e) => yx(e.diff)),
		}),
		zc.of({
			name: "Dockerfile",
			filename: /^Dockerfile$/,
			load: () =>
				import("./chunks/dockerfile.CIX66pgM.js").then((e) => yx(e.dockerFile)),
		}),
		zc.of({
			name: "DTD",
			extensions: ["dtd"],
			load: () => import("./chunks/dtd.DHmvJMBp.js").then((e) => yx(e.dtd)),
		}),
		zc.of({
			name: "Dylan",
			extensions: ["dylan", "dyl", "intr"],
			load: () => import("./chunks/dylan.DThigoWU.js").then((e) => yx(e.dylan)),
		}),
		zc.of({
			name: "EBNF",
			load: () => import("./chunks/ebnf.BPl1i1mV.js").then((e) => yx(e.ebnf)),
		}),
		zc.of({
			name: "ECL",
			extensions: ["ecl"],
			load: () => import("./chunks/ecl.DlTKC6ng.js").then((e) => yx(e.ecl)),
		}),
		zc.of({
			name: "edn",
			extensions: ["edn"],
		...
		zc.of({
			...
			extensions: ["e"],
			load: () =>
				import("./chunks/eiffel.DnpkepbV.js").then((e) => yx(e.eiffel)),
		}),
		zc.of({
			name: "Elm",
			extensions: ["elm"],
			load: () => import("./chunks/elm.Df7_Ou_S.js").then((e) => yx(e.elm)),
		}),
		zc.of({
			name: "Erlang",
			extensions: ["erl"],
			load: () =>
				import("./chunks/erlang.m6jC0iJq.js").then((e) => yx(e.erlang)),
		}),
		zc.of({
			name: "Esper",
			load: () => import("./chunks/sql.75XwNhOs.js").then((e) => yx(e.esper)),
		}),
		zc.of({
			name: "Factor",
			extensions: ["factor"],
			load: () =>
				import("./chunks/factor.CwIZ-yW9.js").then((e) => yx(e.factor)),
		}),
		zc.of({
			name: "FCL",
			load: () => import("./chunks/fcl.DsMLxKmt.js").then((e) => yx(e.fcl)),
		}),
		zc.of({
			name: "Forth",
			extensions: ["forth", "fth", "4th"],
			load: () => import("./chunks/forth.CjNP_C63.js").then((e) => yx(e.forth)),
		}),
		zc.of({
			name: "Fortran",
			extensions: ["f", "for", "f77", "f90", "f95"],
			load: () =>
				import("./chunks/fortran.DGVebH1T.js").then((e) => yx(e.fortran)),
		}),
		zc.of({
			name: "F#",
			alias: ["fsharp"],
			extensions: ["fs"],
			load: () =>
				import("./chunks/mllike.BIlLwAVn.js").then((e) => yx(e.fSharp)),
		}),
		zc.of({
			name: "Gas",
			extensions: ["s"],
			load: () => import("./chunks/gas.2k1o-Fcu.js").then((e) => yx(e.gas)),
		}),
		zc.of({
			name: "Gherkin",
			extensions: ["feature"],
			load: () =>
				import("./chunks/gherkin.CKsh3To3.js").then((e) => yx(e.gherkin)),
		}),
		zc.of({
			name: "Groovy",
			...
			load: () =>
				import("./chunks/groovy.DBGl9nhQ.js").then((e) => yx(e.groovy)),
		}),
		zc.of({
			name: "Haskell",
			extensions: ["hs"],
			load: () =>
				import("./chunks/haskell.Da2b6MPs.js").then((e) => yx(e.haskell)),
		}),
		zc.of({
			name: "Haxe",
			extensions: ["hx"],
			load: () => import("./chunks/haxe.ivLtr28K.js").then((e) => yx(e.haxe)),
		}),
		zc.of({
			name: "HXML",
			extensions: ["hxml"],
			load: () => import("./chunks/haxe.ivLtr28K.js").then((e) => yx(e.hxml)),
		}),
		zc.of({
			name: "HTTP",
			load: () => import("./chunks/http.BNmpM_vR.js").then((e) => yx(e.http)),
		}),
		zc.of({
			name: "IDL",
			extensions: ["pro"],
			load: () => import("./chunks/idl.3mUKWOqz.js").then((e) => yx(e.idl)),
		}),
		zc.of({
			name: "JSON-LD",
			alias: ["jsonld"],
			extensions: ["jsonld"],
			load: () =>
				import("./chunks/javascript.B3Nx0vxZ.js").then((e) => yx(e.jsonld)),
		}),
		zc.of({
			name: "Jinja2",
			extensions: ["j2", "jinja", "jinja2"],
			load: () =>
				import("./chunks/jinja2.Cr3fAPUR.js").then((e) => yx(e.jinja2)),
		}),
		zc.of({
			name: "Julia",
			extensions: ["jl"],
			load: () => import("./chunks/julia.D_Qut0AW.js").then((e) => yx(e.julia)),
		}),
		zc.of({
			name: "Kotlin",
			extensions: ["kt", "kts"],
			load: () =>
				import("./chunks/clike.Z6adwjbt.js").then((e) => yx(e.kotlin)),
		}),
		zc.of({
			name: "LiveScript",
			alias: ["ls"],
			extensions: ["ls"],
			load: () =>
				import("./chunks/livescript.ClU1eWJr.js").then((e) => yx(e.liveScript)),
		}),
		zc.of({
			name: "Lua",
			extensions: ["lua"],
			load: () => import("./chunks/lua.B8RdepYz.js").then((e) => yx(e.lua)),
		}),
		zc.of({
			name: "mIRC",
			extensions: ["mrc"],
			load: () => import("./chunks/mirc.BdEckOLi.js").then((e) => yx(e.mirc)),
		}),
		zc.of({
			name: "Mathematica",
			extensions: ["m", "nb", "wl", "wls"],
			load: () =>
				import("./chunks/mathematica.BorQWnMn.js").then((e) =>
					yx(e.mathematica),
				),
		}),
		zc.of({
			...
			extensions: ["mo"],
			load: () =>
				import("./chunks/modelica.CyL5rqsj.js").then((e) => yx(e.modelica)),
		}),
		zc.of({
			name: "MUMPS",
			extensions: ["mps"],
			load: () => import("./chunks/mumps.D6oD-Bue.js").then((e) => yx(e.mumps)),
		}),
		zc.of({
			name: "Mbox",
			extensions: ["mbox"],
			load: () => import("./chunks/mbox.CWtOZfdP.js").then((e) => yx(e.mbox)),
		}),
		zc.of({
			name: "Nginx",
			filename: /nginx.*\.conf$/i,
			load: () => import("./chunks/nginx.COD3haS3.js").then((e) => yx(e.nginx)),
		}),
		zc.of({
			name: "NSIS",
			extensions: ["nsh", "nsi"],
			load: () => import("./chunks/nsis.1b3D2vjq.js").then((e) => yx(e.nsis)),
		}),
		zc.of({
			name: "NTriples",
			extensions: ["nt", "nq"],
			load: () =>
				import("./chunks/ntriples.BzclbgrI.js").then((e) => yx(e.ntriples)),
		}),
		zc.of({
			name: "Objective-C",
			...
			extensions: ["m"],
			load: () =>
				import("./chunks/clike.Z6adwjbt.js").then((e) => yx(e.objectiveC)),
		}),
		zc.of({
			name: "Objective-C++",
			alias: ["objective-c++", "objc++"],
			extensions: ["mm"],
			load: () =>
				import("./chunks/clike.Z6adwjbt.js").then((e) => yx(e.objectiveCpp)),
		}),
		zc.of({
			name: "OCaml",
			extensions: ["ml", "mli", "mll", "mly"],
			load: () =>
				import("./chunks/mllike.BIlLwAVn.js").then((e) => yx(e.oCaml)),
		}),
		zc.of({
			name: "Octave",
			extensions: ["m"],
			load: () =>
				import("./chunks/octave.CZppgsJS.js").then((e) => yx(e.octave)),
		}),
		zc.of({
			name: "Oz",
			extensions: ["oz"],
			load: () => import("./chunks/oz.D39nb3y6.js").then((e) => yx(e.oz)),
		}),
		zc.of({
			name: "Pascal",
			extensions: ["p", "pas"],
			load: () =>
				import("./chunks/pascal.Bj1Bk88c.js").then((e) => yx(e.pascal)),
		}),
		zc.of({
			name: "Perl",
			extensions: ["pl", "pm"],
			load: () => import("./chunks/perl.DHlvaNDM.js").then((e) => yx(e.perl)),
		}),
		zc.of({
			name: "Pig",
			extensions: ["pig"],
			load: () => import("./chunks/pig.2wLnZvF4.js").then((e) => yx(e.pig)),
		}),
		zc.of({
			name: "PowerShell",
			extensions: ["ps1", "psd1", "psm1"],
			load: () =>
				import("./chunks/powershell.C_Ll44XY.js").then((e) => yx(e.powerShell)),
		}),
		zc.of({
			...
			load: () =>
				import("./chunks/properties.D2zthyUO.js").then((e) => yx(e.properties)),
		}),
		zc.of({
			name: "ProtoBuf",
			extensions: ["proto"],
			load: () =>
				import("./chunks/protobuf.wgdb8_7L.js").then((e) => yx(e.protobuf)),
		}),
		zc.of({
			name: "Pug",
			alias: ["jade"],
			extensions: ["pug", "jade"],
			load: () => import("./chunks/pug.B4Qbr_cb.js").then((e) => yx(e.pug)),
		}),
		zc.of({
			name: "Puppet",
			extensions: ["pp"],
			load: () =>
				import("./chunks/puppet.L4ezZLQu.js").then((e) => yx(e.puppet)),
		}),
		zc.of({
			name: "Q",
			extensions: ["q"],
			load: () => import("./chunks/q.BtR8mygb.js").then((e) => yx(e.q)),
		}),
		zc.of({
			name: "R",
			alias: ["rscript"],
			extensions: ["r", "R"],
			load: () => import("./chunks/r.C5pzXBdj.js").then((e) => yx(e.r)),
		}),
		zc.of({
			name: "RPM Changes",
			load: () =>
				import("./chunks/rpm.KKvZJ4W8.js").then((e) => yx(e.rpmChanges)),
		}),
		zc.of({
			name: "RPM Spec",
			extensions: ["spec"],
			load: () => import("./chunks/rpm.KKvZJ4W8.js").then((e) => yx(e.rpmSpec)),
		}),
		zc.of({
			name: "Ruby",
			...
			load: () => import("./chunks/ruby.thyNi4Yk.js").then((e) => yx(e.ruby)),
		}),
		zc.of({
			name: "SAS",
			extensions: ["sas"],
			load: () => import("./chunks/sas.CKjkBb7d.js").then((e) => yx(e.sas)),
		}),
		zc.of({
			name: "Scala",
			extensions: ["scala"],
			load: () => import("./chunks/clike.Z6adwjbt.js").then((e) => yx(e.scala)),
		}),
		zc.of({
			name: "Scheme",
			extensions: ["scm", "ss"],
			load: () =>
				import("./chunks/scheme.Dtu404JC.js").then((e) => yx(e.scheme)),
		}),
		zc.of({
			name: "Shell",
			alias: ["bash", "sh", "zsh"],
			...
			filename: /^PKGBUILD$/,
			load: () => import("./chunks/shell.DLX2i_q1.js").then((e) => yx(e.shell)),
		}),
		zc.of({
			name: "Sieve",
			extensions: ["siv", "sieve"],
			load: () => import("./chunks/sieve.3OvMc-Y4.js").then((e) => yx(e.sieve)),
		}),
		zc.of({
			name: "Smalltalk",
			extensions: ["st"],
			load: () =>
				import("./chunks/smalltalk.DL31wNzm.js").then((e) => yx(e.smalltalk)),
		}),
		zc.of({
			name: "Solr",
			load: () => import("./chunks/solr.CVP6q5HE.js").then((e) => yx(e.solr)),
		}),
		zc.of({
			name: "SML",
			extensions: ["sml", "sig", "fun", "smackspec"],
			load: () => import("./chunks/mllike.BIlLwAVn.js").then((e) => yx(e.sml)),
		}),
		zc.of({
			name: "SPARQL",
			alias: ["sparul"],
			...
			load: () =>
				import("./chunks/sparql.CIvqL7dI.js").then((e) => yx(e.sparql)),
		}),
		zc.of({
			name: "Spreadsheet",
			alias: ["excel", "formula"],
			load: () =>
				import("./chunks/spreadsheet.CeWYJxMY.js").then((e) =>
					yx(e.spreadsheet),
				),
		}),
		zc.of({
			...
			extensions: ["nut"],
			load: () =>
				import("./chunks/clike.Z6adwjbt.js").then((e) => yx(e.squirrel)),
		}),
		zc.of({
			name: "Stylus",
			extensions: ["styl"],
			load: () =>
				import("./chunks/stylus.BLPPhoz2.js").then((e) => yx(e.stylus)),
		}),
		zc.of({
			name: "Swift",
			extensions: ["swift"],
			load: () => import("./chunks/swift.DtqUmMvB.js").then((e) => yx(e.swift)),
		}),
		zc.of({
			name: "sTeX",
			load: () => import("./chunks/stex.WqMcNvi5.js").then((e) => yx(e.stex)),
		}),
		zc.of({
			name: "LaTeX",
			alias: ["tex"],
		...
		zc.of({
			...
			extensions: ["v", "sv", "svh"],
			load: () =>
				import("./chunks/verilog.C-_eg7aF.js").then((e) => yx(e.verilog)),
		}),
		zc.of({
			name: "Tcl",
			extensions: ["tcl"],
			load: () => import("./chunks/tcl.q1lwRrZ4.js").then((e) => yx(e.tcl)),
		}),
		zc.of({
			name: "Textile",
			extensions: ["textile"],
			load: () =>
				import("./chunks/textile.BnaC9dNi.js").then((e) => yx(e.textile)),
		}),
		zc.of({
			name: "TiddlyWiki",
			load: () =>
				import("./chunks/tiddlywiki.CtDxKVmQ.js").then((e) => yx(e.tiddlyWiki)),
		}),
		zc.of({
			name: "Tiki wiki",
			load: () => import("./chunks/tiki.Bk1uTHaM.js").then((e) => yx(e.tiki)),
		}),
		zc.of({
			name: "TOML",
			extensions: ["toml"],
			load: () => import("./chunks/toml.DGmDG0nM.js").then((e) => yx(e.toml)),
		}),
		zc.of({
			name: "Troff",
			extensions: ["1", "2", "3", "4", "5", "6", "7", "8", "9"],
			load: () => import("./chunks/troff.DLnvmCOC.js").then((e) => yx(e.troff)),
		}),
		zc.of({
			name: "TTCN",
			extensions: ["ttcn", "ttcn3", "ttcnpp"],
			load: () => import("./chunks/ttcn.sGRMYvXL.js").then((e) => yx(e.ttcn)),
		}),
		zc.of({
			name: "TTCN_CFG",
			extensions: ["cfg"],
			load: () =>
				import("./chunks/ttcn-cfg.DbSW0IsS.js").then((e) => yx(e.ttcnCfg)),
		}),
		zc.of({
			name: "Turtle",
			extensions: ["ttl"],
			load: () =>
				import("./chunks/turtle.Cofu2VVe.js").then((e) => yx(e.turtle)),
		}),
		zc.of({
			name: "Web IDL",
			extensions: ["webidl"],
			load: () =>
				import("./chunks/webidl.CiWwuWvI.js").then((e) => yx(e.webIDL)),
		}),
		zc.of({
			name: "VB.NET",
			extensions: ["vb"],
			load: () => import("./chunks/vb.DVLDzVAd.js").then((e) => yx(e.vb)),
		}),
		zc.of({
			name: "VBScript",
			extensions: ["vbs"],
			load: () =>
				import("./chunks/vbscript.BRu0NuXY.js").then((e) => yx(e.vbScript)),
		}),
		zc.of({
			name: "Velocity",
			extensions: ["vtl"],
			load: () =>
				import("./chunks/velocity.B_x6nW8V.js").then((e) => yx(e.velocity)),
		}),
		zc.of({
			name: "Verilog",
			extensions: ["v"],
		...
		zc.of({
			name: "VHDL",
			extensions: ["vhd", "vhdl"],
			load: () => import("./chunks/vhdl.Df__JK-N.js").then((e) => yx(e.vhdl)),
		}),
		zc.of({
			name: "XQuery",
			extensions: ["xy", "xquery"],
			load: () =>
				import("./chunks/xquery.66dTacz0.js").then((e) => yx(e.xQuery)),
		}),
		zc.of({
			name: "Yacas",
			extensions: ["ys"],
			load: () => import("./chunks/yacas.Clqa9jm0.js").then((e) => yx(e.yacas)),
		}),
		zc.of({
			name: "Z80",
			extensions: ["z80"],
			load: () => import("./chunks/z80.QjeMdy9V.js").then((e) => yx(e.z80)),
		}),
		zc.of({
			name: "MscGen",
			extensions: ["mscgen", "mscin", "msc"],
			load: () =>
				import("./chunks/mscgen.3g7QdSUS.js").then((e) => yx(e.mscgen)),
		}),
		zc.of({
			name: "Xù",
			extensions: ["xu"],
			load: () => import("./chunks/mscgen.3g7QdSUS.js").then((e) => yx(e.xu)),
		}),
		zc.of({
			name: "MsGenny",
			extensions: ["msgenny"],
			load: () =>
				import("./chunks/mscgen.3g7QdSUS.js").then((e) => yx(e.msgenny)),
		}),
		zc.of({
			name: "Vue",
			extensions: ["vue"],
			load: () => import("./chunks/index.SdqH0VWl.js").then((e) => e.vue()),
		}),
		zc.of({
			name: "Angular Template",
			load: () => import("./chunks/index.D_dxZaOq.js").then((e) => e.angular()),
		}),
	],
			...
			null !== i && i !== e
				...
				this.$nextTick(() => {
					console.log(
						...
						console.log(
							"[EditorComponent/$nextTick] Checking for rootElement ref:",
							this.$refs.rootElement,
						),
						console.log(
							"[EditorComponent/$nextTick] Checking for editorElement ref:",
