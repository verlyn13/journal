import { javascript as t } from "./javascript-D48wDJXV.js";
var e = { "{": "}", "(": ")", "[": "]" };
function n(t) {
...
class i {
	...
	copy() {
		...
		return (
			...
			(e.jsState = (t.copyState || n)(this.jsState)),
...
function a(t, e) {
	if (t.match(/^:([\w\-]+)/)) return c(t, e), "atom";
}
function s(n, i) {
	if (i.isAttrs) {
		if (
			(e[n.peek()] && i.attrsNest.push(e[n.peek()]),
		...
		if (i.inAttributeName && n.match(/^[^=,\)!]+/))
			return (
				("=" !== n.peek() && "!" !== n.peek()) ||
					((i.inAttributeName = !1),
					(i.jsState = t.startState(2)),
					"script" === i.lastTag && "type" === n.current().trim().toLowerCase()
						? (i.attributeIsType = !0)
						: (i.attributeIsType = !1)),
				"attribute"
			);
		var r = t.token(n, i.jsState);
		if (
			...
			try {
				return (
					Function(
						"",
						"var x " + i.attrValue.replace(/,\s*$/, "").replace(/^!/, ""),
					),
					(i.inAttributeName = !0),
					(i.attrValue = ""),
		...
		return (i.attrValue += n.current()), r || !0;
	}
}
function c(t, e) {
	...
	token: function (e, n) {
		var i =
			...
			(function (t, e) {
				if (e.isEach) {
					if (t.match(/^ in\b/))
						return (e.javaScriptLine = !0), (e.isEach = !1), "keyword";
			...
			(function (e, n) {
				if (
					...
					if (n.javaScriptLineExcludesColon && ":" === e.peek())
						return (
							(n.javaScriptLine = !1), void (n.javaScriptLineExcludesColon = !1)
						);
					var i = t.token(e, n.jsState);
					return e.eol() && (n.javaScriptLine = !1), i || !0;
				}
			})(e, n) ||
			(function (e, n) {
				if (n.javaScriptArguments)
					return 0 === n.javaScriptArgumentsDepth && "(" !== e.peek()
						? void (n.javaScriptArguments = !1)
						: ("(" === e.peek()
								? n.javaScriptArgumentsDepth++
								: ")" === e.peek() && n.javaScriptArgumentsDepth--,
							0 === n.javaScriptArgumentsDepth
								? void (n.javaScriptArguments = !1)
								: t.token(e, n.jsState) || !0);
			})(e, n) ||
			(function (t, e) {
				if (e.mixinCallAfter)
					return (
						(e.mixinCallAfter = !1),
						t.match(/^\( *[-\w]+ *=/, !1) ||
							((e.javaScriptArguments = !0), (e.javaScriptArgumentsDepth = 0)),
						!0
					);
			})(e, n) ||
			(function (t) {
			...
			(function (t, e) {
				if (t.match(/^prepend\b/))
					return (e.restOfLine = "variable"), "keyword";
			})(e, n) ||
			(function (t, e) {
			...
			(function (t, e) {
				if (t.match(/^include:([a-zA-Z0-9\-]+)/, !1) && t.match("include"))
					return (e.isIncludeFiltered = !0), "keyword";
			})(e, n) ||
			(function (t, e) {
			...
			(function (t, e) {
				return t.match(/^\+([-\w]+)/)
					? (t.match(/^\( *[-\w]+ *=/, !1) ||
						...
						"variable")
					: t.match("+#{", !1)
						? (t.next(), (e.mixinCallAfter = !0), r(t, e))
						: void 0;
			})(e, n) ||
			(function (t, e) {
				if (t.match(/^(if|unless|else if|else)\b/))
					return (e.javaScriptLine = !0), "keyword";
			})(e, n) ||
			(function (t, e) {
			...
			(function (t, e) {
				var n;
				if ((n = t.match(/^(\w(?:[-:\w]*\w)?)\/?/)))
					return (e.lastTag = n[1].toLowerCase()), "tag";
			})(e, n) ||
			a(e, n) ||
			(function (t, e) {
			...
			(function (t, e) {
				return t.match(/^(?:\| ?| )([^\n]+)/)
					? "string"
					: t.match(/^(<[^\n]*)/, !1)
						? (c(t, e), t.skipToEnd(), e.indentToken)
						: void 0;
			})(e, n) ||
			(function (t, e) {
				if (t.match(/^ *\/\/(-)?([^\n]*)/))
