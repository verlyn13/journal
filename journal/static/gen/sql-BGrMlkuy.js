function e(e) {
	...
	function h(e, i) {
		...
		if ("?" == n && (e.eatSpace() || e.eol() || e.eat(";"))) return "macroName";
		if ("'" == n || ('"' == n && c.doubleQuote))
			return (i.tokenize = b(n)), i.tokenize(e, i);
		if (
			((c.nCharCast && ("n" == n || "N" == n)) ||
				(c.charsetCast && "_" == n && e.match(/[a-z][a-z0-9]*/i))) &&
			("'" == e.peek() || '"' == e.peek())
		)
			return "keyword";
		if (
		...
		if (c.commentSlashSlash && "/" == n && e.eat("/"))
			return e.skipToEnd(), "comment";
		if (
			(c.commentHash && "#" == n) ||
			("-" == n && e.eat("-") && (!c.commentSpaceRequired || e.eat(" ")))
		)
			return e.skipToEnd(), "comment";
		if ("/" == n && e.eat("*")) return (i.tokenize = f(1)), i.tokenize(e, i);
		if ("." != n) {
			if (l.test(n)) return e.eatWhile(l), "operator";
			if (p.test(n)) return "bracket";
	...
	return {
		...
		languageData: {
			commentTokens: {
				line: c.commentSlashSlash ? "//" : c.commentHash ? "#" : "--",
				block: { open: "/*", close: "*/" },
			},
...
function t(e) {
	...
	return (
		e.backUp(e.current().length - 1), e.eatWhile(/\w/) ? "string.special" : null
	);
}
function r(e) {
	return (
		...
		hooks: {
			...
			'"': function (e) {
				...
				return (
					...
					e.eatWhile(/\w/) ? "string.special" : null
				);
			},
			"`": t,
		},
