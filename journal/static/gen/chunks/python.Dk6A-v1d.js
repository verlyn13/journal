...
function a(a) {
	for (
		...
		s[c] || s.splice(c--, 1);
	var u = a.hangingIndent,
		f = n,
		p = r;
	null != a.extra_keywords && (f = f.concat(a.extra_keywords)),
		null != a.extra_builtins && (p = p.concat(a.extra_builtins));
	var d = !(a.version && Number(a.version) < 3);
	if (d) {
		var m =
			a.identifiers || /^[_A-Za-z\u00A1-\uFFFF][_A-Za-z0-9\u00A1-\uFFFF]*/;
		(f = f.concat([
			"nonlocal",
			"None",
			"aiter",
		...
		m = a.identifiers || /^[_A-Za-z][_A-Za-z0-9]*/;
	...
	function y(e, t) {
		...
		if ((n && (t.indent = e.indentation()), n && "py" == i(t).type)) {
			var r = i(t).offset;
			if (e.eatSpace()) {
				var a = e.indentation();
				return (
					a > r
						? v(e, t)
						: a < r && x(e, t) && "#" != e.peek() && (t.errorToken = !0),
					null
				);
			}
			var l = k(e, t);
			return r > 0 && x(e, t) && (l += " " + o), l;
		}
		return k(e, t);
	}
	function k(e, n, r) {
		...
		if (e.match(/^[0-9\.]/, !1)) {
			...
			if (
				...
				e.match(/^[1-9][\d_]*(e[\+\-]?[\d_]+)?/) && (e.eat(/J/i), (c = !0)),
				e.match(/^0(?![\dx])/i) && (c = !0),
				c)
			)
			...
			return -1 !== e.current().toLowerCase().indexOf("f")
				? ((n.tokenize = (function (e, t) {
						...
						function l(l, s) {
							for (; !l.eol(); )
								if ((l.eatWhile(/[^'"\{\}\\]/), l.eat("\\"))) {
									if ((l.next(), n && l.eol())) return r;
								} else {
									if (l.match(e)) return (s.tokenize = t), r;
									if (l.match("{{")) return r;
									if (l.match("{", !1))
										return (
											(s.tokenize = i(0)), l.current() ? r : s.tokenize(l, s)
										);
									if (l.match("}}")) return r;
									if (l.match("}")) return o;
									l.eat(/['"]/);
						...
						function i(i, l) {
							for (; !i.eol(); )
								if ((i.eatWhile(/[^'"\\]/), i.eat("\\"))) {
									...
									if (i.match(e)) return (l.tokenize = t), r;
									i.eat(/['"]/);
								}
							if (n) {
								if (a.singleLineStringErrors) return o;
				...
				: e.match(b) || e.match(t)
					...
					: e.match(g)
						...
						: e.match(/^(self|cls)\b/)
							? "self"
							: e.match(m)
								? "def" == n.lastToken || "class" == n.lastToken
									? "def"
									: "variable"
								: (e.next(), r ? null : o);
	}
	...
	function _(e, t) {
		...
		if (t.beginningOfLine && "@" == r)
			return e.match(m, !1) ? "meta" : d ? "operator" : o;
		if (
			(/\S/.test(r) && (t.beginningOfLine = !1),
			("variable" != n && "builtin" != n) ||
				"meta" != t.lastToken ||
				(n = "meta"),
			("pass" != r && "return" != r) || (t.dedent = !0),
			"lambda" == r && (t.lambda = !0),
			":" == r &&
				!t.lambda &&
				"py" == i(t).type &&
			...
			if (
				...
				if (i(t).type != r) return o;
				t.indent = t.scopes.pop().offset - (u || e.indentUnit);
			}
		}
		return (
			t.dedent &&
...
var s;
export { l as cython, a as mkPython, o as python };
