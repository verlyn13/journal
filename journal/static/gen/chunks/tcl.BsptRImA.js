...
var r = e(
	...
	t = e("if elseif else and not or eq ne in ni for foreach while switch"),
	n = /[+\-*&%=<>!?^\/\|]/;
function a(e, r, t) {
	return (r.tokenize = t), t(e, r);
}
function o(e, f) {
	var s = f.beforeParams;
	f.beforeParams = !1;
	var c,
		u = e.next();
	if (('"' != u && "'" != u) || !f.inParams) {
		if (/[\[\]{}\(\),;\.]/.test(u))
			return (
				"(" == u && s ? (f.inParams = !0) : ")" == u && (f.inParams = !1), null
			);
		...
		if (n.test(u)) return e.eatWhile(n), "comment";
		e.eatWhile(/[\w\$_{}\xa1-\uffff]/);
		var m = e.current().toLowerCase();
		return r && r.propertyIsEnumerable(m)
			? "keyword"
			: t && t.propertyIsEnumerable(m)
				? ((f.beforeParams = !0), "keyword")
				: null;
	}
	return a(
		e,
