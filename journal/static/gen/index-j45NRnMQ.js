...
function f(e, t) {
	for (; 95 == e.next || m(e.next); )
		null != t && (t += String.fromCharCode(e.next)), e.advance();
	return t;
}
function g(e, t) {
...
function h(e, t) {
	...
	if (69 == e.next || 101 == e.next)
		for (
			e.advance(), (43 != e.next && 45 != e.next) || e.advance();
			e.next >= 48 && e.next <= 57;
		)
			e.advance();
}
...
function y(e, t, a) {
	...
	for (let t of e.split(" ")) t && (n[t] = 20);
	for (let e of t.split(" ")) e && (n[e] = 21);
...
function w(e) {
	return new l((t) => {
		...
		let { next: n } = t;
		if ((t.advance(), _(n, v))) {
			for (; _(t.next, v); ) t.advance();
			t.acceptToken(36);
		} else if (36 == n && e.doubleDollarQuotedStrings) {
			let e = f(t, "");
			36 == t.next &&
				(t.advance(),
				(function (e, t) {
				...
				t.acceptToken(3));
		} else if (39 == n || (34 == n && e.doubleQuotedStrings))
			p(t, n, e.backslashEscapes), t.acceptToken(3);
		else if (
			(35 == n && e.hashComments) ||
			(47 == n && 47 == t.next && e.slashComments)
		)
			b(t), t.acceptToken(1);
			...
			if (47 == n && 42 == t.next) {
				...
				if ((110 != n && 78 != n) || 39 != t.next || !e.charSetCasts)
					if (95 == n && e.charSetCasts)
						for (let a = 0; ; a++) {
							if (39 == t.next && a > 1) {
								t.advance(), p(t, 39, e.backslashEscapes), t.acceptToken(3);
								break;
							}
							if (!m(t.next)) break;
							t.advance();
					...
					else if (e.unquotedBitLiterals && 48 == n && 98 == t.next)
						t.advance(), g(t), t.acceptToken(22);
					else if ((98 != n && 66 != n) || (39 != t.next && 34 != t.next)) {
						if (
							(48 == n && (120 == t.next || 88 == t.next)) ||
							((120 == n || 88 == n) && 39 == t.next)
						) {
							let e = 39 == t.next;
							for (
								t.advance();
						...
						} else if (46 == n && t.next >= 48 && t.next <= 57)
							h(t, !0), t.acceptToken(4);
						else if (46 == n) t.acceptToken(14);
						else if (n >= 48 && n <= 57) h(t, !1), t.acceptToken(4);
						else if (_(n, e.operatorChars)) {
							for (; _(t.next, e.operatorChars); ) t.advance();
							t.acceptToken(15);
						} else if (_(n, e.specialVar))
							t.next == n && t.advance(),
								(function (e) {
								...
								t.acceptToken(17);
						else if (_(n, e.identifierQuotes)) p(t, n, !1), t.acceptToken(19);
						else if (58 == n || 44 == n) t.acceptToken(16);
						else if (m(n)) {
							let r = f(t, String.fromCharCode(n));
							t.acceptToken(
								46 == t.next || 46 == t.peek(-r.length - 1)
									? 18
									: null !== (a = e.words[r.toLowerCase()]) && void 0 !== a
										? a
										: 18,
							);
						}
						...
						t.advance(),
							e.treatBitsAsBytes
								? (p(t, a, e.backslashEscapes), t.acceptToken(23))
								: (g(t, a), t.acceptToken(22));
					}
				else t.advance(), p(t, 39, e.backslashEscapes), t.acceptToken(3);
			else t.advance(), p(t, 39, !0), t.acceptToken(3);
		else b(t), t.acceptToken(1);
		var r;
	});
}
const Q = w(k),
...
function T(e, t) {
	if ("CompositeIdentifier" == t.name) {
		let a = [];
		for (let n = t.firstChild; n; n = n.nextSibling) S(n) && a.push(P(e, n));
		return a;
	}
	return [P(e, t)];
}
function U(e, t) {
	for (let a = []; ; ) {
		...
		let n = q(t);
		if (!S(n)) return a;
		a.unshift(P(e, n)), (t = q(n));
	}
}
function z(e, t) {
	let a = u(e).resolveInner(t, -1),
		n = (function (e, t) {
			let a;
			...
			for (let t = a.firstChild, r = !1, i = null; t; t = t.nextSibling) {
				let a =
						"Keyword" == t.name
							? e.sliceString(t.from, t.to).toLowerCase()
							: null,
					s = null;
				if (r)
					if ("as" == a && i && S(t.nextSibling)) s = P(e, t.nextSibling);
					else {
						if (a && X.has(a)) break;
						i && S(t) && (s = P(e, t));
					}
				else r = "from" == a;
				s && (n || (n = Object.create(null)), (n[s] = T(e, i))),
					(i = /Identifier$/.test(t.name) ? t : null);
			}
			return n;
		})(e.doc, a);
	return "Identifier" == a.name ||
		"QuotedIdentifier" == a.name ||
		"Keyword" == a.name
		? {
				from: a.from,
				quoted:
		...
		: "." == a.name
			? { from: t, quoted: null, parents: U(e.doc, a), aliases: n }
			: { from: t, quoted: null, parents: [], empty: !0, aliases: n };
}
const X = new Set(
...
class R {
	...
	child(e) {
		...
		return (
			a ||
			(e &&
				!this.list.some((t) => t.label == e) &&
				this.list.push(Z(e, "type", this.idQuote, this.idCaseInsensitive)),
			(t[e] = new R(this.idQuote, this.idCaseInsensitive)))
		);
	}
	maybeChild(e) {
	...
	addCompletions(e) {
		for (let t of e)
			this.addCompletion(
				"string" == typeof t
					? Z(t, "property", this.idQuote, this.idCaseInsensitive)
					: t,
			);
	}
	addNamespace(e) {
	...
	addNamespaceObject(e) {
		for (let t of Object.keys(e)) {
			let a = e[t],
				...
				i = this;
			I(a) && ((n = a.self), (a = a.children));
			for (let e = 0; e < r.length; e++)
				n && e == r.length - 1 && i.addCompletion(n),
...
function Z(e, t, a, n) {
	return new RegExp("^[a-z_][a-z_\\d]*$", n ? "i" : "").test(e)
		? { label: e, type: t }
		: { label: e, type: t, apply: a + e + a };
}
let V = C.configure({
	props: [
		n.add({ Statement: s() }),
...
class D {
	...
	static define(t) {
		let a = (function (e, t, a, n) {
				let r = {};
				for (let t in k) r[t] = (e.hasOwnProperty(t) ? e : k)[t];
				return t && (r.words = y(t, a || "", n)), r;
			})(t, t.keywords, t.types, t.builtin),
			n = e.define({
				name: "sql",
				parser: V.configure({ tokenizers: [{ from: Q, to: w(a) }] }),
				languageData: {
...
function $(e, t = !1, a) {
	return (function (e, t, a) {
		let n = Object.keys(e).map((n) => {
			return a(
				t ? n.toUpperCase() : n,
				21 == (r = e[n]) ? "type" : 20 == r ? "keyword" : "variable",
			);
			var r;
		});
		return c(
...
function E(e) {
	return e.schema
		? (function (e, t, a, n, r, i) {
				var s;
				let o =
						(null === (s = null == i ? void 0 : i.spec.identifierQuotes) ||
						void 0 === s
							? void 0
							: s[0]) || '"',
					l = new R(
						o,
						!!(null == i ? void 0 : i.spec.caseInsensitiveIdentifiers),
					),
					c = r ? l.child(r) : null;
				return (
					l.addNamespace(e),
					t && (c || l).addCompletions(t),
					a && l.addCompletions(a),
					c && l.addCompletions(c.list),
					n && l.addCompletions((c || l).child(n).list),
					(e) => {
						let {
							parents: t,
							from: a,
									...
									m
										? p.map((e) =>
												Object.assign(Object.assign({}, e), {
													label: e.label[0] == m ? e.label : m + e.label + m,
													apply: void 0,
												}),
											)
										: p),
...
function A(e) {
	return e.schema
		? (e.dialect || W).language.data.of({ autocomplete: E(e) })
		: [];
}
function L(e = {}) {
	let t = e.dialect || W;
	return new a(t.language, [
		A(e),
		t.language.data.of({
			autocomplete: $(t, e.upperCaseKeywords, e.keywordCompletion),
		}),
	]);
}
const W = D.define({}),
...
export {
	...
	ee as SQLite,
	W as StandardSQL,
	$ as keywordCompletionSource,
	E as schemaCompletionSource,
	L as sql,
};
