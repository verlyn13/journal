...
function wS(e) {
	return import("./chunks/index.C9t8aHtB.js").then((t) =>
		t.sql({ dialect: t[e] }),
	);
}
const SS = [
		Cf.of({
			name: "C",
			extensions: ["c", "h", "ino"],
			load: () => import("./chunks/index.D_aB6Rxr.js").then((e) => e.cpp()),
		}),
		Cf.of({
			name: "C++",
			alias: ["cpp"],
		...
		Cf.of({
			name: "Go",
			extensions: ["go"],
			load: () => import("./chunks/index.TTGfT5TZ.js").then((e) => e.go()),
		}),
		Cf.of({
			name: "HTML",
			alias: ["xhtml"],
		...
		Cf.of({
			name: "Java",
			extensions: ["java"],
			load: () => import("./chunks/index.D7KkUIfF.js").then((e) => e.java()),
		}),
		Cf.of({
			name: "JavaScript",
		...
		Cf.of({
			...
			alias: ["json5"],
			extensions: ["json", "map"],
			load: () => import("./chunks/index.Bh2UYdQd.js").then((e) => e.json()),
		}),
		Cf.of({
			name: "JSX",
			extensions: ["jsx"],
		...
		Cf.of({
			name: "LESS",
			extensions: ["less"],
			load: () => import("./chunks/index.DSmEe-lC.js").then((e) => e.less()),
		}),
		Cf.of({
			name: "Liquid",
			extensions: ["liquid"],
			load: () => import("./chunks/index.2G120fmN.js").then((e) => e.liquid()),
		}),
		...
		Cf.of({
			...
			load: () => import("./chunks/index.CfmJWInc.js").then((e) => e.php()),
		}),
		...
		Cf.of({
			...
			filename: /^(BUCK|BUILD)$/,
			load: () => import("./chunks/index.CZWdTRz6.js").then((e) => e.python()),
		}),
		Cf.of({
			name: "Rust",
			extensions: ["rs"],
			load: () => import("./chunks/index.DgkwT3Z_.js").then((e) => e.rust()),
		}),
		Cf.of({
			name: "Sass",
			extensions: ["sass"],
			load: () =>
				import("./chunks/index.EOXUsV3F.js").then((e) =>
					e.sass({ indented: !0 }),
				),
		}),
		Cf.of({
			name: "SCSS",
			extensions: ["scss"],
			load: () => import("./chunks/index.EOXUsV3F.js").then((e) => e.sass()),
		}),
		...
		Cf.of({
			name: "WebAssembly",
			extensions: ["wat", "wast"],
			load: () => import("./chunks/index.BHv6w56U.js").then((e) => e.wast()),
		}),
		Cf.of({
			name: "XML",
			alias: ["rss", "wsdl", "xsd"],
			extensions: ["xml", "xsl", "xsd", "svg"],
			load: () => import("./chunks/index.Dm3ZXP4T.js").then((e) => e.xml()),
		}),
		Cf.of({
			name: "YAML",
			alias: ["yml"],
			extensions: ["yaml", "yml"],
			load: () => import("./chunks/index.Bs4NQqXn.js").then((e) => e.yaml()),
		}),
		Cf.of({
			name: "APL",
			extensions: ["dyalog", "apl"],
			load: () => import("./chunks/apl.Q1F4My0C.js").then((e) => yS(e.apl)),
		}),
		Cf.of({
			name: "PGP",
			alias: ["asciiarmor"],
			...
			load: () =>
				import("./chunks/asciiarmor.DBAniv5l.js").then((e) => yS(e.asciiArmor)),
		}),
		Cf.of({
			name: "ASN.1",
			extensions: ["asn", "asn1"],
			load: () =>
				import("./chunks/asn1.Ds1RBZfa.js").then((e) => yS(e.asn1({}))),
		}),
		Cf.of({
			name: "Asterisk",
			filename: /^extensions\.conf$/i,
			load: () =>
				import("./chunks/asterisk.DR8CPeC-.js").then((e) => yS(e.asterisk)),
		}),
		Cf.of({
			name: "Brainfuck",
			extensions: ["b", "bf"],
			load: () =>
				import("./chunks/brainfuck.CeGJJzyt.js").then((e) => yS(e.brainfuck)),
		}),
		Cf.of({
			name: "Cobol",
			extensions: ["cob", "cpy"],
			load: () => import("./chunks/cobol.CDNOYdhz.js").then((e) => yS(e.cobol)),
		}),
		Cf.of({
			name: "C#",
			alias: ["csharp", "cs"],
			extensions: ["cs"],
			load: () =>
				import("./chunks/clike.B6pwk-FI.js").then((e) => yS(e.csharp)),
		}),
		Cf.of({
			name: "Clojure",
			extensions: ["clj", "cljc", "cljx"],
			load: () =>
				import("./chunks/clojure.Cc_Qde6r.js").then((e) => yS(e.clojure)),
		}),
		Cf.of({
			name: "ClojureScript",
			extensions: ["cljs"],
		...
		Cf.of({
			...
			extensions: ["gss"],
			load: () => import("./chunks/css.CDKahX_F.js").then((e) => yS(e.gss)),
		}),
		Cf.of({
			name: "CMake",
			extensions: ["cmake", "cmake.in"],
			filename: /^CMakeLists\.txt$/,
			load: () => import("./chunks/cmake.CqsvoDfk.js").then((e) => yS(e.cmake)),
		}),
		Cf.of({
			name: "CoffeeScript",
			...
			extensions: ["coffee"],
			load: () =>
				import("./chunks/coffeescript.DpRjwNVh.js").then((e) =>
					yS(e.coffeeScript),
				),
		}),
		Cf.of({
			...
			load: () =>
				import("./chunks/commonlisp.BXsEO6SE.js").then((e) => yS(e.commonLisp)),
		}),
		Cf.of({
			name: "Cypher",
			extensions: ["cyp", "cypher"],
			load: () =>
				import("./chunks/cypher.BQf3ChNX.js").then((e) => yS(e.cypher)),
		}),
		Cf.of({
			name: "Cython",
			extensions: ["pyx", "pxd", "pxi"],
			load: () =>
				import("./chunks/python.DArKRpbp.js").then((e) => yS(e.cython)),
		}),
		Cf.of({
			name: "Crystal",
			extensions: ["cr"],
			load: () =>
				import("./chunks/crystal.7ToqdAFb.js").then((e) => yS(e.crystal)),
		}),
		Cf.of({
			name: "D",
			extensions: ["d"],
			load: () => import("./chunks/d.CU7ULkQd.js").then((e) => yS(e.d)),
		}),
		Cf.of({
			name: "Dart",
			extensions: ["dart"],
			load: () => import("./chunks/clike.B6pwk-FI.js").then((e) => yS(e.dart)),
		}),
		Cf.of({
			name: "diff",
			extensions: ["diff", "patch"],
			load: () => import("./chunks/diff.CzydS0xo.js").then((e) => yS(e.diff)),
		}),
		Cf.of({
			name: "Dockerfile",
			filename: /^Dockerfile$/,
			load: () =>
				import("./chunks/dockerfile.Cll4ZNO6.js").then((e) => yS(e.dockerFile)),
		}),
		Cf.of({
			name: "DTD",
			extensions: ["dtd"],
			load: () => import("./chunks/dtd.BOGQ6-Go.js").then((e) => yS(e.dtd)),
		}),
		Cf.of({
			name: "Dylan",
			extensions: ["dylan", "dyl", "intr"],
			load: () => import("./chunks/dylan.Dud6j2i3.js").then((e) => yS(e.dylan)),
		}),
		Cf.of({
			name: "EBNF",
			load: () => import("./chunks/ebnf.BBxAsCfG.js").then((e) => yS(e.ebnf)),
		}),
		Cf.of({
			name: "ECL",
			extensions: ["ecl"],
			load: () => import("./chunks/ecl.T5bl5kPH.js").then((e) => yS(e.ecl)),
		}),
		Cf.of({
			name: "edn",
			extensions: ["edn"],
		...
		Cf.of({
			...
			extensions: ["e"],
			load: () =>
				import("./chunks/eiffel.D6Sk62xW.js").then((e) => yS(e.eiffel)),
		}),
		Cf.of({
			name: "Elm",
			extensions: ["elm"],
			load: () => import("./chunks/elm.Bvwbwe4h.js").then((e) => yS(e.elm)),
		}),
		Cf.of({
			name: "Erlang",
			extensions: ["erl"],
			load: () =>
				import("./chunks/erlang.0fvHZ81P.js").then((e) => yS(e.erlang)),
		}),
		Cf.of({
			name: "Esper",
			load: () => import("./chunks/sql.DeKPv_s2.js").then((e) => yS(e.esper)),
		}),
		Cf.of({
			name: "Factor",
			extensions: ["factor"],
			load: () =>
				import("./chunks/factor.Bdy_E4J0.js").then((e) => yS(e.factor)),
		}),
		Cf.of({
			name: "FCL",
			load: () => import("./chunks/fcl.Bd2DpF-H.js").then((e) => yS(e.fcl)),
		}),
		Cf.of({
			name: "Forth",
			extensions: ["forth", "fth", "4th"],
			load: () => import("./chunks/forth.BwvwskWO.js").then((e) => yS(e.forth)),
		}),
		Cf.of({
			name: "Fortran",
			extensions: ["f", "for", "f77", "f90", "f95"],
			load: () =>
				import("./chunks/fortran.Dem9WZ90.js").then((e) => yS(e.fortran)),
		}),
		Cf.of({
			name: "F#",
			alias: ["fsharp"],
			extensions: ["fs"],
			load: () =>
				import("./chunks/mllike.BGHn-93w.js").then((e) => yS(e.fSharp)),
		}),
		Cf.of({
			name: "Gas",
			extensions: ["s"],
			load: () => import("./chunks/gas.BXrKND9q.js").then((e) => yS(e.gas)),
		}),
		Cf.of({
			name: "Gherkin",
			extensions: ["feature"],
			load: () =>
				import("./chunks/gherkin.Dz6R0kx3.js").then((e) => yS(e.gherkin)),
		}),
		Cf.of({
			name: "Groovy",
			...
			load: () =>
				import("./chunks/groovy.BoyZVuoe.js").then((e) => yS(e.groovy)),
		}),
		Cf.of({
			name: "Haskell",
			extensions: ["hs"],
			load: () =>
				import("./chunks/haskell.Cs097JKD.js").then((e) => yS(e.haskell)),
		}),
		Cf.of({
			name: "Haxe",
			extensions: ["hx"],
			load: () => import("./chunks/haxe.qyNfaZjT.js").then((e) => yS(e.haxe)),
		}),
		Cf.of({
			name: "HXML",
			extensions: ["hxml"],
			load: () => import("./chunks/haxe.qyNfaZjT.js").then((e) => yS(e.hxml)),
		}),
		Cf.of({
			name: "HTTP",
			load: () => import("./chunks/http.DYhe2mXI.js").then((e) => yS(e.http)),
		}),
		Cf.of({
			name: "IDL",
			extensions: ["pro"],
			load: () => import("./chunks/idl.Bbyot1QL.js").then((e) => yS(e.idl)),
		}),
		Cf.of({
			name: "JSON-LD",
			alias: ["jsonld"],
			extensions: ["jsonld"],
			load: () =>
				import("./chunks/javascript.4zhwgixy.js").then((e) => yS(e.jsonld)),
		}),
		Cf.of({
			name: "Jinja2",
			extensions: ["j2", "jinja", "jinja2"],
			load: () =>
				import("./chunks/jinja2.Bf-3-9iV.js").then((e) => yS(e.jinja2)),
		}),
		Cf.of({
			name: "Julia",
			extensions: ["jl"],
			load: () => import("./chunks/julia.DfcGyndM.js").then((e) => yS(e.julia)),
		}),
		Cf.of({
			name: "Kotlin",
			extensions: ["kt", "kts"],
			load: () =>
				import("./chunks/clike.B6pwk-FI.js").then((e) => yS(e.kotlin)),
		}),
		Cf.of({
			name: "LiveScript",
			alias: ["ls"],
			extensions: ["ls"],
			load: () =>
				import("./chunks/livescript.D3riAYJy.js").then((e) => yS(e.liveScript)),
		}),
		Cf.of({
			name: "Lua",
			extensions: ["lua"],
			load: () => import("./chunks/lua.5PQ8W4c_.js").then((e) => yS(e.lua)),
		}),
		Cf.of({
			name: "mIRC",
			extensions: ["mrc"],
			load: () => import("./chunks/mirc.BmxHzM04.js").then((e) => yS(e.mirc)),
		}),
		Cf.of({
			name: "Mathematica",
			extensions: ["m", "nb", "wl", "wls"],
			load: () =>
				import("./chunks/mathematica.CPcpYPeA.js").then((e) =>
					yS(e.mathematica),
				),
		}),
		Cf.of({
			...
			extensions: ["mo"],
			load: () =>
				import("./chunks/modelica.D3AWas4r.js").then((e) => yS(e.modelica)),
		}),
		Cf.of({
			name: "MUMPS",
			extensions: ["mps"],
			load: () => import("./chunks/mumps.BwuvLfSK.js").then((e) => yS(e.mumps)),
		}),
		Cf.of({
			name: "Mbox",
			extensions: ["mbox"],
			load: () => import("./chunks/mbox.CntmJh76.js").then((e) => yS(e.mbox)),
		}),
		Cf.of({
			name: "Nginx",
			filename: /nginx.*\.conf$/i,
			load: () => import("./chunks/nginx.nFUZn_AE.js").then((e) => yS(e.nginx)),
		}),
		Cf.of({
			name: "NSIS",
			extensions: ["nsh", "nsi"],
			load: () => import("./chunks/nsis.Doye8BKd.js").then((e) => yS(e.nsis)),
		}),
		Cf.of({
			name: "NTriples",
			extensions: ["nt", "nq"],
			load: () =>
				import("./chunks/ntriples.OwpHb0_T.js").then((e) => yS(e.ntriples)),
		}),
		Cf.of({
			name: "Objective-C",
			...
			extensions: ["m"],
			load: () =>
				import("./chunks/clike.B6pwk-FI.js").then((e) => yS(e.objectiveC)),
		}),
		Cf.of({
			name: "Objective-C++",
			alias: ["objective-c++", "objc++"],
			extensions: ["mm"],
			load: () =>
				import("./chunks/clike.B6pwk-FI.js").then((e) => yS(e.objectiveCpp)),
		}),
		Cf.of({
			name: "OCaml",
			extensions: ["ml", "mli", "mll", "mly"],
			load: () =>
				import("./chunks/mllike.BGHn-93w.js").then((e) => yS(e.oCaml)),
		}),
		Cf.of({
			name: "Octave",
			extensions: ["m"],
			load: () =>
				import("./chunks/octave.DmQl-RBz.js").then((e) => yS(e.octave)),
		}),
		Cf.of({
			name: "Oz",
			extensions: ["oz"],
			load: () => import("./chunks/oz.BsQOC_LN.js").then((e) => yS(e.oz)),
		}),
		Cf.of({
			name: "Pascal",
			extensions: ["p", "pas"],
			load: () =>
				import("./chunks/pascal.BTEGQJj8.js").then((e) => yS(e.pascal)),
		}),
		Cf.of({
			name: "Perl",
			extensions: ["pl", "pm"],
			load: () => import("./chunks/perl.0sUxBRMt.js").then((e) => yS(e.perl)),
		}),
		Cf.of({
			name: "Pig",
			extensions: ["pig"],
			load: () => import("./chunks/pig.B1VBNaXw.js").then((e) => yS(e.pig)),
		}),
		Cf.of({
			name: "PowerShell",
			extensions: ["ps1", "psd1", "psm1"],
			load: () =>
				import("./chunks/powershell.j9dcH8iE.js").then((e) => yS(e.powerShell)),
		}),
		Cf.of({
			...
			load: () =>
				import("./chunks/properties.D7xUT0sA.js").then((e) => yS(e.properties)),
		}),
		Cf.of({
			name: "ProtoBuf",
			extensions: ["proto"],
			load: () =>
				import("./chunks/protobuf.CMgn_T3y.js").then((e) => yS(e.protobuf)),
		}),
		Cf.of({
			name: "Pug",
			alias: ["jade"],
			extensions: ["pug", "jade"],
			load: () => import("./chunks/pug.BqQQJZ01.js").then((e) => yS(e.pug)),
		}),
		Cf.of({
			name: "Puppet",
			extensions: ["pp"],
			load: () =>
				import("./chunks/puppet.BGvn1Wfk.js").then((e) => yS(e.puppet)),
		}),
		Cf.of({
			name: "Q",
			extensions: ["q"],
			load: () => import("./chunks/q.pD7vo0L_.js").then((e) => yS(e.q)),
		}),
		Cf.of({
			name: "R",
			alias: ["rscript"],
			extensions: ["r", "R"],
			load: () => import("./chunks/r.iNPA1Slt.js").then((e) => yS(e.r)),
		}),
		Cf.of({
			name: "RPM Changes",
			load: () =>
				import("./chunks/rpm.DNoYUoBu.js").then((e) => yS(e.rpmChanges)),
		}),
		Cf.of({
			name: "RPM Spec",
			extensions: ["spec"],
			load: () => import("./chunks/rpm.DNoYUoBu.js").then((e) => yS(e.rpmSpec)),
		}),
		Cf.of({
			name: "Ruby",
			...
			load: () => import("./chunks/ruby.a2yCOHJt.js").then((e) => yS(e.ruby)),
		}),
		Cf.of({
			name: "SAS",
			extensions: ["sas"],
			load: () => import("./chunks/sas.CGhjzhWX.js").then((e) => yS(e.sas)),
		}),
		Cf.of({
			name: "Scala",
			extensions: ["scala"],
			load: () => import("./chunks/clike.B6pwk-FI.js").then((e) => yS(e.scala)),
		}),
		Cf.of({
			name: "Scheme",
			extensions: ["scm", "ss"],
			load: () =>
				import("./chunks/scheme.vij-n_9Q.js").then((e) => yS(e.scheme)),
		}),
		Cf.of({
			name: "Shell",
			alias: ["bash", "sh", "zsh"],
			...
			filename: /^PKGBUILD$/,
			load: () => import("./chunks/shell.DdXD27kT.js").then((e) => yS(e.shell)),
		}),
		Cf.of({
			name: "Sieve",
			extensions: ["siv", "sieve"],
			load: () => import("./chunks/sieve.DoPvdf-l.js").then((e) => yS(e.sieve)),
		}),
		Cf.of({
			name: "Smalltalk",
			extensions: ["st"],
			load: () =>
				import("./chunks/smalltalk.CfRCXNpo.js").then((e) => yS(e.smalltalk)),
		}),
		Cf.of({
			name: "Solr",
			load: () => import("./chunks/solr.DtoRxS38.js").then((e) => yS(e.solr)),
		}),
		Cf.of({
			name: "SML",
			extensions: ["sml", "sig", "fun", "smackspec"],
			load: () => import("./chunks/mllike.BGHn-93w.js").then((e) => yS(e.sml)),
		}),
		Cf.of({
			name: "SPARQL",
			alias: ["sparul"],
			...
			load: () =>
				import("./chunks/sparql.VYwd_SdN.js").then((e) => yS(e.sparql)),
		}),
		Cf.of({
			name: "Spreadsheet",
			alias: ["excel", "formula"],
			load: () =>
				import("./chunks/spreadsheet.BUPckppE.js").then((e) =>
					yS(e.spreadsheet),
				),
		}),
		Cf.of({
			...
			extensions: ["nut"],
			load: () =>
				import("./chunks/clike.B6pwk-FI.js").then((e) => yS(e.squirrel)),
		}),
		Cf.of({
			name: "Stylus",
			extensions: ["styl"],
			load: () =>
				import("./chunks/stylus.CzG-tEp-.js").then((e) => yS(e.stylus)),
		}),
		Cf.of({
			name: "Swift",
			extensions: ["swift"],
			load: () => import("./chunks/swift.D8kQHVjl.js").then((e) => yS(e.swift)),
		}),
		Cf.of({
			name: "sTeX",
			load: () => import("./chunks/stex.DLIt-W0t.js").then((e) => yS(e.stex)),
		}),
		Cf.of({
			name: "LaTeX",
			alias: ["tex"],
		...
		Cf.of({
			...
			extensions: ["v", "sv", "svh"],
			load: () =>
				import("./chunks/verilog.BB4f6BoZ.js").then((e) => yS(e.verilog)),
		}),
		Cf.of({
			name: "Tcl",
			extensions: ["tcl"],
			load: () => import("./chunks/tcl.C5gprhHN.js").then((e) => yS(e.tcl)),
		}),
		Cf.of({
			name: "Textile",
			extensions: ["textile"],
			load: () =>
				import("./chunks/textile.x-uJZlbl.js").then((e) => yS(e.textile)),
		}),
		Cf.of({
			name: "TiddlyWiki",
			load: () =>
				import("./chunks/tiddlywiki.BZkfW3ei.js").then((e) => yS(e.tiddlyWiki)),
		}),
		Cf.of({
			name: "Tiki wiki",
			load: () => import("./chunks/tiki.DyH4wbII.js").then((e) => yS(e.tiki)),
		}),
		Cf.of({
			name: "TOML",
			extensions: ["toml"],
			load: () => import("./chunks/toml.CPj6He00.js").then((e) => yS(e.toml)),
		}),
		Cf.of({
			name: "Troff",
			extensions: ["1", "2", "3", "4", "5", "6", "7", "8", "9"],
			load: () => import("./chunks/troff.CToPbPq4.js").then((e) => yS(e.troff)),
		}),
		Cf.of({
			name: "TTCN",
			extensions: ["ttcn", "ttcn3", "ttcnpp"],
			load: () => import("./chunks/ttcn.CgNwrns4.js").then((e) => yS(e.ttcn)),
		}),
		Cf.of({
			name: "TTCN_CFG",
			extensions: ["cfg"],
			load: () =>
				import("./chunks/ttcn-cfg.C_CXhKSI.js").then((e) => yS(e.ttcnCfg)),
		}),
		Cf.of({
			name: "Turtle",
			extensions: ["ttl"],
			load: () =>
				import("./chunks/turtle.Dx5B5McL.js").then((e) => yS(e.turtle)),
		}),
		Cf.of({
			name: "Web IDL",
			extensions: ["webidl"],
			load: () =>
				import("./chunks/webidl.CCWvaDc0.js").then((e) => yS(e.webIDL)),
		}),
		Cf.of({
			name: "VB.NET",
			extensions: ["vb"],
			load: () => import("./chunks/vb.fipgYUTi.js").then((e) => yS(e.vb)),
		}),
		Cf.of({
			name: "VBScript",
			extensions: ["vbs"],
			load: () =>
				import("./chunks/vbscript.B1RX1Vz7.js").then((e) => yS(e.vbScript)),
		}),
		Cf.of({
			name: "Velocity",
			extensions: ["vtl"],
			load: () =>
				import("./chunks/velocity.jhh7MCCW.js").then((e) => yS(e.velocity)),
		}),
		Cf.of({
			name: "Verilog",
			extensions: ["v"],
		...
		Cf.of({
			name: "VHDL",
			extensions: ["vhd", "vhdl"],
			load: () => import("./chunks/vhdl.DwF_aDSs.js").then((e) => yS(e.vhdl)),
		}),
		Cf.of({
			name: "XQuery",
			extensions: ["xy", "xquery"],
			load: () =>
				import("./chunks/xquery.BtF6GHD5.js").then((e) => yS(e.xQuery)),
		}),
		Cf.of({
			name: "Yacas",
			extensions: ["ys"],
			load: () => import("./chunks/yacas.B37VA90M.js").then((e) => yS(e.yacas)),
		}),
		Cf.of({
			name: "Z80",
			extensions: ["z80"],
			load: () => import("./chunks/z80.UH7R73Ae.js").then((e) => yS(e.z80)),
		}),
		Cf.of({
			name: "MscGen",
			extensions: ["mscgen", "mscin", "msc"],
			load: () =>
				import("./chunks/mscgen.D-w4WMS-.js").then((e) => yS(e.mscgen)),
		}),
		Cf.of({
			name: "Xù",
			extensions: ["xu"],
			load: () => import("./chunks/mscgen.D-w4WMS-.js").then((e) => yS(e.xu)),
		}),
		Cf.of({
			name: "MsGenny",
			extensions: ["msgenny"],
			load: () =>
				import("./chunks/mscgen.D-w4WMS-.js").then((e) => yS(e.msgenny)),
		}),
		Cf.of({
			name: "Vue",
			extensions: ["vue"],
			load: () => import("./chunks/index.DIXy6sVQ.js").then((e) => e.vue()),
		}),
		Cf.of({
			name: "Angular Template",
			load: () => import("./chunks/index.2qPDnXnb.js").then((e) => e.angular()),
		}),
	],
...
function BS(e = null) {
	return {
		...
		initializeCodeMirror(e) {
			if (
				(console.log(
					"[EditorComponent/initializeCodeMirror] Attempting to create CodeMirror editor on target:",
					e,
				),
				e)
			) {
				try {
					(this.editorView = (function (e, t = "", i = {}) {
						...
						console.log(
							"[EditorComponent/initializeCodeMirror] CodeMirror editor created successfully.",
						);
				} catch (e) {
					return void console.error(
						"[EditorComponent/initializeCodeMirror] Error creating CodeMirror editor:",
						e,
					);
				}
				("split" !== this.mode && "preview" !== this.mode) ||
					(console.log(
						`[EditorComponent/initializeCodeMirror] Initial mode is '${this.mode}', triggering initial preview update.`,
					),
					this.updatePreview());
			} else
				console.error(
					"[EditorComponent/initializeCodeMirror] Received null targetElement. Cannot initialize CodeMirror.",
				);
		},
