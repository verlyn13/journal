...
function wS(e) {
	return import("./chunks/index._Jwxvabg.js").then((t) =>
		t.sql({ dialect: t[e] }),
	);
}
const SS = [
		Cf.of({
			name: "C",
			extensions: ["c", "h", "ino"],
			load: () => import("./chunks/index.C6vEHEfx.js").then((e) => e.cpp()),
		}),
		Cf.of({
			name: "C++",
			alias: ["cpp"],
		...
		Cf.of({
			name: "Go",
			extensions: ["go"],
			load: () => import("./chunks/index.BO6f_RDL.js").then((e) => e.go()),
		}),
		Cf.of({
			name: "HTML",
			alias: ["xhtml"],
		...
		Cf.of({
			name: "Java",
			extensions: ["java"],
			load: () => import("./chunks/index.D-xgtPHZ.js").then((e) => e.java()),
		}),
		Cf.of({
			name: "JavaScript",
		...
		Cf.of({
			...
			alias: ["json5"],
			extensions: ["json", "map"],
			load: () => import("./chunks/index.DnBTv6c1.js").then((e) => e.json()),
		}),
		Cf.of({
			name: "JSX",
			extensions: ["jsx"],
		...
		Cf.of({
			name: "LESS",
			extensions: ["less"],
			load: () => import("./chunks/index.DUqDrzro.js").then((e) => e.less()),
		}),
		Cf.of({
			name: "Liquid",
			extensions: ["liquid"],
			load: () => import("./chunks/index.ByiwP6c4.js").then((e) => e.liquid()),
		}),
		...
		Cf.of({
			...
			load: () => import("./chunks/index.Dtrd9Fmx.js").then((e) => e.php()),
		}),
		...
		Cf.of({
			...
			filename: /^(BUCK|BUILD)$/,
			load: () => import("./chunks/index.xroFerIl.js").then((e) => e.python()),
		}),
		Cf.of({
			name: "Rust",
			extensions: ["rs"],
			load: () => import("./chunks/index.DxEFtzrQ.js").then((e) => e.rust()),
		}),
		Cf.of({
			name: "Sass",
			extensions: ["sass"],
			load: () =>
				import("./chunks/index.hrit28TT.js").then((e) =>
					e.sass({ indented: !0 }),
				),
		}),
		Cf.of({
			name: "SCSS",
			extensions: ["scss"],
			load: () => import("./chunks/index.hrit28TT.js").then((e) => e.sass()),
		}),
		...
		Cf.of({
			name: "WebAssembly",
			extensions: ["wat", "wast"],
			load: () => import("./chunks/index.D1SC6YWw.js").then((e) => e.wast()),
		}),
		Cf.of({
			name: "XML",
			alias: ["rss", "wsdl", "xsd"],
			extensions: ["xml", "xsl", "xsd", "svg"],
			load: () => import("./chunks/index.HGo1NsuL.js").then((e) => e.xml()),
		}),
		Cf.of({
			name: "YAML",
			alias: ["yml"],
			extensions: ["yaml", "yml"],
			load: () => import("./chunks/index.BknbO4Qn.js").then((e) => e.yaml()),
		}),
		Cf.of({
			name: "APL",
			extensions: ["dyalog", "apl"],
			load: () => import("./chunks/apl.BcM3E78p.js").then((e) => yS(e.apl)),
		}),
		Cf.of({
			name: "PGP",
			alias: ["asciiarmor"],
			...
			load: () =>
				import("./chunks/asciiarmor.BHA00kPU.js").then((e) => yS(e.asciiArmor)),
		}),
		Cf.of({
			name: "ASN.1",
			extensions: ["asn", "asn1"],
			load: () =>
				import("./chunks/asn1.wSrWXHNJ.js").then((e) => yS(e.asn1({}))),
		}),
		Cf.of({
			name: "Asterisk",
			filename: /^extensions\.conf$/i,
			load: () =>
				import("./chunks/asterisk.DPKRa3GX.js").then((e) => yS(e.asterisk)),
		}),
		Cf.of({
			name: "Brainfuck",
			extensions: ["b", "bf"],
			load: () =>
				import("./chunks/brainfuck.Cil2U2Ac.js").then((e) => yS(e.brainfuck)),
		}),
		Cf.of({
			name: "Cobol",
			extensions: ["cob", "cpy"],
			load: () => import("./chunks/cobol.ve9oXz10.js").then((e) => yS(e.cobol)),
		}),
		Cf.of({
			name: "C#",
			alias: ["csharp", "cs"],
			extensions: ["cs"],
			load: () =>
				import("./chunks/clike.BD8qd1JQ.js").then((e) => yS(e.csharp)),
		}),
		Cf.of({
			name: "Clojure",
			extensions: ["clj", "cljc", "cljx"],
			load: () =>
				import("./chunks/clojure.CocHVeon.js").then((e) => yS(e.clojure)),
		}),
		Cf.of({
			name: "ClojureScript",
			extensions: ["cljs"],
		...
		Cf.of({
			...
			extensions: ["gss"],
			load: () => import("./chunks/css.0k48cz59.js").then((e) => yS(e.gss)),
		}),
		Cf.of({
			name: "CMake",
			extensions: ["cmake", "cmake.in"],
			filename: /^CMakeLists\.txt$/,
			load: () => import("./chunks/cmake.CqJcqF46.js").then((e) => yS(e.cmake)),
		}),
		Cf.of({
			name: "CoffeeScript",
			...
			extensions: ["coffee"],
			load: () =>
				import("./chunks/coffeescript.DqBW98yF.js").then((e) =>
					yS(e.coffeeScript),
				),
		}),
		Cf.of({
			...
			load: () =>
				import("./chunks/commonlisp.BJ7SSNKG.js").then((e) => yS(e.commonLisp)),
		}),
		Cf.of({
			name: "Cypher",
			extensions: ["cyp", "cypher"],
			load: () =>
				import("./chunks/cypher.CGkNHKrT.js").then((e) => yS(e.cypher)),
		}),
		Cf.of({
			name: "Cython",
			extensions: ["pyx", "pxd", "pxi"],
			load: () =>
				import("./chunks/python.B8d7qETH.js").then((e) => yS(e.cython)),
		}),
		Cf.of({
			name: "Crystal",
			extensions: ["cr"],
			load: () =>
				import("./chunks/crystal.DjUADp0V.js").then((e) => yS(e.crystal)),
		}),
		Cf.of({
			name: "D",
			extensions: ["d"],
			load: () => import("./chunks/d.D70LYnFK.js").then((e) => yS(e.d)),
		}),
		Cf.of({
			name: "Dart",
			extensions: ["dart"],
			load: () => import("./chunks/clike.BD8qd1JQ.js").then((e) => yS(e.dart)),
		}),
		Cf.of({
			name: "diff",
			extensions: ["diff", "patch"],
			load: () => import("./chunks/diff.ajACGgZp.js").then((e) => yS(e.diff)),
		}),
		Cf.of({
			name: "Dockerfile",
			filename: /^Dockerfile$/,
			load: () =>
				import("./chunks/dockerfile.CJqC00jM.js").then((e) => yS(e.dockerFile)),
		}),
		Cf.of({
			name: "DTD",
			extensions: ["dtd"],
			load: () => import("./chunks/dtd.DmobFkee.js").then((e) => yS(e.dtd)),
		}),
		Cf.of({
			name: "Dylan",
			extensions: ["dylan", "dyl", "intr"],
			load: () => import("./chunks/dylan.Bkxf8rBg.js").then((e) => yS(e.dylan)),
		}),
		Cf.of({
			name: "EBNF",
			load: () => import("./chunks/ebnf.N8I7hAPg.js").then((e) => yS(e.ebnf)),
		}),
		Cf.of({
			name: "ECL",
			extensions: ["ecl"],
			load: () => import("./chunks/ecl.CSc47vsr.js").then((e) => yS(e.ecl)),
		}),
		Cf.of({
			name: "edn",
			extensions: ["edn"],
		...
		Cf.of({
			...
			extensions: ["e"],
			load: () =>
				import("./chunks/eiffel.CABShHud.js").then((e) => yS(e.eiffel)),
		}),
		Cf.of({
			name: "Elm",
			extensions: ["elm"],
			load: () => import("./chunks/elm.CL0yBXga.js").then((e) => yS(e.elm)),
		}),
		Cf.of({
			name: "Erlang",
			extensions: ["erl"],
			load: () =>
				import("./chunks/erlang.BjPxHKhk.js").then((e) => yS(e.erlang)),
		}),
		Cf.of({
			name: "Esper",
			load: () => import("./chunks/sql.MEDqSdzo.js").then((e) => yS(e.esper)),
		}),
		Cf.of({
			name: "Factor",
			extensions: ["factor"],
			load: () =>
				import("./chunks/factor.DP80FIU8.js").then((e) => yS(e.factor)),
		}),
		Cf.of({
			name: "FCL",
			load: () => import("./chunks/fcl.Bb1wemlg.js").then((e) => yS(e.fcl)),
		}),
		Cf.of({
			name: "Forth",
			extensions: ["forth", "fth", "4th"],
			load: () => import("./chunks/forth.D1Px3N8y.js").then((e) => yS(e.forth)),
		}),
		Cf.of({
			name: "Fortran",
			extensions: ["f", "for", "f77", "f90", "f95"],
			load: () =>
				import("./chunks/fortran.C0SyLoOz.js").then((e) => yS(e.fortran)),
		}),
		Cf.of({
			name: "F#",
			alias: ["fsharp"],
			extensions: ["fs"],
			load: () =>
				import("./chunks/mllike.B5rK5JeO.js").then((e) => yS(e.fSharp)),
		}),
		Cf.of({
			name: "Gas",
			extensions: ["s"],
			load: () => import("./chunks/gas.D-dGkQqL.js").then((e) => yS(e.gas)),
		}),
		Cf.of({
			name: "Gherkin",
			extensions: ["feature"],
			load: () =>
				import("./chunks/gherkin.FH6S1YO6.js").then((e) => yS(e.gherkin)),
		}),
		Cf.of({
			name: "Groovy",
			...
			load: () =>
				import("./chunks/groovy.D2ZOismR.js").then((e) => yS(e.groovy)),
		}),
		Cf.of({
			name: "Haskell",
			extensions: ["hs"],
			load: () =>
				import("./chunks/haskell.DpI_N9sO.js").then((e) => yS(e.haskell)),
		}),
		Cf.of({
			name: "Haxe",
			extensions: ["hx"],
			load: () => import("./chunks/haxe.CyB18AWe.js").then((e) => yS(e.haxe)),
		}),
		Cf.of({
			name: "HXML",
			extensions: ["hxml"],
			load: () => import("./chunks/haxe.CyB18AWe.js").then((e) => yS(e.hxml)),
		}),
		Cf.of({
			name: "HTTP",
			load: () => import("./chunks/http.CuYVGGYy.js").then((e) => yS(e.http)),
		}),
		Cf.of({
			name: "IDL",
			extensions: ["pro"],
			load: () => import("./chunks/idl.D2dJfsrS.js").then((e) => yS(e.idl)),
		}),
		Cf.of({
			name: "JSON-LD",
			alias: ["jsonld"],
			extensions: ["jsonld"],
			load: () =>
				import("./chunks/javascript.DSQ0JFL4.js").then((e) => yS(e.jsonld)),
		}),
		Cf.of({
			name: "Jinja2",
			extensions: ["j2", "jinja", "jinja2"],
			load: () =>
				import("./chunks/jinja2.DwObcw5x.js").then((e) => yS(e.jinja2)),
		}),
		Cf.of({
			name: "Julia",
			extensions: ["jl"],
			load: () => import("./chunks/julia.CNEsIlEO.js").then((e) => yS(e.julia)),
		}),
		Cf.of({
			name: "Kotlin",
			extensions: ["kt", "kts"],
			load: () =>
				import("./chunks/clike.BD8qd1JQ.js").then((e) => yS(e.kotlin)),
		}),
		Cf.of({
			name: "LiveScript",
			alias: ["ls"],
			extensions: ["ls"],
			load: () =>
				import("./chunks/livescript.BwCxuoWz.js").then((e) => yS(e.liveScript)),
		}),
		Cf.of({
			name: "Lua",
			extensions: ["lua"],
			load: () => import("./chunks/lua.jC3QYWgz.js").then((e) => yS(e.lua)),
		}),
		Cf.of({
			name: "mIRC",
			extensions: ["mrc"],
			load: () => import("./chunks/mirc.ClDNCNis.js").then((e) => yS(e.mirc)),
		}),
		Cf.of({
			name: "Mathematica",
			extensions: ["m", "nb", "wl", "wls"],
			load: () =>
				import("./chunks/mathematica.kX55BzRA.js").then((e) =>
					yS(e.mathematica),
				),
		}),
		Cf.of({
			...
			extensions: ["mo"],
			load: () =>
				import("./chunks/modelica.UOrjrn0D.js").then((e) => yS(e.modelica)),
		}),
		Cf.of({
			name: "MUMPS",
			extensions: ["mps"],
			load: () => import("./chunks/mumps.BXf8X_Q7.js").then((e) => yS(e.mumps)),
		}),
		Cf.of({
			name: "Mbox",
			extensions: ["mbox"],
			load: () => import("./chunks/mbox.DLwA_RBl.js").then((e) => yS(e.mbox)),
		}),
		Cf.of({
			name: "Nginx",
			filename: /nginx.*\.conf$/i,
			load: () => import("./chunks/nginx.Bo1L-QVf.js").then((e) => yS(e.nginx)),
		}),
		Cf.of({
			name: "NSIS",
			extensions: ["nsh", "nsi"],
			load: () => import("./chunks/nsis.CeSiJ1Lh.js").then((e) => yS(e.nsis)),
		}),
		Cf.of({
			name: "NTriples",
			extensions: ["nt", "nq"],
			load: () =>
				import("./chunks/ntriples.CvkEUqwt.js").then((e) => yS(e.ntriples)),
		}),
		Cf.of({
			name: "Objective-C",
			...
			extensions: ["m"],
			load: () =>
				import("./chunks/clike.BD8qd1JQ.js").then((e) => yS(e.objectiveC)),
		}),
		Cf.of({
			name: "Objective-C++",
			alias: ["objective-c++", "objc++"],
			extensions: ["mm"],
			load: () =>
				import("./chunks/clike.BD8qd1JQ.js").then((e) => yS(e.objectiveCpp)),
		}),
		Cf.of({
			name: "OCaml",
			extensions: ["ml", "mli", "mll", "mly"],
			load: () =>
				import("./chunks/mllike.B5rK5JeO.js").then((e) => yS(e.oCaml)),
		}),
		Cf.of({
			name: "Octave",
			extensions: ["m"],
			load: () =>
				import("./chunks/octave.CIqvhCcD.js").then((e) => yS(e.octave)),
		}),
		Cf.of({
			name: "Oz",
			extensions: ["oz"],
			load: () => import("./chunks/oz.C1C_wfe-.js").then((e) => yS(e.oz)),
		}),
		Cf.of({
			name: "Pascal",
			extensions: ["p", "pas"],
			load: () =>
				import("./chunks/pascal.jFGy5UJH.js").then((e) => yS(e.pascal)),
		}),
		Cf.of({
			name: "Perl",
			extensions: ["pl", "pm"],
			load: () => import("./chunks/perl.Bh9b5QjY.js").then((e) => yS(e.perl)),
		}),
		Cf.of({
			name: "Pig",
			extensions: ["pig"],
			load: () => import("./chunks/pig.C26bAQnt.js").then((e) => yS(e.pig)),
		}),
		Cf.of({
			name: "PowerShell",
			extensions: ["ps1", "psd1", "psm1"],
			load: () =>
				import("./chunks/powershell.DTl532RZ.js").then((e) => yS(e.powerShell)),
		}),
		Cf.of({
			...
			load: () =>
				import("./chunks/properties.Ck6gf3zA.js").then((e) => yS(e.properties)),
		}),
		Cf.of({
			name: "ProtoBuf",
			extensions: ["proto"],
			load: () =>
				import("./chunks/protobuf.DJ8OIuwY.js").then((e) => yS(e.protobuf)),
		}),
		Cf.of({
			name: "Pug",
			alias: ["jade"],
			extensions: ["pug", "jade"],
			load: () => import("./chunks/pug.hwtLFB_v.js").then((e) => yS(e.pug)),
		}),
		Cf.of({
			name: "Puppet",
			extensions: ["pp"],
			load: () =>
				import("./chunks/puppet.D65N8bBn.js").then((e) => yS(e.puppet)),
		}),
		Cf.of({
			name: "Q",
			extensions: ["q"],
			load: () => import("./chunks/q.BWlHxtt9.js").then((e) => yS(e.q)),
		}),
		Cf.of({
			name: "R",
			alias: ["rscript"],
			extensions: ["r", "R"],
			load: () => import("./chunks/r.C6zYqLVP.js").then((e) => yS(e.r)),
		}),
		Cf.of({
			name: "RPM Changes",
			load: () =>
				import("./chunks/rpm.C_rUVoe7.js").then((e) => yS(e.rpmChanges)),
		}),
		Cf.of({
			name: "RPM Spec",
			extensions: ["spec"],
			load: () => import("./chunks/rpm.C_rUVoe7.js").then((e) => yS(e.rpmSpec)),
		}),
		Cf.of({
			name: "Ruby",
			...
			load: () => import("./chunks/ruby.axdXGI4b.js").then((e) => yS(e.ruby)),
		}),
		Cf.of({
			name: "SAS",
			extensions: ["sas"],
			load: () => import("./chunks/sas.ClfN_P-c.js").then((e) => yS(e.sas)),
		}),
		Cf.of({
			name: "Scala",
			extensions: ["scala"],
			load: () => import("./chunks/clike.BD8qd1JQ.js").then((e) => yS(e.scala)),
		}),
		Cf.of({
			name: "Scheme",
			extensions: ["scm", "ss"],
			load: () =>
				import("./chunks/scheme.CS1iPuCv.js").then((e) => yS(e.scheme)),
		}),
		Cf.of({
			name: "Shell",
			alias: ["bash", "sh", "zsh"],
			...
			filename: /^PKGBUILD$/,
			load: () => import("./chunks/shell.Tks9-r1I.js").then((e) => yS(e.shell)),
		}),
		Cf.of({
			name: "Sieve",
			extensions: ["siv", "sieve"],
			load: () => import("./chunks/sieve.eSkCp4As.js").then((e) => yS(e.sieve)),
		}),
		Cf.of({
			name: "Smalltalk",
			extensions: ["st"],
			load: () =>
				import("./chunks/smalltalk.BrYHVhoS.js").then((e) => yS(e.smalltalk)),
		}),
		Cf.of({
			name: "Solr",
			load: () => import("./chunks/solr.JnPo4SYc.js").then((e) => yS(e.solr)),
		}),
		Cf.of({
			name: "SML",
			extensions: ["sml", "sig", "fun", "smackspec"],
			load: () => import("./chunks/mllike.B5rK5JeO.js").then((e) => yS(e.sml)),
		}),
		Cf.of({
			name: "SPARQL",
			alias: ["sparul"],
			...
			load: () =>
				import("./chunks/sparql.uVBVwf9C.js").then((e) => yS(e.sparql)),
		}),
		Cf.of({
			name: "Spreadsheet",
			alias: ["excel", "formula"],
			load: () =>
				import("./chunks/spreadsheet.CLipdBFb.js").then((e) =>
					yS(e.spreadsheet),
				),
		}),
		Cf.of({
			...
			extensions: ["nut"],
			load: () =>
				import("./chunks/clike.BD8qd1JQ.js").then((e) => yS(e.squirrel)),
		}),
		Cf.of({
			name: "Stylus",
			extensions: ["styl"],
			load: () =>
				import("./chunks/stylus.DKSZQrrJ.js").then((e) => yS(e.stylus)),
		}),
		Cf.of({
			name: "Swift",
			extensions: ["swift"],
			load: () => import("./chunks/swift.BdMQXC9i.js").then((e) => yS(e.swift)),
		}),
		Cf.of({
			name: "sTeX",
			load: () => import("./chunks/stex.CEYYQE7T.js").then((e) => yS(e.stex)),
		}),
		Cf.of({
			name: "LaTeX",
			alias: ["tex"],
		...
		Cf.of({
			...
			extensions: ["v", "sv", "svh"],
			load: () =>
				import("./chunks/verilog.ejktX7yA.js").then((e) => yS(e.verilog)),
		}),
		Cf.of({
			name: "Tcl",
			extensions: ["tcl"],
			load: () => import("./chunks/tcl.BtwPB97-.js").then((e) => yS(e.tcl)),
		}),
		Cf.of({
			name: "Textile",
			extensions: ["textile"],
			load: () =>
				import("./chunks/textile.CXa7qFKN.js").then((e) => yS(e.textile)),
		}),
		Cf.of({
			name: "TiddlyWiki",
			load: () =>
				import("./chunks/tiddlywiki.DSkxZcIq.js").then((e) => yS(e.tiddlyWiki)),
		}),
		Cf.of({
			name: "Tiki wiki",
			load: () => import("./chunks/tiki.DoIRJ7Fr.js").then((e) => yS(e.tiki)),
		}),
		Cf.of({
			name: "TOML",
			extensions: ["toml"],
			load: () => import("./chunks/toml.DZzXgivH.js").then((e) => yS(e.toml)),
		}),
		Cf.of({
			name: "Troff",
			extensions: ["1", "2", "3", "4", "5", "6", "7", "8", "9"],
			load: () => import("./chunks/troff.DxD2hb-u.js").then((e) => yS(e.troff)),
		}),
		Cf.of({
			name: "TTCN",
			extensions: ["ttcn", "ttcn3", "ttcnpp"],
			load: () => import("./chunks/ttcn.CCzwMrLu.js").then((e) => yS(e.ttcn)),
		}),
		Cf.of({
			name: "TTCN_CFG",
			extensions: ["cfg"],
			load: () =>
				import("./chunks/ttcn-cfg.Ck6EDmYh.js").then((e) => yS(e.ttcnCfg)),
		}),
		Cf.of({
			name: "Turtle",
			extensions: ["ttl"],
			load: () =>
				import("./chunks/turtle.CkBiZCdc.js").then((e) => yS(e.turtle)),
		}),
		Cf.of({
			name: "Web IDL",
			extensions: ["webidl"],
			load: () =>
				import("./chunks/webidl.DM945tFZ.js").then((e) => yS(e.webIDL)),
		}),
		Cf.of({
			name: "VB.NET",
			extensions: ["vb"],
			load: () => import("./chunks/vb.CEkNq74m.js").then((e) => yS(e.vb)),
		}),
		Cf.of({
			name: "VBScript",
			extensions: ["vbs"],
			load: () =>
				import("./chunks/vbscript.Df8s8_n3.js").then((e) => yS(e.vbScript)),
		}),
		Cf.of({
			name: "Velocity",
			extensions: ["vtl"],
			load: () =>
				import("./chunks/velocity.CDZTfJdh.js").then((e) => yS(e.velocity)),
		}),
		Cf.of({
			name: "Verilog",
			extensions: ["v"],
		...
		Cf.of({
			name: "VHDL",
			extensions: ["vhd", "vhdl"],
			load: () => import("./chunks/vhdl.D3BiVmTO.js").then((e) => yS(e.vhdl)),
		}),
		Cf.of({
			name: "XQuery",
			extensions: ["xy", "xquery"],
			load: () =>
				import("./chunks/xquery.Lzsri9WK.js").then((e) => yS(e.xQuery)),
		}),
		Cf.of({
			name: "Yacas",
			extensions: ["ys"],
			load: () => import("./chunks/yacas.CCVIYS3V.js").then((e) => yS(e.yacas)),
		}),
		Cf.of({
			name: "Z80",
			extensions: ["z80"],
			load: () => import("./chunks/z80.BLQaPGEP.js").then((e) => yS(e.z80)),
		}),
		Cf.of({
			name: "MscGen",
			extensions: ["mscgen", "mscin", "msc"],
			load: () =>
				import("./chunks/mscgen.Bm-2QuQi.js").then((e) => yS(e.mscgen)),
		}),
		Cf.of({
			name: "Xù",
			extensions: ["xu"],
			load: () => import("./chunks/mscgen.Bm-2QuQi.js").then((e) => yS(e.xu)),
		}),
		Cf.of({
			name: "MsGenny",
			extensions: ["msgenny"],
			load: () =>
				import("./chunks/mscgen.Bm-2QuQi.js").then((e) => yS(e.msgenny)),
		}),
		Cf.of({
			name: "Vue",
			extensions: ["vue"],
			load: () => import("./chunks/index.BZhCFs5z.js").then((e) => e.vue()),
		}),
		Cf.of({
			name: "Angular Template",
			load: () => import("./chunks/index.DIcM114M.js").then((e) => e.angular()),
		}),
	],
			...
			null !== n && n !== e
				...
				this.$nextTick(() => {
					console.log(
						...
						setTimeout(() => {
							console.log(
								"[EditorComponent/$nextTick/setTimeout] Running deferred CodeMirror setup.",
							);
							const e = this.$el.querySelector('[x-ref="editorElement"]');
							if (e) {
								console.log(
									"[EditorComponent/$nextTick/setTimeout] Attempting to create CodeMirror editor...",
								);
								try {
									(this.editorView = (function (e, t = "", i = {}) {
										const {
												onChange: n = () => {},
												additionalExtensions: r = [],
											} = i,
											s = Sr.create({
												doc: t,
												extensions: [
										...
										console.log(
											"[EditorComponent/$nextTick/setTimeout] CodeMirror editor created successfully.",
										);
								} catch (e) {
									console.error(
										"[EditorComponent/$nextTick/setTimeout] Error creating CodeMirror editor:",
										e,
									);
								}
								("split" !== this.mode && "preview" !== this.mode) ||
									(console.log(
										`[EditorComponent/$nextTick/setTimeout] Initial mode is '${this.mode}', triggering initial preview update.`,
									),
									this.updatePreview());
							} else
								console.error(
									"[EditorComponent/$nextTick/setTimeout] Editor target element (x-ref='editorElement') not found via querySelector after setTimeout. Cannot initialize CodeMirror.",
								);
						}, 0);
				}),
				setInterval(() => {
