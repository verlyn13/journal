...
function Pe(e, t = !1) {
	return Ze(e, (e) => {
		if ((t ? Qe() : ke()).some((t) => e.matches(t))) return !0;
	});
}
function Ze(e, t) {
	if (e) {
...
var pt = {
		...
		start: function () {
			...
			ye &&
				...
				Array.from(document.querySelectorAll(Qe().join(",")))
	...
	if ("clear" === t) o.forEach(l);
		...
		switch ((void 0 !== i && l(o.get(i)), t)) {
			case "add":
				wt(e)
					? Tt(i) && l(o.get("length"))
					: (l(o.get(Mt)), kt(e) && l(o.get(Rt)));
				break;
			case "delete":
				wt(e) || (l(o.get(Mt)), kt(e) && l(o.get(Rt)));
				break;
			case "set":
				kt(e) && l(o.get(Mt));
		}
...
function Gt(e = !1, t = !1) {
	return function (i, n, r) {
		...
		if ("__v_raw" === n && r === (e ? (t ? vi : Qi) : t ? ki : wi).get(i))
			return i;
		const s = wt(i);
		if (!e && s && St(Ut, n)) return Reflect.get(Ut, n, r);
		const o = Reflect.get(i, n, r);
		if (Qt(n) ? Yt.has(n) : zt(n)) return o;
...
function Ht(e = !1) {
	return function (t, i, n, r) {
		let s = t[i];
		if (!e && ((n = Ti(n)), (s = Ti(s)), !wt(t) && _i(s) && !_i(n)))
			return (s.value = n), !0;
		const o = wt(t) && Tt(i) ? Number(i) < t.length : St(t, i),
			a = Reflect.set(t, i, n, r);
		return (
			t === Ti(r) &&
				(o ? Ct(n, s) && Dt(t, "set", i, n, s) : Dt(t, "add", i, n)),
			a
		);
	};
}
var Ft = {
		...
		deleteProperty: function (e, t) {
			...
			return r && i && Dt(e, "delete", t, void 0, n), r;
		},
		has: function (e, t) {
			const i = Reflect.has(e, t);
			return (Qt(t) && Yt.has(t)) || Wt(e, "has", t), i;
		},
		ownKeys: function (e) {
			return Wt(e, "iterate", wt(e) ? "length" : Mt), Reflect.ownKeys(e);
		},
	},
	Kt = {
		get: It,
...
function si(e, t = !1) {
	return (
		(e = e.__v_raw), !t && Wt(Ti(e), "iterate", Mt), Reflect.get(e, "size", e)
	);
}
function oi(e) {
	e = Ti(e);
	const t = Ti(this);
	return ii(t).has.call(t, e) || (t.add(e), Dt(t, "add", e, e)), this;
}
function ai(e, t) {
	t = Ti(t);
	const i = Ti(this),
		{ has: n, get: r } = ii(i);
	let s = n.call(i, e);
	s ? Si(i, n, e) : ((e = Ti(e)), (s = n.call(i, e)));
	const o = r.call(i, e);
	return (
		i.set(e, t),
		s ? Ct(t, o) && Dt(i, "set", e, t, o) : Dt(i, "add", e, t),
		this
	);
}
function li(e) {
	const t = Ti(this),
		{ has: i, get: n } = ii(t);
	let r = i.call(t, e);
	r ? Si(t, i, e) : ((e = Ti(e)), (r = i.call(t, e)));
	const s = n ? n.call(t, e) : void 0,
		o = t.delete(e);
	return r && Dt(t, "delete", e, void 0, s), o;
}
function hi() {
	const e = Ti(this),
		t = 0 !== e.size,
		i = kt(e) ? new Map(e) : new Set(e),
		n = e.clear();
...
function ci(e, t) {
	return function (i, n) {
		const r = this,
			...
			a = t ? ti : e ? ei : Jt;
		return (
			!e && Wt(o, "iterate", Mt), s.forEach((e, t) => i.call(n, a(e), a(t), r))
		);
	};
}
function ui(e, t, i) {
	...
	return (t, n, r) =>
		"__v_isReactive" === n
			...
			: "__v_isReadonly" === n
				...
				: "__v_raw" === n
					? t
					: Reflect.get(St(i, n) && n in t ? i : t, n, r);
}
var bi = { get: xi(!1) },
	yi = { get: xi(!0) };
function Si(e, t, i) {
	...
	return $(() => {
		...
		if ("select" === e.tagName.toLowerCase() && e.multiple)
			return t.includes("number")
				? Array.from(i.target.selectedOptions).map((e) => Di(e.value || e.text))
				: t.includes("boolean")
		...
		(e, { modifiers: t, expression: i }, { effect: n, cleanup: r }) => {
			...
			if (
				...
				let i = ji(e.form, "reset", [], (i) => {
					Re(() => e._x_model && e._x_model.set(Wi(e, t, { target: e }, l())));
				});
				r(() => i());
			}
			(e._x_model = {
...
(Yi.inline = (e, { value: t, modifiers: i, expression: n }) => {
	...
	te("data", (t, { expression: i }, { cleanup: n }) => {
		if (
			(function (e) {
				return !!Be && (!!Ge || e.hasAttribute("data-has-alpine-state"));
			})(t)
		)
			return;
		i = "" === i ? "{}" : i;
			...
			const i = (function (e, t) {
				const i = function () {
					...
					if (!Xt.includes(i)) {
						jt(i);
						try {
							return Vt.push(qt), (qt = !0), Xt.push(i), (xt = i), e();
						} finally {
							Xt.pop(), Lt(), (xt = Xt[Xt.length - 1]);
						}
					}
				};
				return (
...
class wn {
	...
	composeDesc(e) {
		return this.empty ? e : e.empty ? this : Zn(this, e);
	}
	mapDesc(e, t = !1) {
		return e.empty ? this : Pn(this, e, t);
	}
	mapPos(e, t = -1, i = Sn.Simple) {
		let n = 0,
			r = 0;
		for (let s = 0; s < this.sections.length; ) {
			...
			if (a < 0) {
				...
				if (
					i != Sn.Simple &&
					l >= e &&
					((i == Sn.TrackDel && n < e && l > e) ||
						(i == Sn.TrackBefore && n < e) ||
						(i == Sn.TrackAfter && l > e))
				)
					return null;
				if (l > e || (l == e && t < 0 && !o))
...
class kn extends wn {
	...
	compose(e) {
		return this.empty ? e : e.empty ? this : Zn(this, e, !0);
	}
	map(e, t = !1) {
		return e.empty ? this : Pn(this, e, t, !0);
	}
	iterChanges(e, t = !1) {
		$n(this, e, t);
	}
	...
	filter(e) {
		...
		e: for (let s = 0, o = 0; ; ) {
			...
			for (; o < a || (o == a && 0 == r.len); ) {
				...
				Qn(t, e, s), s > 0 && vn(i, t, r.text), r.forward(e), (o += e);
			}
			let l = e[s++];
			for (; o < l; ) {
				if (r.done) break e;
		...
		return { changes: new kn(t, i), filtered: wn.create(n) };
	}
	toJSON() {
		let e = [];
		for (let t = 0; t < this.sections.length; t += 2) {
		...
		if (-1 == o.ins && -1 == a.ins) {
			...
			for (Qn(r, a.ins, -1); t; ) {
				...
				o.ins >= 0 &&
					e < o.i &&
					o.len <= i &&
					(Qn(r, 0, o.ins), s && vn(s, r, o.text), (e = o.i)),
					o.forward(i),
					(t -= i);
			}
			a.next();
			...
			if (!(o.ins >= 0)) {
				if (o.done && a.done) return s ? kn.createSet(r, s) : wn.create(r);
				throw new Error("Mismatched change set lengths");
			}
			{
				let t = 0,
...
function Zn(e, t, i = !1) {
	let n = [],
		...
		o = new Tn(t);
	for (let e = !1; ; ) {
		if (s.done && o.done) return r ? kn.createSet(n, r) : wn.create(n);
		if (0 == s.ins) Qn(n, s.len, 0, e), s.next();
			...
			if (s.done || o.done) throw new Error("Mismatched change set lengths");
			{
				...
				if (-1 == s.ins) {
					...
					Qn(n, t, i, e), r && i && vn(r, n, o.text);
				} else
					-1 == o.ins
						? (Qn(n, s.off ? 0 : s.len, t, e), r && vn(r, n, s.textBit(t)))
		...
		} else Qn(n, 0, o.ins, e), r && vn(r, n, o.text), o.next();
	}
}
class Tn {
	constructor(e) {
...
class _n {
	...
	map(e, t = -1) {
		...
		return (
			...
			i == this.from && n == this.to ? this : new _n(i, n, this.flags)
		);
	}
	extend(e, t = e) {
		if (e <= this.anchor && t >= this.anchor) return Cn.range(e, t);
		let i = Math.abs(e - this.anchor) > Math.abs(t - this.anchor) ? e : t;
		return Cn.range(this.anchor, i);
	}
	eq(e, t = !1) {
		return !(
	...
	static fromJSON(e) {
		...
		return Cn.range(e.anchor, e.head);
	}
	static create(e, t, i) {
		return new _n(e, t, i);
	}
...
class Cn {
	...
	asSingle() {
		return 1 == this.ranges.length ? this : new Cn([this.main], 0);
	}
	addRange(e, t = !0) {
		return Cn.create([e].concat(this.ranges), t ? 0 : this.mainIndex + 1);
	}
	replaceRange(e, t = this.mainIndex) {
		let i = this.ranges.slice();
		return (i[t] = e), Cn.create(i, this.mainIndex);
	}
	toJSON() {
	...
	static fromJSON(e) {
		...
		return new Cn(
			e.ranges.map((e) => _n.fromJSON(e)),
			e.main,
		);
	}
	static single(e, t = e) {
		return new Cn([Cn.range(e, t)], 0);
	}
	static create(e, t = 0) {
		if (0 == e.length)
		...
		for (let i = 0, n = 0; n < e.length; n++) {
			...
			if (r.empty ? r.from <= i : r.from < i)
				return Cn.normalized(e.slice(), t);
			i = r.to;
		}
		return new Cn(e, t);
	}
	...
	static normalized(e, t = 0) {
		...
		for (let i = 1; i < e.length; i++) {
			...
			if (n.empty ? n.from <= r.to : n.from < r.to) {
				...
				i <= t && t--,
					e.splice(--i, 2, n.anchor > n.head ? Cn.range(o, s) : Cn.range(s, o));
			}
		}
		return new Cn(e, t);
	}
...
class Mn {
	...
	static define(e = {}) {
		return new Mn(
			...
			e.compare || (e.combine ? (e, t) => e === t : Rn),
			!!e.static,
			e.enables,
		);
	}
		...
		return {
			...
			update(e, t) {
				if (
					...
					let t = i(e);
					if (o ? !jn(t, e.values[s], n) : !n(t, e.values[s]))
	...
	return {
		...
		reconfigure(e, r) {
			let s = qn(e, n),
				...
				h = r.facet(t);
			if (l && !s && Rn(i, l)) return (e.values[o] = h), 0;
			let c = a(e);
			return t.compare(c, h) ? ((e.values[o] = h), 0) : ((e.values[o] = c), 1);
		},
	};
}
const Ln = Mn.define({ static: !0 });
class Wn {
	constructor(e, t, i, n, r) {
		(this.id = e),
			(this.createF = t),
	...
	create(e) {
		let t = e.facet(Ln).find((e) => e.field == this);
...
class Gn {
	...
	reconfigure(e) {
		return Gn.reconfigure.of({ compartment: this, extension: e });
	}
	get(e) {
	...
	static resolve(e, t, i) {
		...
		for (let i of (function (e, t, i) {
			...
			function s(e, o) {
				...
				if (null != a) {
					...
					let t = n[a].indexOf(e);
					t > -1 && n[a].splice(t, 1),
						e instanceof Hn && i.delete(e.compartment);
				}
				...
				} else if (e instanceof Nn) s(e.inner, e.prec);
		...
		for (let e in r) {
			...
			if (t.every((e) => 0 == e.type))
				if (((o[n.id] = (a.length << 1) | 1), Rn(s, t))) a.push(i.facet(n));
				else {
...
const er = Mn.define(),
	tr = Mn.define({ combine: (e) => e.some((e) => e), static: !0 }),
	ir = Mn.define({ combine: (e) => (e.length ? e[0] : void 0), static: !0 }),
	nr = Mn.define(),
	rr = Mn.define(),
	sr = Mn.define(),
	or = Mn.define({ combine: (e) => !!e.length && e[0] });
class ar {
	constructor(e, t) {
...
class ur {
	...
	isUserEvent(e) {
		let t = this.annotation(ur.userEvent);
		return !(
			!t ||
			!(
				t == e ||
				...
				(o = e.changes.compose(r))),
		{
			...
			selection: t.selection
				...
				: null === (n = e.selection) || void 0 === n
					? void 0
					: n.map(r),
			effects: cr.mapEffects(e.effects, r).concat(cr.mapEffects(t.effects, s)),
...
function Or(e, t, i) {
	let n = t.selection,
		r = gr(t.annotations);
	return (
		t.userEvent && (r = r.concat(ur.userEvent.of(t.userEvent))),
		{
			changes:
				t.changes instanceof kn
					? t.changes
					: kn.of(t.changes || [], i, e.facet(ir)),
			selection: n && (n instanceof Cn ? n : Cn.single(n.anchor, n.head)),
			effects: gr(t.effects),
			annotations: r,
...
function pr(e, t, i) {
	...
	for (let r = 1; r < t.length; r++) {
		...
		n = dr(n, Or(e, t[r], s ? n.changes.newLength : e.doc.length), s);
	}
	let r = ur.create(
		e,
		n.changes,
	...
	return (function (e) {
		...
		for (let r = i.length - 1; r >= 0; r--) {
			...
			s &&
				...
				(n = dr(n, Or(t, s, e.changes.newLength), !0));
		}
		return n == e
			? e
			: ur.create(
		...
		i
			? (function (e) {
					let t = e.startState,
						i = !0;
					for (let n of t.facet(nr)) {
						let t = n(e);
						if (!1 === t) {
							i = !1;
							break;
						}
						Array.isArray(t) && (i = !0 === i ? t : fr(i, t));
					}
					if (!0 !== i) {
						let n, r;
						if (!1 === i)
...
const mr = [];
function gr(e) {
	return null == e ? mr : Array.isArray(e) ? e : [e];
}
var xr = (function (e) {
	return (
		(e[(e.Word = 0)] = "Word"),
...
class wr {
	constructor(e, t, i, n, r, s) {
		(this.config = e),
			...
			(this.computeSlot = r),
			s && (s._state = this);
		for (let e = 0; e < this.config.dynamicSlots.length; e++) Kn(this, e << 1);
	...
	applyTransaction(e) {
		...
		for (let t of e.effects)
			t.is(Gn.reconfigure)
				...
				: t.is(cr.reconfigure)
					? ((i = null), (n = t.value))
					: t.is(cr.appendConfig) && ((i = null), (n = gr(n).concat(t.value)));
		...
		let s = e.startState.facet(tr) ? e.newSelection : e.newSelection.asSingle();
		new wr(i, e.newDoc, s, t, (t, i) => i.update(t, e), e);
	}
	replaceSelection(e) {
		return (
			...
			this.changeByRange((t) => ({
				...
				range: Cn.cursor(t.from + e.length),
			}))
		);
	}
	changeByRange(e) {
		...
		for (let i = 1; i < t.ranges.length; i++) {
			...
			r.push(o.range.map(h)),
				(n = n.compose(l)),
				(s = cr.mapEffects(s, l).concat(cr.mapEffects(gr(o.effects), h)));
		}
		return { changes: n, selection: Cn.create(r, t.mainIndex), effects: s };
	}
	changes(e = []) {
		return e instanceof kn
			? e
			: kn.of(e, this.doc.length, this.facet(wr.lineSeparator));
	}
	toText(e) {
		return an.of(e.split(this.facet(wr.lineSeparator) || yn));
	}
	...
	facet(e) {
		...
		return null == t ? e.default : (Kn(this, t), Jn(this, t));
	}
	toJSON(e) {
	...
	static fromJSON(e, t = {}, i) {
		...
		return wr.create({
			doc: e.doc,
			selection: Cn.fromJSON(e.selection),
	...
	static create(e = {}) {
		let t = Fn.resolve(e.extensions || [], new Map()),
			i =
				e.doc instanceof an
					? e.doc
					: an.of((e.doc || "").split(t.staticFacet(wr.lineSeparator) || yn)),
			n = e.selection
				? e.selection instanceof Cn
					? e.selection
					: Cn.single(e.selection.anchor, e.selection.head)
				: Cn.single(0);
		return (
			An(n, i.length),
			t.staticFacet(tr) || (n = n.asSingle()),
			new wr(
				t,
				i,
				n,
	...
	get tabSize() {
		return this.facet(wr.tabSize);
	}
	get lineBreak() {
		return this.facet(wr.lineSeparator) || "\n";
	}
	get readOnly() {
		return this.facet(or);
	}
	phrase(e, ...t) {
		for (let t of this.facet(wr.phrases))
	...
	wordAt(e) {
		...
		return s == o ? null : Cn.range(s + i, o + i);
	}
}
function kr(e, t, i = {}) {
	let n = {};
...
(wr.allowMultipleSelections = tr),
	(wr.tabSize = Mn.define({ combine: (e) => (e.length ? e[0] : 4) })),
	(wr.lineSeparator = ir),
	(wr.readOnly = or),
	(wr.phrases = Mn.define({
		compare(e, t) {
			let i = Object.keys(e),
				n = Object.keys(t);
	...
	(wr.languageData = er),
	(wr.changeFilter = nr),
	(wr.transactionFilter = rr),
	(wr.transactionExtender = sr),
	(Gn.reconfigure = cr.define());
class Qr {
	eq(e) {
		return this == e;
	}
...
class Pr {
	...
	map(e, t) {
		...
		return { mapped: i.length ? new Pr(n, r, i, o) : null, pos: s };
	}
}
class Zr {
	constructor(e, t, i, n) {
	...
	update(e) {
		...
		if ((i && (t = t.slice().sort($r)), this.isEmpty))
			return t.length ? Zr.of(t) : this;
		let o = new Cr(this, null, -1).goto(0),
			a = 0,
			l = [],
			h = new Tr();
				...
				h.addChunk(this.chunkPos[o.chunkIndex], this.chunk[o.chunkIndex])
					...
					: ((!s || n > o.to || r < o.from || s(o.from, o.to, o.value)) &&
							(h.addInner(o.from, o.to, o.value) ||
								l.push(vr.create(o.from, o.to, o.value))),
						o.next());
	...
	map(e) {
		...
		return 0 == t.length ? r : new Zr(i, t, r || Zr.empty, n);
	}
	between(e, t, i) {
		if (!this.isEmpty) {
	...
	iter(e = 0) {
		return Ar.from([this]).goto(e);
	}
	get isEmpty() {
		return this.nextLayer == this;
	}
	static iter(e, t = 0) {
		return Ar.from(e).goto(t);
	}
	static compare(e, t, i, n, r = -1) {
		let s = e.filter((e) => e.maxPoint > 0 || (!e.isEmpty && e.maxPoint >= r)),
			...
			l = new Mr(s, a, r),
			h = new Mr(o, a, r);
		i.iterGaps((e, t, i) => Rr(l, e, h, t, i, n)),
	...
	static eq(e, t, i = 0, n) {
		...
		let o = _r(r, s),
			a = new Mr(r, o, 0).goto(i),
			l = new Mr(s, o, 0).goto(i);
		for (;;) {
			if (
				a.to != l.to ||
				!Er(a.active, l.active) ||
	...
	static join(e) {
		if (!e.length) return Zr.empty;
		let t = e[e.length - 1];
		for (let i = e.length - 2; i >= 0; i--)
			for (let n = e[i]; n != Zr.empty; n = n.nextLayer)
				t = new Zr(n.chunkPos, n.chunk, t, Math.max(n.maxPoint, t.maxPoint));
		return t;
	}
}
(Zr.empty = new Zr([], [], null, -1)), (Zr.empty.nextLayer = Zr.empty);
class Tr {
	finishChunk(e) {
		this.chunks.push(new Pr(this.from, this.to, this.value, this.maxPoint)),
	...
	finish() {
		return this.finishInner(Zr.empty);
	}
	finishInner(e) {
	...
	static from(e, t = null, i = -1) {
		...
		for (let r = 0; r < e.length; r++)
			for (let s = e[r]; !s.isEmpty; s = s.nextLayer)
				s.maxPoint >= i && n.push(new Cr(s, t, i, r));
		return 1 == n.length ? n[0] : new Ar(n);
	}
	get startSide() {
		return this.value ? this.value.startSide : 0;
	}
...
class Mr {
	...
	addActive(e) {
		...
		for (
			...
			t++;
		qr(this.active, t, i),
			qr(this.activeTo, t, n),
			qr(this.activeRank, t, r),
			e && qr(e, t, this.cursor.from),
			(this.minActive = Vr(this.active, this.activeTo));
	}
	next() {
		let e = this.to,
		...
		if (
			(e.point || i.point
				? (e.point &&
						...
						Er(e.activeForPoint(e.to), i.activeForPoint(i.to))) ||
					s.comparePoint(a, h, e.point, i.point)
				: h > a &&
					!Er(e.active, i.active) &&
...
function Lr(e, t, i = e.length) {
	let n = 0;
	for (let r = 0; r < i && r < e.length; )
		9 == e.charCodeAt(r) ? ((n += t - (n % t)), r++) : (n++, (r = gn(e, r)));
	return n;
}
const Wr = "undefined" == typeof Symbol ? "__ͼ" : Symbol.for("ͼ"),
	Dr =
		"undefined" == typeof Symbol
...
class Yr {
	...
	static newName() {
		let e = zr[Wr] || 1;
		return (zr[Wr] = e + 1), "ͼ" + e.toString(36);
	}
	static mount(e, t, i) {
		let n = e[Dr],
			r = i && i.nonce;
		n ? r && n.setNonce(r) : (n = new Ir(e, r)),
...
for (
	...
	Ur[48 + Fr] = Ur[96 + Fr] = String(Fr);
for (Fr = 1; Fr <= 24; Fr++) Ur[Fr + 111] = "F" + Fr;
for (Fr = 65; Fr <= 90; Fr++)
	(Ur[Fr] = String.fromCharCode(Fr + 32)), (Nr[Fr] = String.fromCharCode(Fr));
for (var Kr in Ur) Nr.hasOwnProperty(Kr) || (Nr[Kr] = Ur[Kr]);
function Jr(e) {
	let t;
	return (
...
function is(e) {
	return 3 == e.nodeType
		? ps(e, 0, e.nodeValue.length).getClientRects()
		: 1 == e.nodeType
			? e.getClientRects()
			: [];
}
function ns(e, t, i, n) {
	return !!i && (os(e, t, i, n, -1) || os(e, t, i, n, 1));
}
function rs(e) {
...
class us {
	...
	setRange(e) {
		...
		this.set(
			t,
			Math.min(e.anchorOffset, t ? as(t) : 0),
			i,
			Math.min(e.focusOffset, i ? as(i) : 0),
		);
	}
	set(e, t, i, n) {
		(this.anchorNode = e),
...
function ps(e, t, i = t) {
	let n = fs || (fs = document.createRange());
...
function bs(e, t) {
	for (let i = e, n = t; ; ) {
		...
		if (1 == i.nodeType && n > 0) {
			...
			(i = i.childNodes[n - 1]), (n = as(i));
		} else {
			if (!i.parentNode || ss(i)) return null;
			(n = rs(i)), (i = i.parentNode);
		}
	}
}
function ys(e, t) {
...
class Ss {
	...
	static before(e, t) {
		return new Ss(e.parentNode, rs(e), t);
	}
	static after(e, t) {
		return new Ss(e.parentNode, rs(e) + 1, t);
	}
}
const ws = [];
class ks {
	...
	localPosFromDOM(e, t) {
		...
		for (; i && !ks.get(i); ) i = i.nextSibling;
	...
	childCursor(e = this.length) {
		return new vs(this.children, e, this.children.length);
	}
	childPos(e, t = 1) {
...
const _s = /Edge\/(\d+)/.exec(Zs.userAgent),
	Cs = /MSIE \d/.test(Zs.userAgent),
	As = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Zs.userAgent),
	Xs = !!(Cs || As || _s),
	Ms = !Xs && /gecko\/(\d+)/i.test(Zs.userAgent),
	Rs = !Xs && /Chrome\/(\d+)/.exec(Zs.userAgent),
	Es = "webkitFontSmoothing" in Ts.documentElement.style,
	js = !Xs && /Apple Computer/.test(Zs.vendor),
	qs = js && (/Mobile\/\w+/.test(Zs.userAgent) || Zs.maxTouchPoints > 2);
var Vs = {
	mac: qs || /Mac/.test(Zs.platform),
	windows: /Win/.test(Zs.platform),
	linux: /Linux|X11/.test(Zs.platform),
	ie: Xs,
	ie_version: Cs ? Ts.documentMode || 6 : As ? +As[1] : _s ? +_s[1] : 0,
	gecko: Ms,
	gecko_version: Ms ? +(/Firefox\/(\d+)/.exec(Zs.userAgent) || [0, 0])[1] : 0,
	chrome: !!Rs,
	...
	webkit_version: Es
		...
		: 0,
	tabSize:
		null != Ts.documentElement.style.tabSize ? "tab-size" : "-moz-tab-size",
};
class Ls extends ks {
	constructor(e) {
		super(), (this.text = e);
	...
	split(e) {
		let t = new Ls(this.text.slice(e));
		return (
...
class Ws extends ks {
	...
	merge(e, t, i, n, r, s) {
		return (
			(!i ||
				!(
					!(i instanceof Ws && i.mark.eq(this.mark)) ||
					(e && r <= 0) ||
					(t < this.length && s <= 0)
				)) &&
			(Ps(this, e, t, i ? i.children.slice() : [], r - 1, s - 1),
			this.markDirty(),
			!0)
		);
	}
...
class Ds extends ks {
	...
	split(e) {
		let t = Ds.create(this.widget, this.length - e, this.side);
	...
	merge(e, t, i, n, r, s) {
		return (
			!(
				i &&
				(!(i instanceof Ds && this.widget.compare(i.widget)) ||
					(e > 0 && r <= 0) ||
					(t < this.length && s <= 0))
...
class zs extends ks {
	...
	become(e) {
		return e instanceof zs && e.side == this.side;
	}
	split() {
...
function Bs(e, t, i) {
	...
	t instanceof Ws &&
	r.length &&
	(n = r[r.length - 1]) instanceof Ws &&
	n.mark.eq(t.mark)
		? Bs(n, t.children[0], i - 1)
...
Ls.prototype.children = Ds.prototype.children = zs.prototype.children = ws;
...
class to extends Qr {
	...
	static widget(e) {
		...
		return (
			...
			new ro(e, t, t, i, e.widget || null, !1)
		);
	}
	static replace(e) {
		let t,
		...
		if (e.isBlockGap) (t = -5e8), (i = 4e8);
			...
			let { start: r, end: s } = so(e, n);
			(t = (r ? (n ? -3e8 : -1) : 5e8) - 1),
				(i = 1 + (s ? (n ? 2e8 : 1) : -6e8));
		}
		return new ro(e, t, i, n, e.widget || null, !0);
	}
	static line(e) {
		return new no(e);
	}
...
class no extends to {
	...
	eq(e) {
		return (
			...
			Hs(this.spec.attributes, e.spec.attributes)
		);
	}
	range(e, t = e) {
		if (t != e)
...
(no.prototype.mapMode = Sn.TrackBefore), (no.prototype.point = !0);
class ro extends to {
	constructor(e, t, i, n, r, s) {
		super(t, i, r, e),
			(this.block = n),
...
class ao extends ks {
	...
	merge(e, t, i, n, r, s) {
		if (i) {
			if (!(i instanceof ao)) return !1;
			this.dom || i.transferDOM(this);
		}
		return (
			n && this.setDeco(i ? i.attrs : null),
			Ps(this, e, t, i ? i.children.slice() : [], r, s),
			!0
		);
	}
	split(e) {
	...
	sync(e, t) {
		...
		this.dom
			...
			void 0 !== this.prevAttrs &&
				(Fs(this.dom, this.prevAttrs, this.attrs),
				this.dom.classList.add("cm-line"),
				(this.prevAttrs = void 0)),
			super.sync(e, t);
		let n = this.dom.lastChild;
		for (; n && ks.get(n) instanceof Ws; ) n = n.lastChild;
		if (
			!(
				n &&
				this.length &&
				("BR" == n.nodeName ||
					0 !=
						(null === (i = ks.get(n)) || void 0 === i
							? void 0
							: i.isEditable) ||
					(Vs.ios && this.children.some((e) => e instanceof Ls)))
			)
		) {
	...
	measureTextSize() {
		...
		let e,
			t = 0;
		for (let i of this.children) {
			if (!(i instanceof Ls) || /[^ -~]/.test(i.text)) return null;
			let n = is(i.dom);
...
class lo extends ks {
	...
	merge(e, t, i, n, r, s) {
		return (
			!(
				i &&
				(!(i instanceof lo && this.widget.compare(i.widget)) ||
					(e > 0 && r <= 0) ||
					(t < this.length && s <= 0))
			) && ((this.length = e + (i ? i.length : 0) + (this.length - t)), !0)
		);
	...
	split(e) {
		let t = this.length - e;
		this.length = e;
		let i = new lo(this.widget, t, this.deco);
	...
	coordsAt(e, t) {
		...
		return (
			i ||
			(this.widget instanceof ho
				? null
				: ls(this.dom.getBoundingClientRect(), this.length ? 0 == e : t <= 0))
		);
	}
	destroy() {
		super.destroy(), this.dom && this.widget.destroy(this.dom);
...
class co {
	...
	posCovered() {
		...
		return !(e.breakAfter || (e instanceof lo && e.deco.endSide < 0));
	}
	getLine() {
		return (
			this.curLine ||
				(this.content.push((this.curLine = new ao())), (this.atCursorPos = !0)),
			this.curLine
		);
	}
	flushBuffer(e = this.bufferMarks) {
		this.pendingBuffer &&
			(this.curLine.append(uo(new zs(-1), e), e.length),
			(this.pendingBuffer = 0));
	}
	addBlockWidget(e) {
	...
	finish(e) {
		this.pendingBuffer && e <= this.bufferMarks.length
			...
			this.posCovered() ||
				(e &&
					this.content.length &&
					this.content[this.content.length - 1] instanceof lo) ||
				this.getLine();
	}
	buildText(e, t, i) {
		for (; e > 0; ) {
			...
			this.flushBuffer(t.slice(t.length - i)),
				this.getLine().append(
					uo(new Ls(this.text.slice(this.textOff, this.textOff + n)), t),
					i,
				),
				(this.atCursorPos = !0),
				(this.textOff += n),
	...
	point(e, t, i, n, r, s) {
		if (this.disallowBlockEffectsFor[s] && i instanceof ro) {
			if (i.block)
				throw new RangeError(
		...
		if (i instanceof ro)
			if (i.block)
				i.startSide > 0 && !this.posCovered() && this.getLine(),
					this.addBlockWidget(new lo(i.widget || fo.block, o, i));
			else {
				let s = Ds.create(i.widget || fo.inline, o, o ? 0 : i.startSide),
					a =
						this.atCursorPos &&
						!s.isEditable &&
						r <= n.length &&
	...
	static build(e, t, i, n, r) {
		let s = new co(e, t, i, r);
		return (
			(s.openEnd = Zr.spans(n, t, i, s)),
...
function uo(e, t) {
	for (let i of t) e = new Ws(i, [e], e.length);
	return e;
}
class fo extends Js {
	constructor(e) {
...
(fo.inline = new fo("span")), (fo.block = new fo("div"));
var Oo = (function (e) {
			...
			e: for (;;)
				if (h < s.length && d == s[h].from) {
					...
					if ((h++, u)) u.push(O);
						...
						O.from > l && o.push(new Qo(l, O.from, f)),
							Zo(
								e,
								(O.direction == po) != !(f % 2) ? n + 1 : n,
								r,
								O.inner,
								O.from,
								O.to,
					...
					if (d == i || (t ? $o[d] != a : $o[d] == a)) break;
					d++;
				}
			u ? Po(e, l, d, n + 1, r, u, o) : l < d && o.push(new Qo(l, d, f)),
				(l = d);
		}
	else
		for (let l = i, h = s.length; l > t; ) {
			...
			e: for (;;)
				if (h && d == s[h - 1].to) {
					...
					if (d == t || (i ? $o[d - 1] != a : $o[d - 1] == a)) break;
					d--;
				}
			u ? Po(e, d, l, n + 1, r, u, o) : d < l && o.push(new Qo(d, l, f)),
				(l = d);
		}
}
function Zo(e, t, i, n, r, s, o) {
	let a = t % 2 ? 2 : 1;
	!(function (e, t, i, n, r) {
		for (let s = 0; s <= n.length; s++) {
			...
			for (let e = o, t = l, n = l; e < a; e++) {
				...
				if (128 == r)
					...
					for (; r < a && 64 == $o[r]; ) r++;
					let s =
						(e && 8 == t) || (r < i && 8 == $o[r]) ? (1 == n ? 1 : 8) : 256;
					for (let t = e; t < r; t++) $o[t] = s;
					e = r - 1;
				} else 8 == r && 1 == n && ($o[e] = 1);
				(t = r), 7 & r && (n = r);
			}
...
function Co(e, t, i, n, r) {
	...
	return u && c == h && u.level + (r ? 0 : 1) < l.level
		? Cn.cursor(u.side(!r, i) + e.from, u.forward(r, i) ? 1 : -1, u.level)
		: Cn.cursor(c + e.from, l.forward(r, i) ? -1 : 1, l.level);
}
function Ao(e, t, i) {
	for (let n = t; n < i; n++) {
		let t = wo(e.charCodeAt(n));
		if (1 == t) return po;
		if (2 == t || 4 == t) return mo;
	}
	return po;
}
const Xo = Mn.define(),
	...
	Lo = Mn.define(),
	Wo = Mn.define(),
	Do = Mn.define({ combine: (e) => e.some((e) => e) }),
	zo = Mn.define({ combine: (e) => e.some((e) => e) }),
	Yo = Mn.define();
class Bo {
...
const Io = cr.define({ map: (e, t) => e.map(t) }),
	Uo = cr.define();
function No(e, t, i) {
	let n = e.facet(Eo);
	n.length
...
const Go = Mn.define({ combine: (e) => !e.length || e[0] });
let Ho = 0;
const Fo = Mn.define();
class Ko {
	constructor(e, t, i, n, r) {
	...
	update(e) {
		if (this.value) {
			if (this.mustUpdate) {
				...
				if (((this.mustUpdate = null), this.value.update))
					try {
						...
						if (
							(No(e.state, t, "CodeMirror plugin crashed"), this.value.destroy)
						)
							try {
								this.value.destroy();
							} catch (e) {}
			...
			try {
				...
				No(e.state, t, "CodeMirror plugin crashed"), this.deactivate();
			}
		return this;
	}
	destroy(e) {
		...
		if (null === (t = this.value) || void 0 === t ? void 0 : t.destroy)
			try {
				...
				No(e.state, t, "CodeMirror plugin crashed");
			}
	}
	deactivate() {
		...
		for (let n = 0, r = 0, s = 0, o = 0; ; n++) {
			...
			for (; r < t.length && t[r] < h; ) {
				let e = t[r],
					...
					s = Math.max(o, e),
					a = Math.min(h, n);
				if ((s <= a && new ca(s + l, a + l, s, a).addToSet(i), n > h)) break;
				r += 2;
			}
			if (!a) return i;
			new ca(a.fromA, a.toA, a.fromB, a.toB).addToSet(i),
				(s = a.toA),
				(o = a.toB);
		}
	}
...
class ua {
	constructor(e, t, i) {
		...
		let n = [];
		this.changes.iterChangedRanges((e, t, i, r) => n.push(new ca(e, t, i, r))),
...
class fa extends ks {
	...
	constructor(e) {
		super(),
			...
			this.updateDeco(),
			this.updateInner([new ca(0, 0, 0, e.state.doc.length)], 0, null);
	}
	update(e) {
		var t;
			...
			n > -1
				? (function (e, t, i) {
						...
						let l = t.invertedDesc,
							h = new ca(l.mapPos(s), l.mapPos(o), s, o),
							c = [];
						for (let t = r.parentNode; ; t = t.parentNode) {
							let i = ks.get(t);
							if (i instanceof Ws) c.push({ node: t, deco: i.mark });
							else {
								if (
									i instanceof ao ||
		...
		let s = (function (e, t, i) {
			let n = new Oa();
			return Zr.compare(e, t, i, n), n.changes;
		})(this.decorations, this.updateDeco(), e.changes);
		return (
			(i = ca.extendWithRanges(i, s)),
	...
	updateInner(e, t, i) {
		...
		if (
			...
			for (let e of this.children)
				e instanceof lo && e.widget instanceof ho && r.push(e.dom);
		n.updateGaps(r);
	}
	...
	updateEditContextFormatting(e) {
		...
		for (let t of e.transactions)
			for (let e of t.effects)
				e.is(Uo) && (this.editContextFormatting = e.value);
	}
	compositionView(e) {
		let t = new Ls(e.text.nodeValue);
		t.flags |= 8;
		for (let { deco: i } of e.marks) t = new Ws(i, [t], t.length);
		let i = new ao();
	...
	updateSelection(e = !1, t = !1) {
		...
		(!s &&
			c.focusNode &&
			((ns(a.node, a.offset, c.anchorNode, c.anchorOffset) &&
				ns(l.node, l.offset, c.focusNode, c.focusOffset)) ||
								...
								1 != t.nodeType
									...
									: (n && "false" == t.childNodes[n - 1].contentEditable
										...
										"false" == t.childNodes[n].contentEditable
											...
											: 0));
							if (e && 3 != e) {
								let t = (1 == e ? bs : ys)(a.node, a.offset);
	...
	suppressWidgetCursorChange(e, t) {
		return (
			this.hasComposition &&
			t.empty &&
			ns(e.focusNode, e.focusOffset, e.anchorNode, e.anchorOffset) &&
	...
	moveToLine(e) {
		...
		for (let n = e.offset; !t && n < i.childNodes.length; n++) {
			let e = ks.get(i.childNodes[n]);
			e instanceof ao && (t = e.domAtPos(0));
		}
		for (let n = e.offset - 1; !t && n >= 0; n--) {
			let e = ks.get(i.childNodes[n]);
			e instanceof ao && (t = e.domAtPos(e.length));
		}
	...
	domAtPos(e) {
		...
		for (; t < this.children.length - 1; ) {
			...
			if (i < e.length || e instanceof ao) break;
			t++, (i = 0);
		}
	...
	coordsAt(e, t) {
		...
		for (let r = this.length, s = this.children.length - 1; s >= 0; s--) {
			...
			if (
				...
				(l < e || o.covers(-1)) &&
				(a > e || o.covers(1)) &&
				(!i || (o instanceof ao && !(i instanceof ao && t >= 0)))
			)
				(i = o), (n = l);
			else if (i && l == e && a == e && o instanceof lo && Math.abs(t) < 2) {
	...
	coordsForChar(e) {
		let { i: t, off: i } = this.childPos(e, 1),
			n = this.children[t];
		if (!(n instanceof ao)) return null;
		...
		if (!(n instanceof Ls)) return null;
		let r = gn(n.text, i);
		if (r == i) return null;
		let s = ps(n.dom, i, r).getClientRects();
	...
	childCursor(e = this.length) {
		...
		return t && (e -= this.children[--t].length), new vs(this.children, e, t);
	}
	computeBlockGapDeco() {
		let e = [],
	...
	updateDeco() {
		let e = 1,
			...
			i = !1,
			n = this.view.state.facet(na).map((e, t) => {
				let n = "function" == typeof e;
				return n && (i = !0), n ? e(this.view) : e;
			});
		for (
			n.length && ((this.dynamicDecorationMap[e++] = i), t.push(Zr.join(n))),
				this.decorations = [
	...
	scrollIntoView(e) {
		...
		for (let t of this.view.state.facet(Yo))
			try {
				if (t(this.view, e.range, e)) return !0;
			} catch (e) {
				No(this.view.state, e, "scroll handler");
			}
		let t,
			{ range: i } = e,
...
function da(e, t) {
	...
	let n = bs(i.focusNode, i.focusOffset),
		r = ys(i.focusNode, i.focusOffset),
		s = n || r;
	if (r && n && r.node != n.node) {
		let t = ks.get(r.node);
		if (!t || (t instanceof Ls && t.text != r.node.nodeValue)) s = r;
		else if (e.docView.lastCompositionAfterCursor) {
			let e = ks.get(n.node);
			!e || (e instanceof Ls && e.text != n.node.nodeValue) || (s = r);
		}
	}
...
function ya(e, t, i) {
	...
	for (let f = e.firstChild; f; f = f.nextSibling) {
		...
		for (let d = 0; d < e.length; d++) {
			let O = e[d];
			r && ga(r, O) && (O = xa(ba(O, r.bottom), r.top));
			let p = pa(t, O),
				m = ma(i, O);
			if (0 == p && 0 == m) return 3 == f.nodeType ? Sa(f, t, i) : ya(f, t, i);
			if (!n || o > m || (o == m && s > p)) {
				(n = f), (r = O), (s = p), (o = m);
...
function Sa(e, t, i) {
	let n = e.nodeValue.length,
		...
		o = 0;
	for (let a = 0; a < n; a++) {
		let n = ps(e, a, a + 1).getClientRects();
		for (let l = 0; l < n.length; l++) {
			...
			if (h.left - 1 <= t && h.right + 1 >= t && c < s) {
				let i = t >= (h.left + h.right) / 2,
					n = i;
				if (Vs.chrome || Vs.gecko) {
					ps(e, a).getBoundingClientRect().left == h.right && (n = !i);
				}
...
function wa(e, t, i, n = -1) {
	...
	for (
		...
		(o = e.elementAtHeight(f)), o.type != eo.Text;
	)
	...
	if (d < e.viewport.from)
		return 0 == e.viewport.from ? 0 : i ? null : ka(e, a, o, c, u);
	if (d > e.viewport.to)
				...
				(!e.contentDOM.contains(g) ||
					(Vs.safari &&
						(function (e, t, i) {
							...
							return ps(e, n - 1, n).getBoundingClientRect().left > i;
						})(g, x, c)) ||
					(Vs.chrome &&
						(function (e, t, i) {
							if (0 != t) return !1;
	...
	if (!g || !e.docView.dom.contains(g)) {
		let t = ao.find(e.docView, d);
		if (!t) return f > o.top + o.height / 2 ? o.to : o.from;
		({ node: g, offset: x } = ya(t.dom, c, u));
	}
...
function Qa(e, t) {
	...
	if (Array.isArray(i.type))
		for (let e of i.type)
			if (e.to > t || (e.to == t && (e.to == i.to || e.type == eo.Text)))
				return e;
	return i;
}
function va(e, t, i, n) {
...
function Pa(e, t, i) {
	let n = $a(
		e.state.facet(ra).map((t) => t(e)),
		i.from,
		t.head > i.from ? -1 : 1,
	);
	return n == i.from ? i : Cn.cursor(n, n < i.from ? 1 : -1);
}
const Za = "￿";
class Ta {
	constructor(e, t) {
...
function Xa(e, t) {
	...
	if (t.bounds) {
		let { from: n, to: o } = t.bounds,
			a = r.from,
			l = null;
		(8 === s || (Vs.android && t.text.length < o - n)) &&
			((a = r.to), (l = "end"));
		...
		})(e.state.doc.sliceString(n, o, Za), t.text, a - n, l);
		h &&
			(Vs.chrome &&
				13 == s &&
				h.toB == h.from + 2 &&
				t.text.slice(h.from, h.toB) == Za + Za &&
				h.toB--,
			(i = {
				from: n + h.from,
				to: n + h.toA,
				insert: an.of(t.text.slice(h.from, h.toB).split(Za)),
			}));
	} else
		n && ((!e.hasFocus && e.state.facet(Go)) || n.main.eq(r)) && (n = null);
	if (!i && !n) return !1;
	if (
		(!i && t.typeOver && !r.empty && n && n.main.empty
			...
			: (Vs.mac || Vs.android) &&
				...
				? (n &&
						2 == i.insert.length &&
						(n = Cn.single(n.main.anchor - 1, n.main.head - 1)),
					(i = {
						from: i.from,
						to: i.to,
				...
				: i &&
					...
					: Vs.chrome &&
						...
						"\n " == i.insert.toString() &&
						e.lineWrapping &&
						(n && (n = Cn.single(n.main.anchor - 1, n.main.head - 1)),
...
function Ma(e, t, i, n = -1) {
	if (Vs.ios && e.inputState.flushIOSKey(t)) return !0;
				...
				if (
					...
					n = r.changeByRange((i) => {
						...
						return {
							changes: d,
							range: a
								? Cn.range(Math.max(0, a.anchor + O), Math.max(0, a.head + O))
								: i.map(d),
						};
					});
	...
	return (
		e.state.facet(qo).some((i) => i(e, t.from, t.to, o, a)) || e.dispatch(a()),
		!0
	);
}
class Ra {
	...
	constructor(e) {
		(this.view = e),
			...
			Vs.safari && e.contentDOM.addEventListener("input", () => null),
			Vs.gecko &&
				(function (e) {
					ll.has(e) ||
						(ll.add(e),
	...
	handleEvent(e) {
		(function (e, t) {
			...
			for (let i, n = t.target; n != e.contentDOM; n = n.parentNode)
				if (!n || 11 == n.nodeType || ((i = ks.get(n)) && i.ignoreEvent(t)))
					return !1;
			return !0;
		})(this.view, e) &&
	...
	keydown(e) {
		...
		return !Vs.ios ||
			...
			e.metaKey ||
			!(
				((t = qa.find((t) => t.keyCode == e.keyCode)) && !e.ctrlKey) ||
				(Va.indexOf(e.key) > -1 && e.ctrlKey && !e.shiftKey)
			)
	...
	for (let t of e) {
		...
		if (e && e.domEventHandlers)
			for (let n in e.domEventHandlers) {
				...
				r && i(n).handlers.push(Ea(t.value, r));
			}
		if (e && e.domEventObservers)
			for (let n in e.domEventObservers) {
				let r = e.domEventObservers[n];
				r && i(n).observers.push(Ea(t.value, r));
			}
	}
	for (let e in za) i(e).handlers.push(za[e]);
	for (let e in Ya) i(e).observers.push(Ya[e]);
	return t;
}
const qa = [
...
class Da {
	constructor(e, t, i, n) {
		(this.view = e),
			...
			(this.atoms = e.state.facet(ra).map((t) => t(e)));
		...
		r.addEventListener("mousemove", (this.move = this.move.bind(this))),
			...
			(this.multiple =
				...
				(function (e, t) {
					...
					return i.length ? i[0](t) : Vs.mac ? t.metaKey : t.ctrlKey;
				})(e, t)),
			(this.dragging =
				!(
					!(function (e, t) {
	...
	move(e) {
		...
		e.clientX - h.left <= s + 6
			? (n = -Wa(s - e.clientX))
			: e.clientX + h.right >= a - 6 && (n = Wa(e.clientX - a)),
			e.clientY - h.top <= o + 6
				? (r = -Wa(o - e.clientY))
				: e.clientY + h.bottom >= l - 6 && (r = Wa(e.clientY - l)),
	...
	skipAtoms(e) {
		...
		for (let i = 0; i < e.ranges.length; i++) {
			let n = e.ranges[i],
				r = null;
			if (n.empty) {
				let e = $a(this.atoms, n.from, 0);
				e != n.from && (r = Cn.cursor(e, -1));
			} else {
				let e = $a(this.atoms, n.from, -1),
					t = $a(this.atoms, n.to, 1);
				(e == n.from && t == n.to) ||
					(r = Cn.range(n.from == n.anchor ? e : t, n.from == n.head ? e : t));
			}
			r && (t || (t = e.ranges.slice()), (t[i] = r));
		}
		return t ? Cn.create(t, e.mainIndex) : e;
	}
	select(e) {
		let { view: t } = this,
...
const za = Object.create(null),
	...
	Ba = (Vs.ie && Vs.ie_version < 15) || (Vs.ios && Vs.webkit_version < 604);
function Ia(e, t, i) {
	...
	if (
		...
		i = n.changeByRange((i) => {
			...
			return {
				...
				range: Cn.cursor(i.from + l.length),
			};
		});
	} else
		i = o
			? n.changeByRange((e) => {
					...
					return {
						...
						range: Cn.cursor(e.from + t.length),
					};
				})
...
function Na(e, t, i, n) {
	if (1 == n) return Cn.cursor(t, i);
	if (2 == n)
		return (function (e, t, i = 1) {
			let n = e.charCategorizer(t),
				r = e.doc.lineAt(t),
				s = t - r.from;
			if (0 == r.length) return Cn.cursor(t);
			...
			return Cn.range(o + r.from, a + r.from);
		})(e.state, t, i);
	{
		let i = ao.find(e.docView, t),
			n = e.state.doc.lineAt(i ? i.posAtEnd : t),
			r = i ? i.posAtStart : n.from,
			s = i ? i.posAtEnd : n.to;
		return s < e.state.doc.length && s == n.to && s++, Cn.range(r, s);
	}
}
(Ya.scroll = (e) => {
	...
	(za.mousedown = (e, t) => {
		if ((e.observer.flush(), e.inputState.lastTouchTime > Date.now() - 2e3))
			return !1;
		let i = null;
		for (let n of e.state.facet(Ro)) if (((i = n(e, t)), i)) break;
		if (
			(i ||
				0 != t.button ||
				(i = (function (e, t) {
					...
					return {
						...
						get(t, s, o) {
							let a,
								l = Fa(e, t),
								h = Na(e, l.pos, l.bias, n);
							if (i.pos != l.pos && !s) {
								let t = Na(e, i.pos, i.bias, n),
									r = Math.min(t.from, h.from),
									s = Math.max(t.to, h.to);
								h = r < h.from ? Cn.range(r, s) : Cn.range(s, r);
							}
							return s
			...
			let n = !e.hasFocus;
			e.inputState.startMouseSelection(new Da(e, t, i, n)),
				n &&
					e.observer.ignore(() => {
						Os(e.contentDOM);
...
function Fa(e, t) {
	...
	return { pos: i, bias: Ha(e, i, t.clientX, t.clientY) };
}
const Ka = Vs.ie && Vs.ie_version <= 11;
let Ja = null,
	el = 0,
	tl = 0;
function il(e) {
...
function nl(e, t, i, n) {
	...
	let r = e.posAtCoords({ x: t.clientX, y: t.clientY }, !1),
		...
		o =
			...
			s &&
			(function (e, t) {
				let i = e.state.facet(Mo);
				return i.length ? i[0](t) : Vs.mac ? !t.altKey : !t.ctrlKey;
			})(e, t)
				? { from: s.from, to: s.to }
				: null,
		a = { from: r, insert: i },
...
(za.dragstart = (e, t) => {
	...
	if (t.target.draggable) {
		...
		if (n && n.isWidget) {
			let e = n.posAtStart,
				t = e + n.length;
			(e >= i.to || t <= i.from) && (i = Cn.range(e, t));
		}
	}
	let { inputState: n } = e;
	return (
		...
		t.dataTransfer &&
			(t.dataTransfer.setData(
				"Text",
				Ia(e.state, Wo, e.state.sliceDoc(i.from, i.to)),
			),
			(t.dataTransfer.effectAllowed = "copyMove")),
		!1
	);
}),
	(za.dragend = (e) => ((e.inputState.draggedContent = null), !1)),
	(za.drop = (e, t) => {
		...
		if (i && i.length) {
			let n = Array(i.length),
				...
				s = () => {
					++r == i.length &&
						nl(e, t, n.filter((e) => null != e).join(e.state.lineBreak), !1);
				};
	...
	(za.paste = (e, t) => {
		if (e.state.readOnly) return !0;
		e.observer.flush();
		let i = Ba ? null : t.clipboardData;
		return i
			? (Ua(e, i.getData("text/plain") || i.getData("text/uri-list")), !0)
			: ((function (e) {
...
za.copy = za.cut = (e, t) => {
	let {
		...
		return { text: Ia(e, Wo, t.join(e.lineBreak)), ranges: i, linewise: n };
	})(e.state);
	if (!i && !r) return !1;
	(rl = r ? i : null),
		"cut" != t.type ||
...
function ol(e, t) {
	let i = [];
	for (let n of e.facet(Vo)) {
		let r = n(e, t);
		r && i.push(r);
	}
	return i ? e.update({ effects: i, annotations: sl.of(!0) }) : null;
}
function al(e) {
	setTimeout(() => {
		let t = e.hasFocus;
...
(Ya.focus = (e) => {
	...
	(Ya.blur = (e) => {
		e.observer.clearSelectionRange(), al(e);
	}),
	(Ya.compositionstart = Ya.compositionupdate =
		(e) => {
	...
	(za.beforeinput = (e, t) => {
		...
		if ("insertReplacementText" == t.inputType && e.observer.editContext) {
			...
			if (n && r.length) {
				...
				return Ma(e, { from: i, to: s, insert: e.state.toText(n) }, null), !0;
			}
		}
		let r;
		if (
			Vs.chrome &&
			Vs.android &&
			(r = qa.find((e) => e.inputType == t.inputType)) &&
		...
		return (
			Vs.ios && "deleteContentForward" == t.inputType && e.observer.flushSoon(),
			Vs.safari &&
				"insertText" == t.inputType &&
				e.inputState.composing >= 0 &&
				setTimeout(() => Ya.compositionend(e, t), 20),
			!1
		);
	});
const ll = new Set();
const hl = ["pre-wrap", "normal", "pre-line", "break-spaces"];
let cl = !1;
function ul() {
	cl = !1;
}
class fl {
	...
	mustRefreshForWrapping(e) {
		return hl.indexOf(e) > -1 != this.lineWrapping;
	}
...
class Ol {
	...
	get widget() {
		return this._content instanceof ro ? this._content.widget : null;
	}
...
class gl {
	...
	setHeight(e) {
		this.height != e &&
			(Math.abs(this.height - e) > ml && (cl = !0), (this.height = e));
	}
	replace(e, t, i) {
		return gl.of(i);
	}
	...
	applyChanges(e, t, i, n) {
		...
		for (let o = n.length - 1; o >= 0; o--) {
			let { fromA: a, toA: l, fromB: h, toB: c } = n[o],
				u = r.lineAt(a, pl.ByPosNoHeight, i.setDoc(t), 0, 0),
				f = u.to >= l ? u : r.lineAt(l, pl.ByPosNoHeight, i, 0, 0);
			for (c += f.to - l, l = f.to; o > 0 && u.from <= n[o - 1].toA; )
				(a = n[o - 1].fromA),
					(h = n[o - 1].fromB),
					o--,
					a < u.from && (u = r.lineAt(a, pl.ByPosNoHeight, i, 0, 0));
			(h += u.from - a), (a = u.from);
			let d = Ql.build(i.setDoc(s), e, h, c);
			r = xl(r, r.replace(a, l, d));
		}
	...
	static of(e) {
		...
		return (
			...
			new wl(gl.of(e.slice(0, t)), s, gl.of(e.slice(i)))
		);
	}
}
function xl(e, t) {
	return e == t ? e : (e.constructor != t.constructor && (cl = !0), t);
}
gl.prototype.size = 1;
class bl extends gl {
	constructor(e, t, i) {
	...
	blockAt(e, t, i, n) {
		return new Ol(n, this.length, i, this.height, this.deco || 0);
	}
	lineAt(e, t, i, n, r) {
...
class yl extends bl {
	...
	blockAt(e, t, i, n) {
		return new Ol(n, this.length, i, this.height, this.breaks);
	}
	replace(e, t, i) {
		let n = i[0];
		return 1 == i.length &&
			(n instanceof yl || (n instanceof Sl && 4 & n.flags)) &&
			Math.abs(this.length - n.length) < 10
			? (n instanceof Sl
					? (n = new yl(n.length, this.height))
...
class Sl extends gl {
	...
	blockAt(e, t, i, n) {
		...
		if (t.lineWrapping) {
			let r =
				...
				l = o + s.length * a,
				h = Math.max(i, e - l / 2);
			return new Ol(s.from, s.length, h, l, 0);
		}
		{
			let n = Math.max(0, Math.min(s - r, Math.floor((e - i) / o))),
				{ from: a, length: l } = t.doc.line(r + n);
			return new Ol(a, l, i + o * n, o, 0);
		}
	}
	lineAt(e, t, i, n, r) {
		if (t == pl.ByHeight) return this.blockAt(e, i, n, r);
		if (t == pl.ByPosNoHeight) {
			let { from: t, to: n } = i.doc.lineAt(e);
			return new Ol(t, n - t, 0, 0, 0);
		}
	...
	forEachLine(e, t, i, n, r, s) {
		...
		for (let h = e, c = n; h <= t; ) {
			...
			let n = a + l * t.length;
			s(new Ol(t.from, t.length, c, n, 0)), (c += n), (h = t.to + 1);
		}
	}
	replace(e, t, i) {
		let n = this.length - t;
	...
	updateHeight(e, t = 0, i = !1, n) {
		...
		if (n && n.from <= t + this.length && n.more) {
			...
			return (
				(o < 0 ||
					Math.abs(a.height - this.height) >= ml ||
					Math.abs(o - this.heightMetrics(e, t).perLine) >= ml) &&
					(cl = !0),
				xl(this, a)
			);
		}
...
class wl extends gl {
	...
	forEachLine(e, t, i, n, r, s) {
		...
		if (this.break)
			...
			let l = this.lineAt(a, pl.ByPos, i, n, r);
	...
	replace(e, t, i) {
		...
		if ((e > 0 && kl(r, s - 1), t < this.length)) {
			let e = r.length;
			this.decomposeRight(t, r), kl(r, e);
		}
		return gl.of(r);
	}
	decomposeLeft(e, t) {
	...
	balanced(e, t) {
		return e.size > 2 * t.size || t.size > 2 * e.size
			? gl.of(this.break ? [e, null, t] : [e, t])
			: ((this.left = xl(this.left, e)),
				(this.right = xl(this.right, t)),
...
class Ql {
		...
		if (this.lineStart > -1) {
			...
			i instanceof yl
				...
				: (e > this.pos || !this.isCovered) &&
					this.nodes.push(new yl(e - this.pos, -1)),
				(this.writtenTo = e),
				t > e &&
	...
	enterLine() {
		...
		(this.lineStart = e),
			...
			this.pos > e && this.nodes.push(new yl(this.pos - e, -1)),
	...
	finish(e) {
		...
		!(this.lineStart > -1) || t instanceof yl || this.isCovered
			? (this.writtenTo < this.pos || null == t) &&
				this.nodes.push(this.blankContent(this.writtenTo, this.pos))
			: this.nodes.push(new yl(0, -1));
		let i = e;
		for (let e of this.nodes)
			e instanceof yl && e.updateHeight(this.oracle, i),
				(i += e ? e.length : 1);
		return this.nodes;
	}
	static build(e, t, i, n) {
		let r = new Ql(i, e);
		return Zr.spans(t, i, n, r, 0), r.finish(i);
	}
}
class vl {
	constructor() {
...
class _l {
	constructor(e) {
		...
		(this.heightOracle = new fl(t)),
			(this.stateDeco = e.facet(ia).filter((e) => "function" != typeof e)),
			(this.heightMap = gl
				.empty()
				.applyChanges(
					this.stateDeco,
		...
		this.updateViewportLines(),
			...
			(this.lineGapDeco = to.set(this.lineGaps.map((e) => e.draw(this, !1)))),
	...
	updateViewportLines() {
		(this.viewportLines = []),
			this.heightMap.forEachLine(
				...
				0,
				(e) => {
					this.viewportLines.push(El(e, this.scaler));
				},
			);
	}
	update(e, t = null) {
		...
		this.stateDeco = this.state.facet(ia).filter((e) => "function" != typeof e);
		let n = e.changedRanges,
			r = ca.extendWithRanges(
				n,
				(function (e, t, i) {
					let n = new vl();
					return Zr.compare(e, t, i, n, 0), n.changes;
		...
		ul(),
			...
			(this.heightMap.height != s || cl) && (e.flags |= 2),
			o
	...
	measure(e) {
		...
		this.scrollTop != f &&
			...
			(this.scrolledToBottom = xs(e.scrollDOM));
		let d = (this.printing ? Pl : $l)(t, this.paddingTop),
					...
					s
						? gl
								...
								.applyChanges(this.stateDeco, an.empty, this.heightOracle, [
									new ca(0, 0, 0, e.state.doc.length),
								])
						: this.heightMap
				).updateHeight(n, 0, s, new dl(i.from, r));
			}
			cl && (l |= 2);
		}
		let x =
	...
	getViewport(e, t) {
		let i = 0.5 - Math.max(-0.5, Math.min(0.5, e / 1e3 / 2)),
			...
			a = new Cl(
				n.lineAt(s - 1e3 * i, pl.ByHeight, r, 0, 0).from,
				n.lineAt(o + 1e3 * (1 - i), pl.ByHeight, r, 0, 0).to,
			);
		if (t) {
			let { head: e } = t.range;
			if (e < a.from || e > a.to) {
				...
				(i =
					"center" == t.y
						...
						: "start" == t.y || ("nearest" == t.y && e < a.from)
							...
							: o.bottom - s),
					(a = new Cl(
						n.lineAt(i - 500, pl.ByHeight, r, 0, 0).from,
						n.lineAt(i + s + 500, pl.ByHeight, r, 0, 0).to,
					));
			}
		}
		return a;
	...
	mapViewport(e, t) {
		let i = t.mapPos(e.from, -1),
			n = t.mapPos(e.to, 1);
		return new Cl(
			this.heightMap.lineAt(i, pl.ByPos, this.heightOracle, 0, 0).from,
			this.heightMap.lineAt(n, pl.ByPos, this.heightOracle, 0, 0).to,
		);
	}
	...
	mapLineGaps(e, t) {
		...
		for (let n of e)
			t.touchesRange(n.from, n.to) ||
				i.push(new Zl(t.mapPos(n.from), t.mapPos(n.to), n.size, n.displaySize));
		return i;
	}
	ensureLineGaps(e, t) {
			...
			a = (n, s, l, h) => {
				...
				if (!f) {
					if (
						...
						let e = t.moveToLineBoundary(Cn.cursor(s), !1, !0).head;
						e > n && (s = e);
					}
					let e = this.gapSize(l, n, s, h);
					f = new Zl(n, s, e, i || e < 2e6 ? e : 2e6);
				}
				o.push(f);
			},
			l = (t) => {
				if (t.length < s || t.type != eo.Text) return;
...
function Al({ total: e, ranges: t }, i) {
...
class Rl {
	constructor(e, t, i) {
		...
		(this.viewports = i.map(({ from: i, to: r }) => {
			let s = t.lineAt(i, pl.ByPos, e, 0, 0).top,
				o = t.lineAt(r, pl.ByPos, e, 0, 0).bottom;
			return (
				(n += o - s),
...
function El(e, t) {
	...
	return new Ol(
		...
		i,
		n - i,
		Array.isArray(e._content) ? e._content.map((e) => El(e, t)) : e._content,
	);
}
const jl = Mn.define({ combine: (e) => e.join(" ") }),
	ql = Mn.define({ combine: (e) => e.indexOf(!0) > -1 }),
	Vl = Yr.newName(),
	Ll = Yr.newName(),
	Wl = Yr.newName(),
	Dl = { "&light": "." + Ll, "&dark": "." + Wl };
...
const Yl = zl(
	...
	Il = Vs.ie && Vs.ie_version <= 11;
class Ul {
	constructor(e) {
		(this.view = e),
			(this.active = !1),
			(this.editContext = null),
			(this.selectionRange = new us()),
			...
			(this.observer = new MutationObserver((t) => {
				...
				((Vs.ie && Vs.ie_version <= 11) || (Vs.ios && e.composing)) &&
				t.some(
					(e) =>
			...
			!window.EditContext ||
				...
				(Vs.chrome && Vs.chrome_version < 126) ||
				((this.editContext = new Hl(e)),
				e.state.facet(Go) &&
	...
	onSelectionChange(e) {
		...
		r && r.ignoreEvent(e)
			...
			: ((Vs.ie && Vs.ie_version <= 11) || (Vs.android && Vs.chrome)) &&
					!i.state.selection.main.empty &&
					n.focusNode &&
					ns(n.focusNode, n.focusOffset, n.anchorNode, n.anchorOffset)
				? this.flushSoon()
				: this.flush(!1);
	}
	readSelectionRange() {
		...
		return n &&
			...
			(function (e, t) {
				...
				for (n = Math.min(n, as(i)); ; )
					if (n) {
						if (1 != i.nodeType) return !1;
						let e = i.childNodes[n - 1];
						"false" == e.contentEditable ? n-- : ((i = e), (n = as(i)));
					} else {
						if (i == e) return !0;
						(n = rs(i)), (i = i.parentNode);
					}
	...
	start() {
		this.active ||
			(this.observer.observe(this.dom, Bl),
			Il &&
			...
			let e = () => {
				...
				if (e) {
					this.clearDelayedAndroidKey(),
						...
						!this.flush() && e.force && ms(this.dom, e.key, e.keyCode);
				}
			};
	...
	readMutation(e) {
		...
		if (
			...
			let i = Nl(t, e.previousSibling || e.target.previousSibling, -1),
				n = Nl(t, e.nextSibling || e.target.nextSibling, 1);
			return {
	...
	update(e) {
		this.editContext &&
			...
			e.startState.facet(Go) != e.state.facet(Go) &&
				(e.view.contentDOM.editContext = e.state.facet(Go)
...
function Gl(e, t) {
	...
	return (
		ns(o.node, o.offset, r, s) && ([i, n, r, s] = [r, s, i, n]),
				...
				for (let e of t.getTextFormats()) {
					...
					if ("None" != t && "None" != n) {
						...
						if (r < s) {
							...
							i.push(to.mark({ attributes: { style: e } }).range(r, s));
						}
					}
				}
				e.dispatch({ effects: Uo.of(to.set(i)) });
			}),
...
class Fl {
	...
	update(e) {
		...
		let s = this.hasFocus,
			o = 0,
			a = null;
		e.some((e) => e.annotation(sl))
			? ((this.inputState.notifiedFocused = s), (o = 1))
			: s != this.inputState.notifiedFocused &&
				((this.inputState.notifiedFocused = s), (a = ol(r, s)), a || (o = 1));
			...
			(l
				? (this.observer.clearDelayedAndroidKey(),
					...
					((h && !this.state.doc.eq(r.doc)) ||
						...
						(h = null))
				: this.observer.clear(),
			r.facet(wr.phrases) != this.state.facet(wr.phrases))
		)
			return this.setState(r);
		(t = ua.create(this, r, e)), (t.flags |= o);
		...
		try {
			...
			for (let t of e) {
				if ((c && (c = c.map(t.changes)), t.scrollIntoView)) {
					...
					c = new Bo(
						e.empty ? e : Cn.cursor(e.head, e.head > e.anchor ? -1 : 1),
					);
				}
				for (let e of t.effects) e.is(Io) && (c = e.value.clip(this.state));
			}
			this.viewState.update(t, c),
				(this.bidiCache = eh.update(this.bidiCache, t.changes)),
				t.empty || (this.updatePlugins(t), this.inputState.update(t)),
				(i = this.docView.update(t)),
				this.state.facet(ha) != this.styleModules && this.mountStyles(),
				(n = this.updateAttrs()),
		...
		if (
			(t.startState.facet(jl) != t.state.facet(jl) &&
			...
			for (let e of this.state.facet(jo))
				try {
					e(t);
				} catch (e) {
					No(this.state, e, "update listener");
				}
		(a || h) &&
			Promise.resolve().then(() => {
				a && this.state == a.startState && this.dispatch(a),
					h && !Xa(this, h) && l.force && ms(this.contentDOM, l.key, l.keyCode);
			});
	}
	setState(e) {
		if (0 != this.updateState)
		...
		try {
			...
			(this.viewState = new _l(e)),
				(this.plugins = e.facet(Fo).map((e) => new Jo(e))),
	...
	updatePlugins(e) {
		let t = e.startState.facet(Fo),
			i = e.state.facet(Fo);
		if (t != i) {
			let n = [];
			for (let r of i) {
				let i = t.indexOf(r);
				if (i < 0) n.push(new Jo(r));
				else {
		...
		for (let e of this.plugins) {
			...
			if (t && t.docViewUpdate)
				try {
					...
					No(this.state, e, "doc view update listener");
				}
		}
	}
	measure(e = !0) {
		...
		try {
			for (let e = 0; ; e++) {
				if (s < 0)
					if (xs(i)) (r = -1), (s = this.viewState.heightMap.height);
					else {
				...
				let l = a.map((e) => {
						try {
							...
							return No(this.state, e), Jl;
						}
					}),
					h = ua.create(this, this.state, []),
					c = !1;
				(h.flags |= o),
					t ? (t.flags |= o) : (t = h),
					(this.updateState = 2),
		...
		if (t && !t.empty) for (let e of this.state.facet(jo)) e(t);
	}
	get themeClasses() {
		return (
			Vl + " " + (this.state.facet(ql) ? Wl : Ll) + " " + this.state.facet(jl)
		);
	}
	updateAttrs() {
		let e = th(this, ea, {
			...
			t = {
				...
				class: "cm-content",
				style: `${Vs.tabSize}: ${this.state.tabSize}`,
				role: "textbox",
				"aria-multiline": "true",
			};
		this.state.readOnly && (t["aria-readonly"] = "true"), th(this, ta, t);
		let i = this.observer.ignore(() => {
			let i = Fs(this.contentDOM, this.contentAttrs, t),
				n = Fs(this.dom, this.editorAttrs, e);
			return i || n;
		});
	...
	mountStyles() {
		this.styleModules = this.state.facet(ha);
		let e = this.state.facet(Fl.cspNonce);
		Yr.mount(
			this.root,
			this.styleModules.concat(Yl).reverse(),
			e ? { nonce: e } : void 0,
		);
	}
	readMeasured() {
	...
	moveByChar(e, t, i) {
		return Pa(this, e, va(this, e, t, i));
	}
	moveByGroup(e, t) {
		return Pa(
			this,
	...
	visualLineSide(e, t) {
		let i = this.bidiSpans(e),
			...
			r = i[t ? i.length - 1 : 0];
		return Cn.cursor(r.side(t, n) + e.from, r.forward(!t, n) ? 1 : -1);
	}
	moveToLineBoundary(e, t, i = !0) {
		return (function (e, t, i, n) {
			let r = Qa(e, t.head),
				s =
					n && r.type == eo.Text && (e.lineWrapping || r.widgetLineBreaks)
						? e.coordsAtPos(
			...
			if (s) {
				let t = e.dom.getBoundingClientRect(),
					...
					o = e.posAtCoords({
						x: i == (n == Oo.LTR) ? t.right - 1 : t.left + 1,
						y: (s.top + s.bottom) / 2,
					});
				if (null != o) return Cn.cursor(o, i ? -1 : 1);
			}
			return Cn.cursor(i ? r.to : r.from, i ? -1 : 1);
		})(this, e, t, i);
	}
	moveVertically(e, t, i) {
		return Pa(
			...
			(function (e, t, i, n) {
				let r = t.head,
					s = i ? 1 : -1;
				if (r == (i ? e.state.doc.length : 0)) return Cn.cursor(r, t.assoc);
				let o,
					a = t.goalColumn,
	...
	posAtCoords(e, t = !0) {
		return this.readMeasured(), wa(this, e, t);
	}
	coordsAtPos(e, t = 1) {
		this.readMeasured();
		...
		let n = this.state.doc.lineAt(e),
			r = this.bidiSpans(n);
		return ls(i, (r[Qo.find(r, e - n.from, -1, t)].dir == Oo.LTR) == t > 0);
	}
	coordsForChar(e) {
	...
	bidiSpans(e) {
		if (e.length > Kl) return To(e.length);
		let t,
		...
		for (let n of this.bidiCache)
			if (
				n.from == e.from &&
				n.dir == i &&
				(n.fresh || vo(n.isolates, (t = oa(this, e))))
			)
				return n.order;
		t || (t = oa(this, e));
		let n = (function (e, t, i) {
			if (!e) return [new Qo(0, 0, t == mo ? 1 : 0)];
			if (t == po && !i.length && !ko.test(e)) return To(e.length);
			if (i.length) for (; e.length > $o.length; ) $o[$o.length] = 256;
			let n = [],
				r = t == po ? 0 : 1;
			return Zo(e, r, r, i, 0, e.length, n), n;
		})(e.text, i, t);
		return this.bidiCache.push(new eh(e.from, e.to, i, t, !0, n)), n;
	}
	get hasFocus() {
		var e;
		return (
	...
	scrollSnapshot() {
		...
		return Io.of(new Bo(Cn.cursor(i.from), "start", "start", i.top - e, t, !0));
	}
	setTabFocusMode(e) {
		null == e
	...
	static domEventHandlers(e) {
		return Ko.define(() => ({}), { eventHandlers: e });
	}
	static domEventObservers(e) {
		return Ko.define(() => ({}), { eventObservers: e });
	}
	static theme(e, t) {
		let i = Yr.newName(),
			n = [jl.of(i), ha.of(zl(`.${i}`, e))];
		return t && t.dark && n.push(ql.of(!0)), n;
	}
	static baseTheme(e) {
		return Un.lowest(ha.of(zl("." + Vl, e, Dl)));
	}
	static findFromDOM(e) {
		var t;
		let i = e.querySelector(".cm-content"),
			n = (i && ks.get(i)) || ks.get(e);
		return (
...
(Fl.styleModule = ha),
	(Fl.inputHandler = qo),
	(Fl.clipboardInputFilter = Lo),
	(Fl.clipboardOutputFilter = Wo),
	(Fl.scrollHandler = Yo),
	(Fl.focusChangeEffect = Vo),
	(Fl.perLineTextDirection = Do),
	(Fl.exceptionSink = Eo),
	(Fl.updateListener = jo),
	(Fl.editable = Go),
	(Fl.mouseSelectionStyle = Ro),
	(Fl.dragMovesSelection = Mo),
	(Fl.clickAddsSelectionRange = Xo),
	(Fl.decorations = ia),
	(Fl.outerDecorations = na),
	(Fl.atomicRanges = ra),
	(Fl.bidiIsolatedRanges = sa),
	(Fl.scrollMargins = aa),
	(Fl.darkTheme = ql),
	(Fl.cspNonce = Mn.define({ combine: (e) => (e.length ? e[0] : "") })),
	(Fl.contentAttributes = ta),
	(Fl.editorAttributes = ea),
	(Fl.lineWrapping = Fl.contentAttributes.of({ class: "cm-lineWrapping" })),
	(Fl.announce = cr.define());
const Kl = 4096,
	Jl = {};
class eh {
	constructor(e, t, i, n, r, s) {
	...
	static update(e, t) {
		...
		let i = [],
			n = e.length ? e[e.length - 1].dir : Oo.LTR;
...
const ih = Vs.mac ? "mac" : Vs.windows ? "win" : Vs.linux ? "linux" : "key";
function nh(e, t, i) {
	return (
		t.altKey && (e = "Alt-" + e),
		t.ctrlKey && (e = "Ctrl-" + e),
			...
			keydown: (e, t) =>
				(function (e, t, i, n) {
					...
					let r = (function (e) {
							var t =
								(!(
									(Gr && e.metaKey && e.shiftKey && !e.ctrlKey && !e.altKey) ||
									(Hr && e.shiftKey && e.key && 1 == e.key.length) ||
									"Unidentified" == e.key
								) &&
									e.key) ||
								(e.shiftKey ? Nr : Ur)[e.keyCode] ||
								e.key ||
								"Unidentified";
							return (
								"Esc" == t && (t = "Escape"),
					...
					ah &&
						...
						ah.scope == n &&
						((a = ah.prefix + " "),
						La.indexOf(t.keyCode) < 0 && ((h = !0), (ah = null)));
					let u,
						f,
						d = new Set(),
						O = (e) => {
							...
							: o &&
								...
								? (O(p[a + nh(u, t, !0)]) ||
										(t.shiftKey &&
											...
											O(p[a + nh(f, t, !1)]))) &&
									(l = !0)
								: o && t.shiftKey && O(p[a + nh(r, t, !0)]) && (l = !0),
						!l && O(p._any) && (l = !0));
					h && (l = !0);
									...
									for (let n of e) {
										...
										if (n.any)
											for (let t of e) {
												...
												let { any: r } = n;
												for (let t in e) e[t].run.push((e) => r(e, hh));
											}
										let r = n[t] || n.key;
										if (r)
											for (let t of e)
...
class ch {
	...
	static forRange(e, t, i) {
		if (i.empty) {
			...
			let r = uh(e);
			return [
				new ch(t, n.left - r.left, n.top - r.top, null, n.bottom - n.top),
			];
		}
		return (function (e, t, i) {
			...
			let n = Math.max(i.from, e.viewport.from),
				...
				d = Qa(e, n),
				O = Qa(e, r),
				p = d.type == eo.Text ? d : null,
				m = O.type == eo.Text ? O : null;
			p && (e.lineWrapping || d.widgetLineBreaks) && (p = fh(e, n, 1, p));
			m && (e.lineWrapping || O.widgetLineBreaks) && (m = fh(e, r, -1, m));
			if (p && m && p.from == m.from && p.to == m.to)
				return x(b(i.from, i.to, p));
			{
				let t = p ? b(i.from, null, p) : y(d, !1),
					n = m ? b(null, i.to, m) : y(O, !0),
					r = [];
				return (
					(p || d).to < (m || O).from - (p && m ? 1 : 0) ||
					(d.widgetLineBreaks > 1 && t.bottom + e.defaultLineHeight / 2 < n.top)
						? r.push(g(u, t.bottom, f, n.top))
						: t.bottom < n.top &&
							e.elementAtHeight((t.bottom + n.top) / 2).type == eo.Text &&
							(t.bottom = n.top = (t.bottom + n.top) / 2),
					x(t).concat(r).concat(x(n))
				);
			}
			function g(e, i, n, r) {
				return new ch(t, e - l.left, i - l.top, n - e, r - i);
			}
			...
			function b(t, i, n) {
				...
				function l(t, i, l, h, c) {
					let d = e.coordsAtPos(t, t == n.to ? -2 : 2),
						O = e.coordsAtPos(l, l == n.from ? 2 : -2);
					d &&
						O &&
						((r = Math.min(d.top, O.top, r)),
						(o = Math.max(d.bottom, O.bottom, o)),
						c == Oo.LTR
							? a.push(s && i ? u : d.left, s && h ? f : O.right)
							: a.push(!s && h ? u : O.left, !s && i ? f : d.right));
				}
...
class dh {
	...
	update(e) {
		e.startState.facet(Oh) != e.state.facet(Oh) && this.setOrder(e.state),
...
const Oh = Mn.define();
function ph(e) {
	return [Ko.define((t) => new dh(t, e)), Oh.of(e)];
}
const mh = Mn.define({
	combine: (e) =>
		kr(
...
function gh(e = {}) {
	return [mh.of(e), bh, Sh, wh, zo.of(!0)];
}
function xh(e) {
	return e.startState.facet(mh) != e.state.facet(mh);
}
const bh = ph({
	above: !0,
	markers(e) {
		...
		for (let r of t.selection.ranges) {
			...
			if (r.empty || i.drawRangeCursor) {
				let t = s
					...
					i = r.empty ? r : Cn.cursor(r.head, r.head > r.anchor ? -1 : 1);
				for (let r of ch.forRange(e, t, i)) n.push(r);
			}
		}
		return n;
	},
	update(e, t) {
		...
		let i = xh(e);
		return i && yh(e.state, t), e.docChanged || e.selectionSet || i;
	},
	mount(e, t) {
		yh(t.state, e);
	},
...
function yh(e, t) {
	t.style.animationDuration = e.facet(mh).cursorBlinkRate + "ms";
}
const Sh = ph({
		above: !1,
		markers: (e) =>
			e.state.selection.ranges
				.map((t) =>
					t.empty ? [] : ch.forRange(e, "cm-selectionBackground", t),
				)
				.reduce((e, t) => e.concat(t)),
		update: (e, t) =>
			e.docChanged || e.selectionSet || e.viewportChanged || xh(e),
...
class Qh {
	...
	createDeco(e) {
		...
		for (let { from: t, to: n } of (function (e, t) {
			...
			kh(e.state.doc, this.regexp, t, n, (t, n) => this.addMatch(n, e, t, i));
		return t.finish();
	}
	updateDeco(e, t) {
		let i = 1e9,
		...
		for (let r of e.visibleRanges) {
			...
			if (o > s) {
				...
				if (i == n)
					...
					kh(e.state.doc, this.regexp, a, l, (t, i) =>
...
const Th = Mn.define({
	combine(e) {
		let t = kr(e, { render: null, specialChars: $h, addSpecialChars: null });
		return (
			(t.replaceTabs = !(function () {
				var e;
				if (null == Zh && "undefined" != typeof document && document.body) {
				...
				return Zh || !1;
			})()) && (t.specialChars = new RegExp("\t|" + t.specialChars.source, vh)),
			t.addSpecialChars &&
				...
				class {
					constructor(e) {
						(this.view = e),
							...
							(this.decorator = this.makeDecorator(e.state.facet(Th))),
						...
						return new Qh({
							...
							decoration: (t, i, n) => {
								...
								return (
									...
									(this.decorationCache[s] = to.replace({
										widget: new Ah(e, s),
									}))
								);
							},
					...
					update(e) {
						let t = e.state.facet(Th);
						e.startState.facet(Th) != t
	...
	toDOM(e) {
		let t = (function (e) {
			...
			i =
				...
				" " +
				(Ph[this.code] || "0x" + this.code.toString(16)),
...
const Mh = to.line({ class: "cm-activeLine" }),
	Rh = Ko.fromClass(
		class {
			constructor(e) {
			...
			getDeco(e) {
				...
				for (let n of e.state.selection.ranges) {
					...
					r.from > t && (i.push(Mh.range(r.from)), (t = r.from));
				}
				return to.set(i);
			}
		},
...
class Eh extends Js {
	...
	coordsAt(e) {
		let t = e.firstChild ? is(e.firstChild) : [];
		if (!t.length) return null;
		let i = window.getComputedStyle(e.parentNode),
			n = ls(t[0], "rtl" != i.direction),
			...
			constructor(t) {
				(this.view = t),
					(this.placeholder = to.set([
						to.widget({ widget: new Eh(e), side: 1 }).range(0),
					]));
			}
			get decorations() {
...
(qh.prototype.elementClass = ""),
	(qh.prototype.toDOM = void 0),
	(qh.prototype.mapMode = Sn.TrackBefore),
	(qh.prototype.startSide = qh.prototype.endSide = -1),
	(qh.prototype.point = !0);
const Vh = Mn.define(),
	Lh = Mn.define(),
	Wh = Mn.define(),
	Dh = Mn.define({ combine: (e) => e.some((e) => e) });
const zh = Ko.fromClass(
	class {
		constructor(e) {
			(this.view = e),
				...
				(this.gutters = e.state.facet(Wh).map((t) => new Uh(e, t)));
			for (let e of this.gutters) this.dom.appendChild(e.dom);
			(this.fixed = !e.state.facet(Dh)),
		...
		update(e) {
			...
			e.geometryChanged &&
				(this.dom.style.minHeight =
					this.view.contentHeight / this.view.scaleY + "px"),
				this.view.state.facet(Dh) != !this.fixed &&
		...
		syncGutters(e) {
			...
			e && this.dom.remove();
			let i = Zr.iter(this.view.state.facet(Vh), this.view.viewport.from),
				n = [],
				r = this.gutters.map(
					(e) => new Ih(e, this.view.viewport, -this.view.documentPadding.top),
				);
	...
	{
		provide: (e) =>
			Fl.scrollMargins.of((t) => {
				let i = t.plugin(e);
				return i && 0 != i.gutters.length && i.fixed
					? t.textDirection == Oo.LTR
...
class Ih {
	constructor(e, t, i) {
		(this.gutter = e),
			(this.height = i),
			(this.i = 0),
			(this.cursor = Zr.iter(e.markers, t.from));
	}
	addElement(e, t, i) {
		let { gutter: n } = this,
	...
	line(e, t, i) {
		let n = [];
		Bh(this.cursor, n, t.from), i.length && (n = n.concat(i));
...
class Uh {
	constructor(e, t) {
		...
		(this.markers = Yh(t.markers(e))),
			t.initialSpacer &&
				((this.spacer = new Nh(e, 0, 0, [t.initialSpacer(e)])),
	...
	update(e) {
		let t = this.markers;
		if (
			((this.markers = Yh(this.config.markers(e.view))),
		...
		return (
			!Zr.eq(this.markers, t, i.from, i.to) ||
...
function Jh(e, t) {
	return e.state.facet(Fh).formatNumber(t, e.state);
}
const ec = Wh.compute([Fh], (e) => ({
	class: "cm-lineNumbers",
	renderEmptyElements: !1,
	markers: (e) => e.state.facet(Gh),
	lineMarker: (e, t, i) =>
		i.some((e) => e.toDOM)
			? null
			: new Kh(Jh(e, e.state.doc.lineAt(t.from).number)),
	widgetMarker: (e, t, i) => {
		for (let n of e.state.facet(Hh)) {
			let r = n(e, t, i);
			if (r) return r;
		}
		return null;
	},
	lineMarkerChange: (e) => e.startState.facet(Fh) != e.state.facet(Fh),
	initialSpacer: (e) => new Kh(Jh(e, ic(e.state.doc.lines))),
	updateSpacer(e, t) {
		let i = Jh(t.view, ic(t.view.state.doc.lines));
		return i == e.number ? e : new Kh(i);
	},
	domEventHandlers: e.facet(Fh).domEventHandlers,
}));
function tc(e = {}) {
	return [Fh.of(e), [zh], ec];
}
function ic(e) {
	let t = 9;
	for (; t < e; ) t = 10 * t + 9;
...
const nc = new (class extends qh {
		constructor() {
			super(...arguments), (this.elementClass = "cm-activeLineGutter");
		}
	})(),
	rc = Vh.compute(["selection"], (e) => {
		let t = [],
			i = -1;
		for (let n of e.selection.ranges) {
			let r = e.doc.lineAt(n.head).from;
			r > i && ((i = r), t.push(nc.range(r)));
		}
		return Zr.of(t);
	});
const sc = 1024;
...
class lc {
	...
	add(e) {
		...
		return (
			"function" != typeof e && (e = uc.match(e)),
			(t) => {
				let i = e(t);
...
(lc.closedBy = new lc({ deserialize: (e) => e.split(" ") })),
	(lc.openedBy = new lc({ deserialize: (e) => e.split(" ") })),
	(lc.group = new lc({ deserialize: (e) => e.split(" ") })),
	(lc.isolate = new lc({
		deserialize: (e) => {
	...
	(lc.contextHash = new lc({ perNode: !0 })),
	(lc.lookAhead = new lc({ perNode: !0 })),
	(lc.mounted = new lc({ perNode: !0 }));
class hc {
	constructor(e, t, i) {
		(this.tree = e), (this.overlay = t), (this.parser = i);
	}
	static get(e) {
		return e && e.props && e.props[lc.mounted.id];
	}
}
...
class uc {
	...
	static define(e) {
		let t = e.props && e.props.length ? Object.create(null) : cc,
			i =
				(e.top ? 1 : 0) |
				(e.skipped ? 2 : 0) |
				(e.error ? 4 : 0) |
				(null == e.name ? 8 : 0),
			n = new uc(e.name || "", t, e.id, i);
		if (e.props)
	...
	static match(e) {
		...
		return (e) => {
			for (let i = e.prop(lc.group), n = -1; n < (i ? i.length : 0); n++) {
...
uc.none = new uc("", Object.create(null), 0, 8);
class fc {
	constructor(e) {
		this.types = e;
		for (let t = 0; t < e.length; t++)
	...
	extend(...e) {
		...
		for (let i of this.types) {
			...
			t.push(n ? new uc(i.name, n, i.id, i.flags) : i);
		}
		return new fc(t);
	}
}
...
class mc {
	...
	cursorAt(e, t = 0, i = 0) {
		let n = dc.get(this) || this.topNode,
			r = new Tc(n);
		return r.moveTo(e, t), dc.set(this, r._tree), r;
	}
	get topNode() {
		return new wc(this, 0, 0, null);
	}
	resolve(e, t = 0) {
		let i = yc(dc.get(this) || this.topNode, e, t, !1);
		return dc.set(this, i), i;
	}
	resolveInner(e, t = 0) {
		let i = yc(Oc.get(this) || this.topNode, e, t, !0);
		return Oc.set(this, i), i;
	}
	resolveStack(e, t = 0) {
		return (function (e, t, i) {
			let n = e.resolveInner(t, i),
				r = null;
			for (let e = n instanceof wc ? n : n.context.parent; e; e = e.parent)
				if (e.index < 0) {
					let s = e.parent;
					...
					if (
						...
						let o = new wc(s.tree, s.overlay[0].from + e.from, -1, e);
						(r || (r = [n])).push(yc(o, t, i, !1));
					}
				}
			return r ? Pc(r) : n;
		})(this, e, t);
	...
	iterate(e) {
		let { enter: t, leave: i, from: n = 0, to: r = this.length } = e,
			s = e.mode || 0,
			o = (s & pc.IncludeAnonymous) > 0;
		for (let e = this.cursor(s | pc.IncludeAnonymous); ; ) {
			let s = !1;
			if (
				e.from <= r &&
				e.to >= n &&
	...
	balance(e = {}) {
		return this.children.length <= 8
			...
			: Xc(
					...
					0,
					this.length,
					(e, t, i) => new mc(this.type, e, t, i, this.propValues),
					e.makeTree || ((e, t, i) => new mc(uc.none, e, t, i)),
				);
	}
	static build(e) {
		return (function (e) {
			...
			let {
					buffer: i,
					nodeSet: n,
					maxBufferLength: r = sc,
					reused: s = [],
					minRepeatType: o = n.types.length,
				} = e,
				a = Array.isArray(i) ? new gc(i, i.length) : i,
				l = n.types,
				h = 0,
				c = 0;
			function u(e, t, i, x, b, y) {
				let { id: S, start: w, end: k, size: Q } = a,
					v = c,
					$ = h;
				for (; Q < 0; ) {
					if ((a.next(), -1 == Q)) {
					...
					if (-3 == Q) return void (h = S);
					if (-4 == Q) return void (c = S);
					...
					for (; a.pos > e; )
						n >= 0 && a.id == n && a.size >= 0
							...
							: y > 2500
								...
								: u(w, e, t, i, n, y + 1);
					if (
						(n >= 0 && s > 0 && s < t.length && O(t, i, w, s, w, l, n, v, $),
						t.reverse(),
						i.reverse(),
						n > -1 && s > 0)
					) {
						let e = d(T, $);
						P = Xc(T, t, i, 0, t.length, 0, k - w, e, e);
					} else P = p(T, t, i, k - w, v - k, $);
				}
				i.push(P), x.push(_);
			}
			function f(e, t, i, s) {
				...
				if (l) {
					...
					for (let e = o.length - 3, i = 0; e >= 0; e -= 3)
						(t[i++] = o[e]),
							...
							(t[i++] = o[e + 2] - r),
							(t[i++] = i);
					i.push(new xc(t, o[2] - r, n)), s.push(r - e);
				}
			}
			function d(e, t) {
				return (i, n, r) => {
					let s,
						...
						a = 0,
						l = i.length - 1;
					if (l >= 0 && (s = i[l]) instanceof mc) {
						if (!l && s.type == e && s.length == r) return s;
						(o = s.prop(lc.lookAhead)) && (a = n[l] + s.length + o);
					}
			...
			function p(e, t, i, n, r, s, o) {
				if (s) {
					let e = [lc.contextHash, s];
					o = o ? [e].concat(o) : [e];
				}
				if (r > 25) {
					let e = [lc.lookAhead, r];
					o = o ? [e].concat(o) : [e];
				}
				return new mc(e, t, i, n, o);
			}
			function m(e, t) {
				let i = a.fork(),
					n = 0,
			...
			let y =
				null !== (t = e.length) && void 0 !== t
					...
					: x.length
						? b[0] + x[0].length
						: 0;
			return new mc(l[e.topID], x.reverse(), b.reverse(), y);
		})(e);
	}
}
mc.empty = new mc(uc.none, [], [], 0);
class gc {
	constructor(e, t) {
	...
	fork() {
		return new gc(this.buffer, this.index);
	}
}
class xc {
	constructor(e, t, i) {
	...
	findChild(e, t, i, n, r) {
		...
		for (
			let a = e;
			a != t && !(bc(r, n, s[a + 1], s[a + 2]) && ((o = a), i > 0));
			a = s[a + 3]
		);
		return o;
	}
...
function yc(e, t, i, n) {
	for (
		...
		let t = !n && e instanceof wc && e.index < 0 ? null : e.parent;
		if (!t) return e;
		e = t;
	}
	let s = n ? 0 : pc.IgnoreOverlays;
	if (n)
...
class Sc {
	...
	getChildren(e, t = null, i = null) {
		return kc(this, e, t, i);
	}
	resolve(e, t = 0) {
		return yc(this, e, t, !1);
	}
	resolveInner(e, t = 0) {
		return yc(this, e, t, !0);
	}
	matchContext(e) {
...
class wc extends Sc {
	...
	nextChild(e, t, i, n, r = 0) {
		for (let s = this; ; ) {
			for (
				...
				let l = o[e],
					h = a[e] + s.from;
				if (bc(n, i, h, h + l.length))
					if (l instanceof xc) {
						if (r & pc.ExcludeBuffers) continue;
						let o = l.findChild(0, l.buffer.length, t, i - h, n);
						if (o > -1) return new $c(new vc(s, l, e, h), null, o);
					} else if (r & pc.IncludeAnonymous || !l.type.isAnonymous || _c(l)) {
						let o;
						if (!(r & pc.IgnoreMounts) && (o = hc.get(l)) && !o.overlay)
							return new wc(o.tree, h, e, s);
						let a = new wc(l, h, e, s);
						return r & pc.IncludeAnonymous || !a.type.isAnonymous
							? a
							: a.nextChild(t < 0 ? l.children.length - 1 : 0, t, i, n);
					}
			}
			if (r & pc.IncludeAnonymous || !s.type.isAnonymous) return null;
			if (
				((e =
					s.index >= 0
						? s.index + t
	...
	enter(e, t, i = 0) {
		let n;
		if (!(i & pc.IgnoreOverlays) && (n = hc.get(this._tree)) && n.overlay) {
			let i = e - this.from;
			for (let { from: e, to: r } of n.overlay)
				if ((t > 0 ? e <= i : e < i) && (t < 0 ? r >= i : r > i))
					return new wc(n.tree, n.overlay[0].from + this.from, -1, this);
		}
...
class $c extends Sc {
	...
	child(e, t, i) {
		...
		return r < 0 ? null : new $c(this.context, this, r);
	}
	get firstChild() {
	...
	enter(e, t, i = 0) {
		if (i & pc.ExcludeBuffers) return null;
		let { buffer: n } = this.context,
			r = n.findChild(
				this.index + 4,
				n.buffer[this.index + 3],
	...
	get nextSibling() {
		...
		return t <
			...
			? new $c(this.context, this._parent, t)
	...
	toTree() {
		...
		return new mc(this.type, e, t, this.to - this.from);
	}
	toString() {
...
function Pc(e) {
	...
	let n = i instanceof wc && i.index < 0 ? null : i.parent,
		r = e.slice();
	return n ? (r[t] = n) : r.splice(t, 1), new Zc(r, i);
}
class Zc {
	constructor(e, t) {
...
class Tc {
	...
	enter(e, t, i = this.mode) {
		return this.buffer
			? !(i & pc.ExcludeBuffers) && this.enterChild(1, e, t)
			: this.yield(this._tree.enter(e, t, i));
	}
	parent() {
		if (!this.buffer)
			return this.yieldNode(
				this.mode & pc.IncludeAnonymous
					? this._tree._parent
					: this._tree.parent,
			);
	...
	get node() {
		...
		for (let e = i; e < this.stack.length; e++)
			t = new $c(this.buffer, t, this.stack[e]);
		return (this.bufferNode = new $c(this.buffer, t, this.index));
	}
	get tree() {
	...
	matchContext(e) {
		...
		for (let n = e.length - 1, r = this.stack.length - 1; n >= 0; r--) {
			if (r < 0) return Qc(this._tree, e, n);
...
function _c(e) {
	return e.children.some(
		(e) => e instanceof xc || !e.type.isAnonymous || _c(e),
	);
}
const Cc = new WeakMap();
function Ac(e, t) {
	if (!e.isAnonymous || t instanceof xc || t.type != e) return 1;
	let i = Cc.get(t);
	if (null == i) {
		i = 1;
		for (let n of t.children) {
			if (n.type != e || !(n instanceof mc)) {
				i = 1;
				break;
			}
			i += Ac(e, n);
...
function Xc(e, t, i, n, r, s, o, a, l) {
	let h = 0;
	for (let i = n; i < r; i++) h += Ac(e, t[i]);
		...
		(function t(i, n, r, o, a) {
			for (let h = r; h < o; ) {
				...
				if (h == r + 1) {
					...
					u.push(Xc(e, i, n, r, h, d, t, null, l));
				}
				f.push(d + a - s);
			}
		})(t, i, n, r, 0),
...
class Mc {
	...
	set(e, t) {
		e instanceof $c
			...
			: e instanceof wc && this.map.set(e.tree, t);
	}
	get(e) {
...
class Rc {
	...
	static addTree(e, t = [], i = !1) {
		let n = [new Rc(0, e.length, e, 0, !1, i)];
				...
				for (; s && s.from < c; ) {
					...
					if (a >= t.from || c <= t.to || l) {
						let e = Math.max(t.from, a) - l,
							i = Math.min(t.to, c) - l;
						t = e >= i ? null : new Rc(e, i, t.tree, t.offset + l, o > 0, !!h);
					}
...
class Ec {
	startParse(e, t, i) {
		return (
			"string" == typeof e && (e = new jc(e)),
			(i = i
				? i.length
					? i.map((e) => new ac(e.from, e.to))
					: [new ac(0, 0)]
				: [new ac(0, e.length)]),
...
function qc(e) {
	return (t, i, n, r) => new zc(t, e, i, n, r);
}
class Vc {
	constructor(e, t, i, n, r) {
		(this.parser = e),
...
class zc {
	...
	advance() {
			...
			return (
				null != this.stoppedAt &&
					(e = new mc(
						...
						e.positions,
						e.length,
						e.propValues.concat([[Dc, this.stoppedAt]]),
					)),
				e
			);
		}
		...
		if (t) {
			...
			(i[lc.mounted.id] = new hc(t, e.overlay, e.parser)), (e.target.props = i);
		}
		return null;
	}
	get parsedPos() {
	...
	startInner() {
		let e = new Nc(this.fragments),
			t = null,
			i = null,
			n = new Tc(
				new wc(this.baseTree, this.ranges[0].from, 0, null),
				pc.IncludeAnonymous | pc.IgnoreMounts,
			);
		e: for (let r, s; ; ) {
			let o,
				a = !0;
			if (null != this.stoppedAt && n.from >= this.stoppedAt) a = !1;
				...
				a = !1;
			} else if (i && (s = Yc(i.ranges, n.from, n.to))) a = 2 != s;
			else if (
				!n.type.isAnonymous &&
				...
				if ("function" == typeof r.overlay)
					...
					let e = Gc(
						this.ranges,
						r.overlay || (n.from < n.to ? [new ac(n.from, n.to)] : []),
					);
					e.length && Lc(e),
						(!e.length && r.overlay) ||
							this.inner.push(
								new Vc(
									r.parser,
									e.length
										? r.parser.startParse(this.input, Fc(s, e), e)
										: r.parser.startParse(""),
									r.overlay
										? r.overlay.map(
												(e) => new ac(e.from - n.from, e.to - n.from),
											)
										: null,
									n.tree,
				...
				t &&
				(o = t.predicate(n)) &&
				(!0 === o && (o = new ac(n.from, n.to)), o.from < o.to)
			) {
					...
					if (t && !--t.depth) {
						...
						e.length &&
							...
							this.inner.splice(
								...
								new Vc(
									t.parser,
									t.parser.startParse(this.input, Fc(t.mounts, e), e),
									t.ranges.map((e) => new ac(e.from - t.start, e.to - t.start)),
									t.target,
									e[0].from,
								),
							)),
...
function Ic(e) {
	...
	r.children[s] = (function e(n, r, s, h, c, u) {
		...
		let g = u
			...
			: t.toTree();
		return (
			d.push(g), O.push(p - h), Bc(o, a[f + 3], r, d, O, h), new mc(s, d, O, c)
		);
	})(0, a.length, uc.none, 0, o.length, i.length - 1);
	for (let t of l) {
		let i = e.tree.children[t],
			n = e.tree.positions[t];
		e.yield(new wc(i, n + e.from, t, e._tree));
	}
}
class Uc {
	constructor(e, t) {
		(this.offset = t),
			(this.done = !1),
			(this.cursor = e.cursor(pc.IncludeAnonymous | pc.IgnoreMounts));
	}
	moveTo(e) {
		let { cursor: t } = this,
			i = e - this.offset;
		for (; !this.done && t.from < i; )
			(t.to >= e && t.enter(i, 1, pc.IgnoreOverlays | pc.ExcludeBuffers)) ||
				t.next(!1) ||
				(this.done = !0);
	}
	hasNode(e) {
...
let Nc = class {
	constructor(e) {
		...
		if (((this.fragments = e), (this.curTo = 0), (this.fragI = 0), e.length)) {
			...
			(this.curTo = null !== (t = i.tree.prop(Dc)) && void 0 !== t ? t : i.to),
				(this.inner = new Uc(i.tree, -i.offset));
	...
	nextFrag() {
		...
		if ((this.fragI++, this.fragI == this.fragments.length))
			...
			(this.curTo = null !== (e = t.tree.prop(Dc)) && void 0 !== e ? e : t.to),
				(this.inner = new Uc(t.tree, -t.offset));
		}
	}
	findMounts(e, t) {
		var i;
		...
		if (this.inner) {
			...
			for (let e = this.inner.cursor.node; e; e = e.parent) {
				let r =
					null === (i = e.tree) || void 0 === i ? void 0 : i.prop(lc.mounted);
				if (r && r.parser == t)
	...
	for (let r = 1, s = 0; r < e.length; r++) {
		...
		for (; s < n.length; s++) {
			...
			e.to <= o ||
				...
				e.from < o
					? ((i[s] = new ac(e.from, o)),
						e.to > a && i.splice(s + 1, 0, new ac(a, e.to)))
					: e.to > a
						? (i[s--] = new ac(a, e.to))
						: i.splice(s--, 1));
		}
...
function Fc(e, t) {
	...
	for (let { pos: n, mount: r, frag: s } of e) {
		...
		if (r.overlay) {
			let o = Hc(
				t,
				r.overlay.map((e) => new ac(e.from + n, e.to + n)),
				a,
				l,
			);
			for (let t = 0, n = a; ; t++) {
...
class Jc {
	...
	static define(e, t) {
		...
		if ((e instanceof Jc && (t = e), null == t ? void 0 : t.base))
...
class tu {
	constructor(e) {
		(this.name = e), (this.instances = []), (this.id = eu++);
	}
	static get(e, t) {
		if (!t.length) return e;
		...
		for (let t of e.set)
			if (!t.modified.length) for (let e of s) n.push(tu.get(t, e));
		return r;
	}
}
function iu(e) {
	...
	for (let i in e) {
		...
		for (let e of i.split(" "))
			if (e) {
				...
				let l = new ru(n, r, o > 0 ? i.slice(0, o) : null);
				t[a] = l.sort(t[a]);
			}
	}
	return nu.add(t);
...
function ou(e, t, i, n = 0, r = e.length) {
	let s = new au(n, Array.isArray(t) ? t : [t], i);
	s.highlightRange(e.cursor(), n, r, "", s.highlighters), s.flush(r);
}
ru.empty = new ru([], 2, null);
class au {
	constructor(e, t, i) {
...
const lu = Jc.define,
	...
	ku = {
		...
		unit: lu(xu),
		modifier: lu(xu),
		operatorKeyword: lu(xu),
		controlKeyword: lu(xu),
		definitionKeyword: lu(xu),
		moduleKeyword: lu(xu),
		operator: bu,
		derefOperator: lu(bu),
		arithmeticOperator: lu(bu),
		logicOperator: lu(bu),
		bitwiseOperator: lu(bu),
		compareOperator: lu(bu),
		updateOperator: lu(bu),
		definitionOperator: lu(bu),
		typeOperator: lu(bu),
		controlOperator: lu(bu),
		punctuation: yu,
		separator: lu(yu),
		bracket: Su,
		angleBracket: lu(Su),
		...
		documentMeta: lu(wu),
		annotation: lu(wu),
		processingInstruction: lu(wu),
		definition: Jc.defineModifier("definition"),
		constant: Jc.defineModifier("constant"),
		function: Jc.defineModifier("function"),
		standard: Jc.defineModifier("standard"),
		local: Jc.defineModifier("local"),
		special: Jc.defineModifier("special"),
	};
for (let e in ku) {
	let t = ku[e];
	t instanceof Jc && (t.name = e);
}
var Qu;
su([
	{ tag: ku.link, class: "tok-link" },
	{ tag: ku.heading, class: "tok-heading" },
	{ tag: ku.emphasis, class: "tok-emphasis" },
	{ tag: ku.strong, class: "tok-strong" },
	{ tag: ku.keyword, class: "tok-keyword" },
	{ tag: ku.atom, class: "tok-atom" },
	{ tag: ku.bool, class: "tok-bool" },
	{ tag: ku.url, class: "tok-url" },
	{ tag: ku.labelName, class: "tok-labelName" },
	{ tag: ku.inserted, class: "tok-inserted" },
	{ tag: ku.deleted, class: "tok-deleted" },
	{ tag: ku.literal, class: "tok-literal" },
	{ tag: ku.string, class: "tok-string" },
	{ tag: ku.number, class: "tok-number" },
	{ tag: [ku.regexp, ku.escape, ku.special(ku.string)], class: "tok-string2" },
	{ tag: ku.variableName, class: "tok-variableName" },
	{ tag: ku.local(ku.variableName), class: "tok-variableName tok-local" },
	{
		tag: ku.definition(ku.variableName),
		class: "tok-variableName tok-definition",
	},
	{ tag: ku.special(ku.variableName), class: "tok-variableName2" },
	{
		tag: ku.definition(ku.propertyName),
		class: "tok-propertyName tok-definition",
	},
	{ tag: ku.typeName, class: "tok-typeName" },
	{ tag: ku.namespace, class: "tok-namespace" },
	{ tag: ku.className, class: "tok-className" },
	{ tag: ku.macroName, class: "tok-macroName" },
	{ tag: ku.propertyName, class: "tok-propertyName" },
	{ tag: ku.operator, class: "tok-operator" },
	{ tag: ku.comment, class: "tok-comment" },
	{ tag: ku.meta, class: "tok-meta" },
	{ tag: ku.invalid, class: "tok-invalid" },
	{ tag: ku.punctuation, class: "tok-punctuation" },
]);
const vu = new lc();
function $u(e) {
	return Mn.define({ combine: e ? (t) => t.concat(e) : void 0 });
}
const Pu = new lc();
class Zu {
	constructor(e, t, i = [], n = "") {
	...
	isActiveAt(e, t, i = -1) {
		return Tu(e, t, i).type.prop(vu) == this.data;
	}
	findRegions(e) {
		let t = e.facet(Lu);
		...
		let i = [],
			n = (e, t) => {
				...
				let r = e.prop(lc.mounted);
				if (r) {
					if (r.tree.prop(vu) == this.data) {
						if (r.overlay)
				...
				for (let i = 0; i < e.children.length; i++) {
					let r = e.children[i];
					r instanceof mc && n(r, e.positions[i] + t);
				}
			};
		return n(Cu(e), 0), i;
	}
...
function Tu(e, t, i) {
	...
	if (!n || n.allowsNesting)
		for (let e = r; e; e = e.enter(t, i, pc.ExcludeBuffers))
			e.type.isTop && (r = e);
	return r;
}
Zu.setState = cr.define();
class _u extends Zu {
	constructor(e, t, i) {
		super(e, t, [], i), (this.parser = t);
	}
	static define(e) {
		let t = $u(e.languageData);
		return new _u(
			t,
			e.parser.configure({ props: [vu.add((e) => (e.isTop ? t : void 0))] }),
			e.name,
		);
	}
	configure(e, t) {
		return new _u(this.data, this.parser.configure(e), t || this.name);
	}
	get allowsNesting() {
...
function Cu(e) {
	let t = e.field(Zu.state, !1);
	return t ? t.tree : mc.empty;
}
class Au {
	constructor(e) {
		(this.doc = e),
...
class Mu {
	...
	static create(e, t, i) {
		return new Mu(e, t, [], mc.empty, 0, i, [], null);
	}
	startParse() {
		return this.parser.startParse(new Au(this.state.doc), this.fragments);
	}
	work(e, t) {
		return (
							...
							if (n) {
								if (
									((this.fragments = this.withoutTempSkipped(
										Rc.addTree(n, this.fragments, null != this.parse.stoppedAt),
									)),
									(this.treeLen =
	...
	takeTree() {
		...
		this.parse &&
			...
			(this.tree = t),
			(this.fragments = this.withoutTempSkipped(
				Rc.addTree(this.tree, this.fragments, !0),
			)),
			(this.parse = null));
	}
	withContext(e) {
	...
	withoutTempSkipped(e) {
		for (let t; (t = this.tempSkipped.pop()); ) e = Ru(e, t.from, t.to);
		return e;
	}
	changes(e, t) {
		...
		return new Mu(this.parser, t, i, n, r, s, o, this.scheduleOn);
	}
	updateViewport(e) {
		...
		for (let t = 0; t < this.skipped.length; t++) {
			...
			i < e.to &&
				n > e.from &&
				((this.fragments = Ru(this.fragments, i, n)),
			...
			createParse(t, i, n) {
				...
				return {
					...
					advance() {
						...
						return (this.parsedPos = s), new mc(uc.none, [], [], s - r);
					},
					stoppedAt: null,
					stopAt() {},
				};
...
function Ru(e, t, i) {
	return Rc.applyChanges(e, [{ fromA: t, toA: i, fromB: t, toB: i }]);
}
class Eu {
	constructor(e) {
	...
	apply(e) {
		...
		return t.work(20, i) || t.takeTree(), new Eu(t);
	}
	static init(e) {
		let t = Math.min(3e3, e.doc.length),
			i = Mu.create(e.facet(Lu).parser, e, { from: 0, to: t });
		return i.work(20, t) || i.takeTree(), new Eu(i);
	}
}
Zu.state = Wn.define({
	create: Eu.init,
	update(e, t) {
		for (let e of t.effects) if (e.is(Zu.setState)) return e.value;
		return t.startState.facet(Lu) != t.state.facet(Lu)
			? Eu.init(t.state)
			: e.apply(t);
	},
});
...
const qu =
		"undefined" != typeof navigator &&
		(null === (Qu = navigator.scheduling) || void 0 === Qu
			? void 0
			: Qu.isInputPending)
	...
	Vu = Ko.fromClass(
		class {
			...
			update(e) {
				let t = this.view.state.field(Zu.state).context;
			...
			work(e) {
				...
				let s =
						...
						Math.min(
							this.chunkBudget,
							100,
							e && !qu ? Math.max(25, e.timeRemaining() - 5) : 1e9,
						),
				...
				(this.chunkBudget -= Date.now() - t),
					(a || this.chunkBudget <= 0) &&
						(r.context.takeTree(),
						this.view.dispatch({ effects: Zu.setState.of(new Eu(r.context)) })),
	...
	Lu = Mn.define({
		...
		enables: (e) => [
			Zu.state,
			Vu,
			Fl.contentAttributes.compute([e], (t) => {
				let i = t.facet(e);
...
function Uu(e, t) {
	e instanceof wr && (e = new Nu(e));
	for (let i of e.state.facet(zu)) {
		let n = i(e, t);
...
class Nu {
	constructor(e, t = {}) {
		(this.state = e), (this.options = t), (this.unit = Bu(e));
	}
	lineAt(e, t = 1) {
	...
	countColumn(e, t = e.length) {
		return Lr(e, this.state.tabSize, t);
	}
	lineIndent(e, t = 1) {
		let { text: i, from: n } = this.lineAt(e, t),
...
function Hu(e, t, i) {
	for (let n = e; n; n = n.next) {
		let e = Fu(n.node);
		if (e) return e(Ju.create(t, i, n));
	}
	return 0;
}
function Fu(e) {
	let t = e.type.prop(Gu);
	if (t) return t;
	let i,
		n = e.firstChild;
	if (n && (i = n.type.prop(lc.closedBy))) {
		let t = e.lastChild,
...
function tf({ closing: e, align: t = !0, units: i = 1 }) {
	return (n) => nf(n, t, i, e);
}
...
const rf = (e) => e.baseIndent;
function sf({ except: e, units: t = 1 } = {}) {
	return (i) => {
...
const cf = Mn.define(),
	uf = Mn.define({ combine: (e) => (e.length ? [e[0]] : null) });
function ff(e) {
	let t = e.facet(cf);
	return t.length ? t : e.facet(uf);
}
function df(e, t) {
	let i,
		n = [pf];
	return (
		e instanceof hf &&
			(e.module && n.push(Fl.styleModule.of(e.module)), (i = e.themeType)),
		(null == t ? void 0 : t.fallback)
			? n.push(uf.of(e))
			: i
				? n.push(
						cf.computeN([Fl.darkTheme], (t) =>
							t.facet(Fl.darkTheme) == ("dark" == i) ? [e] : [],
						),
					)
				: n.push(cf.of(e)),
		n
...
class Of {
	constructor(e) {
		(this.markCache = Object.create(null)),
			(this.tree = Cu(e.state)),
			(this.decorations = this.buildDeco(e, ff(e.state))),
	...
	buildDeco(e, t) {
		if (!t || !this.tree.length) return to.none;
		let i = new Tr();
			...
			ou(
				...
				(e, t, n) => {
					i.add(
						e,
						t,
						this.markCache[n] || (this.markCache[n] = to.mark({ class: n })),
					);
				},
				n,
				r,
...
const pf = Un.high(Ko.fromClass(Of, { decorations: (e) => e.decorations })),
	mf = hf.define([
		{ tag: ku.meta, color: "#404740" },
		{ tag: ku.link, textDecoration: "underline" },
		{ tag: ku.heading, textDecoration: "underline", fontWeight: "bold" },
		{ tag: ku.emphasis, fontStyle: "italic" },
		{ tag: ku.strong, fontWeight: "bold" },
		{ tag: ku.strikethrough, textDecoration: "line-through" },
		{ tag: ku.keyword, color: "#708" },
		{
			tag: [ku.atom, ku.bool, ku.url, ku.contentSeparator, ku.labelName],
			color: "#219",
		},
		{ tag: [ku.literal, ku.inserted], color: "#164" },
		{ tag: [ku.string, ku.deleted], color: "#a11" },
		{ tag: [ku.regexp, ku.escape, ku.special(ku.string)], color: "#e40" },
		{ tag: ku.definition(ku.variableName), color: "#00f" },
		{ tag: ku.local(ku.variableName), color: "#30a" },
		{ tag: [ku.typeName, ku.namespace], color: "#085" },
		{ tag: ku.className, color: "#167" },
		{ tag: [ku.special(ku.variableName), ku.macroName], color: "#256" },
		{ tag: ku.definition(ku.propertyName), color: "#00c" },
		{ tag: ku.comment, color: "#940" },
		{ tag: ku.invalid, color: "#f00" },
	]),
	gf = Fl.baseTheme({
	...
	yf = to.mark({ class: "cm-matchingBracket" }),
	Sf = to.mark({ class: "cm-nonmatchingBracket" });
function wf(e) {
	let t = [],
		i = e.matched ? yf : Sf;
	return (
...
const kf = Wn.define({
		...
		update(e, t) {
			...
			for (let e of t.state.selection.ranges) {
				if (!e.empty) continue;
				let r =
					Tf(t.state, e.head, -1, n) ||
					(e.head > 0 && Tf(t.state, e.head - 1, 1, n)) ||
					(n.afterCursor &&
						(Tf(t.state, e.head, 1, n) ||
							(e.head < t.state.doc.length && Tf(t.state, e.head + 1, -1, n))));
				r && (i = i.concat(n.renderMatch(r, t.state)));
			}
			return to.set(i, !0);
		},
		provide: (e) => Fl.decorations.from(e),
	}),
	Qf = [kf, gf];
function vf(e = {}) {
	return [bf.of(e), Qf];
...
const $f = new lc();
function Pf(e, t, i) {
	let n = e.prop(t < 0 ? lc.openedBy : lc.closedBy);
	if (n) return n;
	if (1 == e.name.length) {
...
class Af {
	...
	indentation() {
		...
		return null !== (e = this.overrideIndent) && void 0 !== e
			? e
			: Cf(this.string, null, this.tabSize);
	}
	match(e, t, i) {
		if ("string" == typeof e) {
...
class Rf extends Zu {
	constructor(e) {
		let t,
			...
			n = {
				...
				copyState: r.copyState || Xf,
				indent: r.indent || (() => null),
				languageData: r.languageData || {},
				tokenTable: r.tokenTable || Lf,
				mergeTokens: !1 !== r.mergeTokens,
			};
		var r;
		super(
			i,
			new (class extends Ec {
				createParse(e, i, n) {
					return new qf(t, e, i, n);
				}
			})(),
			[],
			e.name,
			...
			(this.topNode = (function (e, t) {
				let i = uc.define({
					id: Wf.length,
					name: "Document",
					props: [vu.add(() => e), Gu.add(() => (e) => t.getIndent(e))],
					top: !0,
				});
				return Wf.push(i), i;
			})(i, this)),
			(t = this),
			(this.streamParser = n),
			(this.stateAfter = new lc({ perNode: !0 })),
			(this.tokenTable = e.tokenTable ? new If(n.tokenTable) : Uf);
	}
	static define(e) {
		return new Rf(e);
	}
	getIndent(e) {
		...
		i && ((t = Mf.get(e.state)), null != t && t < e.pos - 1e4 && (t = void 0));
		let n,
			r,
			s = Ef(
				this,
		...
		for (; n < e.pos; ) {
			...
			if (t.length) {
				let n = i ? i(t.from) : -1,
					o = new Af(t.text, e.state.tabSize, e.unit, n < 0 ? void 0 : n);
				for (; o.pos < s - t.from; ) Vf(this.streamParser.token, o, r);
		...
		return (
			i && null == t && Mf.set(e.state, o.from),
...
function Ef(e, t, i, n, r) {
	...
	for (let s = t.children.length - 1; s >= 0; s--) {
		let o = t.children[s],
			a = i + t.positions[s],
			l = o instanceof mc && a < r && Ef(e, o, a, n, r);
		if (l) return l;
	}
	return null;
}
function jf(e, t, i, n, r) {
	...
	for (let s = t.children.length - 1; s >= 0; s--) {
		let o,
			a = t.positions[s],
			l = t.children[s];
		if (a < n && l instanceof mc) {
			if (!(o = jf(e, l, i - a, n - a, r))) break;
			return r
				? new mc(
						t.type,
...
let qf = class {
	constructor(e, t, i, n) {
			...
			{ state: o, tree: a } = (function (e, t, i, n, r) {
				for (let r of t) {
					let t,
						...
						a = s <= i && o > i && Ef(e, r.tree, 0 - r.offset, i, o);
					if (
						a &&
						a.pos <= n &&
						(t = jf(e, r.tree, i + r.offset, a.pos + r.offset, !1))
					)
						return { state: a.state, tree: t };
				}
				return {
					state: e.streamParser.startState(r ? Bu(r) : 4),
					tree: mc.empty,
				};
		...
		r &&
			...
			((this.state = this.lang.streamParser.startState(Bu(r.state))),
	...
	parseLine(e) {
		let { line: t, end: i } = this.nextLine(),
			...
			s = new Af(t, e ? e.state.tabSize : 4, e ? Bu(e.state) : 2);
		if (s.eol()) r.blankLine(this.state, s.indentUnit);
		else
			for (; !s.eol(); ) {
				let e = Vf(r.token, s, this.state);
				if (
					(e &&
						(n = this.emitToken(
	...
	finishChunk() {
		...
		(e = new mc(e.type, e.children, e.positions, e.length, [
...
class If {
	constructor(e) {
		(this.extra = e), (this.table = Object.assign(Object.create(null), Bf));
	}
	resolve(e) {
		return e ? this.table[e] || (this.table[e] = Gf(this.extra, e)) : 0;
	}
}
const Uf = new If(Lf);
function Nf(e, t) {
	zf.indexOf(e) > -1 || (zf.push(e), console.warn(t));
}
function Gf(e, t) {
	let i = [];
		...
		for (let i of n.split(".")) {
			...
			n
				? "function" == typeof n
					? t.length
						? (t = t.map(n))
						: Nf(i, `Modifier ${i} used at start of tag`)
					: t.length
						? Nf(i, `Tag ${i} used as modifier`)
						: (t = Array.isArray(n) ? n : [n])
				: Nf(i, `Unknown highlighting tag ${i}`);
		}
	...
	let n = t.replace(/ /g, "_"),
		...
		s = Yf[r];
	if (s) return s.id;
	let o = (Yf[r] = uc.define({
		id: Wf.length,
		name: n,
		props: [iu({ [n]: i })],
	}));
	return Wf.push(o), o.id;
}
Oo.RTL, Oo.LTR;
function Hf(e, t) {
...
const td = 50;
function id(e, t, i = t.selection.ranges) {
	let n = i.map((e) => ed(t, e.from).block);
	...
	let r = i.map((e, i) =>
		(function (e, { open: t, close: i }, n, r) {
			...
			r - n <= 2 * td
				? (s = o = e.sliceDoc(n, r))
				: ((s = e.sliceDoc(n, n + td)), (o = e.sliceDoc(r - td, r)));
...
function nd(e, t, i = t.selection.ranges) {
	let n = [],
		r = -1;
	...
	ld = Wn.define({
		...
		update(e, t) {
			let i = t.state.facet(ad),
				n = t.annotation(rd);
			if (n) {
				let r = pd.fromTransaction(t, n.selection),
					s = n.side,
					o = 0 == s ? e.undone : e.done;
				return (
					(o = r
						? md(o, o.length, i.minDepth, r)
						: yd(o, t.startState.selection)),
					new vd(0 == s ? n.rest : o, 0 == s ? o : n.rest)
				);
			}
			let r = t.annotation(sd);
			if (
				(("full" != r && "before" != r) || (e = e.isolate()),
				!1 === t.annotation(ur.addToHistory))
			)
				return t.changes.empty ? e : e.addMapping(t.changes.desc);
			let s = pd.fromTransaction(t),
				o = t.annotation(ur.time),
				a = t.annotation(ur.userEvent);
			return (
				s
		...
		fromJSON: (e) => new vd(e.done.map(pd.fromJSON), e.undone.map(pd.fromJSON)),
	});
function hd(e = {}) {
	return [
		ld,
...
class pd {
	...
	static fromJSON(e) {
		return new pd(
			...
			[],
			e.mapped && wn.fromJSON(e.mapped),
			e.startSelection && Cn.fromJSON(e.startSelection),
			e.selectionsAfter.map(Cn.fromJSON),
		);
	}
	static fromTransaction(e, t) {
		let i = xd;
		for (let t of e.startState.facet(od)) {
			let n = t(e);
	...
	static selection(e) {
		return new pd(void 0, xd, void 0, void 0, e);
	}
}
function md(e, t, i, n) {
...
function yd(e, t) {
	if (e.length) {
		let i = e[e.length - 1],
			n = i.selectionsAfter.slice(Math.max(0, i.selectionsAfter.length - bd));
		return n.length && n[n.length - 1].eq(t)
			? e
			: (n.push(t), md(e, e.length - 1, 1e9, i.setSelAfter(n)));
	}
	return [pd.selection([t])];
}
function Sd(e) {
	let t = e[e.length - 1],
		i = e.slice();
...
function wd(e, t) {
	...
	return n.length ? [pd.selection(n)] : xd;
}
function kd(e, t, i) {
	let n = gd(
		e.selectionsAfter.length ? e.selectionsAfter.map((e) => e.map(t)) : xd,
		i,
	);
	if (!e.changes) return pd.selection(n);
	let r = e.changes.map(t),
		s = t.mapDesc(e.changes, !0),
		o = e.mapped ? e.mapped.composeDesc(s) : s;
	return new pd(r, cr.mapEffects(e.effects, t), o, e.startSelection.map(s), n);
}
const Qd = /^(input\.type|delete)($|\.)/;
class vd {
	...
	isolate() {
		return this.prevTime ? new vd(this.done, this.undone) : this;
	}
				...
				((!o.selectionsAfter.length &&
					...
					? md(
							...
							new pd(
								...
								gd(cr.mapEffects(e.effects, o.changes), o.effects),
								o.mapped,
								o.startSelection,
								xd,
							),
						)
					: md(s, s.length, n.minDepth, e)),
			new vd(s, xd, t, i)
		);
	}
	addSelection(e, t, i, n) {
		...
		return r.length > 0 &&
			...
			? this
			: new vd(yd(this.done, e), this.undone, t, i);
		var s, o;
	}
	addMapping(e) {
		return new vd(
	...
	pop(e, t, i) {
		...
		if (i && r.selectionsAfter.length)
			return t.update({
				...
				annotations: rd.of({ side: e, rest: Sd(n), selection: s }),
				userEvent: 0 == e ? "select.undo" : "select.redo",
				scrollIntoView: !0,
			});
		if (r.changes) {
			let i = 1 == n.length ? xd : n.slice(0, n.length - 1);
			return (
				r.mapped && (i = wd(i, r.mapped)),
				t.update({
					changes: r.changes,
					selection: r.startSelection,
					effects: r.effects,
					annotations: rd.of({ side: e, rest: i, selection: s }),
					filter: !1,
...
vd.empty = new vd(xd, xd);
const $d = [
	{ key: "Mod-z", run: ud, preventDefault: !0 },
	{ key: "Mod-y", mac: "Mod-Shift-z", run: fd, preventDefault: !0 },
	{ linux: "Ctrl-Shift-z", run: fd, preventDefault: !0 },
	{ key: "Mod-u", run: dd, preventDefault: !0 },
	{ key: "Alt-u", mac: "Mod-Shift-u", run: Od, preventDefault: !0 },
];
function Pd(e, t) {
	return Cn.create(e.ranges.map(t), e.mainIndex);
}
function Zd(e, t) {
	return e.update({ selection: t, scrollIntoView: !0, userEvent: "select" });
}
function Td({ state: e, dispatch: t }, i) {
	let n = Pd(e.selection, i);
	return !n.eq(e.selection, !0) && (t(Zd(e, n)), !0);
}
function _d(e, t) {
	return Cn.cursor(t ? e.to : e.from);
}
function Cd(e, t) {
	return Td(e, (i) => (i.empty ? e.moveByChar(i, t) : _d(i, t)));
}
function Ad(e) {
	return e.textDirectionAt(e.state.selection.main.head) == Oo.LTR;
}
const Xd = (e) => Cd(e, !Ad(e)),
	Md = (e) => Cd(e, Ad(e));
function Rd(e, t) {
	return Td(e, (i) => (i.empty ? e.moveByGroup(i, t) : _d(i, t)));
}
function Ed(e, t, i) {
...
function jd(e, t, i) {
	let n,
		r,
		s = Cu(e).resolveInner(t.head),
		o = i ? lc.closedBy : lc.openedBy;
	for (let n = t.head; ; ) {
		let t = i ? s.childAfter(n) : s.childBefore(n);
		if (!t) break;
		Ed(e, t, o) ? (s = t) : (n = i ? t.to : t.from);
	}
	return (
		(r =
			s.type.prop(o) &&
			(n = i ? Tf(e, s.from, 1) : Tf(e, s.to, -1)) &&
			n.matched
				? i
					? n.end.to
					: n.end.from
...
function Wd(e) {
	let t,
		...
		r = 0;
	if (i) {
		for (let t of e.state.facet(Fl.scrollMargins)) {
			let i = t(e);
			(null == i ? void 0 : i.top) &&
...
function Dd(e, t) {
	let i,
		...
		{ state: r } = e,
		s = Pd(r.selection, (i) =>
			i.empty ? e.moveVertically(i, t, n.height) : _d(i, t),
		);
	...
	if (n.selfScroll) {
		...
		t &&
			t.top > a &&
			t.bottom < l &&
			(i = Fl.scrollIntoView(s.main.head, { y: "start", yMargin: t.top - a }));
	}
	return e.dispatch(Zd(r, s), { effects: i }), !0;
}
const zd = (e) => Dd(e, !1),
	Yd = (e) => Dd(e, !0);
function Bd(e, t, i) {
	...
	if (
		...
		i && t.head != n.from + i && (r = Cn.cursor(n.from + i));
	}
	return r;
}
function Id(e, t) {
	let i = Pd(e.state.selection, (e) => {
		let i = t(e);
		return Cn.range(e.anchor, i.head, i.goalColumn, i.bidiLevel || void 0);
	});
	return !i.eq(e.state.selection) && (e.dispatch(Zd(e.state, i)), !0);
}
function Ud(e, t) {
	return Id(e, (i) => e.moveByChar(i, t));
}
const Nd = (e) => Ud(e, !Ad(e)),
	Gd = (e) => Ud(e, Ad(e));
function Hd(e, t) {
	return Id(e, (i) => e.moveByGroup(i, t));
}
function Fd(e, t) {
	return Id(e, (i) => e.moveVertically(i, t));
}
const Kd = (e) => Fd(e, !1),
	Jd = (e) => Fd(e, !0);
function eO(e, t) {
	return Id(e, (i) => e.moveVertically(i, t, Wd(e).height));
}
const tO = (e) => eO(e, !1),
	iO = (e) => eO(e, !0),
	nO = ({ state: e, dispatch: t }) => (t(Zd(e, { anchor: 0 })), !0),
	rO = ({ state: e, dispatch: t }) => (t(Zd(e, { anchor: e.doc.length })), !0),
	sO = ({ state: e, dispatch: t }) => (
		t(Zd(e, { anchor: e.selection.main.anchor, head: 0 })), !0
	),
	oO = ({ state: e, dispatch: t }) => (
		t(Zd(e, { anchor: e.selection.main.anchor, head: e.doc.length })), !0
	);
function aO(e, t) {
	...
	let i = "delete.selection",
		...
		r = n.changeByRange((n) => {
			...
			if (r == s) {
				let o = t(n);
				o < r
					? ((i = "delete.backward"), (o = lO(e, o, !1)))
					: o > r && ((i = "delete.forward"), (o = lO(e, o, !0))),
					(r = Math.min(r, o)),
					(s = Math.max(s, o));
			} else (r = lO(e, r, !1)), (s = lO(e, s, !0));
			return r == s
				? { range: n }
				: {
						changes: { from: r, to: s },
						range: Cn.cursor(r, r < n.head ? -1 : 1),
					};
		});
	return (
		!r.changes.empty &&
		(e.dispatch(
			n.update(r, {
				...
				effects:
					"delete.selection" == i
						? Fl.announce.of(n.phrase("Selection deleted"))
						: void 0,
			}),
		),
		!0)
...
function lO(e, t, i) {
	if (e instanceof Fl)
		for (let n of e.state.facet(Fl.atomicRanges).map((t) => t(e)))
			n.between(t, t, (e, n) => {
				e < t && n > t && (t = i ? n : e);
			});
	return t;
...
const hO = (e, t, i) =>
		aO(e, (n) => {
			...
			if (
				...
				let e = Lr(r, a.tabSize) % Bu(a) || Bu(a);
...
function pO(e, t, i) {
	...
	for (let t of OO(e)) {
		...
		if (i) {
			...
			for (let e of t.ranges) r.push(Cn.range(e.anchor - o, e.head - o));
		}
	}
	return (
		!!n.length &&
		(t(
			e.update({
				changes: n,
				scrollIntoView: !0,
				selection: Cn.create(r, e.selection.mainIndex),
				userEvent: "move.line",
			}),
		),
		!0)
...
function bO(e) {
	return ({ state: t, dispatch: i }) => {
		...
		let n = t.changeByRange((i) => {
			...
			let a = new Nu(t, { simulateBreak: n, simulateDoubleBreak: !!o }),
				l = Uu(a, n);
			for (
				null == l && (l = Lr(/^\s*/.exec(t.doc.lineAt(n).text)[0], t.tabSize));
			...
			let h = ["", Iu(t, l)];
			return (
				o && h.push(Iu(t, a.lineIndent(s.from, -1))),
				{
					changes: { from: n, to: r, insert: an.of(h) },
					range: Cn.cursor(n + 1 + h[1].length),
				}
			);
		});
...
function yO(e, t) {
	...
	return e.changeByRange((n) => {
		...
		return {
			changes: r,
			range: Cn.range(s.mapPos(n.anchor, 1), s.mapPos(n.head, 1)),
		};
	});
}
const SO = [
		{ key: "Ctrl-b", run: Xd, shift: Nd, preventDefault: !0 },
		{ key: "Ctrl-f", run: Md, shift: Gd },
		{ key: "Ctrl-p", run: Vd, shift: Kd },
		{ key: "Ctrl-n", run: Ld, shift: Jd },
		{
			key: "Ctrl-a",
			run: (e) => Td(e, (t) => Cn.cursor(e.lineBlockAt(t.head).from, 1)),
			shift: (e) => Id(e, (t) => Cn.cursor(e.lineBlockAt(t.head).from)),
		},
		{
			key: "Ctrl-e",
			run: (e) => Td(e, (t) => Cn.cursor(e.lineBlockAt(t.head).to, -1)),
			shift: (e) => Id(e, (t) => Cn.cursor(e.lineBlockAt(t.head).to)),
		},
		{ key: "Ctrl-d", run: uO },
		{ key: "Ctrl-h", run: cO },
		{
	...
	wO = [
		{ key: "ArrowLeft", run: Xd, shift: Nd, preventDefault: !0 },
		{
			key: "Mod-ArrowLeft",
			mac: "Alt-ArrowLeft",
			run: (e) => Rd(e, !Ad(e)),
		...
		{
			mac: "Cmd-ArrowLeft",
			run: (e) => Td(e, (t) => Bd(e, t, !Ad(e))),
			shift: (e) => Id(e, (t) => Bd(e, t, !Ad(e))),
			preventDefault: !0,
		},
		{ key: "ArrowRight", run: Md, shift: Gd, preventDefault: !0 },
		{
			key: "Mod-ArrowRight",
			mac: "Alt-ArrowRight",
			run: (e) => Rd(e, Ad(e)),
		...
		{ key: "ArrowUp", run: Vd, shift: Kd, preventDefault: !0 },
		{ mac: "Cmd-ArrowUp", run: nO, shift: sO },
		{ mac: "Ctrl-ArrowUp", run: zd, shift: tO },
		{ key: "ArrowDown", run: Ld, shift: Jd, preventDefault: !0 },
		{ mac: "Cmd-ArrowDown", run: rO, shift: oO },
		{ mac: "Ctrl-ArrowDown", run: Yd, shift: iO },
		{ key: "PageUp", run: zd, shift: tO },
		{ key: "PageDown", run: Yd, shift: iO },
		{
			key: "Home",
			run: (e) => Td(e, (t) => Bd(e, t, !1)),
			shift: (e) => Id(e, (t) => Bd(e, t, !1)),
			preventDefault: !0,
		},
		{ key: "Mod-Home", run: nO, shift: sO },
		{
			key: "End",
			run: (e) => Td(e, (t) => Bd(e, t, !0)),
			shift: (e) => Id(e, (t) => Bd(e, t, !0)),
			preventDefault: !0,
		},
		{ key: "Mod-End", run: rO, shift: oO },
		...
		{ key: "Backspace", run: cO, shift: cO },
		{ key: "Delete", run: uO },
		{ key: "Mod-Backspace", mac: "Alt-Backspace", run: dO },
		{ key: "Mod-Delete", mac: "Alt-Delete", run: (e) => fO(e, !0) },
		{
			mac: "Mod-Backspace",
			run: (e) =>
				aO(e, (t) => {
	...
	].concat(SO.map((e) => ({ mac: e.key, run: e.run, shift: e.shift }))),
	kO = [
		{
			key: "Alt-ArrowLeft",
			mac: "Ctrl-ArrowLeft",
			run: (e) => Td(e, (t) => jd(e.state, t, !Ad(e))),
			shift: (e) => Id(e, (t) => jd(e.state, t, !Ad(e))),
		},
		{
			key: "Alt-ArrowRight",
			mac: "Ctrl-ArrowRight",
		...
		{ key: "Alt-ArrowUp", run: ({ state: e, dispatch: t }) => pO(e, t, !1) },
		{
			key: "Shift-Alt-ArrowUp",
			run: ({ state: e, dispatch: t }) => mO(e, t, !1),
		},
		{ key: "Alt-ArrowDown", run: ({ state: e, dispatch: t }) => pO(e, t, !0) },
		{
			key: "Shift-Alt-ArrowDown",
			run: ({ state: e, dispatch: t }) => mO(e, t, !0),
		},
		{
			key: "Escape",
			run: ({ state: e, dispatch: t }) => {
				...
				return (
					i.ranges.length > 1
						? (n = Cn.create([i.main]))
						: i.main.empty || (n = Cn.create([Cn.cursor(i.main.head)])),
					!!n && (t(Zd(e, n)), !0)
				);
			},
		},
		{ key: "Mod-Enter", run: xO },
		{
			key: "Alt-l",
			mac: "Ctrl-l",
			run: ({ state: e, dispatch: t }) => {
				let i = OO(e).map(({ from: t, to: i }) =>
					Cn.range(t, Math.min(i + 1, e.doc.length)),
				);
				return (
					t(e.update({ selection: Cn.create(i), userEvent: "select" })), !0
				);
			},
		},
		{
				...
				let i = Pd(e.selection, (t) => {
					...
					for (let e = n; e; e = e.next) {
						...
						if (
							...
							return Cn.range(i.to, i.from);
					}
					return t;
				});
				return !i.eq(e.selection) && (t(Zd(e, i)), !0);
			},
			preventDefault: !0,
		},
		{
				...
				(t(
					e.update(
						yO(e, (t, i) => {
							...
							if (!n) return;
							let r = Lr(n, e.tabSize),
								s = 0,
								o = Iu(e, Math.max(0, r - Bu(e)));
							for (
								;
								s < n.length &&
								s < o.length &&
		...
		},
		{
			...
			run: ({ state: e, dispatch: t }) =>
				...
				(t(
					e.update(
						yO(e, (t, i) => {
							i.push({ from: t.from, insert: e.facet(Yu) });
						}),
					...
					let i = !1,
						n = Pd(e.selection, (t) => {
							let n =
								Tf(e, t.head, -1) ||
								Tf(e, t.head, 1) ||
								(t.head > 0 && Tf(e, t.head - 1, 1)) ||
								(t.head < e.doc.length && Tf(e, t.head + 1, -1));
							if (!n || !n.end) return t;
							i = !0;
		...
		},
		{
			...
			run: (e) => {
				let { state: t } = e,
					...
					n = ed(e.state, i.from);
				return n.line ? Ff(e) : !!n.block && Jf(e);
			},
		},
		{ key: "Alt-A", run: Kf },
		{
...
class QO {
	...
	tokenBefore(e) {
		let t = Cu(this.state).resolveInner(this.pos, -1);
...
function PO(e, t) {
	return (i) => {
		for (let t = Cu(i.state).resolveInner(i.pos, -1); t; t = t.parent) {
...
class CO {
	...
	map(e) {
		let t = e.mapPos(this.from, -1, Sn.TrackDel),
			i = e.mapPos(this.to, 1, Sn.TrackDel);
		return null == t || null == i ? null : new CO(this.field, t, i);
	}
}
class AO {
	constructor(e, t) {
	...
	static parse(e) {
		...
		for (let s of e.split(/\r\n?|\n/)) {
			for (
				...
				r.push(new _O(a, n.length, t.index, t.index + l.length)),
...
let XO = to.widget({
	...
	MO = to.mark({ class: "cm-snippetField" });
class RO {
	constructor(e, t) {
		(this.ranges = e),
			(this.active = t),
			(this.deco = to.set(
				e.map((e) => (e.from == e.to ? XO : MO).range(e.from, e.to)),
			));
	}
	map(e) {
		let t = [];
...
const EO = cr.define({ map: (e, t) => e && e.map(t) }),
	jO = cr.define(),
	qO = Wn.define({
		create: () => null,
		update(e, t) {
			for (let i of t.effects) {
				...
				if (i.is(jO) && e) return new RO(e.ranges, i.value);
			}
			return (
		...
		provide: (e) => Fl.decorations.from(e, (e) => (e ? e.deco : to.none)),
	});
function VO(e, t) {
	return Cn.create(
		e.filter((e) => e.field == t).map((e) => Cn.range(e.from, e.to)),
	);
}
function LO(e) {
	let t = AO.parse(e);
	return (e, i, n, r) => {
		let { text: s, ranges: o } = t.instantiate(e.state, n),
			...
			l = {
				...
				scrollIntoView: !0,
				annotations: i ? [ZO.of(i), ur.userEvent.of("input.complete")] : void 0,
			};
		if ((o.length && (l.selection = VO(o, 0)), o.some((e) => e.field > 0))) {
			let t = new RO(o, 0),
				i = (l.effects = [EO.of(t)]);
			void 0 === e.state.field(qO, !1) &&
				i.push(cr.appendConfig.of([qO, YO, IO, TO]));
		}
...
function WO(e) {
	return ({ state: t, dispatch: i }) => {
		...
		return (
			i(
				t.update({
					selection: VO(n.ranges, r),
					effects: EO.of(s ? null : new RO(n.ranges, r)),
					scrollIntoView: !0,
				}),
			),
			!0
...
const DO = [
		{ key: "Tab", run: WO(1), shift: WO(-1) },
		{
			key: "Escape",
			run: ({ state: e, dispatch: t }) =>
				!!e.field(qO, !1) && (t(e.update({ effects: EO.of(null) })), !0),
		},
	],
	zO = Mn.define({ combine: (e) => (e.length ? e[0] : DO) }),
	YO = Un.highest(sh.compute([zO], (e) => e.facet(zO)));
function BO(e, t) {
	return Object.assign(Object.assign({}, t), { apply: LO(e) });
}
const IO = Fl.domEventHandlers({
		mousedown(e, t) {
			let i,
				n = t.state.field(qO, !1);
			...
			return (
				!(!r || r.field == n.active) &&
				(t.dispatch({
					selection: VO(n.ranges, r.field),
					effects: EO.of(
						n.ranges.some((e) => e.field > r.field)
							? new RO(n.ranges, r.field)
							: null,
					),
					scrollIntoView: !0,
				}),
	...
	NO = cr.define({
		map(e, t) {
			let i = t.mapPos(e, -1, Sn.TrackAfter);
			return null == i ? void 0 : i;
		},
	}),
	GO = new (class extends Qr {})();
(GO.startSide = 1), (GO.endSide = -1);
const HO = Wn.define({
	create: () => Zr.empty,
	update(e, t) {
		...
		for (let i of t.effects)
			i.is(NO) && (e = e.update({ add: [GO.range(i.value, i.value + 1)] }));
		return e;
	},
});
const FO = "()[]{}<>«»»«［］｛｝";
function KO(e) {
	for (let t = 0; t < 16; t += 2)
		if (FO.charCodeAt(t) == e) return FO.charAt(t + 1);
	return (function (e) {
		return e <= 65535
...
function JO(e, t) {
	return e.languageDataAt("closeBrackets", t)[0] || UO;
}
const ep =
		"object" == typeof navigator && /Android\b/.test(navigator.userAgent),
	tp = Fl.inputHandler.of((e, t, i, n) => {
		if ((ep ? e.composing : e.compositionStarted) || e.state.readOnly)
			return !1;
		let r = e.state.selection.main;
		if (
			n.length > 2 ||
			(2 == n.length && 1 == bn(xn(n, 0))) ||
			t != r.from ||
			i != r.to
		)
			return !1;
		let s = (function (e, t) {
			let i = JO(e, e.selection.main.head),
				n = i.brackets || UO.brackets;
			for (let r of n) {
				let s = KO(xn(r, 0));
				if (t == r)
					return s == r
						? ap(e, r, n.indexOf(r + r + r) > -1, i)
						: sp(e, r, s, i.before || UO.before);
				if (t == s && np(e, e.selection.main.from)) return op(e, r, s);
			}
			return null;
		})(e.state, n);
	...
	ip = [
		{
			...
			run: ({ state: e, dispatch: t }) => {
				if (e.readOnly) return !1;
				let i = JO(e, e.selection.main.head).brackets || UO.brackets,
					n = null,
					r = e.changeByRange((t) => {
						if (t.empty) {
							let n = (function (e, t) {
								let i = e.sliceString(t - 2, t);
								return bn(xn(i, 0)) == i.length ? i : i.slice(1);
							})(e.doc, t.head);
							for (let r of i)
								if (r == n && rp(e.doc, t.head) == KO(xn(r, 0)))
									return {
										changes: { from: t.head - r.length, to: t.head + r.length },
										range: Cn.cursor(t.head - r.length),
									};
						}
						return { range: (n = t) };
					});
...
function np(e, t) {
	let i = !1;
	return (
		e.field(HO).between(0, e.doc.length, (e) => {
			e == t && (i = !0);
		}),
		i
	);
		...
		s = e.changeByRange((s) => {
			if (!s.empty)
				return {
					...
					effects: NO.of(s.to + t.length),
					range: Cn.range(s.anchor + t.length, s.head + t.length),
				};
			let o = rp(e.doc, s.head);
			return !o || /\s/.test(o) || n.indexOf(o) > -1
				? {
						changes: { insert: t + i, from: s.head },
						effects: NO.of(s.head + t.length),
						range: Cn.cursor(s.head + t.length),
					}
				: { range: (r = s) };
		});
	return r
...
function op(e, t, i) {
	let n = null,
		r = e.changeByRange((t) =>
			t.empty && rp(e.doc, t.head) == i
				? {
						changes: { from: t.head, to: t.head + i.length, insert: i },
						range: Cn.cursor(t.head + i.length),
					}
				: (n = { range: t }),
		);
	return n
...
function ap(e, t, i, n) {
	let r = n.stringPrefixes || UO.stringPrefixes,
		s = null,
		o = e.changeByRange((n) => {
			if (!n.empty)
				return {
					...
					effects: NO.of(n.to + t.length),
					range: Cn.range(n.anchor + t.length, n.head + t.length),
				};
			let o,
				a = n.head,
				l = rp(e.doc, a);
			if (l == t) {
				if (lp(e, a))
					return {
						...
						effects: NO.of(a + t.length),
						range: Cn.cursor(a + t.length),
					};
				if (np(e, a)) {
					let n =
...
class cp {
	static create(e, t, i, n, r) {
		return new cp(e, t, i, (n + (n << 8) + e + (t << 4)) | 0, r, [], []);
	}
	constructor(e, t, i, n, r, s, o) {
		(this.type = e),
			(this.value = t),
			...
			(this.children = s),
			(this.positions = o),
			(this.hashProp = [[lc.contextHash, n]]);
	}
	addChild(e, t) {
		e.prop(lc.contextHash) != this.hash &&
			(e = new mc(e.type, e.children, e.positions, e.length, this.hashProp)),
	...
	toTree(e, t = this.end) {
		...
		return (
			...
			new mc(
				...
				makeTree: (e, t, i) => new mc(uc.none, e, t, i, this.hashProp),
			})
		);
	}
}
...
function Op(e, t, i) {
	...
	let n = (e.type == up.OrderedList ? Qp : kp)(i, t, !1);
	return (
		n > 0 &&
		(e.type != up.BulletList || Sp(i, t, !1) < 0) &&
...
const pp = {
	[up.Blockquote]: (e, t, i) =>
		62 == i.next &&
		(i.markers.push(
			Kp(up.QuoteMark, t.lineStart + i.pos, t.lineStart + i.pos + 1),
		),
		i.moveBase(i.pos + (mp(i.text.charCodeAt(i.pos + 1)) ? 2 : 1)),
...
function gp(e, t = 0) {
	for (; t < e.length && mp(e.charCodeAt(t)); ) t++;
	return t;
}
function xp(e, t, i) {
	for (; t > i && mp(e.charCodeAt(t - 1)); ) t--;
	return t;
}
function bp(e) {
...
function kp(e, t, i) {
	return (45 != e.next && 43 != e.next && 42 != e.next) ||
		(e.pos != e.text.length - 1 && !mp(e.text.charCodeAt(e.pos + 1))) ||
		!(!i || wp(t, up.BulletList) || e.skipSpace(e.pos + 2) < e.text.length)
		? -1
		: 1;
}
function Qp(e, t, i) {
	...
	return n == e.pos ||
		n > e.pos + 9 ||
		(46 != r && 41 != r) ||
		(n < e.text.length - 1 && !mp(e.text.charCodeAt(n + 1))) ||
		(i &&
			!wp(t, up.OrderedList) &&
...
function $p(e) {
	...
	for (; t < e.text.length && e.text.charCodeAt(t) == e.next; ) t++;
	let i = t;
	for (; t < e.text.length && mp(e.text.charCodeAt(t)); ) t++;
...
function Cp(e, t, i) {
	...
	for (let e = 0, t = _p.length - (i ? 1 : 0); e < t; e++)
		if (_p[e][0].test(n)) return e;
	return -1;
}
function Ap(e, t) {
...
function Xp(e, t, i) {
	let n = e.length - 1;
	n >= 0 && e[n].to == t && e[n].type == up.CodeText
		? (e[n].to = i)
		: e.push(Kp(up.CodeText, t, i));
}
const Mp = {
	...
	IndentedCode(e, t) {
		...
		let n = t.findColumn(i),
			...
			o = [],
			a = [];
		for (Xp(o, r, s); e.nextLine() && t.depth >= e.stack.length; )
			if (t.pos == t.text.length) {
				Xp(a, e.lineStart - 1, e.lineStart);
				...
				if (t.indent < i) break;
				{
					if (a.length) {
						for (let e of a)
							e.type == up.CodeText ? Xp(o, e.from, e.to) : o.push(e);
						a = [];
					}
					Xp(o, e.lineStart - 1, e.lineStart);
		...
		return (
			a.length &&
				((a = a.filter((e) => e.type != up.CodeText)),
				a.length && (t.markers = a.concat(t.markers))),
			e.addNode(e.buffer.writeElements(o, -r).finish(up.CodeBlock, s - r), r),
			!0
		);
	},
	FencedCode(e, t) {
		...
		let n = e.lineStart + t.pos,
			...
			s = i - t.pos,
			o = t.skipSpace(i),
			a = xp(t.text, t.text.length, o),
			l = [Kp(up.CodeMark, n, n + s)];
		o < a && l.push(Kp(up.CodeInfo, e.lineStart + o, e.lineStart + a));
		for (let i = !0; e.nextLine() && t.depth >= e.stack.length; i = !1) {
			...
			if (n - t.pos >= s && t.skipSpace(n) == t.text.length) {
				...
				l.push(Kp(up.CodeMark, e.lineStart + t.pos, e.lineStart + n)),
					e.nextLine();
				break;
			}
			{
				i || Xp(l, e.lineStart - 1, e.lineStart);
				for (let e of t.markers) l.push(e);
		...
		return (
			e.addNode(
				e.buffer
					.writeElements(l, -n)
					.finish(up.FencedCode, e.prevLineEnd() - n),
				n,
			),
			!0
		);
	...
	Blockquote(e, t) {
		...
		return (
			!(i < 0) &&
			(e.startContext(up.Blockquote, t.pos),
			e.addNode(up.QuoteMark, e.lineStart + t.pos, e.lineStart + t.pos + 1),
			t.moveBase(t.pos + i),
			null)
		);
	},
	HorizontalRule(e, t) {
		if (Sp(t, e, !1) < 0) return !1;
		let i = e.lineStart + t.pos;
		return e.nextLine(), e.addNode(up.HorizontalRule, i), !0;
	},
	BulletList(e, t) {
		let i = kp(t, e, !1);
		if (i < 0) return !1;
		e.block.type != up.BulletList &&
			e.startContext(up.BulletList, t.basePos, t.next);
		let n = Ap(t, t.pos + 1);
		return (
			e.startContext(up.ListItem, t.basePos, n - t.baseIndent),
			e.addNode(up.ListMark, e.lineStart + t.pos, e.lineStart + t.pos + i),
			t.moveBaseColumn(n),
			null
		);
	},
	...
	ATXHeading(e, t) {
		...
		let n = t.pos,
			r = e.lineStart + n,
			s = xp(t.text, t.text.length, n),
			o = s;
		for (; o > n && t.text.charCodeAt(o - 1) == t.next; ) o--;
		(o != s && o != n && mp(t.text.charCodeAt(o - 1))) || (o = t.text.length);
		let a = e.buffer
			.write(up.HeaderMark, 0, i)
			.writeElements(
				e.parser.parseInline(t.text.slice(n + i + 1, o), r + i + 1),
				-r,
			);
		o < t.text.length && a.write(up.HeaderMark, o - n, s - n);
		let l = a.finish(up.ATXHeading1 - 1 + i, t.text.length - n);
...
class Rp {
	...
	finish(e, t) {
		return (
			...
			gp(t.content, this.pos) == t.content.length &&
	...
	complete(e, t, i) {
		return (
			e.addLeafElement(
				t,
				Kp(up.LinkReference, this.start, this.start + i, this.elts),
			),
			!0
		);
	}
	...
	advance(e) {
		for (;;) {
			if (-1 == this.stage) return -1;
			if (0 == this.stage) {
				if (!this.nextStage(cm(e, this.pos, this.start, !0))) return -1;
				if (58 != e.charCodeAt(this.pos)) return (this.stage = -1);
				this.elts.push(
					Kp(up.LinkMark, this.pos + this.start, this.pos + this.start + 1),
				),
					this.pos++;
			} else {
				if (1 != this.stage) {
					if (2 == this.stage) {
						let t = gp(e, this.pos),
							i = 0;
						if (t > this.pos) {
							let n = hm(e, t, this.start);
							if (n) {
								let t = Ep(e, n.to - this.start);
								t > 0 && (this.nextStage(n), (i = t));
							}
						}
						return i || (i = Ep(e, this.pos)), i > 0 && i < e.length ? i : -1;
					}
					return Ep(e, this.pos);
				}
				if (!this.nextStage(lm(e, gp(e, this.pos), this.start))) return -1;
			}
		}
	}
}
...
class jp {
	nextLine(e, t, i) {
		let n = t.depth < e.stack.length ? -1 : $p(t),
			r = t.next;
		if (n < 0) return !1;
		let s = Kp(up.HeaderMark, e.lineStart + t.pos, e.lineStart + n);
		return (
			e.nextLine(),
			e.addLeafElement(
				i,
				Kp(
					61 == r ? up.SetextHeading1 : up.SetextHeading2,
					i.start,
					e.prevLineEnd(),
...
const qp = {
		LinkReference: (e, t) => (91 == t.content.charCodeAt(0) ? new Rp(t) : null),
		SetextHeading: () => new jp(),
	},
	Vp = [
		(e, t) => vp(t) >= 0,
		(e, t) => bp(t) >= 0,
...
class Wp {
		...
		(this.parser = e),
			...
			(this.lineStart =
				...
				this.absoluteLineEnd =
					n[0].from),
			(this.block = cp.create(up.Document, 0, this.lineStart, 0, 0)),
			(this.stack = [this.block]),
			(this.fragments = i.length ? new Om(i, t) : null),
			this.readLine();
	}
	get parsedPos() {
	...
	advance() {
		...
		let t = new fp(this.lineStart + e.pos, e.text.slice(e.pos));
	...
	reuseFragment(e) {
		...
		return (
			...
			(this.lineStart = pm(this.absoluteLineStart, this.ranges)),
			this.moveRangeI(),
	...
	readLine() {
		...
		for (
			...
			if (!i) throw new Error("Unhandled block context " + up[t.type]);
			if (!i(t, this, e)) break;
			e.forward();
		}
	}
	...
	addLeafElement(e, t) {
		this.addNode(
			this.buffer
				.writeElements(fm(t.children, e.marks), -t.from)
	...
	finishLeaf(e) {
		...
		let t = fm(this.parser.parseInline(e.content, e.start), e.marks);
		this.addNode(
			this.buffer
				.writeElements(t, -e.start)
				.finish(up.Paragraph, e.content.length),
			e.start,
		);
	}
	elt(e, t, i, n) {
		return "string" == typeof e
			? Kp(this.parser.getNodeType(e), t, i, n)
			: new Fp(e, t);
	}
	get buffer() {
		return new Gp(this.parser.nodeSet);
	}
}
function Dp(e, t, i, n, r) {
	let s = e[t].to,
		o = [],
		a = [],
		l = i.from + n;
	...
	return (
		h(i.to + n, !1),
		new mc(i.type, o, a, i.to + n - l, i.tree ? i.tree.propValues : void 0)
	);
}
class zp extends Ec {
	...
	configure(e) {
			...
			for (let i of t.defineNodes) {
				...
				let l = r.length,
					h = o
						? ["Block", "BlockContext"]
						: s
							? l >= up.ATXHeading1 && l <= up.SetextHeading2
								? ["Block", "LeafBlock", "Heading"]
								: ["Block", "LeafBlock"]
							: void 0;
				r.push(uc.define({ id: l, name: t, props: h && [[lc.group, h]] })),
					a &&
						(e || (e = {}),
						Array.isArray(a) || a instanceof Jc
							? (e[t] = a)
							: Object.assign(e, a));
			}
			(i = new fc(r)), e && (i = i.extend(iu(e)));
		}
		if ((Yp(t.props) && (i = i.extend(...t.props)), Yp(t.remove)))
		...
		return t.wrap && (c = c.concat(t.wrap)), new zp(i, r, s, o, h, n, a, l, c);
	}
	getNodeType(e) {
		...
		props:
			t >= up.Escape
				...
				: [
						[
							lc.group,
							t in pp ? ["Block", "BlockContext"] : ["Block", "LeafBlock"],
						],
					],
		top: "Document" == e,
	});
...
function Kp(e, t, i, n) {
	return new Hp(e, t, i, n);
}
const Jp = { resolve: "Emphasis", mark: "EmphasisMark" },
	em = { resolve: "Emphasis", mark: "EmphasisMark" },
	tm = {},
	im = {};
class nm {
	constructor(e, t, i, n) {
...
const om = {
	Escape(e, t, i) {
		...
		let n = e.char(i + 1);
		for (let t = 0; t < 32; t++)
			if (rm.charCodeAt(t) == n) return e.append(Kp(up.Escape, i, i + 2));
		return -1;
	},
	Entity(e, t, i) {
		if (38 != t) return -1;
		let n = /^(?:#\d+|#x[a-f\d]+|\w+);/i.exec(e.slice(i + 1, i + 31));
		return n ? e.append(Kp(up.Entity, i, i + 1 + n[0].length)) : -1;
	},
	InlineCode(e, t, i) {
		...
		for (; n < e.end; n++)
			if (96 == e.char(n)) {
				if ((s++, s == r && 96 != e.char(n + 1)))
					return e.append(
						Kp(up.InlineCode, i, n + 1, [
							Kp(up.CodeMark, i, i + r),
							Kp(up.CodeMark, n + 1 - r, n + 1),
						]),
					);
			} else s = 0;
		return -1;
	...
	HTMLTag(e, t, i) {
		...
		if (r)
			return e.append(
				Kp(up.Autolink, i, i + 1 + r[0].length, [
					Kp(up.LinkMark, i, i + 1),
					Kp(up.URL, i + 1, i + r[0].length),
					Kp(up.LinkMark, i + r[0].length, i + 1 + r[0].length),
				]),
			);
		let s = /^!--[^>](?:-[^-]|[^-])*?-->/i.exec(n);
		if (s) return e.append(Kp(up.Comment, i, i + 1 + s[0].length));
		let o = /^\?[^]*?\?>/.exec(n);
		if (o)
			return e.append(Kp(up.ProcessingInstruction, i, i + 1 + o[0].length));
		let a =
			/^(?:![A-Z][^]*?>|!\[CDATA\[[^]*?\]\]>|\/\s*[a-zA-Z][\w-]*\s*>|\s*[a-zA-Z][\w-]*(\s+[a-zA-Z:_][\w-.:]*(?:\s*=\s*(?:[^\s"'=<>`]+|'[^']*'|"[^"]*"))?)*\s*(\/\s*)?>)/.exec(
				n,
			);
		return a ? e.append(Kp(up.HTMLTag, i, i + 1 + a[0].length)) : -1;
	},
	Emphasis(e, t, i) {
		...
		let r = e.slice(i - 1, i),
			...
			f = c && (42 == t || !u || o),
			d = u && (42 == t || !c || a);
		return e.append(new nm(95 == t ? Jp : em, i, n, (f ? 1 : 0) | (d ? 2 : 0)));
	},
	HardBreak(e, t, i) {
		if (92 == t && 10 == e.char(i + 1))
			return e.append(Kp(up.HardBreak, i, i + 2));
		if (32 == t) {
			let t = i + 1;
			for (; 32 == e.char(t); ) t++;
			if (10 == e.char(t) && t >= i + 2)
				return e.append(Kp(up.HardBreak, i, t + 1));
		}
		return -1;
	},
	Link: (e, t, i) => (91 == t ? e.append(new nm(tm, i, i + 1, 1)) : -1),
	Image: (e, t, i) =>
		33 == t && 91 == e.char(i + 1) ? e.append(new nm(im, i, i + 2, 1)) : -1,
	LinkEnd(e, t, i) {
		if (93 != t) return -1;
		for (let t = e.parts.length - 1; t >= 0; t--) {
			let n = e.parts[t];
			if (n instanceof nm && (n.type == tm || n.type == im)) {
				if (
					!n.side ||
				...
				if (n.type == tm)
					for (let i = 0; i < t; i++) {
						let t = e.parts[i];
						t instanceof nm && t.type == tm && (t.side = 0);
					}
				return s.to;
			}
		}
...
function am(e, t, i, n, r) {
	let { text: s } = e,
		...
		a = r;
	if (
		(t.unshift(Kp(up.LinkMark, n, n + (i == up.Image ? 2 : 1))),
		t.push(Kp(up.LinkMark, r - 1, r)),
		40 == o)
	) {
		let i,
			n = e.skipSpace(r + 1),
			o = lm(s, n - e.offset, e.offset);
		o &&
			((n = e.skipSpace(o.to)),
			n != o.to &&
				((i = hm(s, n - e.offset, e.offset)), i && (n = e.skipSpace(i.to)))),
			41 == e.char(n) &&
				(t.push(Kp(up.LinkMark, r, r + 1)),
				(a = n + 1),
				o && t.push(o),
				i && t.push(i),
				t.push(Kp(up.LinkMark, n, a)));
	} else if (91 == o) {
		let i = cm(s, r - e.offset, e.offset, !1);
		i && (t.push(i), (a = i.to));
	}
	return Kp(i, n, a, t);
}
function lm(e, t, i) {
	if (60 == e.charCodeAt(t)) {
		for (let n = t + 1; n < e.length; n++) {
			...
			if (62 == r) return Kp(up.URL, t + i, n + 1 + i);
	...
	}
	{
		...
		return r > t ? Kp(up.URL, t + i, r + i) : r == e.length && null;
	}
}
function hm(e, t, i) {
	...
	for (let n = t + 1, s = !1; n < e.length; n++) {
		...
		if (s) s = !1;
			...
			if (o == r) return Kp(up.LinkTitle, t + i, n + 1 + i);
			92 == o && (s = !0);
		}
	}
	return null;
...
function cm(e, t, i, n) {
	for (let r = !1, s = t + 1, o = Math.min(e.length, s + 999); s < o; s++) {
		...
		if (r) r = !1;
			...
			if (93 == o) return !n && Kp(up.LinkLabel, t + i, s + 1 + i);
			if ((n && !mp(o) && (n = !1), 91 == o)) return !1;
			92 == o && (r = !0);
		}
	}
	return null;
...
class um {
	...
	addDelimiter(e, t, i, n, r) {
		return this.append(new nm(e, t, i, (n ? 1 : 0) | (r ? 2 : 0)));
	}
	get hasOpenLink() {
		for (let e = this.parts.length - 1; e >= 0; e--) {
			let t = this.parts[e];
			if (t instanceof nm && (t.type == tm || t.type == im)) return !0;
		}
		return !1;
	}
	addElement(e) {
	...
	resolveMarkers(e) {
		for (let t = e; t < this.parts.length; t++) {
			let i = this.parts[t];
			if (!(i instanceof nm && i.type.resolve && 2 & i.side)) continue;
			let n,
				r = i.type == Jp || i.type == em,
				s = i.to - i.from,
				o = t - 1;
			for (; o >= e; o--) {
				let e = this.parts[o];
			...
			for (let e = o + 1; e < t; e++)
				this.parts[e] instanceof Hp && l.push(this.parts[e]),
					(this.parts[e] = null);
			i.type.mark && l.push(this.elt(i.type.mark, i.from, c));
			let u = this.elt(a, h, c, l);
			(this.parts[o] =
				r && n.from != h ? new nm(n.type, n.from, h, n.side) : null),
				(this.parts[t] =
					r && i.to != c ? new nm(i.type, c, i.to, i.side) : null)
	...
	findOpeningDelimiter(e) {
		for (let t = this.parts.length - 1; t >= 0; t--) {
			let i = this.parts[t];
			if (i instanceof nm && i.type == e) return t;
		}
		return null;
	}
	takeContent(e) {
	...
	skipSpace(e) {
		return gp(this.text, e - this.offset) + this.offset;
	}
	elt(e, t, i, n) {
		return "string" == typeof e
			? Kp(this.parser.getNodeType(e), t, i, n)
...
function fm(e, t) {
	...
	for (let e of t) {
		...
		if (n < i.length && i[n].from < e.from) {
			let t = i[n];
			t instanceof Hp &&
				(i[n] = new Hp(t.type, t.from, t.to, fm(t.children, [e])));
		} else i.splice(n++, 0, e);
	}
	return i;
}
const dm = [up.CodeBlock, up.ListItem, up.OrderedList, up.BulletList];
let Om = class {
	constructor(e, t) {
		(this.fragments = e),
			(this.input = t),
	...
	matches(e) {
		...
		return t && t.prop(lc.contextHash) == e;
	}
	takeNodes(e) {
		let t = this.cursor,
		...
		for (;;) {
			...
			let r = pm(t.from - i, e.ranges);
			if (t.to - i <= e.ranges[e.rangeI].to) e.addNode(t.tree, r);
			else {
				let i = new mc(
					e.parser.nodeSet.types[up.Paragraph],
					[],
					[],
					0,
					e.block.hashProp,
...
const mm = iu({
		"Blockquote/...": ku.quote,
		HorizontalRule: ku.contentSeparator,
		"ATXHeading1/... SetextHeading1/...": ku.heading1,
		"ATXHeading2/... SetextHeading2/...": ku.heading2,
		"ATXHeading3/...": ku.heading3,
		"ATXHeading4/...": ku.heading4,
		"ATXHeading5/...": ku.heading5,
		"ATXHeading6/...": ku.heading6,
		"Comment CommentBlock": ku.comment,
		Escape: ku.escape,
		Entity: ku.character,
		"Emphasis/...": ku.emphasis,
		"StrongEmphasis/...": ku.strong,
		"Link/... Image/...": ku.link,
		"OrderedList/... BulletList/...": ku.list,
		"BlockQuote/...": ku.quote,
		"InlineCode CodeText": ku.monospace,
		"URL Autolink": ku.url,
		"HeaderMark HardBreak QuoteMark ListMark LinkMark EmphasisMark CodeMark":
			ku.processingInstruction,
		"CodeInfo LinkLabel": ku.labelName,
		LinkTitle: ku.string,
		Paragraph: ku.content,
	}),
	gm = new zp(
		new fc(Up).extend(mm),
		Object.keys(Mp).map((e) => Mp[e]),
		Object.keys(Mp).map((e) => qp[e]),
		Object.keys(Mp),
		Vp,
		pp,
		Object.keys(om).map((e) => om[e]),
		Object.keys(om),
		[],
	);
function xm(e, t, i) {
...
const bm = { resolve: "Strikethrough", mark: "StrikethroughMark" },
	ym = {
		defineNodes: [
			{
				name: "Strikethrough",
				style: { "Strikethrough/...": ku.strikethrough },
			},
			{ name: "StrikethroughMark", style: ku.processingInstruction },
		],
		parseInline: [
			{
				name: "Strikethrough",
		...
		if (null == this.rows) {
			...
			if (
				...
				(45 == t.next || 58 == t.next || 124 == t.next) &&
					km.test((n = t.text.slice(t.pos))))
			) {
				let r = [];
				Sm(e, i.content, 0, r, i.start) == Sm(e, n, t.pos) &&
					(this.rows = [
			...
			let i = [];
			Sm(e, t.text, t.pos, i, e.lineStart),
				this.rows.push(
					e.elt(
						"TableRow",
						e.lineStart + t.pos,
...
const vm = {
	defineNodes: [
		{ name: "Table", block: !0 },
		{ name: "TableHeader", style: { "TableHeader/...": ku.heading } },
		"TableRow",
		{ name: "TableCell", style: ku.content },
		{ name: "TableDelimiter", style: ku.processingInstruction },
	],
	parseBlock: [
		{
			name: "Table",
			leaf: (e, t) => (wm(t.content, 0) ? new Qm() : null),
			endLeaf(e, t, i) {
				if (i.parsers.some((e) => e instanceof Qm) || !wm(t.text, t.basePos))
					return !1;
				let n = e.peekLine();
				return km.test(n) && Sm(e, t.text, t.basePos) == Sm(e, n, t.basePos);
			},
...
const Pm = {
		defineNodes: [
			{ name: "Task", block: !0, style: ku.list },
			{ name: "TaskMarker", style: ku.atom },
		],
		parseBlock: [
			{
				name: "TaskList",
	...
	Zm = /(www\.)|(https?:\/\/)|([\w.+-]{1,100}@)|(mailto:|xmpp:)/gy,
	Tm = /[\w-]+(\.[\w-]+)+(\/[^\s<]*)?/gy,
	_m = /[\w-]+\.[\w-]+($|\/)/,
	Cm = /[\w.+-]+@[\w-]+(\.[\w.-]+)+/gy,
	Am = /\/[a-zA-Z\d@.]+/gy;
					...
					if (r[1] || r[2]) {
						if (
							((s = (function (e, t) {
								Tm.lastIndex = t;
								let i = Tm.exec(e);
								if (!i || _m.exec(i[0])[0].indexOf("_") > -1) return -1;
								let n = t + i[0].length;
								for (;;) {
									let i,
										r = e[n - 1];
...
function Em(e, t, i) {
	return (n, r, s) => {
		...
		for (let r = s + 1; r < n.end; r++) {
			...
			if ((92 == a && o.push(n.elt("Escape", r, 2 + r++)), mp(a))) break;
		}
		return -1;
	};
}
const jm = {
		defineNodes: [
			{ name: "Superscript", style: ku.special(ku.content) },
			{ name: "SuperscriptMark", style: ku.processingInstruction },
		],
		parseInline: [
			{ name: "Superscript", parse: Em(94, "Superscript", "SuperscriptMark") },
		],
	},
	qm = {
		defineNodes: [
			{ name: "Subscript", style: ku.special(ku.content) },
			{ name: "SubscriptMark", style: ku.processingInstruction },
		],
		parseInline: [
			{ name: "Subscript", parse: Em(126, "Subscript", "SubscriptMark") },
		],
	},
	Vm = {
		defineNodes: [{ name: "Emoji", style: ku.character }],
		parseInline: [
			{
				name: "Emoji",
				parse(e, t, i) {
...
class Lm {
	...
	updateContext(e) {
		if (e != this.curContext.context) {
			let t = new Wm(this.curContext.tracker, e);
...
class zm {
	...
	static create(e, t = e.bufferBase + e.buffer.length) {
		return new zm(e, t, t - e.bufferBase);
	}
	maybeNext() {
	...
	fork() {
		return new zm(this.stack, this.pos, this.index);
	}
}
function Ym(e, t = Uint16Array) {
...
class Nm {
	...
	token(e, t) {
		let { parser: i } = t.p;
		Fm(this.data, e, t, this.id, i.data, i.tokenPrecTable);
	}
}
Nm.prototype.contextual = Nm.prototype.fallback = Nm.prototype.extend = !1;
class Gm {
	constructor(e, t, i) {
		(this.precTable = t),
			(this.elseToken = i),
			(this.data = "string" == typeof e ? Ym(e) : e);
	}
	token(e, t) {
		let i = e.pos,
			n = 0;
		for (;;) {
			...
			if (
				(Fm(this.data, e, t, 0, this.data, this.precTable), e.token.value > -1)
			)
				break;
...
Gm.prototype.contextual = Nm.prototype.fallback = Nm.prototype.extend = !1;
class Hm {
	constructor(e, t = {}) {
		(this.token = e),
...
let tg = null;
function ig(e, t, i) {
	let n = e.cursor(pc.IncludeAnonymous);
	for (n.moveTo(t); ; )
		...
		if (e) {
			for (
				this.safeFrom = e.openStart
					? ig(e.tree, e.from + e.offset, 1) - e.offset
					: e.from,
					this.safeTo = e.openEnd
						? ig(e.tree, e.to + e.offset, -1) - e.offset
						: e.to;
				this.trees.length;
			)
...
class rg {
	constructor(e, t) {
		(this.stream = t),
			...
			(this.mainToken = null),
			(this.actions = []),
			(this.tokens = e.tokenizers.map((e) => new Bm()));
	}
	getActions(e) {
		let t = 0,
			i = null,
			...
			for (let a = s.stateSlot(r, e ? 2 : 1); ; a += 3) {
				if (65535 == o[a]) {
					if (1 != o[a + 1]) {
						0 == n &&
							2 == o[a + 1] &&
							(n = this.putAction(ug(o, a + 2), t, i, n));
						break;
					}
					a = ug(o, a + 2);
				}
				o[a] == t && (n = this.putAction(ug(o, a + 1), t, i, n));
			}
		return n;
	}
}
class sg {
	constructor(e, t, i, n) {
		(this.parser = e),
			...
			(this.stream = new Um(t, n)),
			(this.tokens = new rg(e, this.stream)),
			(this.topTerm = e.top[1]);
		let { from: r } = n[0];
		(this.stacks = [Lm.start(this, e.top[0], r)]),
			(this.fragments =
	...
	advance() {
		...
		if (!r.length) {
			...
			if (t)
				return (
					eg && console.log("Finish with " + this.stackID(t)),
					this.stackToTree(t)
				);
		...
		if (this.recovering && e) {
			...
			if (i)
				return (
					eg && console.log("Force-finish " + this.stackID(i)),
			...
			for (let o = this.fragments.nodeAt(n); o; ) {
				let n =
					this.parser.nodeSet.types[o.type.id] == o.type
						...
						: -1;
				if (n > -1 && o.length && (!t || (o.prop(lc.contextHash) || 0) == i))
					return (
						e.useNode(o, n),
						eg &&
							console.log(
				...
				if (!(o instanceof mc) || 0 == o.children.length || o.positions[0] > 0)
					break;
				let a = o.children[0];
				if (!(a instanceof mc && 0 == o.positions[0])) break;
				o = a;
			}
		}
		...
		for (let s = 0; s < e.length; s++) {
			...
			if (o.deadEnd) {
				...
				if (
					((r = !0),
					o.restart(),
					eg && console.log(h + this.stackID(o) + " (restarted)"),
			...
			for (let e = 0; c.forceReduce() && e < 10; e++) {
				if (
					(eg && console.log(u + this.stackID(c) + " (via force-reduce)"),
			...
			for (let e of o.recoverByInsert(a))
				eg && console.log(h + this.stackID(e) + " (via recover-insert)"),
	...
	stackID(e) {
		let t = (tg || (tg = new WeakMap())).get(e);
		return (
			t || tg.set(e, (t = String.fromCodePoint(this.nextStackID++))), t + e
		);
	}
}
function og(e, t) {
...
class hg {
	constructor(e) {
		(this.start = e.start),
			(this.shift = e.shift || lg),
			(this.reduce = e.reduce || lg),
			(this.reuse = e.reuse || lg),
			(this.hash = e.hash || (() => 0)),
...
class cg extends Ec {
	constructor(e) {
		...
		(this.nodeSet = new fc(
			...
			(this.strict = !1),
			(this.bufferLength = sc);
		let s = Ym(e.tokenData);
		...
		(this.specializers = this.specializerSpecs.map(fg)),
			(this.states = Ym(e.states, Uint32Array)),
			(this.data = Ym(e.stateData)),
			(this.goto = Ym(e.goto)),
			(this.maxTerm = e.maxTerm),
			(this.tokenizers = e.tokenizers.map((e) =>
				"number" == typeof e ? new Nm(s, e) : e,
			)),
	...
	hasAction(e, t) {
		...
		for (let n = 0; n < 2; n++)
			for (let r, s = this.stateSlot(e, n ? 2 : 1); ; s += 3) {
				if (65535 == (r = i[s])) {
					if (1 != i[s + 1]) {
						if (2 == i[s + 1]) return ug(i, s + 2);
						break;
					}
					r = i[(s = ug(i, s + 2))];
				}
				if (r == t || 0 == r) return ug(i, s + 1);
			}
		return 0;
	}
	stateSlot(e, t) {
	...
	configure(e) {
		let t = Object.assign(Object.create(cg.prototype), this);
		...
		return (
			...
			e.specializers &&
				...
				(t.specializerSpecs = this.specializerSpecs.map((i, n) => {
					...
					return (t.specializers[n] = fg(s)), s;
				}))),
...
function yg(e, t) {
	...
	return (
		(xg = e),
		(bg = i),
		(gg = r ? r.toLowerCase() : n == Sg || n == wg ? void 0 : null)
	);
}
const Sg = 63,
	wg = 33;
...
const Qg = [6, 10, 7, 8, 9],
	vg = new hg({
		start: null,
		shift: (e, t, i, n) => (Qg.indexOf(t) > -1 ? new kg(yg(n, 1) || "", e) : e),
		reduce: (e, t) => (20 == t && e ? e.parent : e),
		reuse(e, t, i, n) {
			let r = t.type.id;
			return 6 == r || 36 == r ? new kg(yg(n, 1) || "", e) : e;
		},
		strict: !1,
	}),
	$g = new Hm(
		(e, t) => {
			...
			if (i) {
				...
				if (r && Og[r]) return e.acceptToken(57, -2);
				...
				if (dg.hasOwnProperty(n)) return e.acceptToken(10);
				r && pg[r] && pg[r][n] ? e.acceptToken(57, -1) : e.acceptToken(6);
			}
		},
		{ contextual: !0 },
	),
...
const _g = Tg("script", 54, 1),
	Cg = Tg("style", 55, 2),
	Ag = Tg("textarea", 56, 3),
	Xg = iu({
		"Text RawText": ku.content,
		"StartTag StartCloseTag SelfClosingEndTag EndTag": ku.angleBracket,
		TagName: ku.tagName,
		"MismatchedCloseTag/TagName": [ku.tagName, ku.invalid],
		AttributeName: ku.attributeName,
		"AttributeValue UnquotedAttributeValue": ku.attributeValue,
		Is: ku.definitionOperator,
		"EntityReference CharacterReference": ku.character,
		Comment: ku.blockComment,
		ProcessingInst: ku.processingInstruction,
		DoctypeDecl: ku.documentMeta,
	}),
	Mg = cg.deserialize({
		version: 14,
		states:
		...
		tokenizers: [_g, Cg, Ag, Zg, $g, Pg, 0, 1, 2, 3, 4, 5],
...
function jg(e, t, i) {
	let n;
	for (let r of i)
		if (!r.attrs || r.attrs(n || (n = Rg(e.node.parent.firstChild, t))))
...
function qg(e = [], t = []) {
	...
	return qc((e, t) => {
		let a = e.type.id;
		if (28 == a) return jg(e, t, i);
		if (31 == a) return jg(e, t, n);
		if (34 == a) return jg(e, t, r);
		if (20 == a && s.length) {
			let i,
				n = e.node,
				r = n.firstChild,
			...
			if (o)
				for (let e of s)
					if (e.tag == o && (!e.attrs || e.attrs(i || (i = Rg(r, t))))) {
						let t = n.lastChild,
		...
		if (o && 23 == a) {
			...
			if ((i = n.firstChild)) {
				...
				if (e)
					for (let i of e) {
						if (i.tagName && i.tagName != Eg(n.parent, t)) continue;
						let e = n.lastChild;
						if (26 == e.type.id) {
							let t = e.from + 1,
								n = e.lastChild,
...
const Dg = new Hm((e, t) => {
	...
	Yg = new Hm((e) => {
		if (!Vg.includes(e.peek(-1))) {
			let { next: t } = e;
			if ((37 == t && (e.advance(), e.acceptToken(1)), Lg(t))) {
				do {
					e.advance();
				} while (Lg(e.next) || Wg(e.next));
				e.acceptToken(1);
			}
		}
	}),
	Bg = iu({
		"AtKeyword import charset namespace keyframes media supports":
			ku.definitionKeyword,
		"from to selector": ku.keyword,
		NamespaceName: ku.namespace,
		KeyframeName: ku.labelName,
		KeyframeRangeName: ku.operatorKeyword,
		TagName: ku.tagName,
		ClassName: ku.className,
		PseudoClassName: ku.constant(ku.className),
		IdName: ku.labelName,
		"FeatureName PropertyName": ku.propertyName,
		AttributeName: ku.attributeName,
		NumberLiteral: ku.number,
		KeywordQuery: ku.keyword,
		UnaryQueryOp: ku.operatorKeyword,
		"CallTag ValueName": ku.atom,
		VariableName: ku.variableName,
		Callee: ku.operatorKeyword,
		Unit: ku.unit,
		"UniversalSelector NestingSelector": ku.definitionOperator,
		MatchOp: ku.compareOperator,
		"ChildOp SiblingOp, LogicOp": ku.logicOperator,
		BinOp: ku.arithmeticOperator,
		Important: ku.modifier,
		Comment: ku.blockComment,
		ColorLiteral: ku.color,
		"ParenthesizedContent StringLiteral": ku.string,
		":": ku.punctuation,
		"PseudoOp #": ku.derefOperator,
		"; ,": ku.separator,
		"( )": ku.paren,
		"[ ]": ku.squareBracket,
		"{ }": ku.brace,
	...
	Ng = { __proto__: null, not: 134, only: 134 },
	Gg = cg.deserialize({
		version: 14,
		states:
		...
		tokenizers: [
			...
			3,
			4,
			new Gm("m~RRYZ[z{a~~g~aO#`~~dP!P!Qg~lO#a~~", 28, 107),
		],
		topRules: { StyleSheet: [0, 4], Styles: [1, 87] },
		specialized: [
			{ term: 102, get: (e) => Ig[e] || -1 },
			{ term: 59, get: (e) => Ug[e] || -1 },
			{ term: 103, get: (e) => Ng[e] || -1 },
		],
		tokenPrec: 1246,
	});
let Hg = null;
function Fg() {
	if (!Hg && "object" == typeof document && document.body) {
		...
		Hg = t.sort().map((e) => ({ type: "property", label: e, apply: e + ": " }));
	}
	return Hg || [];
}
const Kg = [
...
function ax(e, t, i) {
	if (t.to - t.from > 4096) {
		...
		let r = [],
			s = new Set(),
			o = t.cursor(pc.IncludeAnonymous);
		if (o.firstChild())
			do {
				for (let t of ax(e, o.node, i))
...
const lx = (e) => (t) => {
		...
		if (
			...
			return { from: r.from, options: Fg(), validFor: ix };
		if ("ValueName" == r.name)
			return { from: r.from, options: Jg, validFor: ix };
		if ("PseudoClassName" == r.name)
			return { from: r.from, options: Kg, validFor: ix };
		if (
			e(r) ||
			((t.explicit || s) &&
				(function (e, t) {
		...
		if ("TagName" == r.name) {
			for (let { parent: e } = r; e; e = e.parent)
				if ("Block" == e.name)
					return { from: r.from, options: Fg(), validFor: ix };
			return { from: r.from, options: ex, validFor: ix };
		}
		if ("AtKeyword" == r.name)
			return { from: r.from, options: tx, validFor: ix };
		if (!t.explicit) return null;
		let o = r.resolve(n),
			a = o.childBefore(n);
		return a && ":" == a.name && "PseudoClassSelector" == o.name
			? { from: n, options: Kg, validFor: ix }
			: (a && ":" == a.name && "Declaration" == o.name) || "ArgList" == o.name
				? { from: n, options: Jg, validFor: ix }
				: "Block" == o.name || "Styles" == o.name
					? { from: n, options: Fg(), validFor: ix }
					: null;
	},
	hx = lx((e) => "VariableName" == e.name),
	cx = _u.define({
		name: "css",
		parser: Gg.configure({
			props: [
				Gu.add({ Declaration: sf() }),
				af.add({ "Block KeyframeList": lf }),
			],
		}),
		languageData: {
...
function ux() {
	return new Wu(cx, cx.data.of({ autocomplete: hx }));
}
var fx = Object.freeze({
	__proto__: null,
	css: ux,
	cssCompletionSource: hx,
	cssLanguage: cx,
	defineCSSCompletionSource: lx,
});
const dx = [
		9, 10, 11, 12, 13, 32, 133, 160, 5760, 8192, 8193, 8194, 8195, 8196, 8197,
		8198, 8199, 8200, 8201, 8202, 8232, 8233, 8239, 8287, 12288,
...
const yx = new Hm((e, t) => {
		...
		let i = 0;
		for (; dx.indexOf(e.next) > -1; ) e.advance(), i++;
		if (bx(e.next, !0)) {
			for (e.advance(), i++; bx(e.next, !1); ) e.advance(), i++;
			for (; dx.indexOf(e.next) > -1; ) e.advance(), i++;
			if (44 == e.next) return;
			for (let t = 0; ; t++) {
				if (7 == t) {
					if (!bx(e.next, !0)) return;
					break;
				}
	...
	Sx = iu({
		"get set async static": ku.modifier,
		"for while do if else switch try catch finally return throw break continue default case":
			ku.controlKeyword,
		"in of await yield void typeof delete instanceof": ku.operatorKeyword,
		"let var const using function class extends": ku.definitionKeyword,
		"import export from": ku.moduleKeyword,
		"with debugger as new": ku.keyword,
		TemplateString: ku.special(ku.string),
		super: ku.atom,
		BooleanLiteral: ku.bool,
		this: ku.self,
		null: ku.null,
		Star: ku.modifier,
		VariableName: ku.variableName,
		"CallExpression/VariableName TaggedTemplateExpression/VariableName":
			ku.function(ku.variableName),
		VariableDefinition: ku.definition(ku.variableName),
		Label: ku.labelName,
		PropertyName: ku.propertyName,
		PrivatePropertyName: ku.special(ku.propertyName),
		"CallExpression/MemberExpression/PropertyName": ku.function(
			ku.propertyName,
		),
		"FunctionDeclaration/VariableDefinition": ku.function(
			ku.definition(ku.variableName),
		),
		"ClassDeclaration/VariableDefinition": ku.definition(ku.className),
		"NewExpression/VariableName": ku.className,
		PropertyDefinition: ku.definition(ku.propertyName),
		PrivatePropertyDefinition: ku.definition(ku.special(ku.propertyName)),
		UpdateOp: ku.updateOperator,
		"LineComment Hashbang": ku.lineComment,
		BlockComment: ku.blockComment,
		Number: ku.number,
		String: ku.string,
		Escape: ku.escape,
		ArithOp: ku.arithmeticOperator,
		LogicOp: ku.logicOperator,
		BitOp: ku.bitwiseOperator,
		CompareOp: ku.compareOperator,
		RegExp: ku.regexp,
		Equals: ku.definitionOperator,
		Arrow: ku.function(ku.punctuation),
		": Spread": ku.punctuation,
		"( )": ku.paren,
		"[ ]": ku.squareBracket,
		"{ }": ku.brace,
		"InterpolationStart InterpolationEnd": ku.special(ku.brace),
		".": ku.derefOperator,
		", ;": ku.separator,
		"@": ku.meta,
		TypeName: ku.typeName,
		TypeDefinition: ku.definition(ku.typeName),
		"type enum interface implements namespace module declare":
			ku.definitionKeyword,
		"abstract global Privacy readonly override": ku.modifier,
		"is keyof unique infer asserts": ku.operatorKeyword,
		JSXAttributeValue: ku.attributeValue,
		JSXText: ku.content,
		"JSXStartTag JSXStartCloseTag JSXSelfCloseEndTag JSXEndTag":
			ku.angleBracket,
		"JSXIdentifier JSXNameSpacedName": ku.tagName,
		"JSXAttribute/JSXIdentifier JSXAttribute/JSXNameSpacedName":
			ku.attributeName,
		"JSXBuiltin/JSXIdentifier": ku.standard(ku.tagName),
	}),
	wx = {
		__proto__: null,
		export: 20,
	...
	vx = cg.deserialize({
		...
		tokenizers: [
			...
			new Gm("j~RQYZXz{^~^O(O~~aP!P!Qd~iO(P~~", 25, 321),
		],
		topRules: {
			Script: [0, 7],
		...
		specialized: [
			{ term: 325, get: (e) => wx[e] || -1 },
			{ term: 341, get: (e) => kx[e] || -1 },
			{ term: 93, get: (e) => Qx[e] || -1 },
		],
		tokenPrec: 15116,
	}),
	$x = [
		BO("function ${name}(${params}) {\n\t${}\n}", {
			label: "function",
			detail: "definition",
			type: "keyword",
		}),
		BO("for (let ${index} = 0; ${index} < ${bound}; ${index}++) {\n\t${}\n}", {
			label: "for",
			detail: "loop",
			type: "keyword",
		}),
		BO("for (let ${name} of ${collection}) {\n\t${}\n}", {
			label: "for",
			detail: "of loop",
			type: "keyword",
		}),
		...
		BO('import {${names}} from "${module}"\n${}', {
			label: "import",
			detail: "named",
			type: "keyword",
		}),
		BO('import ${name} from "${module}"\n${}', {
			label: "import",
			detail: "default",
			type: "keyword",
		}),
...
const Cx = ["FunctionDeclaration"],
	Ax = {
		FunctionDeclaration: _x("function"),
		ClassDeclaration: _x("class"),
		ClassExpression: () => !0,
		EnumDeclaration: _x("constant"),
		TypeAliasDeclaration: _x("type"),
		NamespaceDeclaration: _x("namespace"),
		VariableDefinition(e, t) {
			e.matchContext(Cx) || t(e, "variable");
		},
		TypeDefinition(e, t) {
			t(e, "type");
		},
...
function Xx(e, t) {
	...
	return (
		t.cursor(pc.IncludeAnonymous).iterate((t) => {
			if (r) r = !1;
			else if (t.name) {
				let e = Ax[t.name];
				if ((e && e(t, s)) || Tx.has(t.name)) return !1;
			} else if (t.to - t.from > 8192) {
				for (let i of Xx(e, t.node)) n.push(i);
				return !1;
			}
		}),
		Zx.set(t, n),
...
function Ex(e) {
	let t = Cu(e.state).resolveInner(e.pos, -1);
	if (Rx.indexOf(t.name) > -1) return null;
	let i =
		"VariableName" == t.name ||
		(t.to - t.from < 20 && Mx.test(e.state.sliceDoc(t.from, t.to)));
	if (!i && !e.explicit) return null;
	let n = [];
	for (let i = t; i; i = i.parent)
		Tx.has(i.name) && (n = n.concat(Xx(e.state.doc, i)));
	return { options: n, from: i ? t.from : e.pos, validFor: Mx };
}
function jx(e, t, i) {
	var n;
	let r = [];
...
function qx(e) {
	let t = (t) => e.state.doc.sliceString(t.from, t.to),
		i = Cu(e.state).resolveInner(e.pos, -1);
	return "PropertyName" == i.name
		? jx(t, i.parent, t(i))
		: ("." != i.name && "?." != i.name) || "MemberExpression" != i.parent.name
			? Rx.indexOf(i.name) > -1
				? null
				: "VariableName" == i.name || (i.to - i.from < 20 && Mx.test(t(i)))
					? { path: [], name: t(i) }
...
const Vx = _u.define({
		...
		parser: vx.configure({
			props: [
				Gu.add({
					IfStatement: sf({ except: /^\s*({|else\b)/ }),
					TryStatement: sf({ except: /^\s*({|catch\b|finally\b)/ }),
					LabeledStatement: rf,
					SwitchBody: (e) => {
						let t = e.textAfter,
							i = /^\s*\}/.test(t),
	...
	Lx = {
		...
		facet: $u({ commentTokens: { block: { open: "{/*", close: "*/}" } } }),
	},
	Wx = Vx.configure({ dialect: "ts" }, "typescript"),
	Dx = Vx.configure({
		dialect: "jsx",
		props: [Pu.add((e) => (e.isTop ? [Lx] : void 0))],
	}),
	zx = Vx.configure(
		{ dialect: "jsx ts", props: [Pu.add((e) => (e.isTop ? [Lx] : void 0))] },
		"typescript",
	);
let Yx = (e) => ({ label: e, type: "keyword" });
const Bx =
		"break case const continue default delete export extends false finally in instanceof let new return static super switch this throw true typeof var yield"
			...
			.map(Yx),
	Ix = Bx.concat(
		["declare", "implements", "private", "protected", "public"].map(Yx),
	);
function Ux(e = {}) {
	let t = e.jsx ? (e.typescript ? zx : Dx) : e.typescript ? Wx : Vx,
		i = e.typescript ? Px.concat(Ix) : $x.concat(Bx);
	return new Wu(t, [
		Vx.data.of({ autocomplete: PO(Rx, $O(i)) }),
		Vx.data.of({ autocomplete: Ex }),
		e.jsx ? Hx : [],
	]);
}
function Nx(e, t, i = e.length) {
...
const Gx =
		"object" == typeof navigator && /Android\b/.test(navigator.userAgent),
	Hx = Fl.inputHandler.of((e, t, i, n, r) => {
		if (
			(Gx ? e.composing : e.compositionStarted) ||
			e.state.readOnly ||
			t != i ||
			(">" != n && "/" != n) ||
			!Vx.isActiveAt(e.state, t, -1)
		)
			return !1;
		let s = r(),
			{ state: o } = s,
...
function Kx(e, t, i) {
	let n = Fx(e.line, e.column, t, i),
		r = {
			from: n,
			to:
				null != e.endLine && 1 != e.endColumn
					? Fx(e.endLine, e.endColumn, t, i)
					: n,
			message: e.message,
...
var Jx = Object.freeze({
	...
	esLint: function (e, t) {
		return (
			...
			(i) => {
				let { state: n } = i,
					r = [];
				for (let { from: i, to: s } of Vx.findRegions(n)) {
					let o = n.doc.lineAt(i),
						a = { line: o.number - 1, col: i - o.from, pos: i };
					for (let o of e.verify(n.sliceDoc(i, s), t)) r.push(Kx(o, n.doc, a));
				}
				return r;
			}
		);
	...
	javascript: Ux,
	javascriptLanguage: Vx,
	jsxLanguage: Dx,
	localCompletionSource: Ex,
	scopeCompletionSource: function (e) {
		...
		return (i) => {
			...
			return (
				...
				{ from: i.pos - n.name.length, options: s, validFor: Mx }
			);
		};
	},
	snippets: $x,
	tsxLanguage: zx,
	typescriptLanguage: Wx,
	typescriptSnippets: Px,
});
const eb = ["_blank", "_self", "_top", "_parent"],
	tb = ["ascii", "utf-8", "utf-16", "latin1", "latin1"],
	ib = ["get", "post", "put", "delete"],
	nb = [
	...
	ob = {
		...
		b: sb,
		base: { attrs: { href: null, target: eb } },
		bdi: sb,
		bdo: sb,
	...
	lb =
		"beforeunload copy cut dragstart dragover dragleave dragenter dragend drag paste focus blur change click load mousedown mouseenter mouseleave mouseup keydown keyup resize scroll unload"
			.split(" ")
			.map((e) => "on" + e);
for (let e of lb) ab[e] = null;
class hb {
	constructor(e, t) {
		(this.tags = Object.assign(Object.assign({}, ob), e)),
			(this.globalAttrs = Object.assign(Object.assign({}, ab), t)),
			(this.allTags = Object.keys(this.tags)),
			(this.globalAttrNames = Object.keys(this.globalAttrs));
	}
}
function cb(e, t, i = e.length) {
	if (!t) return "";
	let n = t.firstChild,
...
function fb(e, t, i) {
	let n = i.tags[cb(e, ub(t))];
	return (null == n ? void 0 : n.children) || i.allTags;
}
function db(e, t) {
	let i = [];
	for (let n = ub(t); n && !n.type.isTop; n = ub(n.parent)) {
		let r = cb(e, n);
					...
					: "Is" == r.name ||
						...
						: !t.explicit ||
							...
							: (function (e, t, i, n) {
									let r = [],
										s = 0;
									for (let n of fb(e.doc, i, t))
										r.push({ label: "<" + n, type: "type" });
									for (let t of db(e.doc, i))
										r.push({
											label: "</" + t + ">",
											type: "type",
											boost: 99 - s++,
...
function xb(e) {
	return gb(hb.default, e);
}
function bb(e) {
	let { extraTags: t, extraGlobalAttributes: i } = e,
		n = i || t ? new hb(t, i) : hb.default;
	return (e) => gb(n, e);
}
const yb = Vx.parser.configure({ top: "SingleExpression" }),
	Sb = [
		{
			tag: "script",
	...
	wb = [
		{ name: "style", parser: cx.parser.configure({ top: "Styles" }) },
	].concat(lb.map((e) => ({ name: e, parser: Vx.parser }))),
	kb = _u.define({
		name: "html",
		parser: Mg.configure({
			props: [
				...
				$f.add({ "OpenTag CloseTag": (e) => e.getChild("TagName") }),
			],
		}),
		languageData: {
...
function vb(e = {}) {
	...
	!1 === e.matchClosingTags && (i = "noMatch"),
		...
		((e.nestedLanguages && e.nestedLanguages.length) ||
			...
			(t = qg(
				(e.nestedLanguages || []).concat(Sb),
				(e.nestedAttributes || []).concat(wb),
			));
	let n = t
		? kb.configure({ wrap: t, dialect: i })
		: i
			? Qb.configure({ dialect: i })
			: Qb;
	return new Wu(n, [
		Qb.data.of({ autocomplete: bb(e) }),
		!1 !== e.autoCloseTags ? Pb : [],
		Ux().support,
		ux().support,
	]);
}
const $b = new Set(
	...
	Pb = Fl.inputHandler.of((e, t, i, n, r) => {
		if (
			e.composing ||
			e.state.readOnly ||
			t != i ||
			(">" != n && "/" != n) ||
			!Qb.isActiveAt(e.state, t, -1)
		)
			return !1;
		let s = r(),
			{ state: o } = s,
...
var Zb = Object.freeze({
	...
	autoCloseTags: Pb,
	html: vb,
	htmlCompletionSource: xb,
	htmlCompletionSourceWith: bb,
	htmlLanguage: Qb,
	htmlPlain: kb,
});
const Tb = $u({
...
function Xb(e, t) {
	...
	for (;;) {
		let e,
			n = i.nextSibling;
		if (!n || (null != (e = Ab(n.type)) && e <= t)) break;
		i = n;
	}
	return i.to;
}
const Mb = of.of((e, t, i) => {
	for (let n = Cu(e).resolveInner(i, -1); n && !(n.from < t); n = n.parent) {
		let e = n.type.prop(_b);
		if (null == e) continue;
		let t = Xb(n, e);
...
function Rb(e) {
	return new Zu(Tb, e, [Mb], "markdown");
}
const Eb = Rb(Cb),
	jb = Rb(
		Cb.configure([
...
class qb {
	...
	marker(e, t) {
		let i =
			"OrderedList" == this.node.name ? String(+Lb(this.item, e)[2] + t) : "";
...
function Vb(e, t) {
	...
	for (let e = i.length - 1; e >= 0; e--) {
		...
		if ("Blockquote" == s.name && (r = /^ *>( ?)/.exec(o.text.slice(a))))
			n.push(new qb(s, a, a + r[0].length, "", r[1], ">", null));
		else if (
			"ListItem" == s.name &&
			...
			e.length >= 4 && ((e = e.slice(0, e.length - 4)), (t -= 4)),
				n.push(new qb(s.parent, a, a + t, r[1], e, r[2], s));
		} else if (
			"ListItem" == s.name &&
			...
			r[3] && (i += r[3].replace(/[xX]/, " ")),
				n.push(new qb(s.parent, a, a + t, r[1], e, i, s));
		}
	}
	return n;
}
...
function Db(e, t) {
	...
	if (!i || "\t" != t.facet(Yu)) return e;
	let n = "";
	for (let t = Lr(e, 4, i); t > 0; )
		t >= 4 ? ((n += "\t"), (t -= 4)) : ((n += " "), t--);
	return n + e.slice(i);
}
const zb = ({ state: e, dispatch: t }) => {
	let i = Cu(e),
		{ doc: n } = e,
		r = null,
		s = e.changeByRange((t) => {
			if (!t.empty || !jb.isActiveAt(e, t.from, 0)) return (r = { range: t });
			let s = t.from,
				o = n.lineAt(s),
				a = Vb(i.resolveInner(s, -1), n);
			...
			if (l.item && h) {
				...
				if (
					...
					return (
						"OrderedList" == l.node.name && Wb(l.item, n, r, -2),
						t && "OrderedList" == t.node.name && Wb(t.item, n, r),
						{ range: Cn.cursor(e + i.length), changes: r }
					);
				}
				{
					let t = Bb(a, e, o);
					return {
						range: Cn.cursor(s + t.length + 1),
			...
			let c = [];
			"OrderedList" == l.node.name && Wb(l.item, n, c);
			...
			if (!u || /^[\s\d.)\-+*>]*/.exec(o.text)[0].length >= l.to)
				for (let e = 0, t = a.length - 1; e <= t; e++)
					f +=
						e != t || u
							? a[e].blank(
									e < t ? Lr(o.text, 4, a[e + 1].from) - f.length : null,
								)
							: a[e].marker(n, 1);
			let d = s;
			...
			return (
				...
				})(l.node, e.doc) && (f = Bb(a, e, o) + e.lineBreak + f),
				c.push({ from: d, to: s, insert: e.lineBreak + f }),
				{ range: Cn.cursor(d + f.length + 1), changes: c }
			);
		});
...
function Bb(e, t, i) {
	...
	for (let t = 0, r = e.length - 2; t <= r; t++)
		n += e[t].blank(
			t < r
				? Lr(i.text, 4, Math.min(i.text.length, e[t + 1].from)) - n.length
				: null,
			t < r,
		);
	return Db(n, t);
}
const Ib = ({ state: e, dispatch: t }) => {
		let i = Cu(e),
			n = null,
			r = e.changeByRange((t) => {
				let r = t.from,
					{ doc: s } = e;
				if (t.empty && jb.isActiveAt(e, t.from)) {
					let t = s.lineAt(r),
						n = Vb(
							(function (e, t) {
								let i = e.resolveInner(t, -1),
									n = t;
								Yb(i) && ((n = i.from), (i = i.parent));
					...
					if (n.length) {
						...
						if (
							...
							if (
								...
								let r = i.blank(Lr(t.text, 4, i.to) - Lr(t.text, 4, i.from));
								return (
									n == t.from && (r = Db(r, e)),
									{
										range: Cn.cursor(n + r.length),
										changes: { from: n, to: t.from + i.to, insert: r },
									}
								);
							}
							if (n < r)
								return { range: Cn.cursor(n), changes: { from: n, to: r } };
						}
					}
				}
				return (n = { range: t });
...
function Gb(e = {}) {
	...
	let a,
		...
		h = [o.support];
	i instanceof Wu ? (h.push(i.support), (a = i.language)) : i && (a = i);
	let c =
		t || a
			? (function (e, t) {
					return (i) => {
						if (i && e) {
							...
							if (
								...
								(t =
									"function" == typeof e
										? e(i)
										: Du.matchLanguageName(e, i, !0)),
								t instanceof Du)
							)
								return t.support
									? t.support.language.parser
									: Mu.getSkippingParser(t.load());
	...
	l.push(
		(function (e) {
			let { codeParser: t, htmlParser: i } = e,
				n = qc((e, n) => {
					let r = e.type.id;
					if (!t || (r != up.CodeBlock && r != up.FencedCode)) {
						if (i && (r == up.HTMLBlock || r == up.HTMLTag))
							return { parser: i, overlay: xm(e.node, e.from, e.to) };
					} else {
						let i = "";
						if (r == up.FencedCode) {
							let t = e.node.getChild(up.CodeInfo);
							t && (i = n.read(t.from, t.to));
						}
						let s = t(i);
						if (s)
							return { parser: s, overlay: (e) => e.type.id == up.CodeText };
					}
					return null;
				});
			return { wrap: n };
		...
		n && h.push(Un.high(sh.of(Ub)));
	let u = Rb(r.configure(l));
	return s && h.push(u.data.of({ autocomplete: Hb })), new Wu(u, h);
}
function Hb(e) {
	let { state: t, pos: i } = e,
		n = /<[:\-\.\w\u00b7-\uffff]*$/.exec(t.sliceDoc(i - 25, i));
	if (!n) return null;
	let r = Cu(t).resolveInner(i, -1);
	for (; r && !r.type.isTop; ) {
		if (
			"CodeBlock" == r.name ||
			"FencedCode" == r.name ||
...
function Kb() {
	if (Fb) return Fb;
	let e = xb(new QO(wr.create({ extensions: Nb }), 0, !0));
	return (Fb = e ? e.options : []);
}
var Jb = Object.freeze({
	__proto__: null,
	commonmarkLanguage: Eb,
	deleteMarkupBackward: Ib,
	insertNewlineContinueMarkup: zb,
	markdown: Gb,
	markdownKeymap: Ub,
	markdownLanguage: jb,
});
function ey(e) {
	return new Wu(Rf.define(e));
}
function ty(e) {
	return import("./chunks/index.D5fs75Gz.js").then((t) =>
		t.sql({ dialect: t[e] }),
	);
}
const iy = [
		Du.of({
			name: "C",
			extensions: ["c", "h", "ino"],
			load: () => import("./chunks/index.BJJ5-xqP.js").then((e) => e.cpp()),
		}),
		Du.of({
			name: "C++",
			alias: ["cpp"],
		...
		Du.of({
			name: "Go",
			extensions: ["go"],
			load: () => import("./chunks/index.Co_XKNq5.js").then((e) => e.go()),
		}),
		Du.of({
			name: "HTML",
			alias: ["xhtml"],
		...
		Du.of({
			name: "Java",
			extensions: ["java"],
			load: () => import("./chunks/index.tJV-BRUA.js").then((e) => e.java()),
		}),
		Du.of({
			name: "JavaScript",
		...
		Du.of({
			...
			alias: ["json5"],
			extensions: ["json", "map"],
			load: () => import("./chunks/index.NX4Ebrcw.js").then((e) => e.json()),
		}),
		Du.of({
			name: "JSX",
			extensions: ["jsx"],
		...
		Du.of({
			name: "LESS",
			extensions: ["less"],
			load: () => import("./chunks/index.O5_VdGpq.js").then((e) => e.less()),
		}),
		Du.of({
			name: "Liquid",
			extensions: ["liquid"],
			load: () => import("./chunks/index.CWF3YC1H.js").then((e) => e.liquid()),
		}),
		Du.of({ name: "MariaDB SQL", load: () => ty("MariaSQL") }),
		Du.of({
			name: "Markdown",
		...
		Du.of({ name: "MS SQL", load: () => ty("MSSQL") }),
		Du.of({ name: "MySQL", load: () => ty("MySQL") }),
		Du.of({
			name: "PHP",
			extensions: ["php", "php3", "php4", "php5", "php7", "phtml"],
			load: () => import("./chunks/index.CvGiPsMB.js").then((e) => e.php()),
		}),
		Du.of({ name: "PLSQL", extensions: ["pls"], load: () => ty("PLSQL") }),
		Du.of({ name: "PostgreSQL", load: () => ty("PostgreSQL") }),
		Du.of({
			name: "Python",
			extensions: ["BUILD", "bzl", "py", "pyw"],
			filename: /^(BUCK|BUILD)$/,
			load: () => import("./chunks/index.6NDEwdHc.js").then((e) => e.python()),
		}),
		Du.of({
			name: "Rust",
			extensions: ["rs"],
			load: () => import("./chunks/index.DvwpPNGe.js").then((e) => e.rust()),
		}),
		Du.of({
			name: "Sass",
			extensions: ["sass"],
			load: () =>
				import("./chunks/index.qvBtxdCP.js").then((e) =>
					e.sass({ indented: !0 }),
				),
		}),
		Du.of({
			name: "SCSS",
			extensions: ["scss"],
			load: () => import("./chunks/index.qvBtxdCP.js").then((e) => e.sass()),
		}),
		Du.of({ name: "SQL", extensions: ["sql"], load: () => ty("StandardSQL") }),
		Du.of({ name: "SQLite", load: () => ty("SQLite") }),
		Du.of({
			name: "TSX",
			extensions: ["tsx"],
			load: () =>
		...
		Du.of({
			name: "WebAssembly",
			extensions: ["wat", "wast"],
			load: () => import("./chunks/index.DHVNj1ny.js").then((e) => e.wast()),
		}),
		Du.of({
			name: "XML",
			alias: ["rss", "wsdl", "xsd"],
			extensions: ["xml", "xsl", "xsd", "svg"],
			load: () => import("./chunks/index.CIlkkRBN.js").then((e) => e.xml()),
		}),
		Du.of({
			name: "YAML",
			alias: ["yml"],
			extensions: ["yaml", "yml"],
			load: () => import("./chunks/index.C8cYkFRn.js").then((e) => e.yaml()),
		}),
		Du.of({
			name: "APL",
			extensions: ["dyalog", "apl"],
			load: () => import("./chunks/apl.BuPX9VEw.js").then((e) => ey(e.apl)),
		}),
		Du.of({
			name: "PGP",
			alias: ["asciiarmor"],
			...
			load: () =>
				import("./chunks/asciiarmor.Dc8B5G8A.js").then((e) => ey(e.asciiArmor)),
		}),
		Du.of({
			name: "ASN.1",
			extensions: ["asn", "asn1"],
			load: () =>
				import("./chunks/asn1.BDz4iuxp.js").then((e) => ey(e.asn1({}))),
		}),
		Du.of({
			name: "Asterisk",
			filename: /^extensions\.conf$/i,
			load: () =>
				import("./chunks/asterisk.C82DPUKR.js").then((e) => ey(e.asterisk)),
		}),
		Du.of({
			name: "Brainfuck",
			extensions: ["b", "bf"],
			load: () =>
				import("./chunks/brainfuck.BwRv728K.js").then((e) => ey(e.brainfuck)),
		}),
		Du.of({
			name: "Cobol",
			extensions: ["cob", "cpy"],
			load: () => import("./chunks/cobol.-krg72Cf.js").then((e) => ey(e.cobol)),
		}),
		Du.of({
			name: "C#",
			alias: ["csharp", "cs"],
			extensions: ["cs"],
			load: () =>
				import("./chunks/clike.C9L4dJVO.js").then((e) => ey(e.csharp)),
		}),
		Du.of({
			name: "Clojure",
			extensions: ["clj", "cljc", "cljx"],
			load: () =>
				import("./chunks/clojure.AkF0XW0v.js").then((e) => ey(e.clojure)),
		}),
		Du.of({
			name: "ClojureScript",
			extensions: ["cljs"],
		...
		Du.of({
			...
			extensions: ["gss"],
			load: () => import("./chunks/css.CwX5DWH3.js").then((e) => ey(e.gss)),
		}),
		Du.of({
			name: "CMake",
			extensions: ["cmake", "cmake.in"],
			filename: /^CMakeLists\.txt$/,
			load: () => import("./chunks/cmake.S1okIffi.js").then((e) => ey(e.cmake)),
		}),
		Du.of({
			name: "CoffeeScript",
			...
			extensions: ["coffee"],
			load: () =>
				import("./chunks/coffeescript.B2Ds5C9w.js").then((e) =>
					ey(e.coffeeScript),
				),
		}),
		Du.of({
			...
			load: () =>
				import("./chunks/commonlisp.DwONo3U1.js").then((e) => ey(e.commonLisp)),
		}),
		Du.of({
			name: "Cypher",
			extensions: ["cyp", "cypher"],
			load: () =>
				import("./chunks/cypher.DYjRYMkW.js").then((e) => ey(e.cypher)),
		}),
		Du.of({
			name: "Cython",
			extensions: ["pyx", "pxd", "pxi"],
			load: () =>
				import("./chunks/python.CpuYapI3.js").then((e) => ey(e.cython)),
		}),
		Du.of({
			name: "Crystal",
			extensions: ["cr"],
			load: () =>
				import("./chunks/crystal.DhnynEcp.js").then((e) => ey(e.crystal)),
		}),
		Du.of({
			name: "D",
			extensions: ["d"],
			load: () => import("./chunks/d.BVJ07tn8.js").then((e) => ey(e.d)),
		}),
		Du.of({
			name: "Dart",
			extensions: ["dart"],
			load: () => import("./chunks/clike.C9L4dJVO.js").then((e) => ey(e.dart)),
		}),
		Du.of({
			name: "diff",
			extensions: ["diff", "patch"],
			load: () => import("./chunks/diff.C-R2Fpml.js").then((e) => ey(e.diff)),
		}),
		Du.of({
			name: "Dockerfile",
			filename: /^Dockerfile$/,
			load: () =>
				import("./chunks/dockerfile.CVq5ZMHQ.js").then((e) => ey(e.dockerFile)),
		}),
		Du.of({
			name: "DTD",
			extensions: ["dtd"],
			load: () => import("./chunks/dtd.BuZjojg2.js").then((e) => ey(e.dtd)),
		}),
		Du.of({
			name: "Dylan",
			extensions: ["dylan", "dyl", "intr"],
			load: () => import("./chunks/dylan.C6_CAjix.js").then((e) => ey(e.dylan)),
		}),
		Du.of({
			name: "EBNF",
			load: () => import("./chunks/ebnf.BjwhfbFx.js").then((e) => ey(e.ebnf)),
		}),
		Du.of({
			name: "ECL",
			extensions: ["ecl"],
			load: () => import("./chunks/ecl.Bx-RV3ra.js").then((e) => ey(e.ecl)),
		}),
		Du.of({
			name: "edn",
			extensions: ["edn"],
		...
		Du.of({
			...
			extensions: ["e"],
			load: () =>
				import("./chunks/eiffel.CzM7XVnb.js").then((e) => ey(e.eiffel)),
		}),
		Du.of({
			name: "Elm",
			extensions: ["elm"],
			load: () => import("./chunks/elm.u17ZFtZ5.js").then((e) => ey(e.elm)),
		}),
		Du.of({
			name: "Erlang",
			extensions: ["erl"],
			load: () =>
				import("./chunks/erlang.CaCSIOV6.js").then((e) => ey(e.erlang)),
		}),
		Du.of({
			name: "Esper",
			load: () => import("./chunks/sql.tZ5ZKsvZ.js").then((e) => ey(e.esper)),
		}),
		Du.of({
			name: "Factor",
			extensions: ["factor"],
			load: () =>
				import("./chunks/factor.BmDusBT0.js").then((e) => ey(e.factor)),
		}),
		Du.of({
			name: "FCL",
			load: () => import("./chunks/fcl.yyRnLECb.js").then((e) => ey(e.fcl)),
		}),
		Du.of({
			name: "Forth",
			extensions: ["forth", "fth", "4th"],
			load: () => import("./chunks/forth.kdsLDARs.js").then((e) => ey(e.forth)),
		}),
		Du.of({
			name: "Fortran",
			extensions: ["f", "for", "f77", "f90", "f95"],
			load: () =>
				import("./chunks/fortran.D51XuN6l.js").then((e) => ey(e.fortran)),
		}),
		Du.of({
			name: "F#",
			alias: ["fsharp"],
			extensions: ["fs"],
			load: () =>
				import("./chunks/mllike.B4tPkq-p.js").then((e) => ey(e.fSharp)),
		}),
		Du.of({
			name: "Gas",
			extensions: ["s"],
			load: () => import("./chunks/gas.DrJj-82u.js").then((e) => ey(e.gas)),
		}),
		Du.of({
			name: "Gherkin",
			extensions: ["feature"],
			load: () =>
				import("./chunks/gherkin.RX6Qn0dm.js").then((e) => ey(e.gherkin)),
		}),
		Du.of({
			name: "Groovy",
			...
			load: () =>
				import("./chunks/groovy.X-6GX7ze.js").then((e) => ey(e.groovy)),
		}),
		Du.of({
			name: "Haskell",
			extensions: ["hs"],
			load: () =>
				import("./chunks/haskell.BCnhBulK.js").then((e) => ey(e.haskell)),
		}),
		Du.of({
			name: "Haxe",
			extensions: ["hx"],
			load: () => import("./chunks/haxe.D4zSCdiB.js").then((e) => ey(e.haxe)),
		}),
		Du.of({
			name: "HXML",
			extensions: ["hxml"],
			load: () => import("./chunks/haxe.D4zSCdiB.js").then((e) => ey(e.hxml)),
		}),
		Du.of({
			name: "HTTP",
			load: () => import("./chunks/http.BU69H5as.js").then((e) => ey(e.http)),
		}),
		Du.of({
			name: "IDL",
			extensions: ["pro"],
			load: () => import("./chunks/idl.I8V4P5aO.js").then((e) => ey(e.idl)),
		}),
		Du.of({
			name: "JSON-LD",
			alias: ["jsonld"],
			extensions: ["jsonld"],
			load: () =>
				import("./chunks/javascript.BN3akSpK.js").then((e) => ey(e.jsonld)),
		}),
		Du.of({
			name: "Jinja2",
			extensions: ["j2", "jinja", "jinja2"],
			load: () =>
				import("./chunks/jinja2.Df7Us2GM.js").then((e) => ey(e.jinja2)),
		}),
		Du.of({
			name: "Julia",
			extensions: ["jl"],
			load: () => import("./chunks/julia.CcctcoET.js").then((e) => ey(e.julia)),
		}),
		Du.of({
			name: "Kotlin",
			extensions: ["kt", "kts"],
			load: () =>
				import("./chunks/clike.C9L4dJVO.js").then((e) => ey(e.kotlin)),
		}),
		Du.of({
			name: "LiveScript",
			alias: ["ls"],
			extensions: ["ls"],
			load: () =>
				import("./chunks/livescript.GnE8telU.js").then((e) => ey(e.liveScript)),
		}),
		Du.of({
			name: "Lua",
			extensions: ["lua"],
			load: () => import("./chunks/lua.C0O-S2F2.js").then((e) => ey(e.lua)),
		}),
		Du.of({
			name: "mIRC",
			extensions: ["mrc"],
			load: () => import("./chunks/mirc.7i5xRqqO.js").then((e) => ey(e.mirc)),
		}),
		Du.of({
			name: "Mathematica",
			extensions: ["m", "nb", "wl", "wls"],
			load: () =>
				import("./chunks/mathematica.DyMxy8Yi.js").then((e) =>
					ey(e.mathematica),
				),
		}),
		Du.of({
			...
			extensions: ["mo"],
			load: () =>
				import("./chunks/modelica.CNlGkRmq.js").then((e) => ey(e.modelica)),
		}),
		Du.of({
			name: "MUMPS",
			extensions: ["mps"],
			load: () => import("./chunks/mumps.Cp0zpLQL.js").then((e) => ey(e.mumps)),
		}),
		Du.of({
			name: "Mbox",
			extensions: ["mbox"],
			load: () => import("./chunks/mbox.DynYm9G_.js").then((e) => ey(e.mbox)),
		}),
		Du.of({
			name: "Nginx",
			filename: /nginx.*\.conf$/i,
			load: () => import("./chunks/nginx.DQwbQvlx.js").then((e) => ey(e.nginx)),
		}),
		Du.of({
			name: "NSIS",
			extensions: ["nsh", "nsi"],
			load: () => import("./chunks/nsis.DChWAGMQ.js").then((e) => ey(e.nsis)),
		}),
		Du.of({
			name: "NTriples",
			extensions: ["nt", "nq"],
			load: () =>
				import("./chunks/ntriples.C0a5RtTO.js").then((e) => ey(e.ntriples)),
		}),
		Du.of({
			name: "Objective-C",
			...
			extensions: ["m"],
			load: () =>
				import("./chunks/clike.C9L4dJVO.js").then((e) => ey(e.objectiveC)),
		}),
		Du.of({
			name: "Objective-C++",
			alias: ["objective-c++", "objc++"],
			extensions: ["mm"],
			load: () =>
				import("./chunks/clike.C9L4dJVO.js").then((e) => ey(e.objectiveCpp)),
		}),
		Du.of({
			name: "OCaml",
			extensions: ["ml", "mli", "mll", "mly"],
			load: () =>
				import("./chunks/mllike.B4tPkq-p.js").then((e) => ey(e.oCaml)),
		}),
		Du.of({
			name: "Octave",
			extensions: ["m"],
			load: () =>
				import("./chunks/octave.D-_WkXCA.js").then((e) => ey(e.octave)),
		}),
		Du.of({
			name: "Oz",
			extensions: ["oz"],
			load: () => import("./chunks/oz.DUZw3GIi.js").then((e) => ey(e.oz)),
		}),
		Du.of({
			name: "Pascal",
			extensions: ["p", "pas"],
			load: () =>
				import("./chunks/pascal.BJAbCgSP.js").then((e) => ey(e.pascal)),
		}),
		Du.of({
			name: "Perl",
			extensions: ["pl", "pm"],
			load: () => import("./chunks/perl.DIg7Ledi.js").then((e) => ey(e.perl)),
		}),
		Du.of({
			name: "Pig",
			extensions: ["pig"],
			load: () => import("./chunks/pig.Cou8x8-L.js").then((e) => ey(e.pig)),
		}),
		Du.of({
			name: "PowerShell",
			extensions: ["ps1", "psd1", "psm1"],
			load: () =>
				import("./chunks/powershell.0bTgRPH2.js").then((e) => ey(e.powerShell)),
		}),
		Du.of({
			...
			load: () =>
				import("./chunks/properties.BhmI2oK4.js").then((e) => ey(e.properties)),
		}),
		Du.of({
			name: "ProtoBuf",
			extensions: ["proto"],
			load: () =>
				import("./chunks/protobuf.DhXce1wF.js").then((e) => ey(e.protobuf)),
		}),
		Du.of({
			name: "Pug",
			alias: ["jade"],
			extensions: ["pug", "jade"],
			load: () => import("./chunks/pug.BBXMNeTD.js").then((e) => ey(e.pug)),
		}),
		Du.of({
			name: "Puppet",
			extensions: ["pp"],
			load: () =>
				import("./chunks/puppet.BH0nsyIx.js").then((e) => ey(e.puppet)),
		}),
		Du.of({
			name: "Q",
			extensions: ["q"],
			load: () => import("./chunks/q.BkijbN36.js").then((e) => ey(e.q)),
		}),
		Du.of({
			name: "R",
			alias: ["rscript"],
			extensions: ["r", "R"],
			load: () => import("./chunks/r.wGAz1Uhc.js").then((e) => ey(e.r)),
		}),
		Du.of({
			name: "RPM Changes",
			load: () =>
				import("./chunks/rpm.Bbchi_Be.js").then((e) => ey(e.rpmChanges)),
		}),
		Du.of({
			name: "RPM Spec",
			extensions: ["spec"],
			load: () => import("./chunks/rpm.Bbchi_Be.js").then((e) => ey(e.rpmSpec)),
		}),
		Du.of({
			name: "Ruby",
			...
			load: () => import("./chunks/ruby.CvaHvrJd.js").then((e) => ey(e.ruby)),
		}),
		Du.of({
			name: "SAS",
			extensions: ["sas"],
			load: () => import("./chunks/sas.DfyHupFZ.js").then((e) => ey(e.sas)),
		}),
		Du.of({
			name: "Scala",
			extensions: ["scala"],
			load: () => import("./chunks/clike.C9L4dJVO.js").then((e) => ey(e.scala)),
		}),
		Du.of({
			name: "Scheme",
			extensions: ["scm", "ss"],
			load: () =>
				import("./chunks/scheme.BhM5u3Ks.js").then((e) => ey(e.scheme)),
		}),
		Du.of({
			name: "Shell",
			alias: ["bash", "sh", "zsh"],
			...
			filename: /^PKGBUILD$/,
			load: () => import("./chunks/shell.Cqhz4sx0.js").then((e) => ey(e.shell)),
		}),
		Du.of({
			name: "Sieve",
			extensions: ["siv", "sieve"],
			load: () => import("./chunks/sieve.Bpa21WeI.js").then((e) => ey(e.sieve)),
		}),
		Du.of({
			name: "Smalltalk",
			extensions: ["st"],
			load: () =>
				import("./chunks/smalltalk.CsIHXArJ.js").then((e) => ey(e.smalltalk)),
		}),
		Du.of({
			name: "Solr",
			load: () => import("./chunks/solr.DZjs5L2P.js").then((e) => ey(e.solr)),
		}),
		Du.of({
			name: "SML",
			extensions: ["sml", "sig", "fun", "smackspec"],
			load: () => import("./chunks/mllike.B4tPkq-p.js").then((e) => ey(e.sml)),
		}),
		Du.of({
			name: "SPARQL",
			alias: ["sparul"],
			...
			load: () =>
				import("./chunks/sparql.BzrNCnOT.js").then((e) => ey(e.sparql)),
		}),
		Du.of({
			name: "Spreadsheet",
			alias: ["excel", "formula"],
			load: () =>
				import("./chunks/spreadsheet.BqfJNQPn.js").then((e) =>
					ey(e.spreadsheet),
				),
		}),
		Du.of({
			...
			extensions: ["nut"],
			load: () =>
				import("./chunks/clike.C9L4dJVO.js").then((e) => ey(e.squirrel)),
		}),
		Du.of({
			name: "Stylus",
			extensions: ["styl"],
			load: () =>
				import("./chunks/stylus.B_0T-kOa.js").then((e) => ey(e.stylus)),
		}),
		Du.of({
			name: "Swift",
			extensions: ["swift"],
			load: () => import("./chunks/swift.C-2FdhPT.js").then((e) => ey(e.swift)),
		}),
		Du.of({
			name: "sTeX",
			load: () => import("./chunks/stex.DgHDpNlu.js").then((e) => ey(e.stex)),
		}),
		Du.of({
			name: "LaTeX",
			alias: ["tex"],
		...
		Du.of({
			...
			extensions: ["v", "sv", "svh"],
			load: () =>
				import("./chunks/verilog.BIuuowBK.js").then((e) => ey(e.verilog)),
		}),
		Du.of({
			name: "Tcl",
			extensions: ["tcl"],
			load: () => import("./chunks/tcl.BkM_P_nr.js").then((e) => ey(e.tcl)),
		}),
		Du.of({
			name: "Textile",
			extensions: ["textile"],
			load: () =>
				import("./chunks/textile.91nK2ZjG.js").then((e) => ey(e.textile)),
		}),
		Du.of({
			name: "TiddlyWiki",
			load: () =>
				import("./chunks/tiddlywiki.DAyW1ws_.js").then((e) => ey(e.tiddlyWiki)),
		}),
		Du.of({
			name: "Tiki wiki",
			load: () => import("./chunks/tiki.O4orVd5R.js").then((e) => ey(e.tiki)),
		}),
		Du.of({
			name: "TOML",
			extensions: ["toml"],
			load: () => import("./chunks/toml.BQI8Qp1X.js").then((e) => ey(e.toml)),
		}),
		Du.of({
			name: "Troff",
			extensions: ["1", "2", "3", "4", "5", "6", "7", "8", "9"],
			load: () => import("./chunks/troff.qTBBeaq6.js").then((e) => ey(e.troff)),
		}),
		Du.of({
			name: "TTCN",
			extensions: ["ttcn", "ttcn3", "ttcnpp"],
			load: () => import("./chunks/ttcn.lyl7xtwa.js").then((e) => ey(e.ttcn)),
		}),
		Du.of({
			name: "TTCN_CFG",
			extensions: ["cfg"],
			load: () =>
				import("./chunks/ttcn-cfg.BLy080lI.js").then((e) => ey(e.ttcnCfg)),
		}),
		Du.of({
			name: "Turtle",
			extensions: ["ttl"],
			load: () =>
				import("./chunks/turtle.7zCrDCQK.js").then((e) => ey(e.turtle)),
		}),
		Du.of({
			name: "Web IDL",
			extensions: ["webidl"],
			load: () =>
				import("./chunks/webidl.BicSo0Ey.js").then((e) => ey(e.webIDL)),
		}),
		Du.of({
			name: "VB.NET",
			extensions: ["vb"],
			load: () => import("./chunks/vb.Mevqhl22.js").then((e) => ey(e.vb)),
		}),
		Du.of({
			name: "VBScript",
			extensions: ["vbs"],
			load: () =>
				import("./chunks/vbscript.BiO1Qwur.js").then((e) => ey(e.vbScript)),
		}),
		Du.of({
			name: "Velocity",
			extensions: ["vtl"],
			load: () =>
				import("./chunks/velocity.CI_sEQN8.js").then((e) => ey(e.velocity)),
		}),
		Du.of({
			name: "Verilog",
			extensions: ["v"],
		...
		Du.of({
			name: "VHDL",
			extensions: ["vhd", "vhdl"],
			load: () => import("./chunks/vhdl.B28qeLZt.js").then((e) => ey(e.vhdl)),
		}),
		Du.of({
			name: "XQuery",
			extensions: ["xy", "xquery"],
			load: () =>
				import("./chunks/xquery.Bw57PY-2.js").then((e) => ey(e.xQuery)),
		}),
		Du.of({
			name: "Yacas",
			extensions: ["ys"],
			load: () => import("./chunks/yacas.BSnLxiM6.js").then((e) => ey(e.yacas)),
		}),
		Du.of({
			name: "Z80",
			extensions: ["z80"],
			load: () => import("./chunks/z80.CyKjxy6W.js").then((e) => ey(e.z80)),
		}),
		Du.of({
			name: "MscGen",
			extensions: ["mscgen", "mscin", "msc"],
			load: () =>
				import("./chunks/mscgen.CiflsZgB.js").then((e) => ey(e.mscgen)),
		}),
		Du.of({
			name: "Xù",
			extensions: ["xu"],
			load: () => import("./chunks/mscgen.CiflsZgB.js").then((e) => ey(e.xu)),
		}),
		Du.of({
			name: "MsGenny",
			extensions: ["msgenny"],
			load: () =>
				import("./chunks/mscgen.CiflsZgB.js").then((e) => ey(e.msgenny)),
		}),
		Du.of({
			name: "Vue",
			extensions: ["vue"],
			load: () => import("./chunks/index.vHMrm0_S.js").then((e) => e.vue()),
		}),
		Du.of({
			name: "Angular Template",
			load: () => import("./chunks/index.DHehNNjI.js").then((e) => e.angular()),
		}),
	],
	ny = "var(--editor-bg, #1e1e1e)",
	ry = "var(--editor-text, #d4d4d4)",
	sy = "var(--editor-selection-bg, #3a3d41)",
	oy = "var(--editor-cursor, #aeafad)",
	ay = "var(--editor-line-highlight-bg, #2a2a2a)",
	ly = "var(--editor-comment, #6a9955)",
	hy = "var(--editor-keyword, #569cd6)",
	cy = "var(--editor-string, #ce9178)",
	uy = "var(--editor-number, #b5cea8)",
	fy = "var(--editor-heading, #4ec9b0)",
	dy = "var(--editor-link, #9cdcfe)",
	Oy = "var(--editor-operator, #d4d4d4)",
	py = "var(--editor-punctuation, #808080)",
	my = Fl.theme(
		{
			"&": {
				color: ry,
			...
			"&.cm-focused .cm-cursor": { borderLeftColor: oy },
			"&.cm-focused .cm-selectionBackground, ::selection": {
				backgroundColor: sy + " !important",
			},
			".cm-gutters": { backgroundColor: ny, color: py, border: "none" },
			".cm-activeLineGutter": { backgroundColor: ay },
			".cm-activeLine": { backgroundColor: ay },
			[ku.heading]: { color: fy, fontWeight: "bold" },
			[ku.strong]: { fontWeight: "bold" },
			[ku.emphasis]: { fontStyle: "italic" },
			[ku.link]: { color: dy, textDecoration: "underline" },
			[ku.url]: { color: dy },
			[ku.quote]: { color: ly, fontStyle: "italic" },
			[ku.keyword]: { color: hy },
			[ku.comment]: { color: ly, fontStyle: "italic" },
			[ku.string]: { color: cy },
			[ku.number]: { color: uy },
			[ku.operator]: { color: Oy },
			[ku.punctuation]: { color: py },
			[ku.monospace]: {
				fontFamily: "var(--editor-mono-font-family, monospace)",
			},
			[ku.contentSeparator]: { color: fy, fontWeight: "bold" },
			[ku.list]: { color: ry },
			[ku.meta]: { color: ly },
		},
		{ dark: !0 },
	...
	const { onChange: n = () => {}, additionalExtensions: r = [] } = i,
		s = wr.create({
			...
			extensions: [
				...
				[tp, HO],
				Rh,
				wr.allowMultipleSelections.of(!0),
				Fl.lineWrapping,
				sh.of([...ip, ...kO, ...$d]),
				Gb({ base: jb, codeLanguages: iy }),
				my,
				jh("Start writing your journal entry..."),
				gy(n),
				...r,
			],
		});
	return new Fl({ state: s, parent: e });
}
class by {
	constructor(e) {
...
function yy(e, t, i, n, r = t.length) {
	const s = e.selection.main;
	if (s.empty) {
		const e = t + n + i;
		return {
			changes: { from: s.from, insert: e },
			selection: Cn.cursor(s.from + r),
		};
	}
	return {
		changes: [
		...
		selection: Cn.range(s.from + t.length, s.to + t.length),
	};
}
function Sy(e, t, i = !1) {
	const n = [];
...
function wy(e, t, i = "", n = "", r = !1) {
	const { state: s } = e,
		o = [],
		a = s.selection.main,
		l = s.doc.lineAt(a.from);
	let h = t,
		c = i,
		u = n || t + (i || "");
	if (r) {
		const e = s.doc.lineAt(a.to);
		l.from > 0 &&
			"\n" !== s.doc.sliceString(l.from - 1, l.from) &&
			(h = "\n" + h),
			l.number === e.number && 0 === l.length
				? ((u = h + "\n" + n + "\n" + c),
					o.push({ from: a.from, to: a.to, insert: u }))
				: (o.push({ from: l.from, insert: h + "\n" }),
					e.to,
					((e.to < s.doc.length &&
		...
		a.empty
			? o.push({ from: a.from, insert: h + n + c })
			: (o.push({ from: a.from, insert: h }),
				o.push({ from: a.to, insert: c }));
	e.dispatch({
		changes: o,
		selection:
			a.empty && !r
				? Cn.cursor(a.from + h.length)
				: a.empty && r
					? Cn.cursor(l.from + h.length + 1 + n.length + 1)
					: void 0,
...
function Qy(e = null) {
	return {
		...
		init() {
			...
			this.persistence = new by(this.entryId);
			...
			const r = new MutationObserver((e, t) => {
				...
				if (i) {
					...
					try {
						(this.editorView = xy(i, this.content, {
							onChange: (e) => {
				...
				if (e) {
					...
					try {
						console.log(
							...
							(this.editorView = xy(e, this.content, {
								onChange: (e) => {
									(this.content = e), this.handleContentChange();
								},
							})),
		...
		handleContentChange: ky(function () {
			console.log(
		...
		async updatePreview() {
			...
			try {
				const t = await fetch("/api/v1/markdown/preview", {
					method: "POST",
					headers: {
		...
		insertMarkdown(e) {
			if (this.editorView)
				switch (e) {
					...
					case "italic":
						!(function (e) {
							const t = yy(e.state, "*", "*", "italic text");
							e.dispatch(
						...
						!(function (e) {
							...
							if (i.empty) {
								...
								n = {
									...
									selection: Cn.cursor(i.from + e.length + 3),
								};
							}
					...
					case "blockquote":
						...
						break;
					case "image":
						wy(this.editorView, "![", "](url)", "alt text");
						break;
					case "table":
						const t =
							"| Header 1 | Header 2 |\n|---|---|\n| Cell 1 | Cell 2 |\n| Cell 3 | Cell 4 |";
						wy(this.editorView, "", "", t, !0);
						break;
					case "codeblock":
						wy(this.editorView, "```\n", "\n```", "code here", !0);
						break;
