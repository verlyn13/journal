...
function df(e, t) {
	return ff(e, (i) => (i.empty ? e.moveByChar(i, t) : Of(i, t)));
}
function pf(e) {
	return e.textDirectionAt(e.state.selection.main.head) == co.LTR;
}
const mf = (e) => df(e, !pf(e)),
	gf = (e) => df(e, pf(e));
function xf(e, t) {
	return ff(e, (i) => (i.empty ? e.moveByGroup(i, t) : Of(i, t)));
}
function bf(e, t, i) {
...
function vf(e, t) {
	let i,
		...
		{ state: r } = e,
		s = cf(r.selection, (i) =>
			i.empty ? e.moveVertically(i, t, n.height) : Of(i, t),
		);
...
function Tf(e, t) {
	return _f(e, (i) => e.moveByChar(i, t));
}
const Xf = (e) => Tf(e, !pf(e)),
	Af = (e) => Tf(e, pf(e));
function Cf(e, t) {
	return _f(e, (i) => e.moveByGroup(i, t));
}
function Rf(e, t) {
	return _f(e, (i) => e.moveVertically(i, t));
}
const Mf = (e) => Rf(e, !1),
	jf = (e) => Rf(e, !0);
function Ef(e, t) {
	return _f(e, (i) => e.moveVertically(i, t, kf(e).height));
}
const qf = (e) => Ef(e, !1),
	Vf = (e) => Ef(e, !0),
...
const rO = [
		...
		{
			key: "Ctrl-a",
			run: (e) => ff(e, (t) => _n.cursor(e.lineBlockAt(t.head).from, 1)),
			shift: (e) => _f(e, (t) => _n.cursor(e.lineBlockAt(t.head).from)),
		},
		{
			key: "Ctrl-e",
			run: (e) => ff(e, (t) => _n.cursor(e.lineBlockAt(t.head).to, -1)),
			shift: (e) => _f(e, (t) => _n.cursor(e.lineBlockAt(t.head).to)),
		},
		{ key: "Ctrl-d", run: Gf },
		{ key: "Ctrl-h", run: Uf },
		{
	...
	].concat(rO.map((e) => ({ mac: e.key, run: e.run, shift: e.shift }))),
	oO = [
		{
			key: "Alt-ArrowLeft",
			mac: "Ctrl-ArrowLeft",
			run: (e) => ff(e, (t) => Sf(e.state, t, !pf(e))),
			shift: (e) => _f(e, (t) => Sf(e.state, t, !pf(e))),
		},
		{
			key: "Alt-ArrowRight",
			mac: "Ctrl-ArrowRight",
...
class dO {
	...
	map(e) {
		...
		return null == t || null == i ? null : new dO(this.field, t, i);
	}
}
class pO {
	constructor(e, t) {
	...
	instantiate(e, t) {
		...
		let o = this.fieldPositions.map(
			(e) => new dO(e.field, n[e.line] + e.from, n[e.line] + e.to),
		);
	...
	static parse(e) {
		...
		for (let s of e.split(/\r\n?|\n/)) {
			for (
				...
				r.push(new OO(a, n.length, t.index, t.index + l.length)),
...
let mO = Ks.widget({
	...
	gO = Ks.mark({ class: "cm-snippetField" });
class xO {
	constructor(e, t) {
		(this.ranges = e),
			(this.active = t),
			(this.deco = Ks.set(
				e.map((e) => (e.from == e.to ? mO : gO).range(e.from, e.to)),
			));
	}
	map(e) {
		let t = [];
...
const bO = lr.define({ map: (e, t) => e && e.map(t) }),
	SO = lr.define(),
	yO = Vn.define({
		create: () => null,
		update(e, t) {
			for (let i of t.effects) {
				if (i.is(bO)) return i.value;
				if (i.is(SO) && e) return new xO(e.ranges, i.value);
			}
			return (
	...
	return (e, i, n, r) => {
		let { text: s, ranges: o } = t.instantiate(e.state, n),
			...
			l = {
				...
				scrollIntoView: !0,
				annotations: i ? [uO.of(i), hr.userEvent.of("input.complete")] : void 0,
			};
		if ((o.length && (l.selection = QO(o, 0)), o.some((e) => e.field > 0))) {
			let t = new xO(o, 0),
				i = (l.effects = [bO.of(t)]);
			void 0 === e.state.field(yO, !1) &&
				i.push(lr.appendConfig.of([yO, PO, _O, fO]));
		}
...
function kO(e) {
	return ({ state: t, dispatch: i }) => {
		...
		return (
			i(
				t.update({
					selection: QO(n.ranges, r),
					effects: bO.of(s ? null : new xO(n.ranges, r)),
					scrollIntoView: !0,
				}),
			),
			!0
...
const vO = [
		{ key: "Tab", run: kO(1), shift: kO(-1) },
		{
			key: "Escape",
			run: ({ state: e, dispatch: t }) =>
				!!e.field(yO, !1) && (t(e.update({ effects: bO.of(null) })), !0),
		},
	],
	$O = An.define({ combine: (e) => (e.length ? e[0] : vO) }),
	PO = Bn.highest(ih.compute([$O], (e) => e.facet($O)));
function ZO(e, t) {
	return Object.assign(Object.assign({}, t), { apply: wO(e) });
}
const _O = Gl.domEventHandlers({
		mousedown(e, t) {
			let i,
				n = t.state.field(yO, !1);
			...
			return (
				!(!r || r.field == n.active) &&
				(t.dispatch({
					selection: QO(n.ranges, r.field),
					effects: bO.of(
						n.ranges.some((e) => e.field > r.field)
							? new xO(n.ranges, r.field)
							: null,
					),
					scrollIntoView: !0,
				}),
	...
	TO = new (class extends yr {})();
(TO.startSide = 1), (TO.endSide = -1);
class XO {
	static create(e, t, i, n, r) {
		return new XO(e, t, i, (n + (n << 8) + e + (t << 4)) | 0, r, [], []);
	}
	constructor(e, t, i, n, r, s, o) {
		(this.type = e),
			(this.value = t),
...
function MO(e, t, i) {
	...
	let n = (e.type == AO.OrderedList ? BO : DO)(i, t, !1);
	return (
		n > 0 &&
		(e.type != AO.BulletList || zO(i, t, !1) < 0) &&
...
const jO = {
	[AO.Blockquote]: (e, t, i) =>
		62 == i.next &&
		(i.markers.push(
			bd(AO.QuoteMark, t.lineStart + i.pos, t.lineStart + i.pos + 1),
		),
		i.moveBase(i.pos + (EO(i.text.charCodeAt(i.pos + 1)) ? 2 : 1)),
...
function zO(e, t, i) {
	...
	for (let t = e.pos + 1; t < e.text.length; t++) {
		...
		if (i == e.next) n++;
		else if (!EO(i)) return -1;
	}
	return (i &&
		45 == e.next &&
		UO(e) > -1 &&
		e.depth == t.stack.length &&
		t.parser.leafBlockParsers.indexOf(sd.SetextHeading) > -1) ||
		n < 3
		? -1
		: 1;
}
...
function DO(e, t, i) {
	return (45 != e.next && 43 != e.next && 42 != e.next) ||
		(e.pos != e.text.length - 1 && !EO(e.text.charCodeAt(e.pos + 1))) ||
		!(!i || YO(t, AO.BulletList) || e.skipSpace(e.pos + 2) < e.text.length)
		? -1
		: 1;
}
function BO(e, t, i) {
	...
	return n == e.pos ||
		n > e.pos + 9 ||
		(46 != r && 41 != r) ||
		(n < e.text.length - 1 && !EO(e.text.charCodeAt(n + 1))) ||
		(i &&
			!YO(t, AO.OrderedList) &&
...
function UO(e) {
	...
	for (; t < e.text.length && e.text.charCodeAt(t) == e.next; ) t++;
	let i = t;
	for (; t < e.text.length && EO(e.text.charCodeAt(t)); ) t++;
...
function KO(e, t, i) {
	...
	for (let e = 0, t = FO.length - (i ? 1 : 0); e < t; e++)
		if (FO[e][0].test(n)) return e;
	return -1;
}
function JO(e, t) {
...
function ed(e, t, i) {
	let n = e.length - 1;
	n >= 0 && e[n].to == t && e[n].type == AO.CodeText
		? (e[n].to = i)
		: e.push(bd(AO.CodeText, t, i));
}
const td = {
	...
	IndentedCode(e, t) {
		...
		let n = t.findColumn(i),
			...
			o = [],
			a = [];
		for (ed(o, r, s); e.nextLine() && t.depth >= e.stack.length; )
			if (t.pos == t.text.length) {
				ed(a, e.lineStart - 1, e.lineStart);
				...
				if (t.indent < i) break;
				{
					if (a.length) {
						for (let e of a)
							e.type == AO.CodeText ? ed(o, e.from, e.to) : o.push(e);
						a = [];
					}
					ed(o, e.lineStart - 1, e.lineStart);
		...
		return (
			a.length &&
				((a = a.filter((e) => e.type != AO.CodeText)),
				a.length && (t.markers = a.concat(t.markers))),
			e.addNode(e.buffer.writeElements(o, -r).finish(AO.CodeBlock, s - r), r),
			!0
		);
	},
	FencedCode(e, t) {
		...
		let n = e.lineStart + t.pos,
			...
			s = i - t.pos,
			o = t.skipSpace(i),
			a = VO(t.text, t.text.length, o),
			l = [bd(AO.CodeMark, n, n + s)];
		o < a && l.push(bd(AO.CodeInfo, e.lineStart + o, e.lineStart + a));
		for (let i = !0; e.nextLine() && t.depth >= e.stack.length; i = !1) {
			...
			if (n - t.pos >= s && t.skipSpace(n) == t.text.length) {
				...
				l.push(bd(AO.CodeMark, e.lineStart + t.pos, e.lineStart + n)),
					e.nextLine();
				break;
			}
			{
				i || ed(l, e.lineStart - 1, e.lineStart);
				for (let e of t.markers) l.push(e);
		...
		return (
			e.addNode(
				e.buffer
					.writeElements(l, -n)
					.finish(AO.FencedCode, e.prevLineEnd() - n),
				n,
			),
			!0
		);
	...
	Blockquote(e, t) {
		...
		return (
			!(i < 0) &&
			(e.startContext(AO.Blockquote, t.pos),
			e.addNode(AO.QuoteMark, e.lineStart + t.pos, e.lineStart + t.pos + 1),
			t.moveBase(t.pos + i),
			null)
		);
	},
	HorizontalRule(e, t) {
		if (zO(t, e, !1) < 0) return !1;
		let i = e.lineStart + t.pos;
		return e.nextLine(), e.addNode(AO.HorizontalRule, i), !0;
	},
	BulletList(e, t) {
		let i = DO(t, e, !1);
		if (i < 0) return !1;
		e.block.type != AO.BulletList &&
			e.startContext(AO.BulletList, t.basePos, t.next);
		let n = JO(t, t.pos + 1);
		return (
			e.startContext(AO.ListItem, t.basePos, n - t.baseIndent),
			e.addNode(AO.ListMark, e.lineStart + t.pos, e.lineStart + t.pos + i),
			t.moveBaseColumn(n),
			null
		);
	},
	...
	ATXHeading(e, t) {
		...
		let n = t.pos,
			r = e.lineStart + n,
			s = VO(t.text, t.text.length, n),
			o = s;
		for (; o > n && t.text.charCodeAt(o - 1) == t.next; ) o--;
		(o != s && o != n && EO(t.text.charCodeAt(o - 1))) || (o = t.text.length);
		let a = e.buffer
			.write(AO.HeaderMark, 0, i)
			.writeElements(
				e.parser.parseInline(t.text.slice(n + i + 1, o), r + i + 1),
				-r,
			);
		o < t.text.length && a.write(AO.HeaderMark, o - n, s - n);
		let l = a.finish(AO.ATXHeading1 - 1 + i, t.text.length - n);
...
class id {
	...
	finish(e, t) {
		return (
			...
			qO(t.content, this.pos) == t.content.length &&
	...
	complete(e, t, i) {
		return (
			e.addLeafElement(
				t,
				bd(AO.LinkReference, this.start, this.start + i, this.elts),
			),
			!0
		);
	}
	...
	advance(e) {
		for (;;) {
			if (-1 == this.stage) return -1;
			if (0 == this.stage) {
				if (!this.nextStage(Xd(e, this.pos, this.start, !0))) return -1;
				if (58 != e.charCodeAt(this.pos)) return (this.stage = -1);
				this.elts.push(
					bd(AO.LinkMark, this.pos + this.start, this.pos + this.start + 1),
				),
					this.pos++;
			} else {
				if (1 != this.stage) {
					if (2 == this.stage) {
						let t = qO(e, this.pos),
							i = 0;
						if (t > this.pos) {
							let n = Td(e, t, this.start);
							if (n) {
								let t = nd(e, n.to - this.start);
								t > 0 && (this.nextStage(n), (i = t));
							}
						}
						return i || (i = nd(e, this.pos)), i > 0 && i < e.length ? i : -1;
					}
					return nd(e, this.pos);
				}
				if (!this.nextStage(_d(e, qO(e, this.pos), this.start))) return -1;
			}
		}
	}
}
...
class rd {
	nextLine(e, t, i) {
		let n = t.depth < e.stack.length ? -1 : UO(t),
			r = t.next;
		if (n < 0) return !1;
		let s = bd(AO.HeaderMark, e.lineStart + t.pos, e.lineStart + n);
		return (
			e.nextLine(),
			e.addLeafElement(
				i,
				bd(
					61 == r ? AO.SetextHeading1 : AO.SetextHeading2,
					i.start,
					e.prevLineEnd(),
...
const sd = {
		LinkReference: (e, t) => (91 == t.content.charCodeAt(0) ? new id(t) : null),
		SetextHeading: () => new rd(),
	},
	od = [
		(e, t) => IO(t) >= 0,
		(e, t) => LO(t) >= 0,
...
class ld {
		...
		(this.parser = e),
			...
			(this.lineStart =
				...
				this.absoluteLineEnd =
					n[0].from),
			(this.block = XO.create(AO.Document, 0, this.lineStart, 0, 0)),
			(this.stack = [this.block]),
			(this.fragments = i.length ? new Md(i, t) : null),
			this.readLine();
	}
	get parsedPos() {
	...
	advance() {
		...
		let t = new CO(this.lineStart + e.pos, e.text.slice(e.pos));
	...
	reuseFragment(e) {
		...
		return (
			...
			(this.lineStart = jd(this.absoluteLineStart, this.ranges)),
			this.moveRangeI(),
	...
	readLine() {
		...
		for (
			...
			if (!i) throw new Error("Unhandled block context " + AO[t.type]);
			if (!i(t, this, e)) break;
			e.forward();
		}
	}
	...
	addLeafElement(e, t) {
		this.addNode(
			this.buffer
				.writeElements(Cd(t.children, e.marks), -t.from)
	...
	finishLeaf(e) {
		...
		let t = Cd(this.parser.parseInline(e.content, e.start), e.marks);
		this.addNode(
			this.buffer
				.writeElements(t, -e.start)
				.finish(AO.Paragraph, e.content.length),
			e.start,
		);
	}
	elt(e, t, i, n) {
		return "string" == typeof e
			? bd(this.parser.getNodeType(e), t, i, n)
			: new xd(e, t);
	}
	get buffer() {
		return new md(this.parser.nodeSet);
	}
}
...
class cd extends Vh {
	...
	configure(e) {
			...
			for (let i of t.defineNodes) {
				...
				let l = r.length,
					h = o
						? ["Block", "BlockContext"]
						: s
							? l >= AO.ATXHeading1 && l <= AO.SetextHeading2
		...
		if ((ud(t.props) && (i = i.extend(...t.props)), ud(t.remove)))
		...
		return t.wrap && (c = c.concat(t.wrap)), new cd(i, r, s, o, h, n, a, l, c);
	}
	getNodeType(e) {
		...
		props:
			t >= AO.Escape
				...
				: [
						[
							uh.group,
							t in jO ? ["Block", "BlockContext"] : ["Block", "LeafBlock"],
						],
					],
		top: "Document" == e,
	});
...
function bd(e, t, i, n) {
	return new gd(e, t, i, n);
}
const Sd = { resolve: "Emphasis", mark: "EmphasisMark" },
	yd = { resolve: "Emphasis", mark: "EmphasisMark" },
	Qd = {},
	wd = {};
class kd {
	constructor(e, t, i, n) {
...
const Pd = {
	Escape(e, t, i) {
		...
		let n = e.char(i + 1);
		for (let t = 0; t < 32; t++)
			if (vd.charCodeAt(t) == n) return e.append(bd(AO.Escape, i, i + 2));
		return -1;
	},
	Entity(e, t, i) {
		if (38 != t) return -1;
		let n = /^(?:#\d+|#x[a-f\d]+|\w+);/i.exec(e.slice(i + 1, i + 31));
		return n ? e.append(bd(AO.Entity, i, i + 1 + n[0].length)) : -1;
	},
	InlineCode(e, t, i) {
		...
		for (; n < e.end; n++)
			if (96 == e.char(n)) {
				if ((s++, s == r && 96 != e.char(n + 1)))
					return e.append(
						bd(AO.InlineCode, i, n + 1, [
							bd(AO.CodeMark, i, i + r),
							bd(AO.CodeMark, n + 1 - r, n + 1),
						]),
					);
			} else s = 0;
		return -1;
	...
	HTMLTag(e, t, i) {
		...
		if (r)
			return e.append(
				bd(AO.Autolink, i, i + 1 + r[0].length, [
					bd(AO.LinkMark, i, i + 1),
					bd(AO.URL, i + 1, i + r[0].length),
					bd(AO.LinkMark, i + r[0].length, i + 1 + r[0].length),
				]),
			);
		let s = /^!--[^>](?:-[^-]|[^-])*?-->/i.exec(n);
		if (s) return e.append(bd(AO.Comment, i, i + 1 + s[0].length));
		let o = /^\?[^]*?\?>/.exec(n);
		if (o)
			return e.append(bd(AO.ProcessingInstruction, i, i + 1 + o[0].length));
		let a =
			/^(?:![A-Z][^]*?>|!\[CDATA\[[^]*?\]\]>|\/\s*[a-zA-Z][\w-]*\s*>|\s*[a-zA-Z][\w-]*(\s+[a-zA-Z:_][\w-.:]*(?:\s*=\s*(?:[^\s"'=<>`]+|'[^']*'|"[^"]*"))?)*\s*(\/\s*)?>)/.exec(
				n,
			);
		return a ? e.append(bd(AO.HTMLTag, i, i + 1 + a[0].length)) : -1;
	},
	Emphasis(e, t, i) {
		...
		let r = e.slice(i - 1, i),
			...
			f = c && (42 == t || !u || o),
			O = u && (42 == t || !c || a);
		return e.append(new kd(95 == t ? Sd : yd, i, n, (f ? 1 : 0) | (O ? 2 : 0)));
	},
	HardBreak(e, t, i) {
		if (92 == t && 10 == e.char(i + 1))
			return e.append(bd(AO.HardBreak, i, i + 2));
		if (32 == t) {
			let t = i + 1;
			for (; 32 == e.char(t); ) t++;
			if (10 == e.char(t) && t >= i + 2)
				return e.append(bd(AO.HardBreak, i, t + 1));
		}
		return -1;
	},
	Link: (e, t, i) => (91 == t ? e.append(new kd(Qd, i, i + 1, 1)) : -1),
	Image: (e, t, i) =>
		33 == t && 91 == e.char(i + 1) ? e.append(new kd(wd, i, i + 2, 1)) : -1,
	LinkEnd(e, t, i) {
		if (93 != t) return -1;
		for (let t = e.parts.length - 1; t >= 0; t--) {
			let n = e.parts[t];
			if (n instanceof kd && (n.type == Qd || n.type == wd)) {
				if (
					!n.side ||
				...
				if (n.type == Qd)
					for (let i = 0; i < t; i++) {
						let t = e.parts[i];
						t instanceof kd && t.type == Qd && (t.side = 0);
					}
				return s.to;
			}
		}
...
function Zd(e, t, i, n, r) {
	let { text: s } = e,
		...
		a = r;
	if (
		(t.unshift(bd(AO.LinkMark, n, n + (i == AO.Image ? 2 : 1))),
		t.push(bd(AO.LinkMark, r - 1, r)),
		40 == o)
	) {
		let i,
			n = e.skipSpace(r + 1),
			o = _d(s, n - e.offset, e.offset);
		o &&
			((n = e.skipSpace(o.to)),
			n != o.to &&
				((i = Td(s, n - e.offset, e.offset)), i && (n = e.skipSpace(i.to)))),
			41 == e.char(n) &&
				(t.push(bd(AO.LinkMark, r, r + 1)),
				(a = n + 1),
				o && t.push(o),
				i && t.push(i),
				t.push(bd(AO.LinkMark, n, a)));
	} else if (91 == o) {
		let i = Xd(s, r - e.offset, e.offset, !1);
		i && (t.push(i), (a = i.to));
	}
	return bd(i, n, a, t);
}
function _d(e, t, i) {
	if (60 == e.charCodeAt(t)) {
		for (let n = t + 1; n < e.length; n++) {
			...
			if (62 == r) return bd(AO.URL, t + i, n + 1 + i);
	...
	}
	{
		...
		return r > t ? bd(AO.URL, t + i, r + i) : r == e.length && null;
	}
}
function Td(e, t, i) {
	...
	for (let n = t + 1, s = !1; n < e.length; n++) {
		...
		if (s) s = !1;
			...
			if (o == r) return bd(AO.LinkTitle, t + i, n + 1 + i);
			92 == o && (s = !0);
		}
	}
	return null;
...
function Xd(e, t, i, n) {
	for (let r = !1, s = t + 1, o = Math.min(e.length, s + 999); s < o; s++) {
		...
		if (r) r = !1;
			...
			if (93 == o) return !n && bd(AO.LinkLabel, t + i, s + 1 + i);
			if ((n && !EO(o) && (n = !1), 91 == o)) return !1;
			92 == o && (r = !0);
		}
	}
	return null;
...
class Ad {
	...
	addDelimiter(e, t, i, n, r) {
		return this.append(new kd(e, t, i, (n ? 1 : 0) | (r ? 2 : 0)));
	}
	get hasOpenLink() {
		for (let e = this.parts.length - 1; e >= 0; e--) {
			let t = this.parts[e];
			if (t instanceof kd && (t.type == Qd || t.type == wd)) return !0;
		}
		return !1;
	}
	addElement(e) {
	...
	resolveMarkers(e) {
		for (let t = e; t < this.parts.length; t++) {
			let i = this.parts[t];
			if (!(i instanceof kd && i.type.resolve && 2 & i.side)) continue;
			let n,
				r = i.type == Sd || i.type == yd,
				s = i.to - i.from,
				o = t - 1;
			for (; o >= e; o--) {
				let e = this.parts[o];
			...
			for (let e = o + 1; e < t; e++)
				this.parts[e] instanceof gd && l.push(this.parts[e]),
					(this.parts[e] = null);
			i.type.mark && l.push(this.elt(i.type.mark, i.from, c));
			let u = this.elt(a, h, c, l);
			(this.parts[o] =
				r && n.from != h ? new kd(n.type, n.from, h, n.side) : null),
				(this.parts[t] =
					r && i.to != c ? new kd(i.type, c, i.to, i.side) : null)
	...
	findOpeningDelimiter(e) {
		for (let t = this.parts.length - 1; t >= 0; t--) {
			let i = this.parts[t];
			if (i instanceof kd && i.type == e) return t;
		}
		return null;
	}
	takeContent(e) {
	...
	skipSpace(e) {
		return qO(this.text, e - this.offset) + this.offset;
	}
	elt(e, t, i, n) {
		return "string" == typeof e
			? bd(this.parser.getNodeType(e), t, i, n)
...
function Cd(e, t) {
	...
	for (let e of t) {
		...
		if (n < i.length && i[n].from < e.from) {
			let t = i[n];
			t instanceof gd &&
				(i[n] = new gd(t.type, t.from, t.to, Cd(t.children, [e])));
		} else i.splice(n++, 0, e);
	}
	return i;
}
const Rd = [AO.CodeBlock, AO.ListItem, AO.OrderedList, AO.BulletList];
let Md = class {
	constructor(e, t) {
		(this.fragments = e),
			(this.input = t),
	...
	takeNodes(e) {
		...
		for (;;) {
			...
			let r = jd(t.from - i, e.ranges);
			if (t.to - i <= e.ranges[e.rangeI].to) e.addNode(t.tree, r);
			else {
				let i = new bh(
					e.parser.nodeSet.types[AO.Paragraph],
					[],
					[],
					0,
					e.block.hashProp,
...
const Ed = sc({
	...
	qd = new cd(
		new ph(dd).extend(Ed),
		Object.keys(td).map((e) => td[e]),
		Object.keys(td).map((e) => sd[e]),
		Object.keys(td),
		od,
		jO,
		Object.keys(Pd).map((e) => Pd[e]),
		Object.keys(Pd),
		[],
	);
function Vd(e, t, i) {
...
const Ld = { resolve: "Strikethrough", mark: "StrikethroughMark" },
	Wd = {
		defineNodes: [
			{
				name: "Strikethrough",
		...
		if (null == this.rows) {
			...
			if (
				...
				(45 == t.next || 58 == t.next || 124 == t.next) &&
					Dd.test((n = t.text.slice(t.pos))))
			) {
				let r = [];
				zd(e, i.content, 0, r, i.start) == zd(e, n, t.pos) &&
					(this.rows = [
			...
			let i = [];
			zd(e, t.text, t.pos, i, e.lineStart),
				this.rows.push(
					e.elt(
						"TableRow",
						e.lineStart + t.pos,
...
const Id = {
	...
	parseBlock: [
		{
			name: "Table",
			leaf: (e, t) => (Yd(t.content, 0) ? new Bd() : null),
			endLeaf(e, t, i) {
				if (i.parsers.some((e) => e instanceof Bd) || !Yd(t.text, t.basePos))
					return !1;
				let n = e.peekLine();
				return Dd.test(n) && zd(e, t.text, t.basePos) == zd(e, n, t.basePos);
			},
...
const Gd = {
	...
	Nd = /(www\.)|(https?:\/\/)|([\w.+-]{1,100}@)|(mailto:|xmpp:)/gy,
	Hd = /[\w-]+(\.[\w-]+)+(\/[^\s<]*)?/gy,
	Fd = /[\w-]+\.[\w-]+($|\/)/,
	Kd = /[\w.+-]+@[\w-]+(\.[\w.-]+)+/gy,
	Jd = /\/[a-zA-Z\d@.]+/gy;
					...
					if (r[1] || r[2]) {
						if (
							((s = (function (e, t) {
								Hd.lastIndex = t;
								let i = Hd.exec(e);
								if (!i || Fd.exec(i[0])[0].indexOf("_") > -1) return -1;
								let n = t + i[0].length;
								for (;;) {
									let i,
										r = e[n - 1];
...
function np(e, t, i) {
	return (n, r, s) => {
		...
		for (let r = s + 1; r < n.end; r++) {
			...
			if ((92 == a && o.push(n.elt("Escape", r, 2 + r++)), EO(a))) break;
		}
		return -1;
	};
}
...
class Tp {
	constructor(e) {
		(this.start = e.start),
			(this.shift = e.shift || _p),
			(this.reduce = e.reduce || _p),
			(this.reuse = e.reuse || _p),
			(this.hash = e.hash || (() => 0)),
...
function Wp(e, t) {
	...
	return (
		(Vp = e),
		(Lp = i),
		(qp = r ? r.toLowerCase() : n == zp || n == Yp ? void 0 : null)
	);
}
const zp = 63,
	Yp = 33;
...
const Bp = [6, 10, 7, 8, 9],
	Ip = new Tp({
		start: null,
		shift: (e, t, i, n) => (Bp.indexOf(t) > -1 ? new Dp(Wp(n, 1) || "", e) : e),
		reduce: (e, t) => (20 == t && e ? e.parent : e),
		reuse(e, t, i, n) {
			let r = t.type.id;
			return 6 == r || 36 == r ? new Dp(Wp(n, 1) || "", e) : e;
		},
		strict: !1,
	}),
	Up = new gp(
...
const hm = new gp((e, t) => {
	...
	mm = Xp.deserialize({
		...
		specialized: [
			{ term: 102, get: (e) => Om[e] || -1 },
			{ term: 59, get: (e) => dm[e] || -1 },
...
function Am() {
	return new Wc(Xm, Xm.data.of({ autocomplete: Tm }));
}
...
const Wm = new gp((e, t) => {
	...
	Um = [
		ZO("function ${name}(${params}) {\n\t${}\n}", {
			label: "function",
			detail: "definition",
			type: "keyword",
		}),
		ZO("for (let ${index} = 0; ${index} < ${bound}; ${index}++) {\n\t${}\n}", {
			label: "for",
			detail: "loop",
			type: "keyword",
		}),
		ZO("for (let ${name} of ${collection}) {\n\t${}\n}", {
			label: "for",
			detail: "of loop",
			type: "keyword",
		}),
		...
		ZO('import {${names}} from "${module}"\n${}', {
			label: "import",
			detail: "named",
			type: "keyword",
		}),
		ZO('import ${name} from "${module}"\n${}', {
			label: "import",
			detail: "default",
			type: "keyword",
		}),
...
function dg(e = {}) {
	let t = e.jsx ? (e.typescript ? cg : hg) : e.typescript ? lg : og,
		i = e.typescript ? Gm.concat(Og) : Um.concat(fg);
	return new Wc(t, [
		og.data.of({ autocomplete: cO(ig, hO(i)) }),
...
function Vg(e) {
	return qg(Tg.default, e);
}
function Lg(e) {
	let { extraTags: t, extraGlobalAttributes: i } = e,
		n = i || t ? new Tg(t, i) : Tg.default;
	return (e) => qg(n, e);
}
const Wg = og.parser.configure({ top: "SingleExpression" }),
	...
	].concat(_g.map((e) => ({ name: e, parser: og.parser }))),
	Dg = Tc.define({
		name: "html",
		parser: tm.configure({
			props: [
	...
	l.push(
		(function (e) {
			let { codeParser: t, htmlParser: i } = e,
				n = Wh((e, n) => {
					let r = e.type.id;
					if (!t || (r != AO.CodeBlock && r != AO.FencedCode)) {
						if (i && (r == AO.HTMLBlock || r == AO.HTMLTag))
							return { parser: i, overlay: Vd(e.node, e.from, e.to) };
					} else {
						let i = "";
						if (r == AO.FencedCode) {
							let t = e.node.getChild(AO.CodeInfo);
							t && (i = n.read(t.from, t.to));
						}
						let s = t(i);
						if (s)
							return { parser: s, overlay: (e) => e.type.id == AO.CodeText };
					}
					return null;
				});
			return { wrap: n };
...
function bx() {
	if (xx) return xx;
	let e = Vg(new aO(Sr.create({ extensions: px }), 0, !0));
	return (xx = e ? e.options : []);
}
var Sx = Object.freeze({
	__proto__: null,
	commonmarkLanguage: nx,
	deleteMarkupBackward: Ox,
...
function Qx(e) {
	return import("./index-EWYF_E6l.js").then((t) => t.sql({ dialect: t[e] }));
}
const wx = [
		zc.of({
			name: "C",
			extensions: ["c", "h", "ino"],
			load: () => import("./index-CxoWtD8O.js").then((e) => e.cpp()),
		}),
		zc.of({
			name: "C++",
			alias: ["cpp"],
		...
		zc.of({
			name: "Go",
			extensions: ["go"],
			load: () => import("./index-BjoYQ2h-.js").then((e) => e.go()),
		}),
		zc.of({
			name: "HTML",
			alias: ["xhtml"],
		...
		zc.of({
			name: "Java",
			extensions: ["java"],
			load: () => import("./index-51u7WtGJ.js").then((e) => e.java()),
		}),
		zc.of({
			name: "JavaScript",
		...
		zc.of({
			...
			alias: ["json5"],
			extensions: ["json", "map"],
			load: () => import("./index-BxjkW1ag.js").then((e) => e.json()),
		}),
		zc.of({
			name: "JSX",
			extensions: ["jsx"],
		...
		zc.of({
			name: "LESS",
			extensions: ["less"],
			load: () => import("./index-zhotE5hk.js").then((e) => e.less()),
		}),
		zc.of({
			name: "Liquid",
			extensions: ["liquid"],
			load: () => import("./index-BPudNHTI.js").then((e) => e.liquid()),
		}),
		...
		zc.of({
			...
			load: () => import("./index-BPk2Y-kA.js").then((e) => e.php()),
		}),
		...
		zc.of({
			...
			filename: /^(BUCK|BUILD)$/,
			load: () => import("./index-qWdHQlvN.js").then((e) => e.python()),
		}),
		zc.of({
			name: "Rust",
			extensions: ["rs"],
			load: () => import("./index-QQu6s6fW.js").then((e) => e.rust()),
		}),
		zc.of({
			name: "Sass",
			extensions: ["sass"],
			load: () =>
				import("./index-0iikSKxu.js").then((e) => e.sass({ indented: !0 })),
		}),
		zc.of({
			name: "SCSS",
			extensions: ["scss"],
			load: () => import("./index-0iikSKxu.js").then((e) => e.sass()),
		}),
		...
		zc.of({
			name: "WebAssembly",
			extensions: ["wat", "wast"],
			load: () => import("./index-CL2ajxoo.js").then((e) => e.wast()),
		}),
		zc.of({
			name: "XML",
			alias: ["rss", "wsdl", "xsd"],
			extensions: ["xml", "xsl", "xsd", "svg"],
			load: () => import("./index-CfWFyJbj.js").then((e) => e.xml()),
		}),
		zc.of({
			name: "YAML",
			alias: ["yml"],
			extensions: ["yaml", "yml"],
			load: () => import("./index-DVV1KGmN.js").then((e) => e.yaml()),
		}),
		zc.of({
			name: "APL",
		...
		zc.of({
			name: "Vue",
			extensions: ["vue"],
			load: () => import("./index-SElVQwJI.js").then((e) => e.vue()),
		}),
		zc.of({
			name: "Angular Template",
			load: () => import("./index-DNNsx6He.js").then((e) => e.angular()),
		}),
	],
	...
	_x = "var(--editor-comment, #6a9955)",
	Tx = "var(--editor-keyword, #569cd6)",
	...
	Ex = Gl.theme(
		{
			...
			[wc.url]: { color: Rx },
			[wc.quote]: { color: _x, fontStyle: "italic" },
			[wc.keyword]: { color: Tx },
			[wc.comment]: { color: _x, fontStyle: "italic" },
			[wc.string]: { color: Xx },
			[wc.number]: { color: Ax },
...
function Bx(e = null) {
	return {
		...
		init() {
			...
			else console.warn(`Initial content script tag #${t} not found.`);
		...
		handleContentChange: Dx(function () {
			...
			if (this.editorView)
				switch (e) {
					...
					case "blockquote":
						...
						break;
					case "image":
						Yx(this.editorView, "![", "](url)", "alt text");
						break;
					case "table":
						const t =
							"| Header 1 | Header 2 |\n|---|---|\n| Cell 1 | Cell 2 |\n| Cell 3 | Cell 4 |";
						Yx(this.editorView, "", "", t, !0);
						break;
					case "codeblock":
						Yx(this.editorView, "```\n", "\n```", "code here", !0);
						break;
