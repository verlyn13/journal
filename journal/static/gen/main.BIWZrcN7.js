...
function ty(e) {
	return import("./chunks/index.BqyMZUWq.js").then((t) =>
		t.sql({ dialect: t[e] }),
	);
}
const iy = [
		Du.of({
			name: "C",
			extensions: ["c", "h", "ino"],
			load: () => import("./chunks/index.aD52o7j4.js").then((e) => e.cpp()),
		}),
		Du.of({
			name: "C++",
			alias: ["cpp"],
		...
		Du.of({
			name: "Go",
			extensions: ["go"],
			load: () => import("./chunks/index.BXk6sNin.js").then((e) => e.go()),
		}),
		Du.of({
			name: "HTML",
			alias: ["xhtml"],
		...
		Du.of({
			name: "Java",
			extensions: ["java"],
			load: () => import("./chunks/index.DTyBqLLi.js").then((e) => e.java()),
		}),
		Du.of({
			name: "JavaScript",
		...
		Du.of({
			...
			alias: ["json5"],
			extensions: ["json", "map"],
			load: () => import("./chunks/index.B7cnvj5a.js").then((e) => e.json()),
		}),
		Du.of({
			name: "JSX",
			extensions: ["jsx"],
		...
		Du.of({
			name: "LESS",
			extensions: ["less"],
			load: () => import("./chunks/index.61zQHkXs.js").then((e) => e.less()),
		}),
		Du.of({
			name: "Liquid",
			extensions: ["liquid"],
			load: () => import("./chunks/index.DY-g9tBL.js").then((e) => e.liquid()),
		}),
		...
		Du.of({
			...
			load: () => import("./chunks/index.DDgB0RsT.js").then((e) => e.php()),
		}),
		...
		Du.of({
			...
			filename: /^(BUCK|BUILD)$/,
			load: () => import("./chunks/index.CA_viTim.js").then((e) => e.python()),
		}),
		Du.of({
			name: "Rust",
			extensions: ["rs"],
			load: () => import("./chunks/index.fHr0_WB7.js").then((e) => e.rust()),
		}),
		Du.of({
			name: "Sass",
			extensions: ["sass"],
			load: () =>
				import("./chunks/index.Cu2scQo3.js").then((e) =>
					e.sass({ indented: !0 }),
				),
		}),
		Du.of({
			name: "SCSS",
			extensions: ["scss"],
			load: () => import("./chunks/index.Cu2scQo3.js").then((e) => e.sass()),
		}),
		...
		Du.of({
			name: "WebAssembly",
			extensions: ["wat", "wast"],
			load: () => import("./chunks/index.BaxB_mIW.js").then((e) => e.wast()),
		}),
		Du.of({
			name: "XML",
			alias: ["rss", "wsdl", "xsd"],
			extensions: ["xml", "xsl", "xsd", "svg"],
			load: () => import("./chunks/index.BaANzGm9.js").then((e) => e.xml()),
		}),
		Du.of({
			name: "YAML",
			alias: ["yml"],
			extensions: ["yaml", "yml"],
			load: () => import("./chunks/index.CiFWGknQ.js").then((e) => e.yaml()),
		}),
		Du.of({
			name: "APL",
			extensions: ["dyalog", "apl"],
			load: () => import("./chunks/apl.CV0E-avQ.js").then((e) => ey(e.apl)),
		}),
		Du.of({
			name: "PGP",
			alias: ["asciiarmor"],
			...
			load: () =>
				import("./chunks/asciiarmor.CFhrTOAf.js").then((e) => ey(e.asciiArmor)),
		}),
		Du.of({
			name: "ASN.1",
			extensions: ["asn", "asn1"],
			load: () =>
				import("./chunks/asn1.CXDEdy1o.js").then((e) => ey(e.asn1({}))),
		}),
		Du.of({
			name: "Asterisk",
			filename: /^extensions\.conf$/i,
			load: () =>
				import("./chunks/asterisk.BtQwsH_Z.js").then((e) => ey(e.asterisk)),
		}),
		Du.of({
			name: "Brainfuck",
			extensions: ["b", "bf"],
			load: () =>
				import("./chunks/brainfuck.BjlLFYso.js").then((e) => ey(e.brainfuck)),
		}),
		Du.of({
			name: "Cobol",
			extensions: ["cob", "cpy"],
			load: () => import("./chunks/cobol.D8AWGr7X.js").then((e) => ey(e.cobol)),
		}),
		Du.of({
			name: "C#",
			alias: ["csharp", "cs"],
			extensions: ["cs"],
			load: () =>
				import("./chunks/clike.B7deM-DO.js").then((e) => ey(e.csharp)),
		}),
		Du.of({
			name: "Clojure",
			extensions: ["clj", "cljc", "cljx"],
			load: () =>
				import("./chunks/clojure.C7tYON23.js").then((e) => ey(e.clojure)),
		}),
		Du.of({
			name: "ClojureScript",
			extensions: ["cljs"],
		...
		Du.of({
			...
			extensions: ["gss"],
			load: () => import("./chunks/css.DwVyfHvX.js").then((e) => ey(e.gss)),
		}),
		Du.of({
			name: "CMake",
			extensions: ["cmake", "cmake.in"],
			filename: /^CMakeLists\.txt$/,
			load: () => import("./chunks/cmake.Cv0SGKyU.js").then((e) => ey(e.cmake)),
		}),
		Du.of({
			name: "CoffeeScript",
			...
			extensions: ["coffee"],
			load: () =>
				import("./chunks/coffeescript.CYON6Ldp.js").then((e) =>
					ey(e.coffeeScript),
				),
		}),
		Du.of({
			...
			load: () =>
				import("./chunks/commonlisp.CfV3luy-.js").then((e) => ey(e.commonLisp)),
		}),
		Du.of({
			name: "Cypher",
			extensions: ["cyp", "cypher"],
			load: () =>
				import("./chunks/cypher.Ct-glrzJ.js").then((e) => ey(e.cypher)),
		}),
		Du.of({
			name: "Cython",
			extensions: ["pyx", "pxd", "pxi"],
			load: () =>
				import("./chunks/python.BGkD7Ucy.js").then((e) => ey(e.cython)),
		}),
		Du.of({
			name: "Crystal",
			extensions: ["cr"],
			load: () =>
				import("./chunks/crystal.DRLJCBTL.js").then((e) => ey(e.crystal)),
		}),
		Du.of({
			name: "D",
			extensions: ["d"],
			load: () => import("./chunks/d.BGxv87Pa.js").then((e) => ey(e.d)),
		}),
		Du.of({
			name: "Dart",
			extensions: ["dart"],
			load: () => import("./chunks/clike.B7deM-DO.js").then((e) => ey(e.dart)),
		}),
		Du.of({
			name: "diff",
			extensions: ["diff", "patch"],
			load: () => import("./chunks/diff.CaierbzC.js").then((e) => ey(e.diff)),
		}),
		Du.of({
			name: "Dockerfile",
			filename: /^Dockerfile$/,
			load: () =>
				import("./chunks/dockerfile.mM3V4G5z.js").then((e) => ey(e.dockerFile)),
		}),
		Du.of({
			name: "DTD",
			extensions: ["dtd"],
			load: () => import("./chunks/dtd.WQAGlXfm.js").then((e) => ey(e.dtd)),
		}),
		Du.of({
			name: "Dylan",
			extensions: ["dylan", "dyl", "intr"],
			load: () => import("./chunks/dylan.DRWKKoGb.js").then((e) => ey(e.dylan)),
		}),
		Du.of({
			name: "EBNF",
			load: () => import("./chunks/ebnf.CY9SzlUw.js").then((e) => ey(e.ebnf)),
		}),
		Du.of({
			name: "ECL",
			extensions: ["ecl"],
			load: () => import("./chunks/ecl.C_GzhZcE.js").then((e) => ey(e.ecl)),
		}),
		Du.of({
			name: "edn",
			extensions: ["edn"],
		...
		Du.of({
			...
			extensions: ["e"],
			load: () =>
				import("./chunks/eiffel.BDMSme5R.js").then((e) => ey(e.eiffel)),
		}),
		Du.of({
			name: "Elm",
			extensions: ["elm"],
			load: () => import("./chunks/elm.2Xs4ZtMc.js").then((e) => ey(e.elm)),
		}),
		Du.of({
			name: "Erlang",
			extensions: ["erl"],
			load: () =>
				import("./chunks/erlang.DAqS4wJ8.js").then((e) => ey(e.erlang)),
		}),
		Du.of({
			name: "Esper",
			load: () => import("./chunks/sql.BVuzYYyI.js").then((e) => ey(e.esper)),
		}),
		Du.of({
			name: "Factor",
			extensions: ["factor"],
			load: () =>
				import("./chunks/factor.BOp45gBA.js").then((e) => ey(e.factor)),
		}),
		Du.of({
			name: "FCL",
			load: () => import("./chunks/fcl.DP0uRMUx.js").then((e) => ey(e.fcl)),
		}),
		Du.of({
			name: "Forth",
			extensions: ["forth", "fth", "4th"],
			load: () => import("./chunks/forth.BmpbviDl.js").then((e) => ey(e.forth)),
		}),
		Du.of({
			name: "Fortran",
			extensions: ["f", "for", "f77", "f90", "f95"],
			load: () =>
				import("./chunks/fortran.C-shjs1E.js").then((e) => ey(e.fortran)),
		}),
		Du.of({
			name: "F#",
			alias: ["fsharp"],
			extensions: ["fs"],
			load: () =>
				import("./chunks/mllike.CLh6ZEA3.js").then((e) => ey(e.fSharp)),
		}),
		Du.of({
			name: "Gas",
			extensions: ["s"],
			load: () => import("./chunks/gas.BFEckymH.js").then((e) => ey(e.gas)),
		}),
		Du.of({
			name: "Gherkin",
			extensions: ["feature"],
			load: () =>
				import("./chunks/gherkin.DlP1TLqg.js").then((e) => ey(e.gherkin)),
		}),
		Du.of({
			name: "Groovy",
			...
			load: () =>
				import("./chunks/groovy.Dvhs0TH2.js").then((e) => ey(e.groovy)),
		}),
		Du.of({
			name: "Haskell",
			extensions: ["hs"],
			load: () =>
				import("./chunks/haskell.CJeQ-8Yj.js").then((e) => ey(e.haskell)),
		}),
		Du.of({
			name: "Haxe",
			extensions: ["hx"],
			load: () => import("./chunks/haxe.CvzFfx4I.js").then((e) => ey(e.haxe)),
		}),
		Du.of({
			name: "HXML",
			extensions: ["hxml"],
			load: () => import("./chunks/haxe.CvzFfx4I.js").then((e) => ey(e.hxml)),
		}),
		Du.of({
			name: "HTTP",
			load: () => import("./chunks/http.BvmxVZpU.js").then((e) => ey(e.http)),
		}),
		Du.of({
			name: "IDL",
			extensions: ["pro"],
			load: () => import("./chunks/idl.C5T4duDJ.js").then((e) => ey(e.idl)),
		}),
		Du.of({
			name: "JSON-LD",
			alias: ["jsonld"],
			extensions: ["jsonld"],
			load: () =>
				import("./chunks/javascript.BcZvMzDA.js").then((e) => ey(e.jsonld)),
		}),
		Du.of({
			name: "Jinja2",
			extensions: ["j2", "jinja", "jinja2"],
			load: () =>
				import("./chunks/jinja2.93W0hiTe.js").then((e) => ey(e.jinja2)),
		}),
		Du.of({
			name: "Julia",
			extensions: ["jl"],
			load: () => import("./chunks/julia.Blw9UAx_.js").then((e) => ey(e.julia)),
		}),
		Du.of({
			name: "Kotlin",
			extensions: ["kt", "kts"],
			load: () =>
				import("./chunks/clike.B7deM-DO.js").then((e) => ey(e.kotlin)),
		}),
		Du.of({
			name: "LiveScript",
			alias: ["ls"],
			extensions: ["ls"],
			load: () =>
				import("./chunks/livescript.DeGeLRgB.js").then((e) => ey(e.liveScript)),
		}),
		Du.of({
			name: "Lua",
			extensions: ["lua"],
			load: () => import("./chunks/lua.CKokBVLO.js").then((e) => ey(e.lua)),
		}),
		Du.of({
			name: "mIRC",
			extensions: ["mrc"],
			load: () => import("./chunks/mirc.D0wzsUZq.js").then((e) => ey(e.mirc)),
		}),
		Du.of({
			name: "Mathematica",
			extensions: ["m", "nb", "wl", "wls"],
			load: () =>
				import("./chunks/mathematica.CZ7ZolDb.js").then((e) =>
					ey(e.mathematica),
				),
		}),
		Du.of({
			...
			extensions: ["mo"],
			load: () =>
				import("./chunks/modelica.cmMtsclm.js").then((e) => ey(e.modelica)),
		}),
		Du.of({
			name: "MUMPS",
			extensions: ["mps"],
			load: () => import("./chunks/mumps.BGxkJEeH.js").then((e) => ey(e.mumps)),
		}),
		Du.of({
			name: "Mbox",
			extensions: ["mbox"],
			load: () => import("./chunks/mbox.B8_pZlBR.js").then((e) => ey(e.mbox)),
		}),
		Du.of({
			name: "Nginx",
			filename: /nginx.*\.conf$/i,
			load: () => import("./chunks/nginx.BiyK1c34.js").then((e) => ey(e.nginx)),
		}),
		Du.of({
			name: "NSIS",
			extensions: ["nsh", "nsi"],
			load: () => import("./chunks/nsis.CS5Di1OT.js").then((e) => ey(e.nsis)),
		}),
		Du.of({
			name: "NTriples",
			extensions: ["nt", "nq"],
			load: () =>
				import("./chunks/ntriples.DFFa7eeg.js").then((e) => ey(e.ntriples)),
		}),
		Du.of({
			name: "Objective-C",
			...
			extensions: ["m"],
			load: () =>
				import("./chunks/clike.B7deM-DO.js").then((e) => ey(e.objectiveC)),
		}),
		Du.of({
			name: "Objective-C++",
			alias: ["objective-c++", "objc++"],
			extensions: ["mm"],
			load: () =>
				import("./chunks/clike.B7deM-DO.js").then((e) => ey(e.objectiveCpp)),
		}),
		Du.of({
			name: "OCaml",
			extensions: ["ml", "mli", "mll", "mly"],
			load: () =>
				import("./chunks/mllike.CLh6ZEA3.js").then((e) => ey(e.oCaml)),
		}),
		Du.of({
			name: "Octave",
			extensions: ["m"],
			load: () =>
				import("./chunks/octave.k_f85Ur_.js").then((e) => ey(e.octave)),
		}),
		Du.of({
			name: "Oz",
			extensions: ["oz"],
			load: () => import("./chunks/oz.DMoTT4al.js").then((e) => ey(e.oz)),
		}),
		Du.of({
			name: "Pascal",
			extensions: ["p", "pas"],
			load: () =>
				import("./chunks/pascal.Dw47qpR0.js").then((e) => ey(e.pascal)),
		}),
		Du.of({
			name: "Perl",
			extensions: ["pl", "pm"],
			load: () => import("./chunks/perl.CbhMBB_G.js").then((e) => ey(e.perl)),
		}),
		Du.of({
			name: "Pig",
			extensions: ["pig"],
			load: () => import("./chunks/pig.CycuK0Le.js").then((e) => ey(e.pig)),
		}),
		Du.of({
			name: "PowerShell",
			extensions: ["ps1", "psd1", "psm1"],
			load: () =>
				import("./chunks/powershell.CASkrAIv.js").then((e) => ey(e.powerShell)),
		}),
		Du.of({
			...
			load: () =>
				import("./chunks/properties.CFNc4xiv.js").then((e) => ey(e.properties)),
		}),
		Du.of({
			name: "ProtoBuf",
			extensions: ["proto"],
			load: () =>
				import("./chunks/protobuf.C1Yfx6xM.js").then((e) => ey(e.protobuf)),
		}),
		Du.of({
			name: "Pug",
			alias: ["jade"],
			extensions: ["pug", "jade"],
			load: () => import("./chunks/pug.DxdE3S0k.js").then((e) => ey(e.pug)),
		}),
		Du.of({
			name: "Puppet",
			extensions: ["pp"],
			load: () =>
				import("./chunks/puppet.XyYk31kn.js").then((e) => ey(e.puppet)),
		}),
		Du.of({
			name: "Q",
			extensions: ["q"],
			load: () => import("./chunks/q.D8T3ixVP.js").then((e) => ey(e.q)),
		}),
		Du.of({
			name: "R",
			alias: ["rscript"],
			extensions: ["r", "R"],
			load: () => import("./chunks/r.BIlaxyMm.js").then((e) => ey(e.r)),
		}),
		Du.of({
			name: "RPM Changes",
			load: () =>
				import("./chunks/rpm.BjQOFagB.js").then((e) => ey(e.rpmChanges)),
		}),
		Du.of({
			name: "RPM Spec",
			extensions: ["spec"],
			load: () => import("./chunks/rpm.BjQOFagB.js").then((e) => ey(e.rpmSpec)),
		}),
		Du.of({
			name: "Ruby",
			...
			load: () => import("./chunks/ruby.Bgk8W8eh.js").then((e) => ey(e.ruby)),
		}),
		Du.of({
			name: "SAS",
			extensions: ["sas"],
			load: () => import("./chunks/sas.BLI3lP5u.js").then((e) => ey(e.sas)),
		}),
		Du.of({
			name: "Scala",
			extensions: ["scala"],
			load: () => import("./chunks/clike.B7deM-DO.js").then((e) => ey(e.scala)),
		}),
		Du.of({
			name: "Scheme",
			extensions: ["scm", "ss"],
			load: () =>
				import("./chunks/scheme.DrSc8H74.js").then((e) => ey(e.scheme)),
		}),
		Du.of({
			name: "Shell",
			alias: ["bash", "sh", "zsh"],
			...
			filename: /^PKGBUILD$/,
			load: () => import("./chunks/shell.CKSvVC6Y.js").then((e) => ey(e.shell)),
		}),
		Du.of({
			name: "Sieve",
			extensions: ["siv", "sieve"],
			load: () => import("./chunks/sieve.DNxzEgvJ.js").then((e) => ey(e.sieve)),
		}),
		Du.of({
			name: "Smalltalk",
			extensions: ["st"],
			load: () =>
				import("./chunks/smalltalk.CjejmIK5.js").then((e) => ey(e.smalltalk)),
		}),
		Du.of({
			name: "Solr",
			load: () => import("./chunks/solr.rfc8gF-U.js").then((e) => ey(e.solr)),
		}),
		Du.of({
			name: "SML",
			extensions: ["sml", "sig", "fun", "smackspec"],
			load: () => import("./chunks/mllike.CLh6ZEA3.js").then((e) => ey(e.sml)),
		}),
		Du.of({
			name: "SPARQL",
			alias: ["sparul"],
			...
			load: () =>
				import("./chunks/sparql.CYz_M1_z.js").then((e) => ey(e.sparql)),
		}),
		Du.of({
			name: "Spreadsheet",
			alias: ["excel", "formula"],
			load: () =>
				import("./chunks/spreadsheet.DbBUgoN7.js").then((e) =>
					ey(e.spreadsheet),
				),
		}),
		Du.of({
			...
			extensions: ["nut"],
			load: () =>
				import("./chunks/clike.B7deM-DO.js").then((e) => ey(e.squirrel)),
		}),
		Du.of({
			name: "Stylus",
			extensions: ["styl"],
			load: () =>
				import("./chunks/stylus.BgkOI4Tv.js").then((e) => ey(e.stylus)),
		}),
		Du.of({
			name: "Swift",
			extensions: ["swift"],
			load: () => import("./chunks/swift.DomULmd_.js").then((e) => ey(e.swift)),
		}),
		Du.of({
			name: "sTeX",
			load: () => import("./chunks/stex.BhqUa5JK.js").then((e) => ey(e.stex)),
		}),
		Du.of({
			name: "LaTeX",
			alias: ["tex"],
		...
		Du.of({
			...
			extensions: ["v", "sv", "svh"],
			load: () =>
				import("./chunks/verilog.DF3LX2By.js").then((e) => ey(e.verilog)),
		}),
		Du.of({
			name: "Tcl",
			extensions: ["tcl"],
			load: () => import("./chunks/tcl.C6chGwVl.js").then((e) => ey(e.tcl)),
		}),
		Du.of({
			name: "Textile",
			extensions: ["textile"],
			load: () =>
				import("./chunks/textile.BTu-UUMo.js").then((e) => ey(e.textile)),
		}),
		Du.of({
			name: "TiddlyWiki",
			load: () =>
				import("./chunks/tiddlywiki.B-m_94Fl.js").then((e) => ey(e.tiddlyWiki)),
		}),
		Du.of({
			name: "Tiki wiki",
			load: () => import("./chunks/tiki.DP6QZr9A.js").then((e) => ey(e.tiki)),
		}),
		Du.of({
			name: "TOML",
			extensions: ["toml"],
			load: () => import("./chunks/toml.CYWjIAsW.js").then((e) => ey(e.toml)),
		}),
		Du.of({
			name: "Troff",
			extensions: ["1", "2", "3", "4", "5", "6", "7", "8", "9"],
			load: () => import("./chunks/troff.DBeYqM7D.js").then((e) => ey(e.troff)),
		}),
		Du.of({
			name: "TTCN",
			extensions: ["ttcn", "ttcn3", "ttcnpp"],
			load: () => import("./chunks/ttcn.DDviH9gF.js").then((e) => ey(e.ttcn)),
		}),
		Du.of({
			name: "TTCN_CFG",
			extensions: ["cfg"],
			load: () =>
				import("./chunks/ttcn-cfg.DYS2wZk5.js").then((e) => ey(e.ttcnCfg)),
		}),
		Du.of({
			name: "Turtle",
			extensions: ["ttl"],
			load: () =>
				import("./chunks/turtle.PLbkxokJ.js").then((e) => ey(e.turtle)),
		}),
		Du.of({
			name: "Web IDL",
			extensions: ["webidl"],
			load: () =>
				import("./chunks/webidl.DB767OvI.js").then((e) => ey(e.webIDL)),
		}),
		Du.of({
			name: "VB.NET",
			extensions: ["vb"],
			load: () => import("./chunks/vb.ZN_Ylhnq.js").then((e) => ey(e.vb)),
		}),
		Du.of({
			name: "VBScript",
			extensions: ["vbs"],
			load: () =>
				import("./chunks/vbscript.DDuPImyM.js").then((e) => ey(e.vbScript)),
		}),
		Du.of({
			name: "Velocity",
			extensions: ["vtl"],
			load: () =>
				import("./chunks/velocity.DctX8Q13.js").then((e) => ey(e.velocity)),
		}),
		Du.of({
			name: "Verilog",
			extensions: ["v"],
		...
		Du.of({
			name: "VHDL",
			extensions: ["vhd", "vhdl"],
			load: () => import("./chunks/vhdl.DEhrQM8C.js").then((e) => ey(e.vhdl)),
		}),
		Du.of({
			name: "XQuery",
			extensions: ["xy", "xquery"],
			load: () =>
				import("./chunks/xquery.BiVfihES.js").then((e) => ey(e.xQuery)),
		}),
		Du.of({
			name: "Yacas",
			extensions: ["ys"],
			load: () => import("./chunks/yacas.CNkJvJRj.js").then((e) => ey(e.yacas)),
		}),
		Du.of({
			name: "Z80",
			extensions: ["z80"],
			load: () => import("./chunks/z80.saQwZ0s1.js").then((e) => ey(e.z80)),
		}),
		Du.of({
			name: "MscGen",
			extensions: ["mscgen", "mscin", "msc"],
			load: () =>
				import("./chunks/mscgen.B12NVSiz.js").then((e) => ey(e.mscgen)),
		}),
		Du.of({
			name: "Xù",
			extensions: ["xu"],
			load: () => import("./chunks/mscgen.B12NVSiz.js").then((e) => ey(e.xu)),
		}),
		Du.of({
			name: "MsGenny",
			extensions: ["msgenny"],
			load: () =>
				import("./chunks/mscgen.B12NVSiz.js").then((e) => ey(e.msgenny)),
		}),
		Du.of({
			name: "Vue",
			extensions: ["vue"],
			load: () => import("./chunks/index.0z3jGNqZ.js").then((e) => e.vue()),
		}),
		Du.of({
			name: "Angular Template",
			load: () => import("./chunks/index.CrMPJng4.js").then((e) => e.angular()),
		}),
	],
...
function wy(e, t, i = "", n = "", r = !1) {
	...
	e.dispatch({
		...
		selection:
			a.empty && !r
				? Cn.cursor(a.from + l.length)
				: a.empty && r
					? Cn.cursor(startLine.from + l.length + 1 + n.length + 1)
					: void 0,
