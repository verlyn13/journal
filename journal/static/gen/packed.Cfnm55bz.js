...
function yx(e) {
	return import("./index-DH7zkUP6.js").then((t) => t.sql({ dialect: t[e] }));
}
const Qx = [
		zc.of({
			name: "C",
			extensions: ["c", "h", "ino"],
			load: () => import("./index-GDO10YN6.js").then((e) => e.cpp()),
		}),
		zc.of({
			name: "C++",
			alias: ["cpp"],
		...
		zc.of({
			name: "Go",
			extensions: ["go"],
			load: () => import("./index-DGopoKg6.js").then((e) => e.go()),
		}),
		zc.of({
			name: "HTML",
			alias: ["xhtml"],
		...
		zc.of({
			name: "Java",
			extensions: ["java"],
			load: () => import("./index-DrF4ZlSx.js").then((e) => e.java()),
		}),
		zc.of({
			name: "JavaScript",
		...
		zc.of({
			...
			alias: ["json5"],
			extensions: ["json", "map"],
			load: () => import("./index-CvXeXYeu.js").then((e) => e.json()),
		}),
		zc.of({
			name: "JSX",
			extensions: ["jsx"],
		...
		zc.of({
			name: "LESS",
			extensions: ["less"],
			load: () => import("./index-BpwZIFOL.js").then((e) => e.less()),
		}),
		zc.of({
			name: "Liquid",
			extensions: ["liquid"],
			load: () => import("./index-D9eInSoF.js").then((e) => e.liquid()),
		}),
		...
		zc.of({
			...
			load: () => import("./index-DgPkEjna.js").then((e) => e.php()),
		}),
		...
		zc.of({
			...
			filename: /^(BUCK|BUILD)$/,
			load: () => import("./index-jsPeVUlq.js").then((e) => e.python()),
		}),
		zc.of({
			name: "Rust",
			extensions: ["rs"],
			load: () => import("./index-BdlwbU3k.js").then((e) => e.rust()),
		}),
		zc.of({
			name: "Sass",
			extensions: ["sass"],
			load: () =>
				import("./index-Dlep9cGH.js").then((e) => e.sass({ indented: !0 })),
		}),
		zc.of({
			name: "SCSS",
			extensions: ["scss"],
			load: () => import("./index-Dlep9cGH.js").then((e) => e.sass()),
		}),
		...
		zc.of({
			name: "WebAssembly",
			extensions: ["wat", "wast"],
			load: () => import("./index-CHKB4qdM.js").then((e) => e.wast()),
		}),
		zc.of({
			name: "XML",
			alias: ["rss", "wsdl", "xsd"],
			extensions: ["xml", "xsl", "xsd", "svg"],
			load: () => import("./index-CmNxAvkO.js").then((e) => e.xml()),
		}),
		zc.of({
			name: "YAML",
			alias: ["yml"],
			extensions: ["yaml", "yml"],
			load: () => import("./index-C8kIqQ5R.js").then((e) => e.yaml()),
		}),
		zc.of({
			name: "APL",
		...
		zc.of({
			name: "Vue",
			extensions: ["vue"],
			load: () => import("./index-DZ-6yNc3.js").then((e) => e.vue()),
		}),
		zc.of({
			name: "Angular Template",
			load: () => import("./index-CzOKFmWz.js").then((e) => e.angular()),
		}),
	],
